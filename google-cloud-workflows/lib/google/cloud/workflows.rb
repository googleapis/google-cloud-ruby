...
require "google/cloud/workflows/version"
...
::Google::Cloud.configure.add_config! :workflows do |config|
  config.add_field! :endpoint,      "workflows.googleapis.com", match: ::String
...
module Google
  module Cloud
    module Workflows
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.workflows if block_given?

        ::Google::Cloud.configure.workflows
      end
    end
  end
end
...
require "google/cloud/workflows/helpers" if ::File.file? helper_path
