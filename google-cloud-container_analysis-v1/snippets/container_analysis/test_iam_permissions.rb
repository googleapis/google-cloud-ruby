...
##
# Snippet for the test_iam_permissions call in the ContainerAnalysis service
#
...
# Google::Cloud::ContainerAnalysis::V1::ContainerAnalysis::Client#test_iam_permissions.
#
