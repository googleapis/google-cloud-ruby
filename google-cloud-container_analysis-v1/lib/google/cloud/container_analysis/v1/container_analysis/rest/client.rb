...
require "google/cloud/container_analysis/v1/container_analysis/rest/service_stub"
    ...
    module ContainerAnalysis
      module V1
        module ContainerAnalysis
          module Rest
            ##
            # REST client for the ContainerAnalysis service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::ContainerAnalysis::V1::ContainerAnalysis::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all ContainerAnalysis clients
              #   ::Google::Cloud::ContainerAnalysis::V1::ContainerAnalysis::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new ContainerAnalysis REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @container_analysis_stub = ::Google::Cloud::ContainerAnalysis::V1::ContainerAnalysis::Rest::ServiceStub.new(
                ...
                @container_analysis_stub.logger(stub: true)&.info do |entry|
              ...
              def set_iam_policy request, options = nil
                ...
                @container_analysis_stub.set_iam_policy request, options do |result, operation|
              ...
              def get_iam_policy request, options = nil
                ...
                @container_analysis_stub.get_iam_policy request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def test_iam_permissions request, options = nil
                ...
                @container_analysis_stub.test_iam_permissions request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_vulnerability_occurrences_summary request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_vulnerability_occurrences_summary.metadata.to_h
                ...
                @container_analysis_stub.get_vulnerability_occurrences_summary request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def export_sbom request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.export_sbom.metadata.to_h
                ...
                @container_analysis_stub.export_sbom request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the ContainerAnalysis REST API.
              #
              # This class represents the configuration for ContainerAnalysis REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::ContainerAnalysis::V1::ContainerAnalysis::Rest::Client::Configuration::Rpcs}
