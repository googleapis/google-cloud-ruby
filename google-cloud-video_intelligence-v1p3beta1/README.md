...
API Client library for the Cloud Video Intelligence V1p3beta1 API
...
```
$ gem install google-cloud-video_intelligence-v1p3beta1
```
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-video_intelligence-v1p3beta1/latest)
...
is part of the name, e.g. `google-cloud-video_intelligence-v1p3beta1`.
