...
class ::Google::Cloud::VideoIntelligence::V1p3beta1::VideoIntelligenceService::ClientTest < Minitest::Test
  ...
  def test_annotate_video
    ...
    Gapic::ServiceStub.stub :new, annotate_video_client_stub do
      # Create client
      c = ::Google::Cloud::VideoIntelligence::V1p3beta1::VideoIntelligenceService::Client.new do |config|
      ...
      # Use protobuf object
      c.annotate_video ::Google::Cloud::VideoIntelligence::V1p3beta1::AnnotateVideoRequest.new(input_uri: input_uri, input_content: input_content, features: features, video_context: video_context, output_uri: output_uri, location_id: location_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      c.annotate_video(::Google::Cloud::VideoIntelligence::V1p3beta1::AnnotateVideoRequest.new(input_uri: input_uri, input_content: input_content, features: features, video_context: video_context, output_uri: output_uri, location_id: location_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
