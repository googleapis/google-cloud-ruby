...
##
# Snippet for the list_patch_job_instance_details call in the OsConfigService service
#
...
# Google::Cloud::OsConfig::V1::OsConfigService::Client#list_patch_job_instance_details.
#
