...
##
# Snippet for the trigger_action call in the IssueResolutionService service
#
...
# Google::Shopping::Merchant::IssueResolution::V1beta::IssueResolutionService::Client#trigger_action.
#
def trigger_action
