...
class ::Google::Shopping::Merchant::IssueResolution::V1beta::IssueResolutionService::ClientTest < Minitest::Test
  ...
  def test_render_account_issues
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderAccountIssuesResponse.new
    ...
    render_account_issues_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderAccountIssuesRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["language_code"]
      assert_equal "hello world", request["time_zone"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderIssuesRequestPayload), request["payload"]
      refute_nil options
    end
  ...
  def test_render_product_issues
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderProductIssuesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    render_product_issues_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderProductIssuesRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["language_code"]
      assert_equal "hello world", request["time_zone"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderIssuesRequestPayload), request["payload"]
  ...
  def test_trigger_action
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::IssueResolution::V1beta::TriggerActionResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    trigger_action_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1beta::TriggerActionRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::IssueResolution::V1beta::TriggerActionPayload), request["payload"]
      assert_equal "hello world", request["language_code"]
      refute_nil options
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1beta::IssueResolutionService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1beta::IssueResolutionService::Client, client
