# Ruby Client for the Cloud Datastore V1 API
...
specific version of the Cloud Datastore V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-datastore-admin-v1
```
