...
class ::Google::Cloud::EdgeContainer::V1::EdgeContainer::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Cloud::EdgeContainer::V1::EdgeContainer::Operations.new do |config|
  ...
  def test_configure
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      client = ::Google::Cloud::EdgeContainer::V1::EdgeContainer::Operations.new do |config|
        config.credentials = grpc_channel
      end
    end
    ...
    assert_kind_of ::Google::Cloud::EdgeContainer::V1::EdgeContainer::Operations::Configuration, config
  end
end
