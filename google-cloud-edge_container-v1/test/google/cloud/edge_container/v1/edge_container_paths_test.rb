...
class ::Google::Cloud::EdgeContainer::V1::EdgeContainer::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_machine_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.machine_path project: "value0", location: "value1", machine: "value2"
      assert_equal "projects/value0/locations/value1/machines/value2", path
    end
  end
  ...
  def test_node_pool_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.node_pool_path project: "value0", location: "value1", cluster: "value2", node_pool: "value3"
      assert_equal "projects/value0/locations/value1/clusters/value2/nodePools/value3", path
    end
  end
  ...
  def test_vpn_connection_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.vpn_connection_path project: "value0", location: "value1", vpn_connection: "value2"
      assert_equal "projects/value0/locations/value1/vpnConnections/value2", path
    end
  end
end
