...
##
# Snippet for the create_sk_ad_network_conversion_value_schema call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#create_sk_ad_network_conversion_value_schema.
#
