...
##
# Snippet for the update_subproperty_sync_config call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#update_subproperty_sync_config.
#
