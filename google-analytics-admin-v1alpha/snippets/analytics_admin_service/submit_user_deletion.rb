...
##
# Snippet for the submit_user_deletion call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#submit_user_deletion.
#
