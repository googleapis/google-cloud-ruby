...
##
# Snippet for the update_subproperty_event_filter call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#update_subproperty_event_filter.
#
