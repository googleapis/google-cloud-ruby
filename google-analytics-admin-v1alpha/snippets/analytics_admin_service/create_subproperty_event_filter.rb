...
##
# Snippet for the create_subproperty_event_filter call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#create_subproperty_event_filter.
#
