...
##
# Snippet for the get_channel_group call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#get_channel_group.
#
