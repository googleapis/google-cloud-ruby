...
##
# Snippet for the list_channel_groups call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#list_channel_groups.
#
