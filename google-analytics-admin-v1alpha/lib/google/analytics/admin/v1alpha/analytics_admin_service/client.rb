      ...
      module V1alpha
        module AnalyticsAdminService
          ...
          class Client
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Analytics::Admin::V1alpha::CreateSubpropertyResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def create_subproperty request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.create_subproperty.metadata.to_h
              ...
              @analytics_admin_service_stub.call_rpc :create_subproperty, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
