...
class MockCloudTasksCredentials_v2 < Google::Cloud::Tasks::V2::Credentials
...
describe Google::Cloud::Tasks::V2::CloudTasksClient do

  describe 'list_queues' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#list_queues."
    ...
    it 'invokes list_queues without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Tasks::V2::ListQueuesResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::ListQueuesRequest, request)
        assert_equal(formatted_parent, request.parent)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:list_queues, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("list_queues")

      Google::Cloud::Tasks::V2::CloudTasks::Stub.stub(:new, mock_stub) do
        Google::Cloud::Tasks::V2::Credentials.stub(:default, mock_credentials) do
  ...
  describe 'get_queue' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#get_queue."
    ...
    it 'invokes get_queue without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Tasks::V2::Queue)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::GetQueueRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:get_queue, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("get_queue")
  ...
  describe 'create_queue' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#create_queue."
    ...
    it 'invokes create_queue without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::CreateQueueRequest, request)
        assert_equal(formatted_parent, request.parent)
        assert_equal(Google::Gax::to_proto(queue, Google::Cloud::Tasks::V2::Queue), request.queue)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:create_queue, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("create_queue")
  ...
  describe 'update_queue' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#update_queue."
    ...
    it 'invokes update_queue without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::UpdateQueueRequest, request)
        assert_equal(Google::Gax::to_proto(queue, Google::Cloud::Tasks::V2::Queue), request.queue)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:update_queue, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("update_queue")
  ...
  describe 'delete_queue' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#delete_queue."
    ...
    it 'invokes delete_queue without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::DeleteQueueRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: nil)
      end
      mock_stub = MockGrpcClientStub_v2.new(:delete_queue, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("delete_queue")
  ...
  describe 'purge_queue' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#purge_queue."
    ...
    it 'invokes purge_queue without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::PurgeQueueRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:purge_queue, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("purge_queue")
  ...
  describe 'pause_queue' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#pause_queue."
    ...
    it 'invokes pause_queue without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::PauseQueueRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:pause_queue, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("pause_queue")
  ...
  describe 'resume_queue' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#resume_queue."
    ...
    it 'invokes resume_queue without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::ResumeQueueRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:resume_queue, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("resume_queue")
  ...
  describe 'get_iam_policy' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#get_iam_policy."
    ...
    it 'invokes get_iam_policy without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("get_iam_policy")
  ...
  describe 'set_iam_policy' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#set_iam_policy."
    ...
    it 'invokes set_iam_policy without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("set_iam_policy")
  ...
  describe 'test_iam_permissions' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#test_iam_permissions."
    ...
    it 'invokes test_iam_permissions without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("test_iam_permissions")
  ...
  describe 'list_tasks' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#list_tasks."
    ...
    it 'invokes list_tasks without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Tasks::V2::ListTasksResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::ListTasksRequest, request)
        assert_equal(formatted_parent, request.parent)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:list_tasks, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("list_tasks")
  ...
  describe 'get_task' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#get_task."
    ...
    it 'invokes get_task without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Tasks::V2::Task)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::GetTaskRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:get_task, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("get_task")
  ...
  describe 'create_task' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#create_task."
    ...
    it 'invokes create_task without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::CreateTaskRequest, request)
        assert_equal(formatted_parent, request.parent)
        assert_equal(Google::Gax::to_proto(task, Google::Cloud::Tasks::V2::Task), request.task)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:create_task, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("create_task")
  ...
  describe 'delete_task' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#delete_task."
    ...
    it 'invokes delete_task without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::DeleteTaskRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: nil)
      end
      mock_stub = MockGrpcClientStub_v2.new(:delete_task, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("delete_task")
  ...
  describe 'run_task' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Tasks::V2::CloudTasksClient#run_task."
    ...
    it 'invokes run_task without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Tasks::V2::RunTaskRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2.new(:run_task, mock_method)

      # Mock auth layer
      mock_credentials = MockCloudTasksCredentials_v2.new("run_task")
