...
require File.expand_path("lib/google/cloud/location_finder/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-location_finder-v1"
  gem.version       = Google::Cloud::LocationFinder::V1::VERSION
