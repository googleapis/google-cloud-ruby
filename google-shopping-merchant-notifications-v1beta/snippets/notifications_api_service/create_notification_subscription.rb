...
##
# Snippet for the create_notification_subscription call in the NotificationsApiService service
#
...
# Google::Shopping::Merchant::Notifications::V1beta::NotificationsApiService::Client#create_notification_subscription.
#
