...
require File.expand_path("lib/google/shopping/merchant/notifications/v1beta/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-notifications-v1beta"
  gem.version       = Google::Shopping::Merchant::Notifications::V1beta::VERSION
