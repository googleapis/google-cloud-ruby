...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-data_fusion/latest)
for this library, google-cloud-data_fusion, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-data_fusion-v1](https://googleapis.dev/ruby/google-cloud-data_fusion-v1/latest).
...
```
$ gem install google-cloud-data_fusion
```
