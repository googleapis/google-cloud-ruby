...
```
$ gem install google-cloud-text_to_speech-v1beta1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-text_to_speech-v1beta1/latest)
