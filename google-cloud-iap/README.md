# Ruby Client for the Identity-Aware Proxy API

API Client library for the Identity-Aware Proxy API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-iap/latest)
for this library, google-cloud-iap, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-iap-v1](https://googleapis.dev/ruby/google-cloud-iap-v1/latest).
