...
class ::Google::Cloud::Orchestration::Airflow::Service::V1::ImageVersions::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_image_versions
    # Create test objects.
    client_result = ::Google::Cloud::Orchestration::Airflow::Service::V1::ListImageVersionsResponse.new
    ...
    list_image_versions_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Orchestration::Airflow::Service::V1::ImageVersions::Rest::ServiceStub.stub :transcode_list_image_versions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_image_versions_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_image_versions_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Orchestration::Airflow::Service::V1::ImageVersions::Rest::Client::Configuration, config
  end
end
