...
module Google
  module Cloud
    module GkeHub
      ...
      # {Google::Cloud::GkeHub.gke_hub_available?}.
      #
      # ## About GkeHub
      #
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::GkeHub.gke_hub}.
      ...
      #
      def self.gke_hub_available? version: :v1, transport: :grpc
        require "google/cloud/gke_hub/#{version.to_s.downcase}"
        package_name = Google::Cloud::GkeHub
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::GkeHub.const_get package_name
        return false unless service_module.const_defined? :GkeHub
        service_module = service_module.const_get :GkeHub
        if transport == :rest
