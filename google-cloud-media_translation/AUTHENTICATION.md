...
In general, the google-cloud-media_translation library uses
...
client = Google::Cloud::MediaTranslation.speech_translation_service
```

## Credential Lookup

The google-cloud-media_translation library aims to make authentication
...
The environment variables that google-cloud-media_translation
...
Google::Cloud::MediaTranslation.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-media_translation.
