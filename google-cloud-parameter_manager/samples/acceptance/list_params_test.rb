...
describe "#list_params", :parameter_manager_snippet do
  before do
  ...
  it "list a parameters" do
    sample = SampleLoader.load "list_params.rb"
    ...
    assert_includes out,
                    "Found parameter projects/#{project_id}/locations/global/parameters" \
