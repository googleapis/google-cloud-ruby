...
describe "#delete_regional_param_version", :regional_parameter_manager_snippet do
  before do
  ...
  it "delete a regional parameter version" do
    sample = SampleLoader.load "delete_regional_param_version.rb"

    out, _err = capture_io do
      sample.run project_id: project_id, location_id: location_id, parameter_id: parameter_id, version_id: version_id
    end

    assert_equal "Deleted regional parameter version projects/#{project_id}/locations/#{location_id}/" \
