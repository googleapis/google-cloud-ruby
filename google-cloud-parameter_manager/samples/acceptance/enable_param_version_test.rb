...
describe "#enable_param_version", :parameter_manager_snippet do
  before do
  ...
  it "enable a parameter versions" do
    sample = SampleLoader.load "enable_param_version.rb"

    out, _err = capture_io do
      sample.run project_id: project_id, parameter_id: parameter_id, version_id: version_id
    end

    assert_equal "Enabled parameter version #{version_id} for parameter #{parameter_id}\n", out
  end
end
