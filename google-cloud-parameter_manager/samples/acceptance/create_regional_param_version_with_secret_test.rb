...
describe "#create_regional_param_version_with_secret", :regional_parameter_manager_snippet do
  before do
    client.create_parameter parent: location_name, parameter_id: parameter_id
  end

  it "creates a regional parameter version with secret" do
    sample = SampleLoader.load "create_regional_param_version_with_secret.rb"
