...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-parameter_manager/latest)
for this library, google-cloud-parameter_manager, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-parameter_manager-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-parameter_manager-v1/latest).
...
```
$ gem install google-cloud-parameter_manager
```
