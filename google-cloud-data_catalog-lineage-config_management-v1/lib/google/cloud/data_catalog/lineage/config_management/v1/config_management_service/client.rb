          ...
          module V1
            module ConfigManagementService
              ...
              class Client
                ...
                #
                # See {::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Client::Configuration}
                ...
                def initialize
                  ...
                  require "gapic/grpc"
                  require "google/cloud/datacatalog/lineage/configmanagement/v1/configmanagement_services_pb"
                  ...
                  @config_management_service_stub = ::Gapic::ServiceStub.new(
                    ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Stub,
                  ...
                  @config_management_service_stub.stub_logger&.info do |entry|
                ...
                # @yieldparam response [::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::Config]
                ...
                def get_config request, options = nil
                  ...
                  @config_management_service_stub.call_rpc :get_config, request, options: options do |response, operation|
                ...
                def update_config request, options = nil
                  ...
                  @config_management_service_stub.call_rpc :update_config, request, options: options do |response, operation|
                    yield response, operation if block_given?
                  end
                rescue ::GRPC::BadStatus => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                ##
                # Configuration class for the ConfigManagementService API.
                #
                # This class represents the configuration for ConfigManagementService,
                # providing control over timeouts, retry behavior, logging, transport
                # parameters, and other low-level controls. Certain parameters can also be
                # applied individually to specific RPCs. See
                # {::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Client::Configuration::Rpcs}
