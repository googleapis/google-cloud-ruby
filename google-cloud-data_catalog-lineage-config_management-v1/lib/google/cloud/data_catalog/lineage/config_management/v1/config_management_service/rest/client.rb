...
require "google/cloud/data_catalog/lineage/config_management/v1/config_management_service/rest/service_stub"
            ...
            module ConfigManagementService
              module Rest
                ...
                class Client
                  ...
                  # @private
                  attr_reader :config_management_service_stub

                  ##
                  # Configure the ConfigManagementService Client class.
                  #
                  # See {::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Rest::Client::Configuration}
                  # for a description of the configuration fields.
                  #
                  # @example
                  #
                  #   # Modify the configuration for all ConfigManagementService clients
                  #   ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Rest::Client.configure do |config|
                  #     config.timeout = 10.0
                  #   end
                  #
                  ...
                  #
                  def universe_domain
                    @config_management_service_stub.universe_domain
                  end

                  ##
                  # Create a new ConfigManagementService REST client object.
                  #
                  # @example
                  #
                  ...
                  #   client = ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Rest::Client.new do |config|
                  #     config.timeout = 10.0
                  #   end
                  #
                  # @yield [config] Configure the ConfigManagementService client.
                  # @yieldparam config [Client::Configuration]
                  #
                  def initialize
                    ...
                    @config_management_service_stub = ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Rest::ServiceStub.new(
                    ...
                    @config_management_service_stub.logger(stub: true)&.info do |entry|
                  ...
                  #
                  def logger
                    @config_management_service_stub.logger
                  end
                  ...
                  #   {::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::GetConfigRequest} or an equivalent Hash.
                  #
                  #   @param request [::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::GetConfigRequest, ::Hash]
                  ...
                  def get_config request, options = nil
                    ...
                    request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::GetConfigRequest
                    ...
                    call_metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                      ...
                      gapic_version: ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::VERSION,
                    ...
                    @config_management_service_stub.get_config request, options do |result, operation|
                  ...
                  #   {::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::UpdateConfigRequest} or an equivalent Hash.
                  #
                  #   @param request [::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::UpdateConfigRequest, ::Hash]
                  #     A request object representing the call parameters. Required. To specify no
                  #     parameters, or to keep all the default parameter values, pass an empty Hash.
                  #   @param options [::Gapic::CallOptions, ::Hash]
                  #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                  #
                  # @overload update_config(config: nil)
                  #   Pass arguments to `update_config` via keyword arguments. Note that at
                  #   least one keyword argument is required. To specify no parameters, or to keep all
                  #   the default parameter values, pass an empty Hash as a request object (see above).
                  #
                  #   @param config [::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::Config, ::Hash]
                  ...
                  def update_config request, options = nil
                    ...
                    request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::UpdateConfigRequest
                    ...
                    @config_management_service_stub.update_config request, options do |result, operation|
                      yield result, operation if block_given?
                    end
                  rescue ::Gapic::Rest::Error => e
                    raise ::Google::Cloud::Error.from_error(e)
                  ...
                  ##
                  # Configuration class for the ConfigManagementService REST API.
                  #
                  # This class represents the configuration for ConfigManagementService REST,
                  # providing control over timeouts, retry behavior, logging, transport
                  # parameters, and other low-level controls. Certain parameters can also be
                  # applied individually to specific RPCs. See
                  # {::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Rest::Client::Configuration::Rpcs}
                  ...
                  #   # get_config to 20 seconds,
                  #   # and all remaining timeouts to 10 seconds.
                  #   ::Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Rest::Client.configure do |config|
                  #     config.timeout = 10.0
                  #     config.rpcs.get_config.timeout = 20.0
                  #   end
                  #
                  ...
                  class Configuration
                    ...
                    ##
                    # Configuration RPC class for the ConfigManagementService API.
                    #
