...
##
# Snippet for the get_config call in the ConfigManagementService service
#
...
# Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Client#get_config.
#
def get_config
