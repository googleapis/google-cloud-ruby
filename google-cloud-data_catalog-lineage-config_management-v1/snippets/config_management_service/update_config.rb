...
##
# Snippet for the update_config call in the ConfigManagementService service
#
...
# Google::Cloud::DataCatalog::Lineage::ConfigManagement::V1::ConfigManagementService::Client#update_config.
#
def update_config
