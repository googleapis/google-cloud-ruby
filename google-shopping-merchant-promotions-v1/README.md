...
```
$ gem install google-shopping-merchant-promotions-v1
```
...
request = ::Google::Shopping::Merchant::Promotions::V1::InsertPromotionRequest.new # (request fields as keyword arguments...)
response = client.insert_promotion request
```

View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-promotions-v1)
...
is part of the name, e.g. `google-shopping-merchant-promotions-v1`.
