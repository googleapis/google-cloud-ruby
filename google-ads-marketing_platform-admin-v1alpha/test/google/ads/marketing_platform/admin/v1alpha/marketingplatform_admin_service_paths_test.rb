...
class ::Google::Ads::MarketingPlatform::Admin::V1alpha::MarketingplatformAdminService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_analytics_account_link_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.analytics_account_link_path organization: "value0", analytics_account_link: "value1"
      assert_equal "organizations/value0/analyticsAccountLinks/value1", path
    end
  end
