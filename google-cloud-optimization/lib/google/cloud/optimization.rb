...
require "google/cloud/optimization/version"
...
::Google::Cloud.configure.add_config! :optimization do |config|
...
module Google
  module Cloud
    module Optimization
      ...
      # given API version does not support the given transport of the FleetRouting service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::Optimization.fleet_routing_available?}.
      #
      # ## About FleetRouting
      #
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::Optimization.fleet_routing}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the FleetRouting service,
      # or if the versioned client gem needs an update to support the FleetRouting service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
      ...
      #
      def self.fleet_routing_available? version: :v1, transport: :grpc
        require "google/cloud/optimization/#{version.to_s.downcase}"
        package_name = Google::Cloud::Optimization
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::Optimization.const_get package_name
        return false unless service_module.const_defined? :FleetRouting
        service_module = service_module.const_get :FleetRouting
        if transport == :rest
