...
class ::Google::Cloud::BackupDR::V1::BackupDrProtectionSummary::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_resource_backup_configs
    # Create test objects.
    client_result = ::Google::Cloud::BackupDR::V1::ListResourceBackupConfigsResponse.new
    ...
    list_resource_backup_configs_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::BackupDR::V1::BackupDrProtectionSummary::Rest::ServiceStub.stub :transcode_list_resource_backup_configs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_resource_backup_configs_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_resource_backup_configs_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::BackupDR::V1::BackupDrProtectionSummary::Rest::Client::Configuration, config
  end
end
