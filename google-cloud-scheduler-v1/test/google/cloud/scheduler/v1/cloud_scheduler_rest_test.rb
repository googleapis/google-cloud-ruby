  ...
  def test_list_jobs
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_list_jobs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_jobs_client_stub do
        # Create client
        c = ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::Client.new do |config|
          config.credentials = :dummy_value
        end

        # Use hash object
        c.list_jobs({ parent: parent, page_size: page_size, page_token: page_token }) do |_result, response|
        ...
        # Use protobuf object
        c.list_jobs ::Google::Cloud::Scheduler::V1::ListJobsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.list_jobs({ parent: parent, page_size: page_size, page_token: page_token }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.list_jobs(::Google::Cloud::Scheduler::V1::ListJobsRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_job
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_get_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_job_client_stub do
        ...
        # Use protobuf object
        c.get_job ::Google::Cloud::Scheduler::V1::GetJobRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_job(::Google::Cloud::Scheduler::V1::GetJobRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_job
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_create_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_job_client_stub do
        ...
        # Use protobuf object
        c.create_job ::Google::Cloud::Scheduler::V1::CreateJobRequest.new(parent: parent, job: job) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.create_job(::Google::Cloud::Scheduler::V1::CreateJobRequest.new(parent: parent, job: job), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_job
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_update_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_job_client_stub do
        ...
        # Use protobuf object
        c.update_job ::Google::Cloud::Scheduler::V1::UpdateJobRequest.new(job: job, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_job(::Google::Cloud::Scheduler::V1::UpdateJobRequest.new(job: job, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_job
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_delete_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_job_client_stub do
        ...
        # Use protobuf object
        c.delete_job ::Google::Cloud::Scheduler::V1::DeleteJobRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_job(::Google::Cloud::Scheduler::V1::DeleteJobRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_pause_job
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_pause_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, pause_job_client_stub do
        ...
        # Use protobuf object
        c.pause_job ::Google::Cloud::Scheduler::V1::PauseJobRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.pause_job(::Google::Cloud::Scheduler::V1::PauseJobRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_resume_job
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_resume_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, resume_job_client_stub do
        ...
        # Use protobuf object
        c.resume_job ::Google::Cloud::Scheduler::V1::ResumeJobRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.resume_job(::Google::Cloud::Scheduler::V1::ResumeJobRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_run_job
    ...
    ::Google::Cloud::Scheduler::V1::CloudScheduler::Rest::ServiceStub.stub :transcode_run_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, run_job_client_stub do
        ...
        # Use hash object
        c.run_job({ name: name }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.run_job ::Google::Cloud::Scheduler::V1::RunJobRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.run_job({ name: name }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.run_job(::Google::Cloud::Scheduler::V1::RunJobRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
