...
##
# Snippet for the get_service_level_objective call in the ServiceMonitoringService service
#
...
# Google::Cloud::Monitoring::V3::ServiceMonitoringService::Client#get_service_level_objective.
#
