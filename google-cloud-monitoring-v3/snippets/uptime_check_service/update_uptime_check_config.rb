...
##
# Snippet for the update_uptime_check_config call in the UptimeCheckService service
#
...
# Google::Cloud::Monitoring::V3::UptimeCheckService::Client#update_uptime_check_config.
#
