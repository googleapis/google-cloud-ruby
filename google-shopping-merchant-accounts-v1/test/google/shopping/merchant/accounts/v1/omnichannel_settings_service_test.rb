...
class ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSettingsService::ClientTest < Minitest::Test
  ...
  def test_get_omnichannel_setting
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSetting.new
    ...
    get_omnichannel_setting_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::GetOmnichannelSettingRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_omnichannel_setting_client_stub do
      # Create client
      c = ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSettingsService::Client.new do |config|
      ...
      # Use protobuf object
      c.get_omnichannel_setting ::Google::Shopping::Merchant::Accounts::V1::GetOmnichannelSettingRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.get_omnichannel_setting(::Google::Shopping::Merchant::Accounts::V1::GetOmnichannelSettingRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_omnichannel_settings
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_omnichannel_settings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_omnichannel_settings_client_stub do
      ...
      # Use protobuf object
      c.list_omnichannel_settings ::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_omnichannel_settings(::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_omnichannel_setting
    ...
    create_omnichannel_setting_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::CreateOmnichannelSettingRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSetting), request["omnichannel_setting"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_omnichannel_setting_client_stub do
      ...
      # Use protobuf object
      c.create_omnichannel_setting ::Google::Shopping::Merchant::Accounts::V1::CreateOmnichannelSettingRequest.new(parent: parent, omnichannel_setting: omnichannel_setting) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_omnichannel_setting(::Google::Shopping::Merchant::Accounts::V1::CreateOmnichannelSettingRequest.new(parent: parent, omnichannel_setting: omnichannel_setting), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_omnichannel_setting
    ...
    update_omnichannel_setting_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::UpdateOmnichannelSettingRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSetting), request["omnichannel_setting"]
    ...
    Gapic::ServiceStub.stub :new, update_omnichannel_setting_client_stub do
      ...
      # Use protobuf object
      c.update_omnichannel_setting ::Google::Shopping::Merchant::Accounts::V1::UpdateOmnichannelSettingRequest.new(omnichannel_setting: omnichannel_setting, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_omnichannel_setting(::Google::Shopping::Merchant::Accounts::V1::UpdateOmnichannelSettingRequest.new(omnichannel_setting: omnichannel_setting, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_request_inventory_verification
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::RequestInventoryVerificationResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    request_inventory_verification_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::RequestInventoryVerificationRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, request_inventory_verification_client_stub do
      ...
      # Use protobuf object
      c.request_inventory_verification ::Google::Shopping::Merchant::Accounts::V1::RequestInventoryVerificationRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.request_inventory_verification(::Google::Shopping::Merchant::Accounts::V1::RequestInventoryVerificationRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSettingsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSettingsService::Client, client
