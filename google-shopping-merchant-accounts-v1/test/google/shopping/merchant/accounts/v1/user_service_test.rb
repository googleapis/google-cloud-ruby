...
class ::Google::Shopping::Merchant::Accounts::V1::UserService::ClientTest < Minitest::Test
  ...
  def test_get_user
    ...
    Gapic::ServiceStub.stub :new, get_user_client_stub do
      # Create client
      c = ::Google::Shopping::Merchant::Accounts::V1::UserService::Client.new do |config|
      ...
      # Use protobuf object
      c.get_user ::Google::Shopping::Merchant::Accounts::V1::GetUserRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.get_user(::Google::Shopping::Merchant::Accounts::V1::GetUserRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_user
    ...
    Gapic::ServiceStub.stub :new, create_user_client_stub do
      ...
      # Use hash object
      c.create_user({ parent: parent, user_id: user_id, user: user }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.create_user ::Google::Shopping::Merchant::Accounts::V1::CreateUserRequest.new(parent: parent, user_id: user_id, user: user) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.create_user({ parent: parent, user_id: user_id, user: user }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.create_user(::Google::Shopping::Merchant::Accounts::V1::CreateUserRequest.new(parent: parent, user_id: user_id, user: user), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_user
    ...
    Gapic::ServiceStub.stub :new, delete_user_client_stub do
      ...
      # Use protobuf object
      c.delete_user ::Google::Shopping::Merchant::Accounts::V1::DeleteUserRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_user(::Google::Shopping::Merchant::Accounts::V1::DeleteUserRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_user
    ...
    Gapic::ServiceStub.stub :new, update_user_client_stub do
      ...
      # Use protobuf object
      c.update_user ::Google::Shopping::Merchant::Accounts::V1::UpdateUserRequest.new(user: user, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_user(::Google::Shopping::Merchant::Accounts::V1::UpdateUserRequest.new(user: user, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_users
    ...
    Gapic::ServiceStub.stub :new, list_users_client_stub do
      ...
      # Use hash object
      c.list_users({ parent: parent, page_size: page_size, page_token: page_token }) do |response, operation|
      ...
      # Use protobuf object
      c.list_users ::Google::Shopping::Merchant::Accounts::V1::ListUsersRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      c.list_users({ parent: parent, page_size: page_size, page_token: page_token }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_users(::Google::Shopping::Merchant::Accounts::V1::ListUsersRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_verify_self
    ...
    Gapic::ServiceStub.stub :new, verify_self_client_stub do
      ...
      # Use hash object
      c.verify_self({ account: account }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.verify_self ::Google::Shopping::Merchant::Accounts::V1::VerifySelfRequest.new(account: account) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.verify_self({ account: account }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.verify_self(::Google::Shopping::Merchant::Accounts::V1::VerifySelfRequest.new(account: account), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
