...
class ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovementsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_automatic_improvements
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovements.new
    ...
    get_automatic_improvements_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::GetAutomaticImprovementsRequest, request
  ...
  def test_update_automatic_improvements
    ...
    update_automatic_improvements_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::UpdateAutomaticImprovementsRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovements), request["automatic_improvements"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovementsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovementsService::Client, client
