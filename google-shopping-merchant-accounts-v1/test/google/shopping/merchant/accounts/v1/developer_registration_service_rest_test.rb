...
class ::Google::Shopping::Merchant::Accounts::V1::DeveloperRegistrationService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_register_gcp
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1::DeveloperRegistration.new
    ...
    register_gcp_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Merchant::Accounts::V1::DeveloperRegistrationService::Rest::ServiceStub.stub :transcode_register_gcp_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, register_gcp_client_stub do
        ...
        # Verify method calls
        assert_equal 5, register_gcp_client_stub.call_count
      end
    end
  end
  ...
  def test_get_developer_registration
    ...
    get_developer_registration_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Accounts::V1::DeveloperRegistrationService::Rest::ServiceStub.stub :transcode_get_developer_registration_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_developer_registration_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_developer_registration_client_stub.call_count
      end
    end
  end
  ...
  def test_unregister_gcp
    ...
    unregister_gcp_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_get_account_for_gcp_registration
    ...
    ::Google::Shopping::Merchant::Accounts::V1::DeveloperRegistrationService::Rest::ServiceStub.stub :transcode_get_account_for_gcp_registration_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_account_for_gcp_registration_client_stub do
        ...
        # Use hash object
        client.get_account_for_gcp_registration({  }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object
        client.get_account_for_gcp_registration ::Google::Protobuf::Empty.new() do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        client.get_account_for_gcp_registration({  }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        client.get_account_for_gcp_registration(::Google::Protobuf::Empty.new(), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::DeveloperRegistrationService::Rest::Client::Configuration, config
  end
end
