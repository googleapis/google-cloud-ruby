...
class ::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicyService::ClientTest < Minitest::Test
  ...
  def test_get_online_return_policy
    ...
    Gapic::ServiceStub.stub :new, get_online_return_policy_client_stub do
      ...
      # Use protobuf object
      client.get_online_return_policy ::Google::Shopping::Merchant::Accounts::V1::GetOnlineReturnPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.get_online_return_policy(::Google::Shopping::Merchant::Accounts::V1::GetOnlineReturnPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_online_return_policies
    ...
    Gapic::ServiceStub.stub :new, list_online_return_policies_client_stub do
      ...
      # Use protobuf object
      client.list_online_return_policies ::Google::Shopping::Merchant::Accounts::V1::ListOnlineReturnPoliciesRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_online_return_policies(::Google::Shopping::Merchant::Accounts::V1::ListOnlineReturnPoliciesRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_online_return_policy
    ...
    Gapic::ServiceStub.stub :new, create_online_return_policy_client_stub do
      ...
      # Use protobuf object
      client.create_online_return_policy ::Google::Shopping::Merchant::Accounts::V1::CreateOnlineReturnPolicyRequest.new(parent: parent, online_return_policy: online_return_policy) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_online_return_policy(::Google::Shopping::Merchant::Accounts::V1::CreateOnlineReturnPolicyRequest.new(parent: parent, online_return_policy: online_return_policy), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_online_return_policy
    ...
    Gapic::ServiceStub.stub :new, delete_online_return_policy_client_stub do
      ...
      # Use protobuf object
      client.delete_online_return_policy ::Google::Shopping::Merchant::Accounts::V1::DeleteOnlineReturnPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_online_return_policy(::Google::Shopping::Merchant::Accounts::V1::DeleteOnlineReturnPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
