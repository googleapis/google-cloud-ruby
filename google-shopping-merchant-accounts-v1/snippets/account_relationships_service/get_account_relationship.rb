...
# [START merchantapi_v1_generated_AccountRelationshipsService_GetAccountRelationship_sync]
require "google/shopping/merchant/accounts/v1"

##
# Snippet for the get_account_relationship call in the AccountRelationshipsService service
#
...
# Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Client#get_account_relationship.
#
def get_account_relationship
  # Create a client object. The client can be reused for multiple calls.
  client = Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Client.new
