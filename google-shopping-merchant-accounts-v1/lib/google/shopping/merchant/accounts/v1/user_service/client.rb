        ...
        module V1
          module UserService
            ...
            class Client
              ...
              #
              # See {::Google::Shopping::Merchant::Accounts::V1::UserService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all UserService clients
              #   ::Google::Shopping::Merchant::Accounts::V1::UserService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/shopping/merchant/accounts/v1/user_services_pb"
                ...
                @user_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Shopping::Merchant::Accounts::V1::UserService::Stub,
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::User>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::User>]
              #
              # @raise [::Google::Cloud::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              # {::Google::Shopping::Merchant::Accounts::V1::UserService::Client::Configuration::Rpcs}
