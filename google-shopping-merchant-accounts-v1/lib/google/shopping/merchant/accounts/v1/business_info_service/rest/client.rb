...
require "google/shopping/merchant/accounts/v1/business_info_service/rest/service_stub"
      ...
      module Accounts
        module V1
          module BusinessInfoService
            module Rest
              ##
              # REST client for the BusinessInfoService service.
              #
              ...
              class Client
                ...
                #
                # See {::Google::Shopping::Merchant::Accounts::V1::BusinessInfoService::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all BusinessInfoService clients
                #   ::Google::Shopping::Merchant::Accounts::V1::BusinessInfoService::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                ##
                # Create a new BusinessInfoService REST client object.
                #
                # @example
                #
                #   # Create a client using the default configuration
                #   client = ::Google::Shopping::Merchant::Accounts::V1::BusinessInfoService::Rest::Client.new
                #
                ...
                def initialize
                  ...
                  @business_info_service_stub = ::Google::Shopping::Merchant::Accounts::V1::BusinessInfoService::Rest::ServiceStub.new(
                ...
                # @yieldparam result [::Google::Shopping::Merchant::Accounts::V1::BusinessInfo]
                ...
                def get_business_info request, options = nil
                  ...
                  call_metadata = @config.rpcs.get_business_info.metadata.to_h
                ...
                def update_business_info request, options = nil
                  ...
                  # Customize the options with defaults
                  call_metadata = @config.rpcs.update_business_info.metadata.to_h
                ...
                ##
                # Configuration class for the BusinessInfoService REST API.
                #
                # This class represents the configuration for BusinessInfoService REST,
                # providing control over timeouts, retry behavior, logging, transport
                # parameters, and other low-level controls. Certain parameters can also be
                # applied individually to specific RPCs. See
                # {::Google::Shopping::Merchant::Accounts::V1::BusinessInfoService::Rest::Client::Configuration::Rpcs}
