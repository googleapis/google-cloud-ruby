...
require "google/shopping/merchant/accounts/v1/gbp_accounts_service/rest/service_stub"
          ...
          module GbpAccountsService
            module Rest
              ...
              class Client
                ...
                #
                # See {::Google::Shopping::Merchant::Accounts::V1::GbpAccountsService::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all GbpAccountsService clients
                #   ::Google::Shopping::Merchant::Accounts::V1::GbpAccountsService::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                #   client = ::Google::Shopping::Merchant::Accounts::V1::GbpAccountsService::Rest::Client.new do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                def initialize
                  ...
                  @gbp_accounts_service_stub = ::Google::Shopping::Merchant::Accounts::V1::GbpAccountsService::Rest::ServiceStub.new(
                ...
                #   {::Google::Shopping::Merchant::Accounts::V1::ListGbpAccountsRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::Accounts::V1::ListGbpAccountsRequest, ::Hash]
                ...
                # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::GbpAccount>]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Gapic::Rest::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::GbpAccount>]
                #
                ...
                #   request = Google::Shopping::Merchant::Accounts::V1::ListGbpAccountsRequest.new
                #
                ...
                #   result.each do |item|
                #     # Each element is of type ::Google::Shopping::Merchant::Accounts::V1::GbpAccount.
                #     p item
                #   end
                #
                def list_gbp_accounts request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1::ListGbpAccountsRequest
                ...
                #   {::Google::Shopping::Merchant::Accounts::V1::LinkGbpAccountRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::Accounts::V1::LinkGbpAccountRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::Accounts::V1::LinkGbpAccountResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Shopping::Merchant::Accounts::V1::LinkGbpAccountResponse]
                #
                # @raise [::Google::Cloud::Error] if the REST call is aborted.
                #
                # @example Basic example
                ...
                #
                #   # Create a request. To set request fields, pass in keyword arguments.
                #   request = Google::Shopping::Merchant::Accounts::V1::LinkGbpAccountRequest.new
                #
                #   # Call the link_gbp_account method.
                #   result = client.link_gbp_account request
                #
                #   # The returned object is of type Google::Shopping::Merchant::Accounts::V1::LinkGbpAccountResponse.
                #   p result
                #
                def link_gbp_account request, options = nil
                  raise ::ArgumentError, "request must be provided" if request.nil?

                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1::LinkGbpAccountRequest
                ...
                # {::Google::Shopping::Merchant::Accounts::V1::GbpAccountsService::Rest::Client::Configuration::Rpcs}
