          ...
          module AccountsService
            module Rest
              ...
              class ServiceStub
                ...
                ##
                # Baseline implementation for the create_test_account REST call
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::CreateTestAccountRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @return [::Google::Shopping::Merchant::Accounts::V1::Account]
                #   A result object deserialized from the server's reply
                def create_test_account request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_create_test_account_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "create_test_account",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Shopping::Merchant::Accounts::V1::Account.decode_json response.body, ignore_unknown_fields: true
                ...
                # @private
                #
                # GRPC transcoding helper method for the create_test_account REST call
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::CreateTestAccountRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_create_test_account_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/accounts/v1/{parent}:createTestAccount",
                                                            body: "account",
                                                            matches: [
