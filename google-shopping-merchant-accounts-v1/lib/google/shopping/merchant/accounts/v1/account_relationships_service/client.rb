      ...
      module Accounts
        module V1
          module AccountRelationshipsService
            ##
            # Client for the AccountRelationshipsService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all AccountRelationshipsService clients
              #   ::Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new AccountRelationshipsService client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/shopping/merchant/accounts/v1/accountrelationships_services_pb"
                ...
                @account_relationships_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Stub,
                ...
                @account_relationships_service_stub.stub_logger&.info do |entry|
              ...
              # @yieldparam response [::Google::Shopping::Merchant::Accounts::V1::AccountRelationship]
              ...
              def get_account_relationship request, options = nil
                ...
                metadata = @config.rpcs.get_account_relationship.metadata.to_h
                ...
                @account_relationships_service_stub.call_rpc :get_account_relationship, request, options: options do |response, operation|
              ...
              def update_account_relationship request, options = nil
                ...
                # Customize the options with defaults
                metadata = @config.rpcs.update_account_relationship.metadata.to_h
                ...
                header_params = {}
                if request.account_relationship&.name
                  header_params["account_relationship.name"] = request.account_relationship.name
                end
                ...
                @account_relationships_service_stub.call_rpc :update_account_relationship, request, options: options do |response, operation|
                  yield response, operation if block_given?
                end
              rescue ::GRPC::BadStatus => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::AccountRelationship>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::AccountRelationship>]
              #
              # @raise [::Google::Cloud::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              def list_account_relationships request, options = nil
                ...
                # Customize the options with defaults
                metadata = @config.rpcs.list_account_relationships.metadata.to_h
                ...
                @account_relationships_service_stub.call_rpc :list_account_relationships, request, options: options do |response, operation|
                  response = ::Gapic::PagedEnumerable.new @account_relationships_service_stub, :list_account_relationships, request, response, operation, options
                  yield response, operation if block_given?
              ...
              ##
              # Configuration class for the AccountRelationshipsService API.
              #
              # This class represents the configuration for AccountRelationshipsService,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Client::Configuration::Rpcs}
