...
# Source: google/shopping/merchant/accounts/v1/user.proto for package 'Google.Shopping.Merchant.Accounts.V1'
        ...
        module V1
          module UserService
            ...
            class Service
              ...
              self.service_name = 'google.shopping.merchant.accounts.v1.UserService'

              # Retrieves a Merchant Center account user.
              rpc :GetUser, ::Google::Shopping::Merchant::Accounts::V1::GetUserRequest, ::Google::Shopping::Merchant::Accounts::V1::User
              # Creates a Merchant Center account user. Executing this method requires
              # admin access.
              rpc :CreateUser, ::Google::Shopping::Merchant::Accounts::V1::CreateUserRequest, ::Google::Shopping::Merchant::Accounts::V1::User
