...
class ::Google::Cloud::Memcache::V1beta2::CloudMemcache::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_instances
    # Create test objects.
    client_result = ::Google::Cloud::Memcache::V1beta2::ListInstancesResponse.new
  ...
  def test_get_instance
    # Create test objects.
    client_result = ::Google::Cloud::Memcache::V1beta2::Instance.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_apply_software_update
    ...
    apply_software_update_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Memcache::V1beta2::CloudMemcache::Rest::ServiceStub.stub :transcode_apply_software_update_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, apply_software_update_client_stub do
        ...
        # Verify method calls
        assert_equal 5, apply_software_update_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Memcache::V1beta2::CloudMemcache::Rest::Client::Configuration, config
  end
end
