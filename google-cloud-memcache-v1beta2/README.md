# Ruby Client for the Cloud Memorystore for Memcached V1BETA2 API
...
specific version of the Cloud Memorystore for Memcached V1BETA2 API. Most users should consider using
the main client gem,
