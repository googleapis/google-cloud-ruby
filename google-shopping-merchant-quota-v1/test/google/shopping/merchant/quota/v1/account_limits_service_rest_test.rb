...
class ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_account_limit
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Quota::V1::AccountLimit.new
    ...
    get_account_limit_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::Rest::ServiceStub.stub :transcode_get_account_limit_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_account_limit_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_account_limit_client_stub.call_count
      end
    end
  end

  def test_list_account_limits
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Quota::V1::ListAccountLimitsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_account_limits_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::Rest::ServiceStub.stub :transcode_list_account_limits_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_account_limits_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_account_limits_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::Rest::Client::Configuration, config
  end
end
