...
class ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_account_limit
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Quota::V1::AccountLimit.new
    ...
    get_account_limit_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_account_limit, name
      assert_kind_of ::Google::Shopping::Merchant::Quota::V1::GetAccountLimitRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_account_limit_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_account_limit_client_stub.call_rpc_count
    end
  end

  def test_list_account_limits
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Quota::V1::ListAccountLimitsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_account_limits_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_account_limits, name
      assert_kind_of ::Google::Shopping::Merchant::Quota::V1::ListAccountLimitsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_account_limits_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_account_limits_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::Client, client
