  ...
  module Shopping
    module Merchant
      module IssueResolution
        ...
        #
        # By default, this returns an instance of
        # [Google::Shopping::Merchant::IssueResolution::V1beta::IssueResolutionService::Client](https://rubydoc.info/gems/google-shopping-merchant-issue_resolution-v1beta/Google/Shopping/Merchant/IssueResolution/V1beta/IssueResolutionService/Client)
        # for a gRPC client for version V1beta of the API.
        # However, you can specify a different API version by passing it in the
        ...
        #
        # Raises an exception if the currently installed versioned client gem for the
        # given API version does not support the given transport of the IssueResolutionService service.
        # You can determine whether the method will succeed by calling
        # {Google::Shopping::Merchant::IssueResolution.issue_resolution_service_available?}.
        #
        ...
        # @return [::Object] A client object for the specified version.
        #
        def self.issue_resolution_service version: :v1beta, transport: :grpc, &block
          require "google/shopping/merchant/issue_resolution/#{version.to_s.downcase}"
          ...
          package_name = Google::Shopping::Merchant::IssueResolution
                         ...
                         .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
                         .first
          service_module = Google::Shopping::Merchant::IssueResolution.const_get(package_name).const_get(:IssueResolutionService)
          service_module = service_module.const_get(:Rest) if transport == :rest
          service_module.const_get(:Client).new(&block)
        end
        ...
        # If true, you can retrieve a client object by calling {Google::Shopping::Merchant::IssueResolution.issue_resolution_service}.
        # If false, that method will raise an exception. This could happen if the given
        # API version does not exist or does not support the IssueResolutionService service,
        # or if the versioned client gem needs an update to support the IssueResolutionService service.
        #
        # @param version [::String, ::Symbol] The API version to connect to. Optional.
        #   Defaults to `:v1beta`.
        # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
        # @return [boolean] Whether the service is available.
        #
        def self.issue_resolution_service_available? version: :v1beta, transport: :grpc
          require "google/shopping/merchant/issue_resolution/#{version.to_s.downcase}"
          package_name = Google::Shopping::Merchant::IssueResolution
                         .constants
                         .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
          ...
          return false unless package_name
          service_module = Google::Shopping::Merchant::IssueResolution.const_get package_name
          return false unless service_module.const_defined? :IssueResolutionService
          service_module = service_module.const_get :IssueResolutionService
          if transport == :rest
            return false unless service_module.const_defined? :Rest
            service_module = service_module.const_get :Rest
          end
...
helper_path = ::File.join __dir__, "issue_resolution", "helpers.rb"
require "google/shopping/merchant/issue_resolution/helpers" if ::File.file? helper_path
