...
require File.expand_path("lib/google/shopping/merchant/issue_resolution/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-issue_resolution"
  gem.version       = Google::Shopping::Merchant::IssueResolution::VERSION
  ...
  gem.add_dependency "google-shopping-merchant-issue_resolution-v1beta", ">= 0.0", "< 2.a"
end
