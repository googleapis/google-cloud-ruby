          ...
          module SubscriptionsService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Apps::Events::Subscriptions::V1beta::CreateSubscriptionRequest]
                ...
                #
                # @param request_pb [::Google::Apps::Events::Subscriptions::V1beta::DeleteSubscriptionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Apps::Events::Subscriptions::V1beta::GetSubscriptionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def get_subscription request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Apps::Events::Subscriptions::V1beta::Subscription.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                #
                # @param request_pb [::Google::Apps::Events::Subscriptions::V1beta::ListSubscriptionsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Apps::Events::Subscriptions::V1beta::ListSubscriptionsResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Apps::Events::Subscriptions::V1beta::ListSubscriptionsResponse]
                #   A result object deserialized from the server's reply
                def list_subscriptions request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Apps::Events::Subscriptions::V1beta::ListSubscriptionsResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                #
                # @param request_pb [::Google::Apps::Events::Subscriptions::V1beta::UpdateSubscriptionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Apps::Events::Subscriptions::V1beta::ReactivateSubscriptionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def self.transcode_create_subscription_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/v1beta/subscriptions",
                                                            body: "subscription",
                                                            matches: []
                                                          )
                ...
                def self.transcode_update_subscription_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :patch,
                                                            uri_template: "/v1beta/{subscription.name}",
                                                            body: "subscription",
                                                            matches: [
                ...
                def self.transcode_reactivate_subscription_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/v1beta/{name}:reactivate",
                                                            body: "*",
                                                            matches: [
                                                              ["name", %r{^subscriptions/[^/]+/?$}, false]
                                                            ]
