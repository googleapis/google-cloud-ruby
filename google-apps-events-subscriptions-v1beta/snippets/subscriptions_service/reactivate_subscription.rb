...
##
# Snippet for the reactivate_subscription call in the SubscriptionsService service
#
...
# Google::Apps::Events::Subscriptions::V1beta::SubscriptionsService::Client#reactivate_subscription.
#
