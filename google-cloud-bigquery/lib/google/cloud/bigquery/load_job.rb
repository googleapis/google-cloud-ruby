  ...
  module Cloud
    module Bigquery
      ...
      class LoadJob < Job
        ...
        # types.
        #
        # @return [Array<String>, nil] The array of null marker strings.
        def null_markers
        ...
        # names in the schema.
        #
        # @return [String, nil] The source column match strategy, such as "POSITION".
        ...
        class Updater < LoadJob
          ...
          # values.
          #
          # @param [String] val The date format pattern, such as "%Y-%m-%d".
          def date_format= val
            @gapi.configuration.load.date_format = val
          end
          ...
          # values.
          #
          # @param [String] val The datetime format pattern, such as "%Y-%m-%d %H:%M:%S".
          def datetime_format= val
            @gapi.configuration.load.datetime_format = val
          end
          ...
          # values.
          #
          # @param [String] val The time format pattern, such as "%H:%M:%S".
          def time_format= val
            @gapi.configuration.load.time_format = val
          end
          ...
          # values.
          #
          # @param [String] val The timestamp format pattern, such as "%Y-%m-%d %H:%M:%S.%f %z".
          def timestamp_format= val
            @gapi.configuration.load.timestamp_format = val
          end
          ...
          # types.
          #
          # @param [Array<String>] val The array of null marker strings.
          def null_markers= val
            @gapi.configuration.load.null_markers = val
          end

          ##
          # Sets the strategy used to match loaded columns to the schema. If
          # not set, a sensible default is chosen based on how the schema is provided. If
          # autodetect is used, then columns are matched by name. Otherwise, columns are
          # matched by position. This is done to keep the behavior backward-compatible.
          # Acceptable values are: POSITION - matches by position. This assumes that the
          ...
          # names in the schema.
          #
          # @param [String] val The source column match strategy, such as "BY_NAME".
          def source_column_match= val
            @gapi.configuration.load.source_column_match = val
          end
          ...
          # is a IANA timezone string (e.g. America/Los_Angeles).
          #
          # @param [String] val The IANA time zone name, such as "America/Los_Angeles".
          def time_zone= val
            @gapi.configuration.load.time_zone = val
          end
