    ...
    module Bigquery
      ...
      class LoadJob < Job
        ...
        class Updater < LoadJob
          ...
          # `PARQUET`, `ORC`.
          #
          # @param [String, nil] reference_file_schema_uri The URI of the reference file, or `nil` to unset.
          def reference_file_schema_uri= reference_file_schema_uri
            @gapi.configuration.load.update! reference_file_schema_uri: reference_file_schema_uri
          end
