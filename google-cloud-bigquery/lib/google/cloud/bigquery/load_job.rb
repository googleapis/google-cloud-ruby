    ...
    module Bigquery
      ...
      class LoadJob < Job
        ...
        class Updater < LoadJob
          ...
          #   `%Y-%m-%d`. `nil` to unset.
          def date_format= val
            @gapi.configuration.load.update! date_format: val
          end
          ...
          def datetime_format= val
            @gapi.configuration.load.update! datetime_format: val
          end
          ...
          #   `%H:%M:%S`. `nil` to unset.
          def time_format= val
            @gapi.configuration.load.update! time_format: val
          end
          ...
          def timestamp_format= val
            @gapi.configuration.load.update! timestamp_format: val
          end
          ...
          def null_markers= val
            @gapi.configuration.load.update! null_markers: val
          end
          ...
          def source_column_match= val
            @gapi.configuration.load.update! source_column_match: val
          end
          ...
          def time_zone= val
            @gapi.configuration.load.update! time_zone: val
          end
