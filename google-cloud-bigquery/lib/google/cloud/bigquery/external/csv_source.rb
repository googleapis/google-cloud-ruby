    ...
    module Bigquery
      module External
        ...
        class CsvSource < External::DataSource
          ...
          # By default, ASCII control characters are not preserved.
          #
          # @param [Boolean, nil] preserve_ascii_control_characters whether or
          #   not ASCII control characters are preserved. `nil` to unset.
          #
          # @example
          #   require "google/cloud/bigquery"
          #
          ...
          #   csv_table.preserve_ascii_control_characters #=> true
          #
          def preserve_ascii_control_characters= preserve_ascii_control_characters
            frozen_check!
            @gapi.csv_options.preserve_ascii_control_characters = preserve_ascii_control_characters
          end
