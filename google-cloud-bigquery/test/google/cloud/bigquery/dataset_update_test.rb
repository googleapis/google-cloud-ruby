...
describe Google::Cloud::Bigquery::Dataset, :update, :mock_bigquery do
  ...
  it "updates its name" do
    ...
    mock.expect :patch_dataset, updated_gapi, [project, dataset_id, patch_dataset_gapi], options: {header: {"If-Match" => dataset_gapi.etag}}, access_policy_version: nil, update_mode: "UPDATE_METADATA"
  ...
  it "updates its description" do
    ...
    mock.expect :patch_dataset, updated_gapi, [project, dataset_id, patch_gapi], options: {header: {"If-Match" => dataset_gapi.etag}}, access_policy_version: nil, update_mode: "UPDATE_METADATA"
