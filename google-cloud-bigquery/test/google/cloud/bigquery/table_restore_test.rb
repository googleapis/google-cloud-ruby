...
describe Google::Cloud::Bigquery::Table, :copy, :mock_bigquery do
  ...
  it "can restore itself" do
    ...
    result = source_table.restore target_table
    mock.verify

    _(result).must_equal true
  end

  it "can restore to a table identified by a string" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.restore "target-project:target_dataset.target_table_id"
    mock.verify

    _(result).must_equal true
  end

  it "can restore to a table name string only" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.restore "new_target_table_id"
    mock.verify

    _(result).must_equal true
  end

  it "can restore itself with create disposition" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.restore target_table, create: "CREATE_NEVER"
    mock.verify

    _(result).must_equal true
  end

  it "can restore itself with create disposition symbol" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.restore target_table, create: :never
    mock.verify
  ...
  it "can restore itself with write disposition" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.restore target_table, write: "WRITE_TRUNCATE"
    mock.verify

    _(result).must_equal true
  end

  it "can restore itself with write disposition symbol" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.restore target_table, write: :truncate
    mock.verify
