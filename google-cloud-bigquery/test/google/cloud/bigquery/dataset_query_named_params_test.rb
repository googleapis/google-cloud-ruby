...
describe Google::Cloud::Bigquery::Dataset, :query, :named_params, :mock_bigquery do
  ...
  it "queries the data with a string parameter" do
    job_gapi = query_job_gapi "#{query} WHERE name = @name", parameter_mode: "NAMED", dataset: dataset_id
  ...
  it "queries the data with a numeric parameter" do
    job_gapi = query_job_gapi "#{query} WHERE pi = @pi", parameter_mode: "NAMED", dataset: dataset_id
    job_gapi.configuration.query.query_parameters = [
      Google::Apis::BigqueryV2::QueryParameter.new(
        name: "pi",
        parameter_type: Google::Apis::BigqueryV2::QueryParameterType.new(
  ...
  it "queries the data with a date parameter" do
    ...
    job_gapi = query_job_gapi "#{query} WHERE create_date = @day", parameter_mode: "NAMED", dataset: dataset_id
    job_gapi.configuration.query.query_parameters = [
      Google::Apis::BigqueryV2::QueryParameter.new(
        name: "day",
        parameter_type: Google::Apis::BigqueryV2::QueryParameterType.new(
  ...
  it "queries the data with a datetime parameter" do
    ...
    job_gapi = query_job_gapi "#{query} WHERE update_datetime < @when", parameter_mode: "NAMED", dataset: dataset_id
    job_gapi.configuration.query.query_parameters = [
      Google::Apis::BigqueryV2::QueryParameter.new(
        name: "when",
        parameter_type: Google::Apis::BigqueryV2::QueryParameterType.new(
  ...
  it "queries the data with a timestamp parameter" do
    ...
    job_gapi = query_job_gapi "#{query} WHERE update_timestamp < @when", parameter_mode: "NAMED", dataset: dataset_id
    job_gapi.configuration.query.query_parameters = [
      Google::Apis::BigqueryV2::QueryParameter.new(
        name: "when",
        parameter_type: Google::Apis::BigqueryV2::QueryParameterType.new(
  ...
  it "queries the data with a time parameter" do
    ...
    job_gapi = query_job_gapi "#{query} WHERE create_time = @time", parameter_mode: "NAMED", dataset: dataset_id
    job_gapi.configuration.query.query_parameters = [
      Google::Apis::BigqueryV2::QueryParameter.new(
        name: "time",
        parameter_type: Google::Apis::BigqueryV2::QueryParameterType.new(
  ...
  it "queries the data with a File parameter" do
    ...
    job_gapi = query_job_gapi "#{query} WHERE avatar = @file", parameter_mode: "NAMED", dataset: dataset_id
    job_gapi.configuration.query.query_parameters = [
      Google::Apis::BigqueryV2::QueryParameter.new(
        name: "file",
        parameter_type: Google::Apis::BigqueryV2::QueryParameterType.new(
  ...
  it "queries the data with many parameters" do
    ...
    job_gapi = query_job_gapi "#{query} WHERE name = @name" +
                                       ...
                                       " AND update_timestamp < @time", parameter_mode: "NAMED", dataset: dataset_id
