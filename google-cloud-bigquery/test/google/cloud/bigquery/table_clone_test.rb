...
describe Google::Cloud::Bigquery::Table, :copy, :mock_bigquery do
  ...
  it "can clone itself" do
    ...
    result = source_table.clone target_table
    mock.verify

    _(result).must_equal true
  end

  it "can clone to a table identified by a string" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.clone "target-project:target_dataset.target_table_id"
    mock.verify

    _(result).must_equal true
  end

  it "can clone to a table name string only" do
    mock = Minitest::Mock.new
    bigquery.service.mocked_service = mock
    ...
    result = source_table.clone "new_target_table_id"
    mock.verify
