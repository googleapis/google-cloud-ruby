...
describe Google::Cloud do
  describe "#bigquery" do
    it "calls out to Google::Cloud.bigquery" do
      ...
      stubbed_bigquery = ->(project, keyfile, scope: nil, retries: nil, timeout: nil, host: nil, logger: nil) {
        project.must_be :nil?
        keyfile.must_be :nil?
        scope.must_be :nil?
        retries.must_be :nil?
  ...
  describe ".bigquery" do
    ...
    it "uses provided project_id and keyfile" do
      ...
      stubbed_service = ->(project, credentials, retries: nil, timeout: nil, host: nil, logger: nil) {
        project.must_equal "project-id"
  ...
  describe "Bigquery.new" do
    ...
    it "uses provided stdlib logger" do
      require "logger"
      ...
      ENV.stub :[], nil do
        Google::Cloud.stub :env, OpenStruct.new(project_id: "project-id") do
          Google::Cloud::Bigquery::Service.stub :new, stubbed_service do
            bigquery = Google::Cloud::Bigquery.new credentials: default_credentials, logger: my_logger
            bigquery.must_be_kind_of Google::Cloud::Bigquery::Project
            bigquery.project.must_equal "project-id"
            bigquery.service.must_be_kind_of OpenStruct
          end
