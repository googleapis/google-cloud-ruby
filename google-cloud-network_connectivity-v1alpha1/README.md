...
API Client library for the Network Connectivity V1alpha1 API
...
```
$ gem install google-cloud-network_connectivity-v1alpha1
```
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-network_connectivity-v1alpha1/latest)
for class and method documentation.

See also the [Product Documentation](cloud.google.com/network-connectivity/)
