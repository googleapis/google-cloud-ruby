...
In general, the google-cloud-network_connectivity-v1alpha1 library uses
...
```sh
export NETWORK_CONNECTIVITY_CREDENTIALS=path/to/keyfile.json
```
...
The google-cloud-network_connectivity-v1alpha1 library aims to make authentication
...
The environment variables that google-cloud-network_connectivity-v1alpha1
...
connect to most services with google-cloud-network_connectivity-v1alpha1.
