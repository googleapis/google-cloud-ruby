...
class Google::Cloud::Run::ClientConstructionMinitest < Minitest::Test
  ...
  def test_worker_pools_grpc
    skip unless Google::Cloud::Run.worker_pools_available? transport: :grpc
    Gapic::ServiceStub.stub :new, DummyStub.new do
      grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
      client = Google::Cloud::Run.worker_pools transport: :grpc do |config|
        config.credentials = grpc_channel
      end
      assert_kind_of Google::Cloud::Run::V2::WorkerPools::Client, client
    end
  end

  def test_worker_pools_rest
    skip unless Google::Cloud::Run.worker_pools_available? transport: :rest
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
      client = Google::Cloud::Run.worker_pools transport: :rest do |config|
        config.credentials = :dummy_credentials
      end
      assert_kind_of Google::Cloud::Run::V2::WorkerPools::Rest::Client, client
    end
  end
end
