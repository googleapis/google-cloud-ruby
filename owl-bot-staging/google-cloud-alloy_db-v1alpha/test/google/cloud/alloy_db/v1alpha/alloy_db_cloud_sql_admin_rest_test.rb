...
class ::Google::Cloud::AlloyDB::V1alpha::AlloyDBCloudSQLAdmin::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AlloyDB::V1alpha::AlloyDBCloudSQLAdmin::Rest::Client::Configuration, config
  end
end
