...
require "google/cloud/alloydb/v1alpha/csql_service_services_pb"
require "google/cloud/alloy_db/v1alpha/alloy_db_cloud_sql_admin"

class ::Google::Cloud::AlloyDB::V1alpha::AlloyDBCloudSQLAdmin::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AlloyDB::V1alpha::AlloyDBCloudSQLAdmin::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AlloyDB::V1alpha::AlloyDBCloudSQLAdmin::Operations::Configuration, config
  end
end
