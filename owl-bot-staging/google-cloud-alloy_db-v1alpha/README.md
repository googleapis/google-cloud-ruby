...
specific version of the AlloyDB V1ALPHA API. Most users should consider using
the main client gem,
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-alloy_db-v1alpha/latest)
...
is part of the name, e.g. `google-cloud-alloy_db-v1alpha`.
