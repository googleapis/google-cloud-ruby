  ...
  module Cloud
    module AlloyDB
      module V1alpha
        ...
        #   @return [::Array<::Google::Cloud::AlloyDB::V1alpha::SqlResultColumn>]
        #     List of columns included in the result. This also includes the data type
        #     of the column.
        # @!attribute [rw] rows
        #   @return [::Array<::Google::Cloud::AlloyDB::V1alpha::SqlResultRow>]
        ...
        # @!attribute [rw] values
        #   @return [::Array<::Google::Cloud::AlloyDB::V1alpha::SqlResultValue>]
