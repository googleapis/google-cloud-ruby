...
class ::Google::Cloud::Commerce::Consumer::Procurement::V1::ConsumerProcurementService::ClientPathsTest < Minitest::Test
  ...
  def test_offer_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.offer_path service: "value0", offer: "value1"
      assert_equal "services/value0/standardOffers/value1", path

      path = client.offer_path consumer_billing_account: "value0", offer: "value1"
      assert_equal "billingAccounts/value0/offers/value1", path
    end
  end
end
