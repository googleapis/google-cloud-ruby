...
##
# Snippet for the get_order call in the ConsumerProcurementService service
#
...
# Google::Cloud::Commerce::Consumer::Procurement::V1::ConsumerProcurementService::Client#get_order.
#
def get_order
