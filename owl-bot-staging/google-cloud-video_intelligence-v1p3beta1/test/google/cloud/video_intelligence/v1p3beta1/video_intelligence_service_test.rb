...
class ::Google::Cloud::VideoIntelligence::V1p3beta1::VideoIntelligenceService::ClientTest < Minitest::Test
  ...
  def test_annotate_video
    ...
    annotate_video_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::VideoIntelligence::V1p3beta1::AnnotateVideoRequest, request
      ...
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::VideoIntelligence::V1p3beta1::VideoContext), request["video_context"]
    ...
    Gapic::ServiceStub.stub :new, annotate_video_client_stub do
      ...
      # Use protobuf object
      client.annotate_video ::Google::Cloud::VideoIntelligence::V1p3beta1::AnnotateVideoRequest.new(input_uri: input_uri, input_content: input_content, features: features, video_context: video_context, output_uri: output_uri, location_id: location_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      client.annotate_video(::Google::Cloud::VideoIntelligence::V1p3beta1::AnnotateVideoRequest.new(input_uri: input_uri, input_content: input_content, features: features, video_context: video_context, output_uri: output_uri, location_id: location_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VideoIntelligence::V1p3beta1::VideoIntelligenceService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::VideoIntelligence::V1p3beta1::VideoIntelligenceService::Client, client
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::VideoIntelligence::V1p3beta1::VideoIntelligenceService::Operations, client.operations_client
  end
end
