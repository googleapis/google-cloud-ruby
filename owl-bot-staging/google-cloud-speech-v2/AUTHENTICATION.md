...
The recommended way to authenticate to the google-cloud-speech-v2 library is to use
...
The google-cloud-speech-v2 library provides several mechanisms to configure your system.
