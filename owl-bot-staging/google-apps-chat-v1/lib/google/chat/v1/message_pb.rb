  ...
  module Apps
    module Chat
      module V1
        ...
        QuotedMessageMetadata::QuoteType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.chat.v1.QuotedMessageMetadata.QuoteType").enummodule
        QuotedMessageSnapshot = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.chat.v1.QuotedMessageSnapshot").msgclass
        ForwardedMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.chat.v1.ForwardedMetadata").msgclass
