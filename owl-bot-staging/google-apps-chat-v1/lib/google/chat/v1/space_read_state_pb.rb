...
module Google
  module Apps
    module Chat
      module V1
        SpaceReadState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.chat.v1.SpaceReadState").msgclass
        GetSpaceReadStateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.chat.v1.GetSpaceReadStateRequest").msgclass
        UpdateSpaceReadStateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.chat.v1.UpdateSpaceReadStateRequest").msgclass
      end
    end
  end
end
