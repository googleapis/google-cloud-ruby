...
class ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::ClientPathsTest < Minitest::Test
  ...
  def test_catalog_item_path_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.catalog_item_path_path project: "value0", location: "value1", catalog: "value2", catalog_item_path: "value3"
      assert_equal "projects/value0/locations/value1/catalogs/value2/catalogItems/value3", path
    end
  end
end
