...
class ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Operations::Configuration, config
  end
end
