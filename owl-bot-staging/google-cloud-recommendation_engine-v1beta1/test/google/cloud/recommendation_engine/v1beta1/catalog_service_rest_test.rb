...
class ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_catalog_item
    # Create test objects.
    client_result = ::Google::Cloud::RecommendationEngine::V1beta1::CatalogItem.new
    ...
    create_catalog_item_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::ServiceStub.stub :transcode_create_catalog_item_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_catalog_item_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_catalog_item_client_stub.call_count
      end
    end
  end
  ...
  def test_get_catalog_item
    ...
    get_catalog_item_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::ServiceStub.stub :transcode_get_catalog_item_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_catalog_item_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_catalog_item_client_stub.call_count
      end
    end
  end
  ...
  def test_list_catalog_items
    # Create test objects.
    client_result = ::Google::Cloud::RecommendationEngine::V1beta1::ListCatalogItemsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_catalog_items_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::ServiceStub.stub :transcode_list_catalog_items_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_catalog_items_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_catalog_items_client_stub.call_count
      end
    end
  end
  ...
  def test_update_catalog_item
    ...
    update_catalog_item_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::ServiceStub.stub :transcode_update_catalog_item_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_catalog_item_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_catalog_item_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_catalog_item
    ...
    delete_catalog_item_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::ServiceStub.stub :transcode_delete_catalog_item_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_catalog_item_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_catalog_item_client_stub.call_count
      end
    end
  end
  ...
  def test_import_catalog_items
    ...
    import_catalog_items_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::ServiceStub.stub :transcode_import_catalog_items_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, import_catalog_items_client_stub do
        ...
        # Verify method calls
        assert_equal 5, import_catalog_items_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::RecommendationEngine::V1beta1::CatalogService::Rest::Client::Configuration, config
  end
end
