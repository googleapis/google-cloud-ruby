...
specific version of the Cloud Video Intelligence V1p2beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-video_intelligence-v1p2beta1
```
...
request = ::Google::Cloud::VideoIntelligence::V1p2beta1::AnnotateVideoRequest.new # (request fields as keyword arguments...)
...
is part of the name, e.g. `google-cloud-video_intelligence-v1p2beta1`.
