...
require File.expand_path("lib/google/maps/fleet_engine/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-maps-fleet_engine"
  gem.version       = Google::Maps::FleetEngine::VERSION
  ...
  gem.add_dependency "google-maps-fleet_engine-v1", ">= 0.0", "< 2.a"
end
