...
##
# Snippet for the get_encryption_spec call in the EncryptionSpecService service
#
...
# Google::Cloud::Dialogflow::V2::EncryptionSpecService::Client#get_encryption_spec.
#
