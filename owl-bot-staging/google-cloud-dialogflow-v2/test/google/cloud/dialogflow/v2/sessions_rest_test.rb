...
class ::Google::Cloud::Dialogflow::V2::Sessions::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_detect_intent
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::DetectIntentResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::Sessions::Rest::Client::Configuration, config
  end
end
