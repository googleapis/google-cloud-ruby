...
class ::Google::Cloud::Dialogflow::V2::SipTrunks::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_sip_trunk
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2::SipTrunk.new
    ...
    create_sip_trunk_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_sip_trunk, name
      assert_kind_of ::Google::Cloud::Dialogflow::V2::CreateSipTrunkRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2::SipTrunk), request["sip_trunk"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_sip_trunk_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_sip_trunk_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_sip_trunk
    ...
    delete_sip_trunk_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_sip_trunk, name
      assert_kind_of ::Google::Cloud::Dialogflow::V2::DeleteSipTrunkRequest, request
    ...
    Gapic::ServiceStub.stub :new, delete_sip_trunk_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_sip_trunk_client_stub.call_rpc_count
    end
  end

  def test_list_sip_trunks
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2::ListSipTrunksResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_sip_trunks_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_sip_trunks, name
      assert_kind_of ::Google::Cloud::Dialogflow::V2::ListSipTrunksRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_sip_trunks_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_sip_trunks_client_stub.call_rpc_count
    end
  end

  def test_get_sip_trunk
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2::SipTrunk.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    get_sip_trunk_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_sip_trunk, name
      assert_kind_of ::Google::Cloud::Dialogflow::V2::GetSipTrunkRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_sip_trunk_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_sip_trunk_client_stub.call_rpc_count
    end
  end

  def test_update_sip_trunk
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2::SipTrunk.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    update_sip_trunk_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_sip_trunk, name
      assert_kind_of ::Google::Cloud::Dialogflow::V2::UpdateSipTrunkRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2::SipTrunk), request["sip_trunk"]
    ...
    Gapic::ServiceStub.stub :new, update_sip_trunk_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_sip_trunk_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::SipTrunks::Client::Configuration, config
  end
