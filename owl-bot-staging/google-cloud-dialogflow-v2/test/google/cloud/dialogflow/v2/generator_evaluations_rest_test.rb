...
class ::Google::Cloud::Dialogflow::V2::GeneratorEvaluations::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_generator_evaluation
    ...
    create_generator_evaluation_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dialogflow::V2::GeneratorEvaluations::Rest::ServiceStub.stub :transcode_create_generator_evaluation_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_generator_evaluation_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_generator_evaluation_client_stub.call_count
      end
    end
  end
  ...
  def test_get_generator_evaluation
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::GeneratorEvaluation.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_generator_evaluation_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::GeneratorEvaluations::Rest::ServiceStub.stub :transcode_get_generator_evaluation_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_generator_evaluation_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_generator_evaluation_client_stub.call_count
      end
    end
  end
  ...
  def test_list_generator_evaluations
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ListGeneratorEvaluationsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_generator_evaluations_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::GeneratorEvaluations::Rest::ServiceStub.stub :transcode_list_generator_evaluations_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_generator_evaluations_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_generator_evaluations_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_generator_evaluation
    ...
    delete_generator_evaluation_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::GeneratorEvaluations::Rest::ServiceStub.stub :transcode_delete_generator_evaluation_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_generator_evaluation_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_generator_evaluation_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::GeneratorEvaluations::Rest::Client::Configuration, config
  end
end
