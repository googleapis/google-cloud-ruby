...
class ::Google::Cloud::Dialogflow::V2::KnowledgeBases::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_knowledge_bases
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ListKnowledgeBasesResponse.new
    ...
    list_knowledge_bases_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dialogflow::V2::KnowledgeBases::Rest::ServiceStub.stub :transcode_list_knowledge_bases_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_knowledge_bases_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_knowledge_bases_client_stub.call_count
      end
    end
  end
  ...
  def test_get_knowledge_base
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::KnowledgeBase.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_knowledge_base_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::KnowledgeBases::Rest::ServiceStub.stub :transcode_get_knowledge_base_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_knowledge_base_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_knowledge_base_client_stub.call_count
      end
    end
  end
  ...
  def test_create_knowledge_base
    ...
    create_knowledge_base_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::KnowledgeBases::Rest::ServiceStub.stub :transcode_create_knowledge_base_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_knowledge_base_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_knowledge_base_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_knowledge_base
    ...
    delete_knowledge_base_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::KnowledgeBases::Rest::ServiceStub.stub :transcode_delete_knowledge_base_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_knowledge_base_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_knowledge_base_client_stub.call_count
      end
    end
  end
  ...
  def test_update_knowledge_base
    ...
    update_knowledge_base_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::KnowledgeBases::Rest::ServiceStub.stub :transcode_update_knowledge_base_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_knowledge_base_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_knowledge_base_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::KnowledgeBases::Rest::Client::Configuration, config
  end
end
