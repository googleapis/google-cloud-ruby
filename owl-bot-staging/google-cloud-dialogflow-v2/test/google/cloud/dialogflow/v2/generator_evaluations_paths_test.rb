...
class ::Google::Cloud::Dialogflow::V2::GeneratorEvaluations::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_generator_evaluation_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.generator_evaluation_path project: "value0", location: "value1", generator: "value2", evaluation: "value3"
      assert_equal "projects/value0/locations/value1/generators/value2/evaluations/value3", path
    end
  end
