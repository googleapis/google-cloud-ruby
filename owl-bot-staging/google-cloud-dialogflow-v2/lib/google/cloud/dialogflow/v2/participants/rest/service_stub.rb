            ...
            class ServiceStub
              ...
              def create_participant request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  method_name: "create_participant",
                  options: options
                )
              ...
              def update_participant request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "update_participant",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Dialogflow::V2::Participant.decode_json response.body, ignore_unknown_fields: true
              ...
              def suggest_faq_answers request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "suggest_faq_answers",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def suggest_smart_replies request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "suggest_smart_replies",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def suggest_knowledge_assist request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "suggest_knowledge_assist",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
