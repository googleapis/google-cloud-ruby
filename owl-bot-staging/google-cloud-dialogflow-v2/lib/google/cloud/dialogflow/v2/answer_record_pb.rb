  ...
  module Cloud
    module Dialogflow
      module V2
        ...
        AgentAssistantFeedback::KnowledgeAssistFeedback = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.dialogflow.v2.AgentAssistantFeedback.KnowledgeAssistFeedback").msgclass
