...
require File.expand_path("lib/google/shopping/merchant/reports/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-reports-v1"
  gem.version       = Google::Shopping::Merchant::Reports::V1::VERSION
