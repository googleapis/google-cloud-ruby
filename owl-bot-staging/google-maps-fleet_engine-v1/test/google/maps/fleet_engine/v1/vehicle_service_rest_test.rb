...
class ::Google::Maps::FleetEngine::V1::VehicleService::Rest::ClientTest < Minitest::Test
  ...
  def test_update_vehicle_location
    # Create test objects.
    client_result = ::Google::Maps::FleetEngine::V1::VehicleLocation.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    update_vehicle_location_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end

    ::Google::Maps::FleetEngine::V1::VehicleService::Rest::ServiceStub.stub :transcode_update_vehicle_location_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_vehicle_location_client_stub do
        # Create client
        client = ::Google::Maps::FleetEngine::V1::VehicleService::Rest::Client.new do |config|
          config.credentials = :dummy_value
        end
        ...
        # Use hash object
        client.update_vehicle_location({ header: header, name: name, current_location: current_location, current_state: current_state }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        client.update_vehicle_location ::Google::Maps::FleetEngine::V1::UpdateVehicleLocationRequest.new(header: header, name: name, current_location: current_location, current_state: current_state) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        client.update_vehicle_location({ header: header, name: name, current_location: current_location, current_state: current_state }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        client.update_vehicle_location(::Google::Maps::FleetEngine::V1::UpdateVehicleLocationRequest.new(header: header, name: name, current_location: current_location, current_state: current_state), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Verify method calls
        assert_equal 5, update_vehicle_location_client_stub.call_count
      end
    end
  end
  ...
  def test_search_fuzzed_vehicles
    ...
    search_fuzzed_vehicles_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end

    ::Google::Maps::FleetEngine::V1::VehicleService::Rest::ServiceStub.stub :transcode_search_fuzzed_vehicles_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_fuzzed_vehicles_client_stub do
        # Create client
        client = ::Google::Maps::FleetEngine::V1::VehicleService::Rest::Client.new do |config|
          config.credentials = :dummy_value
        end
        ...
        # Verify method calls
        assert_equal 5, search_fuzzed_vehicles_client_stub.call_count
      end
    end
  end
