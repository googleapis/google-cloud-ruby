...
require File.expand_path("lib/google/shopping/merchant/reviews/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-reviews"
  gem.version       = Google::Shopping::Merchant::Reviews::VERSION
  ...
  gem.add_dependency "google-shopping-merchant-reviews-v1beta", ">= 0.0", "< 2.a"
end
