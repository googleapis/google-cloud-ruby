...
module Google
  module Cloud
    module Iot
      ...
      #   Defaults to `:v1`.
      # @return [DeviceManager::Client] A client object for the specified version.
      #
      def self.device_manager version: :v1, &block
        ...
        package_name = Google::Cloud::Iot
                       ...
                       .first
        package_module = Google::Cloud::Iot.const_get package_name
        package_module.const_get(:DeviceManager).const_get(:Client).new(&block)
      end
