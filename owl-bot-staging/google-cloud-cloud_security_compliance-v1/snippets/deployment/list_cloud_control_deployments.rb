...
##
# Snippet for the list_cloud_control_deployments call in the Deployment service
#
...
# Google::Cloud::CloudSecurityCompliance::V1::Deployment::Client#list_cloud_control_deployments.
#
