...
class ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_frameworks
    # Create test objects.
    client_result = ::Google::Cloud::CloudSecurityCompliance::V1::ListFrameworksResponse.new
    ...
    list_frameworks_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_list_frameworks_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_frameworks_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_frameworks_client_stub.call_count
      end
    end
  end
  ...
  def test_get_framework
    # Create test objects.
    client_result = ::Google::Cloud::CloudSecurityCompliance::V1::Framework.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_framework_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_get_framework_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_framework_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_framework_client_stub.call_count
      end
    end
  end
  ...
  def test_create_framework
    ...
    create_framework_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_create_framework_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_framework_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_framework_client_stub.call_count
      end
    end
  end
  ...
  def test_update_framework
    ...
    update_framework_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_update_framework_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_framework_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_framework_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_framework
    ...
    delete_framework_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_delete_framework_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_framework_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_framework_client_stub.call_count
      end
    end
  end
  ...
  def test_list_cloud_controls
    # Create test objects.
    client_result = ::Google::Cloud::CloudSecurityCompliance::V1::ListCloudControlsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_cloud_controls_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_list_cloud_controls_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_cloud_controls_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_cloud_controls_client_stub.call_count
      end
    end
  end
  ...
  def test_get_cloud_control
    # Create test objects.
    client_result = ::Google::Cloud::CloudSecurityCompliance::V1::CloudControl.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_get_cloud_control_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_cloud_control_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_cloud_control_client_stub.call_count
      end
    end
  end
  ...
  def test_create_cloud_control
    ...
    create_cloud_control_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_create_cloud_control_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_cloud_control_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_cloud_control_client_stub.call_count
      end
    end
  end
  ...
  def test_update_cloud_control
    ...
    update_cloud_control_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_update_cloud_control_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_cloud_control_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_cloud_control_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_cloud_control
    ...
    delete_cloud_control_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::ServiceStub.stub :transcode_delete_cloud_control_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_cloud_control_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_cloud_control_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::Config::Rest::Client::Configuration, config
  end
end
