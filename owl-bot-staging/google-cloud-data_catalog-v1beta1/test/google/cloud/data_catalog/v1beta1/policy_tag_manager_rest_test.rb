...
class ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_taxonomy
    # Create test objects.
    client_result = ::Google::Cloud::DataCatalog::V1beta1::Taxonomy.new
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_create_taxonomy_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_taxonomy_client_stub do
        ...
        # Use protobuf object
        client.create_taxonomy ::Google::Cloud::DataCatalog::V1beta1::CreateTaxonomyRequest.new(parent: parent, taxonomy: taxonomy) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.create_taxonomy(::Google::Cloud::DataCatalog::V1beta1::CreateTaxonomyRequest.new(parent: parent, taxonomy: taxonomy), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_taxonomy
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_delete_taxonomy_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_taxonomy_client_stub do
        ...
        # Use protobuf object
        client.delete_taxonomy ::Google::Cloud::DataCatalog::V1beta1::DeleteTaxonomyRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.delete_taxonomy(::Google::Cloud::DataCatalog::V1beta1::DeleteTaxonomyRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_taxonomy
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_update_taxonomy_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_taxonomy_client_stub do
        ...
        # Use protobuf object
        client.update_taxonomy ::Google::Cloud::DataCatalog::V1beta1::UpdateTaxonomyRequest.new(taxonomy: taxonomy, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.update_taxonomy(::Google::Cloud::DataCatalog::V1beta1::UpdateTaxonomyRequest.new(taxonomy: taxonomy, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_taxonomies
    # Create test objects.
    client_result = ::Google::Cloud::DataCatalog::V1beta1::ListTaxonomiesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_list_taxonomies_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_taxonomies_client_stub do
        ...
        # Use protobuf object
        client.list_taxonomies ::Google::Cloud::DataCatalog::V1beta1::ListTaxonomiesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.list_taxonomies(::Google::Cloud::DataCatalog::V1beta1::ListTaxonomiesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_taxonomy
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_get_taxonomy_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_taxonomy_client_stub do
        ...
        # Use protobuf object
        client.get_taxonomy ::Google::Cloud::DataCatalog::V1beta1::GetTaxonomyRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.get_taxonomy(::Google::Cloud::DataCatalog::V1beta1::GetTaxonomyRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_policy_tag
    # Create test objects.
    client_result = ::Google::Cloud::DataCatalog::V1beta1::PolicyTag.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_create_policy_tag_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_policy_tag_client_stub do
        ...
        # Use protobuf object
        client.create_policy_tag ::Google::Cloud::DataCatalog::V1beta1::CreatePolicyTagRequest.new(parent: parent, policy_tag: policy_tag) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.create_policy_tag(::Google::Cloud::DataCatalog::V1beta1::CreatePolicyTagRequest.new(parent: parent, policy_tag: policy_tag), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_policy_tag
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_delete_policy_tag_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_policy_tag_client_stub do
        ...
        # Use protobuf object
        client.delete_policy_tag ::Google::Cloud::DataCatalog::V1beta1::DeletePolicyTagRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.delete_policy_tag(::Google::Cloud::DataCatalog::V1beta1::DeletePolicyTagRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_policy_tag
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_update_policy_tag_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_policy_tag_client_stub do
        ...
        # Use protobuf object
        client.update_policy_tag ::Google::Cloud::DataCatalog::V1beta1::UpdatePolicyTagRequest.new(policy_tag: policy_tag, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.update_policy_tag(::Google::Cloud::DataCatalog::V1beta1::UpdatePolicyTagRequest.new(policy_tag: policy_tag, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_policy_tags
    # Create test objects.
    client_result = ::Google::Cloud::DataCatalog::V1beta1::ListPolicyTagsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_list_policy_tags_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_policy_tags_client_stub do
        ...
        # Use protobuf object
        client.list_policy_tags ::Google::Cloud::DataCatalog::V1beta1::ListPolicyTagsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.list_policy_tags(::Google::Cloud::DataCatalog::V1beta1::ListPolicyTagsRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_policy_tag
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_get_policy_tag_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_policy_tag_client_stub do
        ...
        # Use protobuf object
        client.get_policy_tag ::Google::Cloud::DataCatalog::V1beta1::GetPolicyTagRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.get_policy_tag(::Google::Cloud::DataCatalog::V1beta1::GetPolicyTagRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_iam_policy
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_get_iam_policy_request, ["", "", {}] do
  ...
  def test_set_iam_policy
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_set_iam_policy_request, ["", "", {}] do
  ...
  def test_test_iam_permissions
    ...
    ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::ServiceStub.stub :transcode_test_iam_permissions_request, ["", "", {}] do
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::Rest::Client::Configuration, config
  end
end
