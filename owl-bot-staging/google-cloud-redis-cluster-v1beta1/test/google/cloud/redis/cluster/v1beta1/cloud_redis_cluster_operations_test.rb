...
class ::Google::Cloud::Redis::Cluster::V1beta1::CloudRedisCluster::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Redis::Cluster::V1beta1::CloudRedisCluster::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Redis::Cluster::V1beta1::CloudRedisCluster::Operations::Configuration, config
  end
end
