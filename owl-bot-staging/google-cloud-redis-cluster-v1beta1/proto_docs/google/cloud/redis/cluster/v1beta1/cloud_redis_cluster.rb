    ...
    module Redis
      module Cluster
        module V1beta1
          ...
          #   @return [::Array<::Google::Cloud::Redis::Cluster::V1beta1::BackupCollection>]
          ...
          #   @return [::Array<::Google::Cloud::Redis::Cluster::V1beta1::Backup>]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::Cluster::GcsBackupSource]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::Cluster::ManagedBackupSource]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::CrossClusterReplicationConfig]
          #     Optional. Cross cluster replication config.
          # @!attribute [rw] deletion_protection_enabled
          #   @return [::Boolean]
          #     Optional. The delete operation will fail when the value is set to true.
          # @!attribute [rw] maintenance_policy
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::ClusterMaintenancePolicy]
          #     Optional. ClusterMaintenancePolicy determines when to allow or deny
          #     updates.
          # @!attribute [r] maintenance_schedule
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::ClusterMaintenanceSchedule]
          #     Output only. ClusterMaintenanceSchedule Output only Published maintenance
          #     schedule.
          # @!attribute [r] psc_service_attachments
          #   @return [::Array<::Google::Cloud::Redis::Cluster::V1beta1::PscServiceAttachment>]
          #     Output only. Service attachment details to configure Psc connections
          # @!attribute [rw] cluster_endpoints
          #   @return [::Array<::Google::Cloud::Redis::Cluster::V1beta1::ClusterEndpoint>]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::AutomatedBackupConfig]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::AutomatedBackupConfig::FixedFrequencySchedule]
          #     Optional. Trigger automated backups at a fixed frequency.
          # @!attribute [rw] automated_backup_mode
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::AutomatedBackupConfig::AutomatedBackupMode]
          ...
          #   @return [::Array<::Google::Cloud::Redis::Cluster::V1beta1::BackupFile>]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::Backup::BackupType]
          #     Output only. Type of the backup.
          # @!attribute [r] state
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::Backup::State]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::ConnectionType]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::CrossClusterReplicationConfig::ClusterRole]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::CrossClusterReplicationConfig::Membership]
          ...
          #   @return [::Array<::Google::Cloud::Redis::Cluster::V1beta1::ClusterWeeklyMaintenanceWindow>]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::PscConnectionStatus]
          ...
          #   @return [::Array<::Google::Cloud::Redis::Cluster::V1beta1::ConnectionDetail>]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::PscAutoConnection]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::PscConnection]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::RescheduleClusterMaintenanceRequest::RescheduleType]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::EncryptionInfo::Type]
          ...
          #   @return [::Google::Cloud::Redis::Cluster::V1beta1::EncryptionInfo::KmsKeyState]
