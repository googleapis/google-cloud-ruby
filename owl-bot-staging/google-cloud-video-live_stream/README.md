# Ruby Client for the Live Stream API

API Client library for the Live Stream API
...
_versioned_ client gems, with names of the form `google-cloud-video-live_stream-v*`.
The gem `google-cloud-video-live_stream` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-video-live_stream/latest)
for this library, google-cloud-video-live_stream, to see the convenience methods for
