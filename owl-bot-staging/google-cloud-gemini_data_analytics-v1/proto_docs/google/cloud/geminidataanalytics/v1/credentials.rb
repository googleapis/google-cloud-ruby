  ...
  module Cloud
    module GeminiDataAnalytics
      module V1
        ...
        # @!attribute [rw] oauth
        #   @return [::Google::Cloud::GeminiDataAnalytics::V1::OAuthCredentials]
        #     OAuth credentials.
        class Credentials
        ...
        # @!attribute [rw] secret
        #   @return [::Google::Cloud::GeminiDataAnalytics::V1::OAuthCredentials::SecretBased]
        ...
        # @!attribute [rw] token
        #   @return [::Google::Cloud::GeminiDataAnalytics::V1::OAuthCredentials::TokenBased]
