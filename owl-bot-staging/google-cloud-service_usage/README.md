# Ruby Client for the Service Usage API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-service_usage/latest)
for this library, google-cloud-service_usage, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-service_usage-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-service_usage-v1/latest).
