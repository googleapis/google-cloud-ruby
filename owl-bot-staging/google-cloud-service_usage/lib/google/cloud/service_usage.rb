...
::Google::Cloud.configure.add_config! :service_usage do |config|
  config.add_field! :endpoint,      "serviceusage.googleapis.com", match: ::String
...
module Google
  module Cloud
    module ServiceUsage
      ...
      # [Google::Cloud::ServiceUsage::V1::ServiceUsage::Client](https://googleapis.dev/ruby/google-cloud-service_usage-v1/latest/Google/Cloud/ServiceUsage/V1/ServiceUsage/Client.html)
      ...
      #   Defaults to `:v1`.
      # @return [ServiceUsage::Client] A client object for the specified version.
      #
      def self.service_usage version: :v1, &block
        ...
        package_name = Google::Cloud::ServiceUsage
                       ...
                       .first
        package_module = Google::Cloud::ServiceUsage.const_get package_name
        package_module.const_get(:ServiceUsage).const_get(:Client).new(&block)
      end
