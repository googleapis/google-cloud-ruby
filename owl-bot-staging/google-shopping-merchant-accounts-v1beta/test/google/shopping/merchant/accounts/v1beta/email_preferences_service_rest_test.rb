...
class ::Google::Shopping::Merchant::Accounts::V1beta::EmailPreferencesService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_email_preferences
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1beta::EmailPreferences.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1beta::EmailPreferencesService::Rest::Client::Configuration, config
  end
end
