...
class ::Google::Shopping::Merchant::Accounts::V1beta::EmailPreferencesService::Rest::ClientTest < Minitest::Test
  ...
  def test_get_email_preferences
    ...
    get_email_preferences_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_update_email_preferences
    ...
    update_email_preferences_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
