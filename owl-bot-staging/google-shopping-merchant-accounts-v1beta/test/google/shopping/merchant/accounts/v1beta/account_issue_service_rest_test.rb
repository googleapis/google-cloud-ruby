...
class ::Google::Shopping::Merchant::Accounts::V1beta::AccountIssueService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_account_issues
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1beta::ListAccountIssuesResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1beta::AccountIssueService::Rest::Client::Configuration, config
  end
end
