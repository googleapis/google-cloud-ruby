...
class ::Google::Shopping::Merchant::Accounts::V1beta::LfpProvidersService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_find_lfp_providers
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1beta::FindLfpProvidersResponse.new
    ...
    find_lfp_providers_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::LfpProvidersService::Rest::ServiceStub.stub :transcode_find_lfp_providers_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, find_lfp_providers_client_stub do
        ...
        # Verify method calls
        assert_equal 5, find_lfp_providers_client_stub.call_count
      end
    end
  end
  ...
  def test_link_lfp_provider
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1beta::LinkLfpProviderResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    link_lfp_provider_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::LfpProvidersService::Rest::ServiceStub.stub :transcode_link_lfp_provider_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, link_lfp_provider_client_stub do
        ...
        # Verify method calls
        assert_equal 5, link_lfp_provider_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1beta::LfpProvidersService::Rest::Client::Configuration, config
  end
end
