...
class ::Google::Shopping::Merchant::Accounts::V1beta::AccountTaxService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_account_tax_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.account_tax_path account: "value0", tax: "value1"
      assert_equal "accounts/value0/accounttax/value1", path
    end
  end
end
