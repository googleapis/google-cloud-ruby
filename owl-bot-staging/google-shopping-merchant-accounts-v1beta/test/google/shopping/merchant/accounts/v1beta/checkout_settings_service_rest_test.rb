...
class ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_checkout_settings
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettings.new
    ...
    get_checkout_settings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Rest::ServiceStub.stub :transcode_get_checkout_settings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_checkout_settings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_checkout_settings_client_stub.call_count
      end
    end
  end
  ...
  def test_create_checkout_settings
    ...
    create_checkout_settings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Rest::ServiceStub.stub :transcode_create_checkout_settings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_checkout_settings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_checkout_settings_client_stub.call_count
      end
    end
  end
  ...
  def test_update_checkout_settings
    ...
    update_checkout_settings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Rest::ServiceStub.stub :transcode_update_checkout_settings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_checkout_settings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_checkout_settings_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_checkout_settings
    ...
    delete_checkout_settings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Rest::ServiceStub.stub :transcode_delete_checkout_settings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_checkout_settings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_checkout_settings_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Rest::Client::Configuration, config
  end
end
