...
##
# Snippet for the update_email_preferences call in the EmailPreferencesService service
#
...
# Google::Shopping::Merchant::Accounts::V1beta::EmailPreferencesService::Client#update_email_preferences.
#
