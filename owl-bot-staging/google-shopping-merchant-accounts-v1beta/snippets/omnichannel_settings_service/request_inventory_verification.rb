...
##
# Snippet for the request_inventory_verification call in the OmnichannelSettingsService service
#
...
# Google::Shopping::Merchant::Accounts::V1beta::OmnichannelSettingsService::Client#request_inventory_verification.
#
