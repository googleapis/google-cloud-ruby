...
##
# Snippet for the get_account_tax call in the AccountTaxService service
#
...
# Google::Shopping::Merchant::Accounts::V1beta::AccountTaxService::Client#get_account_tax.
#
def get_account_tax
