  ...
  module Cloud
    module TextToSpeech
      module V1beta1
        ...
        CustomPronunciationParams::PhoneticEncoding = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.texttospeech.v1beta1.CustomPronunciationParams.PhoneticEncoding").enummodule
