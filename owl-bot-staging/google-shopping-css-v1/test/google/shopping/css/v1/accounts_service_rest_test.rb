...
class ::Google::Shopping::Css::V1::AccountsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_child_accounts
    # Create test objects.
    client_result = ::Google::Shopping::Css::V1::ListChildAccountsResponse.new
    ...
    list_child_accounts_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Css::V1::AccountsService::Rest::ServiceStub.stub :transcode_list_child_accounts_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_child_accounts_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_child_accounts_client_stub.call_count
      end
    end
  end
  ...
  def test_get_account
    # Create test objects.
    client_result = ::Google::Shopping::Css::V1::Account.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_update_labels
    ...
    update_labels_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Css::V1::AccountsService::Rest::ServiceStub.stub :transcode_update_labels_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_labels_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_labels_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Css::V1::AccountsService::Rest::Client::Configuration, config
  end
end
