...
class ::Google::Shopping::Css::V1::CssProductsService::Rest::ClientTest < Minitest::Test
  ...
  def test_get_css_product
    ...
    get_css_product_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_list_css_products
    ...
    list_css_products_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
