...
class ::Google::Shopping::Css::V1::CssProductsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_css_product_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.css_product_path account: "value0", css_product: "value1"
      assert_equal "accounts/value0/cssProducts/value1", path
    end
  end
end
