...
class ::Google::Shopping::Css::V1::QuotaService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_quota_groups
    # Create test objects.
    client_result = ::Google::Shopping::Css::V1::ListQuotaGroupsResponse.new
    ...
    list_quota_groups_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Css::V1::QuotaService::Rest::ServiceStub.stub :transcode_list_quota_groups_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_quota_groups_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_quota_groups_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Css::V1::QuotaService::Rest::Client::Configuration, config
  end
end
