...
class ::Google::Shopping::Css::V1::CssProductInputsService::Rest::ClientTest < Minitest::Test
  ...
  def test_insert_css_product_input
    ...
    insert_css_product_input_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
  ...
  def test_update_css_product_input
    ...
    update_css_product_input_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Css::V1::CssProductInputsService::Rest::ServiceStub.stub :transcode_update_css_product_input_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_css_product_input_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_css_product_input_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_css_product_input
    ...
    delete_css_product_input_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
