...
class ::Google::Shopping::Css::V1::AccountLabelsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_account_label_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.account_label_path account: "value0", label: "value1"
      assert_equal "accounts/value0/labels/value1", path
    end
  end
end
