...
class ::Google::Cloud::Talent::V4beta1::EventService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_client_event
    # Create test objects.
    client_result = ::Google::Cloud::Talent::V4beta1::ClientEvent.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Talent::V4beta1::EventService::Rest::Client::Configuration, config
  end
end
