...
require "google/cloud/vision_ai/version"
...
::Google::Cloud.configure.add_config! :vision_ai do |config|
...
module Google
  module Cloud
    module VisionAI
      ...
      # [Google::Cloud::VisionAI::V1::LiveVideoAnalytics::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-vision_ai-v1/latest/Google-Cloud-VisionAI-V1-LiveVideoAnalytics-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the LiveVideoAnalytics service is
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::VisionAI::V1::AppPlatform::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-vision_ai-v1/latest/Google-Cloud-VisionAI-V1-AppPlatform-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the AppPlatform service is
      # supported by that API version, and the corresponding gem is available, the
      # appropriate versioned client will be returned.
      # You can also specify a different transport by passing `:rest` or `:grpc` in
      # the `transport` parameter.
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::VisionAI::V1::StreamingService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-vision_ai-v1/latest/Google-Cloud-VisionAI-V1-StreamingService-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the StreamingService service is
      # supported by that API version, and the corresponding gem is available, the
      # appropriate versioned client will be returned.
      # You can also specify a different transport by passing `:rest` or `:grpc` in
      # the `transport` parameter.
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::VisionAI::V1::StreamsService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-vision_ai-v1/latest/Google-Cloud-VisionAI-V1-StreamsService-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the StreamsService service is
      # supported by that API version, and the corresponding gem is available, the
      # appropriate versioned client will be returned.
      # You can also specify a different transport by passing `:rest` or `:grpc` in
      # the `transport` parameter.
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::VisionAI::V1::Warehouse::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-vision_ai-v1/latest/Google-Cloud-VisionAI-V1-Warehouse-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the Warehouse service is
      # supported by that API version, and the corresponding gem is available, the
      # appropriate versioned client will be returned.
      # You can also specify a different transport by passing `:rest` or `:grpc` in
      # the `transport` parameter.
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::VisionAI::V1::HealthCheckService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-vision_ai-v1/latest/Google-Cloud-VisionAI-V1-HealthCheckService-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the HealthCheckService service is
      # supported by that API version, and the corresponding gem is available, the
      # appropriate versioned client will be returned.
      # You can also specify a different transport by passing `:rest` or `:grpc` in
      # the `transport` parameter.
...
helper_path = ::File.join __dir__, "vision_ai", "helpers.rb"
require "google/cloud/vision_ai/helpers" if ::File.file? helper_path
