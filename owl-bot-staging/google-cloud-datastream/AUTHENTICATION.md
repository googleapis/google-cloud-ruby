...
The recommended way to authenticate to the google-cloud-datastream library is to use
...
The google-cloud-datastream library provides several mechanisms to configure your system.
