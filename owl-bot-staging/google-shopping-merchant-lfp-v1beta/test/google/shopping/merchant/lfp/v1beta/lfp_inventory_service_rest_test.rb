...
class ::Google::Shopping::Merchant::Lfp::V1beta::LfpInventoryService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_insert_lfp_inventory
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Lfp::V1beta::LfpInventory.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Lfp::V1beta::LfpInventoryService::Rest::Client::Configuration, config
  end
end
