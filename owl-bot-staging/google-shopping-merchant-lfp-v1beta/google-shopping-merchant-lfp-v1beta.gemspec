...
require File.expand_path("lib/google/shopping/merchant/lfp/v1beta/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-lfp-v1beta"
  gem.version       = Google::Shopping::Merchant::Lfp::V1beta::VERSION
