...
class ::Google::Cloud::BeyondCorp::AppGateways::V1::AppGatewaysService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::BeyondCorp::AppGateways::V1::AppGatewaysService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::BeyondCorp::AppGateways::V1::AppGatewaysService::Operations::Configuration, config
  end
end
