...
class Google::Cloud::Billing::Budgets::ClientConstructionMinitest < Minitest::Test
  ...
  def test_budget_service_rest
    Gapic::Rest::ClientStub.stub :new, :stub do
      ...
      assert_kind_of Google::Cloud::Billing::Budgets::V1::BudgetService::Rest::Client, client
    end
  end
end
