...
In general, the google-cloud-debugger-v2 library uses
...
```sh
export DEBUGGER_CREDENTIALS=path/to/keyfile.json
```
...
The google-cloud-debugger-v2 library aims to make authentication
...
The environment variables that google-cloud-debugger-v2
...
connect to most services with google-cloud-debugger-v2.
