...
specific version of the Cloud Debugger V2 API. Most users should consider using
the main client gem,
[google-cloud-debugger](https://rubygems.org/gems/google-cloud-debugger).
...
client library with a name such as `google-cloud-debugger`,
...
is part of the name, e.g. `google-cloud-debugger-v2`.
