...
module Google
  module Cloud
    module SecurityCenter
      module V1
        AttackPath = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v1.AttackPath").msgclass
        AttackPath::AttackPathNode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v1.AttackPath.AttackPathNode").msgclass
        AttackPath::AttackPathNode::PathNodeAssociatedFinding = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v1.AttackPath.AttackPathNode.PathNodeAssociatedFinding").msgclass
        AttackPath::AttackPathNode::AttackStepNode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v1.AttackPath.AttackPathNode.AttackStepNode").msgclass
        AttackPath::AttackPathNode::NodeType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v1.AttackPath.AttackPathNode.NodeType").enummodule
        AttackPath::AttackPathEdge = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v1.AttackPath.AttackPathEdge").msgclass
      end
    end
  end
end
