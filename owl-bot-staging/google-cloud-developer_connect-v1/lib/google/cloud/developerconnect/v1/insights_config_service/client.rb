      ...
      module V1
        module InsightsConfigService
          ...
          class Client
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Developerconnect::V1::DeploymentEvent]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_deployment_event request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.get_deployment_event.metadata.to_h
              ...
              @insights_config_service_stub.call_rpc :get_deployment_event, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Developerconnect::V1::DeploymentEvent>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Developerconnect::V1::DeploymentEvent>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def list_deployment_events request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.list_deployment_events.metadata.to_h
              ...
              @insights_config_service_stub.call_rpc :list_deployment_events, request, options: options do |response, operation|
                response = ::Gapic::PagedEnumerable.new @insights_config_service_stub, :list_deployment_events, request, response, operation, options
                yield response, operation if block_given?
                throw :response, response
              end
            rescue ::GRPC::BadStatus => e
