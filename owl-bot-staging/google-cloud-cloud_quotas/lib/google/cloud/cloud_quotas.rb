...
require "google/cloud/cloud_quotas/version"
...
::Google::Cloud.configure.add_config! :cloud_quotas do |config|
...
module Google
  module Cloud
    module CloudQuotas
      ...
      # {Google::Cloud::CloudQuotas.cloud_quotas_available?}.
      #
      # ## About CloudQuotas
      #
      ...
      #
      def self.cloud_quotas version: :v1, transport: :grpc, &block
        ...
        package_name = Google::Cloud::CloudQuotas
                       ...
                       .first
        service_module = Google::Cloud::CloudQuotas.const_get(package_name).const_get(:CloudQuotas)
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::CloudQuotas.cloud_quotas}.
      ...
      #
      def self.cloud_quotas_available? version: :v1, transport: :grpc
        require "google/cloud/cloud_quotas/#{version.to_s.downcase}"
        package_name = Google::Cloud::CloudQuotas
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        return false unless service_module.const_defined? :CloudQuotas
        service_module = service_module.const_get :CloudQuotas
        if transport == :rest
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.cloud_quotas if block_given?
...
require "google/cloud/cloud_quotas/helpers" if ::File.file? helper_path
