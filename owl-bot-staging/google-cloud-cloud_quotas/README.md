# Ruby Client for the Cloud Quotas API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-cloud_quotas/latest)
for this library, google-cloud-cloud_quotas, to see the convenience methods for
