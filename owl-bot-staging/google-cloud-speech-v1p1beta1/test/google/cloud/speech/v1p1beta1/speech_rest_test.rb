...
class ::Google::Cloud::Speech::V1p1beta1::Speech::Rest::ClientTest < Minitest::Test
  ...
  def test_recognize
    ...
    ::Google::Cloud::Speech::V1p1beta1::Speech::Rest::ServiceStub.stub :transcode_recognize_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, recognize_client_stub do
        # Create client
        c = ::Google::Cloud::Speech::V1p1beta1::Speech::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.recognize ::Google::Cloud::Speech::V1p1beta1::RecognizeRequest.new(config: config, audio: audio) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.recognize(::Google::Cloud::Speech::V1p1beta1::RecognizeRequest.new(config: config, audio: audio), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_long_running_recognize
    ...
    long_running_recognize_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Speech::V1p1beta1::Speech::Rest::ServiceStub.stub :transcode_long_running_recognize_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, long_running_recognize_client_stub do
        ...
        # Use protobuf object
        c.long_running_recognize ::Google::Cloud::Speech::V1p1beta1::LongRunningRecognizeRequest.new(config: config, audio: audio, output_config: output_config) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.long_running_recognize(::Google::Cloud::Speech::V1p1beta1::LongRunningRecognizeRequest.new(config: config, audio: audio, output_config: output_config), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
