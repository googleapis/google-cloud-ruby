...
class ::Google::Cloud::Speech::V1p1beta1::Adaptation::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_phrase_set
    # Create test objects.
    client_result = ::Google::Cloud::Speech::V1p1beta1::PhraseSet.new
  ...
  def test_list_phrase_set
    # Create test objects.
    client_result = ::Google::Cloud::Speech::V1p1beta1::ListPhraseSetResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_create_custom_class
    # Create test objects.
    client_result = ::Google::Cloud::Speech::V1p1beta1::CustomClass.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_custom_classes
    # Create test objects.
    client_result = ::Google::Cloud::Speech::V1p1beta1::ListCustomClassesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Speech::V1p1beta1::Adaptation::Rest::Client::Configuration, config
  end
end
