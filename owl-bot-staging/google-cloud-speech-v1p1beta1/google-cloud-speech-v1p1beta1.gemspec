...
require File.expand_path("lib/google/cloud/speech/v1p1beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-speech-v1p1beta1"
  gem.version       = Google::Cloud::Speech::V1p1beta1::VERSION
  ...
  gem.summary       = "API Client library for the Cloud Speech-to-Text V1p1beta1 API"
