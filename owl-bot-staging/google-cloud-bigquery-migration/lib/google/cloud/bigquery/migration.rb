...
require "google/cloud/bigquery/migration/version"
...
::Google::Cloud.configure.add_config! :bigquery_migration do |config|
  ...
  module Cloud
    module Bigquery
      module Migration
        ...
        # given API version does not support the MigrationService service.
        # You can determine whether the method will succeed by calling
        # {Google::Cloud::Bigquery::Migration.migration_service_available?}.
        #
        ...
        # If true, you can retrieve a client object by calling {Google::Cloud::Bigquery::Migration.migration_service}.
        ...
        #
        def self.migration_service_available? version: :v2
          require "google/cloud/bigquery/migration/#{version.to_s.downcase}"
          package_name = Google::Cloud::Bigquery::Migration
                         .constants
                         .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
          ...
          service_module = Google::Cloud::Bigquery::Migration.const_get package_name
        ...
        ##
        # Configure the google-cloud-bigquery-migration library.
        #
        ...
        #
        def self.configure
          yield ::Google::Cloud.configure.bigquery_migration if block_given?

          ::Google::Cloud.configure.bigquery_migration
        end
      end
    end
  end
...
helper_path = ::File.join __dir__, "migration", "helpers.rb"
require "google/cloud/bigquery/migration/helpers" if ::File.file? helper_path
