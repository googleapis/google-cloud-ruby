...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "google-cloud-tasks-v2", ">= 0.7", "< 2.a"
  gem.add_dependency "google-cloud-tasks-v2beta2", ">= 0.8", "< 2.a"
  gem.add_dependency "google-cloud-tasks-v2beta3", ">= 0.9", "< 2.a"
