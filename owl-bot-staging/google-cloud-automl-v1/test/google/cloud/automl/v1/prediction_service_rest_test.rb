...
class ::Google::Cloud::AutoML::V1::PredictionService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_predict
    # Create test objects.
    client_result = ::Google::Cloud::AutoML::V1::PredictResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AutoML::V1::PredictionService::Rest::Client::Configuration, config
  end
end
