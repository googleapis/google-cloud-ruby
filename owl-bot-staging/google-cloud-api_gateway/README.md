...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-api_gateway/latest)
for this library, google-cloud-api_gateway, to see the convenience methods for
...
```
$ gem install google-cloud-api_gateway
```
...
client library with a name such as `google-cloud-api_gateway`,
...
is part of the name, e.g. `google-cloud-api_gateway-v1`.
