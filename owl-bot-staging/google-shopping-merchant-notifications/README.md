...
View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-notifications)
for this library, google-shopping-merchant-notifications, to see the convenience methods for
...
```
$ gem install google-shopping-merchant-notifications
```
...
is part of the name, e.g. `google-shopping-merchant-notifications-v1beta`.
