...
class ::Google::Cloud::Appoptimize::V1beta::AppOptimize::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_report_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.report_path project: "value0", location: "value1", report: "value2"
      assert_equal "projects/value0/locations/value1/reports/value2", path
    end
  end
end
