...
The recommended way to authenticate to the google-cloud-bigquery-data_exchange-v1beta1 library is to use
...
The google-cloud-bigquery-data_exchange-v1beta1 library provides several mechanisms to configure your system.
