...
The recommended way to authenticate to the google-cloud-managed_identities-v1 library is to use
...
The google-cloud-managed_identities-v1 library provides several mechanisms to configure your system.
