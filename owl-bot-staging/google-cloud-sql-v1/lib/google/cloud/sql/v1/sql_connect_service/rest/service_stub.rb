        ...
        module SqlConnectService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1::GetConnectSettingsRequest]
              ...
              def generate_ephemeral_cert request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Sql::V1::GenerateEphemeralCertResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              def self.transcode_get_connect_settings_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v1/projects/{project}/instances/{instance}/connectSettings",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["instance", %r{^[^/]+/?$}, false]
                                                          ]
              ...
              def self.transcode_generate_ephemeral_cert_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/projects/{project}/instances/{instance}:generateEphemeralCert",
                                                          body: "*",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["instance", %r{^[^/]+/?$}, false]
