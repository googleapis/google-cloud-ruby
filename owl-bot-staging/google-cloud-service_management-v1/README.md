...
```
$ gem install google-cloud-service_management-v1
```
...
1. [Enable the API.](https://console.cloud.google.com/apis/library/servicemanagement.googleapis.com)
...
client library with a name such as `google-cloud-service_management`,
...
is part of the name, e.g. `google-cloud-service_management-v1`.
