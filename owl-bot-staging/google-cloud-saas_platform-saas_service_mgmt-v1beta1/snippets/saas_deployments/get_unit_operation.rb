...
##
# Snippet for the get_unit_operation call in the SaasDeployments service
#
...
# Google::Cloud::SaasPlatform::SaasServiceMgmt::V1beta1::SaasDeployments::Client#get_unit_operation.
#
