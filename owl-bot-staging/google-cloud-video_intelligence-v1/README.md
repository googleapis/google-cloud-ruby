...
```
$ gem install google-cloud-video_intelligence-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-video_intelligence-v1/latest)
