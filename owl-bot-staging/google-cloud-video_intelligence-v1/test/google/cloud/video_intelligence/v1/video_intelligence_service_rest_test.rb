...
class ::Google::Cloud::VideoIntelligence::V1::VideoIntelligenceService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VideoIntelligence::V1::VideoIntelligenceService::Rest::Client::Configuration, config
  end
end
