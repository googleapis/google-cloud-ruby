...
::Google::Cloud.configure.add_config! :filestore do |config|
  config.add_field! :endpoint,      "file.googleapis.com", match: ::String
...
module Google
  module Cloud
    module Filestore
      ...
      #   Defaults to `:v1`.
      # @return [CloudFilestoreManager::Client] A client object for the specified version.
      #
      def self.cloud_filestore_manager version: :v1, &block
        ...
        package_name = Google::Cloud::Filestore
                       ...
                       .first
        package_module = Google::Cloud::Filestore.const_get package_name
        package_module.const_get(:CloudFilestoreManager).const_get(:Client).new(&block)
      end
