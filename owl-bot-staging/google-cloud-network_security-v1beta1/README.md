...
```
$ gem install google-cloud-network_security-v1beta1
```
...
client library with a name such as `google-cloud-network_security`,
...
is part of the name, e.g. `google-cloud-network_security-v1beta1`.
