...
##
# Snippet for the create_authorization_policy call in the NetworkSecurity service
#
...
# Google::Cloud::NetworkSecurity::V1beta1::NetworkSecurity::Client#create_authorization_policy.
#
