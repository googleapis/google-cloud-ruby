...
In general, the google-cloud-binary_authorization library uses
...
The google-cloud-binary_authorization library aims to make authentication
...
Google::Cloud::BinaryAuthorization.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-binary_authorization.
