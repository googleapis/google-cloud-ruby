...
module Google
  module Cloud
    module Dataform
      ...
      # given API version does not support the given transport of the Dataform service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::Dataform.dataform_available?}.
      #
      # ## About Dataform
      #
      ...
      ##
      # Determines whether the Dataform service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::Dataform.dataform}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the Dataform service,
      # or if the versioned client gem needs an update to support the Dataform service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1beta1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
      ...
      #
      def self.dataform_available? version: :v1beta1, transport: :grpc
        require "google/cloud/dataform/#{version.to_s.downcase}"
        package_name = Google::Cloud::Dataform
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::Dataform.const_get package_name
        return false unless service_module.const_defined? :Dataform
        service_module = service_module.const_get :Dataform
        if transport == :rest
