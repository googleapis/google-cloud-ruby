...
class ::Google::Cloud::LicenseManager::V1::LicenseManager::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_configuration_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.configuration_path project: "value0", location: "value1", configuration: "value2"
      assert_equal "projects/value0/locations/value1/configurations/value2", path
    end
  end
