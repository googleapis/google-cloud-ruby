...
specific version of the Cloud Functions V2 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-functions-v2
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-functions-v2/latest)
