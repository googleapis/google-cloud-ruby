...
class Google::Cloud::ConfidentialComputing::ClientConstructionMinitest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_confidential_computing_rest
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
      ...
      assert_kind_of Google::Cloud::ConfidentialComputing::V1::ConfidentialComputing::Rest::Client, client
    end
  end
end
