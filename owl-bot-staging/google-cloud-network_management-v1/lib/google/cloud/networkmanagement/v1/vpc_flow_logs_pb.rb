  ...
  module Cloud
    module NetworkManagement
      module V1
        ...
        QueryOrgVpcFlowLogsConfigsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.networkmanagement.v1.QueryOrgVpcFlowLogsConfigsRequest").msgclass
        QueryOrgVpcFlowLogsConfigsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.networkmanagement.v1.QueryOrgVpcFlowLogsConfigsResponse").msgclass
        ShowEffectiveFlowLogsConfigsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.networkmanagement.v1.ShowEffectiveFlowLogsConfigsRequest").msgclass
        ShowEffectiveFlowLogsConfigsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.networkmanagement.v1.ShowEffectiveFlowLogsConfigsResponse").msgclass
      end
    end
  end
end
