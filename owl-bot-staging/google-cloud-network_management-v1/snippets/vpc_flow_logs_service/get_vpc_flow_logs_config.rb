...
##
# Snippet for the get_vpc_flow_logs_config call in the VpcFlowLogsService service
#
...
# Google::Cloud::NetworkManagement::V1::VpcFlowLogsService::Client#get_vpc_flow_logs_config.
#
