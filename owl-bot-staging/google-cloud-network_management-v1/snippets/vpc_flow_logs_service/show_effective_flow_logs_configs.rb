...
##
# Snippet for the show_effective_flow_logs_configs call in the VpcFlowLogsService service
#
...
# Google::Cloud::NetworkManagement::V1::VpcFlowLogsService::Client#show_effective_flow_logs_configs.
#
