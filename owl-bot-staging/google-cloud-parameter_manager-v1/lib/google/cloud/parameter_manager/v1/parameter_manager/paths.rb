      ...
      module V1
        module ParameterManager
          ...
          module Paths
            ...
            #
            # @return [::String]
            def parameter_path project:, location:, parameter:
              raise ::ArgumentError, "project cannot contain /" if project.to_s.include? "/"
            ...
            #
            # @return [::String]
            def parameter_version_path project:, location:, parameter:, parameter_version:
              raise ::ArgumentError, "project cannot contain /" if project.to_s.include? "/"
              raise ::ArgumentError, "location cannot contain /" if location.to_s.include? "/"
              raise ::ArgumentError, "parameter cannot contain /" if parameter.to_s.include? "/"
