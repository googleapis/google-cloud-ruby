...
class ::Google::Cloud::ParameterManager::V1::ParameterManager::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_parameter_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.parameter_path project: "value0", location: "value1", parameter: "value2"
      assert_equal "projects/value0/locations/value1/parameters/value2", path
    end
  end
  ...
  def test_parameter_version_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.parameter_version_path project: "value0", location: "value1", parameter: "value2", parameter_version: "value3"
