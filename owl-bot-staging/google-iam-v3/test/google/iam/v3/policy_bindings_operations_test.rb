...
require "google/iam/v3/policy_bindings_service_services_pb"
require "google/iam/v3/policy_bindings"

class ::Google::Iam::V3::PolicyBindings::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Iam::V3::PolicyBindings::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Iam::V3::PolicyBindings::Operations::Configuration, config
  end
end
