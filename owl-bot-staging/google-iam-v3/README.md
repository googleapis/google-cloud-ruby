# Ruby Client for the Identity and Access Management (IAM) V3 API
...
specific version of the Identity and Access Management (IAM) V3 API. Most users should consider using
the main client gem,
...
is part of the name, e.g. `google-iam-v3`.
