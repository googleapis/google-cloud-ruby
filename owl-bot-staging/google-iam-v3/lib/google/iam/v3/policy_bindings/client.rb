    ...
    module V3
      module PolicyBindings
        ...
        class Client
          ...
          #
          # See {::Google::Iam::V3::PolicyBindings::Client::Configuration}
          ...
          def initialize
            ...
            @policy_bindings_stub = ::Gapic::ServiceStub.new(
              ::Google::Iam::V3::PolicyBindings::Stub,
          ...
          #
          # @return [::Google::Iam::V3::PolicyBindings::Operations]
          #
          ...
          #
          # @yield [response, operation] Access the result along with the RPC operation
          # @yieldparam response [::Google::Iam::V3::PolicyBinding]
          # @yieldparam operation [::GRPC::ActiveCall::Operation]
          #
          ...
          # {::Google::Iam::V3::PolicyBindings::Client::Configuration::Rpcs}
