...
require "google/iam/v3/access_policies/rest/service_stub"
      ...
      module AccessPolicies
        module Rest
          ...
          class Client
            ...
            #
            # See {::Google::Iam::V3::AccessPolicies::Rest::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all AccessPolicies clients
            #   ::Google::Iam::V3::AccessPolicies::Rest::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @operations_client = ::Google::Iam::V3::AccessPolicies::Rest::Operations.new do |config|
              ...
              @access_policies_stub = ::Google::Iam::V3::AccessPolicies::Rest::ServiceStub.new(
            ...
            #
            # @return [::Google::Iam::V3::AccessPolicies::Rest::Operations]
            #
            ...
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Google::Iam::V3::AccessPolicy]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            ...
            #     page token.
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Iam::V3::AccessPolicy>]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Gapic::Rest::PagedEnumerable<::Google::Iam::V3::AccessPolicy>]
            #
            # @raise [::Google::Cloud::Error] if the REST call is aborted.
            #
            # @example Basic example
            ...
            # {::Google::Iam::V3::AccessPolicies::Rest::Client::Configuration::Rpcs}
