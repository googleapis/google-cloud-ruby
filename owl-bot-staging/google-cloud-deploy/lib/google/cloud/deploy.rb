...
::Google::Cloud.configure.add_config! :deploy do |config|
  config.add_field! :endpoint,      "clouddeploy.googleapis.com", match: ::String
...
module Google
  module Cloud
    module Deploy
      ...
      #
      def self.cloud_deploy version: :v1, &block
        ...
        package_name = Google::Cloud::Deploy
                       ...
                       .first
        package_module = Google::Cloud::Deploy.const_get package_name
        package_module.const_get(:CloudDeploy).const_get(:Client).new(&block)
      end
