        ...
        module SystemPolicy
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all SystemPolicy clients
              #   ::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              # {::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::Rest::Client::Configuration::Rpcs}
