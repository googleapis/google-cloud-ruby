...
class ::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::Rest::Client::Configuration, config
  end
end
