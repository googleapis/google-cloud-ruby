...
class ::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::ClientTest < Minitest::Test
  ...
  def test_get_system_policy
    ...
    Gapic::ServiceStub.stub :new, get_system_policy_client_stub do
      ...
      # Use protobuf object
      client.get_system_policy ::Google::Cloud::BinaryAuthorization::V1::GetSystemPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.get_system_policy(::Google::Cloud::BinaryAuthorization::V1::GetSystemPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
