...
class ::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_system_policy
    ...
    get_system_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::BinaryAuthorization::V1::GetSystemPolicyRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_system_policy_client_stub do
      # Create client
      c = ::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::Client.new do |config|
      ...
      # Use protobuf object
      c.get_system_policy ::Google::Cloud::BinaryAuthorization::V1::GetSystemPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.get_system_policy(::Google::Cloud::BinaryAuthorization::V1::GetSystemPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::BinaryAuthorization::V1::SystemPolicy::Client::Configuration, config
  end
