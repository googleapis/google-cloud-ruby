...
class ::Google::Cloud::BinaryAuthorization::V1::ValidationHelper::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_validate_attestation_occurrence
    # Create test objects.
    client_result = ::Google::Cloud::BinaryAuthorization::V1::ValidateAttestationOccurrenceResponse.new
    ...
    validate_attestation_occurrence_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::BinaryAuthorization::V1::ValidationHelper::Rest::ServiceStub.stub :transcode_validate_attestation_occurrence_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, validate_attestation_occurrence_client_stub do
        ...
        # Verify method calls
        assert_equal 5, validate_attestation_occurrence_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::BinaryAuthorization::V1::ValidationHelper::Rest::Client::Configuration, config
  end
end
