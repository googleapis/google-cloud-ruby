...
require File.expand_path("lib/google/shopping/merchant/conversions/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-conversions-v1"
  gem.version       = Google::Shopping::Merchant::Conversions::V1::VERSION
