...
```
$ gem install google-shopping-merchant-conversions-v1
```
...
request = ::Google::Shopping::Merchant::Conversions::V1::CreateConversionSourceRequest.new # (request fields as keyword arguments...)
response = client.create_conversion_source request
```

View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-conversions-v1)
...
is part of the name, e.g. `google-shopping-merchant-conversions-v1`.
