# Ruby Client for the Secret Manager V1BETA2 API
...
specific version of the Secret Manager V1BETA2 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-secret_manager-v1beta2
```
...
request = ::Google::Cloud::SecretManager::V1beta2::ListSecretsRequest.new # (request fields as keyword arguments...)
...
is part of the name, e.g. `google-cloud-secret_manager-v1beta2`.
