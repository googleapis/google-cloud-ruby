...
require File.expand_path("lib/google/shopping/merchant/inventories/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-inventories-v1"
  gem.version       = Google::Shopping::Merchant::Inventories::V1::VERSION
