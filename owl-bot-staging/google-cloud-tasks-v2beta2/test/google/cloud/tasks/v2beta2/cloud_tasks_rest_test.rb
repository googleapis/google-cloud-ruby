...
class ::Google::Cloud::Tasks::V2beta2::CloudTasks::Rest::ClientTest < Minitest::Test
  ...
  def test_buffer_task
    # Create test objects.
    client_result = ::Google::Cloud::Tasks::V2beta2::BufferTaskResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::Tasks::V2beta2::CloudTasks::Rest::ServiceStub.stub :transcode_buffer_task_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, buffer_task_client_stub do
        ...
        # Use protobuf object
        client.buffer_task ::Google::Cloud::Tasks::V2beta2::BufferTaskRequest.new(queue: queue, task_id: task_id, body: body) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.buffer_task(::Google::Cloud::Tasks::V2beta2::BufferTaskRequest.new(queue: queue, task_id: task_id, body: body), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
