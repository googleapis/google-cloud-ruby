# Ruby Client for the Service Health V1 API
...
specific version of the Service Health V1 API. Most users should consider using
the main client gem,
[google-cloud-service_health](https://rubygems.org/gems/google-cloud-service_health).
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-service_health-v1/latest)
