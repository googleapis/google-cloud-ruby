...
class ::Google::Cloud::ServiceHealth::V1::ServiceHealth::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_events
    # Create test objects.
    client_result = ::Google::Cloud::ServiceHealth::V1::ListEventsResponse.new
  ...
  def test_get_event
    # Create test objects.
    client_result = ::Google::Cloud::ServiceHealth::V1::Event.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_organization_events
    # Create test objects.
    client_result = ::Google::Cloud::ServiceHealth::V1::ListOrganizationEventsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_organization_events_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ServiceHealth::V1::ServiceHealth::Rest::ServiceStub.stub :transcode_list_organization_events_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_organization_events_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_organization_events_client_stub.call_count
      end
    end
  end
  ...
  def test_get_organization_event
    # Create test objects.
    client_result = ::Google::Cloud::ServiceHealth::V1::OrganizationEvent.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_organization_event_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ServiceHealth::V1::ServiceHealth::Rest::ServiceStub.stub :transcode_get_organization_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_organization_event_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_organization_event_client_stub.call_count
      end
    end
  end
  ...
  def test_list_organization_impacts
    # Create test objects.
    client_result = ::Google::Cloud::ServiceHealth::V1::ListOrganizationImpactsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_organization_impacts_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ServiceHealth::V1::ServiceHealth::Rest::ServiceStub.stub :transcode_list_organization_impacts_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_organization_impacts_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_organization_impacts_client_stub.call_count
      end
    end
  end
  ...
  def test_get_organization_impact
    # Create test objects.
    client_result = ::Google::Cloud::ServiceHealth::V1::OrganizationImpact.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_organization_impact_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ServiceHealth::V1::ServiceHealth::Rest::ServiceStub.stub :transcode_get_organization_impact_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_organization_impact_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_organization_impact_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ServiceHealth::V1::ServiceHealth::Rest::Client::Configuration, config
  end
end
