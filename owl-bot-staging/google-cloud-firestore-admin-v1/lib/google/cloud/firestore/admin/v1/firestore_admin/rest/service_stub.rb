          ...
          module FirestoreAdmin
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::BulkDeleteDocumentsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @return [::Google::Longrunning::Operation]
                #   A result object deserialized from the server's reply
                def bulk_delete_documents request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_bulk_delete_documents_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                ...
                ##
                # Baseline implementation for the create_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::CreateUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #   A result object deserialized from the server's reply
                def create_user_creds request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_create_user_creds_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "create_user_creds",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Cloud::Firestore::Admin::V1::UserCreds.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                ##
                # Baseline implementation for the get_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::GetUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @return [::Google::Cloud::Firestore::Admin::V1::UserCreds]
                #   A result object deserialized from the server's reply
                def get_user_creds request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_get_user_creds_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                ...
                ##
                # Baseline implementation for the list_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::ListUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #   A result object deserialized from the server's reply
                def list_user_creds request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_list_user_creds_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "list_user_creds",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Cloud::Firestore::Admin::V1::ListUserCredsResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                ##
                # Baseline implementation for the enable_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::EnableUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @return [::Google::Cloud::Firestore::Admin::V1::UserCreds]
                #   A result object deserialized from the server's reply
                def enable_user_creds request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_enable_user_creds_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                ...
                ##
                # Baseline implementation for the disable_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::DisableUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @return [::Google::Cloud::Firestore::Admin::V1::UserCreds]
                #   A result object deserialized from the server's reply
                def disable_user_creds request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_disable_user_creds_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "disable_user_creds",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Cloud::Firestore::Admin::V1::UserCreds.decode_json response.body, ignore_unknown_fields: true
                ...
                ##
                # Baseline implementation for the reset_user_password REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::ResetUserPasswordRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @return [::Google::Cloud::Firestore::Admin::V1::UserCreds]
                #   A result object deserialized from the server's reply
                def reset_user_password request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_reset_user_password_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                ...
                ##
                # Baseline implementation for the delete_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::DeleteUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @return [::Google::Protobuf::Empty]
                #   A result object deserialized from the server's reply
                def delete_user_creds request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_delete_user_creds_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                ...
                # @private
                #
                # GRPC transcoding helper method for the bulk_delete_documents REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::BulkDeleteDocumentsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_bulk_delete_documents_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/v1/{name}:bulkDeleteDocuments",
                                                            body: "*",
                                                            matches: [
                                                              ["name", %r{^projects/[^/]+/databases/[^/]+/?$}, false]
                                                            ]
                ...
                # @private
                #
                # GRPC transcoding helper method for the create_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::CreateUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_create_user_creds_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/v1/{parent}/userCreds",
                                                            body: "user_creds",
                                                            matches: [
                ...
                # @private
                #
                # GRPC transcoding helper method for the get_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::GetUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_get_user_creds_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/v1/{name}",
                                                            matches: [
                                                              ["name", %r{^projects/[^/]+/databases/[^/]+/userCreds/[^/]+/?$}, false]
                                                            ]
                                                          )
                  transcoder.transcode request_pb
                end
                ...
                # @private
                #
                # GRPC transcoding helper method for the list_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::ListUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_list_user_creds_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/v1/{parent}/userCreds",
                ...
                # @private
                #
                # GRPC transcoding helper method for the enable_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::EnableUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_enable_user_creds_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                ...
                # @private
                #
                # GRPC transcoding helper method for the disable_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::DisableUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_disable_user_creds_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                ...
                # @private
                #
                # GRPC transcoding helper method for the reset_user_password REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::ResetUserPasswordRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_reset_user_password_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/v1/{name}:resetPassword",
                                                            body: "*",
                                                            matches: [
                                                              ["name", %r{^projects/[^/]+/databases/[^/]+/userCreds/[^/]+/?$}, false]
                                                            ]
                ...
                # @private
                #
                # GRPC transcoding helper method for the delete_user_creds REST call
                #
                # @param request_pb [::Google::Cloud::Firestore::Admin::V1::DeleteUserCredsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_delete_user_creds_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :delete,
                                                            uri_template: "/v1/{name}",
