...
class ::Google::Cloud::Billing::V1::CloudCatalog::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_services
    # Create test objects.
    client_result = ::Google::Cloud::Billing::V1::ListServicesResponse.new
  ...
  def test_list_skus
    # Create test objects.
    client_result = ::Google::Cloud::Billing::V1::ListSkusResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Billing::V1::CloudCatalog::Rest::Client::Configuration, config
  end
end
