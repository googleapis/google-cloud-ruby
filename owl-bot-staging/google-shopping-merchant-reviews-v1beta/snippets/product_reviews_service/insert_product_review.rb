...
##
# Snippet for the insert_product_review call in the ProductReviewsService service
#
...
# Google::Shopping::Merchant::Reviews::V1beta::ProductReviewsService::Client#insert_product_review.
#
