...
##
# Snippet for the insert_merchant_review call in the MerchantReviewsService service
#
...
# Google::Shopping::Merchant::Reviews::V1beta::MerchantReviewsService::Client#insert_merchant_review.
#
