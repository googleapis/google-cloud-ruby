...
##
# Snippet for the delete_merchant_review call in the MerchantReviewsService service
#
...
# Google::Shopping::Merchant::Reviews::V1beta::MerchantReviewsService::Client#delete_merchant_review.
#
