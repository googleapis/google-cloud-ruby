...
class ::Google::Shopping::Merchant::Reviews::V1beta::MerchantReviewsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_merchant_review_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.merchant_review_path account: "value0", name: "value1"
      assert_equal "accounts/value0/merchantReviews/value1", path
    end
  end
end
