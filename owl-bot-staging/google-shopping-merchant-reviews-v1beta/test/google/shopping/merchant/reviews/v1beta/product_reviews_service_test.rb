...
require "google/shopping/merchant/reviews/v1beta/product_reviews_service"

class ::Google::Shopping::Merchant::Reviews::V1beta::ProductReviewsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_product_review
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Reviews::V1beta::ProductReview.new
    ...
    get_product_review_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_product_review, name
      assert_kind_of ::Google::Shopping::Merchant::Reviews::V1beta::GetProductReviewRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_product_review_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_product_review_client_stub.call_rpc_count
    end
  end

  def test_list_product_reviews
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Reviews::V1beta::ListProductReviewsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_product_reviews_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_product_reviews, name
      assert_kind_of ::Google::Shopping::Merchant::Reviews::V1beta::ListProductReviewsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_product_reviews_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_product_reviews_client_stub.call_rpc_count
    end
  end

  def test_insert_product_review
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Reviews::V1beta::ProductReview.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    insert_product_review_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :insert_product_review, name
      assert_kind_of ::Google::Shopping::Merchant::Reviews::V1beta::InsertProductReviewRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Reviews::V1beta::ProductReview), request["product_review"]
    ...
    Gapic::ServiceStub.stub :new, insert_product_review_client_stub do
      ...
      # Verify method calls
      assert_equal 5, insert_product_review_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_product_review
    ...
    delete_product_review_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_product_review, name
      assert_kind_of ::Google::Shopping::Merchant::Reviews::V1beta::DeleteProductReviewRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_product_review_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_product_review_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Reviews::V1beta::ProductReviewsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Reviews::V1beta::ProductReviewsService::Client, client
