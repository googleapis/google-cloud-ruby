...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-gke_multi_cloud/latest)
for this library, google-cloud-gke_multi_cloud, to see the convenience methods for
...
```
$ gem install google-cloud-gke_multi_cloud
```
