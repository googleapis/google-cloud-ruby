...
module Google
  module Cloud
    module Ces
      module V1beta
        Changelog = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.ces.v1beta.Changelog").msgclass
      end
    end
  end
end
