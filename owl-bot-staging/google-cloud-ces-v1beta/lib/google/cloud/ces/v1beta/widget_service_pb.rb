...
module Google
  module Cloud
    module Ces
      module V1beta
        GenerateChatTokenRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.ces.v1beta.GenerateChatTokenRequest").msgclass
        GenerateChatTokenResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.ces.v1beta.GenerateChatTokenResponse").msgclass
      end
    end
  end
end
