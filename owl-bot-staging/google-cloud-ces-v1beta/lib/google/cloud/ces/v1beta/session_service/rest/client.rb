...
require "google/cloud/ces/v1beta/session_service/rest/service_stub"
        ...
        module SessionService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Ces::V1beta::SessionService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all SessionService clients
              #   ::Google::Cloud::Ces::V1beta::SessionService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @session_service_stub = ::Google::Cloud::Ces::V1beta::SessionService::Rest::ServiceStub.new(
