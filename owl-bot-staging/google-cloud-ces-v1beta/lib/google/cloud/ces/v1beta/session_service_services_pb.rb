...
# Source: google/cloud/ces/v1beta/session_service.proto for package 'google.cloud.ces.v1beta'
      ...
      module V1beta
        module SessionService
          ...
          class Service
            ...
            self.service_name = 'google.cloud.ces.v1beta.SessionService'

            # Initiates a single-turn interaction with the CES agent within a session.
            rpc :RunSession, ::Google::Cloud::Ces::V1beta::RunSessionRequest, ::Google::Cloud::Ces::V1beta::RunSessionResponse
            ...
            # to true.
            rpc :StreamRunSession, ::Google::Cloud::Ces::V1beta::RunSessionRequest, stream(::Google::Cloud::Ces::V1beta::RunSessionResponse)
            ...
            rpc :BidiRunSession, stream(::Google::Cloud::Ces::V1beta::BidiSessionClientMessage), stream(::Google::Cloud::Ces::V1beta::BidiSessionServerMessage)
          end
