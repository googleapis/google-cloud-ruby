          ...
          module Rest
            ...
            class Client
              ...
              def get_security_settings request, options = nil
                ...
                @agent_service_stub.get_security_settings request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def update_security_settings request, options = nil
                ...
                @agent_service_stub.update_security_settings request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def generate_app_resource request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.generate_app_resource.metadata.to_h
                ...
                @agent_service_stub.generate_app_resource request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
