...
In general, the google-cloud-recommender library uses
...
The google-cloud-recommender library aims to make authentication
...
connect to most services with google-cloud-recommender.
