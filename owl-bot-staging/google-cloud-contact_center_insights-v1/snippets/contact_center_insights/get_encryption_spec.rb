...
##
# Snippet for the get_encryption_spec call in the ContactCenterInsights service
#
...
# Google::Cloud::ContactCenterInsights::V1::ContactCenterInsights::Client#get_encryption_spec.
#
