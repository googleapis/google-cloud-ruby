...
##
# Snippet for the delete_qa_scorecard call in the ContactCenterInsights service
#
...
# Google::Cloud::ContactCenterInsights::V1::ContactCenterInsights::Client#delete_qa_scorecard.
#
