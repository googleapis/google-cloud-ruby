...
##
# Snippet for the query_metrics call in the ContactCenterInsights service
#
...
# Google::Cloud::ContactCenterInsights::V1::ContactCenterInsights::Client#query_metrics.
#
def query_metrics
