...
The recommended way to authenticate to the google-cloud-workflows library is to use
...
The google-cloud-workflows library provides several mechanisms to configure your system.
