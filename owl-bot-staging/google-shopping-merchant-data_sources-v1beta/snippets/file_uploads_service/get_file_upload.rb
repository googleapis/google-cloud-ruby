...
##
# Snippet for the get_file_upload call in the FileUploadsService service
#
...
# Google::Shopping::Merchant::DataSources::V1beta::FileUploadsService::Client#get_file_upload.
#
def get_file_upload
