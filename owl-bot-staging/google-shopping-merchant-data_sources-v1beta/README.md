...
```
$ gem install google-shopping-merchant-data_sources-v1beta
```
...
View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-data_sources-v1beta)
