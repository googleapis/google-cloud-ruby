...
##
# Snippet for the test_iam_permissions call in the DatabaseAdmin service
#
...
# Google::Cloud::Spanner::Admin::Database::V1::DatabaseAdmin::Client#test_iam_permissions.
#
