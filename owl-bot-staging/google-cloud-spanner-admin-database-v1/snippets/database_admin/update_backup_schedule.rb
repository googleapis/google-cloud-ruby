...
##
# Snippet for the update_backup_schedule call in the DatabaseAdmin service
#
...
# Google::Cloud::Spanner::Admin::Database::V1::DatabaseAdmin::Client#update_backup_schedule.
#
