      ...
      module Admin
        module Database
          module V1
            ...
            IncrementalBackupSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.spanner.admin.database.v1.IncrementalBackupSpec").msgclass
          end
        end
      end
    end
