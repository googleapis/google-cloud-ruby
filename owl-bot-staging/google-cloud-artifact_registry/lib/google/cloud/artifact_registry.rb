...
require "google/cloud/artifact_registry/version"
...
::Google::Cloud.configure.add_config! :artifact_registry do |config|
  config.add_field! :endpoint,      "artifactregistry.googleapis.com", match: ::String
...
module Google
  module Cloud
    module ArtifactRegistry
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.artifact_registry if block_given?
...
require "google/cloud/artifact_registry/helpers" if ::File.file? helper_path
