...
class Google::Cloud::ArtifactRegistry::ClientConstructionMinitest < Minitest::Test
  ...
  def test_artifact_registry_grpc
    skip unless Google::Cloud::ArtifactRegistry.artifact_registry_available? transport: :grpc
  ...
  def test_artifact_registry_rest
    skip unless Google::Cloud::ArtifactRegistry.artifact_registry_available? transport: :rest
