          ...
          module CloudRedisCluster
            module Rest
              ...
              class Client
                ...
                #   {::Google::Cloud::Redis::Cluster::V1::GetSharedRegionalCertificateAuthorityRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Cloud::Redis::Cluster::V1::GetSharedRegionalCertificateAuthorityRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Cloud::Redis::Cluster::V1::SharedRegionalCertificateAuthority]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Cloud::Redis::Cluster::V1::SharedRegionalCertificateAuthority]
                #
                # @raise [::Google::Cloud::Error] if the REST call is aborted.
                #
                # @example Basic example
                ...
                #
                #   # Create a request. To set request fields, pass in keyword arguments.
                #   request = Google::Cloud::Redis::Cluster::V1::GetSharedRegionalCertificateAuthorityRequest.new
                #
                #   # Call the get_shared_regional_certificate_authority method.
                #   result = client.get_shared_regional_certificate_authority request
                #
                #   # The returned object is of type Google::Cloud::Redis::Cluster::V1::SharedRegionalCertificateAuthority.
                #   p result
                #
                def get_shared_regional_certificate_authority request, options = nil
                  raise ::ArgumentError, "request must be provided" if request.nil?

                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Redis::Cluster::V1::GetSharedRegionalCertificateAuthorityRequest
