...
class ::Google::Cloud::Redis::Cluster::V1::CloudRedisCluster::Rest::ClientTest < Minitest::Test
  ...
  def test_get_shared_regional_certificate_authority
    # Create test objects.
    client_result = ::Google::Cloud::Redis::Cluster::V1::SharedRegionalCertificateAuthority.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_backup_collections
    # Create test objects.
    client_result = ::Google::Cloud::Redis::Cluster::V1::ListBackupCollectionsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_get_backup_collection
    # Create test objects.
    client_result = ::Google::Cloud::Redis::Cluster::V1::BackupCollection.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_backups
    # Create test objects.
    client_result = ::Google::Cloud::Redis::Cluster::V1::ListBackupsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_get_backup
    # Create test objects.
    client_result = ::Google::Cloud::Redis::Cluster::V1::Backup.new
    http_response = OpenStruct.new body: client_result.to_json
