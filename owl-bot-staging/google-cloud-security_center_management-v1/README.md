...
```
$ gem install google-cloud-security_center_management-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-security_center_management-v1/latest)
...
client library with a name such as `google-cloud-security_center_management`,
...
is part of the name, e.g. `google-cloud-security_center_management-v1`.
