...
class ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_cloud_locations
    # Create test objects.
    client_result = ::Google::Cloud::LocationFinder::V1::ListCloudLocationsResponse.new
    ...
    list_cloud_locations_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::Rest::ServiceStub.stub :transcode_list_cloud_locations_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_cloud_locations_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_cloud_locations_client_stub.call_count
      end
    end
  end
  ...
  def test_get_cloud_location
    # Create test objects.
    client_result = ::Google::Cloud::LocationFinder::V1::CloudLocation.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_cloud_location_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::Rest::ServiceStub.stub :transcode_get_cloud_location_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_cloud_location_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_cloud_location_client_stub.call_count
      end
    end
  end
  ...
  def test_search_cloud_locations
    # Create test objects.
    client_result = ::Google::Cloud::LocationFinder::V1::SearchCloudLocationsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    search_cloud_locations_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::Rest::ServiceStub.stub :transcode_search_cloud_locations_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_cloud_locations_client_stub do
        ...
        # Verify method calls
        assert_equal 5, search_cloud_locations_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::Rest::Client::Configuration, config
  end
end
