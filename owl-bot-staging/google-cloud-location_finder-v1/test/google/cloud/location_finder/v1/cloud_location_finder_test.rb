...
class ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_cloud_locations
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::LocationFinder::V1::ListCloudLocationsResponse.new
    ...
    list_cloud_locations_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_cloud_locations, name
      assert_kind_of ::Google::Cloud::LocationFinder::V1::ListCloudLocationsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_cloud_locations_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_cloud_locations_client_stub.call_rpc_count
    end
  end

  def test_get_cloud_location
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::LocationFinder::V1::CloudLocation.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_cloud_location_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_cloud_location, name
      assert_kind_of ::Google::Cloud::LocationFinder::V1::GetCloudLocationRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_cloud_location_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_cloud_location_client_stub.call_rpc_count
    end
  end

  def test_search_cloud_locations
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::LocationFinder::V1::SearchCloudLocationsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    # Create request parameters for a unary method.
    parent = "hello world"
    source_cloud_location = "hello world"
    page_size = 42
    page_token = "hello world"
    query = "hello world"

    search_cloud_locations_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :search_cloud_locations, name
      assert_kind_of ::Google::Cloud::LocationFinder::V1::SearchCloudLocationsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["source_cloud_location"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
    ...
    Gapic::ServiceStub.stub :new, search_cloud_locations_client_stub do
      ...
      # Verify method calls
      assert_equal 5, search_cloud_locations_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::LocationFinder::V1::CloudLocationFinder::Client, client
