...
In general, the google-cloud-service_management library uses
...
The google-cloud-service_management library aims to make authentication
...
The environment variables that google-cloud-service_management
...
Google::Cloud::ServiceManagement.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-service_management.
