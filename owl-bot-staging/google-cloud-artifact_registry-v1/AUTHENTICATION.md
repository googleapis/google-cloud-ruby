...
The recommended way to authenticate to the google-cloud-artifact_registry-v1 library is to use
...
The google-cloud-artifact_registry-v1 library provides several mechanisms to configure your system.
