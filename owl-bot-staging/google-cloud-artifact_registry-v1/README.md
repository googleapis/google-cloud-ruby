...
specific version of the Artifact Registry V1 API. Most users should consider using
the main client gem,
[google-cloud-artifact_registry](https://rubygems.org/gems/google-cloud-artifact_registry).
