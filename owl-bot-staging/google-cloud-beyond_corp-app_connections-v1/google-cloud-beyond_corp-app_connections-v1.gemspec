...
require File.expand_path("lib/google/cloud/beyond_corp/app_connections/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-beyond_corp-app_connections-v1"
  gem.version       = Google::Cloud::BeyondCorp::AppConnections::V1::VERSION
  ...
  gem.summary       = "API Client library for the BeyondCorp AppConnections V1 API"
