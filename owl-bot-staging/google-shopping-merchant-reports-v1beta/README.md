...
```
$ gem install google-shopping-merchant-reports-v1beta
```
...
View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-reports-v1beta)
