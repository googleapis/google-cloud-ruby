...
class ::Google::Ads::DataManager::V1::MarketingDataInsightsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_retrieve_insights
    # Create GRPC objects.
    grpc_response = ::Google::Ads::DataManager::V1::RetrieveInsightsResponse.new
    ...
    parent = "hello world"
    baseline = {}
    user_list_id = "hello world"

    retrieve_insights_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :retrieve_insights, name
      assert_kind_of ::Google::Ads::DataManager::V1::RetrieveInsightsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Ads::DataManager::V1::Baseline), request["baseline"]
      assert_equal "hello world", request["user_list_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, retrieve_insights_client_stub do
      ...
      # Verify method calls
      assert_equal 5, retrieve_insights_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::DataManager::V1::MarketingDataInsightsService::Client::Configuration, config
  end
