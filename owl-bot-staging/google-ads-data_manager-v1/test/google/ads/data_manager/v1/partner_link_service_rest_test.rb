...
class ::Google::Ads::DataManager::V1::PartnerLinkService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_partner_link
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::PartnerLink.new
    ...
    create_partner_link_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::DataManager::V1::PartnerLinkService::Rest::ServiceStub.stub :transcode_create_partner_link_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_partner_link_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_partner_link_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_partner_link
    ...
    delete_partner_link_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::PartnerLinkService::Rest::ServiceStub.stub :transcode_delete_partner_link_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_partner_link_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_partner_link_client_stub.call_count
      end
    end
  end
  ...
  def test_search_partner_links
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::SearchPartnerLinksResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    search_partner_links_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::PartnerLinkService::Rest::ServiceStub.stub :transcode_search_partner_links_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_partner_links_client_stub do
        ...
        # Verify method calls
        assert_equal 5, search_partner_links_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::DataManager::V1::PartnerLinkService::Rest::Client::Configuration, config
  end
end
