...
require 'google/cloud/gkehub/v1/rbacrolebindingactuation/rbacrolebindingactuation_pb'
...
begin
  ...
  imports = [
    ...
    ["google.cloud.gkehub.rbacrolebindingactuation.v1.FeatureState", "google/cloud/gkehub/v1/rbacrolebindingactuation/rbacrolebindingactuation.proto"],
  ...
  module Cloud
    module GkeHub
      module V1
        ...
        ScopeFeatureSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.gkehub.v1.ScopeFeatureSpec").msgclass
        ScopeFeatureState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.gkehub.v1.ScopeFeatureState").msgclass
