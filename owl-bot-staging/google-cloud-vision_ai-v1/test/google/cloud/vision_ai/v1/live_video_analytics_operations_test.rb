...
class ::Google::Cloud::VisionAI::V1::LiveVideoAnalytics::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::VisionAI::V1::LiveVideoAnalytics::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VisionAI::V1::LiveVideoAnalytics::Operations::Configuration, config
  end
end
