...
require "google/cloud/vision_ai/v1/streaming_service/client"
...
helper_path = ::File.join __dir__, "streaming_service", "helpers.rb"
require "google/cloud/vision_ai/v1/streaming_service/helpers" if ::File.file? helper_path
