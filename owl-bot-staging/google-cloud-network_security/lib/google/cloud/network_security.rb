...
module Google
  module Cloud
    module NetworkSecurity
      ...
      # given API version does not support the given transport of the NetworkSecurity service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::NetworkSecurity.network_security_available?}.
      #
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::NetworkSecurity.network_security}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the NetworkSecurity service,
      # or if the versioned client gem needs an update to support the NetworkSecurity service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1beta1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
      ...
      #
      def self.network_security_available? version: :v1beta1, transport: :grpc
        require "google/cloud/network_security/#{version.to_s.downcase}"
        package_name = Google::Cloud::NetworkSecurity
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        return false unless service_module.const_defined? :NetworkSecurity
        service_module = service_module.const_get :NetworkSecurity
        if transport == :rest
