...
require "google/cloud/security/public_ca/version"
...
::Google::Cloud.configure.add_config! :security_public_ca do |config|
  config.add_field! :endpoint,      "publicca.googleapis.com", match: ::String
  ...
  module Cloud
    module Security
      module PublicCA
        ...
        #
        def self.configure
          yield ::Google::Cloud.configure.security_public_ca if block_given?

          ::Google::Cloud.configure.security_public_ca
        end
      end
    end
  end
