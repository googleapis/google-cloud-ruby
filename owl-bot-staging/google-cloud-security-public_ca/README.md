...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-security-public_ca/latest)
for this library, google-cloud-security-public_ca, to see the convenience methods for
...
```
$ gem install google-cloud-security-public_ca
```
