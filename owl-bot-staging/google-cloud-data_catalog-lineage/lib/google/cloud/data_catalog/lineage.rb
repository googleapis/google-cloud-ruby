...
require "google/cloud/data_catalog/lineage/version"
...
::Google::Cloud.configure.add_config! :data_catalog_lineage do |config|
  config.add_field! :endpoint,      "datalineage.googleapis.com", match: ::String
  ...
  module Cloud
    module DataCatalog
      module Lineage
        ...
        # [Google::Cloud::DataCatalog::Lineage::V1::Lineage::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-data_catalog-lineage-v1/latest/Google-Cloud-DataCatalog-Lineage-V1-Lineage-Client)
