...
require File.expand_path("lib/google/shopping/merchant/products/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-products-v1"
  gem.version       = Google::Shopping::Merchant::Products::V1::VERSION
