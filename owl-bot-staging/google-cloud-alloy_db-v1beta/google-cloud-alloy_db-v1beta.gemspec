...
require File.expand_path("lib/google/cloud/alloy_db/v1beta/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-alloy_db-v1beta"
  gem.version       = Google::Cloud::AlloyDB::V1beta::VERSION
