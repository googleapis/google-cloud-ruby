...
class ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Operations, client.operations_client
  end
end
