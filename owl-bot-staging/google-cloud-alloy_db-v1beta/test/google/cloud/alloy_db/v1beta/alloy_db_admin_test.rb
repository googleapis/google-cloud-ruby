...
class ::Google::Cloud::AlloyDB::V1beta::AlloyDBAdmin::ClientTest < Minitest::Test
  ...
  def test_upgrade_cluster
    ...
    Gapic::ServiceStub.stub :new, upgrade_cluster_client_stub do
      ...
      # Use protobuf object
      client.upgrade_cluster ::Google::Cloud::AlloyDB::V1beta::UpgradeClusterRequest.new(name: name, version: version, request_id: request_id, validate_only: validate_only, etag: etag) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.upgrade_cluster(::Google::Cloud::AlloyDB::V1beta::UpgradeClusterRequest.new(name: name, version: version, request_id: request_id, validate_only: validate_only, etag: etag), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_switchover_cluster
    ...
    Gapic::ServiceStub.stub :new, switchover_cluster_client_stub do
      ...
      # Use protobuf object
      client.switchover_cluster ::Google::Cloud::AlloyDB::V1beta::SwitchoverClusterRequest.new(name: name, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.switchover_cluster(::Google::Cloud::AlloyDB::V1beta::SwitchoverClusterRequest.new(name: name, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_restart_instance
    ...
    Gapic::ServiceStub.stub :new, restart_instance_client_stub do
      ...
      # Use protobuf object
      client.restart_instance ::Google::Cloud::AlloyDB::V1beta::RestartInstanceRequest.new(name: name, request_id: request_id, validate_only: validate_only, node_ids: node_ids) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.restart_instance(::Google::Cloud::AlloyDB::V1beta::RestartInstanceRequest.new(name: name, request_id: request_id, validate_only: validate_only, node_ids: node_ids), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_execute_sql
    ...
    Gapic::ServiceStub.stub :new, execute_sql_client_stub do
      ...
      # Use protobuf object
      client.execute_sql ::Google::Cloud::AlloyDB::V1beta::ExecuteSqlRequest.new(password: password, instance: instance, database: database, user: user, sql_statement: sql_statement, validate_only: validate_only) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.execute_sql(::Google::Cloud::AlloyDB::V1beta::ExecuteSqlRequest.new(password: password, instance: instance, database: database, user: user, sql_statement: sql_statement, validate_only: validate_only), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_databases
    ...
    Gapic::ServiceStub.stub :new, list_databases_client_stub do
      ...
      # Use protobuf object
      client.list_databases ::Google::Cloud::AlloyDB::V1beta::ListDatabasesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_databases(::Google::Cloud::AlloyDB::V1beta::ListDatabasesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_database
    ...
    Gapic::ServiceStub.stub :new, create_database_client_stub do
      ...
      # Use protobuf object
      client.create_database ::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest.new(parent: parent, database_id: database_id, database: database) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_database(::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest.new(parent: parent, database_id: database_id, database: database), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
