...
##
# Snippet for the submit_order call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#submit_order.
#
def submit_order
