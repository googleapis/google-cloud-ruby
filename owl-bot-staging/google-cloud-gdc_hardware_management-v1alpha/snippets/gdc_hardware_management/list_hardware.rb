...
##
# Snippet for the list_hardware call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#list_hardware.
#
def list_hardware
