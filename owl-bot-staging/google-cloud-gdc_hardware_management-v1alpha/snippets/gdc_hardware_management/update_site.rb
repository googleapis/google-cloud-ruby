...
##
# Snippet for the update_site call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#update_site.
#
def update_site
