...
##
# Snippet for the create_zone call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#create_zone.
#
def create_zone
