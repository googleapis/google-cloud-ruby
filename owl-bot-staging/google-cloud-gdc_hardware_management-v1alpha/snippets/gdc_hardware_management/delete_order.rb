...
##
# Snippet for the delete_order call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#delete_order.
#
def delete_order
