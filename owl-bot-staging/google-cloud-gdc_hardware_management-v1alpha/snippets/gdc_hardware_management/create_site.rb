...
##
# Snippet for the create_site call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#create_site.
#
def create_site
