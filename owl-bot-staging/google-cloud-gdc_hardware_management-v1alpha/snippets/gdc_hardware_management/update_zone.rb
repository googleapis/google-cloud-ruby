...
##
# Snippet for the update_zone call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#update_zone.
#
def update_zone
