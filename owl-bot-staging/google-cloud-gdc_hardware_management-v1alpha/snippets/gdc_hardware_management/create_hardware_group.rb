...
##
# Snippet for the create_hardware_group call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#create_hardware_group.
#
