...
##
# Snippet for the delete_zone call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#delete_zone.
#
def delete_zone
