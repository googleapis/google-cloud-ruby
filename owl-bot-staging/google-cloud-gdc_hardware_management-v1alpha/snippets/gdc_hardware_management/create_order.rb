...
##
# Snippet for the create_order call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#create_order.
#
def create_order
