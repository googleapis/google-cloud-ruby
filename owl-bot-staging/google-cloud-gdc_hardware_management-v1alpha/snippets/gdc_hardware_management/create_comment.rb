...
##
# Snippet for the create_comment call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#create_comment.
#
def create_comment
