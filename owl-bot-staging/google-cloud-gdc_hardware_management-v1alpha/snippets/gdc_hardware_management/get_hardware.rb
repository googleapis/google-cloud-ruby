...
##
# Snippet for the get_hardware call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#get_hardware.
#
def get_hardware
