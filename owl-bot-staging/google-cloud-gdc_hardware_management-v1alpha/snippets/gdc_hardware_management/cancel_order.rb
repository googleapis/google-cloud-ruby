...
##
# Snippet for the cancel_order call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#cancel_order.
#
def cancel_order
