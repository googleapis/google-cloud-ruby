...
##
# Snippet for the delete_site call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#delete_site.
#
def delete_site
