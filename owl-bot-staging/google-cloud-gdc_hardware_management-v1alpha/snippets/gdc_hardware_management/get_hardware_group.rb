...
##
# Snippet for the get_hardware_group call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#get_hardware_group.
#
