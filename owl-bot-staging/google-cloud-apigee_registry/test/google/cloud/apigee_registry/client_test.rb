...
class Google::Cloud::ApigeeRegistry::ClientConstructionMinitest < Minitest::Test
  ...
  def test_provisioning_rest
    Gapic::Rest::ClientStub.stub :new, :stub do
      ...
      assert_kind_of Google::Cloud::ApigeeRegistry::V1::Provisioning::Rest::Client, client
    end
  end
  ...
  def test_registry_rest
    Gapic::Rest::ClientStub.stub :new, :stub do
      ...
      assert_kind_of Google::Cloud::ApigeeRegistry::V1::Registry::Rest::Client, client
    end
  end
end
