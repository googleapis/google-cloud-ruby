# Ruby Client for the Apigee Registry API

API Client library for the Apigee Registry API
...
_versioned_ client gems, with names of the form `google-cloud-apigee_registry-v*`.
The gem `google-cloud-apigee_registry` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-apigee_registry/latest)
for this library, google-cloud-apigee_registry, to see the convenience methods for
...
```
$ gem install google-cloud-apigee_registry
```
...
client library with a name such as `google-cloud-apigee_registry`,
...
is part of the name, e.g. `google-cloud-apigee_registry-v1`.
