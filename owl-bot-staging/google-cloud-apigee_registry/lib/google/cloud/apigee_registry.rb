...
require "google/cloud/apigee_registry/version"
...
::Google::Cloud.configure.add_config! :apigee_registry do |config|
  config.add_field! :endpoint,      "apigeeregistry.googleapis.com", match: ::String
...
module Google
  module Cloud
    module ApigeeRegistry
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::ApigeeRegistry::V1::Locations::Client](https://googleapis.dev/ruby/google-cloud-apigee_registry-v1/latest/Google/Cloud/ApigeeRegistry/V1/Locations/Client.html)
      # for version V1 of the API.
      # However, you can specify specify a different API version by passing it in the
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::ApigeeRegistry::V1::IAMPolicy::Client](https://googleapis.dev/ruby/google-cloud-apigee_registry-v1/latest/Google/Cloud/ApigeeRegistry/V1/IAMPolicy/Client.html)
      # for version V1 of the API.
      # However, you can specify specify a different API version by passing it in the
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.apigee_registry if block_given?

        ::Google::Cloud.configure.apigee_registry
      end
    end
  end
end

helper_path = ::File.join __dir__, "apigee_registry", "helpers.rb"
require "google/cloud/apigee_registry/helpers" if ::File.file? helper_path
