...
class ::Google::Cloud::CloudQuotas::V1beta::QuotaAdjusterSettingsManager::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_update_quota_adjuster_settings
    # Create test objects.
    client_result = ::Google::Cloud::CloudQuotas::V1beta::QuotaAdjusterSettings.new
    ...
    update_quota_adjuster_settings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::CloudQuotas::V1beta::QuotaAdjusterSettingsManager::Rest::ServiceStub.stub :transcode_update_quota_adjuster_settings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_quota_adjuster_settings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_quota_adjuster_settings_client_stub.call_count
      end
    end
  end

  def test_get_quota_adjuster_settings
    # Create test objects.
    client_result = ::Google::Cloud::CloudQuotas::V1beta::QuotaAdjusterSettings.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_quota_adjuster_settings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudQuotas::V1beta::QuotaAdjusterSettingsManager::Rest::ServiceStub.stub :transcode_get_quota_adjuster_settings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_quota_adjuster_settings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_quota_adjuster_settings_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::CloudQuotas::V1beta::QuotaAdjusterSettingsManager::Rest::Client::Configuration, config
  end
end
