...
The recommended way to authenticate to the google-cloud-web_risk library is to use
...
The google-cloud-web_risk library provides several mechanisms to configure your system.
