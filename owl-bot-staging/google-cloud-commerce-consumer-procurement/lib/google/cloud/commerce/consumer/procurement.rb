...
require "google/cloud/commerce/consumer/procurement/version"
...
::Google::Cloud.configure.add_config! :commerce_consumer_procurement do |config|
  config.add_field! :endpoint,      "cloudcommerceconsumerprocurement.googleapis.com", match: ::String
    ...
    module Commerce
      module Consumer
        module Procurement
          ...
          # [Google::Cloud::Commerce::Consumer::Procurement::V1::ConsumerProcurementService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-commerce-consumer-procurement-v1/latest/Google-Cloud-Commerce-Consumer-Procurement-V1-ConsumerProcurementService-Client)
...
helper_path = ::File.join __dir__, "procurement", "helpers.rb"
require "google/cloud/commerce/consumer/procurement/helpers" if ::File.file? helper_path
