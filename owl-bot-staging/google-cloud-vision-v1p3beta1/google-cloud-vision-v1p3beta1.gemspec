...
require File.expand_path("lib/google/cloud/vision/v1p3beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-vision-v1p3beta1"
  gem.version       = Google::Cloud::Vision::V1p3beta1::VERSION
  ...
  gem.summary       = "API Client library for the Cloud Vision V1p3beta1 API"
