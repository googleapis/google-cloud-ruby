  ...
  module Cloud
    module NetApp
      module V1
        ...
        BackupVault::BackupRetentionPolicy = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.BackupVault.BackupRetentionPolicy").msgclass
        ...
        BackupVault::BackupVaultType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.BackupVault.BackupVaultType").enummodule
        BackupVault::EncryptionState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.BackupVault.EncryptionState").enummodule
