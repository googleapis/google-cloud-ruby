  ...
  module Cloud
    module NetApp
      module V1
        ...
        UserCommands = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.UserCommands").msgclass
        ...
        HybridReplicationSchedule = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.HybridReplicationSchedule").enummodule
        QosType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.QosType").enummodule
      end
    end
  end
end
