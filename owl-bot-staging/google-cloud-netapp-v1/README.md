# Ruby Client for the NetApp V1 API
...
specific version of the NetApp V1 API. Most users should consider using
the main client gem,
[google-cloud-netapp](https://rubygems.org/gems/google-cloud-netapp).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-netapp-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-netapp-v1/latest)
...
client library with a name such as `google-cloud-netapp`,
...
is part of the name, e.g. `google-cloud-netapp-v1`.
