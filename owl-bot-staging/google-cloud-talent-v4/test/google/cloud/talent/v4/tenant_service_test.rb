...
class ::Google::Cloud::Talent::V4::TenantService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_tenant
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Talent::V4::Tenant.new
    ...
    create_tenant_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Talent::V4::CreateTenantRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Talent::V4::Tenant), request["tenant"]
      refute_nil options
    end
  ...
  def test_get_tenant
    ...
    get_tenant_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Talent::V4::GetTenantRequest, request
  ...
  def test_update_tenant
    ...
    update_tenant_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Talent::V4::UpdateTenantRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Talent::V4::Tenant), request["tenant"]
  ...
  def test_delete_tenant
    ...
    delete_tenant_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Talent::V4::DeleteTenantRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_list_tenants
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Talent::V4::ListTenantsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_tenants_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Talent::V4::ListTenantsRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Talent::V4::TenantService::Client::Configuration, config
  end
end
