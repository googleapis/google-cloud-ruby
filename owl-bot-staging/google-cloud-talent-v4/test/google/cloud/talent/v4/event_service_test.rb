...
class ::Google::Cloud::Talent::V4::EventService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_client_event
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Talent::V4::ClientEvent.new
    ...
    create_client_event_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Talent::V4::CreateClientEventRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Talent::V4::ClientEvent), request["client_event"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_client_event_client_stub do
      ...
      # Use protobuf object
      client.create_client_event ::Google::Cloud::Talent::V4::CreateClientEventRequest.new(parent: parent, client_event: client_event) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.create_client_event(::Google::Cloud::Talent::V4::CreateClientEventRequest.new(parent: parent, client_event: client_event), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Talent::V4::EventService::Client::Configuration, config
  end
end
