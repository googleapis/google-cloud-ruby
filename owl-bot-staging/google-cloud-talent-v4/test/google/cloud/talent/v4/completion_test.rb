...
class ::Google::Cloud::Talent::V4::Completion::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_complete_query
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Talent::V4::CompleteQueryResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Talent::V4::Completion::Client::Configuration, config
  end
end
