...
The recommended way to authenticate to the google-cloud-automl library is to use
...
The google-cloud-automl library provides several mechanisms to configure your system.
