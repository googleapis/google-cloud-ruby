...
The recommended way to authenticate to the google-cloud-document_ai library is to use
...
The google-cloud-document_ai library provides several mechanisms to configure your system.
