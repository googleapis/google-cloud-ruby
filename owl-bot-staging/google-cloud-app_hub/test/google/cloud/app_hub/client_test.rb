...
class Google::Cloud::AppHub::ClientConstructionMinitest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_app_hub_grpc
    ...
    Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      assert_kind_of Google::Cloud::AppHub::V1::AppHub::Client, client
    end
  end
  ...
  def test_app_hub_rest
    ...
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
      ...
      assert_kind_of Google::Cloud::AppHub::V1::AppHub::Rest::Client, client
    end
  end
end
