...
##
# Snippet for the create_workstation_config call in the Workstations service
#
...
# Google::Cloud::Workstations::V1beta::Workstations::Client#create_workstation_config.
#
