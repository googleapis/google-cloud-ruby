...
In general, the google-cloud-os_config library uses
...
The google-cloud-os_config library aims to make authentication
...
connect to most services with google-cloud-os_config.
