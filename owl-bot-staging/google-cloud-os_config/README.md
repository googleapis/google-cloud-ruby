# Ruby Client for the Cloud OS Config API

API Client library for the Cloud OS Config API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-os_config/latest)
for this library, google-cloud-os_config, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-os_config-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-os_config-v1/latest).
