...
The recommended way to authenticate to the google-cloud-firestore-admin library is to use
...
The google-cloud-firestore-admin library provides several mechanisms to configure your system.
