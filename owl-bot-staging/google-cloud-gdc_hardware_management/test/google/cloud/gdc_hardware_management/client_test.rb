...
class Google::Cloud::GDCHardwareManagement::ClientConstructionMinitest < Minitest::Test
  ...
  def test_gdc_hardware_management_grpc
    skip unless Google::Cloud::GDCHardwareManagement.gdc_hardware_management_available? transport: :grpc
  ...
  def test_gdc_hardware_management_rest
    skip unless Google::Cloud::GDCHardwareManagement.gdc_hardware_management_available? transport: :rest
