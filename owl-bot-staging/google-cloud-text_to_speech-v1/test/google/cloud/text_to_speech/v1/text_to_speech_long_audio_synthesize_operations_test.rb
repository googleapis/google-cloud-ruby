...
class ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::Operations.new do |config|
  ...
  def test_configure
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      client = ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::Operations.new do |config|
        config.credentials = grpc_channel
      end
    end
    ...
    assert_kind_of ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::Operations::Configuration, config
  end
end
