...
class ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::Rest::Client::Configuration, config
  end
end
