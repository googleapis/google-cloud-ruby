...
##
# Snippet for the get_internal_range call in the InternalRangeService service
#
...
# Google::Cloud::NetworkConnectivity::V1::InternalRangeService::Client#get_internal_range.
#
def get_internal_range
