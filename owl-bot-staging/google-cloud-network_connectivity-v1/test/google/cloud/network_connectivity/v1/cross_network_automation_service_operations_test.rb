...
class ::Google::Cloud::NetworkConnectivity::V1::CrossNetworkAutomationService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::NetworkConnectivity::V1::CrossNetworkAutomationService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::NetworkConnectivity::V1::CrossNetworkAutomationService::Operations::Configuration, config
  end
end
