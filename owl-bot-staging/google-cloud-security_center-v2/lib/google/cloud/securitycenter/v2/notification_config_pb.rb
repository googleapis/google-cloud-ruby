...
module Google
  module Cloud
    module SecurityCenter
      module V2
        NotificationConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.NotificationConfig").msgclass
        NotificationConfig::StreamingConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.NotificationConfig.StreamingConfig").msgclass
      end
    end
  end
end
