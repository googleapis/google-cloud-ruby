...
module Google
  module Cloud
    module SecurityCenter
      module V2
        MitreAttack = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.MitreAttack").msgclass
        MitreAttack::Tactic = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.MitreAttack.Tactic").enummodule
        MitreAttack::Technique = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.MitreAttack.Technique").enummodule
      end
    end
  end
end
