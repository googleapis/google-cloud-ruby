...
module Google
  module Cloud
    module SecurityCenter
      module V2
        ResourceValueConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.ResourceValueConfig").msgclass
        ResourceValueConfig::SensitiveDataProtectionMapping = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.ResourceValueConfig.SensitiveDataProtectionMapping").msgclass
        ResourceValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.securitycenter.v2.ResourceValue").enummodule
      end
    end
  end
end
