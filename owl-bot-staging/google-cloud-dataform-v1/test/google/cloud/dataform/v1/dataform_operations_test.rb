...
class ::Google::Cloud::Dataform::V1::Dataform::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Dataform::V1::Dataform::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dataform::V1::Dataform::Operations::Configuration, config
  end
end
