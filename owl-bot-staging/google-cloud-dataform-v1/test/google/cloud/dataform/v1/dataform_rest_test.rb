  ...
  def test_query_directory_contents
    ...
    ::Google::Cloud::Dataform::V1::Dataform::Rest::ServiceStub.stub :transcode_query_directory_contents_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, query_directory_contents_client_stub do
        ...
        # Use protobuf object
        client.query_directory_contents ::Google::Cloud::Dataform::V1::QueryDirectoryContentsRequest.new(workspace: workspace, path: path, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.query_directory_contents(::Google::Cloud::Dataform::V1::QueryDirectoryContentsRequest.new(workspace: workspace, path: path, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
