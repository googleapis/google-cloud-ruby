...
class ::Google::Cloud::ApiKeys::V2::ApiKeys::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::ApiKeys::V2::ApiKeys::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ApiKeys::V2::ApiKeys::Operations::Configuration, config
  end
end
