# Ruby Client for the Google Analytics Admin API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-analytics-admin/latest)
