...
The recommended way to authenticate to the google-analytics-admin library is to use
...
The google-analytics-admin library provides several mechanisms to configure your system.
