...
The recommended way to authenticate to the google-cloud-recaptcha_enterprise library is to use
...
The google-cloud-recaptcha_enterprise library provides several mechanisms to configure your system.
