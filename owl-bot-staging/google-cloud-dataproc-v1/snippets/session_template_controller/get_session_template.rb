...
##
# Snippet for the get_session_template call in the SessionTemplateController service
#
...
# Google::Cloud::Dataproc::V1::SessionTemplateController::Client#get_session_template.
#
