...
class ::Google::Cloud::Dataproc::V1::BatchController::ClientPathsTest < Minitest::Test
  def test_batch_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.batch_path project: "value0", location: "value1", batch: "value2"
      assert_equal "projects/value0/locations/value1/batches/value2", path
    end
  end
