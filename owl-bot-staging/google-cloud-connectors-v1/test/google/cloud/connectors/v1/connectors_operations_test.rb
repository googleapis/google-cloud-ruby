...
class ::Google::Cloud::Connectors::V1::Connectors::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Connectors::V1::Connectors::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Connectors::V1::Connectors::Operations::Configuration, config
  end
end
