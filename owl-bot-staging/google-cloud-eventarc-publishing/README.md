# Ruby Client for the Eventarc Publishing API
...
The gem `google-cloud-eventarc-publishing` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-eventarc-publishing/latest)
for this library, google-cloud-eventarc-publishing, to see the convenience methods for
...
```
$ gem install google-cloud-eventarc-publishing
```
