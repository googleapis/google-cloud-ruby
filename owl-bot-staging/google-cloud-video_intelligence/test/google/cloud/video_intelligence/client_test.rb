...
class Google::Cloud::VideoIntelligence::ClientConstructionMinitest < Minitest::Test
  def test_video_intelligence_service_grpc
    Gapic::ServiceStub.stub :new, :stub do
      ...
      assert_kind_of Google::Cloud::VideoIntelligence::V1::VideoIntelligenceService::Client, client
    end
  end
  ...
  def test_video_intelligence_service_rest
    Gapic::Rest::ClientStub.stub :new, :stub do
      ...
      assert_kind_of Google::Cloud::VideoIntelligence::V1::VideoIntelligenceService::Rest::Client, client
    end
  end
end
