...
##
# Snippet for the stop_airflow_command call in the Environments service
#
...
# Google::Cloud::Orchestration::Airflow::Service::V1::Environments::Client#stop_airflow_command.
#
