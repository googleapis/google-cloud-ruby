...
##
# Snippet for the get_user_workloads_config_map call in the Environments service
#
...
# Google::Cloud::Orchestration::Airflow::Service::V1::Environments::Client#get_user_workloads_config_map.
#
