  ...
  module Cloud
    module Dialogflow
      module CX
        ...
        #
        # By default, this returns an instance of
        # [Google::Cloud::Dialogflow::CX::V3::Locations::Client](https://googleapis.dev/ruby/google-cloud-dialogflow-cx-v3/latest/Google/Cloud/Dialogflow/CX/V3/Locations/Client.html)
        # for version V3 of the API.
        # However, you can specify specify a different API version by passing it in the
        ...
        #
        def self.locations version: :v3, &block
          require "google/cloud/dialogflow/cx/#{version.to_s.downcase}"
