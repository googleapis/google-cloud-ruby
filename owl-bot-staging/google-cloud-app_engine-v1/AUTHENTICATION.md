...
In general, the google-cloud-app_engine-v1 library uses
...
The google-cloud-app_engine-v1 library aims to make authentication
...
connect to most services with google-cloud-app_engine-v1.
