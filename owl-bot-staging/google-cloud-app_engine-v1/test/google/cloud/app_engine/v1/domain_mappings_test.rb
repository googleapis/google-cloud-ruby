...
class ::Google::Cloud::AppEngine::V1::DomainMappings::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_domain_mappings
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AppEngine::V1::ListDomainMappingsResponse.new
    ...
    list_domain_mappings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_domain_mappings, name
      assert_kind_of ::Google::Cloud::AppEngine::V1::ListDomainMappingsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_domain_mappings_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_domain_mappings_client_stub.call_rpc_count
    end
  end

  def test_get_domain_mapping
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AppEngine::V1::DomainMapping.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_domain_mapping_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_domain_mapping, name
      assert_kind_of ::Google::Cloud::AppEngine::V1::GetDomainMappingRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_domain_mapping_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_domain_mapping_client_stub.call_rpc_count
    end
  end
  ...
  def test_create_domain_mapping
    ...
    create_domain_mapping_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_domain_mapping, name
      assert_kind_of ::Google::Cloud::AppEngine::V1::CreateDomainMappingRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AppEngine::V1::DomainMapping), request["domain_mapping"]
      assert_equal :UNSPECIFIED_DOMAIN_OVERRIDE_STRATEGY, request["override_strategy"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_domain_mapping_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_domain_mapping_client_stub.call_rpc_count
    end
  end
  ...
  def test_update_domain_mapping
    ...
    update_domain_mapping_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_domain_mapping, name
      assert_kind_of ::Google::Cloud::AppEngine::V1::UpdateDomainMappingRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AppEngine::V1::DomainMapping), request["domain_mapping"]
    ...
    Gapic::ServiceStub.stub :new, update_domain_mapping_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_domain_mapping_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_domain_mapping
    ...
    delete_domain_mapping_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_domain_mapping, name
      assert_kind_of ::Google::Cloud::AppEngine::V1::DeleteDomainMappingRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_domain_mapping_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_domain_mapping_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AppEngine::V1::DomainMappings::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::AppEngine::V1::DomainMappings::Operations, client.operations_client
  end
end
