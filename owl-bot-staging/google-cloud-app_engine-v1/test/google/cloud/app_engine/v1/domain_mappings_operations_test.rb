...
class ::Google::Cloud::AppEngine::V1::DomainMappings::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AppEngine::V1::DomainMappings::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AppEngine::V1::DomainMappings::Operations::Configuration, config
  end
end
