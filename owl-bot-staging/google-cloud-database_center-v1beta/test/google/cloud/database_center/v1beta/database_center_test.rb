...
class ::Google::Cloud::DatabaseCenter::V1beta::DatabaseCenter::ClientTest < Minitest::Test
  ...
  def test_aggregate_query_stats
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DatabaseCenter::V1beta::AggregateQueryStatsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    aggregate_query_stats_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :aggregate_query_stats, name
      assert_kind_of ::Google::Cloud::DatabaseCenter::V1beta::AggregateQueryStatsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["order_by"]
      assert_equal "hello world", request["filter"]
      assert_equal 42, request["page_size"]
    ...
    Gapic::ServiceStub.stub :new, aggregate_query_stats_client_stub do
      ...
      # Verify method calls
      assert_equal 5, aggregate_query_stats_client_stub.call_rpc_count
    end
  end

  def test_query_issues
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DatabaseCenter::V1beta::QueryIssuesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    query_issues_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :query_issues, name
      assert_kind_of ::Google::Cloud::DatabaseCenter::V1beta::QueryIssuesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["filter"]
      assert_kind_of ::Google::Cloud::DatabaseCenter::V1beta::SignalProductsFilters, request["signal_products_filters"].first
      assert_equal "hello world", request["order_by"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, query_issues_client_stub do
      ...
      # Verify method calls
      assert_equal 5, query_issues_client_stub.call_rpc_count
    end
  end
