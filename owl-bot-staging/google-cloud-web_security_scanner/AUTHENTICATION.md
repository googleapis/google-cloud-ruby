...
In general, the google-cloud-web_security_scanner library uses
...
client = Google::Cloud::WebSecurityScanner.web_security_scanner
```

## Credential Lookup

The google-cloud-web_security_scanner library aims to make authentication
...
The environment variables that google-cloud-web_security_scanner
...
Google::Cloud::WebSecurityScanner.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-web_security_scanner.
