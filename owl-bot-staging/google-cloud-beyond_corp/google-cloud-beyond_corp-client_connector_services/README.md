# Ruby Client for the BeyondCorp ClientConnectorServices API

API Client library for the BeyondCorp ClientConnectorServices API
...
_versioned_ client gems, with names of the form `google-cloud-beyond_corp-client_connector_services-v*`.
The gem `google-cloud-beyond_corp-client_connector_services` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-beyond_corp-client_connector_services/latest)
for this library, google-cloud-beyond_corp-client_connector_services, to see the convenience methods for
...
```
$ gem install google-cloud-beyond_corp-client_connector_services
```
