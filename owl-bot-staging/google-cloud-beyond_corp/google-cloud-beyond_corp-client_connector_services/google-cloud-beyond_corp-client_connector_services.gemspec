...
require File.expand_path("lib/google/cloud/beyond_corp/client_connector_services/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-beyond_corp-client_connector_services"
  gem.version       = Google::Cloud::BeyondCorp::ClientConnectorServices::VERSION
  ...
  gem.summary       = "API Client library for the BeyondCorp ClientConnectorServices API"
