# Ruby Client for the BeyondCorp AppConnections API

API Client library for the BeyondCorp AppConnections API
...
The gem `google-cloud-beyond_corp-app_connections` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-beyond_corp-app_connections/latest)
for this library, google-cloud-beyond_corp-app_connections, to see the convenience methods for
...
```
$ gem install google-cloud-beyond_corp-app_connections
```
