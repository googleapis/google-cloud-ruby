...
require "google/cloud/beyond_corp/app_connections/version"
  ...
  module Cloud
    module BeyondCorp
      module AppConnections
        ...
        #
        def self.configure
          yield ::Google::Cloud.configure.beyond_corp_app_connections if block_given?

          ::Google::Cloud.configure.beyond_corp_app_connections
        end
      end
    end
  end
...
helper_path = ::File.join __dir__, "app_connections", "helpers.rb"
require "google/cloud/beyond_corp/app_connections/helpers" if ::File.file? helper_path
