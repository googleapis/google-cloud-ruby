...
require File.expand_path("lib/google/cloud/beyond_corp/app_gateways/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-beyond_corp-app_gateways"
  gem.version       = Google::Cloud::BeyondCorp::AppGateways::VERSION
  ...
  gem.summary       = "API Client library for the BeyondCorp AppGateways API"
