...
require File.expand_path("lib/google/cloud/beyond_corp/client_gateways/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-beyond_corp-client_gateways"
  gem.version       = Google::Cloud::BeyondCorp::ClientGateways::VERSION
  ...
  gem.summary       = "API Client library for the BeyondCorp ClientGateways API"
