...
##
# Snippet for the generate_optimized_manifest call in the GkeInferenceQuickstart service
#
...
# Google::Cloud::GkeRecommender::V1::GkeInferenceQuickstart::Client#generate_optimized_manifest.
#
