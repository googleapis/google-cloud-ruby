...
specific version of the Firestore in Datastore mode V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-datastore-v1
```
...
is part of the name, e.g. `google-cloud-datastore-v1`.
