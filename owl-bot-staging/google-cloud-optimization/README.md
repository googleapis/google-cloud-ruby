# Ruby Client for the Cloud Optimization API

API Client library for the Cloud Optimization API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-optimization/latest)
for this library, google-cloud-optimization, to see the convenience methods for
...
```
$ gem install google-cloud-optimization
```
...
client library with a name such as `google-cloud-optimization`,
...
is part of the name, e.g. `google-cloud-optimization-v1`.
