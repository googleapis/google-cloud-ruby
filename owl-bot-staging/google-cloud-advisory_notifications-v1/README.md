...
specific version of the Advisory Notifications V1 API. Most users should consider using
the main client gem,
[google-cloud-advisory_notifications](https://rubygems.org/gems/google-cloud-advisory_notifications).
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-advisory_notifications-v1/latest)
