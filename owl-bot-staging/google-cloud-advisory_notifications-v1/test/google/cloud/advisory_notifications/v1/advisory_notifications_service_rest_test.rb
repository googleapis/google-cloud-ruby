...
class ::Google::Cloud::AdvisoryNotifications::V1::AdvisoryNotificationsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_notifications
    # Create test objects.
    client_result = ::Google::Cloud::AdvisoryNotifications::V1::ListNotificationsResponse.new
    ...
    list_notifications_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::AdvisoryNotifications::V1::AdvisoryNotificationsService::Rest::ServiceStub.stub :transcode_list_notifications_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_notifications_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_notifications_client_stub.call_count
      end
    end
  end
  ...
  def test_get_notification
    # Create test objects.
    client_result = ::Google::Cloud::AdvisoryNotifications::V1::Notification.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_notification_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AdvisoryNotifications::V1::AdvisoryNotificationsService::Rest::ServiceStub.stub :transcode_get_notification_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_notification_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_notification_client_stub.call_count
      end
    end
  end
  ...
  def test_get_settings
    # Create test objects.
    client_result = ::Google::Cloud::AdvisoryNotifications::V1::Settings.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AdvisoryNotifications::V1::AdvisoryNotificationsService::Rest::Client::Configuration, config
  end
end
