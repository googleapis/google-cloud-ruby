...
class ::Google::Cloud::AdvisoryNotifications::V1::AdvisoryNotificationsService::Rest::ClientTest < Minitest::Test
  ...
  def test_list_notifications
    ...
    list_notifications_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_get_notification
    ...
    get_notification_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
