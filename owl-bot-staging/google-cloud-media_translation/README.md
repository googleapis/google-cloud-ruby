# Ruby Client for the Media Translation API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-media_translation/latest)
for this library, google-cloud-media_translation, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-media_translation-v1beta1](https://cloud.google.com/ruby/docs/reference/google-cloud-media_translation-v1beta1/latest).
...
```
$ gem install google-cloud-media_translation
```
