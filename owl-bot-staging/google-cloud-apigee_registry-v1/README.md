# Ruby Client for the Apigee Registry V1 API

API Client library for the Apigee Registry V1 API
...
specific version of the Apigee Registry V1 API. Most users should consider using
the main client gem,
[google-cloud-apigee_registry](https://rubygems.org/gems/google-cloud-apigee_registry).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-apigee_registry-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-apigee_registry-v1/latest)
