...
the main client gem,
[google-cloud-config_service](https://rubygems.org/gems/google-cloud-config_service).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-config_service-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-config_service-v1/latest)
