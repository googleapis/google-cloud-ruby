...
##
# Snippet for the test_iam_permissions call in the ArtifactRegistry service
#
...
# Google::Cloud::ArtifactRegistry::V1beta2::ArtifactRegistry::Client#test_iam_permissions.
#
