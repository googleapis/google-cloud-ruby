...
class ::Google::Cloud::Bigtable::Admin::V2::BigtableInstanceAdmin::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Bigtable::Admin::V2::BigtableInstanceAdmin::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Bigtable::Admin::V2::BigtableInstanceAdmin::Operations::Configuration, config
  end
end
