    ...
    module Bigtable
      module Admin
        module V2
          ...
          Type::String::Encoding::Utf8Bytes = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.String.Encoding.Utf8Bytes").msgclass
          ...
          Type::Int64::Encoding::OrderedCodeBytes = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Int64.Encoding.OrderedCodeBytes").msgclass
          Type::Bool = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Bool").msgclass
          Type::Float32 = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Float32").msgclass
          Type::Float64 = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Float64").msgclass
          Type::Timestamp = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Timestamp").msgclass
          Type::Timestamp::Encoding = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Timestamp.Encoding").msgclass
          Type::Date = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Date").msgclass
          Type::Struct = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Struct").msgclass
          Type::Struct::Field = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Struct.Field").msgclass
          Type::Struct::Encoding = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Struct.Encoding").msgclass
          ...
          Type::Aggregate::Max = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Aggregate.Max").msgclass
          Type::Aggregate::Min = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Aggregate.Min").msgclass
          Type::Aggregate::HyperLogLogPlusPlusUniqueCount = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.Type.Aggregate.HyperLogLogPlusPlusUniqueCount").msgclass
        end
      end
    end
  end
