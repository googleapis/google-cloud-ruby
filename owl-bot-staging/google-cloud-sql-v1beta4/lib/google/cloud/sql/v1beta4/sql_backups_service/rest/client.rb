...
require "google/cloud/sql/v1beta4/sql_backups_service/rest/service_stub"
        ...
        module SqlBackupsService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Sql::V1beta4::SqlBackupsService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all SqlBackupsService clients
              #   ::Google::Cloud::Sql::V1beta4::SqlBackupsService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Cloud::Sql::V1beta4::SqlBackupsService::Rest::Client.new
              #
              ...
              def initialize
                ...
                @sql_backups_service_stub = ::Google::Cloud::Sql::V1beta4::SqlBackupsService::Rest::ServiceStub.new(
              ...
              #   {::Google::Cloud::Sql::V1beta4::CreateBackupRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Sql::V1beta4::CreateBackupRequest, ::Hash]
              ...
              #   @param backup [::Google::Cloud::Sql::V1beta4::Backup, ::Hash]
              ...
              #   request = Google::Cloud::Sql::V1beta4::CreateBackupRequest.new
              #
              ...
              def create_backup request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Sql::V1beta4::CreateBackupRequest
              ...
              #   {::Google::Cloud::Sql::V1beta4::GetBackupRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Sql::V1beta4::GetBackupRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::Sql::V1beta4::Backup]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Sql::V1beta4::GetBackupRequest.new
              #
              #   # Call the get_backup method.
              #   result = client.get_backup request
              #
              #   # The returned object is of type Google::Cloud::Sql::V1beta4::Backup.
              #   p result
              #
              def get_backup request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Sql::V1beta4::GetBackupRequest
              ...
              #   {::Google::Cloud::Sql::V1beta4::ListBackupsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Sql::V1beta4::ListBackupsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Sql::V1beta4::Backup>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Sql::V1beta4::Backup>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Sql::V1beta4::ListBackupsRequest.new
              #
              ...
              #   result.each do |item|
              #     # Each element is of type ::Google::Cloud::Sql::V1beta4::Backup.
              #     p item
              #   end
              #
              def list_backups request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Sql::V1beta4::ListBackupsRequest
              ...
              #   {::Google::Cloud::Sql::V1beta4::UpdateBackupRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Sql::V1beta4::UpdateBackupRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Sql::V1beta4::UpdateBackupRequest.new
              #
              ...
              def update_backup request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Sql::V1beta4::UpdateBackupRequest
              ...
              #   {::Google::Cloud::Sql::V1beta4::DeleteBackupRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Sql::V1beta4::DeleteBackupRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Sql::V1beta4::DeleteBackupRequest.new
              #
              ...
              def delete_backup request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Sql::V1beta4::DeleteBackupRequest
              ...
              # {::Google::Cloud::Sql::V1beta4::SqlBackupsService::Rest::Client::Configuration::Rpcs}
