      ...
      module V1beta4
        module SqlBackupsService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Sql::V1beta4::SqlBackupsService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all SqlBackupsService clients
            #   ::Google::Cloud::Sql::V1beta4::SqlBackupsService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @sql_backups_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Sql::V1beta4::SqlBackupsService::Stub,
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Sql::V1beta4::Backup]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Sql::V1beta4::Backup>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Sql::V1beta4::Backup>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            # {::Google::Cloud::Sql::V1beta4::SqlBackupsService::Client::Configuration::Rpcs}
