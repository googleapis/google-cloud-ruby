      ...
      module V1beta4
        module SqlOperationsService
          ...
          class Client
            ...
            #   {::Google::Cloud::Sql::V1beta4::SqlOperationsCancelRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Sql::V1beta4::SqlOperationsCancelRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def cancel request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Sql::V1beta4::SqlOperationsCancelRequest
