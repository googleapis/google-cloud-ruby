...
# [START sqladmin_v1beta4_generated_SqlInstancesService_GetLatestRecoveryTime_sync]
require "google/cloud/sql/v1beta4"

##
# Snippet for the get_latest_recovery_time call in the SqlInstancesService service
#
...
# Google::Cloud::Sql::V1beta4::SqlInstancesService::Client#get_latest_recovery_time.
#
