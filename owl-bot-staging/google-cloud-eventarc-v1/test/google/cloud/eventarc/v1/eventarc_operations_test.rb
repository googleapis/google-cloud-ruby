...
class ::Google::Cloud::Eventarc::V1::Eventarc::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Eventarc::V1::Eventarc::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Eventarc::V1::Eventarc::Operations::Configuration, config
  end
end
