...
specific version of the Eventarc V1 API. Most users should consider using
the main client gem,
[google-cloud-eventarc](https://rubygems.org/gems/google-cloud-eventarc).
...
client library with a name such as `google-cloud-eventarc`,
...
is part of the name, e.g. `google-cloud-eventarc-v1`.
