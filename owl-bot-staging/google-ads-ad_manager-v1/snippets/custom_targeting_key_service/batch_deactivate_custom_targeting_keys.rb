...
##
# Snippet for the batch_deactivate_custom_targeting_keys call in the CustomTargetingKeyService service
#
...
# Google::Ads::AdManager::V1::CustomTargetingKeyService::Rest::Client#batch_deactivate_custom_targeting_keys.
#
