...
require 'google/ads/admanager/v1/audience_segment_messages_pb'
...
module Google
  module Ads
    module AdManager
      module V1
        GetAudienceSegmentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.GetAudienceSegmentRequest").msgclass
        ListAudienceSegmentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListAudienceSegmentsRequest").msgclass
        ListAudienceSegmentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListAudienceSegmentsResponse").msgclass
      end
    end
  end
end
