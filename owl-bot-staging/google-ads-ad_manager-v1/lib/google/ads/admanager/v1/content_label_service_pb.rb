...
require 'google/ads/admanager/v1/content_label_messages_pb'
...
module Google
  module Ads
    module AdManager
      module V1
        GetContentLabelRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.GetContentLabelRequest").msgclass
        ListContentLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListContentLabelsRequest").msgclass
        ListContentLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListContentLabelsResponse").msgclass
      end
    end
  end
end
