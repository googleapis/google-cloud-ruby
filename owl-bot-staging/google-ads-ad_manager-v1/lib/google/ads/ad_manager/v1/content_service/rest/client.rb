...
require "google/ads/ad_manager/v1/content_service/rest/service_stub"
        ...
        module ContentService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Ads::AdManager::V1::ContentService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all ContentService clients
              #   ::Google::Ads::AdManager::V1::ContentService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @content_service_stub = ::Google::Ads::AdManager::V1::ContentService::Rest::ServiceStub.new(
              ...
              #   {::Google::Ads::AdManager::V1::GetContentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::GetContentRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload get_content(name: nil)
              ...
              # @yieldparam result [::Google::Ads::AdManager::V1::Content]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Ads::AdManager::V1::Content]
              #
              ...
              #   request = Google::Ads::AdManager::V1::GetContentRequest.new
              #
              #   # Call the get_content method.
              #   result = client.get_content request
              #
              #   # The returned object is of type Google::Ads::AdManager::V1::Content.
              #   p result
              #
              def get_content request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::GetContentRequest
              ...
              #   {::Google::Ads::AdManager::V1::ListContentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::ListContentRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload list_content(parent: nil, page_size: nil, page_token: nil, filter: nil, order_by: nil, skip: nil)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::Content>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::Content>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_content request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::ListContentRequest
              ...
              # {::Google::Ads::AdManager::V1::ContentService::Rest::Client::Configuration::Rpcs}
              ...
              #   # get_content to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::AdManager::V1::ContentService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.get_content.timeout = 20.0
              #   end
              #
