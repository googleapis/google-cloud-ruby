    ...
    module AdManager
      module V1
        module LineItemService
          # Path helper methods for the LineItemService API.
          module Paths
            ##
            # Create a fully-qualified LineItem resource string.
            #
            ...
            # @param line_item [String]
            #
            # @return [::String]
            def line_item_path network_code:, line_item:
