    ...
    module AdManager
      module V1
        module ContentLabelService
          # Path helper methods for the ContentLabelService API.
          module Paths
            ##
            # Create a fully-qualified ContentLabel resource string.
            #
            ...
            #
            # @return [::String]
            def content_label_path network_code:, content_label:
