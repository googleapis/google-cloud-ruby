    ...
    module AdManager
      module V1
        module EntitySignalsMappingService
          # Path helper methods for the EntitySignalsMappingService API.
          module Paths
            ##
            # Create a fully-qualified EntitySignalsMapping resource string.
            #
            ...
            # @param entity_signals_mapping [String]
            #
            # @return [::String]
            def entity_signals_mapping_path network_code:, entity_signals_mapping:
