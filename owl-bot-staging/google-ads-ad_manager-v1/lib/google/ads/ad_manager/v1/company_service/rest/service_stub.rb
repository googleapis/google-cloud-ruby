        ...
        module CompanyService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Ads::AdManager::V1::GetCompanyRequest]
              ...
              #
              # @param request_pb [::Google::Ads::AdManager::V1::ListCompaniesRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Ads::AdManager::V1::ListCompaniesResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Ads::AdManager::V1::ListCompaniesResponse]
              #   A result object deserialized from the server's reply
              ...
              def self.transcode_get_company_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          ...
                                                          matches: [
                                                            ["name", %r{^networks/[^/]+/companies/[^/]+/?$}, false]
                                                          ]
                                                        )
              ...
              def self.transcode_list_companies_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v1/{parent}/companies",
                                                          matches: [
