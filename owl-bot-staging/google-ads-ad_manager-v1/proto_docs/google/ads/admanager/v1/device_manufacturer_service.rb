  ...
  module Ads
    module AdManager
      module V1
        ...
        class GetDeviceManufacturerRequest
        ...
        class ListDeviceManufacturersRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        # @!attribute [rw] device_manufacturers
        #   @return [::Array<::Google::Ads::AdManager::V1::DeviceManufacturer>]
