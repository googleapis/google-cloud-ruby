...
require "google/ads/ad_manager/v1/ad_review_center_ad_service/rest"


class ::Google::Ads::AdManager::V1::AdReviewCenterAdService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_search_ad_review_center_ads
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::SearchAdReviewCenterAdsResponse.new
    ...
    ::Google::Ads::AdManager::V1::AdReviewCenterAdService::Rest::ServiceStub.stub :transcode_search_ad_review_center_ads_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_ad_review_center_ads_client_stub do
        ...
        # Verify method calls
        assert_equal 5, search_ad_review_center_ads_client_stub.call_count
      end
    end
  end

  def test_batch_allow_ad_review_center_ads
    # Create test objects.
    ...
    batch_allow_ad_review_center_ads_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::AdReviewCenterAdService::Rest::ServiceStub.stub :transcode_batch_allow_ad_review_center_ads_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_allow_ad_review_center_ads_client_stub do
        ...
        # Verify method calls
        assert_equal 5, batch_allow_ad_review_center_ads_client_stub.call_count
      end
    end
  end

  def test_batch_block_ad_review_center_ads
    # Create test objects.
    client_result = ::Google::Longrunning::Operation.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    batch_block_ad_review_center_ads_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::AdReviewCenterAdService::Rest::Client::Configuration, config
  end
end
