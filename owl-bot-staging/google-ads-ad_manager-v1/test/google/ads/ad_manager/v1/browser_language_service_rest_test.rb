...
class ::Google::Ads::AdManager::V1::BrowserLanguageService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_browser_language
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::BrowserLanguage.new
    ...
    get_browser_language_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::AdManager::V1::BrowserLanguageService::Rest::ServiceStub.stub :transcode_get_browser_language_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_browser_language_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_browser_language_client_stub.call_count
      end
    end
  end

  def test_list_browser_languages
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ListBrowserLanguagesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_browser_languages_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::BrowserLanguageService::Rest::ServiceStub.stub :transcode_list_browser_languages_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_browser_languages_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_browser_languages_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::BrowserLanguageService::Rest::Client::Configuration, config
  end
end
