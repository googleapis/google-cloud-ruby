...
class ::Google::Ads::AdManager::V1::ProgrammaticBuyerService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_programmatic_buyer
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ProgrammaticBuyer.new
    ...
    get_programmatic_buyer_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::AdManager::V1::ProgrammaticBuyerService::Rest::ServiceStub.stub :transcode_get_programmatic_buyer_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_programmatic_buyer_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_programmatic_buyer_client_stub.call_count
      end
    end
  end

  def test_list_programmatic_buyers
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ListProgrammaticBuyersResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_programmatic_buyers_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::ProgrammaticBuyerService::Rest::ServiceStub.stub :transcode_list_programmatic_buyers_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_programmatic_buyers_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_programmatic_buyers_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::ProgrammaticBuyerService::Rest::Client::Configuration, config
  end
end
