...
class ::Google::Ads::AdManager::V1::AdBreakService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_ad_break
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::AdBreak.new
    ...
    get_ad_break_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::AdManager::V1::AdBreakService::Rest::ServiceStub.stub :transcode_get_ad_break_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_ad_break_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_ad_break_client_stub.call_count
      end
    end
  end

  def test_list_ad_breaks
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ListAdBreaksResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_ad_breaks_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::AdBreakService::Rest::ServiceStub.stub :transcode_list_ad_breaks_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_ad_breaks_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_ad_breaks_client_stub.call_count
      end
    end
  end

  def test_create_ad_break
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::AdBreak.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    create_ad_break_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::AdBreakService::Rest::ServiceStub.stub :transcode_create_ad_break_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_ad_break_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_ad_break_client_stub.call_count
      end
    end
  end

  def test_update_ad_break
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::AdBreak.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    update_ad_break_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::AdBreakService::Rest::ServiceStub.stub :transcode_update_ad_break_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_ad_break_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_ad_break_client_stub.call_count
      end
    end
  end

  def test_delete_ad_break
    # Create test objects.
    ...
    delete_ad_break_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::AdBreakService::Rest::ServiceStub.stub :transcode_delete_ad_break_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_ad_break_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_ad_break_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::AdBreakService::Rest::Client::Configuration, config
  end
end
