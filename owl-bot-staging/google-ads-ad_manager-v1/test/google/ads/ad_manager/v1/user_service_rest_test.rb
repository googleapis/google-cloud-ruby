...
class ::Google::Ads::AdManager::V1::UserService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::UserService::Rest::Client::Configuration, config
  end
end
