...
require "helper"
require "gapic/rest"
require "google/ads/admanager/v1/cms_metadata_key_service_pb"
require "google/ads/ad_manager/v1/cms_metadata_key_service/rest"


class ::Google::Ads::AdManager::V1::CmsMetadataKeyService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_cms_metadata_key
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::CmsMetadataKey.new
    ...
    get_cms_metadata_key_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::AdManager::V1::CmsMetadataKeyService::Rest::ServiceStub.stub :transcode_get_cms_metadata_key_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_cms_metadata_key_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_cms_metadata_key_client_stub.call_count
      end
    end
  end

  def test_list_cms_metadata_keys
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ListCmsMetadataKeysResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_cms_metadata_keys_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::CmsMetadataKeyService::Rest::ServiceStub.stub :transcode_list_cms_metadata_keys_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_cms_metadata_keys_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_cms_metadata_keys_client_stub.call_count
      end
    end
  end

  def test_batch_activate_cms_metadata_keys
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::BatchActivateCmsMetadataKeysResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    batch_activate_cms_metadata_keys_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::CmsMetadataKeyService::Rest::ServiceStub.stub :transcode_batch_activate_cms_metadata_keys_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_activate_cms_metadata_keys_client_stub do
        ...
        # Verify method calls
        assert_equal 5, batch_activate_cms_metadata_keys_client_stub.call_count
      end
    end
  end

  def test_batch_deactivate_cms_metadata_keys
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::BatchDeactivateCmsMetadataKeysResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    batch_deactivate_cms_metadata_keys_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::CmsMetadataKeyService::Rest::ServiceStub.stub :transcode_batch_deactivate_cms_metadata_keys_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_deactivate_cms_metadata_keys_client_stub do
        ...
        # Verify method calls
        assert_equal 5, batch_deactivate_cms_metadata_keys_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::CmsMetadataKeyService::Rest::Client::Configuration, config
  end
end
