...
require "google/ads/ad_manager/v1/content_bundle_service/rest"


class ::Google::Ads::AdManager::V1::ContentBundleService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_content_bundle
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ContentBundle.new
    ...
    get_content_bundle_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::AdManager::V1::ContentBundleService::Rest::ServiceStub.stub :transcode_get_content_bundle_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_content_bundle_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_content_bundle_client_stub.call_count
      end
    end
  end

  def test_list_content_bundles
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ListContentBundlesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_content_bundles_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::ContentBundleService::Rest::ServiceStub.stub :transcode_list_content_bundles_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_content_bundles_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_content_bundles_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::ContentBundleService::Rest::Client::Configuration, config
  end
end
