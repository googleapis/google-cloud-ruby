...
class ::Google::Shopping::Merchant::Promotions::V1::PromotionsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_insert_promotion
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Promotions::V1::Promotion.new
    ...
    insert_promotion_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Promotions::V1::InsertPromotionRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Promotions::V1::Promotion), request["promotion"]
  ...
  def test_get_promotion
    ...
    get_promotion_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Promotions::V1::GetPromotionRequest, request
  ...
  def test_list_promotions
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Promotions::V1::ListPromotionsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_promotions_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Promotions::V1::ListPromotionsRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Promotions::V1::PromotionsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Promotions::V1::PromotionsService::Client, client
