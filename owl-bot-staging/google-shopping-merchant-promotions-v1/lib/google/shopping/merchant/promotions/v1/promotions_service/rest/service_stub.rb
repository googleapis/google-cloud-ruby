          ...
          module PromotionsService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Promotions::V1::InsertPromotionRequest]
                ...
                def insert_promotion request_pb, options = nil
                  ...
                  result = ::Google::Shopping::Merchant::Promotions::V1::Promotion.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Promotions::V1::GetPromotionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Promotions::V1::ListPromotionsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::Promotions::V1::ListPromotionsResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Shopping::Merchant::Promotions::V1::ListPromotionsResponse]
                #   A result object deserialized from the server's reply
                def list_promotions request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Shopping::Merchant::Promotions::V1::ListPromotionsResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                def self.transcode_insert_promotion_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/promotions/v1/{parent}/promotions:insert",
                                                            body: "*",
                                                            matches: [
                ...
                def self.transcode_get_promotion_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/promotions/v1/{name}",
                                                            matches: [
                ...
                def self.transcode_list_promotions_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/promotions/v1/{parent}/promotions",
                                                            matches: [
                                                              ["parent", %r{^accounts/[^/]+/?$}, false]
                                                            ]
                                                          )
