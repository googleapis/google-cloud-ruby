...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-redis-cluster/latest)
for this library, google-cloud-redis-cluster, to see the convenience methods for
...
```
$ gem install google-cloud-redis-cluster
```
