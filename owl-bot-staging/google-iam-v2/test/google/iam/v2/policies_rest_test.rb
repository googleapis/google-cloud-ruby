...
class ::Google::Iam::V2::Policies::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_policies
    # Create test objects.
    client_result = ::Google::Iam::V2::ListPoliciesResponse.new
  ...
  def test_get_policy
    # Create test objects.
    client_result = ::Google::Iam::V2::Policy.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Iam::V2::Policies::Rest::Client::Configuration, config
  end
end
