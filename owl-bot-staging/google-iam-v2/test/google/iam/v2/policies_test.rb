...
class ::Google::Iam::V2::Policies::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_policies
    # Create GRPC objects.
    grpc_response = ::Google::Iam::V2::ListPoliciesResponse.new
    ...
    list_policies_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Iam::V2::ListPoliciesRequest, request
  ...
  def test_get_policy
    # Create GRPC objects.
    grpc_response = ::Google::Iam::V2::Policy.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Iam::V2::GetPolicyRequest, request
  ...
  def test_create_policy
    ...
    create_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Iam::V2::CreatePolicyRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Iam::V2::Policy), request["policy"]
      assert_equal "hello world", request["policy_id"]
      refute_nil options
    end
  ...
  def test_update_policy
    ...
    update_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Iam::V2::UpdatePolicyRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Iam::V2::Policy), request["policy"]
      refute_nil options
    end
  ...
  def test_delete_policy
    ...
    delete_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Iam::V2::DeletePolicyRequest, request
      assert_equal "hello world", request["name"]
  ...
  def test_list_applicable_policies
    # Create GRPC objects.
    grpc_response = ::Google::Iam::V2::ListApplicablePoliciesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}

    # Create request parameters for a unary method.
    attachment_point = "hello world"
    filter = "hello world"
    page_token = "hello world"
    page_size = 42

    list_applicable_policies_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_applicable_policies, name
      assert_kind_of ::Google::Iam::V2::ListApplicablePoliciesRequest, request
      assert_equal "hello world", request["attachment_point"]
    ...
    Gapic::ServiceStub.stub :new, list_applicable_policies_client_stub do
      # Create client
      client = ::Google::Iam::V2::Policies::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.list_applicable_policies({ attachment_point: attachment_point, filter: filter, page_token: page_token, page_size: page_size }) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.list_applicable_policies ::Google::Iam::V2::ListApplicablePoliciesRequest.new(attachment_point: attachment_point, filter: filter, page_token: page_token, page_size: page_size) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.list_applicable_policies({ attachment_point: attachment_point, filter: filter, page_token: page_token, page_size: page_size }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_applicable_policies(::Google::Iam::V2::ListApplicablePoliciesRequest.new(attachment_point: attachment_point, filter: filter, page_token: page_token, page_size: page_size), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Verify method calls
      assert_equal 5, list_applicable_policies_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Iam::V2::Policies::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Iam::V2::Policies::Operations, client.operations_client
  end
end
