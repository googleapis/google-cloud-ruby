...
class ::Google::Iam::V2::Policies::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Iam::V2::Policies::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Iam::V2::Policies::Operations::Configuration, config
  end
end
