...
class ::Google::Cloud::PolicySimulator::V1::OrgPolicyViolationsPreviewService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::PolicySimulator::V1::OrgPolicyViolationsPreviewService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::PolicySimulator::V1::OrgPolicyViolationsPreviewService::Operations::Configuration, config
  end
end
