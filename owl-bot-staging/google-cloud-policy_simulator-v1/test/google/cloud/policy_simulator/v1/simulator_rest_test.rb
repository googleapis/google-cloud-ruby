...
class ::Google::Cloud::PolicySimulator::V1::Simulator::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_replay
    # Create test objects.
    client_result = ::Google::Cloud::PolicySimulator::V1::Replay.new
    ...
    get_replay_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::PolicySimulator::V1::Simulator::Rest::ServiceStub.stub :transcode_get_replay_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_replay_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_replay_client_stub.call_count
      end
    end
  end
  ...
  def test_create_replay
    ...
    create_replay_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::PolicySimulator::V1::Simulator::Rest::ServiceStub.stub :transcode_create_replay_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_replay_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_replay_client_stub.call_count
      end
    end
  end
  ...
  def test_list_replay_results
    # Create test objects.
    client_result = ::Google::Cloud::PolicySimulator::V1::ListReplayResultsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_replay_results_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::PolicySimulator::V1::Simulator::Rest::ServiceStub.stub :transcode_list_replay_results_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_replay_results_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_replay_results_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::PolicySimulator::V1::Simulator::Rest::Client::Configuration, config
  end
end
