...
module Google
  module Cloud
    module CertificateManager
      ...
      # given API version does not support the given transport of the CertificateManager service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::CertificateManager.certificate_manager_available?}.
      #
      ...
      ##
      # Determines whether the CertificateManager service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::CertificateManager.certificate_manager}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the CertificateManager service,
      # or if the versioned client gem needs an update to support the CertificateManager service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
      ...
      #
      def self.certificate_manager_available? version: :v1, transport: :grpc
        require "google/cloud/certificate_manager/#{version.to_s.downcase}"
        package_name = Google::Cloud::CertificateManager
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::CertificateManager.const_get package_name
        return false unless service_module.const_defined? :CertificateManager
        service_module = service_module.const_get :CertificateManager
        if transport == :rest
