...
module Google
  module Cloud
    module CertificateManager
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::CertificateManager::V1::Locations::Client](https://googleapis.dev/ruby/google-cloud-certificate_manager-v1/latest/Google/Cloud/CertificateManager/V1/Locations/Client.html)
      # for version V1 of the API.
      # However, you can specify specify a different API version by passing it in the
