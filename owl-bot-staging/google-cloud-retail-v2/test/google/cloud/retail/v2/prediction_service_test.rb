...
class ::Google::Cloud::Retail::V2::PredictionService::ClientTest < Minitest::Test
  ...
  def test_predict
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2::PredictResponse.new
    ...
    predict_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2::PredictRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2::PredictionService::Client::Configuration, config
  end
end
