...
class ::Google::Cloud::Retail::V2::ModelService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_model_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.model_path project: "value0", location: "value1", catalog: "value2", model: "value3"
      assert_equal "projects/value0/locations/value1/catalogs/value2/models/value3", path
    end
  end
end
