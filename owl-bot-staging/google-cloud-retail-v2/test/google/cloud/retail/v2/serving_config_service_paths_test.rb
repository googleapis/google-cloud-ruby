...
class ::Google::Cloud::Retail::V2::ServingConfigService::ClientPathsTest < Minitest::Test
  ...
  def test_serving_config_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.serving_config_path project: "value0", location: "value1", catalog: "value2", serving_config: "value3"
      assert_equal "projects/value0/locations/value1/catalogs/value2/servingConfigs/value3", path
    end
  end
end
