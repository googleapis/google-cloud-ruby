...
require "google/cloud/retail/v2/conversational_search_service/client"
...
require "google/cloud/retail/v2/conversational_search_service/helpers" if ::File.file? helper_path
