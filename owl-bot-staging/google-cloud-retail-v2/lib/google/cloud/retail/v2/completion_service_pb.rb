  ...
  module Cloud
    module Retail
      module V2
        ...
        CompleteQueryResponse::AttributeResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.retail.v2.CompleteQueryResponse.AttributeResult").msgclass
      end
    end
  end
end
