            ...
            class ServiceStub
              ...
              def add_fulfillment_places request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "add_fulfillment_places",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def remove_fulfillment_places request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "remove_fulfillment_places",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def add_local_inventories request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "add_local_inventories",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def remove_local_inventories request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "remove_local_inventories",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
