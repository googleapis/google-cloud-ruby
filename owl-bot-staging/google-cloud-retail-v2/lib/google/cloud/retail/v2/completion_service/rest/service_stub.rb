        ...
        module CompletionService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Retail::V2::CompleteQueryRequest]
              ...
              def complete_query request_pb, options = nil
                ...
                result = ::Google::Cloud::Retail::V2::CompleteQueryResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
              ...
              #
              # @param request_pb [::Google::Cloud::Retail::V2::ImportCompletionDataRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #   A result object deserialized from the server's reply
              def import_completion_data request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "import_completion_data",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def self.transcode_complete_query_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v2/{catalog}:completeQuery",
                                                          matches: [
              ...
              # @private
              #
              # GRPC transcoding helper method for the import_completion_data REST call
              #
              # @param request_pb [::Google::Cloud::Retail::V2::ImportCompletionDataRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_import_completion_data_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v2/{parent}/completionData:import",
                                                          body: "*",
                                                          matches: [
