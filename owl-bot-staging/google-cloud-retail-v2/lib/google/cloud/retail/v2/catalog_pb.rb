  ...
  module Cloud
    module Retail
      module V2
        ...
        CatalogAttribute::FacetConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.retail.v2.CatalogAttribute.FacetConfig").msgclass
        CatalogAttribute::FacetConfig::IgnoredFacetValues = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.retail.v2.CatalogAttribute.FacetConfig.IgnoredFacetValues").msgclass
        CatalogAttribute::FacetConfig::MergedFacetValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.retail.v2.CatalogAttribute.FacetConfig.MergedFacetValue").msgclass
        CatalogAttribute::FacetConfig::MergedFacet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.retail.v2.CatalogAttribute.FacetConfig.MergedFacet").msgclass
        CatalogAttribute::FacetConfig::RerankConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.retail.v2.CatalogAttribute.FacetConfig.RerankConfig").msgclass
