...
class ::Google::Cloud::OrgPolicy::V2::OrgPolicy::ClientPathsTest < Minitest::Test
  ...
  def test_policy_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.policy_path project: "value0", policy: "value1"
      assert_equal "projects/value0/policies/value1", path

      path = client.policy_path folder: "value0", policy: "value1"
      assert_equal "folders/value0/policies/value1", path

      path = client.policy_path organization: "value0", policy: "value1"
