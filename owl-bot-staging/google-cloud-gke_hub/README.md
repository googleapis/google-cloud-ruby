# Ruby Client for the GKE Hub API

API Client library for the GKE Hub API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-gke_hub/latest)
for this library, google-cloud-gke_hub, to see the convenience methods for
...
```
$ gem install google-cloud-gke_hub
```
