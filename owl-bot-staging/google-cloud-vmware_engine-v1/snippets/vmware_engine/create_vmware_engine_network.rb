...
##
# Snippet for the create_vmware_engine_network call in the VmwareEngine service
#
...
# Google::Cloud::VmwareEngine::V1::VmwareEngine::Client#create_vmware_engine_network.
#
