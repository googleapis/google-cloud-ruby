...
##
# Snippet for the revoke_dns_bind_permission call in the VmwareEngine service
#
...
# Google::Cloud::VmwareEngine::V1::VmwareEngine::Client#revoke_dns_bind_permission.
#
