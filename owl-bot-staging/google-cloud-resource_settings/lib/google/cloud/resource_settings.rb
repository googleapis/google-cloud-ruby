...
require "google/cloud/resource_settings/version"
...
::Google::Cloud.configure.add_config! :resource_settings do |config|
...
module Google
  module Cloud
    module ResourceSettings
      ...
      # [Google::Cloud::ResourceSettings::V1::ResourceSettingsService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-resource_settings-v1/latest/Google-Cloud-ResourceSettings-V1-ResourceSettingsService-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the ResourceSettingsService service is
      ...
      # given API version does not support the given transport of the ResourceSettingsService service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::ResourceSettings.resource_settings_service_available?}.
      #
      ...
      ##
      # Determines whether the ResourceSettingsService service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::ResourceSettings.resource_settings_service}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the ResourceSettingsService service,
      # or if the versioned client gem needs an update to support the ResourceSettingsService service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
