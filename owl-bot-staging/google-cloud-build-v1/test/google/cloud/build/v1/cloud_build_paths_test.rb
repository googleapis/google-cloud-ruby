...
class ::Google::Cloud::Build::V1::CloudBuild::ClientPathsTest < Minitest::Test
  ...
  def test_default_service_account_path
    grpc_channel = ::GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      client = ::Google::Cloud::Build::V1::CloudBuild::Client.new do |config|
        config.credentials = grpc_channel
      ...
      path = client.default_service_account_path project: "value0", location: "value1"
      assert_equal "projects/value0/locations/value1/defaultServiceAccount", path
    end
  end
