...
require File.expand_path("lib/google/shopping/merchant/order_tracking/v1beta/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-order_tracking-v1beta"
  gem.version       = Google::Shopping::Merchant::OrderTracking::V1beta::VERSION
