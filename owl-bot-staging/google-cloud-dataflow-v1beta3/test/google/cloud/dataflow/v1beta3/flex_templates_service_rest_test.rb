...
class ::Google::Cloud::Dataflow::V1beta3::FlexTemplatesService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_launch_flex_template
    # Create test objects.
    client_result = ::Google::Cloud::Dataflow::V1beta3::LaunchFlexTemplateResponse.new
    ...
    launch_flex_template_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dataflow::V1beta3::FlexTemplatesService::Rest::ServiceStub.stub :transcode_launch_flex_template_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, launch_flex_template_client_stub do
        ...
        # Verify method calls
        assert_equal 5, launch_flex_template_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dataflow::V1beta3::FlexTemplatesService::Rest::Client::Configuration, config
  end
end
