...
##
# Snippet for the create_uptime_check_config call in the UptimeCheckService service
#
...
# Google::Cloud::Monitoring::V3::UptimeCheckService::Client#create_uptime_check_config.
#
