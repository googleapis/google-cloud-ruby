...
class ::Google::Cloud::Monitoring::V3::QueryService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_query_time_series
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Monitoring::V3::QueryTimeSeriesResponse.new
    ...
    query_time_series_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :query_time_series, name
      assert_kind_of ::Google::Cloud::Monitoring::V3::QueryTimeSeriesRequest, request
    ...
    Gapic::ServiceStub.stub :new, query_time_series_client_stub do
      ...
      # Verify method calls
      assert_equal 5, query_time_series_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Monitoring::V3::QueryService::Client::Configuration, config
  end
end
