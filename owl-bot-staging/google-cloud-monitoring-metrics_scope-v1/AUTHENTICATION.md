...
The recommended way to authenticate to the google-cloud-monitoring-metrics_scope-v1 library is to use
...
The google-cloud-monitoring-metrics_scope-v1 library provides several mechanisms to configure your system.
