...
class ::Google::Cloud::Memcache::V1::CloudMemcache::ClientTest < Minitest::Test
  ...
  def test_list_instances
    ...
    Gapic::ServiceStub.stub :new, list_instances_client_stub do
      ...
      # Use protobuf object
      client.list_instances ::Google::Cloud::Memcache::V1::ListInstancesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_instances(::Google::Cloud::Memcache::V1::ListInstancesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_instance
    ...
    Gapic::ServiceStub.stub :new, get_instance_client_stub do
      ...
      # Use protobuf object
      client.get_instance ::Google::Cloud::Memcache::V1::GetInstanceRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_instance(::Google::Cloud::Memcache::V1::GetInstanceRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_instance
    ...
    Gapic::ServiceStub.stub :new, create_instance_client_stub do
      ...
      # Use protobuf object
      client.create_instance ::Google::Cloud::Memcache::V1::CreateInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_instance(::Google::Cloud::Memcache::V1::CreateInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_instance
    ...
    Gapic::ServiceStub.stub :new, update_instance_client_stub do
      ...
      # Use protobuf object
      client.update_instance ::Google::Cloud::Memcache::V1::UpdateInstanceRequest.new(update_mask: update_mask, instance: instance) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_instance(::Google::Cloud::Memcache::V1::UpdateInstanceRequest.new(update_mask: update_mask, instance: instance), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_parameters
    ...
    Gapic::ServiceStub.stub :new, update_parameters_client_stub do
      ...
      # Use protobuf object
      client.update_parameters ::Google::Cloud::Memcache::V1::UpdateParametersRequest.new(name: name, update_mask: update_mask, parameters: parameters) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_parameters(::Google::Cloud::Memcache::V1::UpdateParametersRequest.new(name: name, update_mask: update_mask, parameters: parameters), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_instance
    ...
    Gapic::ServiceStub.stub :new, delete_instance_client_stub do
      ...
      # Use protobuf object
      client.delete_instance ::Google::Cloud::Memcache::V1::DeleteInstanceRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_instance(::Google::Cloud::Memcache::V1::DeleteInstanceRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_apply_parameters
    ...
    Gapic::ServiceStub.stub :new, apply_parameters_client_stub do
      ...
      # Use protobuf object
      client.apply_parameters ::Google::Cloud::Memcache::V1::ApplyParametersRequest.new(name: name, node_ids: node_ids, apply_all: apply_all) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.apply_parameters(::Google::Cloud::Memcache::V1::ApplyParametersRequest.new(name: name, node_ids: node_ids, apply_all: apply_all), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_reschedule_maintenance
    ...
    Gapic::ServiceStub.stub :new, reschedule_maintenance_client_stub do
      ...
      # Use protobuf object
      client.reschedule_maintenance ::Google::Cloud::Memcache::V1::RescheduleMaintenanceRequest.new(instance: instance, reschedule_type: reschedule_type, schedule_time: schedule_time) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.reschedule_maintenance(::Google::Cloud::Memcache::V1::RescheduleMaintenanceRequest.new(instance: instance, reschedule_type: reschedule_type, schedule_time: schedule_time), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
