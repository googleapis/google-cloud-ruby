...
class ::Google::Cloud::ResourceManager::V3::TagBindings::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_tag_bindings
    # Create test objects.
    client_result = ::Google::Cloud::ResourceManager::V3::ListTagBindingsResponse.new
    ...
    list_tag_bindings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::ResourceManager::V3::TagBindings::Rest::ServiceStub.stub :transcode_list_tag_bindings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_tag_bindings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_tag_bindings_client_stub.call_count
      end
    end
  end
  ...
  def test_create_tag_binding
    ...
    create_tag_binding_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::TagBindings::Rest::ServiceStub.stub :transcode_create_tag_binding_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_tag_binding_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_tag_binding_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_tag_binding
    ...
    delete_tag_binding_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::TagBindings::Rest::ServiceStub.stub :transcode_delete_tag_binding_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_tag_binding_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_tag_binding_client_stub.call_count
      end
    end
  end
  ...
  def test_list_effective_tags
    # Create test objects.
    client_result = ::Google::Cloud::ResourceManager::V3::ListEffectiveTagsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_effective_tags_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::TagBindings::Rest::ServiceStub.stub :transcode_list_effective_tags_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_effective_tags_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_effective_tags_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ResourceManager::V3::TagBindings::Rest::Client::Configuration, config
  end
end
