      ...
      module PrincipalAccessBoundaryPolicies
        module Rest
          ...
          class ServiceStub
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::CreatePrincipalAccessBoundaryPolicyRequest]
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::GetPrincipalAccessBoundaryPolicyRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            def get_principal_access_boundary_policy request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Google::Iam::V3beta::PrincipalAccessBoundaryPolicy.decode_json response.body, ignore_unknown_fields: true
              catch :response do
                yield result, operation if block_given?
                result
              end
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::UpdatePrincipalAccessBoundaryPolicyRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::DeletePrincipalAccessBoundaryPolicyRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::ListPrincipalAccessBoundaryPoliciesRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Google::Iam::V3beta::ListPrincipalAccessBoundaryPoliciesResponse]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Google::Iam::V3beta::ListPrincipalAccessBoundaryPoliciesResponse]
            #   A result object deserialized from the server's reply
            def list_principal_access_boundary_policies request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Google::Iam::V3beta::ListPrincipalAccessBoundaryPoliciesResponse.decode_json response.body, ignore_unknown_fields: true
              catch :response do
                yield result, operation if block_given?
                result
              end
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::SearchPrincipalAccessBoundaryPolicyBindingsRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Google::Iam::V3beta::SearchPrincipalAccessBoundaryPolicyBindingsResponse]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Google::Iam::V3beta::SearchPrincipalAccessBoundaryPolicyBindingsResponse]
            #   A result object deserialized from the server's reply
            def search_principal_access_boundary_policy_bindings request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Google::Iam::V3beta::SearchPrincipalAccessBoundaryPolicyBindingsResponse.decode_json response.body, ignore_unknown_fields: true
              catch :response do
                yield result, operation if block_given?
                result
              end
            ...
            def self.transcode_create_principal_access_boundary_policy_request request_pb
              transcoder = Gapic::Rest::GrpcTranscoder.new
                                                      .with_bindings(
                                                        uri_method: :post,
                                                        uri_template: "/v3beta/{parent}/principalAccessBoundaryPolicies",
            ...
            def self.transcode_update_principal_access_boundary_policy_request request_pb
              transcoder = Gapic::Rest::GrpcTranscoder.new
                                                      .with_bindings(
                                                        uri_method: :patch,
                                                        uri_template: "/v3beta/{principal_access_boundary_policy.name}",
                                                        body: "principal_access_boundary_policy",
                                                        matches: [
