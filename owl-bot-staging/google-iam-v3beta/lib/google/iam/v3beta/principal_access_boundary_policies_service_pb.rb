...
begin
  ...
  imports = [
    ["google.iam.v3beta.PrincipalAccessBoundaryPolicy", "google/iam/v3beta/principal_access_boundary_policy_resources.proto"],
...
module Google
  module Iam
    module V3beta
      CreatePrincipalAccessBoundaryPolicyRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.CreatePrincipalAccessBoundaryPolicyRequest").msgclass
      GetPrincipalAccessBoundaryPolicyRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.GetPrincipalAccessBoundaryPolicyRequest").msgclass
      UpdatePrincipalAccessBoundaryPolicyRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.UpdatePrincipalAccessBoundaryPolicyRequest").msgclass
      DeletePrincipalAccessBoundaryPolicyRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.DeletePrincipalAccessBoundaryPolicyRequest").msgclass
      ListPrincipalAccessBoundaryPoliciesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.ListPrincipalAccessBoundaryPoliciesRequest").msgclass
      ListPrincipalAccessBoundaryPoliciesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.ListPrincipalAccessBoundaryPoliciesResponse").msgclass
      SearchPrincipalAccessBoundaryPolicyBindingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.SearchPrincipalAccessBoundaryPolicyBindingsRequest").msgclass
      SearchPrincipalAccessBoundaryPolicyBindingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.iam.v3beta.SearchPrincipalAccessBoundaryPolicyBindingsResponse").msgclass
    end
  end
end
