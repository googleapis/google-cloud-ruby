      ...
      module PolicyBindings
        module Rest
          ...
          class ServiceStub
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::CreatePolicyBindingRequest]
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::GetPolicyBindingRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            def get_policy_binding request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Google::Iam::V3beta::PolicyBinding.decode_json response.body, ignore_unknown_fields: true
              catch :response do
                yield result, operation if block_given?
                result
              end
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::UpdatePolicyBindingRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::DeletePolicyBindingRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::ListPolicyBindingsRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Google::Iam::V3beta::ListPolicyBindingsResponse]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Google::Iam::V3beta::ListPolicyBindingsResponse]
            #   A result object deserialized from the server's reply
            def list_policy_bindings request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Google::Iam::V3beta::ListPolicyBindingsResponse.decode_json response.body, ignore_unknown_fields: true
              catch :response do
                yield result, operation if block_given?
                result
              end
            ...
            #
            # @param request_pb [::Google::Iam::V3beta::SearchTargetPolicyBindingsRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Google::Iam::V3beta::SearchTargetPolicyBindingsResponse]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Google::Iam::V3beta::SearchTargetPolicyBindingsResponse]
            #   A result object deserialized from the server's reply
            def search_target_policy_bindings request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Google::Iam::V3beta::SearchTargetPolicyBindingsResponse.decode_json response.body, ignore_unknown_fields: true
              catch :response do
                yield result, operation if block_given?
                result
              end
            ...
            def self.transcode_create_policy_binding_request request_pb
              transcoder = Gapic::Rest::GrpcTranscoder.new
                                                      .with_bindings(
                                                        uri_method: :post,
                                                        uri_template: "/v3beta/{parent}/policyBindings",
                                                        body: "policy_binding",
                                                        matches: [
            ...
            def self.transcode_update_policy_binding_request request_pb
              transcoder = Gapic::Rest::GrpcTranscoder.new
                                                      .with_bindings(
                                                        uri_method: :patch,
                                                        uri_template: "/v3beta/{policy_binding.name}",
                                                        body: "policy_binding",
                                                        matches: [
            ...
            def self.transcode_search_target_policy_bindings_request request_pb
              transcoder = Gapic::Rest::GrpcTranscoder.new
                                                      .with_bindings(
                                                        uri_method: :get,
                                                        uri_template: "/v3beta/{parent}/policyBindings:searchTargetPolicyBindings",
                                                        matches: [
                                                          ["parent", %r{^projects/[^/]+/locations/[^/]+/?$}, false]
                                                        ]
                                                      )
