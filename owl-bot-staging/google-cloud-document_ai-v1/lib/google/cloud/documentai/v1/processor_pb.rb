  ...
  module Cloud
    module DocumentAI
      module V1
        ...
        ProcessorVersion::GenAiModelInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1.ProcessorVersion.GenAiModelInfo").msgclass
        ProcessorVersion::GenAiModelInfo::FoundationGenAiModelInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1.ProcessorVersion.GenAiModelInfo.FoundationGenAiModelInfo").msgclass
        ProcessorVersion::GenAiModelInfo::CustomGenAiModelInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1.ProcessorVersion.GenAiModelInfo.CustomGenAiModelInfo").msgclass
        ProcessorVersion::GenAiModelInfo::CustomGenAiModelInfo::CustomModelType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1.ProcessorVersion.GenAiModelInfo.CustomGenAiModelInfo.CustomModelType").enummodule
        ...
        ProcessorVersion::ModelType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1.ProcessorVersion.ModelType").enummodule
