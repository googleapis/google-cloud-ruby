...
specific version of the Document AI V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-document_ai-v1
```
...
is part of the name, e.g. `google-cloud-document_ai-v1`.
