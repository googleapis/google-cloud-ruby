...
The recommended way to authenticate to the google-cloud-billing library is to use
...
The google-cloud-billing library provides several mechanisms to configure your system.
