...
specific version of the Dataplex V1 API. Most users should consider using
the main client gem,
[google-cloud-dataplex](https://rubygems.org/gems/google-cloud-dataplex).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-dataplex-v1
```
...
client library with a name such as `google-cloud-dataplex`,
...
is part of the name, e.g. `google-cloud-dataplex-v1`.
