...
class ::Google::Cloud::Dataplex::V1::CmekService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Dataplex::V1::CmekService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dataplex::V1::CmekService::Operations::Configuration, config
  end
end
