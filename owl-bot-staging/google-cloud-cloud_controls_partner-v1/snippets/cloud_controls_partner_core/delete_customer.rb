...
##
# Snippet for the delete_customer call in the CloudControlsPartnerCore service
#
...
# Google::Cloud::CloudControlsPartner::V1::CloudControlsPartnerCore::Client#delete_customer.
#
def delete_customer
