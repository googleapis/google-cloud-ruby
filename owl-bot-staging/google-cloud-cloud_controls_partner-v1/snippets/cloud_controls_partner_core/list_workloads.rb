...
##
# Snippet for the list_workloads call in the CloudControlsPartnerCore service
#
...
# Google::Cloud::CloudControlsPartner::V1::CloudControlsPartnerCore::Client#list_workloads.
#
def list_workloads
