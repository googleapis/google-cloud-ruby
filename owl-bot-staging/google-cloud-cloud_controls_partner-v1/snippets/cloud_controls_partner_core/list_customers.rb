...
##
# Snippet for the list_customers call in the CloudControlsPartnerCore service
#
...
# Google::Cloud::CloudControlsPartner::V1::CloudControlsPartnerCore::Client#list_customers.
#
def list_customers
