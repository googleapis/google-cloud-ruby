...
##
# Snippet for the get_violation call in the CloudControlsPartnerMonitoring service
#
...
# Google::Cloud::CloudControlsPartner::V1::CloudControlsPartnerMonitoring::Client#get_violation.
#
def get_violation
