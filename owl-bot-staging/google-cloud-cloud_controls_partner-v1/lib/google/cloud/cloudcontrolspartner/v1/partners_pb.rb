...
module Google
  module Cloud
    module CloudControlsPartner
      module V1
        Partner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.cloudcontrolspartner.v1.Partner").msgclass
        GetPartnerRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.cloudcontrolspartner.v1.GetPartnerRequest").msgclass
        Sku = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.cloudcontrolspartner.v1.Sku").msgclass
        EkmMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.cloudcontrolspartner.v1.EkmMetadata").msgclass
        EkmMetadata::EkmSolution = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.cloudcontrolspartner.v1.EkmMetadata.EkmSolution").enummodule
      end
    end
  end
end
