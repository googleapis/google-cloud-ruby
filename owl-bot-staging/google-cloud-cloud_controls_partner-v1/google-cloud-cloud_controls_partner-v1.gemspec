...
require File.expand_path("lib/google/cloud/cloud_controls_partner/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-cloud_controls_partner-v1"
  gem.version       = Google::Cloud::CloudControlsPartner::V1::VERSION
