...
class ::Google::Cloud::CloudControlsPartner::V1::CloudControlsPartnerCore::ClientTest < Minitest::Test
  ...
  def test_create_customer
    ...
    Gapic::ServiceStub.stub :new, create_customer_client_stub do
      ...
      # Use protobuf object
      client.create_customer ::Google::Cloud::CloudControlsPartner::V1::CreateCustomerRequest.new(parent: parent, customer: customer, customer_id: customer_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_customer(::Google::Cloud::CloudControlsPartner::V1::CreateCustomerRequest.new(parent: parent, customer: customer, customer_id: customer_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_customer
    ...
    Gapic::ServiceStub.stub :new, update_customer_client_stub do
      ...
      # Use protobuf object
      client.update_customer ::Google::Cloud::CloudControlsPartner::V1::UpdateCustomerRequest.new(customer: customer, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_customer(::Google::Cloud::CloudControlsPartner::V1::UpdateCustomerRequest.new(customer: customer, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_customer
    ...
    Gapic::ServiceStub.stub :new, delete_customer_client_stub do
      ...
      # Use protobuf object
      client.delete_customer ::Google::Cloud::CloudControlsPartner::V1::DeleteCustomerRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_customer(::Google::Cloud::CloudControlsPartner::V1::DeleteCustomerRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
