        ...
        module V1
          module NotificationsApiService
            ...
            module Paths
              ...
              ##
              # Create a fully-qualified NotificationSubscriptionHealthMetrics resource string.
              #
              # The resource will be in the following format:
              #
              # `accounts/{account}/notificationsubscriptions/{notification_subscription}`
              ...
              #
              # @return [::String]
              def notification_subscription_health_metrics_path account:, notification_subscription:
                raise ::ArgumentError, "account cannot contain /" if account.to_s.include? "/"
