...
specific version of the Audit Manager V1 API. Most users should consider using
the main client gem,
[google-cloud-audit_manager](https://rubygems.org/gems/google-cloud-audit_manager).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-audit_manager-v1
```
...
1. [Enable the API.](https://console.cloud.google.com/apis/library/auditmanager.googleapis.com)
...
See also the [Product Documentation](https://cloud.google.com/audit-manager/docs)
...
client library with a name such as `google-cloud-audit_manager`,
and lower-level _versioned_ client libraries with names such as
`google-cloud-audit_manager-v1`.
...
is part of the name, e.g. `google-cloud-audit_manager-v1`.
