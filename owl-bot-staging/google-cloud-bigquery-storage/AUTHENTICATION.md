...
In general, the google-cloud-bigquery-storage library uses
...
The google-cloud-bigquery-storage library aims to make authentication
...
Google::Cloud::Bigquery::Storage.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-bigquery-storage.
