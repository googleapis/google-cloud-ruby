...
require "google/cloud/cloud_controls_partner/version"
...
::Google::Cloud.configure.add_config! :cloud_controls_partner do |config|
...
module Google
  module Cloud
    module CloudControlsPartner
      ...
      #
      def self.cloud_controls_partner_core version: :v1, transport: :grpc, &block
        ...
        package_name = Google::Cloud::CloudControlsPartner
                       ...
                       .first
        service_module = Google::Cloud::CloudControlsPartner.const_get(package_name).const_get(:CloudControlsPartnerCore)
      ...
      # @return [::Object] A client object for the specified version.
      #
      def self.cloud_controls_partner_monitoring version: :v1, transport: :grpc, &block
        require "google/cloud/cloud_controls_partner/#{version.to_s.downcase}"
        ...
        package_name = Google::Cloud::CloudControlsPartner
                       ...
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
                       .first
        service_module = Google::Cloud::CloudControlsPartner.const_get(package_name).const_get(:CloudControlsPartnerMonitoring)
        service_module = service_module.const_get(:Rest) if transport == :rest
        service_module.const_get(:Client).new(&block)
      end
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.cloud_controls_partner if block_given?
...
helper_path = ::File.join __dir__, "cloud_controls_partner", "helpers.rb"
require "google/cloud/cloud_controls_partner/helpers" if ::File.file? helper_path
