# Ruby Client for the Cloud Build V2 API
...
specific version of the Cloud Build V2 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-build-v2
```
...
request = ::Google::Cloud::Build::V2::CreateConnectionRequest.new # (request fields as keyword arguments...)
...
is part of the name, e.g. `google-cloud-build-v2`.
