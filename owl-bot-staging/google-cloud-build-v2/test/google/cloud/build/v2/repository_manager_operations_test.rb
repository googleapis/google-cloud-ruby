...
class ::Google::Cloud::Build::V2::RepositoryManager::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Build::V2::RepositoryManager::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Build::V2::RepositoryManager::Operations::Configuration, config
  end
end
