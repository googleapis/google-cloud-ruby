  ...
  module Cloud
    module Channel
      module V1
        ...
        DiscountComponent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.channel.v1.DiscountComponent").msgclass
        ...
        DiscountType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.channel.v1.DiscountType").enummodule
      end
    end
  end
end
