...
View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-data_sources)
for this library, google-shopping-merchant-data_sources, to see the convenience methods for
...
```
$ gem install google-shopping-merchant-data_sources
```
...
is part of the name, e.g. `google-shopping-merchant-data_sources-v1beta`.
