...
require File.expand_path("lib/google/cloud/bigquery/migration/v2/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-bigquery-migration-v2"
  gem.version       = Google::Cloud::Bigquery::Migration::V2::VERSION
  ...
  gem.summary       = "API Client library for the BigQuery Migration V2 API"
