...
The recommended way to authenticate to the google-cloud-bigquery-migration-v2 library is to use
...
The google-cloud-bigquery-migration-v2 library provides several mechanisms to configure your system.
