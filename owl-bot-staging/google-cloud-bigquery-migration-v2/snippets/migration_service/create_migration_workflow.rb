...
##
# Snippet for the create_migration_workflow call in the MigrationService service
#
...
# Google::Cloud::Bigquery::Migration::V2::MigrationService::Client#create_migration_workflow.
#
