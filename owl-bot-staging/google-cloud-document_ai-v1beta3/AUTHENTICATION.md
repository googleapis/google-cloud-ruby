...
The recommended way to authenticate to the google-cloud-document_ai-v1beta3 library is to use
...
The google-cloud-document_ai-v1beta3 library provides several mechanisms to configure your system.
