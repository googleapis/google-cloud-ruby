  ...
  module Cloud
    module DocumentAI
      module V1beta3
        ...
        Evaluation::EvaluationRevision = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Evaluation.EvaluationRevision").msgclass
      end
    end
  end
end
