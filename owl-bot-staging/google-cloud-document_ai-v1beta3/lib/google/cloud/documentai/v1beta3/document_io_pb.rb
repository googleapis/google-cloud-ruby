...
module Google
  module Cloud
    module DocumentAI
      module V1beta3
        Documents = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Documents").msgclass
        ...
        RawDocuments = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.RawDocuments").msgclass
