...
class ::Google::Cloud::DocumentAI::V1beta3::DocumentService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::DocumentAI::V1beta3::DocumentService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DocumentAI::V1beta3::DocumentService::Operations::Configuration, config
  end
end
