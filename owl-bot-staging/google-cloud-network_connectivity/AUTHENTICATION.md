...
In general, the google-cloud-network_connectivity library uses
...
The google-cloud-network_connectivity library aims to make authentication
...
Google::Cloud::NetworkConnectivity.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-network_connectivity.
