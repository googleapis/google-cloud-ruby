...
require "google/cloud/network_connectivity/version"
...
helper_path = ::File.join __dir__, "network_connectivity", "helpers.rb"
require "google/cloud/network_connectivity/helpers" if ::File.file? helper_path
