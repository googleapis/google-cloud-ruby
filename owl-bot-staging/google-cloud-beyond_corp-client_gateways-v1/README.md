# Ruby Client for the BeyondCorp ClientGateways V1 API
...
specific version of the BeyondCorp ClientGateways V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-beyond_corp-client_gateways-v1
```
...
request = ::Google::Cloud::BeyondCorp::ClientGateways::V1::ListClientGatewaysRequest.new # (request fields as keyword arguments...)
response = client.list_client_gateways request
```

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-beyond_corp-client_gateways-v1/latest)
...
is part of the name, e.g. `google-cloud-beyond_corp-client_gateways-v1`.
