...
class ::Google::Cloud::Monitoring::Dashboard::V1::DashboardsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_dashboard
    # Create test objects.
    client_result = ::Google::Cloud::Monitoring::Dashboard::V1::Dashboard.new
    ...
    create_dashboard_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Monitoring::Dashboard::V1::DashboardsService::Rest::ServiceStub.stub :transcode_create_dashboard_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_dashboard_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_dashboard_client_stub.call_count
      end
    end
  end
  ...
  def test_list_dashboards
    # Create test objects.
    client_result = ::Google::Cloud::Monitoring::Dashboard::V1::ListDashboardsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_dashboards_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Monitoring::Dashboard::V1::DashboardsService::Rest::ServiceStub.stub :transcode_list_dashboards_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_dashboards_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_dashboards_client_stub.call_count
      end
    end
  end
  ...
  def test_get_dashboard
    ...
    get_dashboard_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Monitoring::Dashboard::V1::DashboardsService::Rest::ServiceStub.stub :transcode_get_dashboard_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_dashboard_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_dashboard_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_dashboard
    ...
    delete_dashboard_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Monitoring::Dashboard::V1::DashboardsService::Rest::ServiceStub.stub :transcode_delete_dashboard_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_dashboard_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_dashboard_client_stub.call_count
      end
    end
  end
  ...
  def test_update_dashboard
    ...
    update_dashboard_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Monitoring::Dashboard::V1::DashboardsService::Rest::ServiceStub.stub :transcode_update_dashboard_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_dashboard_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_dashboard_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Monitoring::Dashboard::V1::DashboardsService::Rest::Client::Configuration, config
  end
end
