...
class ::Google::Cloud::Storage::Control::V2::StorageControl::ClientTest < Minitest::Test
  ...
  def test_create_anywhere_cache
    ...
    create_anywhere_cache_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["anywhere_cache_id"]
    ...
    Gapic::ServiceStub.stub :new, create_anywhere_cache_client_stub do
      ...
      # Use hash object
      client.create_anywhere_cache({ parent: parent, anywhere_cache_id: anywhere_cache_id, anywhere_cache: anywhere_cache, request_id: request_id }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.create_anywhere_cache ::Google::Cloud::Storage::Control::V2::CreateAnywhereCacheRequest.new(parent: parent, anywhere_cache_id: anywhere_cache_id, anywhere_cache: anywhere_cache, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.create_anywhere_cache({ parent: parent, anywhere_cache_id: anywhere_cache_id, anywhere_cache: anywhere_cache, request_id: request_id }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_anywhere_cache(::Google::Cloud::Storage::Control::V2::CreateAnywhereCacheRequest.new(parent: parent, anywhere_cache_id: anywhere_cache_id, anywhere_cache: anywhere_cache, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
