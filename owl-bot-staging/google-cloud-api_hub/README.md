# Ruby Client for the API hub API

API Client library for the API hub API
...
_versioned_ client gems, with names of the form `google-cloud-api_hub-v*`.
The gem `google-cloud-api_hub` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-api_hub/latest)
for this library, google-cloud-api_hub, to see the convenience methods for
...
```
$ gem install google-cloud-api_hub
```
