  ...
  module Cloud
    module Video
      module Stitcher
        ...
        #   Defaults to `:v1`.
        # @return [VideoStitcherService::Client] A client object for the specified version.
        #
        def self.video_stitcher_service version: :v1, &block
          ...
          package_name = Google::Cloud::Video::Stitcher
                         ...
                         .first
          package_module = Google::Cloud::Video::Stitcher.const_get package_name
          package_module.const_get(:VideoStitcherService).const_get(:Client).new(&block)
        end
