...
specific version of the Parallelstore V1 API. Most users should consider using
the main client gem,
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-parallelstore-v1/latest)
