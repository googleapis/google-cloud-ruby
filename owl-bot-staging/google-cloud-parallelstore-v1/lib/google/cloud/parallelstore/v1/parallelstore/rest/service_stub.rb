        ...
        module Parallelstore
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Parallelstore::V1::ListInstancesRequest]
              ...
              def list_instances request_pb, options = nil
                ...
                result = ::Google::Cloud::Parallelstore::V1::ListInstancesResponse.decode_json response.body, ignore_unknown_fields: true
              ...
              #
              # @param request_pb [::Google::Cloud::Parallelstore::V1::GetInstanceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def get_instance request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Parallelstore::V1::Instance.decode_json response.body, ignore_unknown_fields: true
              ...
              #
              # @param request_pb [::Google::Cloud::Parallelstore::V1::CreateInstanceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Parallelstore::V1::UpdateInstanceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Parallelstore::V1::DeleteInstanceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Parallelstore::V1::ImportDataRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Parallelstore::V1::ExportDataRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
