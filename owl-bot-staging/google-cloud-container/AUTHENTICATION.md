...
The recommended way to authenticate to the google-cloud-container library is to use
...
The google-cloud-container library provides several mechanisms to configure your system.
