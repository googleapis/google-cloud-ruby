...
##
# Snippet for the create_version call in the ManagedSchemaRegistry service
#
...
# Google::Cloud::ManagedKafka::SchemaRegistry::V1::ManagedSchemaRegistry::Client#create_version.
#
def create_version
