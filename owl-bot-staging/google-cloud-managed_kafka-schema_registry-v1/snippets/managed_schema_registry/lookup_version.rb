...
##
# Snippet for the lookup_version call in the ManagedSchemaRegistry service
#
...
# Google::Cloud::ManagedKafka::SchemaRegistry::V1::ManagedSchemaRegistry::Client#lookup_version.
#
def lookup_version
