...
class ::Google::Cloud::NetworkConnectivity::V1beta::HubService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_gateway_advertised_route_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.gateway_advertised_route_path project: "value0", location: "value1", spoke: "value2", gateway_advertised_route: "value3"
      assert_equal "projects/value0/locations/value1/spokes/value2/gatewayAdvertisedRoutes/value3", path
    end
  end
  ...
  def test_sac_attachment_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.sac_attachment_path project: "value0", location: "value1", sac_attachment: "value2"
      assert_equal "projects/value0/locations/value1/sacAttachments/value2", path
    end
  end
