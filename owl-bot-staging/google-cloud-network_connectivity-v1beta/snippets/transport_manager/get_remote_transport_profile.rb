...
##
# Snippet for the get_remote_transport_profile call in the TransportManager service
#
...
# Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Client#get_remote_transport_profile.
#
