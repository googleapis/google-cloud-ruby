...
##
# Snippet for the parse_from_activation_key call in the TransportManager service
#
...
# Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Client#parse_from_activation_key.
#
