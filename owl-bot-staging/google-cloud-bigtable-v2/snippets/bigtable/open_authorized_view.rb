...
##
# Snippet for the open_authorized_view call in the Bigtable service
#
...
# Google::Cloud::Bigtable::V2::Bigtable::Client#open_authorized_view.
#
def open_authorized_view
