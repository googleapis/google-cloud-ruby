  ...
  module Cloud
    module Bigtable
      module V2
        ...
        Mutation::AddToCell = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.v2.Mutation.AddToCell").msgclass
        Mutation::MergeToCell = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.v2.Mutation.MergeToCell").msgclass
        ...
        ProtoRows = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.v2.ProtoRows").msgclass
        ...
        Idempotency = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.v2.Idempotency").msgclass
      end
    end
  end
end
