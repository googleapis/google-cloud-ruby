...
In general, the google-cloud-bigtable-v2 library uses
...
The google-cloud-bigtable-v2 library aims to make authentication
...
connect to most services with google-cloud-bigtable-v2.
