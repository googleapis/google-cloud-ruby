...
class ::Google::Cloud::Gaming::V1::GameServerDeploymentsService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Gaming::V1::GameServerDeploymentsService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Gaming::V1::GameServerDeploymentsService::Operations::Configuration, config
  end
end
