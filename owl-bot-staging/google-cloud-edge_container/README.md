# Ruby Client for the Distributed Cloud Edge Container API

API Client library for the Distributed Cloud Edge Container API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-edge_container/latest)
for this library, google-cloud-edge_container, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-edge_container-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-edge_container-v1/latest).
...
```
$ gem install google-cloud-edge_container
```
