...
require File.expand_path("lib/google/cloud/cloud_dms/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-cloud_dms-v1"
  ...
  gem.summary       = "API Client library for the Cloud Database Migration Service V1 API"
