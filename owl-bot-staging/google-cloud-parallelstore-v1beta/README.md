...
specific version of the Parallelstore V1BETA API. Most users should consider using
the main client gem,
[google-cloud-parallelstore](https://rubygems.org/gems/google-cloud-parallelstore).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-parallelstore-v1beta
```
...
request = ::Google::Cloud::Parallelstore::V1beta::ListInstancesRequest.new # (request fields as keyword arguments...)
