...
The recommended way to authenticate to the google-cloud-dlp library is to use
...
The google-cloud-dlp library provides several mechanisms to configure your system.
