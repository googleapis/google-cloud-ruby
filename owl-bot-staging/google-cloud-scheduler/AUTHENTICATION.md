...
The recommended way to authenticate to the google-cloud-scheduler library is to use
...
The google-cloud-scheduler library provides several mechanisms to configure your system.
