...
class ::Google::Cloud::Profiler::V2::ProfilerService::ClientPathsTest < Minitest::Test
  def test_profile_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.profile_path project: "value0", profile: "value1"
      assert_equal "projects/value0/profiles/value1", path
    end
  end
