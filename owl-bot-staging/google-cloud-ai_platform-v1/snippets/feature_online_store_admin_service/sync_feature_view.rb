...
##
# Snippet for the sync_feature_view call in the FeatureOnlineStoreAdminService service
#
...
# Google::Cloud::AIPlatform::V1::FeatureOnlineStoreAdminService::Client#sync_feature_view.
#
