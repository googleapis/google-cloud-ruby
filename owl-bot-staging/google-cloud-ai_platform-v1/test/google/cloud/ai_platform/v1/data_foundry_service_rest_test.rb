...
class ::Google::Cloud::AIPlatform::V1::DataFoundryService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_generate_synthetic_data
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::GenerateSyntheticDataResponse.new
    ...
    generate_synthetic_data_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::AIPlatform::V1::DataFoundryService::Rest::ServiceStub.stub :transcode_generate_synthetic_data_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, generate_synthetic_data_client_stub do
        ...
        # Verify method calls
        assert_equal 5, generate_synthetic_data_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::DataFoundryService::Rest::Client::Configuration, config
  end
end
