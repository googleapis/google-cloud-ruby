...
class ::Google::Cloud::AIPlatform::V1::ModelGardenService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_publisher_model
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::PublisherModel.new
    ...
    ::Google::Cloud::AIPlatform::V1::ModelGardenService::Rest::ServiceStub.stub :transcode_get_publisher_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_publisher_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_publisher_model_client_stub.call_count
      end
    end
  end
  ...
  def test_deploy
    ...
    deploy_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::ModelGardenService::Rest::ServiceStub.stub :transcode_deploy_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, deploy_client_stub do
        ...
        # Verify method calls
        assert_equal 5, deploy_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::ModelGardenService::Rest::Client::Configuration, config
  end
end
