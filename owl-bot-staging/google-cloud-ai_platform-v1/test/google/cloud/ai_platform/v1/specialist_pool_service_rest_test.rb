...
class ::Google::Cloud::AIPlatform::V1::SpecialistPoolService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_specialist_pool
    ...
    create_specialist_pool_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::AIPlatform::V1::SpecialistPoolService::Rest::ServiceStub.stub :transcode_create_specialist_pool_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_specialist_pool_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_specialist_pool_client_stub.call_count
      end
    end
  end
  ...
  def test_get_specialist_pool
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::SpecialistPool.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_specialist_pool_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::SpecialistPoolService::Rest::ServiceStub.stub :transcode_get_specialist_pool_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_specialist_pool_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_specialist_pool_client_stub.call_count
      end
    end
  end
  ...
  def test_list_specialist_pools
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::ListSpecialistPoolsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_specialist_pools_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::SpecialistPoolService::Rest::ServiceStub.stub :transcode_list_specialist_pools_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_specialist_pools_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_specialist_pools_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_specialist_pool
    ...
    delete_specialist_pool_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::SpecialistPoolService::Rest::ServiceStub.stub :transcode_delete_specialist_pool_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_specialist_pool_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_specialist_pool_client_stub.call_count
      end
    end
  end
  ...
  def test_update_specialist_pool
    ...
    update_specialist_pool_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::SpecialistPoolService::Rest::ServiceStub.stub :transcode_update_specialist_pool_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_specialist_pool_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_specialist_pool_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::SpecialistPoolService::Rest::Client::Configuration, config
  end
end
