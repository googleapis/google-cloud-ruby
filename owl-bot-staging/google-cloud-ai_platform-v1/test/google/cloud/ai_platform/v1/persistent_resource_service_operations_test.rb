...
class ::Google::Cloud::AIPlatform::V1::PersistentResourceService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Operations::Configuration, config
  end
end
