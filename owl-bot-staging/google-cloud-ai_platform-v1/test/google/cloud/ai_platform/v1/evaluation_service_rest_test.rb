...
class ::Google::Cloud::AIPlatform::V1::EvaluationService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_evaluate_instances
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::EvaluateInstancesResponse.new
    ...
    evaluate_instances_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::AIPlatform::V1::EvaluationService::Rest::ServiceStub.stub :transcode_evaluate_instances_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, evaluate_instances_client_stub do
        ...
        # Verify method calls
        assert_equal 5, evaluate_instances_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::EvaluationService::Rest::Client::Configuration, config
  end
end
