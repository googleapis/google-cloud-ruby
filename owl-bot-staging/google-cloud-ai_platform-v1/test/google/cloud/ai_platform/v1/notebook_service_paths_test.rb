...
class ::Google::Cloud::AIPlatform::V1::NotebookService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_notebook_runtime_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.notebook_runtime_path project: "value0", location: "value1", notebook_runtime: "value2"
      assert_equal "projects/value0/locations/value1/notebookRuntimes/value2", path
    end
  end
