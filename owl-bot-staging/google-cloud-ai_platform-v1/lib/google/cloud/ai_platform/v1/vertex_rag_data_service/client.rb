        ...
        module VertexRagDataService
          ...
          class Client
            ...
            def initialize
              ...
              @vertex_rag_data_service_stub.stub_logger&.info do |entry|
              ...
              @location_client = Google::Cloud::Location::Locations::Client.new do |config|
                ...
                config.logger = @vertex_rag_data_service_stub.logger if config.respond_to? :logger=
              end
            ...
            #
            def logger
              @vertex_rag_data_service_stub.logger
            end
