...
helper_path = ::File.join __dir__, "persistent_resource_service", "helpers.rb"
require "google/cloud/ai_platform/v1/persistent_resource_service/helpers" if ::File.file? helper_path
