          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::AIPlatform::V1::VertexRagService::Rest::Operations.new do |config|
              ...
              #
              # @return [::Google::Cloud::AIPlatform::V1::VertexRagService::Rest::Operations]
              #
              ...
              def ask_contexts request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.ask_contexts.metadata.to_h
                ...
                @vertex_rag_service_stub.ask_contexts request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def async_retrieve_contexts request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.async_retrieve_contexts.metadata.to_h
                ...
                @vertex_rag_service_stub.async_retrieve_contexts request, options do |result, operation|
