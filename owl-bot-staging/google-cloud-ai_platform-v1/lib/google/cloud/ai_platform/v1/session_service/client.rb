      ...
      module V1
        module SessionService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::AIPlatform::V1::SessionService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all SessionService clients
            #   ::Google::Cloud::AIPlatform::V1::SessionService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::AIPlatform::V1::SessionService::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/aiplatform/v1/session_service_services_pb"
              ...
              @session_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::AIPlatform::V1::SessionService::Stub,
            ...
            #
            # @return [::Google::Cloud::AIPlatform::V1::SessionService::Operations]
            #
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::AIPlatform::V1::Session]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1::Session>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1::Session>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1::SessionEvent>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1::SessionEvent>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def list_events request, options = nil
              ...
              @session_service_stub.call_rpc :list_events, request, options: options do |response, operation|
                response = ::Gapic::PagedEnumerable.new @session_service_stub, :list_events, request, response, operation, options
                yield response, operation if block_given?
                throw :response, response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::AIPlatform::V1::AppendEventResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def append_event request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.append_event.metadata.to_h
              ...
              @session_service_stub.call_rpc :append_event, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            # {::Google::Cloud::AIPlatform::V1::SessionService::Client::Configuration::Rpcs}
