...
require "google/cloud/ai_platform/v1/session_service/rest/service_stub"
        ...
        module SessionService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::AIPlatform::V1::SessionService::Rest::Client::Configuration}
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::AIPlatform::V1::SessionService::Rest::Operations.new do |config|
                ...
                @session_service_stub = ::Google::Cloud::AIPlatform::V1::SessionService::Rest::ServiceStub.new(
              ...
              #
              # @return [::Google::Cloud::AIPlatform::V1::SessionService::Rest::Operations]
              #
              ...
              ##
              # Creates a new {::Google::Cloud::AIPlatform::V1::Session Session}.
              #
              # @overload create_session(request, options = nil)
              #   Pass arguments to `create_session` via a request object, either of type
              #   {::Google::Cloud::AIPlatform::V1::CreateSessionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::AIPlatform::V1::CreateSessionRequest, ::Hash]
              ...
              def create_session request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1::CreateSessionRequest
              ...
              ##
              # Gets details of the specific {::Google::Cloud::AIPlatform::V1::Session Session}.
              #
              # @overload get_session(request, options = nil)
              #   Pass arguments to `get_session` via a request object, either of type
              #   {::Google::Cloud::AIPlatform::V1::GetSessionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::AIPlatform::V1::GetSessionRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::AIPlatform::V1::Session]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              ...
              def get_session request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1::GetSessionRequest
              ...
              ##
              # Lists {::Google::Cloud::AIPlatform::V1::Session Sessions} in a given reasoning
              # engine.
              #
              # @overload list_sessions(request, options = nil)
              #   Pass arguments to `list_sessions` via a request object, either of type
              #   {::Google::Cloud::AIPlatform::V1::ListSessionsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::AIPlatform::V1::ListSessionsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #     {::Google::Cloud::AIPlatform::V1::SessionService::Rest::Client#list_sessions SessionService.ListSessions}
              #     call.
              #   @param filter [::String]
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::AIPlatform::V1::Session>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::AIPlatform::V1::Session>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_sessions request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1::ListSessionsRequest
              ...
              ##
              # Updates the specific {::Google::Cloud::AIPlatform::V1::Session Session}.
              #
              # @overload update_session(request, options = nil)
              #   Pass arguments to `update_session` via a request object, either of type
              #   {::Google::Cloud::AIPlatform::V1::UpdateSessionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::AIPlatform::V1::UpdateSessionRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              def update_session request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1::UpdateSessionRequest
              ...
              # {::Google::Cloud::AIPlatform::V1::Session Session}.
              #
              # @overload delete_session(request, options = nil)
              #   Pass arguments to `delete_session` via a request object, either of type
              #   {::Google::Cloud::AIPlatform::V1::DeleteSessionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::AIPlatform::V1::DeleteSessionRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              def delete_session request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1::DeleteSessionRequest
              ...
              ##
              # Lists {::Google::Cloud::AIPlatform::V1::Event Events} in a given session.
              #
              # @overload list_events(request, options = nil)
              #   Pass arguments to `list_events` via a request object, either of type
              #   {::Google::Cloud::AIPlatform::V1::ListEventsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::AIPlatform::V1::ListEventsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #     value returned from a previous list
              #     {::Google::Cloud::AIPlatform::V1::SessionService::Rest::Client#list_events SessionService.ListEvents}
              #     call.
              #   @param filter [::String]
              #     Optional. The standard list filter.
              #     Supported fields:
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::AIPlatform::V1::SessionEvent>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::AIPlatform::V1::SessionEvent>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_events request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1::ListEventsRequest
                ...
                @session_service_stub.list_events request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @session_service_stub, :list_events, "session_events", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              #
              # @overload append_event(request, options = nil)
              #   Pass arguments to `append_event` via a request object, either of type
              #   {::Google::Cloud::AIPlatform::V1::AppendEventRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::AIPlatform::V1::AppendEventRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload append_event(name: nil, event: nil)
              #   Pass arguments to `append_event` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param name [::String]
              ...
              #     Format:
              #     `projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sessions/{session}`
              #   @param event [::Google::Cloud::AIPlatform::V1::SessionEvent, ::Hash]
              #     Required. The event to append to the session.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::AIPlatform::V1::AppendEventResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::AIPlatform::V1::AppendEventResponse]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              #   p result
              #
              def append_event request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1::AppendEventRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                call_metadata = @config.rpcs.append_event.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.append_event.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.append_event.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @session_service_stub.append_event request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::AIPlatform::V1::SessionService::Rest::Client::Configuration::Rpcs}
              ...
              class Configuration
                ...
                class Rpcs
                  ...
                  ##
                  # RPC-specific configuration for `append_event`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :append_event
                  ...
                  def initialize parent_rpcs = nil
                    ...
                    append_event_config = parent_rpcs.append_event if parent_rpcs.respond_to? :append_event
                    @append_event = ::Gapic::Config::Method.new append_event_config
