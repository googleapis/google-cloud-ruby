          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @index_endpoint_service_stub.logger(stub: true)&.info do |entry|
                ...
                @location_client = Google::Cloud::Location::Locations::Rest::Client.new do |config|
                  ...
                  config.logger = @index_endpoint_service_stub.logger if config.respond_to? :logger=
                end
              ...
              #
              def logger
                @index_endpoint_service_stub.logger
              end
