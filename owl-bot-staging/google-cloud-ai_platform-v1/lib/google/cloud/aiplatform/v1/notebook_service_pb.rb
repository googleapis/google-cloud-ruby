...
require 'google/cloud/aiplatform/v1/notebook_runtime_pb'
...
begin
  ...
  imports = [
    ["google.cloud.aiplatform.v1.NotebookRuntimeTemplate", "google/cloud/aiplatform/v1/notebook_runtime.proto"],
...
module Google
  module Cloud
    module AIPlatform
      module V1
        CreateNotebookRuntimeTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.CreateNotebookRuntimeTemplateRequest").msgclass
        CreateNotebookRuntimeTemplateOperationMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.CreateNotebookRuntimeTemplateOperationMetadata").msgclass
        GetNotebookRuntimeTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.GetNotebookRuntimeTemplateRequest").msgclass
        ListNotebookRuntimeTemplatesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.ListNotebookRuntimeTemplatesRequest").msgclass
        ListNotebookRuntimeTemplatesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.ListNotebookRuntimeTemplatesResponse").msgclass
        DeleteNotebookRuntimeTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.DeleteNotebookRuntimeTemplateRequest").msgclass
        UpdateNotebookRuntimeTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.UpdateNotebookRuntimeTemplateRequest").msgclass
        AssignNotebookRuntimeRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.AssignNotebookRuntimeRequest").msgclass
        AssignNotebookRuntimeOperationMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.AssignNotebookRuntimeOperationMetadata").msgclass
        GetNotebookRuntimeRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.GetNotebookRuntimeRequest").msgclass
        ListNotebookRuntimesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.ListNotebookRuntimesRequest").msgclass
        ListNotebookRuntimesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.ListNotebookRuntimesResponse").msgclass
        DeleteNotebookRuntimeRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.DeleteNotebookRuntimeRequest").msgclass
        UpgradeNotebookRuntimeRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.UpgradeNotebookRuntimeRequest").msgclass
        UpgradeNotebookRuntimeOperationMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.UpgradeNotebookRuntimeOperationMetadata").msgclass
        UpgradeNotebookRuntimeResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.UpgradeNotebookRuntimeResponse").msgclass
