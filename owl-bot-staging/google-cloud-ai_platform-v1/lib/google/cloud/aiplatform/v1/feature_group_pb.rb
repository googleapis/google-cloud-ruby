  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        FeatureGroup::BigQuery::TimeSeries = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.FeatureGroup.BigQuery.TimeSeries").msgclass
      end
    end
  end
end
