  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        Tool::PhishBlockThreshold = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.Tool.PhishBlockThreshold").enummodule
        ...
        GoogleMaps = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.GoogleMaps").msgclass
