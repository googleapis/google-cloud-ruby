  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        NotebookExecutionJob::WorkbenchRuntime = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.NotebookExecutionJob.WorkbenchRuntime").msgclass
      end
    end
  end
end
