  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        GenerateFetchAccessTokenRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.GenerateFetchAccessTokenRequest").msgclass
        GenerateFetchAccessTokenResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.GenerateFetchAccessTokenResponse").msgclass
