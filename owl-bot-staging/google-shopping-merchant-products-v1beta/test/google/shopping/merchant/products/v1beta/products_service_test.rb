...
class ::Google::Shopping::Merchant::Products::V1beta::ProductsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_product
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Products::V1beta::Product.new
  ...
  def test_list_products
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Products::V1beta::ListProductsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_products_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::ListProductsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_products_client_stub do
      ...
      # Use protobuf object
      client.list_products ::Google::Shopping::Merchant::Products::V1beta::ListProductsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_products(::Google::Shopping::Merchant::Products::V1beta::ListProductsRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::ProductsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::ProductsService::Client, client
