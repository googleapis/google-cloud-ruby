...
class ::Google::Shopping::Merchant::Products::V1beta::ProductInputsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_insert_product_input
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Products::V1beta::ProductInput.new
    ...
    insert_product_input_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::InsertProductInputRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Products::V1beta::ProductInput), request["product_input"]
    ...
    Gapic::ServiceStub.stub :new, insert_product_input_client_stub do
      ...
      # Use protobuf object
      client.insert_product_input ::Google::Shopping::Merchant::Products::V1beta::InsertProductInputRequest.new(parent: parent, product_input: product_input, data_source: data_source) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.insert_product_input(::Google::Shopping::Merchant::Products::V1beta::InsertProductInputRequest.new(parent: parent, product_input: product_input, data_source: data_source), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_product_input
    ...
    update_product_input_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::UpdateProductInputRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Products::V1beta::ProductInput), request["product_input"]
    ...
    Gapic::ServiceStub.stub :new, update_product_input_client_stub do
      ...
      # Use protobuf object
      client.update_product_input ::Google::Shopping::Merchant::Products::V1beta::UpdateProductInputRequest.new(product_input: product_input, update_mask: update_mask, data_source: data_source, product_id_base64_url_encoded: product_id_base64_url_encoded) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_product_input(::Google::Shopping::Merchant::Products::V1beta::UpdateProductInputRequest.new(product_input: product_input, update_mask: update_mask, data_source: data_source, product_id_base64_url_encoded: product_id_base64_url_encoded), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_product_input
    ...
    delete_product_input_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::DeleteProductInputRequest, request
    ...
    Gapic::ServiceStub.stub :new, delete_product_input_client_stub do
      ...
      # Use protobuf object
      client.delete_product_input ::Google::Shopping::Merchant::Products::V1beta::DeleteProductInputRequest.new(name: name, data_source: data_source, product_id_base64_url_encoded: product_id_base64_url_encoded) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_product_input(::Google::Shopping::Merchant::Products::V1beta::DeleteProductInputRequest.new(name: name, data_source: data_source, product_id_base64_url_encoded: product_id_base64_url_encoded), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::ProductInputsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Products::V1beta::ProductInputsService::Client, client
