...
class ::Google::Shopping::Merchant::Products::V1beta::ProductInputsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_product_input_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.product_input_path account: "value0", productinput: "value1"
      assert_equal "accounts/value0/productInputs/value1", path
    end
  end
end
