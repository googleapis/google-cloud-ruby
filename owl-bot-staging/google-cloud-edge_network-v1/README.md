# Ruby Client for the Distributed Cloud Edge Network V1 API
...
specific version of the Distributed Cloud Edge Network V1 API. Most users should consider using
the main client gem,
[google-cloud-edge_network](https://rubygems.org/gems/google-cloud-edge_network).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-edge_network-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-edge_network-v1/latest)
