            ...
            class ServiceStub
              ...
              def list_interconnects request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "list_interconnects",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def diagnose_interconnect request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "diagnose_interconnect",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def list_interconnect_attachments request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "list_interconnect_attachments",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def get_interconnect_attachment request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "get_interconnect_attachment",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def create_interconnect_attachment request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "create_interconnect_attachment",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def delete_interconnect_attachment request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "delete_interconnect_attachment",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
