...
##
# Snippet for the update_trust_config call in the CertificateManager service
#
...
# Google::Cloud::CertificateManager::V1::CertificateManager::Client#update_trust_config.
#
