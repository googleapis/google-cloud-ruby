# Ruby Client for the Certificate Manager V1 API

API Client library for the Certificate Manager V1 API
...
specific version of the Certificate Manager V1 API. Most users should consider using
the main client gem,
[google-cloud-certificate_manager](https://rubygems.org/gems/google-cloud-certificate_manager).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-certificate_manager-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-certificate_manager-v1/latest)
