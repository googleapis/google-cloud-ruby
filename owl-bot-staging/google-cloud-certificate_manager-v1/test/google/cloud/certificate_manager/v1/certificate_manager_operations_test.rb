...
class ::Google::Cloud::CertificateManager::V1::CertificateManager::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::CertificateManager::V1::CertificateManager::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::CertificateManager::V1::CertificateManager::Operations::Configuration, config
  end
end
