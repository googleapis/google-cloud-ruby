...
class ::Google::Cloud::TelcoAutomation::V1::TelcoAutomation::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::TelcoAutomation::V1::TelcoAutomation::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::TelcoAutomation::V1::TelcoAutomation::Operations::Configuration, config
  end
end
