# Ruby Client for the Google Cloud Support V2BETA API
...
specific version of the Google Cloud Support V2BETA API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-support-v2beta
```
...
request = ::Google::Cloud::Support::V2beta::ListAttachmentsRequest.new # (request fields as keyword arguments...)
response = client.list_attachments request
```

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-support-v2beta/latest)
...
is part of the name, e.g. `google-cloud-support-v2beta`.
