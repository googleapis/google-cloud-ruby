...
class ::Google::Cloud::Support::V2beta::CommentService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_comments
    # Create test objects.
    client_result = ::Google::Cloud::Support::V2beta::ListCommentsResponse.new
  ...
  def test_create_comment
    # Create test objects.
    client_result = ::Google::Cloud::Support::V2beta::Comment.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Support::V2beta::CommentService::Rest::Client::Configuration, config
  end
end
