...
##
# Snippet for the create_license_config call in the LicenseConfigService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::LicenseConfigService::Client#create_license_config.
#
