...
##
# Snippet for the get_serving_config call in the ServingConfigService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::ServingConfigService::Client#get_serving_config.
#
