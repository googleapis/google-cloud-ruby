...
##
# Snippet for the create_session call in the ConversationalSearchService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::ConversationalSearchService::Client#create_session.
#
def create_session
