...
##
# Snippet for the get_session call in the ConversationalSearchService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::ConversationalSearchService::Client#get_session.
#
def get_session
