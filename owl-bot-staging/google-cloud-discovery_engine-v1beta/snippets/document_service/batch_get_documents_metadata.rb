...
##
# Snippet for the batch_get_documents_metadata call in the DocumentService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::DocumentService::Client#batch_get_documents_metadata.
#
