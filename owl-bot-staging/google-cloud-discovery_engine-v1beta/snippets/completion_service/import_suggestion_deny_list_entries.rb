...
##
# Snippet for the import_suggestion_deny_list_entries call in the CompletionService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::CompletionService::Client#import_suggestion_deny_list_entries.
#
