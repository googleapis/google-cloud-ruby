...
##
# Snippet for the get_sample_query_set call in the SampleQuerySetService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::SampleQuerySetService::Client#get_sample_query_set.
#
