...
##
# Snippet for the recrawl_uris call in the SiteSearchEngineService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::SiteSearchEngineService::Client#recrawl_uris.
#
def recrawl_uris
