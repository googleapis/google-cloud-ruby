...
##
# Snippet for the create_target_site call in the SiteSearchEngineService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::SiteSearchEngineService::Client#create_target_site.
#
