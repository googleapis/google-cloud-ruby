...
module Google
  module Cloud
    module DiscoveryEngine
      module V1beta
        Answer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer").msgclass
        Answer::Citation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Citation").msgclass
        Answer::CitationSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.CitationSource").msgclass
        Answer::Reference = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Reference").msgclass
        Answer::Reference::UnstructuredDocumentInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo").msgclass
        ...
        Answer::Step::Action::Observation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation").msgclass
        Answer::Step::Action::Observation::SearchResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult").msgclass
        Answer::Step::Action::Observation::SearchResult::SnippetInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.SnippetInfo").msgclass
        Answer::Step::Action::Observation::SearchResult::ChunkInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.ChunkInfo").msgclass
        Answer::Step::State = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.Step.State").enummodule
        Answer::QueryUnderstandingInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo").msgclass
        Answer::QueryUnderstandingInfo::QueryClassificationInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo").msgclass
        Answer::QueryUnderstandingInfo::QueryClassificationInfo::Type = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type").enummodule
        Answer::State = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.State").enummodule
        Answer::AnswerSkippedReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Answer.AnswerSkippedReason").enummodule
      end
    end
  end
end
