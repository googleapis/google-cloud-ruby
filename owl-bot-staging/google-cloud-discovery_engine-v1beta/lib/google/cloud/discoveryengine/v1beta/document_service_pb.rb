  ...
  module Cloud
    module DiscoveryEngine
      module V1beta
        ...
        BatchGetDocumentsMetadataRequest::FhirMatcher = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.BatchGetDocumentsMetadataRequest.FhirMatcher").msgclass
