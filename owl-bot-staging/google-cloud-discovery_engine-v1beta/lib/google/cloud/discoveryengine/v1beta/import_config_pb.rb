...
require 'google/cloud/discoveryengine/v1beta/completion_pb'
...
begin
  ...
  imports = [
    ...
    ["google.cloud.discoveryengine.v1beta.SuggestionDenyListEntry", "google/cloud/discoveryengine/v1beta/completion.proto"],
  ...
  module Cloud
    module DiscoveryEngine
      module V1beta
        ...
        SpannerSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.SpannerSource").msgclass
        BigtableOptions = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.BigtableOptions").msgclass
        BigtableOptions::BigtableColumnFamily = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.BigtableOptions.BigtableColumnFamily").msgclass
        BigtableOptions::BigtableColumn = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.BigtableOptions.BigtableColumn").msgclass
        BigtableOptions::Type = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.BigtableOptions.Type").enummodule
        BigtableOptions::Encoding = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.BigtableOptions.Encoding").enummodule
        BigtableSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.BigtableSource").msgclass
        FhirStoreSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.FhirStoreSource").msgclass
        CloudSqlSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.CloudSqlSource").msgclass
        FirestoreSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.FirestoreSource").msgclass
        ...
        ImportSuggestionDenyListEntriesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSuggestionDenyListEntriesRequest").msgclass
        ImportSuggestionDenyListEntriesRequest::InlineSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSuggestionDenyListEntriesRequest.InlineSource").msgclass
        ImportSuggestionDenyListEntriesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSuggestionDenyListEntriesResponse").msgclass
        ImportSuggestionDenyListEntriesMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSuggestionDenyListEntriesMetadata").msgclass
        ImportSampleQueriesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSampleQueriesRequest").msgclass
        ImportSampleQueriesRequest::InlineSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSampleQueriesRequest.InlineSource").msgclass
        ImportSampleQueriesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSampleQueriesResponse").msgclass
        ImportSampleQueriesMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ImportSampleQueriesMetadata").msgclass
      end
    end
  end
end
