  ...
  module Cloud
    module DiscoveryEngine
      module V1beta
        ...
        SearchUseCase = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.SearchUseCase").enummodule
