...
module Google
  module Cloud
    module DiscoveryEngine
      module V1beta
        SiteSearchEngine = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.SiteSearchEngine").msgclass
        TargetSite = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.TargetSite").msgclass
        TargetSite::FailureReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.TargetSite.FailureReason").msgclass
        TargetSite::FailureReason::QuotaFailure = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.TargetSite.FailureReason.QuotaFailure").msgclass
        TargetSite::Type = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.TargetSite.Type").enummodule
        TargetSite::IndexingStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.TargetSite.IndexingStatus").enummodule
        SiteVerificationInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.SiteVerificationInfo").msgclass
        SiteVerificationInfo::SiteVerificationState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.SiteVerificationInfo.SiteVerificationState").enummodule
      end
    end
  end
end
