...
module Google
  module Cloud
    module DiscoveryEngine
      module V1beta
        CreateControlRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.CreateControlRequest").msgclass
        UpdateControlRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.UpdateControlRequest").msgclass
        DeleteControlRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.DeleteControlRequest").msgclass
        GetControlRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.GetControlRequest").msgclass
        ListControlsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ListControlsRequest").msgclass
        ListControlsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.ListControlsResponse").msgclass
      end
    end
  end
end
