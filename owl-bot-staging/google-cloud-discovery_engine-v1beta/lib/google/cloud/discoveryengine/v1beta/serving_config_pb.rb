  ...
  module Cloud
    module DiscoveryEngine
      module V1beta
        ...
        AnswerGenerationSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.AnswerGenerationSpec").msgclass
        AnswerGenerationSpec::UserDefinedClassifierSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.AnswerGenerationSpec.UserDefinedClassifierSpec").msgclass
      end
    end
  end
end
