...
require "google/cloud/discovery_engine/v1beta/cmek_config_service/rest/service_stub"
        ...
        module CmekConfigService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::DiscoveryEngine::V1beta::CmekConfigService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CmekConfigService clients
              #   ::Google::Cloud::DiscoveryEngine::V1beta::CmekConfigService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::DiscoveryEngine::V1beta::CmekConfigService::Rest::Operations.new do |config|
                ...
                @cmek_config_service_stub = ::Google::Cloud::DiscoveryEngine::V1beta::CmekConfigService::Rest::ServiceStub.new(
              ...
              #
              # @return [::Google::Cloud::DiscoveryEngine::V1beta::CmekConfigService::Rest::Operations]
              #
              ...
              #   {::Google::Cloud::DiscoveryEngine::V1beta::UpdateCmekConfigRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::DiscoveryEngine::V1beta::UpdateCmekConfigRequest, ::Hash]
              ...
              #
              #   @param config [::Google::Cloud::DiscoveryEngine::V1beta::CmekConfig, ::Hash]
              ...
              #   request = Google::Cloud::DiscoveryEngine::V1beta::UpdateCmekConfigRequest.new
              #
              ...
              def update_cmek_config request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DiscoveryEngine::V1beta::UpdateCmekConfigRequest
              ...
              ##
              # Gets the {::Google::Cloud::DiscoveryEngine::V1beta::CmekConfig CmekConfig}.
              #
              # @overload get_cmek_config(request, options = nil)
              #   Pass arguments to `get_cmek_config` via a request object, either of type
              #   {::Google::Cloud::DiscoveryEngine::V1beta::GetCmekConfigRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::DiscoveryEngine::V1beta::GetCmekConfigRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::DiscoveryEngine::V1beta::GetCmekConfigRequest.new
              #
              #   # Call the get_cmek_config method.
              #   result = client.get_cmek_config request
              #
              #   # The returned object is of type Google::Cloud::DiscoveryEngine::V1beta::CmekConfig.
              #   p result
              #
              def get_cmek_config request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DiscoveryEngine::V1beta::GetCmekConfigRequest
              ...
              ##
              # Lists all the {::Google::Cloud::DiscoveryEngine::V1beta::CmekConfig CmekConfig}s
              # with the project.
              #
              # @overload list_cmek_configs(request, options = nil)
              #   Pass arguments to `list_cmek_configs` via a request object, either of type
              #   {::Google::Cloud::DiscoveryEngine::V1beta::ListCmekConfigsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::DiscoveryEngine::V1beta::ListCmekConfigsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              def list_cmek_configs request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DiscoveryEngine::V1beta::ListCmekConfigsRequest
              ...
              #   {::Google::Cloud::DiscoveryEngine::V1beta::DeleteCmekConfigRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::DiscoveryEngine::V1beta::DeleteCmekConfigRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::DiscoveryEngine::V1beta::DeleteCmekConfigRequest.new
              #
              ...
              def delete_cmek_config request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DiscoveryEngine::V1beta::DeleteCmekConfigRequest
              ...
              # {::Google::Cloud::DiscoveryEngine::V1beta::CmekConfigService::Rest::Client::Configuration::Rpcs}
