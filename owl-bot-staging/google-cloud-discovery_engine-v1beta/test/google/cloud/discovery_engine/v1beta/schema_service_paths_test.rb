...
class ::Google::Cloud::DiscoveryEngine::V1beta::SchemaService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_schema_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.schema_path project: "value0", location: "value1", data_store: "value2", schema: "value3"
      assert_equal "projects/value0/locations/value1/dataStores/value2/schemas/value3", path

      path = client.schema_path project: "value0", location: "value1", collection: "value2", data_store: "value3", schema: "value4"
      assert_equal "projects/value0/locations/value1/collections/value2/dataStores/value3/schemas/value4", path
    end
  end
end
