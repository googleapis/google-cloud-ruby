...
class ::Google::Cloud::DiscoveryEngine::V1beta::ProjectService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::DiscoveryEngine::V1beta::ProjectService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::ProjectService::Operations::Configuration, config
  end
end
