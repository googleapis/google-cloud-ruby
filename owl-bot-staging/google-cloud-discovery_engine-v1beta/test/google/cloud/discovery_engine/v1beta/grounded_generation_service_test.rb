...
class ::Google::Cloud::DiscoveryEngine::V1beta::GroundedGenerationService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_stream_generate_grounded_content
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentResponse.new
    ...
    Gapic::ServiceStub.stub :new, stream_generate_grounded_content_client_stub do
      ...
      request_proto = ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest.new location: location, system_instruction: system_instruction, contents: contents, generation_spec: generation_spec, grounding_spec: grounding_spec, user_labels: user_labels
      enum_input = [request_hash, request_proto].to_enum
      client.stream_generate_grounded_content enum_input do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentResponse, r
        end
      ...
      stream_generate_grounded_content_client_stub.requests.each do |request|
        request.to_a.each do |r|
          assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest, r
          assert_equal "hello world", r["location"]
          assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::GroundedGenerationContent), r["system_instruction"]
          assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GroundedGenerationContent, r["contents"].first
          assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest::GenerationSpec), r["generation_spec"]
          assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest::GroundingSpec), r["grounding_spec"]
  ...
  def test_generate_grounded_content
    ...
    generate_grounded_content_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest, request
      assert_equal "hello world", request["location"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::GroundedGenerationContent), request["system_instruction"]
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GroundedGenerationContent, request["contents"].first
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest::GenerationSpec), request["generation_spec"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest::GroundingSpec), request["grounding_spec"]
    ...
    Gapic::ServiceStub.stub :new, generate_grounded_content_client_stub do
      ...
      # Use protobuf object
      client.generate_grounded_content ::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest.new(location: location, system_instruction: system_instruction, contents: contents, generation_spec: generation_spec, grounding_spec: grounding_spec, user_labels: user_labels) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.generate_grounded_content(::Google::Cloud::DiscoveryEngine::V1beta::GenerateGroundedContentRequest.new(location: location, system_instruction: system_instruction, contents: contents, generation_spec: generation_spec, grounding_spec: grounding_spec, user_labels: user_labels), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_check_grounding
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1beta::CheckGroundingResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    check_grounding_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::CheckGroundingRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GroundedGenerationService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GroundedGenerationService::Client, client
