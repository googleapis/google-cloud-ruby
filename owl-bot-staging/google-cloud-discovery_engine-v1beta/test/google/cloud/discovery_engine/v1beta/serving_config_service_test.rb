...
class ::Google::Cloud::DiscoveryEngine::V1beta::ServingConfigService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_update_serving_config
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1beta::ServingConfig.new
    ...
    update_serving_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::UpdateServingConfigRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::ServingConfig), request["serving_config"]
  ...
  def test_get_serving_config
    ...
    get_serving_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GetServingConfigRequest, request
  ...
  def test_list_serving_configs
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1beta::ListServingConfigsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_serving_configs_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::ListServingConfigsRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::ServingConfigService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::ServingConfigService::Client, client
