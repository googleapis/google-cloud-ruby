  ...
  def test_complete_query
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::CompletionService::Rest::ServiceStub.stub :transcode_complete_query_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, complete_query_client_stub do
        ...
        # Use protobuf object
        client.complete_query ::Google::Cloud::DiscoveryEngine::V1beta::CompleteQueryRequest.new(data_store: data_store, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.complete_query(::Google::Cloud::DiscoveryEngine::V1beta::CompleteQueryRequest.new(data_store: data_store, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
