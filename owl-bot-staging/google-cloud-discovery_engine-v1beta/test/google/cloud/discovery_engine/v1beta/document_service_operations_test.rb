...
class ::Google::Cloud::DiscoveryEngine::V1beta::DocumentService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::DiscoveryEngine::V1beta::DocumentService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::DocumentService::Operations::Configuration, config
  end
end
