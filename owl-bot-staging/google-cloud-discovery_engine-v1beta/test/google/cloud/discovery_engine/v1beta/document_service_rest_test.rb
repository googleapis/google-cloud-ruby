...
class ::Google::Cloud::DiscoveryEngine::V1beta::DocumentService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_document
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::Document.new
  ...
  def test_list_documents
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::ListDocumentsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_batch_get_documents_metadata
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::BatchGetDocumentsMetadataResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::DocumentService::Rest::Client::Configuration, config
  end
end
