...
class ::Google::Cloud::DiscoveryEngine::V1beta::CompletionService::ClientTest < Minitest::Test
  ...
  def test_complete_query
    ...
    Gapic::ServiceStub.stub :new, complete_query_client_stub do
      ...
      # Use protobuf object
      client.complete_query ::Google::Cloud::DiscoveryEngine::V1beta::CompleteQueryRequest.new(data_store: data_store, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.complete_query(::Google::Cloud::DiscoveryEngine::V1beta::CompleteQueryRequest.new(data_store: data_store, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
