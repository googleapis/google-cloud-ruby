  ...
  def test_write_user_event
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::UserEventService::Rest::ServiceStub.stub :transcode_write_user_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, write_user_event_client_stub do
        # Create client
        c = ::Google::Cloud::DiscoveryEngine::V1beta::UserEventService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.write_user_event ::Google::Cloud::DiscoveryEngine::V1beta::WriteUserEventRequest.new(parent: parent, user_event: user_event, write_async: write_async) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.write_user_event(::Google::Cloud::DiscoveryEngine::V1beta::WriteUserEventRequest.new(parent: parent, user_event: user_event, write_async: write_async), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_collect_user_event
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::UserEventService::Rest::ServiceStub.stub :transcode_collect_user_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, collect_user_event_client_stub do
        ...
        # Use protobuf object
        c.collect_user_event ::Google::Cloud::DiscoveryEngine::V1beta::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.collect_user_event(::Google::Cloud::DiscoveryEngine::V1beta::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_purge_user_events
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::UserEventService::Rest::ServiceStub.stub :transcode_purge_user_events_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, purge_user_events_client_stub do
        ...
        # Use protobuf object
        c.purge_user_events ::Google::Cloud::DiscoveryEngine::V1beta::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.purge_user_events(::Google::Cloud::DiscoveryEngine::V1beta::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_import_user_events
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::UserEventService::Rest::ServiceStub.stub :transcode_import_user_events_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, import_user_events_client_stub do
        ...
        # Use protobuf object
        c.import_user_events ::Google::Cloud::DiscoveryEngine::V1beta::ImportUserEventsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.import_user_events(::Google::Cloud::DiscoveryEngine::V1beta::ImportUserEventsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
