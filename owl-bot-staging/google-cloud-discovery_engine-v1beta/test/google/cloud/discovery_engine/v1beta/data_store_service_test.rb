...
class ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_data_store
    ...
    Gapic::ServiceStub.stub :new, create_data_store_client_stub do
      ...
      # Use protobuf object
      client.create_data_store ::Google::Cloud::DiscoveryEngine::V1beta::CreateDataStoreRequest.new(parent: parent, data_store: data_store, data_store_id: data_store_id, create_advanced_site_search: create_advanced_site_search, skip_default_schema_creation: skip_default_schema_creation) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      client.create_data_store(::Google::Cloud::DiscoveryEngine::V1beta::CreateDataStoreRequest.new(parent: parent, data_store: data_store, data_store_id: data_store_id, create_advanced_site_search: create_advanced_site_search, skip_default_schema_creation: skip_default_schema_creation), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_data_store
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1beta::DataStore.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_data_store_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::GetDataStoreRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_data_store_client_stub do
      ...
      # Use protobuf object
      client.get_data_store ::Google::Cloud::DiscoveryEngine::V1beta::GetDataStoreRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_data_store(::Google::Cloud::DiscoveryEngine::V1beta::GetDataStoreRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_data_stores
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1beta::ListDataStoresResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_data_stores_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::ListDataStoresRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_data_stores_client_stub do
      ...
      # Use protobuf object
      client.list_data_stores ::Google::Cloud::DiscoveryEngine::V1beta::ListDataStoresRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_data_stores(::Google::Cloud::DiscoveryEngine::V1beta::ListDataStoresRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_data_store
    ...
    delete_data_store_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::DeleteDataStoreRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_data_store_client_stub do
      ...
      # Use protobuf object
      client.delete_data_store ::Google::Cloud::DiscoveryEngine::V1beta::DeleteDataStoreRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_data_store(::Google::Cloud::DiscoveryEngine::V1beta::DeleteDataStoreRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_data_store
    ...
    update_data_store_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::UpdateDataStoreRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1beta::DataStore), request["data_store"]
    ...
    Gapic::ServiceStub.stub :new, update_data_store_client_stub do
      ...
      # Use protobuf object
      client.update_data_store ::Google::Cloud::DiscoveryEngine::V1beta::UpdateDataStoreRequest.new(data_store: data_store, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_data_store(::Google::Cloud::DiscoveryEngine::V1beta::UpdateDataStoreRequest.new(data_store: data_store, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Client, client
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Operations, client.operations_client
  end
end
