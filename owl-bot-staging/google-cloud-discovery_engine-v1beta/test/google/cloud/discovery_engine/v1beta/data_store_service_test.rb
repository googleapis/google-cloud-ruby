...
class ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::ClientTest < Minitest::Test
  ...
  def test_create_data_store
    ...
    Gapic::ServiceStub.stub :new, create_data_store_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Client.new do |config|
  ...
  def test_get_data_store
    ...
    Gapic::ServiceStub.stub :new, get_data_store_client_stub do
      ...
      # Use protobuf object
      c.get_data_store ::Google::Cloud::DiscoveryEngine::V1beta::GetDataStoreRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_data_store(::Google::Cloud::DiscoveryEngine::V1beta::GetDataStoreRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_data_stores
    ...
    Gapic::ServiceStub.stub :new, list_data_stores_client_stub do
      ...
      # Use protobuf object
      c.list_data_stores ::Google::Cloud::DiscoveryEngine::V1beta::ListDataStoresRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_data_stores(::Google::Cloud::DiscoveryEngine::V1beta::ListDataStoresRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_data_store
    ...
    Gapic::ServiceStub.stub :new, delete_data_store_client_stub do
      ...
      # Use protobuf object
      c.delete_data_store ::Google::Cloud::DiscoveryEngine::V1beta::DeleteDataStoreRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_data_store(::Google::Cloud::DiscoveryEngine::V1beta::DeleteDataStoreRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_data_store
    ...
    Gapic::ServiceStub.stub :new, update_data_store_client_stub do
      ...
      # Use protobuf object
      c.update_data_store ::Google::Cloud::DiscoveryEngine::V1beta::UpdateDataStoreRequest.new(data_store: data_store, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_data_store(::Google::Cloud::DiscoveryEngine::V1beta::UpdateDataStoreRequest.new(data_store: data_store, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
