...
require "google/cloud/parallelstore/version"
...
::Google::Cloud.configure.add_config! :parallelstore do |config|
    ...
    module Parallelstore
      ...
      def self.parallelstore version: :v1beta, transport: :grpc, &block
        ...
        package_name = Google::Cloud::Parallelstore
                       ...
                       .first
        service_module = Google::Cloud::Parallelstore.const_get(package_name).const_get(:Parallelstore)
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.parallelstore if block_given?
...
require "google/cloud/parallelstore/helpers" if ::File.file? helper_path
