...
View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-css)
for this library, google-shopping-css, to see the convenience methods for
...
```
$ gem install google-shopping-css
```
...
client = Google::Shopping::Css.accounts_service
request = ::Google::Shopping::Css::V1::ListChildAccountsRequest.new # (request fields as keyword arguments...)
...
client library with a name such as `google-shopping-css`,
...
is part of the name, e.g. `google-shopping-css-v1`.
