...
class ::Google::Cloud::GkeMultiCloud::V1::AttachedClusters::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::GkeMultiCloud::V1::AttachedClusters::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::GkeMultiCloud::V1::AttachedClusters::Operations::Configuration, config
  end
end
