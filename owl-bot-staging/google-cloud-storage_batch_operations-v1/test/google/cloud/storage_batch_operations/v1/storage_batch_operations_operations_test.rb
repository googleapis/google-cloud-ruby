...
class ::Google::Cloud::StorageBatchOperations::V1::StorageBatchOperations::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::StorageBatchOperations::V1::StorageBatchOperations::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::StorageBatchOperations::V1::StorageBatchOperations::Operations::Configuration, config
  end
end
