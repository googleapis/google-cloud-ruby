...
class ::Google::Cloud::Kms::V1::Autokey::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_key_handle_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.key_handle_path project: "value0", location: "value1", key_handle: "value2"
      assert_equal "projects/value0/locations/value1/keyHandles/value2", path
    end
  end
