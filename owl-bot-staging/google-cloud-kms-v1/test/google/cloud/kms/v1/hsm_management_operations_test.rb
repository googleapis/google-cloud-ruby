...
class ::Google::Cloud::Kms::V1::HsmManagement::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Kms::V1::HsmManagement::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Kms::V1::HsmManagement::Operations::Configuration, config
  end
end
