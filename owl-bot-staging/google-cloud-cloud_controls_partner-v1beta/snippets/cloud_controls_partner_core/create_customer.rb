...
##
# Snippet for the create_customer call in the CloudControlsPartnerCore service
#
...
# Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Client#create_customer.
#
def create_customer
