  ...
  def test_get_workload
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_get_workload_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_workload_client_stub do
        # Create client
        c = ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.get_workload ::Google::Cloud::CloudControlsPartner::V1beta::GetWorkloadRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.get_workload(::Google::Cloud::CloudControlsPartner::V1beta::GetWorkloadRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_workloads
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_list_workloads_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_workloads_client_stub do
        ...
        # Use protobuf object
        c.list_workloads ::Google::Cloud::CloudControlsPartner::V1beta::ListWorkloadsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_workloads(::Google::Cloud::CloudControlsPartner::V1beta::ListWorkloadsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_customer
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_get_customer_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_customer_client_stub do
        ...
        # Use protobuf object
        c.get_customer ::Google::Cloud::CloudControlsPartner::V1beta::GetCustomerRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_customer(::Google::Cloud::CloudControlsPartner::V1beta::GetCustomerRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_customers
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_list_customers_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_customers_client_stub do
        ...
        # Use protobuf object
        c.list_customers ::Google::Cloud::CloudControlsPartner::V1beta::ListCustomersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_customers(::Google::Cloud::CloudControlsPartner::V1beta::ListCustomersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_ekm_connections
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_get_ekm_connections_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_ekm_connections_client_stub do
        ...
        # Use protobuf object
        c.get_ekm_connections ::Google::Cloud::CloudControlsPartner::V1beta::GetEkmConnectionsRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_ekm_connections(::Google::Cloud::CloudControlsPartner::V1beta::GetEkmConnectionsRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_partner_permissions
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_get_partner_permissions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_partner_permissions_client_stub do
        ...
        # Use protobuf object
        c.get_partner_permissions ::Google::Cloud::CloudControlsPartner::V1beta::GetPartnerPermissionsRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_partner_permissions(::Google::Cloud::CloudControlsPartner::V1beta::GetPartnerPermissionsRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_access_approval_requests
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_list_access_approval_requests_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_access_approval_requests_client_stub do
        ...
        # Use protobuf object
        c.list_access_approval_requests ::Google::Cloud::CloudControlsPartner::V1beta::ListAccessApprovalRequestsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_access_approval_requests(::Google::Cloud::CloudControlsPartner::V1beta::ListAccessApprovalRequestsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_partner
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_get_partner_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_partner_client_stub do
        ...
        # Use protobuf object
        c.get_partner ::Google::Cloud::CloudControlsPartner::V1beta::GetPartnerRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_partner(::Google::Cloud::CloudControlsPartner::V1beta::GetPartnerRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_customer
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_create_customer_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_customer_client_stub do
        ...
        # Use protobuf object
        c.create_customer ::Google::Cloud::CloudControlsPartner::V1beta::CreateCustomerRequest.new(parent: parent, customer: customer, customer_id: customer_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.create_customer(::Google::Cloud::CloudControlsPartner::V1beta::CreateCustomerRequest.new(parent: parent, customer: customer, customer_id: customer_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_customer
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_update_customer_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_customer_client_stub do
        ...
        # Use protobuf object
        c.update_customer ::Google::Cloud::CloudControlsPartner::V1beta::UpdateCustomerRequest.new(customer: customer, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_customer(::Google::Cloud::CloudControlsPartner::V1beta::UpdateCustomerRequest.new(customer: customer, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_customer
    ...
    ::Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Rest::ServiceStub.stub :transcode_delete_customer_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_customer_client_stub do
        ...
        # Use protobuf object
        c.delete_customer ::Google::Cloud::CloudControlsPartner::V1beta::DeleteCustomerRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_customer(::Google::Cloud::CloudControlsPartner::V1beta::DeleteCustomerRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
