...
##
# Snippet for the list_collectors call in the RapidMigrationAssessment service
#
...
# Google::Cloud::RapidMigrationAssessment::V1::RapidMigrationAssessment::Client#list_collectors.
#
def list_collectors
