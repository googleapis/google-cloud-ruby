...
class ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_transition_route_groups
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::ListTransitionRouteGroupsResponse.new
    ...
    list_transition_route_groups_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Rest::ServiceStub.stub :transcode_list_transition_route_groups_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_transition_route_groups_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_transition_route_groups_client_stub.call_count
      end
    end
  end
  ...
  def test_get_transition_route_group
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroup.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_transition_route_group_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Rest::ServiceStub.stub :transcode_get_transition_route_group_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_transition_route_group_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_transition_route_group_client_stub.call_count
      end
    end
  end
  ...
  def test_create_transition_route_group
    ...
    create_transition_route_group_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Rest::ServiceStub.stub :transcode_create_transition_route_group_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_transition_route_group_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_transition_route_group_client_stub.call_count
      end
    end
  end
  ...
  def test_update_transition_route_group
    ...
    update_transition_route_group_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Rest::ServiceStub.stub :transcode_update_transition_route_group_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_transition_route_group_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_transition_route_group_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_transition_route_group
    ...
    delete_transition_route_group_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Rest::ServiceStub.stub :transcode_delete_transition_route_group_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_transition_route_group_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_transition_route_group_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Rest::Client::Configuration, config
  end
end
