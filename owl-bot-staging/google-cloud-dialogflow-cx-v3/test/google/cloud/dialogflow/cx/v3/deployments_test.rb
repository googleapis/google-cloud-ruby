...
class ::Google::Cloud::Dialogflow::CX::V3::Deployments::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_deployments
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::ListDeploymentsResponse.new
    ...
    list_deployments_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::ListDeploymentsRequest, request
  ...
  def test_get_deployment
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::Deployment.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_deployment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::GetDeploymentRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::Deployments::Client::Configuration, config
  end
end
