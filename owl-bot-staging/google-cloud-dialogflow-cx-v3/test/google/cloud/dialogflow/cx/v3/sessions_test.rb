...
class ::Google::Cloud::Dialogflow::CX::V3::Sessions::ClientTest < Minitest::Test
  ...
  def test_detect_intent
    ...
    detect_intent_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_equal :DETECT_INTENT_RESPONSE_VIEW_UNSPECIFIED, request["response_view"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, detect_intent_client_stub do
      ...
      # Use hash object
      client.detect_intent({ session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view }) do |response, operation|
      ...
      # Use protobuf object
      client.detect_intent ::Google::Cloud::Dialogflow::CX::V3::DetectIntentRequest.new(session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.detect_intent({ session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.detect_intent(::Google::Cloud::Dialogflow::CX::V3::DetectIntentRequest.new(session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_server_streaming_detect_intent
    ...
    server_streaming_detect_intent_client_stub = ClientStub.new [grpc_response].to_enum, grpc_operation do |name, request, options:|
      assert_equal :server_streaming_detect_intent, name
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::DetectIntentRequest, request
      assert_equal "hello world", request["session"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::CX::V3::QueryParameters), request["query_params"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::CX::V3::QueryInput), request["query_input"]
    ...
    Gapic::ServiceStub.stub :new, server_streaming_detect_intent_client_stub do
      # Create client
      client = ::Google::Cloud::Dialogflow::CX::V3::Sessions::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.server_streaming_detect_intent({ session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view }) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::DetectIntentResponse, r
        end
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.server_streaming_detect_intent ::Google::Cloud::Dialogflow::CX::V3::DetectIntentRequest.new(session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::DetectIntentResponse, r
        end
      ...
      # Use hash object with options
      client.server_streaming_detect_intent({ session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view }, grpc_options) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::DetectIntentResponse, r
        end
      ...
      # Use protobuf object with options
      client.server_streaming_detect_intent(::Google::Cloud::Dialogflow::CX::V3::DetectIntentRequest.new(session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, response_view: response_view), grpc_options) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::DetectIntentResponse, r
        end
      ...
      # Verify method calls
      assert_equal 5, server_streaming_detect_intent_client_stub.call_rpc_count
    end
  end
  ...
  def test_streaming_detect_intent
    ...
    Gapic::ServiceStub.stub :new, streaming_detect_intent_client_stub do
      ...
      request_hash = { session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, enable_partial_response: enable_partial_response, enable_debugging_info: enable_debugging_info, response_view: response_view }
      request_proto = ::Google::Cloud::Dialogflow::CX::V3::StreamingDetectIntentRequest.new session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config, enable_partial_response: enable_partial_response, enable_debugging_info: enable_debugging_info, response_view: response_view
      ...
      streaming_detect_intent_client_stub.requests.each do |request|
        request.to_a.each do |r|
          ...
          assert_equal :DETECT_INTENT_RESPONSE_VIEW_UNSPECIFIED, r["response_view"]
        end
      end
    end
  end
