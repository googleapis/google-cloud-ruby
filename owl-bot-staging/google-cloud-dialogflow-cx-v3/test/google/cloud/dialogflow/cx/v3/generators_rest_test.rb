...
class ::Google::Cloud::Dialogflow::CX::V3::Generators::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_generators
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::ListGeneratorsResponse.new
    ...
    list_generators_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_get_generator
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::Generator.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_create_generator
    ...
    create_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_update_generator
    ...
    update_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_delete_generator
    ...
    delete_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::Generators::Rest::Client::Configuration, config
  end
end
