...
class ::Google::Cloud::Dialogflow::CX::V3::Tools::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_tool_version_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.tool_version_path project: "value0", location: "value1", agent: "value2", tool: "value3", version: "value4"
      assert_equal "projects/value0/locations/value1/agents/value2/tools/value3/versions/value4", path
    end
  end
end
