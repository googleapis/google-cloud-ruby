...
##
# Snippet for the list_playbook_versions call in the Playbooks service
#
...
# Google::Cloud::Dialogflow::CX::V3::Playbooks::Client#list_playbook_versions.
#
def list_playbook_versions
  # Create a client object. The client can be reused for multiple calls.
  client = Google::Cloud::Dialogflow::CX::V3::Playbooks::Client.new
