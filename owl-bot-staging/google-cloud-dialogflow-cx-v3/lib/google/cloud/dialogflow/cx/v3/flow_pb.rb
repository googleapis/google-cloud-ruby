...
require 'google/cloud/dialogflow/cx/v3/parameter_definition_pb'
...
begin
  ...
  imports = [
    ...
    ["google.cloud.dialogflow.cx.v3.ParameterDefinition", "google/cloud/dialogflow/cx/v3/parameter_definition.proto"],
    ...
    module Dialogflow
      module CX
        module V3
          ...
          Flow::MultiLanguageSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.dialogflow.cx.v3.Flow.MultiLanguageSettings").msgclass
