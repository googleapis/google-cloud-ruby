...
require "google/cloud/dialogflow/cx/v3/examples/rest/service_stub"
        ...
        module V3
          module Examples
            module Rest
              ...
              #
              # Service for managing {::Google::Cloud::Dialogflow::CX::V3::Example Examples}.
              #
              class Client
                # @private
                API_VERSION = ""
                ...
                # @private
                attr_reader :examples_stub

                ##
                # Configure the Examples Client class.
                #
                # See {::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all Examples clients
                #   ::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                #
                def universe_domain
                  @examples_stub.universe_domain
                end

                ##
                # Create a new Examples REST client object.
                #
                # @example
                #
                #   # Create a client using the default configuration
                #   client = ::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::Client.new
                #
                ...
                #   end
                #
                # @yield [config] Configure the Examples client.
                # @yieldparam config [Client::Configuration]
                #
                def initialize
                  ...
                  @examples_stub = ::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::ServiceStub.new(
                  ...
                  @examples_stub.logger(stub: true)&.info do |entry|
                  ...
                  @location_client = Google::Cloud::Location::Locations::Rest::Client.new do |config|
                    ...
                    config.endpoint = @examples_stub.endpoint
                    config.universe_domain = @examples_stub.universe_domain
                    config.bindings_override = @config.bindings_override
                    config.logger = @examples_stub.logger if config.respond_to? :logger=
                  end
                end
                ...
                #   {::Google::Cloud::Dialogflow::CX::V3::CreateExampleRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Cloud::Dialogflow::CX::V3::CreateExampleRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @overload create_example(parent: nil, example: nil)
                ...
                #   @param example [::Google::Cloud::Dialogflow::CX::V3::Example, ::Hash]
                #     Required. The example to create.
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Cloud::Dialogflow::CX::V3::Example]
                ...
                def create_example request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3::CreateExampleRequest
                  ...
                  @examples_stub.create_example request, options do |result, operation|
                ...
                #   {::Google::Cloud::Dialogflow::CX::V3::DeleteExampleRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Cloud::Dialogflow::CX::V3::DeleteExampleRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @overload delete_example(name: nil)
                ...
                def delete_example request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3::DeleteExampleRequest
                  ...
                  @examples_stub.delete_example request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                #   {::Google::Cloud::Dialogflow::CX::V3::ListExamplesRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Cloud::Dialogflow::CX::V3::ListExamplesRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @overload list_examples(parent: nil, page_size: nil, page_token: nil, language_code: nil)
                ...
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3::Example>]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3::Example>]
                #
                # @raise [::Google::Cloud::Error] if the REST call is aborted.
                #
                # @example Basic example
                ...
                def list_examples request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3::ListExamplesRequest
                  ...
                  @examples_stub.list_examples request, options do |result, operation|
                    result = ::Gapic::Rest::PagedEnumerable.new @examples_stub, :list_examples, "examples", request, result, options
                    yield result, operation if block_given?
                ...
                #   {::Google::Cloud::Dialogflow::CX::V3::GetExampleRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Cloud::Dialogflow::CX::V3::GetExampleRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                def get_example request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3::GetExampleRequest
                  ...
                  @examples_stub.get_example request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                #   {::Google::Cloud::Dialogflow::CX::V3::UpdateExampleRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Cloud::Dialogflow::CX::V3::UpdateExampleRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                def update_example request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3::UpdateExampleRequest
                  ...
                  @examples_stub.update_example request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                ##
                # Configuration class for the Examples REST API.
                #
                # This class represents the configuration for Examples REST,
                # providing control over timeouts, retry behavior, logging, transport
                # parameters, and other low-level controls. Certain parameters can also be
                # applied individually to specific RPCs. See
                # {::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::Client::Configuration::Rpcs}
                ...
                #   # create_example to 20 seconds,
                #   # and all remaining timeouts to 10 seconds.
                #   ::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #     config.rpcs.create_example.timeout = 20.0
                #   end
                #
                ...
                class Configuration
                  ...
                  ##
                  # Configuration RPC class for the Examples API.
                  #
