        ...
        module V3
          module Examples
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Dialogflow::CX::V3::Examples::Client::Configuration}
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/cloud/dialogflow/cx/v3/example_services_pb"
                ...
                @examples_stub.stub_logger&.info do |entry|
              ...
              # @yieldparam response [::Google::Cloud::Dialogflow::CX::V3::Example]
              ...
              def create_example request, options = nil
                ...
                @examples_stub.call_rpc :create_example, request, options: options do |response, operation|
              ...
              def delete_example request, options = nil
                ...
                @examples_stub.call_rpc :delete_example, request, options: options do |response, operation|
                  yield response, operation if block_given?
                end
              rescue ::GRPC::BadStatus => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3::Example>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3::Example>]
              #
              # @raise [::Google::Cloud::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              def list_examples request, options = nil
                ...
                @examples_stub.call_rpc :list_examples, request, options: options do |response, operation|
                  response = ::Gapic::PagedEnumerable.new @examples_stub, :list_examples, request, response, operation, options
                  yield response, operation if block_given?
              ...
              def get_example request, options = nil
                ...
                @examples_stub.call_rpc :get_example, request, options: options do |response, operation|
                  yield response, operation if block_given?
                end
              rescue ::GRPC::BadStatus => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def update_example request, options = nil
                ...
                @examples_stub.call_rpc :update_example, request, options: options do |response, operation|
                  yield response, operation if block_given?
                end
              rescue ::GRPC::BadStatus => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the Examples API.
              #
              # This class represents the configuration for Examples,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::Dialogflow::CX::V3::Examples::Client::Configuration::Rpcs}
