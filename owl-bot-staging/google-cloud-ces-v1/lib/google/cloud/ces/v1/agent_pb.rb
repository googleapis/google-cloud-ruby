...
require 'google/cloud/ces/v1/agent_transfers_pb'
...
module Google
  module Cloud
    module Ces
      module V1
        Agent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.ces.v1.Agent").msgclass
        Agent::LlmAgent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.ces.v1.Agent.LlmAgent").msgclass
        Agent::RemoteDialogflowAgent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.ces.v1.Agent.RemoteDialogflowAgent").msgclass
        Agent::AgentToolset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.ces.v1.Agent.AgentToolset").msgclass
      end
    end
  end
end
