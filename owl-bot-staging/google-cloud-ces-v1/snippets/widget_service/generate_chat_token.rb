...
##
# Snippet for the generate_chat_token call in the WidgetService service
#
...
# Google::Cloud::Ces::V1::WidgetService::Client#generate_chat_token.
#
def generate_chat_token
  # Create a client object. The client can be reused for multiple calls.
  client = Google::Cloud::Ces::V1::WidgetService::Client.new
