...
class ::Google::Cloud::OracleDatabase::V1::OracleDatabase::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::OracleDatabase::V1::OracleDatabase::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::OracleDatabase::V1::OracleDatabase::Operations::Configuration, config
  end
end
