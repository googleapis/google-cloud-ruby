...
##
# Snippet for the list_cloud_vm_clusters call in the OracleDatabase service
#
...
# Google::Cloud::OracleDatabase::V1::OracleDatabase::Rest::Client#list_cloud_vm_clusters.
#
