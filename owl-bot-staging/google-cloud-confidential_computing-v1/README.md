...
specific version of the Confidential Computing V1 API. Most users should consider using
the main client gem,
[google-cloud-confidential_computing](https://rubygems.org/gems/google-cloud-confidential_computing).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-confidential_computing-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-confidential_computing-v1/latest)
