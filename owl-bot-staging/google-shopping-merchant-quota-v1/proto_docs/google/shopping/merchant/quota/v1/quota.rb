    ...
    module Merchant
      module Quota
        module V1
          ...
          #   @return [::Array<::Google::Shopping::Merchant::Quota::V1::MethodDetails>]
          ...
          #   @return [::Array<::Google::Shopping::Merchant::Quota::V1::QuotaGroup>]
          ...
          #     {::Google::Shopping::Merchant::Quota::V1::QuotaGroup#quota_usage quota_usage}.
