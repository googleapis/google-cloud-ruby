...
class ::Google::Shopping::Merchant::Quota::V1::AccountLimitsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_account_limit_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.account_limit_path account: "value0", limit: "value1"
      assert_equal "accounts/value0/limits/value1", path
    end
  end
end
