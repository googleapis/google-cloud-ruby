...
class ::Google::Shopping::Merchant::Quota::V1::QuotaService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_quota_groups
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Quota::V1::ListQuotaGroupsResponse.new
    ...
    list_quota_groups_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Quota::V1::ListQuotaGroupsRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Quota::V1::QuotaService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Quota::V1::QuotaService::Client, client
