# Ruby Client for the Cloud Video Intelligence V1p1beta1 API
...
specific version of the Cloud Video Intelligence V1p1beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-video_intelligence-v1p1beta1
```
...
request = ::Google::Cloud::VideoIntelligence::V1p1beta1::AnnotateVideoRequest.new # (request fields as keyword arguments...)
...
is part of the name, e.g. `google-cloud-video_intelligence-v1p1beta1`.
