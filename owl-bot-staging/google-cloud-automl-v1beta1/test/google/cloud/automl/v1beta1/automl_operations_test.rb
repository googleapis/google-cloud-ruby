...
class ::Google::Cloud::AutoML::V1beta1::AutoML::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AutoML::V1beta1::AutoML::Operations::Configuration, config
  end
end
