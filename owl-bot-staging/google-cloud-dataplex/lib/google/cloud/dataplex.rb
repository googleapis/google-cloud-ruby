...
module Google
  module Cloud
    module Dataplex
      ...
      # [Google::Cloud::Dataplex::V1::IAMPolicy::Client](https://googleapis.dev/ruby/google-cloud-dataplex-v1/latest/Google/Cloud/Dataplex/V1/IAMPolicy/Client.html)
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::Dataplex::V1::Locations::Client](https://googleapis.dev/ruby/google-cloud-dataplex-v1/latest/Google/Cloud/Dataplex/V1/Locations/Client.html)
      # for version V1 of the API.
      # However, you can specify specify a different API version by passing it in the
