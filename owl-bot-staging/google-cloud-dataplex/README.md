...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-dataplex/latest)
for this library, google-cloud-dataplex, to see the convenience methods for
