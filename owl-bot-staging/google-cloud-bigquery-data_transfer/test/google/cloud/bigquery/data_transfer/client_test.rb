...
class Google::Cloud::Bigquery::DataTransfer::ClientConstructionMinitest < Minitest::Test
  ...
  def test_data_transfer_service_grpc
    skip unless Google::Cloud::Bigquery::DataTransfer.data_transfer_service_available? transport: :grpc
  ...
  def test_data_transfer_service_rest
    skip unless Google::Cloud::Bigquery::DataTransfer.data_transfer_service_available? transport: :rest
