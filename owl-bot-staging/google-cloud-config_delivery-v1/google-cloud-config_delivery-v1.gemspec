...
require File.expand_path("lib/google/cloud/config_delivery/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-config_delivery-v1"
  gem.version       = Google::Cloud::ConfigDelivery::V1::VERSION

  gem.authors       = ["Google LLC"]
  gem.email         = "googleapis-packages@google.com"
  gem.description   = "ConfigDelivery service manages the deployment of kubernetes configuration to a fleet of kubernetes clusters. Note that google-cloud-config_delivery-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-config_delivery instead. See the readme for more details."
  gem.summary       = "ConfigDelivery service manages the deployment of kubernetes configuration to a fleet of kubernetes clusters."
