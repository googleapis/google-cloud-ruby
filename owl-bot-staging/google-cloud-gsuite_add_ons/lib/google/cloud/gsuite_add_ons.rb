...
::Google::Cloud.configure.add_config! :gsuite_add_ons do |config|
  config.add_field! :endpoint,      "gsuiteaddons.googleapis.com", match: ::String
...
module Google
  module Cloud
    module GSuiteAddOns
      ...
      # [Google::Cloud::GSuiteAddOns::V1::GSuiteAddOns::Client](https://googleapis.dev/ruby/google-cloud-gsuite_add_ons-v1/latest/Google/Cloud/GSuiteAddOns/V1/GSuiteAddOns/Client.html)
      ...
      #
      def self.g_suite_add_ons version: :v1, transport: :grpc, &block
