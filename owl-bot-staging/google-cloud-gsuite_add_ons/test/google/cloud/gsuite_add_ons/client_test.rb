...
class Google::Cloud::GSuiteAddOns::ClientConstructionMinitest < Minitest::Test
  def test_g_suite_add_ons_grpc
    Gapic::ServiceStub.stub :new, :stub do
      ...
      client = Google::Cloud::GSuiteAddOns.g_suite_add_ons transport: :grpc do |config|
  ...
  def test_g_suite_add_ons_rest
    Gapic::Rest::ClientStub.stub :new, :stub do
      client = Google::Cloud::GSuiteAddOns.g_suite_add_ons transport: :rest do |config|
