...
class ::Google::Cloud::Config::V1::Config::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_deployments
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::ListDeploymentsResponse.new
    ...
    list_deployments_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::ListDeploymentsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_deployments_client_stub do
      ...
      # Use protobuf object
      client.list_deployments ::Google::Cloud::Config::V1::ListDeploymentsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_deployments(::Google::Cloud::Config::V1::ListDeploymentsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_deployment
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::Deployment.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_deployment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::GetDeploymentRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_deployment_client_stub do
      ...
      # Use protobuf object
      client.get_deployment ::Google::Cloud::Config::V1::GetDeploymentRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_deployment(::Google::Cloud::Config::V1::GetDeploymentRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_deployment
    ...
    create_deployment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::CreateDeploymentRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["deployment_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Config::V1::Deployment), request["deployment"]
    ...
    Gapic::ServiceStub.stub :new, create_deployment_client_stub do
      ...
      # Use protobuf object
      client.create_deployment ::Google::Cloud::Config::V1::CreateDeploymentRequest.new(parent: parent, deployment_id: deployment_id, deployment: deployment, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_deployment(::Google::Cloud::Config::V1::CreateDeploymentRequest.new(parent: parent, deployment_id: deployment_id, deployment: deployment, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_deployment
    ...
    update_deployment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::UpdateDeploymentRequest, request
    ...
    Gapic::ServiceStub.stub :new, update_deployment_client_stub do
      ...
      # Use protobuf object
      client.update_deployment ::Google::Cloud::Config::V1::UpdateDeploymentRequest.new(update_mask: update_mask, deployment: deployment, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_deployment(::Google::Cloud::Config::V1::UpdateDeploymentRequest.new(update_mask: update_mask, deployment: deployment, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_deployment
    ...
    delete_deployment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::DeleteDeploymentRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
    ...
    Gapic::ServiceStub.stub :new, delete_deployment_client_stub do
      ...
      # Use protobuf object
      client.delete_deployment ::Google::Cloud::Config::V1::DeleteDeploymentRequest.new(name: name, request_id: request_id, force: force, delete_policy: delete_policy) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_deployment(::Google::Cloud::Config::V1::DeleteDeploymentRequest.new(name: name, request_id: request_id, force: force, delete_policy: delete_policy), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_revisions
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::ListRevisionsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_revisions_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::ListRevisionsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
    ...
    Gapic::ServiceStub.stub :new, list_revisions_client_stub do
      ...
      # Use protobuf object
      client.list_revisions ::Google::Cloud::Config::V1::ListRevisionsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_revisions(::Google::Cloud::Config::V1::ListRevisionsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_revision
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::Revision.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_revision_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::GetRevisionRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_revision_client_stub do
      ...
      # Use protobuf object
      client.get_revision ::Google::Cloud::Config::V1::GetRevisionRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_revision(::Google::Cloud::Config::V1::GetRevisionRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_resource
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::Resource.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_resource_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::GetResourceRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_resource_client_stub do
      ...
      # Use protobuf object
      client.get_resource ::Google::Cloud::Config::V1::GetResourceRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_resource(::Google::Cloud::Config::V1::GetResourceRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_resources
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::ListResourcesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_resources_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::ListResourcesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
    ...
    Gapic::ServiceStub.stub :new, list_resources_client_stub do
      ...
      # Use protobuf object
      client.list_resources ::Google::Cloud::Config::V1::ListResourcesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_resources(::Google::Cloud::Config::V1::ListResourcesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_deployment_statefile
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::Statefile.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    export_deployment_statefile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::ExportDeploymentStatefileRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, export_deployment_statefile_client_stub do
      ...
      # Use protobuf object
      client.export_deployment_statefile ::Google::Cloud::Config::V1::ExportDeploymentStatefileRequest.new(parent: parent, draft: draft) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.export_deployment_statefile(::Google::Cloud::Config::V1::ExportDeploymentStatefileRequest.new(parent: parent, draft: draft), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_revision_statefile
    ...
    export_revision_statefile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::ExportRevisionStatefileRequest, request
      assert_equal "hello world", request["parent"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, export_revision_statefile_client_stub do
      ...
      # Use protobuf object
      client.export_revision_statefile ::Google::Cloud::Config::V1::ExportRevisionStatefileRequest.new(parent: parent) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.export_revision_statefile(::Google::Cloud::Config::V1::ExportRevisionStatefileRequest.new(parent: parent), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_statefile
    ...
    import_statefile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::ImportStatefileRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, import_statefile_client_stub do
      ...
      # Use protobuf object
      client.import_statefile ::Google::Cloud::Config::V1::ImportStatefileRequest.new(parent: parent, lock_id: lock_id, skip_draft: skip_draft) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.import_statefile(::Google::Cloud::Config::V1::ImportStatefileRequest.new(parent: parent, lock_id: lock_id, skip_draft: skip_draft), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_statefile
    ...
    delete_statefile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::DeleteStatefileRequest, request
      assert_equal "hello world", request["name"]
      assert_equal 42, request["lock_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_statefile_client_stub do
      ...
      # Use protobuf object
      client.delete_statefile ::Google::Cloud::Config::V1::DeleteStatefileRequest.new(name: name, lock_id: lock_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_statefile(::Google::Cloud::Config::V1::DeleteStatefileRequest.new(name: name, lock_id: lock_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_lock_deployment
    ...
    lock_deployment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::LockDeploymentRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, lock_deployment_client_stub do
      ...
      # Use protobuf object
      client.lock_deployment ::Google::Cloud::Config::V1::LockDeploymentRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.lock_deployment(::Google::Cloud::Config::V1::LockDeploymentRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_unlock_deployment
    ...
    unlock_deployment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::UnlockDeploymentRequest, request
      assert_equal "hello world", request["name"]
      assert_equal 42, request["lock_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, unlock_deployment_client_stub do
      ...
      # Use protobuf object
      client.unlock_deployment ::Google::Cloud::Config::V1::UnlockDeploymentRequest.new(name: name, lock_id: lock_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.unlock_deployment(::Google::Cloud::Config::V1::UnlockDeploymentRequest.new(name: name, lock_id: lock_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_lock_info
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Config::V1::LockInfo.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    export_lock_info_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Config::V1::ExportLockInfoRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, export_lock_info_client_stub do
      ...
      # Use protobuf object
      client.export_lock_info ::Google::Cloud::Config::V1::ExportLockInfoRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.export_lock_info(::Google::Cloud::Config::V1::ExportLockInfoRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Config::V1::Config::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Config::V1::Config::Operations, client.operations_client
  end
end
