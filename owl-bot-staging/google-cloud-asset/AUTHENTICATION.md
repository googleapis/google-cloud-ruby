...
The recommended way to authenticate to the google-cloud-asset library is to use
...
The google-cloud-asset library provides several mechanisms to configure your system.
