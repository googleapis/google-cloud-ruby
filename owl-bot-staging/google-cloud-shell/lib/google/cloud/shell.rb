...
::Google::Cloud.configure.add_config! :shell do |config|
...
module Google
  module Cloud
    module Shell
      ...
      # given API version does not support the given transport of the CloudShellService service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::Shell.cloud_shell_service_available?}.
      #
      ...
      ##
      # Determines whether the CloudShellService service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::Shell.cloud_shell_service}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the CloudShellService service,
      # or if the versioned client gem needs an update to support the CloudShellService service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
