...
::Google::Cloud.configure.add_config! :shell do |config|
  config.add_field! :endpoint,      "cloudshell.googleapis.com", match: ::String
...
module Google
  module Cloud
    module Shell
      ...
      #   Defaults to `:v1`.
      # @return [CloudShellService::Client] A client object for the specified version.
      #
      def self.cloud_shell_service version: :v1, &block
        ...
        package_name = Google::Cloud::Shell
                       ...
                       .first
        package_module = Google::Cloud::Shell.const_get package_name
        package_module.const_get(:CloudShellService).const_get(:Client).new(&block)
      end
