...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-kms-inventory/latest)
for this library, google-cloud-kms-inventory, to see the convenience methods for
...
```
$ gem install google-cloud-kms-inventory
```
