...
module Google
  module Cloud
    module AIPlatform
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::AIPlatform::V1::Locations::Client](https://googleapis.dev/ruby/google-cloud-ai_platform-v1/latest/Google/Cloud/AIPlatform/V1/Locations/Client.html)
      # for version V1 of the API.
      # However, you can specify specify a different API version by passing it in the
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::AIPlatform::V1::IAMPolicy::Client](https://googleapis.dev/ruby/google-cloud-ai_platform-v1/latest/Google/Cloud/AIPlatform/V1/IAMPolicy/Client.html)
      # for version V1 of the API.
      # However, you can specify specify a different API version by passing it in the
