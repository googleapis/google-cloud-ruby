...
```
$ gem install google-cloud-managed_kafka-v1
```
...
client library with a name such as `google-cloud-managed_kafka`,
...
is part of the name, e.g. `google-cloud-managed_kafka-v1`.
