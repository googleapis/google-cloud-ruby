  ...
  module Cloud
    module ManagedKafka
      module V1
        ...
        ConnectCluster = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.managedkafka.v1.ConnectCluster").msgclass
        ConnectCluster::State = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.managedkafka.v1.ConnectCluster.State").enummodule
        ConnectNetworkConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.managedkafka.v1.ConnectNetworkConfig").msgclass
        ConnectAccessConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.managedkafka.v1.ConnectAccessConfig").msgclass
        ConnectGcpConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.managedkafka.v1.ConnectGcpConfig").msgclass
