...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-workflows-executions-v1beta/latest)
...
is part of the name, e.g. `google-cloud-workflows-executions-v1beta`.
