...
class ::Google::Cloud::PrivilegedAccessManager::V1::PrivilegedAccessManager::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::PrivilegedAccessManager::V1::PrivilegedAccessManager::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::PrivilegedAccessManager::V1::PrivilegedAccessManager::Operations::Configuration, config
  end
end
