...
class ::Google::Cloud::Video::LiveStream::V1::LivestreamService::Rest::ClientTest < Minitest::Test
  ...
  def test_create_dvr_session
    ...
    create_dvr_session_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Video::LiveStream::V1::LivestreamService::Rest::ServiceStub.stub :transcode_create_dvr_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_dvr_session_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_dvr_session_client_stub.call_count
      end
    end
  end
  ...
  def test_list_dvr_sessions
    # Create test objects.
    client_result = ::Google::Cloud::Video::LiveStream::V1::ListDvrSessionsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_dvr_sessions_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Video::LiveStream::V1::LivestreamService::Rest::ServiceStub.stub :transcode_list_dvr_sessions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_dvr_sessions_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_dvr_sessions_client_stub.call_count
      end
    end
  end
  ...
  def test_get_dvr_session
    # Create test objects.
    client_result = ::Google::Cloud::Video::LiveStream::V1::DvrSession.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_dvr_session_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Video::LiveStream::V1::LivestreamService::Rest::ServiceStub.stub :transcode_get_dvr_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_dvr_session_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_dvr_session_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_dvr_session
    ...
    delete_dvr_session_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Video::LiveStream::V1::LivestreamService::Rest::ServiceStub.stub :transcode_delete_dvr_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_dvr_session_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_dvr_session_client_stub.call_count
      end
    end
  end
  ...
  def test_update_dvr_session
    ...
    update_dvr_session_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Video::LiveStream::V1::LivestreamService::Rest::ServiceStub.stub :transcode_update_dvr_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_dvr_session_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_dvr_session_client_stub.call_count
      end
    end
  end
