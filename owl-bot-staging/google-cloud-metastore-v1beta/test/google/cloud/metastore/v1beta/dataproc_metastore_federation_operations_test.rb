...
class ::Google::Cloud::Metastore::V1beta::DataprocMetastoreFederation::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Metastore::V1beta::DataprocMetastoreFederation::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Metastore::V1beta::DataprocMetastoreFederation::Operations::Configuration, config
  end
end
