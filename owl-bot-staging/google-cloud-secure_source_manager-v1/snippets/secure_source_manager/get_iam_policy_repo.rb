...
##
# Snippet for the get_iam_policy_repo call in the SecureSourceManager service
#
...
# Google::Cloud::SecureSourceManager::V1::SecureSourceManager::Client#get_iam_policy_repo.
#
