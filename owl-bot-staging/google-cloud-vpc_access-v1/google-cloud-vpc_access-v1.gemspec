...
require File.expand_path("lib/google/cloud/vpc_access/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-vpc_access-v1"
  ...
  gem.summary       = "API Client library for the Serverless VPC Access V1 API"
