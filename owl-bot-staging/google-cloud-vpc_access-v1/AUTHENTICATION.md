...
The recommended way to authenticate to the google-cloud-vpc_access-v1 library is to use
...
The google-cloud-vpc_access-v1 library provides several mechanisms to configure your system.
