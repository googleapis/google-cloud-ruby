...
require File.expand_path("lib/google/cloud/container/v1beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-container-v1beta1"
  gem.version       = Google::Cloud::Container::V1beta1::VERSION
  ...
  gem.summary       = "API Client library for the Kubernetes Engine V1beta1 API"
