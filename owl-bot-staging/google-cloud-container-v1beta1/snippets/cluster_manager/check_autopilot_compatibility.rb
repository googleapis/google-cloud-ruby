...
##
# Snippet for the check_autopilot_compatibility call in the ClusterManager service
#
...
# Google::Cloud::Container::V1beta1::ClusterManager::Client#check_autopilot_compatibility.
#
