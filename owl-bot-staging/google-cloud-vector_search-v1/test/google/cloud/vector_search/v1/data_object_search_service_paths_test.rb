...
class ::Google::Cloud::VectorSearch::V1::DataObjectSearchService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_index_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.index_path project: "value0", location: "value1", collection: "value2", index: "value3"
      assert_equal "projects/value0/locations/value1/collections/value2/indexes/value3", path
    end
  end
end
