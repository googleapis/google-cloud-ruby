...
require "google/shopping/merchant/accounts/v1/omnichannel_settings_service/rest/service_stub"
          ...
          module OmnichannelSettingsService
            module Rest
              ...
              class Client
                ...
                #
                # See {::Google::Shopping::Merchant::Accounts::V1::OmnichannelSettingsService::Rest::Client::Configuration}
                ...
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::OmnichannelSetting>]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Gapic::Rest::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::OmnichannelSetting>]
                #
                # @raise [::Google::Cloud::Error] if the REST call is aborted.
                #
                # @example Basic example
                ...
                # {::Google::Shopping::Merchant::Accounts::V1::OmnichannelSettingsService::Rest::Client::Configuration::Rpcs}
