      ...
      module Accounts
        module V1
          module OnlineReturnPolicyService
            ##
            # Client for the OnlineReturnPolicyService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicyService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all OnlineReturnPolicyService clients
              #   ::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicyService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new OnlineReturnPolicyService client object.
              #
              # @example
              #
              #   # Create a client using the default configuration
              #   client = ::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicyService::Client.new
              #
              ...
              def initialize
                ...
                @online_return_policy_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicyService::Stub,
              ...
              # @yieldparam response [::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicy]
              ...
              def get_online_return_policy request, options = nil
                ...
                metadata = @config.rpcs.get_online_return_policy.metadata.to_h
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicy>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicy>]
              #
              # @raise [::Google::Cloud::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              def list_online_return_policies request, options = nil
                ...
                # Customize the options with defaults
                metadata = @config.rpcs.list_online_return_policies.metadata.to_h
              ...
              ##
              # Configuration class for the OnlineReturnPolicyService API.
              #
              # This class represents the configuration for OnlineReturnPolicyService,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Shopping::Merchant::Accounts::V1::OnlineReturnPolicyService::Client::Configuration::Rpcs}
