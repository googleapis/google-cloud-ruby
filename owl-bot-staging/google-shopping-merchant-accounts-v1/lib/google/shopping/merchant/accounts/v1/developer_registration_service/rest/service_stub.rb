      ...
      module Accounts
        module V1
          module DeveloperRegistrationService
            module Rest
              ##
              # REST service stub for the DeveloperRegistrationService service.
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::RegisterGcpRequest]
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::GetDeveloperRegistrationRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::UnregisterGcpRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                # @private
                #
                # GRPC transcoding helper method for the register_gcp REST call
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::RegisterGcpRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_register_gcp_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/accounts/v1/{name}:registerGcp",
                                                            body: "*",
                                                            matches: [
                                                              ["name", %r{^accounts/[^/]+/developerRegistration/?$}, false]
                                                            ]
                                                          )
                ...
                # @private
                #
                # GRPC transcoding helper method for the get_developer_registration REST call
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::GetDeveloperRegistrationRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_get_developer_registration_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                ...
                # @private
                #
                # GRPC transcoding helper method for the unregister_gcp REST call
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::UnregisterGcpRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_unregister_gcp_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/accounts/v1/{name}:unregisterGcp",
                                                            body: "*",
                                                            matches: [
                                                              ["name", %r{^accounts/[^/]+/developerRegistration/?$}, false]
                                                            ]
