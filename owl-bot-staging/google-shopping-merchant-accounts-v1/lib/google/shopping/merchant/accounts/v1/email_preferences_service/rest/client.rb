...
require "google/shopping/merchant/accounts/v1/email_preferences_service/rest/service_stub"
      ...
      module Accounts
        module V1
          module EmailPreferencesService
            module Rest
              ##
              # REST client for the EmailPreferencesService service.
              #
              ...
              class Client
                ...
                #
                # See {::Google::Shopping::Merchant::Accounts::V1::EmailPreferencesService::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all EmailPreferencesService clients
                #   ::Google::Shopping::Merchant::Accounts::V1::EmailPreferencesService::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                ##
                # Create a new EmailPreferencesService REST client object.
                #
                # @example
                #
                ...
                def initialize
                  ...
                  @email_preferences_service_stub = ::Google::Shopping::Merchant::Accounts::V1::EmailPreferencesService::Rest::ServiceStub.new(
                ...
                #   {::Google::Shopping::Merchant::Accounts::V1::GetEmailPreferencesRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::Accounts::V1::GetEmailPreferencesRequest, ::Hash]
                ...
                # @yieldparam result [::Google::Shopping::Merchant::Accounts::V1::EmailPreferences]
                ...
                def get_email_preferences request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1::GetEmailPreferencesRequest

                  # Converts hash and nil to an options object
                  options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                  # Customize the options with defaults
                  call_metadata = @config.rpcs.get_email_preferences.metadata.to_h
                ...
                #   {::Google::Shopping::Merchant::Accounts::V1::UpdateEmailPreferencesRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::Accounts::V1::UpdateEmailPreferencesRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                #   the default parameter values, pass an empty Hash as a request object (see above).
                #
                #   @param email_preferences [::Google::Shopping::Merchant::Accounts::V1::EmailPreferences, ::Hash]
                ...
                #
                #   # Create a request. To set request fields, pass in keyword arguments.
                #   request = Google::Shopping::Merchant::Accounts::V1::UpdateEmailPreferencesRequest.new
                #
                ...
                def update_email_preferences request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1::UpdateEmailPreferencesRequest

                  # Converts hash and nil to an options object
                  options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                  # Customize the options with defaults
                  call_metadata = @config.rpcs.update_email_preferences.metadata.to_h
                ...
                ##
                # Configuration class for the EmailPreferencesService REST API.
                #
                # This class represents the configuration for EmailPreferencesService REST,
                # providing control over timeouts, retry behavior, logging, transport
                # parameters, and other low-level controls. Certain parameters can also be
                # applied individually to specific RPCs. See
                # {::Google::Shopping::Merchant::Accounts::V1::EmailPreferencesService::Rest::Client::Configuration::Rpcs}
