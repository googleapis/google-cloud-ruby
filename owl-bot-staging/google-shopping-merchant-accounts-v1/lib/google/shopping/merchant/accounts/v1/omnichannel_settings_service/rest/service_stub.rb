          ...
          module OmnichannelSettingsService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::GetOmnichannelSettingRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::Accounts::V1::OmnichannelSetting]
                ...
                def get_omnichannel_setting request_pb, options = nil
                  ...
                  result = ::Google::Shopping::Merchant::Accounts::V1::OmnichannelSetting.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsResponse]
                #   A result object deserialized from the server's reply
                def list_omnichannel_settings request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Shopping::Merchant::Accounts::V1::ListOmnichannelSettingsResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::CreateOmnichannelSettingRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::UpdateOmnichannelSettingRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::RequestInventoryVerificationRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::Accounts::V1::RequestInventoryVerificationResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                ...
                def request_inventory_verification request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Shopping::Merchant::Accounts::V1::RequestInventoryVerificationResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                def self.transcode_list_omnichannel_settings_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/accounts/v1/{parent}/omnichannelSettings",
                                                            matches: [
                ...
                def self.transcode_update_omnichannel_setting_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :patch,
                                                            uri_template: "/accounts/v1/{omnichannel_setting.name}",
                                                            body: "omnichannel_setting",
                                                            matches: [
                ...
                def self.transcode_request_inventory_verification_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/accounts/v1/{name}:requestInventoryVerification",
                                                            body: "*",
                                                            matches: [
                                                              ["name", %r{^accounts/[^/]+/omnichannelSettings/[^/]+/?$}, false]
                                                            ]
