...
module Google
  module Shopping
    module Merchant
      module Accounts
        module V1
          AccountIssue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1.AccountIssue").msgclass
          AccountIssue::ImpactedDestination = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1.AccountIssue.ImpactedDestination").msgclass
          AccountIssue::ImpactedDestination::Impact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1.AccountIssue.ImpactedDestination.Impact").msgclass
          AccountIssue::Severity = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1.AccountIssue.Severity").enummodule
          ListAccountIssuesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1.ListAccountIssuesRequest").msgclass
          ListAccountIssuesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1.ListAccountIssuesResponse").msgclass
        end
      end
    end
  end
