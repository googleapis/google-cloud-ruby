          ...
          module AutofeedSettingsService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::GetAutofeedSettingsRequest]
                ...
                def get_autofeed_settings request_pb, options = nil
                  ...
                  result = ::Google::Shopping::Merchant::Accounts::V1::AutofeedSettings.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Accounts::V1::UpdateAutofeedSettingsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def self.transcode_update_autofeed_settings_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :patch,
                                                            uri_template: "/accounts/v1/{autofeed_settings.name}",
