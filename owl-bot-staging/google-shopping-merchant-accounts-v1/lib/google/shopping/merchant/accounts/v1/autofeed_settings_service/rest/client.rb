...
require "google/shopping/merchant/accounts/v1/autofeed_settings_service/rest/service_stub"
          ...
          module AutofeedSettingsService
            module Rest
              ...
              class Client
                ...
                #
                # See {::Google::Shopping::Merchant::Accounts::V1::AutofeedSettingsService::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all AutofeedSettingsService clients
                #   ::Google::Shopping::Merchant::Accounts::V1::AutofeedSettingsService::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                #   client = ::Google::Shopping::Merchant::Accounts::V1::AutofeedSettingsService::Rest::Client.new
                #
                #   # Create a client using a custom configuration
                #   client = ::Google::Shopping::Merchant::Accounts::V1::AutofeedSettingsService::Rest::Client.new do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                def initialize
                  ...
                  @autofeed_settings_service_stub = ::Google::Shopping::Merchant::Accounts::V1::AutofeedSettingsService::Rest::ServiceStub.new(
                ...
                #   {::Google::Shopping::Merchant::Accounts::V1::GetAutofeedSettingsRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::Accounts::V1::GetAutofeedSettingsRequest, ::Hash]
                ...
                # @yieldparam result [::Google::Shopping::Merchant::Accounts::V1::AutofeedSettings]
                ...
                #   request = Google::Shopping::Merchant::Accounts::V1::GetAutofeedSettingsRequest.new
                #
                #   # Call the get_autofeed_settings method.
                #   result = client.get_autofeed_settings request
                #
                #   # The returned object is of type Google::Shopping::Merchant::Accounts::V1::AutofeedSettings.
                #   p result
                #
                def get_autofeed_settings request, options = nil
                  raise ::ArgumentError, "request must be provided" if request.nil?

                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1::GetAutofeedSettingsRequest
                ...
                #   {::Google::Shopping::Merchant::Accounts::V1::UpdateAutofeedSettingsRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::Accounts::V1::UpdateAutofeedSettingsRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                #   the default parameter values, pass an empty Hash as a request object (see above).
                #
                #   @param autofeed_settings [::Google::Shopping::Merchant::Accounts::V1::AutofeedSettings, ::Hash]
                ...
                #
                #   # Create a request. To set request fields, pass in keyword arguments.
                #   request = Google::Shopping::Merchant::Accounts::V1::UpdateAutofeedSettingsRequest.new
                #
                ...
                def update_autofeed_settings request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1::UpdateAutofeedSettingsRequest
                ...
                # {::Google::Shopping::Merchant::Accounts::V1::AutofeedSettingsService::Rest::Client::Configuration::Rpcs}
