...
class ::Google::Shopping::Merchant::Accounts::V1::AccountServicesService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_account_service_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.account_service_path account: "value0", service: "value1"
      assert_equal "accounts/value0/services/value1", path
    end
  end
end
