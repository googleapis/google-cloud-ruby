...
class ::Google::Shopping::Merchant::Accounts::V1::ShippingSettingsService::ClientTest < Minitest::Test
  ...
  def test_get_shipping_settings
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::ShippingSettings.new
    ...
    get_shipping_settings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::GetShippingSettingsRequest, request
  ...
  def test_insert_shipping_settings
    ...
    insert_shipping_settings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::InsertShippingSettingsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Accounts::V1::ShippingSettings), request["shipping_setting"]
      refute_nil options
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::ShippingSettingsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::ShippingSettingsService::Client, client
