...
require "google/shopping/merchant/accounts/v1/homepage_service"

class ::Google::Shopping::Merchant::Accounts::V1::HomepageService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_homepage
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::Homepage.new
    ...
    get_homepage_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_homepage, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::GetHomepageRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_homepage_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_homepage_client_stub.call_rpc_count
    end
  end
  ...
  def test_update_homepage
    ...
    update_homepage_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_homepage, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::UpdateHomepageRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Accounts::V1::Homepage), request["homepage"]
    ...
    Gapic::ServiceStub.stub :new, update_homepage_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_homepage_client_stub.call_rpc_count
    end
  end
  ...
  def test_claim_homepage
    ...
    claim_homepage_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :claim_homepage, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::ClaimHomepageRequest, request
      assert_equal "hello world", request["name"]
      assert_equal true, request["overwrite"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, claim_homepage_client_stub do
      ...
      # Verify method calls
      assert_equal 5, claim_homepage_client_stub.call_rpc_count
    end
  end
  ...
  def test_unclaim_homepage
    ...
    unclaim_homepage_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :unclaim_homepage, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::UnclaimHomepageRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, unclaim_homepage_client_stub do
      ...
      # Verify method calls
      assert_equal 5, unclaim_homepage_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::HomepageService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::HomepageService::Client, client
