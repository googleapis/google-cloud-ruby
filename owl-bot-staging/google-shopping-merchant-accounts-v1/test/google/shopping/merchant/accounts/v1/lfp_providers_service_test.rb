...
require "google/shopping/merchant/accounts/v1/lfp_providers_service"

class ::Google::Shopping::Merchant::Accounts::V1::LfpProvidersService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_find_lfp_providers
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::FindLfpProvidersResponse.new
    ...
    find_lfp_providers_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :find_lfp_providers, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::FindLfpProvidersRequest, request
    ...
    Gapic::ServiceStub.stub :new, find_lfp_providers_client_stub do
      ...
      # Verify method calls
      assert_equal 5, find_lfp_providers_client_stub.call_rpc_count
    end
  end

  def test_link_lfp_provider
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::LinkLfpProviderResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    # Create request parameters for a unary method.
    name = "hello world"
    external_account_id = "hello world"

    link_lfp_provider_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :link_lfp_provider, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::LinkLfpProviderRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["external_account_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, link_lfp_provider_client_stub do
      ...
      # Verify method calls
      assert_equal 5, link_lfp_provider_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::LfpProvidersService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::LfpProvidersService::Client, client
