...
class ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovementsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_automatic_improvements
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovements.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::AutomaticImprovementsService::Rest::Client::Configuration, config
  end
end
