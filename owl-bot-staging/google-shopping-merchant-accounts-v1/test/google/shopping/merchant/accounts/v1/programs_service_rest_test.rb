...
class ::Google::Shopping::Merchant::Accounts::V1::ProgramsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_program
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1::Program.new
  ...
  def test_list_programs
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1::ListProgramsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::ProgramsService::Rest::Client::Configuration, config
  end
end
