...
require "google/shopping/merchant/accounts/v1/account_relationships_service"

class ::Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_account_relationship
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::AccountRelationship.new
    ...
    get_account_relationship_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_account_relationship, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::GetAccountRelationshipRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_account_relationship_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_account_relationship_client_stub.call_rpc_count
    end
  end

  def test_update_account_relationship
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::AccountRelationship.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    update_account_relationship_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_account_relationship, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::UpdateAccountRelationshipRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Accounts::V1::AccountRelationship), request["account_relationship"]
    ...
    Gapic::ServiceStub.stub :new, update_account_relationship_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_account_relationship_client_stub.call_rpc_count
    end
  end

  def test_list_account_relationships
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1::ListAccountRelationshipsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_account_relationships_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_account_relationships, name
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::ListAccountRelationshipsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_account_relationships_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_account_relationships_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1::AccountRelationshipsService::Client, client
