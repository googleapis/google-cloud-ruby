          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @network_edge_security_services_stub.logger(stub: true)&.info do |entry|
              ...
              #
              def logger
                @network_edge_security_services_stub.logger
              end
              ...
              def aggregated_list request, options = nil
                ...
                @network_edge_security_services_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @network_edge_security_services_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Compute::V1::NetworkEdgeSecurityServices::Rest::Client::Configuration::Rpcs}
