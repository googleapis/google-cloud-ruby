        ...
        module Snapshots
          module Rest
            ...
            class Client
              ...
              #   {::Google::Cloud::Compute::V1::UpdateKmsKeySnapshotRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::UpdateKmsKeySnapshotRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload update_kms_key(project: nil, request_id: nil, snapshot: nil, snapshot_update_kms_key_request_resource: nil)
              ...
              #   @param snapshot_update_kms_key_request_resource [::Google::Cloud::Compute::V1::SnapshotUpdateKmsKeyRequest, ::Hash]
              #     The body resource for this request
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::GenericLRO::Operation]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              ...
              def update_kms_key request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::UpdateKmsKeySnapshotRequest
                ...
                @snapshots_stub.update_kms_key request, options do |result, response|
                  result = ::Google::Cloud::Compute::V1::GlobalOperations::Rest::NonstandardLro.create_operation(
                    operation: result,
                    client: global_operations,
                    request_values: {
              ...
              # {::Google::Cloud::Compute::V1::Snapshots::Rest::Client::Configuration::Rpcs}
