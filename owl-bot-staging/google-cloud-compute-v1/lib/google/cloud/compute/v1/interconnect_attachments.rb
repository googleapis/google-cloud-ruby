...
helper_path = ::File.join __dir__, "interconnect_attachments", "helpers.rb"
require "google/cloud/compute/v1/interconnect_attachments/helpers" if ::File.file? helper_path
