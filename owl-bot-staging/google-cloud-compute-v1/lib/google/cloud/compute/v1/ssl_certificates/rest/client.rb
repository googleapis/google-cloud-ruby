          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @ssl_certificates_stub.logger(stub: true)&.info do |entry|
              ...
              def aggregated_list request, options = nil
                ...
                @ssl_certificates_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @ssl_certificates_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @ssl_certificates_stub.list request, options do |result, operation|
              ...
              # {::Google::Cloud::Compute::V1::SslCertificates::Rest::Client::Configuration::Rpcs}
