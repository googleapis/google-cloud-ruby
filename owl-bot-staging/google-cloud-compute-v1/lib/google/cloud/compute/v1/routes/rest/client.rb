          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @routes_stub.logger(stub: true)&.info do |entry|
              ...
              def get request, options = nil
                ...
                @routes_stub.get request, options do |result, operation|
              ...
              def list request, options = nil
                ...
                @routes_stub.list request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @routes_stub, :list, "items", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              # {::Google::Cloud::Compute::V1::Routes::Rest::Client::Configuration::Rpcs}
