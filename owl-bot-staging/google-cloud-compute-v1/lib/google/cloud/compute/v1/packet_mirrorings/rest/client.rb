        ...
        module PacketMirrorings
          module Rest
            ...
            class Client
              ...
              #
              def universe_domain
                @packet_mirrorings_stub.universe_domain
              end
              ...
              def initialize
                ...
                @packet_mirrorings_stub.logger(stub: true)&.info do |entry|
              ...
              def aggregated_list request, options = nil
                ...
                @packet_mirrorings_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @packet_mirrorings_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @packet_mirrorings_stub.list request, options do |result, operation|
              ...
              def test_iam_permissions request, options = nil
                ...
                @packet_mirrorings_stub.test_iam_permissions request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Compute::V1::PacketMirrorings::Rest::Client::Configuration::Rpcs}
