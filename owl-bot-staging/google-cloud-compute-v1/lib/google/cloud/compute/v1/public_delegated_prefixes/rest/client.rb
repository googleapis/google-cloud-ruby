          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @public_delegated_prefixes_stub.logger(stub: true)&.info do |entry|
              ...
              #
              def logger
                @public_delegated_prefixes_stub.logger
              end
              ...
              def aggregated_list request, options = nil
                ...
                @public_delegated_prefixes_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @public_delegated_prefixes_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @public_delegated_prefixes_stub.list request, options do |result, operation|
              ...
              # {::Google::Cloud::Compute::V1::PublicDelegatedPrefixes::Rest::Client::Configuration::Rpcs}
