          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @ssl_policies_stub.logger(stub: true)&.info do |entry|
              ...
              def aggregated_list request, options = nil
                ...
                @ssl_policies_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @ssl_policies_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @ssl_policies_stub.list request, options do |result, operation|
              ...
              def list_available_features request, options = nil
                ...
                @ssl_policies_stub.list_available_features request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Compute::V1::SslPolicies::Rest::Client::Configuration::Rpcs}
