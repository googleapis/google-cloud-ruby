...
# Google::Cloud::Compute::V1::RegionNetworkFirewallPolicies::Client#test_iam_permissions.
# It may require modification in order to execute successfully.
#
def test_iam_permissions
  # Create a client object. The client can be reused for multiple calls.
  client = Google::Cloud::Compute::V1::RegionNetworkFirewallPolicies::Client.new
