  ...
  def test_aggregated_list
    ...
    ::Google::Cloud::Compute::V1::GlobalOperations::Rest::ServiceStub.stub :transcode_aggregated_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, aggregated_list_client_stub do
        ...
        # Use protobuf object
        c.aggregated_list ::Google::Cloud::Compute::V1::AggregatedListGlobalOperationsRequest.new(filter: filter, include_all_scopes: include_all_scopes, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success, service_project_number: service_project_number) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.aggregated_list(::Google::Cloud::Compute::V1::AggregatedListGlobalOperationsRequest.new(filter: filter, include_all_scopes: include_all_scopes, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success, service_project_number: service_project_number), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list
    ...
    ::Google::Cloud::Compute::V1::GlobalOperations::Rest::ServiceStub.stub :transcode_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_client_stub do
        ...
        # Use protobuf object
        c.list ::Google::Cloud::Compute::V1::ListGlobalOperationsRequest.new(filter: filter, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list(::Google::Cloud::Compute::V1::ListGlobalOperationsRequest.new(filter: filter, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_wait
    ...
    ::Google::Cloud::Compute::V1::GlobalOperations::Rest::ServiceStub.stub :transcode_wait_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, wait_client_stub do
        ...
        # Use hash object
        c.wait({ operation: operation, project: project }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.wait ::Google::Cloud::Compute::V1::WaitGlobalOperationRequest.new(operation: operation, project: project) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.wait({ operation: operation, project: project }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.wait(::Google::Cloud::Compute::V1::WaitGlobalOperationRequest.new(operation: operation, project: project), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
