...
class ::Google::Cloud::Compute::V1::InstanceSettingsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::InstanceSettings.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::InstanceSettingsService::Rest::Client::Configuration, config
  end
end
