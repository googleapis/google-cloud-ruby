  ...
  def test_aggregated_list
    ...
    ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::ServiceStub.stub :transcode_aggregated_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, aggregated_list_client_stub do
        # Create client
        c = ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::Client.new do |config|
  ...
  def test_attach_network_endpoints
    ...
    ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::ServiceStub.stub :transcode_attach_network_endpoints_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, attach_network_endpoints_client_stub do
        ...
        # Use hash object
        c.attach_network_endpoints({ network_endpoint_group: network_endpoint_group, network_endpoint_groups_attach_endpoints_request_resource: network_endpoint_groups_attach_endpoints_request_resource, project: project, request_id: request_id, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.attach_network_endpoints ::Google::Cloud::Compute::V1::AttachNetworkEndpointsNetworkEndpointGroupRequest.new(network_endpoint_group: network_endpoint_group, network_endpoint_groups_attach_endpoints_request_resource: network_endpoint_groups_attach_endpoints_request_resource, project: project, request_id: request_id, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.attach_network_endpoints({ network_endpoint_group: network_endpoint_group, network_endpoint_groups_attach_endpoints_request_resource: network_endpoint_groups_attach_endpoints_request_resource, project: project, request_id: request_id, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete
    ...
    ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::ServiceStub.stub :transcode_delete_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_client_stub do
        ...
        # Use hash object
        c.delete({ network_endpoint_group: network_endpoint_group, project: project, request_id: request_id, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.delete ::Google::Cloud::Compute::V1::DeleteNetworkEndpointGroupRequest.new(network_endpoint_group: network_endpoint_group, project: project, request_id: request_id, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.delete({ network_endpoint_group: network_endpoint_group, project: project, request_id: request_id, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.delete(::Google::Cloud::Compute::V1::DeleteNetworkEndpointGroupRequest.new(network_endpoint_group: network_endpoint_group, project: project, request_id: request_id, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_detach_network_endpoints
    ...
    ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::ServiceStub.stub :transcode_detach_network_endpoints_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, detach_network_endpoints_client_stub do
        ...
        # Use hash object
        c.detach_network_endpoints({ network_endpoint_group: network_endpoint_group, network_endpoint_groups_detach_endpoints_request_resource: network_endpoint_groups_detach_endpoints_request_resource, project: project, request_id: request_id, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.detach_network_endpoints ::Google::Cloud::Compute::V1::DetachNetworkEndpointsNetworkEndpointGroupRequest.new(network_endpoint_group: network_endpoint_group, network_endpoint_groups_detach_endpoints_request_resource: network_endpoint_groups_detach_endpoints_request_resource, project: project, request_id: request_id, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.detach_network_endpoints({ network_endpoint_group: network_endpoint_group, network_endpoint_groups_detach_endpoints_request_resource: network_endpoint_groups_detach_endpoints_request_resource, project: project, request_id: request_id, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get
    ...
    ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::ServiceStub.stub :transcode_get_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_client_stub do
        ...
        # Use hash object
        c.get({ network_endpoint_group: network_endpoint_group, project: project, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.get ::Google::Cloud::Compute::V1::GetNetworkEndpointGroupRequest.new(network_endpoint_group: network_endpoint_group, project: project, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.get({ network_endpoint_group: network_endpoint_group, project: project, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.get(::Google::Cloud::Compute::V1::GetNetworkEndpointGroupRequest.new(network_endpoint_group: network_endpoint_group, project: project, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_insert
    ...
    ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::ServiceStub.stub :transcode_insert_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, insert_client_stub do
        ...
        # Use hash object
        c.insert({ network_endpoint_group_resource: network_endpoint_group_resource, project: project, request_id: request_id, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.insert ::Google::Cloud::Compute::V1::InsertNetworkEndpointGroupRequest.new(network_endpoint_group_resource: network_endpoint_group_resource, project: project, request_id: request_id, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.insert({ network_endpoint_group_resource: network_endpoint_group_resource, project: project, request_id: request_id, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.insert(::Google::Cloud::Compute::V1::InsertNetworkEndpointGroupRequest.new(network_endpoint_group_resource: network_endpoint_group_resource, project: project, request_id: request_id, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_test_iam_permissions
    ...
    ::Google::Cloud::Compute::V1::NetworkEndpointGroups::Rest::ServiceStub.stub :transcode_test_iam_permissions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, test_iam_permissions_client_stub do
        ...
        # Use protobuf object
        c.test_iam_permissions ::Google::Cloud::Compute::V1::TestIamPermissionsNetworkEndpointGroupRequest.new(project: project, resource: resource, test_permissions_request_resource: test_permissions_request_resource, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.test_iam_permissions(::Google::Cloud::Compute::V1::TestIamPermissionsNetworkEndpointGroupRequest.new(project: project, resource: resource, test_permissions_request_resource: test_permissions_request_resource, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
