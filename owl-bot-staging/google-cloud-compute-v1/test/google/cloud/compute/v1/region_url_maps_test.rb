...
class ::Google::Cloud::Compute::V1::RegionUrlMaps::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::RegionUrlMaps::Rest::Client::Configuration, config
  end
end
