...
##
# Snippet for the list_calculated_metrics call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#list_calculated_metrics.
#
