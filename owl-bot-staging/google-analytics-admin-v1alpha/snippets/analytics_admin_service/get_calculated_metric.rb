...
##
# Snippet for the get_calculated_metric call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#get_calculated_metric.
#
