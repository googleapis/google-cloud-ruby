...
##
# Snippet for the get_measurement_protocol_secret call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#get_measurement_protocol_secret.
#
