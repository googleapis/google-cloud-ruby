...
##
# Snippet for the list_measurement_protocol_secrets call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#list_measurement_protocol_secrets.
#
