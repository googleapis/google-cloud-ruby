...
##
# Snippet for the create_subproperty call in the AnalyticsAdminService service
#
...
# Google::Analytics::Admin::V1alpha::AnalyticsAdminService::Client#create_subproperty.
#
