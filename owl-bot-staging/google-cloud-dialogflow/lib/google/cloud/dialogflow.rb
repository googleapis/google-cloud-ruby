...
module Google
  module Cloud
    module Dialogflow
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::Dialogflow::V2::Locations::Client](https://googleapis.dev/ruby/google-cloud-dialogflow-v2/latest/Google/Cloud/Dialogflow/V2/Locations/Client.html)
      # for version V2 of the API.
      # However, you can specify specify a different API version by passing it in the
      ...
      #
      def self.locations version: :v2, &block
        require "google/cloud/dialogflow/#{version.to_s.downcase}"
