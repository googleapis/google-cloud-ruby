...
In general, the google-cloud-bigquery-connection library uses
...
The google-cloud-bigquery-connection library aims to make authentication
...
The environment variables that google-cloud-bigquery-connection
...
client = Google::Cloud::Bigquery::Connection.connection_service do |config|
...
Google::Cloud::Bigquery::Connection.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-bigquery-connection.
