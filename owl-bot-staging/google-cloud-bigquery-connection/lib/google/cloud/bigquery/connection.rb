...
require "google/cloud/bigquery/connection/version"
  ...
  module Cloud
    module Bigquery
      module Connection
        ...
        ##
        # Configure the google-cloud-bigquery-connection library.
        #
        ...
        #
        def self.configure
          yield ::Google::Cloud.configure.bigquery_connection if block_given?

          ::Google::Cloud.configure.bigquery_connection
        end
      end
    end
  end
...
helper_path = ::File.join __dir__, "connection", "helpers.rb"
require "google/cloud/bigquery/connection/helpers" if ::File.file? helper_path
