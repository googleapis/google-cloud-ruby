...
require File.expand_path("lib/google/cloud/recommender/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-recommender-v1"
  gem.version       = Google::Cloud::Recommender::V1::VERSION
