...
##
# Snippet for the list_os_policy_assignment_reports call in the OsConfigZonalService service
#
...
# Google::Cloud::OsConfig::V1alpha::OsConfigZonalService::Client#list_os_policy_assignment_reports.
#
