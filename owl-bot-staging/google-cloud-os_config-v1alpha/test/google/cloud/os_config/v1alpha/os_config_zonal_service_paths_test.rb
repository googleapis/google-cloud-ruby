...
class ::Google::Cloud::OsConfig::V1alpha::OsConfigZonalService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_instance_os_policies_compliance_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.instance_os_policies_compliance_path project: "value0", location: "value1", instance: "value2"
      assert_equal "projects/value0/locations/value1/instanceOSPoliciesCompliances/value2", path
    end
  end
