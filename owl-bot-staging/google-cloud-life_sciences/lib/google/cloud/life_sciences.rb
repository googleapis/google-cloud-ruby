...
module Google
  module Cloud
    module LifeSciences
      ...
      # given API version does not support the given transport of the WorkflowsService service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::LifeSciences.workflows_service_available?}.
      #
      ...
      ##
      # Determines whether the WorkflowsService service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::LifeSciences.workflows_service}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the WorkflowsService service,
      # or if the versioned client gem needs an update to support the WorkflowsService service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v2beta`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
      ...
      #
      def self.workflows_service_available? version: :v2beta, transport: :grpc
        require "google/cloud/life_sciences/#{version.to_s.downcase}"
        package_name = Google::Cloud::LifeSciences
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::LifeSciences.const_get package_name
        return false unless service_module.const_defined? :WorkflowsService
        service_module = service_module.const_get :WorkflowsService
        if transport == :rest
