      ...
      module V1
        module FeaturedContentNativeDashboardService
          ...
          module Paths
            ...
            #
            # @return [::String]
            def content_hub_path project:, location:, instance:
            ...
            # @param location [String]
            # @param instance [String]
            # @param featured_content_native_dashboard [String]
            #
            # @return [::String]
            def featured_content_native_dashboard_path project:, location:, instance:, featured_content_native_dashboard:
              raise ::ArgumentError, "project cannot contain /" if project.to_s.include? "/"
              raise ::ArgumentError, "location cannot contain /" if location.to_s.include? "/"
              raise ::ArgumentError, "instance cannot contain /" if instance.to_s.include? "/"
