...
class ::Google::Cloud::Chronicle::V1::InstanceService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_instance
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::Instance.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Chronicle::V1::InstanceService::Rest::Client::Configuration, config
  end
end
