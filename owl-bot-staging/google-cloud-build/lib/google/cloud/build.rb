...
require "google/cloud/build/version"
...
::Google::Cloud.configure.add_config! :build do |config|
...
module Google
  module Cloud
    module Build
      ...
      # {Google::Cloud::Build.cloud_build_available?}.
      #
      # ## About CloudBuild
      #
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::Build.cloud_build}.
