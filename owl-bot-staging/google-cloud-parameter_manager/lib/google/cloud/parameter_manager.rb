...
require "google/cloud/parameter_manager/version"
...
::Google::Cloud.configure.add_config! :parameter_manager do |config|
...
module Google
  module Cloud
    module ParameterManager
      ...
      # {Google::Cloud::ParameterManager.parameter_manager_available?}.
      #
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::ParameterManager.parameter_manager}.
...
helper_path = ::File.join __dir__, "parameter_manager", "helpers.rb"
require "google/cloud/parameter_manager/helpers" if ::File.file? helper_path
