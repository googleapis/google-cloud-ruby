...
class ::Google::Apps::Events::Subscriptions::V1beta::SubscriptionsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_subscription_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.subscription_path subscription: "value0"
      assert_equal "subscriptions/value0", path
    end
  end
