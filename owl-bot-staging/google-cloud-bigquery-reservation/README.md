...
The gem `google-cloud-bigquery-reservation` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-bigquery-reservation/latest)
for this library, google-cloud-bigquery-reservation, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-bigquery-reservation-v1](https://googleapis.dev/ruby/google-cloud-bigquery-reservation-v1/latest).
...
client library with a name such as `google-cloud-bigquery-reservation`,
...
is part of the name, e.g. `google-cloud-bigquery-reservation-v1`.
