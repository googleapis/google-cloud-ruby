...
class ::Google::Cloud::DiscoveryEngine::V1::UserLicenseService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_user_licenses
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::ListUserLicensesResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::UserLicenseService::Rest::Client::Configuration, config
  end
end
