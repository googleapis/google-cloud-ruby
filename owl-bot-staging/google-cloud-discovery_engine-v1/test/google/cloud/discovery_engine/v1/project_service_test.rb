...
require "google/cloud/discoveryengine/v1/project_service_services_pb"
require "google/cloud/discovery_engine/v1/project_service"

class ::Google::Cloud::DiscoveryEngine::V1::ProjectService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_provision_project
    ...
    provision_project_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ProvisionProjectRequest, request
    ...
    Gapic::ServiceStub.stub :new, provision_project_client_stub do
      ...
      # Use protobuf object
      client.provision_project ::Google::Cloud::DiscoveryEngine::V1::ProvisionProjectRequest.new(name: name, accept_data_use_terms: accept_data_use_terms, data_use_terms_version: data_use_terms_version) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      client.provision_project(::Google::Cloud::DiscoveryEngine::V1::ProvisionProjectRequest.new(name: name, accept_data_use_terms: accept_data_use_terms, data_use_terms_version: data_use_terms_version), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ProjectService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ProjectService::Operations, client.operations_client
  end
end
