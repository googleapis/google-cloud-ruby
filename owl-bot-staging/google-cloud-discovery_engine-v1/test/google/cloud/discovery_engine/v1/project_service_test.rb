...
class ::Google::Cloud::DiscoveryEngine::V1::ProjectService::ClientTest < Minitest::Test
  ...
  def test_provision_project
    ...
    Gapic::ServiceStub.stub :new, provision_project_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1::ProjectService::Client.new do |config|
      ...
      # Use protobuf object
      c.provision_project ::Google::Cloud::DiscoveryEngine::V1::ProvisionProjectRequest.new(name: name, accept_data_use_terms: accept_data_use_terms, data_use_terms_version: data_use_terms_version) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      c.provision_project(::Google::Cloud::DiscoveryEngine::V1::ProvisionProjectRequest.new(name: name, accept_data_use_terms: accept_data_use_terms, data_use_terms_version: data_use_terms_version), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
