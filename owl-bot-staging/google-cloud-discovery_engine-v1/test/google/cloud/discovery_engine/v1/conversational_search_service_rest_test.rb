...
class ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ClientTest < Minitest::Test
  ...
  def test_answer_query
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::AnswerQueryResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_answer_query_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, answer_query_client_stub do
        ...
        # Use hash object with options
        client.answer_query({ serving_config: serving_config, query: query, session: session, safety_spec: safety_spec, related_questions_spec: related_questions_spec, grounding_spec: grounding_spec, answer_generation_spec: answer_generation_spec, search_spec: search_spec, query_understanding_spec: query_understanding_spec, asynchronous_mode: asynchronous_mode, user_pseudo_id: user_pseudo_id, user_labels: user_labels, end_user_spec: end_user_spec }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_stream_answer_query
    ...
    stream_answer_query_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, is_server_streaming:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end

    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_stream_answer_query_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, stream_answer_query_client_stub do
        # Create client
        client = ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::Client.new do |config|
          config.credentials = :dummy_value
        end
        ...
        # Verify method calls
        assert_equal 5, stream_answer_query_client_stub.call_count
      end
    end
  end
  ...
  def test_get_answer
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::Answer.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_get_answer_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_answer_client_stub do
        ...
        # Use protobuf object
        client.get_answer ::Google::Cloud::DiscoveryEngine::V1::GetAnswerRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.get_answer(::Google::Cloud::DiscoveryEngine::V1::GetAnswerRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_session
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::Session.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_create_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_session_client_stub do
        ...
        # Use protobuf object
        client.create_session ::Google::Cloud::DiscoveryEngine::V1::CreateSessionRequest.new(parent: parent, session: session) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.create_session(::Google::Cloud::DiscoveryEngine::V1::CreateSessionRequest.new(parent: parent, session: session), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_session
    ...
    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_delete_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_session_client_stub do
        ...
        # Use protobuf object
        client.delete_session ::Google::Cloud::DiscoveryEngine::V1::DeleteSessionRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.delete_session(::Google::Cloud::DiscoveryEngine::V1::DeleteSessionRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_session
    ...
    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_update_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_session_client_stub do
        ...
        # Use protobuf object
        client.update_session ::Google::Cloud::DiscoveryEngine::V1::UpdateSessionRequest.new(session: session, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.update_session(::Google::Cloud::DiscoveryEngine::V1::UpdateSessionRequest.new(session: session, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_session
    ...
    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_get_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_session_client_stub do
        ...
        # Use protobuf object
        client.get_session ::Google::Cloud::DiscoveryEngine::V1::GetSessionRequest.new(name: name, include_answer_details: include_answer_details) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.get_session(::Google::Cloud::DiscoveryEngine::V1::GetSessionRequest.new(name: name, include_answer_details: include_answer_details), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_sessions
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::ListSessionsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Rest::ServiceStub.stub :transcode_list_sessions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_sessions_client_stub do
        ...
        # Use protobuf object
        client.list_sessions ::Google::Cloud::DiscoveryEngine::V1::ListSessionsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.list_sessions(::Google::Cloud::DiscoveryEngine::V1::ListSessionsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
