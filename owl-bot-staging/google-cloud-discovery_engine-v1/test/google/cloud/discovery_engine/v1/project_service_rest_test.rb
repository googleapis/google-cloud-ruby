...
class ::Google::Cloud::DiscoveryEngine::V1::ProjectService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_provision_project
    ...
    provision_project_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ProjectService::Rest::Client::Configuration, config
  end
end
