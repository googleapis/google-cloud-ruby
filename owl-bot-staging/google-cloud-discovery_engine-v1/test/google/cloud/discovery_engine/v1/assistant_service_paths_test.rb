...
class ::Google::Cloud::DiscoveryEngine::V1::AssistantService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_assistant_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.assistant_path project: "value0", location: "value1", collection: "value2", engine: "value3", assistant: "value4"
      assert_equal "projects/value0/locations/value1/collections/value2/engines/value3/assistants/value4", path
    end
  end
