...
class ::Google::Cloud::DiscoveryEngine::V1::DocumentService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_document
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::Document.new
    ...
    get_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::GetDocumentRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_document_client_stub do
      ...
      # Use protobuf object
      client.get_document ::Google::Cloud::DiscoveryEngine::V1::GetDocumentRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.get_document(::Google::Cloud::DiscoveryEngine::V1::GetDocumentRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_documents
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::ListDocumentsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_documents_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ListDocumentsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_documents_client_stub do
      ...
      # Use protobuf object
      client.list_documents ::Google::Cloud::DiscoveryEngine::V1::ListDocumentsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_documents(::Google::Cloud::DiscoveryEngine::V1::ListDocumentsRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_document
    ...
    create_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::CreateDocumentRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, create_document_client_stub do
      ...
      # Use protobuf object
      client.create_document ::Google::Cloud::DiscoveryEngine::V1::CreateDocumentRequest.new(parent: parent, document: document, document_id: document_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_document(::Google::Cloud::DiscoveryEngine::V1::CreateDocumentRequest.new(parent: parent, document: document, document_id: document_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_document
    ...
    delete_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::DeleteDocumentRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_document_client_stub do
      ...
      # Use protobuf object
      client.delete_document ::Google::Cloud::DiscoveryEngine::V1::DeleteDocumentRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_document(::Google::Cloud::DiscoveryEngine::V1::DeleteDocumentRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_documents
    ...
    import_documents_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ImportDocumentsRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::ImportDocumentsRequest::InlineSource), request["inline_source"]
    ...
    Gapic::ServiceStub.stub :new, import_documents_client_stub do
      ...
      # Use hash object
      client.import_documents({ inline_source: inline_source, parent: parent, error_config: error_config, reconciliation_mode: reconciliation_mode, update_mask: update_mask, auto_generate_ids: auto_generate_ids, id_field: id_field, force_refresh_content: force_refresh_content }) do |response, operation|
      ...
      # Use hash object with options
      client.import_documents({ inline_source: inline_source, parent: parent, error_config: error_config, reconciliation_mode: reconciliation_mode, update_mask: update_mask, auto_generate_ids: auto_generate_ids, id_field: id_field, force_refresh_content: force_refresh_content }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_purge_documents
    ...
    purge_documents_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::PurgeDocumentsRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::GcsSource), request["gcs_source"]
      assert_equal :gcs_source, request.source
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["filter"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::PurgeErrorConfig), request["error_config"]
    ...
    Gapic::ServiceStub.stub :new, purge_documents_client_stub do
      ...
      # Use protobuf object
      client.purge_documents ::Google::Cloud::DiscoveryEngine::V1::PurgeDocumentsRequest.new(gcs_source: gcs_source, parent: parent, filter: filter, error_config: error_config, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.purge_documents(::Google::Cloud::DiscoveryEngine::V1::PurgeDocumentsRequest.new(gcs_source: gcs_source, parent: parent, filter: filter, error_config: error_config, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_get_documents_metadata
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::BatchGetDocumentsMetadataResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    batch_get_documents_metadata_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::BatchGetDocumentsMetadataRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::BatchGetDocumentsMetadataRequest::Matcher), request["matcher"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, batch_get_documents_metadata_client_stub do
      ...
      # Use protobuf object
      client.batch_get_documents_metadata ::Google::Cloud::DiscoveryEngine::V1::BatchGetDocumentsMetadataRequest.new(parent: parent, matcher: matcher) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_get_documents_metadata(::Google::Cloud::DiscoveryEngine::V1::BatchGetDocumentsMetadataRequest.new(parent: parent, matcher: matcher), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Operations, client.operations_client
  end
end
