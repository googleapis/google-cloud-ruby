...
class ::Google::Cloud::DiscoveryEngine::V1::AssistantService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_stream_assist
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::StreamAssistResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::AssistantService::Rest::Client::Configuration, config
  end
end
