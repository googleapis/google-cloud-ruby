...
class ::Google::Cloud::DiscoveryEngine::V1::UserEventService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_write_user_event
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::UserEvent.new
    ...
    write_user_event_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::WriteUserEventRequest, request
  ...
  def test_collect_user_event
    ...
    collect_user_event_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::CollectUserEventRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, collect_user_event_client_stub do
      ...
      # Use protobuf object
      client.collect_user_event ::Google::Cloud::DiscoveryEngine::V1::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.collect_user_event(::Google::Cloud::DiscoveryEngine::V1::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_purge_user_events
    ...
    purge_user_events_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::PurgeUserEventsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, purge_user_events_client_stub do
      ...
      # Use protobuf object
      client.purge_user_events ::Google::Cloud::DiscoveryEngine::V1::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.purge_user_events(::Google::Cloud::DiscoveryEngine::V1::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_user_events
    ...
    import_user_events_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ImportUserEventsRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::ImportUserEventsRequest::InlineSource), request["inline_source"]
    ...
    Gapic::ServiceStub.stub :new, import_user_events_client_stub do
      ...
      # Use protobuf object
      client.import_user_events ::Google::Cloud::DiscoveryEngine::V1::ImportUserEventsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.import_user_events(::Google::Cloud::DiscoveryEngine::V1::ImportUserEventsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::UserEventService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::UserEventService::Operations, client.operations_client
  end
end
