...
##
# Snippet for the fetch_domain_verification_status call in the SiteSearchEngineService service
#
...
# Google::Cloud::DiscoveryEngine::V1::SiteSearchEngineService::Client#fetch_domain_verification_status.
#
