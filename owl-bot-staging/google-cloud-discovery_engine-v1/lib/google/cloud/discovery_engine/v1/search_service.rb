...
require "google/cloud/discovery_engine/v1/search_service/client"
...
require "google/cloud/discovery_engine/v1/search_service/helpers" if ::File.file? helper_path
