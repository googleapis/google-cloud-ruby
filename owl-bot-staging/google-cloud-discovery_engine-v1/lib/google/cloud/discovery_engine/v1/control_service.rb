...
require "google/cloud/discovery_engine/v1/control_service/client"
...
require "google/cloud/discovery_engine/v1/control_service/helpers" if ::File.file? helper_path
