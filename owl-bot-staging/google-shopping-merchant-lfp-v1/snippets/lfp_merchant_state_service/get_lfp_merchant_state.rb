...
##
# Snippet for the get_lfp_merchant_state call in the LfpMerchantStateService service
#
...
# Google::Shopping::Merchant::Lfp::V1::LfpMerchantStateService::Client#get_lfp_merchant_state.
#
