...
class ::Google::Shopping::Merchant::Lfp::V1::LfpStoreService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_lfp_store
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Lfp::V1::LfpStore.new
    ...
    get_lfp_store_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::GetLfpStoreRequest, request
  ...
  def test_insert_lfp_store
    ...
    insert_lfp_store_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::InsertLfpStoreRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Lfp::V1::LfpStore), request["lfp_store"]
      refute_nil options
    end
  ...
  def test_delete_lfp_store
    ...
    delete_lfp_store_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::DeleteLfpStoreRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_list_lfp_stores
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Lfp::V1::ListLfpStoresResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_lfp_stores_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::ListLfpStoresRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::LfpStoreService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::LfpStoreService::Client, client
