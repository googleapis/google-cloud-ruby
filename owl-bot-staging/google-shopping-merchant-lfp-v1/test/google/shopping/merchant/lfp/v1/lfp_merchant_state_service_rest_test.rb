...
class ::Google::Shopping::Merchant::Lfp::V1::LfpMerchantStateService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_lfp_merchant_state
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Lfp::V1::LfpMerchantState.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::LfpMerchantStateService::Rest::Client::Configuration, config
  end
end
