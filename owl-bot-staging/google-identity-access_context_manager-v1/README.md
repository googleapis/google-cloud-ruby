...
specific version of the Access Context Manager V1 API. Most users should consider using
the main client gem,
[google-identity-access_context_manager](https://rubygems.org/gems/google-identity-access_context_manager).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-identity-access_context_manager-v1
```
...
client library with a name such as `google-identity-access_context_manager`,
...
is part of the name, e.g. `google-identity-access_context_manager-v1`.
