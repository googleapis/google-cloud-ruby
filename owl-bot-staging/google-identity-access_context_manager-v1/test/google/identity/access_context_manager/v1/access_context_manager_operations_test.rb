...
class ::Google::Identity::AccessContextManager::V1::AccessContextManager::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Identity::AccessContextManager::V1::AccessContextManager::Operations.new do |config|
  ...
  def test_configure
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      client = ::Google::Identity::AccessContextManager::V1::AccessContextManager::Operations.new do |config|
        config.credentials = grpc_channel
      end
    end
    ...
    assert_kind_of ::Google::Identity::AccessContextManager::V1::AccessContextManager::Operations::Configuration, config
  end
end
