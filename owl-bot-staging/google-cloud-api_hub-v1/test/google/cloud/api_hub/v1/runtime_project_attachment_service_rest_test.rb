...
class ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachmentService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_runtime_project_attachment
    # Create test objects.
    client_result = ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachment.new
    ...
    create_runtime_project_attachment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachmentService::Rest::ServiceStub.stub :transcode_create_runtime_project_attachment_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_runtime_project_attachment_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_runtime_project_attachment_client_stub.call_count
      end
    end
  end
  ...
  def test_get_runtime_project_attachment
    ...
    get_runtime_project_attachment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachmentService::Rest::ServiceStub.stub :transcode_get_runtime_project_attachment_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_runtime_project_attachment_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_runtime_project_attachment_client_stub.call_count
      end
    end
  end
  ...
  def test_list_runtime_project_attachments
    # Create test objects.
    client_result = ::Google::Cloud::ApiHub::V1::ListRuntimeProjectAttachmentsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_runtime_project_attachments_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachmentService::Rest::ServiceStub.stub :transcode_list_runtime_project_attachments_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_runtime_project_attachments_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_runtime_project_attachments_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_runtime_project_attachment
    ...
    delete_runtime_project_attachment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachmentService::Rest::ServiceStub.stub :transcode_delete_runtime_project_attachment_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_runtime_project_attachment_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_runtime_project_attachment_client_stub.call_count
      end
    end
  end
  ...
  def test_lookup_runtime_project_attachment
    # Create test objects.
    client_result = ::Google::Cloud::ApiHub::V1::LookupRuntimeProjectAttachmentResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    lookup_runtime_project_attachment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachmentService::Rest::ServiceStub.stub :transcode_lookup_runtime_project_attachment_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, lookup_runtime_project_attachment_client_stub do
        ...
        # Verify method calls
        assert_equal 5, lookup_runtime_project_attachment_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ApiHub::V1::RuntimeProjectAttachmentService::Rest::Client::Configuration, config
  end
end
