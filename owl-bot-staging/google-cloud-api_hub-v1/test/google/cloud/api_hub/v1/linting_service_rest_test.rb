...
class ::Google::Cloud::ApiHub::V1::LintingService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_style_guide
    # Create test objects.
    client_result = ::Google::Cloud::ApiHub::V1::StyleGuide.new
    ...
    get_style_guide_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::ApiHub::V1::LintingService::Rest::ServiceStub.stub :transcode_get_style_guide_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_style_guide_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_style_guide_client_stub.call_count
      end
    end
  end
  ...
  def test_update_style_guide
    ...
    update_style_guide_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiHub::V1::LintingService::Rest::ServiceStub.stub :transcode_update_style_guide_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_style_guide_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_style_guide_client_stub.call_count
      end
    end
  end
  ...
  def test_get_style_guide_contents
    # Create test objects.
    client_result = ::Google::Cloud::ApiHub::V1::StyleGuideContents.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_style_guide_contents_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiHub::V1::LintingService::Rest::ServiceStub.stub :transcode_get_style_guide_contents_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_style_guide_contents_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_style_guide_contents_client_stub.call_count
      end
    end
  end
  ...
  def test_lint_spec
    ...
    lint_spec_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiHub::V1::LintingService::Rest::ServiceStub.stub :transcode_lint_spec_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, lint_spec_client_stub do
        ...
        # Verify method calls
        assert_equal 5, lint_spec_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ApiHub::V1::LintingService::Rest::Client::Configuration, config
  end
end
