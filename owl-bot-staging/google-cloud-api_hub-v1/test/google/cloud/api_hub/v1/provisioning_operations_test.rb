...
class ::Google::Cloud::ApiHub::V1::Provisioning::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::ApiHub::V1::Provisioning::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ApiHub::V1::Provisioning::Operations::Configuration, config
  end
end
