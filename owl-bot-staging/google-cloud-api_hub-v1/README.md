# Ruby Client for the API hub V1 API
...
specific version of the API hub V1 API. Most users should consider using
the main client gem,
[google-cloud-api_hub](https://rubygems.org/gems/google-cloud-api_hub).
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-api_hub-v1/latest)
