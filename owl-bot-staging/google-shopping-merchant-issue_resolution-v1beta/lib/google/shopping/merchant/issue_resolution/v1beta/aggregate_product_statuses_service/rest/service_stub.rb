          ...
          module AggregateProductStatusesService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::IssueResolution::V1beta::ListAggregateProductStatusesRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::IssueResolution::V1beta::ListAggregateProductStatusesResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Shopping::Merchant::IssueResolution::V1beta::ListAggregateProductStatusesResponse]
                ...
                def list_aggregate_product_statuses request_pb, options = nil
                  ...
                  result = ::Google::Shopping::Merchant::IssueResolution::V1beta::ListAggregateProductStatusesResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                def self.transcode_list_aggregate_product_statuses_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/issueresolution/v1beta/{parent}/aggregateProductStatuses",
                                                            matches: [
