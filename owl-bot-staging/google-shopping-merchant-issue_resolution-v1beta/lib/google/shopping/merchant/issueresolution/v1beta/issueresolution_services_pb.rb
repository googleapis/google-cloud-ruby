...
# Source: google/shopping/merchant/issueresolution/v1beta/issueresolution.proto for package 'Google.Shopping.Merchant.IssueResolution.V1beta'
        ...
        module V1beta
          module IssueResolutionService
            ...
            class Service
              ...
              self.service_name = 'google.shopping.merchant.issueresolution.v1beta.IssueResolutionService'
              ...
              rpc :RenderAccountIssues, ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderAccountIssuesRequest, ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderAccountIssuesResponse
              # Provide a list of issues for business's product with an issue resolution
              # content and available actions. This content and actions are meant to be
              # rendered and shown in third-party applications.
              rpc :RenderProductIssues, ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderProductIssuesRequest, ::Google::Shopping::Merchant::IssueResolution::V1beta::RenderProductIssuesResponse
              ...
              rpc :TriggerAction, ::Google::Shopping::Merchant::IssueResolution::V1beta::TriggerActionRequest, ::Google::Shopping::Merchant::IssueResolution::V1beta::TriggerActionResponse
            end
