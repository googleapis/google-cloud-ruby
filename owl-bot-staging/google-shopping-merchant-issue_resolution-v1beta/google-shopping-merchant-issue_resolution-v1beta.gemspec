...
require File.expand_path("lib/google/shopping/merchant/issue_resolution/v1beta/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-issue_resolution-v1beta"
  gem.version       = Google::Shopping::Merchant::IssueResolution::V1beta::VERSION
