...
class ::Google::Cloud::Billing::Budgets::V1::BudgetService::ClientTest < Minitest::Test
  ...
  def test_create_budget
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Billing::Budgets::V1::Budget.new
    ...
    create_budget_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Billing::Budgets::V1::CreateBudgetRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Billing::Budgets::V1::Budget), request["budget"]
      refute_nil options
    end
  ...
  def test_update_budget
    ...
    update_budget_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Billing::Budgets::V1::UpdateBudgetRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Billing::Budgets::V1::Budget), request["budget"]
  ...
  def test_get_budget
    ...
    get_budget_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Billing::Budgets::V1::GetBudgetRequest, request
  ...
  def test_list_budgets
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Billing::Budgets::V1::ListBudgetsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
  ...
  def test_delete_budget
    ...
    delete_budget_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Billing::Budgets::V1::DeleteBudgetRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Billing::Budgets::V1::BudgetService::Client::Configuration, config
  end
end
