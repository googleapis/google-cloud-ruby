  ...
  def test_get_conference_record
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_get_conference_record_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_conference_record_client_stub do
        # Create client
        c = ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.get_conference_record ::Google::Apps::Meet::V2::GetConferenceRecordRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.get_conference_record(::Google::Apps::Meet::V2::GetConferenceRecordRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_conference_records
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_list_conference_records_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_conference_records_client_stub do
        ...
        # Use protobuf object
        c.list_conference_records ::Google::Apps::Meet::V2::ListConferenceRecordsRequest.new(page_size: page_size, page_token: page_token, filter: filter) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_conference_records(::Google::Apps::Meet::V2::ListConferenceRecordsRequest.new(page_size: page_size, page_token: page_token, filter: filter), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_participant
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_get_participant_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_participant_client_stub do
        ...
        # Use protobuf object
        c.get_participant ::Google::Apps::Meet::V2::GetParticipantRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_participant(::Google::Apps::Meet::V2::GetParticipantRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_participants
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_list_participants_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_participants_client_stub do
        ...
        # Use protobuf object
        c.list_participants ::Google::Apps::Meet::V2::ListParticipantsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_participants(::Google::Apps::Meet::V2::ListParticipantsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_participant_session
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_get_participant_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_participant_session_client_stub do
        ...
        # Use protobuf object
        c.get_participant_session ::Google::Apps::Meet::V2::GetParticipantSessionRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_participant_session(::Google::Apps::Meet::V2::GetParticipantSessionRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_participant_sessions
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_list_participant_sessions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_participant_sessions_client_stub do
        ...
        # Use protobuf object
        c.list_participant_sessions ::Google::Apps::Meet::V2::ListParticipantSessionsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_participant_sessions(::Google::Apps::Meet::V2::ListParticipantSessionsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_recording
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_get_recording_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_recording_client_stub do
        ...
        # Use protobuf object
        c.get_recording ::Google::Apps::Meet::V2::GetRecordingRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_recording(::Google::Apps::Meet::V2::GetRecordingRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_recordings
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_list_recordings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_recordings_client_stub do
        ...
        # Use protobuf object
        c.list_recordings ::Google::Apps::Meet::V2::ListRecordingsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_recordings(::Google::Apps::Meet::V2::ListRecordingsRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_transcript
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_get_transcript_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_transcript_client_stub do
        ...
        # Use protobuf object
        c.get_transcript ::Google::Apps::Meet::V2::GetTranscriptRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_transcript(::Google::Apps::Meet::V2::GetTranscriptRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_transcripts
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_list_transcripts_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_transcripts_client_stub do
        ...
        # Use protobuf object
        c.list_transcripts ::Google::Apps::Meet::V2::ListTranscriptsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_transcripts(::Google::Apps::Meet::V2::ListTranscriptsRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_transcript_entry
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_get_transcript_entry_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_transcript_entry_client_stub do
        ...
        # Use protobuf object
        c.get_transcript_entry ::Google::Apps::Meet::V2::GetTranscriptEntryRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_transcript_entry(::Google::Apps::Meet::V2::GetTranscriptEntryRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_transcript_entries
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_list_transcript_entries_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_transcript_entries_client_stub do
        ...
        # Use protobuf object
        c.list_transcript_entries ::Google::Apps::Meet::V2::ListTranscriptEntriesRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_transcript_entries(::Google::Apps::Meet::V2::ListTranscriptEntriesRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
