              ...
              class ServiceStub
                ...
                def process_open_lineage_run_event request_pb, options = nil
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    method_name: "process_open_lineage_run_event",
                    options: options
                  )
                ...
                def create_lineage_event request_pb, options = nil
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "create_lineage_event",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                ...
                def list_lineage_events request_pb, options = nil
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "list_lineage_events",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                ...
                def delete_lineage_event request_pb, options = nil
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "delete_lineage_event",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                ...
                def batch_search_link_processes request_pb, options = nil
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "batch_search_link_processes",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
