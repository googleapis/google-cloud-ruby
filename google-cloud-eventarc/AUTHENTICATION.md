...
In general, the google-cloud-eventarc library uses
...
The google-cloud-eventarc library aims to make authentication
...
The environment variables that google-cloud-eventarc
...
client = Google::Cloud::Eventarc.eventarc do |config|
...
Google::Cloud::Eventarc.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-eventarc.
