  ...
  def test_list_functions
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_list_functions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_functions_client_stub do
        # Create client
        c = ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::Client.new do |config|
          config.credentials = :dummy_value
        end

        # Use hash object
        c.list_functions({ parent: parent, page_size: page_size, page_token: page_token }) do |_result, response|
        ...
        # Use protobuf object
        c.list_functions ::Google::Cloud::Functions::V1::ListFunctionsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.list_functions({ parent: parent, page_size: page_size, page_token: page_token }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.list_functions(::Google::Cloud::Functions::V1::ListFunctionsRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_function
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_get_function_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_function_client_stub do
        ...
        # Use hash object
        c.get_function({ name: name, version_id: version_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.get_function ::Google::Cloud::Functions::V1::GetFunctionRequest.new(name: name, version_id: version_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.get_function({ name: name, version_id: version_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.get_function(::Google::Cloud::Functions::V1::GetFunctionRequest.new(name: name, version_id: version_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_function
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_create_function_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_function_client_stub do
        ...
        # Use hash object
        c.create_function({ location: location, function: function }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.create_function ::Google::Cloud::Functions::V1::CreateFunctionRequest.new(location: location, function: function) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.create_function({ location: location, function: function }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.create_function(::Google::Cloud::Functions::V1::CreateFunctionRequest.new(location: location, function: function), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_function
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_update_function_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_function_client_stub do
        ...
        # Use protobuf object
        c.update_function ::Google::Cloud::Functions::V1::UpdateFunctionRequest.new(function: function, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_function(::Google::Cloud::Functions::V1::UpdateFunctionRequest.new(function: function, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_function
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_delete_function_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_function_client_stub do
        ...
        # Use protobuf object
        c.delete_function ::Google::Cloud::Functions::V1::DeleteFunctionRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_function(::Google::Cloud::Functions::V1::DeleteFunctionRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_call_function
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_call_function_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, call_function_client_stub do
        ...
        # Use hash object
        c.call_function({ name: name, data: data }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.call_function ::Google::Cloud::Functions::V1::CallFunctionRequest.new(name: name, data: data) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.call_function({ name: name, data: data }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.call_function(::Google::Cloud::Functions::V1::CallFunctionRequest.new(name: name, data: data), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_generate_upload_url
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_generate_upload_url_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, generate_upload_url_client_stub do
        ...
        # Use hash object
        c.generate_upload_url({ parent: parent, kms_key_name: kms_key_name }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.generate_upload_url ::Google::Cloud::Functions::V1::GenerateUploadUrlRequest.new(parent: parent, kms_key_name: kms_key_name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.generate_upload_url({ parent: parent, kms_key_name: kms_key_name }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.generate_upload_url(::Google::Cloud::Functions::V1::GenerateUploadUrlRequest.new(parent: parent, kms_key_name: kms_key_name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_generate_download_url
    ...
    ::Google::Cloud::Functions::V1::CloudFunctionsService::Rest::ServiceStub.stub :transcode_generate_download_url_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, generate_download_url_client_stub do
        ...
        # Use hash object
        c.generate_download_url({ name: name, version_id: version_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.generate_download_url ::Google::Cloud::Functions::V1::GenerateDownloadUrlRequest.new(name: name, version_id: version_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.generate_download_url({ name: name, version_id: version_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.generate_download_url(::Google::Cloud::Functions::V1::GenerateDownloadUrlRequest.new(name: name, version_id: version_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
