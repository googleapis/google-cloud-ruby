...
class ::Google::Cloud::AlloyDb::V1::AlloyDBAdmin::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AlloyDb::V1::AlloyDBAdmin::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AlloyDb::V1::AlloyDBAdmin::Operations::Configuration, config
  end
end
