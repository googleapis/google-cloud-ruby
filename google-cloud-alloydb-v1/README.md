...
the main client gem,
[google-cloud-alloydb](https://rubygems.org/gems/google-cloud-alloydb).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-alloydb-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-alloydb-v1/latest)
...
client library with a name such as `google-cloud-alloydb`,
...
is part of the name, e.g. `google-cloud-alloydb-v1`.
