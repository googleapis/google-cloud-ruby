...
class ::Google::Cloud::ApigeeConnect::V1::ConnectionService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_connections
    # Create test objects.
    client_result = ::Google::Cloud::ApigeeConnect::V1::ListConnectionsResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ApigeeConnect::V1::ConnectionService::Rest::Client::Configuration, config
  end
end
