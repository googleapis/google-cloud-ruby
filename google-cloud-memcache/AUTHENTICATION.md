...
The recommended way to authenticate to the google-cloud-memcache library is to use
...
The google-cloud-memcache library provides several mechanisms to configure your system.
