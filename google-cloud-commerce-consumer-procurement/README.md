...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-commerce-consumer-procurement/latest)
for this library, google-cloud-commerce-consumer-procurement, to see the convenience methods for
...
```
$ gem install google-cloud-commerce-consumer-procurement
```
