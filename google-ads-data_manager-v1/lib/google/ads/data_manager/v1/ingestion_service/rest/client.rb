          ...
          module Rest
            ...
            class Client
              ...
              def remove_all_audience_members request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.remove_all_audience_members.metadata.to_h
                ...
                @ingestion_service_stub.remove_all_audience_members request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
