        ...
        module IngestionService
          module Rest
            ...
            class ServiceStub
              ...
              ##
              # Baseline implementation for the remove_all_audience_members REST call
              #
              # @param request_pb [::Google::Ads::DataManager::V1::RemoveAllAudienceMembersRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Ads::DataManager::V1::RemoveAllAudienceMembersResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Ads::DataManager::V1::RemoveAllAudienceMembersResponse]
              #   A result object deserialized from the server's reply
              def remove_all_audience_members request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_remove_all_audience_members_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "remove_all_audience_members",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Ads::DataManager::V1::RemoveAllAudienceMembersResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              # @private
              #
              # GRPC transcoding helper method for the remove_all_audience_members REST call
              #
              # @param request_pb [::Google::Ads::DataManager::V1::RemoveAllAudienceMembersRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_remove_all_audience_members_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/audienceMembers:removeAll",
                                                          body: "*",
                                                          matches: []
                                                        )
                transcoder.transcode request_pb
