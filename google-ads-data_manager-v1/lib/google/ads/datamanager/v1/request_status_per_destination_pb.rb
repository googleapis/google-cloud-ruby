  ...
  module Ads
    module DataManager
      module V1
        ...
        RequestStatusPerDestination::IngestUserIdDataStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.datamanager.v1.RequestStatusPerDestination.IngestUserIdDataStatus").msgclass
