  ...
  module Ads
    module DataManager
      module V1
        ...
        GoogleUserIdData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.datamanager.v1.GoogleUserIdData").msgclass
        PartnerProvidedIdData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.datamanager.v1.PartnerProvidedIdData").msgclass
      end
    end
  end
end
