...
class ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_user_list_global_license
    # Create GRPC objects.
    grpc_response = ::Google::Ads::DataManager::V1::UserListGlobalLicense.new
    ...
    create_user_list_global_license_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_user_list_global_license, name
      assert_kind_of ::Google::Ads::DataManager::V1::CreateUserListGlobalLicenseRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Ads::DataManager::V1::UserListGlobalLicense), request["user_list_global_license"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_user_list_global_license_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_user_list_global_license_client_stub.call_rpc_count
    end
  end

  def test_update_user_list_global_license
    # Create GRPC objects.
    grpc_response = ::Google::Ads::DataManager::V1::UserListGlobalLicense.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    update_user_list_global_license_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_user_list_global_license, name
      assert_kind_of ::Google::Ads::DataManager::V1::UpdateUserListGlobalLicenseRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Ads::DataManager::V1::UserListGlobalLicense), request["user_list_global_license"]
    ...
    Gapic::ServiceStub.stub :new, update_user_list_global_license_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_user_list_global_license_client_stub.call_rpc_count
    end
  end

  def test_get_user_list_global_license
    # Create GRPC objects.
    grpc_response = ::Google::Ads::DataManager::V1::UserListGlobalLicense.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    get_user_list_global_license_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_user_list_global_license, name
      assert_kind_of ::Google::Ads::DataManager::V1::GetUserListGlobalLicenseRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_user_list_global_license_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_user_list_global_license_client_stub.call_rpc_count
    end
  end

  def test_list_user_list_global_licenses
    # Create GRPC objects.
    grpc_response = ::Google::Ads::DataManager::V1::ListUserListGlobalLicensesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_user_list_global_licenses_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_user_list_global_licenses, name
      assert_kind_of ::Google::Ads::DataManager::V1::ListUserListGlobalLicensesRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_user_list_global_licenses_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_user_list_global_licenses_client_stub.call_rpc_count
    end
  end

  def test_list_user_list_global_license_customer_infos
    # Create GRPC objects.
    grpc_response = ::Google::Ads::DataManager::V1::ListUserListGlobalLicenseCustomerInfosResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_user_list_global_license_customer_infos_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_user_list_global_license_customer_infos, name
      assert_kind_of ::Google::Ads::DataManager::V1::ListUserListGlobalLicenseCustomerInfosRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["filter"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
    ...
    Gapic::ServiceStub.stub :new, list_user_list_global_license_customer_infos_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_user_list_global_license_customer_infos_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Client::Configuration, config
  end
