...
class ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_user_list_global_license
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::UserListGlobalLicense.new
    ...
    ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Rest::ServiceStub.stub :transcode_create_user_list_global_license_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_user_list_global_license_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_user_list_global_license_client_stub.call_count
      end
    end
  end
  ...
  def test_update_user_list_global_license
    ...
    update_user_list_global_license_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Rest::ServiceStub.stub :transcode_update_user_list_global_license_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_user_list_global_license_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_user_list_global_license_client_stub.call_count
      end
    end
  end
  ...
  def test_get_user_list_global_license
    ...
    get_user_list_global_license_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Rest::ServiceStub.stub :transcode_get_user_list_global_license_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_user_list_global_license_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_user_list_global_license_client_stub.call_count
      end
    end
  end
  ...
  def test_list_user_list_global_licenses
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::ListUserListGlobalLicensesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_user_list_global_licenses_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Rest::ServiceStub.stub :transcode_list_user_list_global_licenses_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_user_list_global_licenses_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_user_list_global_licenses_client_stub.call_count
      end
    end
  end
  ...
  def test_list_user_list_global_license_customer_infos
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::ListUserListGlobalLicenseCustomerInfosResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_user_list_global_license_customer_infos_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Rest::ServiceStub.stub :transcode_list_user_list_global_license_customer_infos_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_user_list_global_license_customer_infos_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_user_list_global_license_customer_infos_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::DataManager::V1::UserListGlobalLicenseService::Rest::Client::Configuration, config
  end
end
