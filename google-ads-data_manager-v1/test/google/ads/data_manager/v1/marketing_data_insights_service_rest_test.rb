...
class ::Google::Ads::DataManager::V1::MarketingDataInsightsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_retrieve_insights
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::RetrieveInsightsResponse.new
    ...
    retrieve_insights_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::DataManager::V1::MarketingDataInsightsService::Rest::ServiceStub.stub :transcode_retrieve_insights_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, retrieve_insights_client_stub do
        ...
        # Verify method calls
        assert_equal 5, retrieve_insights_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::DataManager::V1::MarketingDataInsightsService::Rest::Client::Configuration, config
  end
end
