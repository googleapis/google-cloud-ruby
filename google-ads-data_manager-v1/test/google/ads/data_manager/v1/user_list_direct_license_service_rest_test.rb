...
class ::Google::Ads::DataManager::V1::UserListDirectLicenseService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_user_list_direct_license
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::UserListDirectLicense.new
    ...
    create_user_list_direct_license_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::DataManager::V1::UserListDirectLicenseService::Rest::ServiceStub.stub :transcode_create_user_list_direct_license_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_user_list_direct_license_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_user_list_direct_license_client_stub.call_count
      end
    end
  end
  ...
  def test_get_user_list_direct_license
    ...
    get_user_list_direct_license_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::UserListDirectLicenseService::Rest::ServiceStub.stub :transcode_get_user_list_direct_license_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_user_list_direct_license_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_user_list_direct_license_client_stub.call_count
      end
    end
  end
  ...
  def test_update_user_list_direct_license
    ...
    update_user_list_direct_license_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::UserListDirectLicenseService::Rest::ServiceStub.stub :transcode_update_user_list_direct_license_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_user_list_direct_license_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_user_list_direct_license_client_stub.call_count
      end
    end
  end
  ...
  def test_list_user_list_direct_licenses
    # Create test objects.
    client_result = ::Google::Ads::DataManager::V1::ListUserListDirectLicensesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_user_list_direct_licenses_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::DataManager::V1::UserListDirectLicenseService::Rest::ServiceStub.stub :transcode_list_user_list_direct_licenses_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_user_list_direct_licenses_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_user_list_direct_licenses_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::DataManager::V1::UserListDirectLicenseService::Rest::Client::Configuration, config
  end
end
