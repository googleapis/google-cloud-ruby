      ...
      module CX
        module V3
          module Examples
            module Rest
              ##
              # REST service stub for the Examples service.
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Cloud::Dialogflow::CX::V3::CreateExampleRequest]
                ...
                def create_example request_pb, options = nil
                  ...
                  result = ::Google::Cloud::Dialogflow::CX::V3::Example.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Cloud::Dialogflow::CX::V3::DeleteExampleRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Cloud::Dialogflow::CX::V3::ListExamplesRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Cloud::Dialogflow::CX::V3::ListExamplesResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Cloud::Dialogflow::CX::V3::ListExamplesResponse]
                #   A result object deserialized from the server's reply
                def list_examples request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Cloud::Dialogflow::CX::V3::ListExamplesResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                #
                # @param request_pb [::Google::Cloud::Dialogflow::CX::V3::GetExampleRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Cloud::Dialogflow::CX::V3::UpdateExampleRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def self.transcode_delete_example_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            ...
                                                            matches: [
                                                              ["name", %r{^projects/[^/]+/locations/[^/]+/agents/[^/]+/playbooks/[^/]+/examples/[^/]+/?$}, false]
                                                            ]
                                                          )
                  transcoder.transcode request_pb
                end
                ...
                def self.transcode_update_example_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :patch,
                                                            uri_template: "/v3/{example.name}",
                                                            body: "example",
                                                            matches: [
                                                              ["example.name", %r{^projects/[^/]+/locations/[^/]+/agents/[^/]+/playbooks/[^/]+/examples/[^/]+/?$}, false]
                                                            ]
                                                          )
                  transcoder.transcode request_pb
                end
