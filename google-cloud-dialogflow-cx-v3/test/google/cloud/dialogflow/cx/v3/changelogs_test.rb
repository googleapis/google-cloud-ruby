...
class ::Google::Cloud::Dialogflow::CX::V3::Changelogs::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_changelogs
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::ListChangelogsResponse.new
    ...
    list_changelogs_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::ListChangelogsRequest, request
  ...
  def test_get_changelog
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::Changelog.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_changelog_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::GetChangelogRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::Changelogs::Client::Configuration, config
  end
end
