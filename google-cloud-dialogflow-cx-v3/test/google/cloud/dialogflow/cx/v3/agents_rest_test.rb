  ...
  def test_export_agent
    ...
    ::Google::Cloud::Dialogflow::CX::V3::Agents::Rest::ServiceStub.stub :transcode_export_agent_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, export_agent_client_stub do
        ...
        # Use hash object
        client.export_agent({ name: name, agent_uri: agent_uri, data_format: data_format, environment: environment, include_bigquery_export_settings: include_bigquery_export_settings }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        client.export_agent ::Google::Cloud::Dialogflow::CX::V3::ExportAgentRequest.new(name: name, agent_uri: agent_uri, data_format: data_format, environment: environment, include_bigquery_export_settings: include_bigquery_export_settings) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        client.export_agent({ name: name, agent_uri: agent_uri, data_format: data_format, environment: environment, include_bigquery_export_settings: include_bigquery_export_settings }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        client.export_agent(::Google::Cloud::Dialogflow::CX::V3::ExportAgentRequest.new(name: name, agent_uri: agent_uri, data_format: data_format, environment: environment, include_bigquery_export_settings: include_bigquery_export_settings), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
