...
require "google/cloud/dialogflow/cx/v3/examples/rest"


class ::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_example
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::Example.new
  ...
  def test_list_examples
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::ListExamplesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::Examples::Rest::Client::Configuration, config
  end
end
