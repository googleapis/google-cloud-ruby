...
class ::Google::Cloud::Dialogflow::CX::V3::Tools::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_tool
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::Tool.new
    ...
    create_tool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::CreateToolRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::CX::V3::Tool), request["tool"]
      refute_nil options
    end
  ...
  def test_list_tools
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::ListToolsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_tools_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::ListToolsRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_get_tool
    ...
    get_tool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::GetToolRequest, request
  ...
  def test_update_tool
    ...
    update_tool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::UpdateToolRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::CX::V3::Tool), request["tool"]
  ...
  def test_delete_tool
    ...
    delete_tool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::DeleteToolRequest, request
      assert_equal "hello world", request["name"]
  ...
  def test_list_tool_versions
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::ListToolVersionsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_tool_versions_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_tool_versions, name
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::ListToolVersionsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, list_tool_versions_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_tool_versions_client_stub.call_rpc_count
    end
  end

  def test_create_tool_version
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::ToolVersion.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    create_tool_version_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_tool_version, name
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::CreateToolVersionRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::CX::V3::ToolVersion), request["tool_version"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_tool_version_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_tool_version_client_stub.call_rpc_count
    end
  end
  ...
  def test_get_tool_version
    ...
    get_tool_version_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_tool_version, name
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::GetToolVersionRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_tool_version_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_tool_version_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_tool_version
    ...
    delete_tool_version_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_tool_version, name
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::DeleteToolVersionRequest, request
      assert_equal "hello world", request["name"]
      assert_equal true, request["force"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_tool_version_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_tool_version_client_stub.call_rpc_count
    end
  end

  def test_restore_tool_version
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3::RestoreToolVersionResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    restore_tool_version_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :restore_tool_version, name
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::RestoreToolVersionRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, restore_tool_version_client_stub do
      ...
      # Verify method calls
      assert_equal 5, restore_tool_version_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::Tools::Client::Configuration, config
  end
