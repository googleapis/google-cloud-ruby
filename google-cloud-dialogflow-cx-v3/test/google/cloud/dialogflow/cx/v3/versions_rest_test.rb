...
class ::Google::Cloud::Dialogflow::CX::V3::Versions::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_versions
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::ListVersionsResponse.new
  ...
  def test_get_version
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::Version.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_load_version
    ...
    load_version_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::CX::V3::Versions::Rest::ServiceStub.stub :transcode_load_version_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, load_version_client_stub do
        ...
        # Verify method calls
        assert_equal 5, load_version_client_stub.call_count
      end
    end
  end
  ...
  def test_compare_versions
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::CX::V3::CompareVersionsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    compare_versions_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::CX::V3::Versions::Rest::ServiceStub.stub :transcode_compare_versions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, compare_versions_client_stub do
        ...
        # Verify method calls
        assert_equal 5, compare_versions_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3::Versions::Rest::Client::Configuration, config
  end
end
