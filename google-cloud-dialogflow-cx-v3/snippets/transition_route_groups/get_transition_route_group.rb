...
##
# Snippet for the get_transition_route_group call in the TransitionRouteGroups service
#
...
# Google::Cloud::Dialogflow::CX::V3::TransitionRouteGroups::Client#get_transition_route_group.
#
