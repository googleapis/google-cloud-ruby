...
class ::Google::Cloud::VideoIntelligence::V1::VideoIntelligenceService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VideoIntelligence::V1::VideoIntelligenceService::Operations::Configuration, config
  end
end
