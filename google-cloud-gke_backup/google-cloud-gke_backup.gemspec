...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Backup for GKE is a managed Kubernetes workload backup and restore service for GKE clusters."
  ...
  gem.add_dependency "google-cloud-gke_backup-v1", "~> 1.0"
end
