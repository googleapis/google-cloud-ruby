...
require File.expand_path("lib/google/cloud/cloud_security_compliance/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-cloud_security_compliance-v1"
  gem.version       = Google::Cloud::CloudSecurityCompliance::V1::VERSION
