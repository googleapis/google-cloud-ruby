...
class ::Google::Cloud::CloudSecurityCompliance::V1::Audit::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_generate_framework_audit_scope_report
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::CloudSecurityCompliance::V1::GenerateFrameworkAuditScopeReportResponse.new
    ...
    generate_framework_audit_scope_report_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :generate_framework_audit_scope_report, name
      assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::GenerateFrameworkAuditScopeReportRequest, request
      assert_equal "hello world", request["scope"]
      assert_equal :FORMAT_UNSPECIFIED, request["report_format"]
    ...
    Gapic::ServiceStub.stub :new, generate_framework_audit_scope_report_client_stub do
      ...
      # Verify method calls
      assert_equal 5, generate_framework_audit_scope_report_client_stub.call_rpc_count
    end
  end
  ...
  def test_create_framework_audit
    ...
    create_framework_audit_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_framework_audit, name
      assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::CreateFrameworkAuditRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["framework_audit_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::CloudSecurityCompliance::V1::FrameworkAudit), request["framework_audit"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_framework_audit_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_framework_audit_client_stub.call_rpc_count
    end
  end

  def test_list_framework_audits
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::CloudSecurityCompliance::V1::ListFrameworkAuditsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_framework_audits_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_framework_audits, name
      assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::ListFrameworkAuditsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_framework_audits_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_framework_audits_client_stub.call_rpc_count
    end
  end

  def test_get_framework_audit
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::CloudSecurityCompliance::V1::FrameworkAudit.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_framework_audit_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_framework_audit, name
      assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::GetFrameworkAuditRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_framework_audit_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_framework_audit_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::Audit::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::Audit::Operations, client.operations_client
  end
end
