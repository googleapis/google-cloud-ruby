...
class ::Google::Cloud::CloudSecurityCompliance::V1::CmEnrollmentService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_update_cm_enrollment
    # Create test objects.
    client_result = ::Google::Cloud::CloudSecurityCompliance::V1::CmEnrollment.new
    ...
    update_cm_enrollment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::CmEnrollmentService::Rest::ServiceStub.stub :transcode_update_cm_enrollment_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_cm_enrollment_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_cm_enrollment_client_stub.call_count
      end
    end
  end
  ...
  def test_calculate_effective_cm_enrollment
    # Create test objects.
    client_result = ::Google::Cloud::CloudSecurityCompliance::V1::CalculateEffectiveCmEnrollmentResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    calculate_effective_cm_enrollment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::CloudSecurityCompliance::V1::CmEnrollmentService::Rest::ServiceStub.stub :transcode_calculate_effective_cm_enrollment_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, calculate_effective_cm_enrollment_client_stub do
        ...
        # Verify method calls
        assert_equal 5, calculate_effective_cm_enrollment_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::CloudSecurityCompliance::V1::CmEnrollmentService::Rest::Client::Configuration, config
  end
end
