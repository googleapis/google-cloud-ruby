...
helper_path = ::File.join __dir__, "authentication_service", "helpers.rb"
require "google/cloud/identity_toolkit/v2/authentication_service/helpers" if ::File.file? helper_path
