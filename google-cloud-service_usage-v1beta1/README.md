# Ruby Client for the Service Usage V1beta1 API

API Client library for the Service Usage V1beta1 API
...
specific version of the Service Usage V1beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-service_usage-v1beta1
```
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-service_usage-v1beta1/latest)
...
`google-cloud-service_usage-v1beta1`.
...
is part of the name, e.g. `google-cloud-service_usage-v1beta1`.
