            ...
            class OperationsServiceStub
              ...
              def self.transcode_list_operations_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v1p2beta1/{name}/operations",
                                                          matches: [
              ...
              def self.transcode_get_operation_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        ...
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v1p2beta1/operations/{name}",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/operations/[^/]+/?$}, false]
                                                          ]
                                                        )
              ...
              def self.transcode_cancel_operation_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1p2beta1/{name}:cancel",
                                                          body: "*",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/operations/[^/]+/?$}, false]
                                                          ]
                                                        ...
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1p2beta1/operations/{name}:cancel",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/operations/[^/]+/?$}, false]
                                                          ]
                                                        )
