...
In general, the google-cloud-artifact_registry-v1beta2 library uses
...
```sh
export ARTIFACT_REGISTRY_CREDENTIALS=path/to/keyfile.json
```
...
The google-cloud-artifact_registry-v1beta2 library aims to make authentication
...
The environment variables that google-cloud-artifact_registry-v1beta2
...
ENV["ARTIFACT_REGISTRY_CREDENTIALS"] = "path/to/keyfile.json"
...
connect to most services with google-cloud-artifact_registry-v1beta2.
