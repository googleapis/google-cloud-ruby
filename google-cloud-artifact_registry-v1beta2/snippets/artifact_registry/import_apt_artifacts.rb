...
##
# Snippet for the import_apt_artifacts call in the ArtifactRegistry service
#
...
# Google::Cloud::ArtifactRegistry::V1beta2::ArtifactRegistry::Client#import_apt_artifacts.
#
