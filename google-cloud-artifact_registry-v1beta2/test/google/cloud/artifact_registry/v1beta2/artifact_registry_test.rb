...
class ::Google::Cloud::ArtifactRegistry::V1beta2::ArtifactRegistry::ClientTest < Minitest::Test
  ...
  def test_list_docker_images
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::ArtifactRegistry::V1beta2::ListDockerImagesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_docker_images_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::ArtifactRegistry::V1beta2::ListDockerImagesRequest, request
      assert_equal "hello world", request.parent
      assert_equal 42, request.page_size
      assert_equal "hello world", request.page_token
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, list_docker_images_client_stub do
      ...
      # Use protobuf object
      client.list_docker_images ::Google::Cloud::ArtifactRegistry::V1beta2::ListDockerImagesRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_docker_images ::Google::Cloud::ArtifactRegistry::V1beta2::ListDockerImagesRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
