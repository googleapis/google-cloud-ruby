...
class ::Google::Cloud::GkeConnect::Gateway::V1::GatewayControl::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_generate_credentials
    # Create test objects.
    client_result = ::Google::Cloud::GkeConnect::Gateway::V1::GenerateCredentialsResponse.new
    ...
    generate_credentials_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::GkeConnect::Gateway::V1::GatewayControl::Rest::ServiceStub.stub :transcode_generate_credentials_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, generate_credentials_client_stub do
        ...
        # Verify method calls
        assert_equal 5, generate_credentials_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::GkeConnect::Gateway::V1::GatewayControl::Rest::Client::Configuration, config
  end
end
