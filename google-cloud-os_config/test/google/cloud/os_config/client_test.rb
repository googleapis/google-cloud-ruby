...
class Google::Cloud::OsConfig::ClientConstructionMinitest < Minitest::Test
  ...
  def test_os_config_service_grpc
    skip unless Google::Cloud::OsConfig.os_config_service_available? transport: :grpc
  ...
  def test_os_config_service_rest
    skip unless Google::Cloud::OsConfig.os_config_service_available? transport: :rest
  ...
  def test_os_config_zonal_service_grpc
    skip unless Google::Cloud::OsConfig.os_config_zonal_service_available? transport: :grpc
    Gapic::ServiceStub.stub :new, DummyStub.new do
      grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
  ...
  def test_os_config_zonal_service_rest
    skip unless Google::Cloud::OsConfig.os_config_zonal_service_available? transport: :rest
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
