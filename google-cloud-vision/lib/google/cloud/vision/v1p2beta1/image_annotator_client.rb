...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/vision/v1p2beta1/image_annotator.proto,
...
require "google/cloud/vision/v1p2beta1/credentials"
  ...
  module Cloud
    module Vision
      module V1p2beta1
        ...
        #   @return [Google::Cloud::Vision::V1p2beta1::ImageAnnotator::Stub]
        class ImageAnnotatorClient
          ...
          def initialize \
            ...
            credentials ||= Google::Cloud::Vision::V1p2beta1::Credentials.default
            ...
            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Cloud::Vision::V1p2beta1::Credentials.new(credentials).updater_proc
            end
            ...
            @image_annotator_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Vision::V1p2beta1::ImageAnnotator::Stub.method(:new)
            )
          ...
          #
          # @param requests [Array<Google::Cloud::Vision::V1p2beta1::AnnotateImageRequest | Hash>]
          #   Individual image annotation requests for this batch.
          #   A hash of the same form as `Google::Cloud::Vision::V1p2beta1::AnnotateImageRequest`
          #   can also be provided.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Vision::V1p2beta1::BatchAnnotateImagesResponse]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Cloud::Vision::V1p2beta1::BatchAnnotateImagesResponse]
          ...
          def batch_annotate_images \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Vision::V1p2beta1::BatchAnnotateImagesRequest)
          ...
          #
          # @param requests [Array<Google::Cloud::Vision::V1p2beta1::AsyncAnnotateFileRequest | Hash>]
          #   Individual async file annotation requests for this batch.
          #   A hash of the same form as `Google::Cloud::Vision::V1p2beta1::AsyncAnnotateFileRequest`
          #   can also be provided.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          ...
          def async_batch_annotate_files \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Vision::V1p2beta1::AsyncBatchAnnotateFilesRequest)
