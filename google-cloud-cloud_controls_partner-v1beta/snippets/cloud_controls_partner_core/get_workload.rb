...
##
# Snippet for the get_workload call in the CloudControlsPartnerCore service
#
...
# Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Client#get_workload.
#
def get_workload
