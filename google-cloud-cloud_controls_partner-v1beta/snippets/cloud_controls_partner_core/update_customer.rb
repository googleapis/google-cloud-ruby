...
##
# Snippet for the update_customer call in the CloudControlsPartnerCore service
#
...
# Google::Cloud::CloudControlsPartner::V1beta::CloudControlsPartnerCore::Client#update_customer.
#
def update_customer
