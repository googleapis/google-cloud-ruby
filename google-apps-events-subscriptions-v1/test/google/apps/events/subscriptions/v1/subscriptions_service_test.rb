...
class ::Google::Apps::Events::Subscriptions::V1::SubscriptionsService::ClientTest < Minitest::Test
  ...
  def test_create_subscription
    ...
    Gapic::ServiceStub.stub :new, create_subscription_client_stub do
      # Create client
      c = ::Google::Apps::Events::Subscriptions::V1::SubscriptionsService::Client.new do |config|
      ...
      # Use protobuf object
      c.create_subscription ::Google::Apps::Events::Subscriptions::V1::CreateSubscriptionRequest.new(subscription: subscription, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      c.create_subscription(::Google::Apps::Events::Subscriptions::V1::CreateSubscriptionRequest.new(subscription: subscription, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_subscription
    ...
    Gapic::ServiceStub.stub :new, delete_subscription_client_stub do
      ...
      # Use protobuf object
      c.delete_subscription ::Google::Apps::Events::Subscriptions::V1::DeleteSubscriptionRequest.new(name: name, validate_only: validate_only, allow_missing: allow_missing, etag: etag) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_subscription(::Google::Apps::Events::Subscriptions::V1::DeleteSubscriptionRequest.new(name: name, validate_only: validate_only, allow_missing: allow_missing, etag: etag), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_subscription
    ...
    Gapic::ServiceStub.stub :new, get_subscription_client_stub do
      ...
      # Use protobuf object
      c.get_subscription ::Google::Apps::Events::Subscriptions::V1::GetSubscriptionRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_subscription(::Google::Apps::Events::Subscriptions::V1::GetSubscriptionRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_subscriptions
    ...
    Gapic::ServiceStub.stub :new, list_subscriptions_client_stub do
      ...
      # Use protobuf object
      c.list_subscriptions ::Google::Apps::Events::Subscriptions::V1::ListSubscriptionsRequest.new(page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_subscriptions(::Google::Apps::Events::Subscriptions::V1::ListSubscriptionsRequest.new(page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_subscription
    ...
    Gapic::ServiceStub.stub :new, update_subscription_client_stub do
      ...
      # Use protobuf object
      c.update_subscription ::Google::Apps::Events::Subscriptions::V1::UpdateSubscriptionRequest.new(subscription: subscription, update_mask: update_mask, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_subscription(::Google::Apps::Events::Subscriptions::V1::UpdateSubscriptionRequest.new(subscription: subscription, update_mask: update_mask, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_reactivate_subscription
    ...
    Gapic::ServiceStub.stub :new, reactivate_subscription_client_stub do
      ...
      # Use protobuf object
      c.reactivate_subscription ::Google::Apps::Events::Subscriptions::V1::ReactivateSubscriptionRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.reactivate_subscription(::Google::Apps::Events::Subscriptions::V1::ReactivateSubscriptionRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
