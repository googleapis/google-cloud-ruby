...
require "google/cloud/support/version"
...
::Google::Cloud.configure.add_config! :support do |config|
  config.add_field! :endpoint,      "cloudsupport.googleapis.com", match: ::String
...
module Google
  module Cloud
    module Support
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.support if block_given?
...
helper_path = ::File.join __dir__, "support", "helpers.rb"
require "google/cloud/support/helpers" if ::File.file? helper_path
