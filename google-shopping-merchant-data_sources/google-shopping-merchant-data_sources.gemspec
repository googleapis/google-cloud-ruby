...
require File.expand_path("lib/google/shopping/merchant/data_sources/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-data_sources"
  gem.version       = Google::Shopping::Merchant::DataSources::VERSION
