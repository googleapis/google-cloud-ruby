...
##
# Snippet for the create_metadata_import call in the DataprocMetastore service
#
...
# Google::Cloud::Metastore::V1beta::DataprocMetastore::Client#create_metadata_import.
#
