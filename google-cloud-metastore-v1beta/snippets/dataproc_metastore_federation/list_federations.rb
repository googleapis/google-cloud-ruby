...
##
# Snippet for the list_federations call in the DataprocMetastoreFederation service
#
...
# Google::Cloud::Metastore::V1beta::DataprocMetastoreFederation::Client#list_federations.
#
