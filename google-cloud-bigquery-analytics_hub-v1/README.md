...
specific version of the Analytics Hub V1 API. Most users should consider using
the main client gem,
[google-cloud-bigquery-analytics_hub](https://rubygems.org/gems/google-cloud-bigquery-analytics_hub).
