  ...
  module Cloud
    module Bigtable
      class Snapshot
        ...
        # retrieve the snapshot object once the operation has been completed.
        #
        ...
        class Job
          ...
          #
          # @return [Google::Cloud::Bigtable::Snapshot, nil] The snapshot instance, or
          ...
          def snapshot
            ...
            Snapshot.from_grpc(@grpc.results, service)
          end
          ...
          #
          # @return [Google::Cloud::Bigtable::Snapshot::Job] The same job
          #   instance.
          #
          # @example
          #   require "google/cloud/bigtable"
          ...
          # @private
          # New Snapshot::Job from a Google::Gax::Operation object.
