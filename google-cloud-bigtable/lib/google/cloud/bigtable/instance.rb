  ...
  module Cloud
    module Bigtable
      ...
      class Instance
        ...
        # Only one routing policy can applied to app profile. `multi_cluster_routing` or
        #   `single_cluster_routing`
        #
        # @param name [String] Unique name of the app profile
        ...
        # List snapshots for all clusters in an instance.
        #
        ...
        #
        # @param page_size [Integer] Maximum number of snapshot per page to return.
        ...
        #   instance = bigtable.instance("my-instance")
        #
        #   instance.snapshots.all do |snapshot|
        #     p snapshot.name
        #   end
        #
        def snapshots page_size: nil
          ensure_service!
          grpc = service.list_snapshots(instance_id, "-", page_size: page_size)
