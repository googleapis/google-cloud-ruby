  ...
  module Cloud
    module Bigtable
      ...
      class Cluster
        ...
        # List snapshots in cluster.
        #
        #  See {Google::Cloud::Bigtable::Snapshot#delete} to delete
        #  and {Google::Cloud::Bigtable::Snapshot#create_table} create table from snapshot.
        #
        # @param page_size [Integer] The maximum number of snapshots returns in a page.
        # @return [Array<Google::Cloud::Bigtable::Snapshot>]
        #   (See {Google::Cloud::Bigtable::Snapshot::List})
        #
        # @example
        #   require "google/cloud/bigtable"
        #
        ...
        #   cluster = instance.cluster("my-cluster")
        #
        #   cluster.snapshots.all do |snapshot|
        #     p snapshot.name
        #   end
        #
        # @example List snapshots with page size
        #   require "google/cloud/bigtable"
        #
        #   bigtable = Google::Cloud::Bigtable.new
        #
        ...
        #   cluster = instance.cluster("my-cluster")
        #
        #   cluster.snapshots(page_size: 10).all do |snapshot|
        #     p snapshot.name
        #   end
        #
        def snapshots page_size: nil
          ensure_service!
          grpc = service.list_snapshots(
            instance_id,
            cluster_id,
            page_size: page_size
          )
          Snapshot::List.from_grpc(grpc, service)
        end

        # Get a snapshot in the specified cluster.
        # The cluster and the table must be in the same instance.
        #
        #  See {Google::Cloud::Bigtable::Snapshot#delete} to delete
        #  and {Google::Cloud::Bigtable::Snapshot#create_table} create table from snapshot.
        #
        # @param snapshot_id [String] The snapshot id by which the new snapshot
        #   should be referred to within the parent cluster.
        # @return [Google::Cloud::Bigtable::Snapshot, nil]
        #
        # @example
        #   require "google/cloud/bigtable"
        #
        ...
        def snapshot snapshot_id
          ensure_service!
          grpc = service.get_snapshot(instance_id, cluster_id, snapshot_id)
