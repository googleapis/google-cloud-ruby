    ...
    it 'invokes list_instances without error' do
      ...
      Google::Bigtable::Admin::V2::BigtableInstanceAdmin::Stub.stub(:new, mock_stub) do
        Google::Cloud::Bigtable::Admin::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method with block
          client.list_instances(formatted_parent) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
            refute_nil(operation)
          end
    ...
    it 'invokes update_instance without error' do
      ...
      Google::Bigtable::Admin::V2::BigtableInstanceAdmin::Stub.stub(:new, mock_stub) do
        Google::Cloud::Bigtable::Admin::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method with block
          client.update_instance(display_name) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
            refute_nil(operation)
          end
    ...
    it 'invokes update_cluster with error' do
      ...
      Google::Bigtable::Admin::V2::BigtableInstanceAdmin::Stub.stub(:new, mock_stub) do
        Google::Cloud::Bigtable::Admin::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          err = assert_raises Google::Gax::GaxError, CustomTestError_v2 do
            client.update_cluster(serve_nodes)
          end
    ...
    it 'invokes get_app_profile without error' do
      ...
      Google::Bigtable::Admin::V2::BigtableInstanceAdmin::Stub.stub(:new, mock_stub) do
        Google::Cloud::Bigtable::Admin::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method with block
          client.get_app_profile(formatted_name) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
            refute_nil(operation)
          end
    ...
    it 'invokes delete_app_profile without error' do
      ...
      Google::Bigtable::Admin::V2::BigtableInstanceAdmin::Stub.stub(:new, mock_stub) do
        Google::Cloud::Bigtable::Admin::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          response = client.delete_app_profile(formatted_name)

          # Verify the response
          assert_nil(response)

          # Call method with block
          client.delete_app_profile(formatted_name) do |response, operation|
            # Verify the response
            assert_nil(response)
            refute_nil(operation)
          end
    ...
    it 'invokes delete_app_profile with error' do
      ...
      Google::Bigtable::Admin::V2::BigtableInstanceAdmin::Stub.stub(:new, mock_stub) do
        Google::Cloud::Bigtable::Admin::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          err = assert_raises Google::Gax::GaxError, CustomTestError_v2 do
            client.delete_app_profile(formatted_name)
          end
