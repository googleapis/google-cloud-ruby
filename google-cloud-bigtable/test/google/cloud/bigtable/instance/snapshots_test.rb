...
describe Google::Cloud::Bigtable::Instance, :snapshots, :mock_bigtable do
  ...
  it "list snapshots" do
    ...
    mock.expect :list_snapshots, get_res, [cluster_path(instance_id, all_cluster_id), page_size: nil]
  ...
  it "paginates tables with all" do
    ...
    snapshots = instance.snapshots.all.to_a
  ...
  it "iterates tables with all using Enumerator" do
    ...
    snapshots = instance.snapshots.all.take(5)
