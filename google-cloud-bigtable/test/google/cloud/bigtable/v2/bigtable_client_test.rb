...
class MockCredentialsClass < Google::Cloud::Bigtable::Credentials
...
describe Google::Cloud::Bigtable::V2::BigtableClient do
  ...
  describe 'read_rows' do
    ...
    it 'invokes read_rows without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("read_rows")
  ...
  describe 'sample_row_keys' do
    ...
    it 'invokes sample_row_keys without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("sample_row_keys")
  ...
  describe 'mutate_row' do
    ...
    it 'invokes mutate_row without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("mutate_row")
  ...
  describe 'mutate_rows' do
    ...
    it 'invokes mutate_rows without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("mutate_rows")
  ...
  describe 'check_and_mutate_row' do
    ...
    it 'invokes check_and_mutate_row without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("check_and_mutate_row")
  ...
  describe 'read_modify_write_row' do
    ...
    it 'invokes read_modify_write_row without error' do
      ...
      # Mock auth layer
      mock_credentials = MockCredentialsClass.new("read_modify_write_row")
