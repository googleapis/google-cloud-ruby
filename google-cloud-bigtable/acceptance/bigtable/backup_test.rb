...
describe Google::Cloud::Bigtable::Table, :bigtable do
  ...
  let(:instance_3) { bigtable_2_instance }
  let(:cluster) { instance.clusters.first }
  let(:cluster_2) { instance_3.clusters.first }
  ...
  it "creates a copy of the backup using backup class" do
    ...
    begin
      ...
      job = bigtable.copy_backup dest_project_id: bigtable_2.project_id,
                                 dest_instance_id: instance_3.instance_id,
                                 dest_cluster_id: cluster.cluster_id,
