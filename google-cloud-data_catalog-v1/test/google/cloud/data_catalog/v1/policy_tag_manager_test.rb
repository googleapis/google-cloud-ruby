...
class ::Google::Cloud::DataCatalog::V1::PolicyTagManager::ClientTest < Minitest::Test
  ...
  def test_create_taxonomy
    ...
    Gapic::ServiceStub.stub :new, create_taxonomy_client_stub do
      # Create client
      c = ::Google::Cloud::DataCatalog::V1::PolicyTagManager::Client.new do |config|
      ...
      # Use protobuf object
      c.create_taxonomy ::Google::Cloud::DataCatalog::V1::CreateTaxonomyRequest.new(parent: parent, taxonomy: taxonomy) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.create_taxonomy(::Google::Cloud::DataCatalog::V1::CreateTaxonomyRequest.new(parent: parent, taxonomy: taxonomy), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_taxonomy
    ...
    Gapic::ServiceStub.stub :new, delete_taxonomy_client_stub do
      ...
      # Use protobuf object
      c.delete_taxonomy ::Google::Cloud::DataCatalog::V1::DeleteTaxonomyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_taxonomy(::Google::Cloud::DataCatalog::V1::DeleteTaxonomyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_taxonomy
    ...
    Gapic::ServiceStub.stub :new, update_taxonomy_client_stub do
      ...
      # Use protobuf object
      c.update_taxonomy ::Google::Cloud::DataCatalog::V1::UpdateTaxonomyRequest.new(taxonomy: taxonomy, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_taxonomy(::Google::Cloud::DataCatalog::V1::UpdateTaxonomyRequest.new(taxonomy: taxonomy, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_taxonomies
    ...
    Gapic::ServiceStub.stub :new, list_taxonomies_client_stub do
      ...
      # Use protobuf object
      c.list_taxonomies ::Google::Cloud::DataCatalog::V1::ListTaxonomiesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_taxonomies(::Google::Cloud::DataCatalog::V1::ListTaxonomiesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_taxonomy
    ...
    Gapic::ServiceStub.stub :new, get_taxonomy_client_stub do
      ...
      # Use protobuf object
      c.get_taxonomy ::Google::Cloud::DataCatalog::V1::GetTaxonomyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_taxonomy(::Google::Cloud::DataCatalog::V1::GetTaxonomyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_policy_tag
    ...
    Gapic::ServiceStub.stub :new, create_policy_tag_client_stub do
      ...
      # Use protobuf object
      c.create_policy_tag ::Google::Cloud::DataCatalog::V1::CreatePolicyTagRequest.new(parent: parent, policy_tag: policy_tag) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_policy_tag(::Google::Cloud::DataCatalog::V1::CreatePolicyTagRequest.new(parent: parent, policy_tag: policy_tag), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_policy_tag
    ...
    Gapic::ServiceStub.stub :new, delete_policy_tag_client_stub do
      ...
      # Use protobuf object
      c.delete_policy_tag ::Google::Cloud::DataCatalog::V1::DeletePolicyTagRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_policy_tag(::Google::Cloud::DataCatalog::V1::DeletePolicyTagRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_policy_tag
    ...
    Gapic::ServiceStub.stub :new, update_policy_tag_client_stub do
      ...
      # Use protobuf object
      c.update_policy_tag ::Google::Cloud::DataCatalog::V1::UpdatePolicyTagRequest.new(policy_tag: policy_tag, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_policy_tag(::Google::Cloud::DataCatalog::V1::UpdatePolicyTagRequest.new(policy_tag: policy_tag, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_policy_tags
    ...
    Gapic::ServiceStub.stub :new, list_policy_tags_client_stub do
      ...
      # Use protobuf object
      c.list_policy_tags ::Google::Cloud::DataCatalog::V1::ListPolicyTagsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_policy_tags(::Google::Cloud::DataCatalog::V1::ListPolicyTagsRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_policy_tag
    ...
    Gapic::ServiceStub.stub :new, get_policy_tag_client_stub do
      ...
      # Use protobuf object
      c.get_policy_tag ::Google::Cloud::DataCatalog::V1::GetPolicyTagRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_policy_tag(::Google::Cloud::DataCatalog::V1::GetPolicyTagRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
