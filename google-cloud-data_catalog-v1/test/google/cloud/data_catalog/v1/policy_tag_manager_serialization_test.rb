...
class ::Google::Cloud::DataCatalog::V1::PolicyTagManagerSerialization::ClientTest < Minitest::Test
  ...
  def test_replace_taxonomy
    ...
    Gapic::ServiceStub.stub :new, replace_taxonomy_client_stub do
      # Create client
      c = ::Google::Cloud::DataCatalog::V1::PolicyTagManagerSerialization::Client.new do |config|
        config.credentials = grpc_channel
      end

      # Use hash object
      c.replace_taxonomy({ name: name, serialized_taxonomy: serialized_taxonomy }) do |response, operation|
      ...
      # Use protobuf object
      c.replace_taxonomy ::Google::Cloud::DataCatalog::V1::ReplaceTaxonomyRequest.new(name: name, serialized_taxonomy: serialized_taxonomy) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.replace_taxonomy({ name: name, serialized_taxonomy: serialized_taxonomy }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.replace_taxonomy(::Google::Cloud::DataCatalog::V1::ReplaceTaxonomyRequest.new(name: name, serialized_taxonomy: serialized_taxonomy), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_taxonomies
    ...
    Gapic::ServiceStub.stub :new, import_taxonomies_client_stub do
      ...
      # Use protobuf object
      c.import_taxonomies ::Google::Cloud::DataCatalog::V1::ImportTaxonomiesRequest.new(parent: parent, inline_source: inline_source) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.import_taxonomies(::Google::Cloud::DataCatalog::V1::ImportTaxonomiesRequest.new(parent: parent, inline_source: inline_source), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_taxonomies
    ...
    Gapic::ServiceStub.stub :new, export_taxonomies_client_stub do
      ...
      # Use protobuf object
      c.export_taxonomies ::Google::Cloud::DataCatalog::V1::ExportTaxonomiesRequest.new(parent: parent, taxonomies: taxonomies, serialized_taxonomies: serialized_taxonomies) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.export_taxonomies(::Google::Cloud::DataCatalog::V1::ExportTaxonomiesRequest.new(parent: parent, taxonomies: taxonomies, serialized_taxonomies: serialized_taxonomies), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
