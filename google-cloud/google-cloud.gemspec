...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "google-cloud-bigquery", "~> 0.20.0"
  gem.add_dependency "google-cloud-datastore", "~> 0.20.0"
  gem.add_dependency "google-cloud-dns", "~> 0.20.0"
  gem.add_dependency "google-cloud-language", "~> 0.20.0"
  gem.add_dependency "google-cloud-logging", "~> 0.20.0"
  gem.add_dependency "google-cloud-pubsub", "~> 0.20.0"
  gem.add_dependency "google-cloud-resource_manager", "~> 0.20.0"
  gem.add_dependency "google-cloud-speech", "~> 0.20.0"
  ...
  gem.add_dependency "google-cloud-error_reporting", "~> 0.20.0"
