...
describe Stackdriver do
  it "requires google-cloud-error_reporting" do
    _(defined?(Google::Cloud::ErrorReporting)).wont_be_nil
  end

  it "requires google-cloud-logging" do
    _(defined?(Google::Cloud::Logging)).wont_be_nil
  end

  it "requires google-cloud-error_reporting rails module" do
    _(defined?(Google::Cloud::ErrorReporting::Railtie)).wont_be_nil
  end

  it "requires google-cloud-logging rails module" do
    _(defined?(Google::Cloud::Logging::Railtie)).wont_be_nil
  end

  it "requires google-cloud-trace rails module" do
    _(defined?(Google::Cloud::Trace::Railtie)).wont_be_nil
  end
end
