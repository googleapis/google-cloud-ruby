...
class ::Google::Shopping::Merchant::Lfp::V1beta::LfpMerchantStateService::ClientTest < Minitest::Test
  ...
  def test_get_lfp_merchant_state
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Lfp::V1beta::LfpMerchantState.new
    ...
    get_lfp_merchant_state_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Lfp::V1beta::GetLfpMerchantStateRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Lfp::V1beta::LfpMerchantStateService::Client::Configuration, config
  end
end
