...
class ::Google::Shopping::Merchant::Lfp::V1beta::LfpStoreService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_lfp_store
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Lfp::V1beta::LfpStore.new
    ...
    get_lfp_store_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Merchant::Lfp::V1beta::LfpStoreService::Rest::ServiceStub.stub :transcode_get_lfp_store_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_lfp_store_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_lfp_store_client_stub.call_count
      end
    end
  end
  ...
  def test_insert_lfp_store
    ...
    insert_lfp_store_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Lfp::V1beta::LfpStoreService::Rest::ServiceStub.stub :transcode_insert_lfp_store_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, insert_lfp_store_client_stub do
        ...
        # Verify method calls
        assert_equal 5, insert_lfp_store_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_lfp_store
    ...
    delete_lfp_store_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Lfp::V1beta::LfpStoreService::Rest::ServiceStub.stub :transcode_delete_lfp_store_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_lfp_store_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_lfp_store_client_stub.call_count
      end
    end
  end
  ...
  def test_list_lfp_stores
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Lfp::V1beta::ListLfpStoresResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_lfp_stores_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Lfp::V1beta::LfpStoreService::Rest::ServiceStub.stub :transcode_list_lfp_stores_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_lfp_stores_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_lfp_stores_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Lfp::V1beta::LfpStoreService::Rest::Client::Configuration, config
  end
end
