# Ruby Client for the Notebooks V1BETA1 API
...
specific version of the Notebooks V1BETA1 API. Most users should consider using
the main client gem,
...
request = ::Google::Cloud::Notebooks::V1beta1::ListInstancesRequest.new # (request fields as keyword arguments...)
response = client.list_instances request
```

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-notebooks-v1beta1/latest)
