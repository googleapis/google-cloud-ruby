...
require "google/cloud/network_connectivity/v1beta/policy_based_routing_service/rest/service_stub"
    ...
    module NetworkConnectivity
      module V1beta
        module PolicyBasedRoutingService
          module Rest
            ##
            # REST client for the PolicyBasedRoutingService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoutingService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all PolicyBasedRoutingService clients
              #   ::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoutingService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new PolicyBasedRoutingService REST client object.
              #
              # @example
              #
              ...
              #   client = ::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoutingService::Rest::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoutingService::Rest::Operations.new do |config|
                ...
                @policy_based_routing_service_stub = ::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoutingService::Rest::ServiceStub.new(
                ...
                @policy_based_routing_service_stub.logger(stub: true)&.info do |entry|
              ...
              #
              # @return [::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoutingService::Rest::Operations]
              #
              ...
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoute>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoute>]
              #
              ...
              def list_policy_based_routes request, options = nil
                ...
                call_metadata = @config.rpcs.list_policy_based_routes.metadata.to_h
                ...
                @policy_based_routing_service_stub.list_policy_based_routes request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @policy_based_routing_service_stub, :list_policy_based_routes, "policy_based_routes", request, result, options
              ...
              def get_policy_based_route request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_policy_based_route.metadata.to_h
                ...
                @policy_based_routing_service_stub.get_policy_based_route request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def create_policy_based_route request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_policy_based_route.metadata.to_h
                ...
                @policy_based_routing_service_stub.create_policy_based_route request, options do |result, operation|
              ...
              def delete_policy_based_route request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_policy_based_route.metadata.to_h
                ...
                @policy_based_routing_service_stub.delete_policy_based_route request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              ##
              # Configuration class for the PolicyBasedRoutingService REST API.
              #
              # This class represents the configuration for PolicyBasedRoutingService REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::NetworkConnectivity::V1beta::PolicyBasedRoutingService::Rest::Client::Configuration::Rpcs}
