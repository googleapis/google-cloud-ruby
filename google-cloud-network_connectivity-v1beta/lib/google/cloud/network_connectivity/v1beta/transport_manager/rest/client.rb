...
require "google/cloud/network_connectivity/v1beta/transport_manager/rest/service_stub"
    ...
    module NetworkConnectivity
      module V1beta
        module TransportManager
          module Rest
            ##
            # REST client for the TransportManager service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all TransportManager clients
              #   ::Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new TransportManager REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Rest::Operations.new do |config|
                ...
                @transport_manager_stub = ::Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Rest::ServiceStub.new(
                ...
                @transport_manager_stub.logger(stub: true)&.info do |entry|
              ...
              #
              # @return [::Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Rest::Operations]
              #
              ...
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::RemoteTransportProfile>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::RemoteTransportProfile>]
              #
              ...
              def list_remote_transport_profiles request, options = nil
                ...
                call_metadata = @config.rpcs.list_remote_transport_profiles.metadata.to_h
                ...
                @transport_manager_stub.list_remote_transport_profiles request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @transport_manager_stub, :list_remote_transport_profiles, "remote_transport_profiles", request, result, options
              ...
              def get_remote_transport_profile request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_remote_transport_profile.metadata.to_h
                ...
                @transport_manager_stub.get_remote_transport_profile request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def parse_from_activation_key request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.parse_from_activation_key.metadata.to_h
                ...
                @transport_manager_stub.parse_from_activation_key request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #     Optional. Hint for how to order the results.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Transport>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Transport>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_transports request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_transports.metadata.to_h
                ...
                @transport_manager_stub.list_transports request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @transport_manager_stub, :list_transports, "transports", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def get_transport request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_transport.metadata.to_h
                ...
                @transport_manager_stub.get_transport request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_status request, options = nil
                ...
                @transport_manager_stub.get_status request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def create_transport request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_transport.metadata.to_h
                ...
                @transport_manager_stub.create_transport request, options do |result, operation|
              ...
              def update_transport request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.update_transport.metadata.to_h
                ...
                @transport_manager_stub.update_transport request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def delete_transport request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_transport.metadata.to_h
                ...
                @transport_manager_stub.delete_transport request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              ##
              # Configuration class for the TransportManager REST API.
              #
              # This class represents the configuration for TransportManager REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::NetworkConnectivity::V1beta::TransportManager::Rest::Client::Configuration::Rpcs}
