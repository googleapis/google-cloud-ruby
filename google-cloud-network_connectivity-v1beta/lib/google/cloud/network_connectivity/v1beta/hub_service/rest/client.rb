...
require "google/cloud/network_connectivity/v1beta/hub_service/rest/service_stub"
    ...
    module NetworkConnectivity
      module V1beta
        module HubService
          module Rest
            ##
            # REST client for the HubService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::NetworkConnectivity::V1beta::HubService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all HubService clients
              #   ::Google::Cloud::NetworkConnectivity::V1beta::HubService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new HubService REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::NetworkConnectivity::V1beta::HubService::Rest::Operations.new do |config|
                ...
                @hub_service_stub = ::Google::Cloud::NetworkConnectivity::V1beta::HubService::Rest::ServiceStub.new(
                ...
                @hub_service_stub.logger(stub: true)&.info do |entry|
              ...
              #
              # @return [::Google::Cloud::NetworkConnectivity::V1beta::HubService::Rest::Operations]
              #
              ...
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Hub>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Hub>]
              #
              ...
              def list_hubs request, options = nil
                ...
                call_metadata = @config.rpcs.list_hubs.metadata.to_h
                ...
                @hub_service_stub.list_hubs request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :list_hubs, "hubs", request, result, options
              ...
              def get_hub request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_hub.metadata.to_h
                ...
                @hub_service_stub.get_hub request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def create_hub request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_hub.metadata.to_h
                ...
                @hub_service_stub.create_hub request, options do |result, operation|
              ...
              def update_hub request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.update_hub.metadata.to_h
                ...
                @hub_service_stub.update_hub request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def delete_hub request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_hub.metadata.to_h
                ...
                @hub_service_stub.delete_hub request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              #     response.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Spoke>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Spoke>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_hub_spokes request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_hub_spokes.metadata.to_h
                ...
                @hub_service_stub.list_hub_spokes request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :list_hub_spokes, "spokes", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              #       * `psc_propagation_status.code`
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::HubStatusEntry>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::HubStatusEntry>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def query_hub_status request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.query_hub_status.metadata.to_h
                ...
                @hub_service_stub.query_hub_status request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :query_hub_status, "hub_status_entries", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def list_spokes request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_spokes.metadata.to_h
                ...
                @hub_service_stub.list_spokes request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :list_spokes, "spokes", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def get_spoke request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_spoke.metadata.to_h
                ...
                @hub_service_stub.get_spoke request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def create_spoke request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_spoke.metadata.to_h
                ...
                @hub_service_stub.create_spoke request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def update_spoke request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.update_spoke.metadata.to_h
                ...
                @hub_service_stub.update_spoke request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def reject_hub_spoke request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.reject_hub_spoke.metadata.to_h
                ...
                @hub_service_stub.reject_hub_spoke request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def accept_hub_spoke request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.accept_hub_spoke.metadata.to_h
                ...
                @hub_service_stub.accept_hub_spoke request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def accept_spoke_update request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.accept_spoke_update.metadata.to_h
                ...
                @hub_service_stub.accept_spoke_update request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def reject_spoke_update request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.reject_spoke_update.metadata.to_h
                ...
                @hub_service_stub.reject_spoke_update request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def delete_spoke request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_spoke.metadata.to_h
                ...
                @hub_service_stub.delete_spoke request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def get_route_table request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_route_table.metadata.to_h
                ...
                @hub_service_stub.get_route_table request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_route request, options = nil
                ...
                @hub_service_stub.get_route request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #     Sort the results by a certain order.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Route>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Route>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_routes request, options = nil
                ...
                @hub_service_stub.list_routes request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :list_routes, "routes", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              #     Sort the results by a certain order.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::RouteTable>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::RouteTable>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_route_tables request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_route_tables.metadata.to_h
                ...
                @hub_service_stub.list_route_tables request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :list_route_tables, "route_tables", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def get_group request, options = nil
                ...
                @hub_service_stub.get_group request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #     Sort the results by a certain order.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Group>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Group>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_groups request, options = nil
                ...
                @hub_service_stub.list_groups request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :list_groups, "groups", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def update_group request, options = nil
                ...
                @hub_service_stub.update_group request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def create_gateway_advertised_route request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_gateway_advertised_route.metadata.to_h
                ...
                @hub_service_stub.create_gateway_advertised_route request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def get_gateway_advertised_route request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_gateway_advertised_route.metadata.to_h
                ...
                @hub_service_stub.get_gateway_advertised_route request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #     Sort the results by a certain order.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::GatewayAdvertisedRoute>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::GatewayAdvertisedRoute>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_gateway_advertised_routes request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_gateway_advertised_routes.metadata.to_h
                ...
                @hub_service_stub.list_gateway_advertised_routes request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @hub_service_stub, :list_gateway_advertised_routes, "gateway_advertised_routes", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def update_gateway_advertised_route request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.update_gateway_advertised_route.metadata.to_h
                ...
                @hub_service_stub.update_gateway_advertised_route request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def delete_gateway_advertised_route request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_gateway_advertised_route.metadata.to_h
                ...
                @hub_service_stub.delete_gateway_advertised_route request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              ##
              # Configuration class for the HubService REST API.
              #
              # This class represents the configuration for HubService REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::NetworkConnectivity::V1beta::HubService::Rest::Client::Configuration::Rpcs}
