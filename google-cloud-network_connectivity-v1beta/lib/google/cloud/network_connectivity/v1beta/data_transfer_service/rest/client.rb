...
require "google/cloud/network_connectivity/v1beta/data_transfer_service/rest/service_stub"
        ...
        module DataTransferService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all DataTransferService clients
              #   ::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Rest::Operations.new do |config|
                ...
                @data_transfer_service_stub = ::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Rest::ServiceStub.new(
              ...
              #
              # @return [::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Rest::Operations]
              #
              ...
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::MulticloudDataTransferConfig>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::MulticloudDataTransferConfig>]
              #
              ...
              def list_multicloud_data_transfer_configs request, options = nil
                ...
                call_metadata = @config.rpcs.list_multicloud_data_transfer_configs.metadata.to_h
                ...
                @data_transfer_service_stub.list_multicloud_data_transfer_configs request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @data_transfer_service_stub, :list_multicloud_data_transfer_configs, "multicloud_data_transfer_configs", request, result, options
              ...
              def get_multicloud_data_transfer_config request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_multicloud_data_transfer_config.metadata.to_h
                ...
                @data_transfer_service_stub.get_multicloud_data_transfer_config request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def create_multicloud_data_transfer_config request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_multicloud_data_transfer_config.metadata.to_h
                ...
                @data_transfer_service_stub.create_multicloud_data_transfer_config request, options do |result, operation|
              ...
              def update_multicloud_data_transfer_config request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.update_multicloud_data_transfer_config.metadata.to_h
                ...
                @data_transfer_service_stub.update_multicloud_data_transfer_config request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def delete_multicloud_data_transfer_config request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_multicloud_data_transfer_config.metadata.to_h
                ...
                @data_transfer_service_stub.delete_multicloud_data_transfer_config request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              #     list requests.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Destination>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::Destination>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_destinations request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_destinations.metadata.to_h
                ...
                @data_transfer_service_stub.list_destinations request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @data_transfer_service_stub, :list_destinations, "destinations", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def get_destination request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_destination.metadata.to_h
                ...
                @data_transfer_service_stub.get_destination request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def create_destination request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_destination.metadata.to_h
                ...
                @data_transfer_service_stub.create_destination request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def update_destination request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.update_destination.metadata.to_h
                ...
                @data_transfer_service_stub.update_destination request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def delete_destination request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_destination.metadata.to_h
                ...
                @data_transfer_service_stub.delete_destination request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def get_multicloud_data_transfer_supported_service request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_multicloud_data_transfer_supported_service.metadata.to_h
                ...
                @data_transfer_service_stub.get_multicloud_data_transfer_supported_service request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #     Optional. The page token.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::MulticloudDataTransferSupportedService>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::NetworkConnectivity::V1beta::MulticloudDataTransferSupportedService>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_multicloud_data_transfer_supported_services request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_multicloud_data_transfer_supported_services.metadata.to_h
                ...
                @data_transfer_service_stub.list_multicloud_data_transfer_supported_services request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @data_transfer_service_stub, :list_multicloud_data_transfer_supported_services, "multicloud_data_transfer_supported_services", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              # {::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Rest::Client::Configuration::Rpcs}
