...
class ::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_multicloud_data_transfer_configs
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::NetworkConnectivity::V1beta::ListMulticloudDataTransferConfigsResponse.new
    ...
    list_multicloud_data_transfer_configs_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::ListMulticloudDataTransferConfigsRequest, request
  ...
  def test_get_multicloud_data_transfer_config
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::NetworkConnectivity::V1beta::MulticloudDataTransferConfig.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_multicloud_data_transfer_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::GetMulticloudDataTransferConfigRequest, request
  ...
  def test_create_multicloud_data_transfer_config
    ...
    create_multicloud_data_transfer_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::CreateMulticloudDataTransferConfigRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["multicloud_data_transfer_config_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::NetworkConnectivity::V1beta::MulticloudDataTransferConfig), request["multicloud_data_transfer_config"]
  ...
  def test_update_multicloud_data_transfer_config
    ...
    update_multicloud_data_transfer_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::UpdateMulticloudDataTransferConfigRequest, request
  ...
  def test_delete_multicloud_data_transfer_config
    ...
    delete_multicloud_data_transfer_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::DeleteMulticloudDataTransferConfigRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
  ...
  def test_list_destinations
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::NetworkConnectivity::V1beta::ListDestinationsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_destinations_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::ListDestinationsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
  ...
  def test_get_destination
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::NetworkConnectivity::V1beta::Destination.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_destination_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::GetDestinationRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_create_destination
    ...
    create_destination_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::CreateDestinationRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["destination_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::NetworkConnectivity::V1beta::Destination), request["destination"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end
  ...
  def test_update_destination
    ...
    update_destination_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::UpdateDestinationRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::NetworkConnectivity::V1beta::Destination), request["destination"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
  ...
  def test_delete_destination
    ...
    delete_destination_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::DeleteDestinationRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
      assert_equal "hello world", request["etag"]
      refute_nil options
  ...
  def test_get_multicloud_data_transfer_supported_service
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::NetworkConnectivity::V1beta::MulticloudDataTransferSupportedService.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_multicloud_data_transfer_supported_service_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::GetMulticloudDataTransferSupportedServiceRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_list_multicloud_data_transfer_supported_services
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::NetworkConnectivity::V1beta::ListMulticloudDataTransferSupportedServicesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_multicloud_data_transfer_supported_services_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::ListMulticloudDataTransferSupportedServicesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      refute_nil options
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Client, client
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::NetworkConnectivity::V1beta::DataTransferService::Operations, client.operations_client
  end
end
