# Ruby Client for the Cloud Composer API

API Client library for the Cloud Composer API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-orchestration-airflow-service/latest)
for this library, google-cloud-orchestration-airflow-service, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-orchestration-airflow-service-v1](https://googleapis.dev/ruby/google-cloud-orchestration-airflow-service-v1/latest).
...
```
$ gem install google-cloud-orchestration-airflow-service
```
...
is part of the name, e.g. `google-cloud-orchestration-airflow-service-v1`.
