...
Gem::Specification.new do |gem|
  ...
  gem.description   = "An API for setting attribute based access control to requests to GCP services. Note that google-identity-access_context_manager-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-identity-access_context_manager instead. See the readme for more details."
