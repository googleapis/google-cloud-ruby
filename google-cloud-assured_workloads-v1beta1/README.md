# Ruby Client for the Assured Workloads for Government V1beta1 API
...
specific version of the Assured Workloads for Government V1beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-assured_workloads-v1beta1
```
...
is part of the name, e.g. `google-cloud-assured_workloads-v1beta1`.
