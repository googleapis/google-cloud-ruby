  ...
  def test_analyze_sentiment
    ...
    ::Google::Cloud::Language::V2::LanguageService::Rest::ServiceStub.stub :transcode_analyze_sentiment_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, analyze_sentiment_client_stub do
        # Create client
        c = ::Google::Cloud::Language::V2::LanguageService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.analyze_sentiment ::Google::Cloud::Language::V2::AnalyzeSentimentRequest.new(document: document, encoding_type: encoding_type) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.analyze_sentiment(::Google::Cloud::Language::V2::AnalyzeSentimentRequest.new(document: document, encoding_type: encoding_type), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_analyze_entities
    ...
    ::Google::Cloud::Language::V2::LanguageService::Rest::ServiceStub.stub :transcode_analyze_entities_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, analyze_entities_client_stub do
        ...
        # Use protobuf object
        c.analyze_entities ::Google::Cloud::Language::V2::AnalyzeEntitiesRequest.new(document: document, encoding_type: encoding_type) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.analyze_entities(::Google::Cloud::Language::V2::AnalyzeEntitiesRequest.new(document: document, encoding_type: encoding_type), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_classify_text
    ...
    ::Google::Cloud::Language::V2::LanguageService::Rest::ServiceStub.stub :transcode_classify_text_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, classify_text_client_stub do
        ...
        # Use hash object
        c.classify_text({ document: document }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.classify_text ::Google::Cloud::Language::V2::ClassifyTextRequest.new(document: document) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.classify_text({ document: document }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.classify_text(::Google::Cloud::Language::V2::ClassifyTextRequest.new(document: document), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_moderate_text
    ...
    ::Google::Cloud::Language::V2::LanguageService::Rest::ServiceStub.stub :transcode_moderate_text_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, moderate_text_client_stub do
        ...
        # Use hash object
        c.moderate_text({ document: document, model_version: model_version }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.moderate_text ::Google::Cloud::Language::V2::ModerateTextRequest.new(document: document, model_version: model_version) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.moderate_text({ document: document, model_version: model_version }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.moderate_text(::Google::Cloud::Language::V2::ModerateTextRequest.new(document: document, model_version: model_version), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_annotate_text
    ...
    ::Google::Cloud::Language::V2::LanguageService::Rest::ServiceStub.stub :transcode_annotate_text_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, annotate_text_client_stub do
        ...
        # Use protobuf object
        c.annotate_text ::Google::Cloud::Language::V2::AnnotateTextRequest.new(document: document, features: features, encoding_type: encoding_type) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.annotate_text(::Google::Cloud::Language::V2::AnnotateTextRequest.new(document: document, features: features, encoding_type: encoding_type), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
