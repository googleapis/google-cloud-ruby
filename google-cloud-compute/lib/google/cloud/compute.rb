...
module Google
  module Cloud
    module Compute
      ...
      ##
      # Create a new client object for ProjectViews.
      #
      # By default, this returns an instance of
      # [Google::Cloud::Compute::V1::ProjectViews::Rest::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-compute-v1/latest/Google-Cloud-Compute-V1-ProjectViews-Rest-Client)
      # for a REST client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the ProjectViews service is
      # supported by that API version, and the corresponding gem is available, the
      # appropriate versioned client will be returned.
      #
      # Raises an exception if the currently installed versioned client gem for the
      # given API version does not support the ProjectViews service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::Compute.project_views_available?}.
      #
      # ## About ProjectViews
      #
      ...
      # @return [::Object] A client object for the specified version.
      #
      def self.project_views version: :v1, &block
        require "google/cloud/compute/#{version.to_s.downcase}"
        ...
        package_name = Google::Cloud::Compute
                       ...
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
                       .first
        service_module = Google::Cloud::Compute.const_get(package_name).const_get(:ProjectViews)
        service_module.const_get(:Rest).const_get(:Client).new(&block)
      end

      ##
      # Determines whether the ProjectViews service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::Compute.project_views}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the ProjectViews service,
      # or if the versioned client gem needs an update to support the ProjectViews service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1`.
      # @return [boolean] Whether the service is available.
      #
      def self.project_views_available? version: :v1
        require "google/cloud/compute/#{version.to_s.downcase}"
        package_name = Google::Cloud::Compute
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        return false unless package_name
        service_module = Google::Cloud::Compute.const_get package_name
        return false unless service_module.const_defined? :ProjectViews
        service_module = service_module.const_get :ProjectViews
        return false unless service_module.const_defined? :Rest
        service_module = service_module.const_get :Rest
        service_module.const_defined? :Client
      rescue ::LoadError
