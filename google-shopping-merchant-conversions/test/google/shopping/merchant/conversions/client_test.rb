...
class Google::Shopping::Merchant::Conversions::ClientConstructionMinitest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_conversion_sources_service_rest
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
      ...
      assert_kind_of Google::Shopping::Merchant::Conversions::V1beta::ConversionSourcesService::Rest::Client, client
    end
  end
end
