...
View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-conversions)
for this library, google-shopping-merchant-conversions, to see the convenience methods for
...
```
$ gem install google-shopping-merchant-conversions
```
