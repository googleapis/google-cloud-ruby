...
##
# Snippet for the get_gateway_route_view call in the NetworkServices service
#
...
# Google::Cloud::NetworkServices::V1::NetworkServices::Client#get_gateway_route_view.
#
