...
class ::Google::Cloud::NetworkServices::V1::DepService::Rest::ClientTest < Minitest::Test
  ...
  def test_list_authz_extensions
    ...
    list_authz_extensions_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkServices::V1::DepService::Rest::ServiceStub.stub :transcode_list_authz_extensions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_authz_extensions_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_authz_extensions_client_stub.call_count
      end
    end
  end
  ...
  def test_get_authz_extension
    # Create test objects.
    client_result = ::Google::Cloud::NetworkServices::V1::AuthzExtension.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_authz_extension_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkServices::V1::DepService::Rest::ServiceStub.stub :transcode_get_authz_extension_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_authz_extension_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_authz_extension_client_stub.call_count
      end
    end
  end
  ...
  def test_create_authz_extension
    ...
    create_authz_extension_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkServices::V1::DepService::Rest::ServiceStub.stub :transcode_create_authz_extension_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_authz_extension_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_authz_extension_client_stub.call_count
      end
    end
  end
  ...
  def test_update_authz_extension
    ...
    update_authz_extension_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkServices::V1::DepService::Rest::ServiceStub.stub :transcode_update_authz_extension_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_authz_extension_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_authz_extension_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_authz_extension
    ...
    delete_authz_extension_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkServices::V1::DepService::Rest::ServiceStub.stub :transcode_delete_authz_extension_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_authz_extension_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_authz_extension_client_stub.call_count
      end
    end
  end
