...
require File.expand_path("lib/google/cloud/merchant/issue_resolution/v1beta/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-merchant-issue_resolution-v1beta"
  gem.version       = Google::Cloud::Merchant::IssueResolution::V1beta::VERSION
