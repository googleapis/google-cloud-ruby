...
##
# Snippet for the import_user_events call in the UserEventService service
#
...
# Google::Cloud::RecommendationEngine::V1beta1::UserEventService::Client#import_user_events.
#
