...
class ::Google::Cloud::RecommendationEngine::V1beta1::PredictionApiKeyRegistry::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_prediction_api_key_registration
    # Create test objects.
    client_result = ::Google::Cloud::RecommendationEngine::V1beta1::PredictionApiKeyRegistration.new
    ...
    create_prediction_api_key_registration_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::PredictionApiKeyRegistry::Rest::ServiceStub.stub :transcode_create_prediction_api_key_registration_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_prediction_api_key_registration_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_prediction_api_key_registration_client_stub.call_count
      end
    end
  end
  ...
  def test_list_prediction_api_key_registrations
    # Create test objects.
    client_result = ::Google::Cloud::RecommendationEngine::V1beta1::ListPredictionApiKeyRegistrationsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_prediction_api_key_registrations_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::PredictionApiKeyRegistry::Rest::ServiceStub.stub :transcode_list_prediction_api_key_registrations_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_prediction_api_key_registrations_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_prediction_api_key_registrations_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_prediction_api_key_registration
    ...
    delete_prediction_api_key_registration_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::RecommendationEngine::V1beta1::PredictionApiKeyRegistry::Rest::ServiceStub.stub :transcode_delete_prediction_api_key_registration_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_prediction_api_key_registration_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_prediction_api_key_registration_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::RecommendationEngine::V1beta1::PredictionApiKeyRegistry::Rest::Client::Configuration, config
  end
end
