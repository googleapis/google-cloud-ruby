...
class ::Google::Cloud::RecommendationEngine::V1beta1::PredictionService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_predict
    # Create test objects.
    client_result = ::Google::Cloud::RecommendationEngine::V1beta1::PredictResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::RecommendationEngine::V1beta1::PredictionService::Rest::Client::Configuration, config
  end
end
