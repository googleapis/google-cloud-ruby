# Ruby Client for the Storage Control V2 API
...
specific version of the Storage Control V2 API. Most users should consider using
the main client gem,
[google-cloud-storage-control](https://rubygems.org/gems/google-cloud-storage-control).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-storage-control-v2
```
