...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Converts audio to text by applying powerful neural network models. Note that google-cloud-speech-v2 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-speech instead. See the readme for more details."
