...
v3_library = gapic.ruby_library(
    'translate', 'v1', artman_output_name='google-cloud-ruby/google-cloud-translate',
...
s.copy(v3_library / 'google-cloud-translate.gemspec', merge=ruby.merge_gemspec)
...
s.replace(
    [
        ...
        'lib/google/cloud/translate/v*.rb',
        'lib/google/cloud/translate/v*/*_client.rb'
    ],
...
s.replace(
    'lib/google/cloud/translate/*/*_client.rb',
...
s.replace(
    ...
    '\\1Google::Cloud::Translate::VERSION'
)
s.replace(
