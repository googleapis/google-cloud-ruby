...
require "google/cloud/dataqna/v1alpha/question_service/rest/service_stub"
    ...
    module DataQnA
      module V1alpha
        module QuestionService
          module Rest
            ##
            # REST client for the QuestionService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::DataQnA::V1alpha::QuestionService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all QuestionService clients
              #   ::Google::Cloud::DataQnA::V1alpha::QuestionService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new QuestionService REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @question_service_stub = ::Google::Cloud::DataQnA::V1alpha::QuestionService::Rest::ServiceStub.new(
                ...
                @question_service_stub.logger(stub: true)&.info do |entry|
              ...
              def get_question request, options = nil
                ...
                call_metadata = @config.rpcs.get_question.metadata.to_h
                ...
                @question_service_stub.get_question request, options do |result, operation|
              ...
              def create_question request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.create_question.metadata.to_h
                ...
                @question_service_stub.create_question request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def execute_question request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.execute_question.metadata.to_h
                ...
                @question_service_stub.execute_question request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_user_feedback request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.get_user_feedback.metadata.to_h
                ...
                @question_service_stub.get_user_feedback request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def update_user_feedback request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.update_user_feedback.metadata.to_h
                ...
                @question_service_stub.update_user_feedback request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the QuestionService REST API.
              #
              # This class represents the configuration for QuestionService REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::DataQnA::V1alpha::QuestionService::Rest::Client::Configuration::Rpcs}
