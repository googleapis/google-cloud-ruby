...
require "google/cloud/dataqna/v1alpha/auto_suggestion_service/rest/service_stub"
    ...
    module DataQnA
      module V1alpha
        module AutoSuggestionService
          module Rest
            ##
            # REST client for the AutoSuggestionService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::DataQnA::V1alpha::AutoSuggestionService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all AutoSuggestionService clients
              #   ::Google::Cloud::DataQnA::V1alpha::AutoSuggestionService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new AutoSuggestionService REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @auto_suggestion_service_stub = ::Google::Cloud::DataQnA::V1alpha::AutoSuggestionService::Rest::ServiceStub.new(
                ...
                @auto_suggestion_service_stub.logger(stub: true)&.info do |entry|
              ...
              def suggest_queries request, options = nil
                ...
                call_metadata = @config.rpcs.suggest_queries.metadata.to_h
                ...
                @auto_suggestion_service_stub.suggest_queries request, options do |result, operation|
              ...
              ##
              # Configuration class for the AutoSuggestionService REST API.
              #
              # This class represents the configuration for AutoSuggestionService REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::DataQnA::V1alpha::AutoSuggestionService::Rest::Client::Configuration::Rpcs}
