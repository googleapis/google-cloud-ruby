...
describe Google::Cloud::Logging, :logging do
  ...
  describe "Ruby Logger" do
    ...
    describe "Asynchronous" do
      it "writes to a log with add and a symbol" do
        logger = logging.async_logger "#{log_name}-symbol", resource, labels
      ...
      it "writes to a log with add and a string" do
        logger = logging.async_logger "#{log_name}-string", resource, labels
      ...
      it "writes to a log with add and a constant" do
        logger = logging.async_logger "#{log_name}-constant", resource, labels
      ...
      it "writes to a log with named functions" do
        logger = logging.async_logger "#{log_name}-method", resource, labels
