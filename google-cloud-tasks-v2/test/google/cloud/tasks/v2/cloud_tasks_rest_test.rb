...
class ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ClientTest < Minitest::Test
  ...
  def test_list_queues
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_list_queues_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_queues_client_stub do
        # Create client
        c = ::Google::Cloud::Tasks::V2::CloudTasks::Rest::Client.new do |config|
          config.credentials = :dummy_value
        end

        # Use hash object
        c.list_queues({ parent: parent, filter: filter, page_size: page_size, page_token: page_token }) do |_result, response|
        ...
        # Use protobuf object
        c.list_queues ::Google::Cloud::Tasks::V2::ListQueuesRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.list_queues({ parent: parent, filter: filter, page_size: page_size, page_token: page_token }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.list_queues(::Google::Cloud::Tasks::V2::ListQueuesRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_queue
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_get_queue_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_queue_client_stub do
        ...
        # Use hash object
        c.get_queue({ name: name }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.get_queue ::Google::Cloud::Tasks::V2::GetQueueRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.get_queue({ name: name }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.get_queue(::Google::Cloud::Tasks::V2::GetQueueRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_queue
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_create_queue_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_queue_client_stub do
        ...
        # Use protobuf object
        c.create_queue ::Google::Cloud::Tasks::V2::CreateQueueRequest.new(parent: parent, queue: queue) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.create_queue(::Google::Cloud::Tasks::V2::CreateQueueRequest.new(parent: parent, queue: queue), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_queue
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_update_queue_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_queue_client_stub do
        ...
        # Use protobuf object
        c.update_queue ::Google::Cloud::Tasks::V2::UpdateQueueRequest.new(queue: queue, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_queue(::Google::Cloud::Tasks::V2::UpdateQueueRequest.new(queue: queue, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_queue
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_delete_queue_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_queue_client_stub do
        ...
        # Use protobuf object
        c.delete_queue ::Google::Cloud::Tasks::V2::DeleteQueueRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_queue(::Google::Cloud::Tasks::V2::DeleteQueueRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_purge_queue
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_purge_queue_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, purge_queue_client_stub do
        ...
        # Use protobuf object
        c.purge_queue ::Google::Cloud::Tasks::V2::PurgeQueueRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.purge_queue(::Google::Cloud::Tasks::V2::PurgeQueueRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_pause_queue
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_pause_queue_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, pause_queue_client_stub do
        ...
        # Use protobuf object
        c.pause_queue ::Google::Cloud::Tasks::V2::PauseQueueRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.pause_queue(::Google::Cloud::Tasks::V2::PauseQueueRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_resume_queue
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_resume_queue_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, resume_queue_client_stub do
        ...
        # Use protobuf object
        c.resume_queue ::Google::Cloud::Tasks::V2::ResumeQueueRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.resume_queue(::Google::Cloud::Tasks::V2::ResumeQueueRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_tasks
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_list_tasks_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_tasks_client_stub do
        ...
        # Use protobuf object
        c.list_tasks ::Google::Cloud::Tasks::V2::ListTasksRequest.new(parent: parent, response_view: response_view, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_tasks(::Google::Cloud::Tasks::V2::ListTasksRequest.new(parent: parent, response_view: response_view, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_task
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_get_task_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_task_client_stub do
        ...
        # Use protobuf object
        c.get_task ::Google::Cloud::Tasks::V2::GetTaskRequest.new(name: name, response_view: response_view) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_task(::Google::Cloud::Tasks::V2::GetTaskRequest.new(name: name, response_view: response_view), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_task
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_create_task_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_task_client_stub do
        ...
        # Use protobuf object
        c.create_task ::Google::Cloud::Tasks::V2::CreateTaskRequest.new(parent: parent, task: task, response_view: response_view) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.create_task(::Google::Cloud::Tasks::V2::CreateTaskRequest.new(parent: parent, task: task, response_view: response_view), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_batch_create_tasks
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_batch_create_tasks_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_create_tasks_client_stub do
        ...
        # Use protobuf object
        c.batch_create_tasks ::Google::Cloud::Tasks::V2::BatchCreateTasksRequest.new(parent: parent, requests: requests, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.batch_create_tasks(::Google::Cloud::Tasks::V2::BatchCreateTasksRequest.new(parent: parent, requests: requests, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_task
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_delete_task_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_task_client_stub do
        ...
        # Use protobuf object
        c.delete_task ::Google::Cloud::Tasks::V2::DeleteTaskRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_task(::Google::Cloud::Tasks::V2::DeleteTaskRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_batch_delete_tasks
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_batch_delete_tasks_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_delete_tasks_client_stub do
        ...
        # Use protobuf object
        c.batch_delete_tasks ::Google::Cloud::Tasks::V2::BatchDeleteTasksRequest.new(parent: parent, names: names, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.batch_delete_tasks(::Google::Cloud::Tasks::V2::BatchDeleteTasksRequest.new(parent: parent, names: names, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_run_task
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_run_task_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, run_task_client_stub do
        ...
        # Use protobuf object
        c.run_task ::Google::Cloud::Tasks::V2::RunTaskRequest.new(name: name, response_view: response_view) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.run_task(::Google::Cloud::Tasks::V2::RunTaskRequest.new(name: name, response_view: response_view), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_cmek_config
    # Create test objects.
    client_result = ::Google::Cloud::Tasks::V2::CmekConfig.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_update_cmek_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_cmek_config_client_stub do
        ...
        # Use protobuf object
        c.update_cmek_config ::Google::Cloud::Tasks::V2::UpdateCmekConfigRequest.new(cmek_config: cmek_config, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_cmek_config(::Google::Cloud::Tasks::V2::UpdateCmekConfigRequest.new(cmek_config: cmek_config, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_cmek_config
    ...
    ::Google::Cloud::Tasks::V2::CloudTasks::Rest::ServiceStub.stub :transcode_get_cmek_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_cmek_config_client_stub do
        ...
        # Use protobuf object
        c.get_cmek_config ::Google::Cloud::Tasks::V2::GetCmekConfigRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_cmek_config(::Google::Cloud::Tasks::V2::GetCmekConfigRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
