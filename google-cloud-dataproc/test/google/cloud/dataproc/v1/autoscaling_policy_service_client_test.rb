...
class MockAutoscalingPolicyServiceCredentials_v1 < Google::Cloud::Dataproc::V1::Credentials
...
describe Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient do

  describe 'create_autoscaling_policy' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient#create_autoscaling_policy."
    ...
    it 'invokes create_autoscaling_policy without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dataproc::V1::AutoscalingPolicy)
      ...
      # Mock auth layer
      mock_credentials = MockAutoscalingPolicyServiceCredentials_v1.new("create_autoscaling_policy")

      Google::Cloud::Dataproc::V1::AutoscalingPolicyService::Stub.stub(:new, mock_stub) do
  ...
  describe 'update_autoscaling_policy' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient#update_autoscaling_policy."
    ...
    it 'invokes update_autoscaling_policy without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dataproc::V1::UpdateAutoscalingPolicyRequest, request)
        assert_equal(Google::Gax::to_proto(policy, Google::Cloud::Dataproc::V1::AutoscalingPolicy), request.policy)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v1.new(:update_autoscaling_policy, mock_method)

      # Mock auth layer
      mock_credentials = MockAutoscalingPolicyServiceCredentials_v1.new("update_autoscaling_policy")
  ...
  describe 'get_autoscaling_policy' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient#get_autoscaling_policy."
    ...
    it 'invokes get_autoscaling_policy without error' do
      ...
      # Mock auth layer
      mock_credentials = MockAutoscalingPolicyServiceCredentials_v1.new("get_autoscaling_policy")
  ...
  describe 'list_autoscaling_policies' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient#list_autoscaling_policies."
    ...
    it 'invokes list_autoscaling_policies without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dataproc::V1::ListAutoscalingPoliciesResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dataproc::V1::ListAutoscalingPoliciesRequest, request)
        assert_equal(formatted_parent, request.parent)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v1.new(:list_autoscaling_policies, mock_method)

      # Mock auth layer
      mock_credentials = MockAutoscalingPolicyServiceCredentials_v1.new("list_autoscaling_policies")
  ...
  describe 'delete_autoscaling_policy' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient#delete_autoscaling_policy."
    ...
    it 'invokes delete_autoscaling_policy without error' do
      ...
      # Mock auth layer
      mock_credentials = MockAutoscalingPolicyServiceCredentials_v1.new("delete_autoscaling_policy")
