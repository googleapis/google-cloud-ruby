...
class MockWorkflowTemplateServiceCredentials_v1beta2 < Google::Cloud::Dataproc::V1beta2::Credentials
...
describe Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient do

  describe 'create_workflow_template' do
    custom_error = CustomTestError_v1beta2.new "Custom test error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#create_workflow_template."
    ...
    it 'invokes create_workflow_template without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dataproc::V1beta2::WorkflowTemplate)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dataproc::V1beta2::CreateWorkflowTemplateRequest, request)
        assert_equal(formatted_parent, request.parent)
        assert_equal(Google::Gax::to_proto(template, Google::Cloud::Dataproc::V1beta2::WorkflowTemplate), request.template)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v1beta2.new(:create_workflow_template, mock_method)

      # Mock auth layer
      mock_credentials = MockWorkflowTemplateServiceCredentials_v1beta2.new("create_workflow_template")

      Google::Cloud::Dataproc::V1beta2::WorkflowTemplateService::Stub.stub(:new, mock_stub) do
  ...
  describe 'get_workflow_template' do
    custom_error = CustomTestError_v1beta2.new "Custom test error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#get_workflow_template."
    ...
    it 'invokes get_workflow_template without error' do
      ...
      # Mock auth layer
      mock_credentials = MockWorkflowTemplateServiceCredentials_v1beta2.new("get_workflow_template")
  ...
  describe 'instantiate_workflow_template' do
    custom_error = CustomTestError_v1beta2.new "Custom test error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#instantiate_workflow_template."
    ...
    it 'invokes instantiate_workflow_template without error' do
      ...
      # Mock auth layer
      mock_credentials = MockWorkflowTemplateServiceCredentials_v1beta2.new("instantiate_workflow_template")
    ...
    it 'invokes instantiate_workflow_template and returns an operation error.' do
      ...
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#instantiate_workflow_template.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/instantiate_workflow_template_test',
        done: true,
  ...
  describe 'instantiate_inline_workflow_template' do
    custom_error = CustomTestError_v1beta2.new "Custom test error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#instantiate_inline_workflow_template."
    ...
    it 'invokes instantiate_inline_workflow_template without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dataproc::V1beta2::InstantiateInlineWorkflowTemplateRequest, request)
        assert_equal(formatted_parent, request.parent)
        assert_equal(Google::Gax::to_proto(template, Google::Cloud::Dataproc::V1beta2::WorkflowTemplate), request.template)
        OpenStruct.new(execute: operation)
      end
      mock_stub = MockGrpcClientStub_v1beta2.new(:instantiate_inline_workflow_template, mock_method)

      # Mock auth layer
      mock_credentials = MockWorkflowTemplateServiceCredentials_v1beta2.new("instantiate_inline_workflow_template")
    ...
    it 'invokes instantiate_inline_workflow_template and returns an operation error.' do
      ...
      # Create expected grpc response
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#instantiate_inline_workflow_template.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/instantiate_inline_workflow_template_test',
        done: true,
  ...
  describe 'update_workflow_template' do
    custom_error = CustomTestError_v1beta2.new "Custom test error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#update_workflow_template."
    ...
    it 'invokes update_workflow_template without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dataproc::V1beta2::UpdateWorkflowTemplateRequest, request)
        assert_equal(Google::Gax::to_proto(template, Google::Cloud::Dataproc::V1beta2::WorkflowTemplate), request.template)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v1beta2.new(:update_workflow_template, mock_method)

      # Mock auth layer
      mock_credentials = MockWorkflowTemplateServiceCredentials_v1beta2.new("update_workflow_template")
  ...
  describe 'list_workflow_templates' do
    custom_error = CustomTestError_v1beta2.new "Custom test error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#list_workflow_templates."
    ...
    it 'invokes list_workflow_templates without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dataproc::V1beta2::ListWorkflowTemplatesResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dataproc::V1beta2::ListWorkflowTemplatesRequest, request)
        assert_equal(formatted_parent, request.parent)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v1beta2.new(:list_workflow_templates, mock_method)

      # Mock auth layer
      mock_credentials = MockWorkflowTemplateServiceCredentials_v1beta2.new("list_workflow_templates")
  ...
  describe 'delete_workflow_template' do
    custom_error = CustomTestError_v1beta2.new "Custom test error for Google::Cloud::Dataproc::V1beta2::WorkflowTemplateServiceClient#delete_workflow_template."
    ...
    it 'invokes delete_workflow_template without error' do
      ...
      # Mock auth layer
      mock_credentials = MockWorkflowTemplateServiceCredentials_v1beta2.new("delete_workflow_template")
