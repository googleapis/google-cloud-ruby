...
class ::Google::Shopping::Merchant::Reports::V1beta::ReportService::ClientTest < Minitest::Test
  ...
  def test_search
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Reports::V1beta::SearchResponse.new
    ...
    search_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Reports::V1beta::SearchRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Reports::V1beta::ReportService::Client::Configuration, config
  end
end
