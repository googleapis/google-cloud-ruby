...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-security_center_management/latest)
for this library, google-cloud-security_center_management, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-security_center_management-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-security_center_management-v1/latest).
...
```
$ gem install google-cloud-security_center_management
```
