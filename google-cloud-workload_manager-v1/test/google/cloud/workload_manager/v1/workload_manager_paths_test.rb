...
class ::Google::Cloud::WorkloadManager::V1::WorkloadManager::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_execution_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.execution_path project: "value0", location: "value1", evaluation: "value2", execution: "value3"
      assert_equal "projects/value0/locations/value1/evaluations/value2/executions/value3", path
    end
  end
