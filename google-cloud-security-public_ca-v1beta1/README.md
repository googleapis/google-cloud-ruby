...
API Client library for the Public Certificate Authority V1beta1 API
...
specific version of the Public Certificate Authority V1beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-security-public_ca-v1beta1
```
...
request = ::Google::Cloud::Security::PublicCA::V1beta1::CreateExternalAccountKeyRequest.new # (request fields as keyword arguments...)
response = client.create_external_account_key request
```

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-security-public_ca-v1beta1/latest)
