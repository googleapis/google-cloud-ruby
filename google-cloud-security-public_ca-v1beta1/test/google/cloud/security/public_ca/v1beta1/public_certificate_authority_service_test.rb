...
class ::Google::Cloud::Security::PublicCA::V1beta1::PublicCertificateAuthorityService::ClientTest < Minitest::Test
  ...
  def test_create_external_account_key
    ...
    Gapic::ServiceStub.stub :new, create_external_account_key_client_stub do
      # Create client
      c = ::Google::Cloud::Security::PublicCA::V1beta1::PublicCertificateAuthorityService::Client.new do |config|
      ...
      # Use protobuf object
      c.create_external_account_key ::Google::Cloud::Security::PublicCA::V1beta1::CreateExternalAccountKeyRequest.new(parent: parent, external_account_key: external_account_key) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.create_external_account_key(::Google::Cloud::Security::PublicCA::V1beta1::CreateExternalAccountKeyRequest.new(parent: parent, external_account_key: external_account_key), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
