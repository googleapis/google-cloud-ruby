...
class ::Google::Cloud::Security::PublicCA::V1beta1::PublicCertificateAuthorityService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_external_account_key
    # Create test objects.
    client_result = ::Google::Cloud::Security::PublicCA::V1beta1::ExternalAccountKey.new
    ...
    create_external_account_key_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Security::PublicCA::V1beta1::PublicCertificateAuthorityService::Rest::ServiceStub.stub :transcode_create_external_account_key_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_external_account_key_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_external_account_key_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Security::PublicCA::V1beta1::PublicCertificateAuthorityService::Rest::Client::Configuration, config
  end
end
