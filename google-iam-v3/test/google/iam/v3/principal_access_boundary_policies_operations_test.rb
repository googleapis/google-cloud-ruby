...
class ::Google::Iam::V3::PrincipalAccessBoundaryPolicies::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Iam::V3::PrincipalAccessBoundaryPolicies::Operations.new do |config|
  ...
  def test_configure
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      client = ::Google::Iam::V3::PrincipalAccessBoundaryPolicies::Operations.new do |config|
        config.credentials = grpc_channel
      end
    end
    ...
    assert_kind_of ::Google::Iam::V3::PrincipalAccessBoundaryPolicies::Operations::Configuration, config
  end
end
