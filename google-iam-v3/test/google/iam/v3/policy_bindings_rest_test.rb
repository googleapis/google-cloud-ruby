...
class ::Google::Iam::V3::PolicyBindings::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_policy_binding
    # Create test objects.
    client_result = ::Google::Iam::V3::PolicyBinding.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_policy_bindings
    # Create test objects.
    client_result = ::Google::Iam::V3::ListPolicyBindingsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_search_target_policy_bindings
    # Create test objects.
    client_result = ::Google::Iam::V3::SearchTargetPolicyBindingsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Iam::V3::PolicyBindings::Rest::ServiceStub.stub :transcode_search_target_policy_bindings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_target_policy_bindings_client_stub do
        ...
        # Use protobuf object
        c.search_target_policy_bindings ::Google::Iam::V3::SearchTargetPolicyBindingsRequest.new(target: target, page_size: page_size, page_token: page_token, parent: parent, filter: filter) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.search_target_policy_bindings(::Google::Iam::V3::SearchTargetPolicyBindingsRequest.new(target: target, page_size: page_size, page_token: page_token, parent: parent, filter: filter), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Iam::V3::PolicyBindings::Rest::Client::Configuration, config
  end
end
