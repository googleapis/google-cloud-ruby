    ...
    module V3
      module AccessPolicies
        ...
        class Client
          ...
          #
          # See {::Google::Iam::V3::AccessPolicies::Client::Configuration}
          # for a description of the configuration fields.
          #
          # @example
          #
          #   # Modify the configuration for all AccessPolicies clients
          #   ::Google::Iam::V3::AccessPolicies::Client.configure do |config|
          #     config.timeout = 10.0
          #   end
          #
          ...
          def initialize
            ...
            require "gapic/grpc"
            require "google/iam/v3/access_policies_service_services_pb"
            ...
            @access_policies_stub = ::Gapic::ServiceStub.new(
              ::Google::Iam::V3::AccessPolicies::Stub,
          ...
          #
          # @return [::Google::Iam::V3::AccessPolicies::Operations]
          #
          ...
          #   {::Google::Iam::V3::CreateAccessPolicyRequest} or an equivalent Hash.
          #
          #   @param request [::Google::Iam::V3::CreateAccessPolicyRequest, ::Hash]
          ...
          #   @param access_policy [::Google::Iam::V3::AccessPolicy, ::Hash]
          ...
          #   request = Google::Iam::V3::CreateAccessPolicyRequest.new
          #
          ...
          def create_access_policy request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Google::Iam::V3::CreateAccessPolicyRequest
          ...
          #   {::Google::Iam::V3::GetAccessPolicyRequest} or an equivalent Hash.
          #
          #   @param request [::Google::Iam::V3::GetAccessPolicyRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          #
          # @yield [response, operation] Access the result along with the RPC operation
          # @yieldparam response [::Google::Iam::V3::AccessPolicy]
          # @yieldparam operation [::GRPC::ActiveCall::Operation]
          #
          # @return [::Google::Iam::V3::AccessPolicy]
          #
          # @raise [::Google::Cloud::Error] if the RPC is aborted.
          #
          # @example Basic example
          ...
          #
          #   # Create a request. To set request fields, pass in keyword arguments.
          #   request = Google::Iam::V3::GetAccessPolicyRequest.new
          #
          #   # Call the get_access_policy method.
          #   result = client.get_access_policy request
          #
          #   # The returned object is of type Google::Iam::V3::AccessPolicy.
          #   p result
          #
          def get_access_policy request, options = nil
            raise ::ArgumentError, "request must be provided" if request.nil?

            request = ::Gapic::Protobuf.coerce request, to: ::Google::Iam::V3::GetAccessPolicyRequest
          ...
          #   {::Google::Iam::V3::UpdateAccessPolicyRequest} or an equivalent Hash.
          #
          #   @param request [::Google::Iam::V3::UpdateAccessPolicyRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          #
          #   # Create a request. To set request fields, pass in keyword arguments.
          #   request = Google::Iam::V3::UpdateAccessPolicyRequest.new
          #
          ...
          def update_access_policy request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Google::Iam::V3::UpdateAccessPolicyRequest
          ...
          #   {::Google::Iam::V3::DeleteAccessPolicyRequest} or an equivalent Hash.
          #
          #   @param request [::Google::Iam::V3::DeleteAccessPolicyRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          #
          #   # Create a request. To set request fields, pass in keyword arguments.
          #   request = Google::Iam::V3::DeleteAccessPolicyRequest.new
          #
          ...
          def delete_access_policy request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Google::Iam::V3::DeleteAccessPolicyRequest
          ...
          #   {::Google::Iam::V3::ListAccessPoliciesRequest} or an equivalent Hash.
          #
          #   @param request [::Google::Iam::V3::ListAccessPoliciesRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          #
          # @yield [response, operation] Access the result along with the RPC operation
          # @yieldparam response [::Gapic::PagedEnumerable<::Google::Iam::V3::AccessPolicy>]
          # @yieldparam operation [::GRPC::ActiveCall::Operation]
          #
          # @return [::Gapic::PagedEnumerable<::Google::Iam::V3::AccessPolicy>]
          #
          # @raise [::Google::Cloud::Error] if the RPC is aborted.
          #
          # @example Basic example
          ...
          #
          #   # Create a request. To set request fields, pass in keyword arguments.
          #   request = Google::Iam::V3::ListAccessPoliciesRequest.new
          #
          ...
          #   result.each do |item|
          #     # Each element is of type ::Google::Iam::V3::AccessPolicy.
          #     p item
          #   end
          #
          def list_access_policies request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Google::Iam::V3::ListAccessPoliciesRequest
          ...
          #   {::Google::Iam::V3::SearchAccessPolicyBindingsRequest} or an equivalent Hash.
          #
          #   @param request [::Google::Iam::V3::SearchAccessPolicyBindingsRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          #
          #   # Create a request. To set request fields, pass in keyword arguments.
          #   request = Google::Iam::V3::SearchAccessPolicyBindingsRequest.new
          #
          ...
          def search_access_policy_bindings request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Google::Iam::V3::SearchAccessPolicyBindingsRequest
          ...
          # {::Google::Iam::V3::AccessPolicies::Client::Configuration::Rpcs}
