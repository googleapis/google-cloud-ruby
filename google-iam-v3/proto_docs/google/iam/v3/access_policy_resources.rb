...
module Google
  module Iam
    module V3
      ...
      #   @return [::Google::Iam::V3::AccessPolicyDetails]
      ...
      # @!attribute [rw] rules
      #   @return [::Array<::Google::Iam::V3::AccessPolicyRule>]
      ...
      # @!attribute [rw] effect
      #   @return [::Google::Iam::V3::AccessPolicyRule::Effect]
      ...
      #   @return [::Google::Iam::V3::AccessPolicyRule::Operation]
