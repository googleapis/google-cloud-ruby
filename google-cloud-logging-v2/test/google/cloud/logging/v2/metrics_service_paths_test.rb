...
class ::Google::Cloud::Logging::V2::MetricsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_log_metric_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.log_metric_path project: "value0", metric: "value1"
      assert_equal "projects/value0/metrics/value1", path
    end
  end
