...
require "google/cloud/video_intelligence/v1_p2_beta1/credentials"
      ...
      module V1P2Beta1
        ...
        class VideoIntelligenceServiceClient
          ...
          def initialize \
            ...
            credentials ||= Google::Cloud::VideoIntelligence::V1P2Beta1::Credentials.default
            ...
            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Cloud::VideoIntelligence::V1P2Beta1::Credentials.new(credentials).updater_proc
            end
