...
require "google/cloud/video_intelligence/v1_p1_beta1/credentials"
    ...
    module VideoIntelligence
      module V1P1Beta1
        ...
        class VideoIntelligenceServiceClient
          ...
          # @example
          #   require "google/cloud/video_intelligence/v1_p1_beta1"
          #
          #   video_intelligence_service_client = Google::Cloud::VideoIntelligence::V1P1Beta1.new(version: :v1p1beta1)
