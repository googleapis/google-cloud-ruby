...
module Google
  module Cloud
    module VideoIntelligence
      ...
      #
      # video_intelligence_service_client = Google::Cloud::VideoIntelligence::V1P1Beta1.new
      ...
      module V1P1Beta1
        ...
        FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("v1_p1_beta1"))
        ...
        def self.new(*args, version: :v1p1beta1, **kwargs)
          ...
          version_module = Google::Cloud::VideoIntelligence::V1P1Beta1
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::VideoIntelligence::V1P1Beta1.const_get(version_module).new(*args, **kwargs)
        end
      end
    end
  end
