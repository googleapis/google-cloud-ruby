...
##
# Snippet for the cancel_private_offer call in the CommerceTransaction service
#
...
# Google::Cloud::CommerceProducer::V1beta::CommerceTransaction::Client#cancel_private_offer.
#
