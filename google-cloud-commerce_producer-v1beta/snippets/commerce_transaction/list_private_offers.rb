...
##
# Snippet for the list_private_offers call in the CommerceTransaction service
#
...
# Google::Cloud::CommerceProducer::V1beta::CommerceTransaction::Client#list_private_offers.
#
