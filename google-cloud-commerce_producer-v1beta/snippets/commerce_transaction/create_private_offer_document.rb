...
##
# Snippet for the create_private_offer_document call in the CommerceTransaction service
#
...
# Google::Cloud::CommerceProducer::V1beta::CommerceTransaction::Client#create_private_offer_document.
#
