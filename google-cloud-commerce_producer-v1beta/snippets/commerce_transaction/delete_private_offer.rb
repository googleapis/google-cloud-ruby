...
##
# Snippet for the delete_private_offer call in the CommerceTransaction service
#
...
# Google::Cloud::CommerceProducer::V1beta::CommerceTransaction::Client#delete_private_offer.
#
