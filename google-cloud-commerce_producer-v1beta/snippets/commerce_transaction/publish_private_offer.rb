...
##
# Snippet for the publish_private_offer call in the CommerceTransaction service
#
...
# Google::Cloud::CommerceProducer::V1beta::CommerceTransaction::Client#publish_private_offer.
#
