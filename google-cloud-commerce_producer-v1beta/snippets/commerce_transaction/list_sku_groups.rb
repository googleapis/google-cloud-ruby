...
##
# Snippet for the list_sku_groups call in the CommerceTransaction service
#
...
# Google::Cloud::CommerceProducer::V1beta::CommerceTransaction::Client#list_sku_groups.
#
def list_sku_groups
