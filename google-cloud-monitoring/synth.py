...
# module Google::Monitoring. Unfortunately, if we move protos into G::G::M,
# they will conflict with names being generated by monogapic, for example
# Google::Cloud::Monitoring::V3::AlertPolicy is a module created by monogapic
# as a factory for AlertPolicyServviceClient.
# When we move to the microgenerator, we will need to take an additional
# breaking change where the proto types move from G::M to G::C::M.
s.replace(
