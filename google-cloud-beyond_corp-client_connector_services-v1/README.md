...
API Client library for the BeyondCorp ClientConnectorServices V1 API
...
the main client gem,
[google-cloud-beyond_corp-client_connector_services](https://rubygems.org/gems/google-cloud-beyond_corp-client_connector_services).
...
client library with a name such as `google-cloud-beyond_corp-client_connector_services`,
