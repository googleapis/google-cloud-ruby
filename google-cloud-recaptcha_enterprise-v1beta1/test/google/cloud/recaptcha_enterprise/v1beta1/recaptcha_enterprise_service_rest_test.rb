...
class ::Google::Cloud::RecaptchaEnterprise::V1beta1::RecaptchaEnterpriseService::Rest::ClientTest < Minitest::Test
  ...
  def test_create_assessment
    ...
    create_assessment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
  ...
  def test_annotate_assessment
    ...
    annotate_assessment_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
