...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Help protect your website from fraudulent activity, spam, and abuse without creating friction. Note that google-cloud-recaptcha_enterprise-v1beta1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-recaptcha_enterprise instead. See the readme for more details."
