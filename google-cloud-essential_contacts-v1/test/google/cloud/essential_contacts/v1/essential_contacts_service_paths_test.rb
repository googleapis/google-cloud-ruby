...
class ::Google::Cloud::EssentialContacts::V1::EssentialContactsService::ClientPathsTest < Minitest::Test
  ...
  def test_contact_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.contact_path project: "value0", contact: "value1"
      assert_equal "projects/value0/contacts/value1", path

      path = client.contact_path folder: "value0", contact: "value1"
      assert_equal "folders/value0/contacts/value1", path

      path = client.contact_path organization: "value0", contact: "value1"
      assert_equal "organizations/value0/contacts/value1", path
    end
  end
