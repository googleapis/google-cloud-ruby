...
require "google/cloud/device_streaming/version"
...
::Google::Cloud.configure.add_config! :device_streaming do |config|
...
module Google
  module Cloud
    module DeviceStreaming
      ...
      # {Google::Cloud::DeviceStreaming.direct_access_service_available?}.
      #
      ...
      #
      def self.direct_access_service version: :v1, transport: :grpc, &block
        require "google/cloud/device_streaming/#{version.to_s.downcase}"

        package_name = Google::Cloud::DeviceStreaming
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
                       .first
        service_module = Google::Cloud::DeviceStreaming.const_get(package_name).const_get(:DirectAccessService)
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::DeviceStreaming.direct_access_service}.
      ...
      #
      def self.direct_access_service_available? version: :v1, transport: :grpc
        require "google/cloud/device_streaming/#{version.to_s.downcase}"
        package_name = Google::Cloud::DeviceStreaming
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::DeviceStreaming.const_get package_name
        return false unless service_module.const_defined? :DirectAccessService
        service_module = service_module.const_get :DirectAccessService
        if transport == :rest
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.device_streaming if block_given?
...
helper_path = ::File.join __dir__, "device_streaming", "helpers.rb"
require "google/cloud/device_streaming/helpers" if ::File.file? helper_path
