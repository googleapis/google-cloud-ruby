          ...
          module RegionalInventoryService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Inventories::V1::ListRegionalInventoriesRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::Inventories::V1::ListRegionalInventoriesResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Shopping::Merchant::Inventories::V1::ListRegionalInventoriesResponse]
                ...
                def list_regional_inventories request_pb, options = nil
                  ...
                  result = ::Google::Shopping::Merchant::Inventories::V1::ListRegionalInventoriesResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Inventories::V1::InsertRegionalInventoryRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def insert_regional_inventory request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Shopping::Merchant::Inventories::V1::RegionalInventory.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Inventories::V1::DeleteRegionalInventoryRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def self.transcode_list_regional_inventories_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/inventories/v1/{parent}/regionalInventories",
                                                            matches: [
                ...
                def self.transcode_insert_regional_inventory_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/inventories/v1/{parent}/regionalInventories:insert",
