...
```
$ gem install google-shopping-merchant-inventories-v1
```
...
request = ::Google::Shopping::Merchant::Inventories::V1::ListLocalInventoriesRequest.new # (request fields as keyword arguments...)
response = client.list_local_inventories request
```

View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-inventories-v1)
...
is part of the name, e.g. `google-shopping-merchant-inventories-v1`.
