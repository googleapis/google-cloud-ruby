...
# This test is for the deprecated "embedded" IAM policy client class.
...
class ::Google::Cloud::PubSub::V1::IAMPolicy::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::PubSub::V1::IAMPolicy::Client::Configuration, config
  end
end
