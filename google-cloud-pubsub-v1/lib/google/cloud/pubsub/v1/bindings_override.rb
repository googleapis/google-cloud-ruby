...
module Google
  module Cloud
    module PubSub
      ...
      #
      #     require "google/cloud/pubsub/v1/rest"
          ...
          @configure ||= begin
            ...
            default_config.bindings_override["google.iam.v1.IAMPolicy.GetIamPolicy"] = [
              Gapic::Rest::GrpcTranscoder::HttpBinding.create_with_validation(
                ...
                matches: [
                  ["resource", %r{^projects/[^/]+/topics/[^/]+/?$}, false]
                ],
                body: nil
              ),
              Gapic::Rest::GrpcTranscoder::HttpBinding.create_with_validation(
                ...
                uri_template: "/v1/{resource}:getIamPolicy",
                matches: [
                  ["resource", %r{^projects/[^/]+/subscriptions/[^/]+/?$}, false]
                ],
                body: nil
              ),
              Gapic::Rest::GrpcTranscoder::HttpBinding.create_with_validation(
                ...
                uri_template: "/v1/{resource}:getIamPolicy",
                matches: [
                  ["resource", %r{^projects/[^/]+/snapshots/[^/]+/?$}, false]
                ],
                body: nil
              ),
              Gapic::Rest::GrpcTranscoder::HttpBinding.create_with_validation(
                ...
                uri_template: "/v1/{resource}:getIamPolicy",
                matches: [
                  ["resource", %r{^projects/[^/]+/schemas/[^/]+/?$}, false]
                ],
                body: nil
              )
            ]
