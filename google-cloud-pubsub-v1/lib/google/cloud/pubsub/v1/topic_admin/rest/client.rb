...
require "google/cloud/pubsub/v1/topic_admin/rest/service_stub"
    ...
    module PubSub
      module V1
        module TopicAdmin
          module Rest
            ##
            # REST client for the TopicAdmin service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::PubSub::V1::TopicAdmin::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all TopicAdmin clients
              #   ::Google::Cloud::PubSub::V1::TopicAdmin::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new TopicAdmin REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @topic_admin_stub = ::Google::Cloud::PubSub::V1::TopicAdmin::Rest::ServiceStub.new(
                ...
                @topic_admin_stub.logger(stub: true)&.info do |entry|
              ...
              def create_topic request, options = nil
                ...
                @topic_admin_stub.create_topic request, options do |result, operation|
              ...
              def update_topic request, options = nil
                ...
                @topic_admin_stub.update_topic request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def publish request, options = nil
                ...
                @topic_admin_stub.publish request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_topic request, options = nil
                ...
                @topic_admin_stub.get_topic request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Topic>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Topic>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_topics request, options = nil
                ...
                @topic_admin_stub.list_topics request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @topic_admin_stub, :list_topics, "topics", request, result, options
                  yield result, operation if block_given?
              ...
              def list_topic_subscriptions request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_topic_subscriptions.metadata.to_h
                ...
                @topic_admin_stub.list_topic_subscriptions request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list_topic_snapshots request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_topic_snapshots.metadata.to_h
                ...
                @topic_admin_stub.list_topic_snapshots request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def delete_topic request, options = nil
                ...
                @topic_admin_stub.delete_topic request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def detach_subscription request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.detach_subscription.metadata.to_h
                ...
                @topic_admin_stub.detach_subscription request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the TopicAdmin REST API.
              #
              # This class represents the configuration for TopicAdmin REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::PubSub::V1::TopicAdmin::Rest::Client::Configuration::Rpcs}
