...
require "google/cloud/pubsub/v1/subscription_admin/rest/service_stub"
    ...
    module PubSub
      module V1
        module SubscriptionAdmin
          module Rest
            ##
            # REST client for the SubscriptionAdmin service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::PubSub::V1::SubscriptionAdmin::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all SubscriptionAdmin clients
              #   ::Google::Cloud::PubSub::V1::SubscriptionAdmin::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new SubscriptionAdmin REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @subscription_admin_stub = ::Google::Cloud::PubSub::V1::SubscriptionAdmin::Rest::ServiceStub.new(
                ...
                @subscription_admin_stub.logger(stub: true)&.info do |entry|
              ...
              def create_subscription request, options = nil
                ...
                @subscription_admin_stub.create_subscription request, options do |result, operation|
              ...
              def get_subscription request, options = nil
                ...
                @subscription_admin_stub.get_subscription request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def update_subscription request, options = nil
                ...
                @subscription_admin_stub.update_subscription request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Subscription>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Subscription>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_subscriptions request, options = nil
                ...
                @subscription_admin_stub.list_subscriptions request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @subscription_admin_stub, :list_subscriptions, "subscriptions", request, result, options
                  yield result, operation if block_given?
              ...
              def delete_subscription request, options = nil
                ...
                @subscription_admin_stub.delete_subscription request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def modify_ack_deadline request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.modify_ack_deadline.metadata.to_h
                ...
                @subscription_admin_stub.modify_ack_deadline request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def acknowledge request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.acknowledge.metadata.to_h
                ...
                @subscription_admin_stub.acknowledge request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def pull request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.pull.metadata.to_h
                ...
                @subscription_admin_stub.pull request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def modify_push_config request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.modify_push_config.metadata.to_h
                ...
                @subscription_admin_stub.modify_push_config request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_snapshot request, options = nil
                ...
                @subscription_admin_stub.get_snapshot request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Snapshot>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Snapshot>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_snapshots request, options = nil
                ...
                @subscription_admin_stub.list_snapshots request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @subscription_admin_stub, :list_snapshots, "snapshots", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def create_snapshot request, options = nil
                ...
                @subscription_admin_stub.create_snapshot request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def update_snapshot request, options = nil
                ...
                @subscription_admin_stub.update_snapshot request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def delete_snapshot request, options = nil
                ...
                @subscription_admin_stub.delete_snapshot request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def seek request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.seek.metadata.to_h
                ...
                @subscription_admin_stub.seek request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the SubscriptionAdmin REST API.
              #
              # This class represents the configuration for SubscriptionAdmin REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::PubSub::V1::SubscriptionAdmin::Rest::Client::Configuration::Rpcs}
