...
require "google/cloud/pubsub/v1/schema_service/rest/service_stub"
        ...
        module SchemaService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::PubSub::V1::SchemaService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all SchemaService clients
              #   ::Google::Cloud::PubSub::V1::SchemaService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @schema_service_stub = ::Google::Cloud::PubSub::V1::SchemaService::Rest::ServiceStub.new(
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Schema>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::PubSub::V1::Schema>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_schema_revisions request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_schema_revisions.metadata.to_h
                ...
                @schema_service_stub.list_schema_revisions request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @schema_service_stub, :list_schema_revisions, "schemas", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def commit_schema request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.commit_schema.metadata.to_h
                ...
                @schema_service_stub.commit_schema request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def rollback_schema request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.rollback_schema.metadata.to_h
                ...
                @schema_service_stub.rollback_schema request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def delete_schema_revision request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.delete_schema_revision.metadata.to_h
                ...
                @schema_service_stub.delete_schema_revision request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def validate_schema request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.validate_schema.metadata.to_h
                ...
                @schema_service_stub.validate_schema request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def validate_message request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.validate_message.metadata.to_h
                ...
                @schema_service_stub.validate_message request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::PubSub::V1::SchemaService::Rest::Client::Configuration::Rpcs}
