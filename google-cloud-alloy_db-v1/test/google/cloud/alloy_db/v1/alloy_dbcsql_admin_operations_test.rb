...
class ::Google::Cloud::AlloyDB::V1::AlloyDBCSQLAdmin::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AlloyDB::V1::AlloyDBCSQLAdmin::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AlloyDB::V1::AlloyDBCSQLAdmin::Operations::Configuration, config
  end
end
