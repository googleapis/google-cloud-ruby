...
require "google/cloud/alloy_db/v1/alloy_dbcsql_admin"

class ::Google::Cloud::AlloyDB::V1::AlloyDBCSQLAdmin::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_backup_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      client = ::Google::Cloud::AlloyDB::V1::AlloyDBCSQLAdmin::Client.new do |config|
