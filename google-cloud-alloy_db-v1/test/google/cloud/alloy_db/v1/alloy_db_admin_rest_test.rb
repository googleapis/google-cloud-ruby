  ...
  def test_get_cluster
    ...
    ::Google::Cloud::AlloyDB::V1::AlloyDBAdmin::Rest::ServiceStub.stub :transcode_get_cluster_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_cluster_client_stub do
        ...
        # Use protobuf object
        client.get_cluster ::Google::Cloud::AlloyDB::V1::GetClusterRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.get_cluster(::Google::Cloud::AlloyDB::V1::GetClusterRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
