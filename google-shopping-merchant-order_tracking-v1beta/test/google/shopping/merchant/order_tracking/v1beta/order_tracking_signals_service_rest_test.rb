...
class ::Google::Shopping::Merchant::OrderTracking::V1beta::OrderTrackingSignalsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_order_tracking_signal
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::OrderTracking::V1beta::OrderTrackingSignal.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::OrderTracking::V1beta::OrderTrackingSignalsService::Rest::Client::Configuration, config
  end
end
