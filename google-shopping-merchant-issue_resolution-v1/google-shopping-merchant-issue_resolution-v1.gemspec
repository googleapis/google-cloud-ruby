...
require File.expand_path("lib/google/shopping/merchant/issue_resolution/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-issue_resolution-v1"
  gem.version       = Google::Shopping::Merchant::IssueResolution::V1::VERSION

  gem.authors       = ["Google LLC"]
  gem.email         = "googleapis-packages@google.com"
  gem.description   = "Programmatically manage your Merchant Center Accounts. Note that google-shopping-merchant-issue_resolution-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-shopping-merchant-issue_resolution instead. See the readme for more details."
