...
class ::Google::Shopping::Merchant::IssueResolution::V1::AggregateProductStatusesService::ClientTest < Minitest::Test
  ...
  def test_list_aggregate_product_statuses
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::IssueResolution::V1::ListAggregateProductStatusesResponse.new
    ...
    list_aggregate_product_statuses_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_aggregate_product_statuses, name
      assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1::ListAggregateProductStatusesRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_aggregate_product_statuses_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_aggregate_product_statuses_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1::AggregateProductStatusesService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::IssueResolution::V1::AggregateProductStatusesService::Client, client
