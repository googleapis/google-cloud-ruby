...
class ::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::ClientTest < Minitest::Test
  ...
  def test_render_account_issues
    ...
    Gapic::ServiceStub.stub :new, render_account_issues_client_stub do
      # Create client
      c = ::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::Client.new do |config|
      ...
      # Use protobuf object
      c.render_account_issues ::Google::Shopping::Merchant::IssueResolution::V1::RenderAccountIssuesRequest.new(name: name, language_code: language_code, time_zone: time_zone, payload: payload) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.render_account_issues(::Google::Shopping::Merchant::IssueResolution::V1::RenderAccountIssuesRequest.new(name: name, language_code: language_code, time_zone: time_zone, payload: payload), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_render_product_issues
    ...
    Gapic::ServiceStub.stub :new, render_product_issues_client_stub do
      ...
      # Use protobuf object
      c.render_product_issues ::Google::Shopping::Merchant::IssueResolution::V1::RenderProductIssuesRequest.new(name: name, language_code: language_code, time_zone: time_zone, payload: payload) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.render_product_issues(::Google::Shopping::Merchant::IssueResolution::V1::RenderProductIssuesRequest.new(name: name, language_code: language_code, time_zone: time_zone, payload: payload), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_trigger_action
    ...
    Gapic::ServiceStub.stub :new, trigger_action_client_stub do
      ...
      # Use protobuf object
      c.trigger_action ::Google::Shopping::Merchant::IssueResolution::V1::TriggerActionRequest.new(name: name, payload: payload, language_code: language_code) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.trigger_action(::Google::Shopping::Merchant::IssueResolution::V1::TriggerActionRequest.new(name: name, payload: payload, language_code: language_code), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
