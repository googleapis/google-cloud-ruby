...
require "google/shopping/merchant/issue_resolution/v1/issue_resolution_service/rest/service_stub"
          ...
          module IssueResolutionService
            module Rest
              ...
              class Client
                ...
                #
                # See {::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all IssueResolutionService clients
                #   ::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                #   client = ::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::Rest::Client.new
                #
                #   # Create a client using a custom configuration
                #   client = ::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::Rest::Client.new do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                def initialize
                  ...
                  @issue_resolution_service_stub = ::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::Rest::ServiceStub.new(
                ...
                #   {::Google::Shopping::Merchant::IssueResolution::V1::RenderAccountIssuesRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::IssueResolution::V1::RenderAccountIssuesRequest, ::Hash]
                ...
                #   request = Google::Shopping::Merchant::IssueResolution::V1::RenderAccountIssuesRequest.new
                #
                #   # Call the render_account_issues method.
                #   result = client.render_account_issues request
                #
                #   # The returned object is of type Google::Shopping::Merchant::IssueResolution::V1::RenderAccountIssuesResponse.
                #   p result
                #
                def render_account_issues request, options = nil
                  raise ::ArgumentError, "request must be provided" if request.nil?

                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::IssueResolution::V1::RenderAccountIssuesRequest
                ...
                #   {::Google::Shopping::Merchant::IssueResolution::V1::RenderProductIssuesRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::IssueResolution::V1::RenderProductIssuesRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                #
                #   # Create a request. To set request fields, pass in keyword arguments.
                #   request = Google::Shopping::Merchant::IssueResolution::V1::RenderProductIssuesRequest.new
                #
                #   # Call the render_product_issues method.
                #   result = client.render_product_issues request
                #
                #   # The returned object is of type Google::Shopping::Merchant::IssueResolution::V1::RenderProductIssuesResponse.
                #   p result
                #
                def render_product_issues request, options = nil
                  raise ::ArgumentError, "request must be provided" if request.nil?

                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::IssueResolution::V1::RenderProductIssuesRequest
                ...
                # {::Google::Shopping::Merchant::IssueResolution::V1::InputField#id Ids} for all
                ...
                #   {::Google::Shopping::Merchant::IssueResolution::V1::TriggerActionRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::IssueResolution::V1::TriggerActionRequest, ::Hash]
                #     A request object representing the call parameters. Required. To specify no
                #     parameters, or to keep all the default parameter values, pass an empty Hash.
                #   @param options [::Gapic::CallOptions, ::Hash]
                #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                ...
                #     Format: `accounts/{account}`
                #   @param payload [::Google::Shopping::Merchant::IssueResolution::V1::TriggerActionPayload, ::Hash]
                ...
                #
                #   # Create a request. To set request fields, pass in keyword arguments.
                #   request = Google::Shopping::Merchant::IssueResolution::V1::TriggerActionRequest.new
                #
                #   # Call the trigger_action method.
                #   result = client.trigger_action request
                #
                #   # The returned object is of type Google::Shopping::Merchant::IssueResolution::V1::TriggerActionResponse.
                #   p result
                #
                def trigger_action request, options = nil
                  raise ::ArgumentError, "request must be provided" if request.nil?

                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::IssueResolution::V1::TriggerActionRequest
                ...
                # {::Google::Shopping::Merchant::IssueResolution::V1::IssueResolutionService::Rest::Client::Configuration::Rpcs}
