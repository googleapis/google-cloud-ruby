...
In general, the google-cloud-security-private_ca library uses
...
The google-cloud-security-private_ca library aims to make authentication
...
Google::Cloud::Security::PrivateCA.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-security-private_ca.
