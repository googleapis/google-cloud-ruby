...
The recommended way to authenticate to the google-cloud-bigquery-data_transfer library is to use
...
The google-cloud-bigquery-data_transfer library provides several mechanisms to configure your system.
