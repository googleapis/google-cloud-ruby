...
In general, the google-cloud-dataqna library uses
...
The google-cloud-dataqna library aims to make authentication
...
The environment variables that google-cloud-dataqna
...
Google::Cloud::DataQnA.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-dataqna.
