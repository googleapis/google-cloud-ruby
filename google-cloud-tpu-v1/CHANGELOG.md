...
* Added UNKNOWN to TPU node state, used to prevent a node from being marked as READY during diagnosis after it has failed repair ([#28229](https://github.com/googleapis/google-cloud-ruby/issues/28229)) 
#### Documentation
