...
require File.expand_path("lib/google/cloud/video_intelligence/v1p1beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-video_intelligence-v1p1beta1"
  gem.version       = Google::Cloud::VideoIntelligence::V1p1beta1::VERSION
  ...
  gem.summary       = "API Client library for the Cloud Video Intelligence V1p1beta1 API"
