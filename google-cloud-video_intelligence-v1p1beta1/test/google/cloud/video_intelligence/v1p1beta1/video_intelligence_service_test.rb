...
class ::Google::Cloud::VideoIntelligence::V1p1beta1::VideoIntelligenceService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VideoIntelligence::V1p1beta1::VideoIntelligenceService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::VideoIntelligence::V1p1beta1::VideoIntelligenceService::Operations, client.operations_client
  end
end
