  ...
  def test_list_regional_inventories
    ...
    ::Google::Shopping::Merchant::Inventories::V1beta::RegionalInventoryService::Rest::ServiceStub.stub :transcode_list_regional_inventories_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_regional_inventories_client_stub do
        ...
        # Use protobuf object
        client.list_regional_inventories ::Google::Shopping::Merchant::Inventories::V1beta::ListRegionalInventoriesRequest.new(parent: parent, page_size: page_size, page_token: page_token, product_id_base64_url_encoded: product_id_base64_url_encoded) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.list_regional_inventories(::Google::Shopping::Merchant::Inventories::V1beta::ListRegionalInventoriesRequest.new(parent: parent, page_size: page_size, page_token: page_token, product_id_base64_url_encoded: product_id_base64_url_encoded), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_insert_regional_inventory
    ...
    ::Google::Shopping::Merchant::Inventories::V1beta::RegionalInventoryService::Rest::ServiceStub.stub :transcode_insert_regional_inventory_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, insert_regional_inventory_client_stub do
        ...
        # Use protobuf object
        client.insert_regional_inventory ::Google::Shopping::Merchant::Inventories::V1beta::InsertRegionalInventoryRequest.new(parent: parent, regional_inventory: regional_inventory, product_id_base64_url_encoded: product_id_base64_url_encoded) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.insert_regional_inventory(::Google::Shopping::Merchant::Inventories::V1beta::InsertRegionalInventoryRequest.new(parent: parent, regional_inventory: regional_inventory, product_id_base64_url_encoded: product_id_base64_url_encoded), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_regional_inventory
    ...
    ::Google::Shopping::Merchant::Inventories::V1beta::RegionalInventoryService::Rest::ServiceStub.stub :transcode_delete_regional_inventory_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_regional_inventory_client_stub do
        ...
        # Use protobuf object
        client.delete_regional_inventory ::Google::Shopping::Merchant::Inventories::V1beta::DeleteRegionalInventoryRequest.new(name: name, product_id_base64_url_encoded: product_id_base64_url_encoded) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.delete_regional_inventory(::Google::Shopping::Merchant::Inventories::V1beta::DeleteRegionalInventoryRequest.new(name: name, product_id_base64_url_encoded: product_id_base64_url_encoded), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
