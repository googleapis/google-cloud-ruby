  ...
  def test_list_local_inventories
    ...
    ::Google::Shopping::Merchant::Inventories::V1beta::LocalInventoryService::Rest::ServiceStub.stub :transcode_list_local_inventories_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_local_inventories_client_stub do
        ...
        # Use protobuf object
        client.list_local_inventories ::Google::Shopping::Merchant::Inventories::V1beta::ListLocalInventoriesRequest.new(parent: parent, page_size: page_size, page_token: page_token, product_id_base64_url_encoded: product_id_base64_url_encoded) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.list_local_inventories(::Google::Shopping::Merchant::Inventories::V1beta::ListLocalInventoriesRequest.new(parent: parent, page_size: page_size, page_token: page_token, product_id_base64_url_encoded: product_id_base64_url_encoded), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_insert_local_inventory
    ...
    ::Google::Shopping::Merchant::Inventories::V1beta::LocalInventoryService::Rest::ServiceStub.stub :transcode_insert_local_inventory_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, insert_local_inventory_client_stub do
        ...
        # Use protobuf object
        client.insert_local_inventory ::Google::Shopping::Merchant::Inventories::V1beta::InsertLocalInventoryRequest.new(parent: parent, local_inventory: local_inventory, product_id_base64_url_encoded: product_id_base64_url_encoded) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.insert_local_inventory(::Google::Shopping::Merchant::Inventories::V1beta::InsertLocalInventoryRequest.new(parent: parent, local_inventory: local_inventory, product_id_base64_url_encoded: product_id_base64_url_encoded), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_local_inventory
    ...
    ::Google::Shopping::Merchant::Inventories::V1beta::LocalInventoryService::Rest::ServiceStub.stub :transcode_delete_local_inventory_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_local_inventory_client_stub do
        ...
        # Use protobuf object
        client.delete_local_inventory ::Google::Shopping::Merchant::Inventories::V1beta::DeleteLocalInventoryRequest.new(name: name, product_id_base64_url_encoded: product_id_base64_url_encoded) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.delete_local_inventory(::Google::Shopping::Merchant::Inventories::V1beta::DeleteLocalInventoryRequest.new(name: name, product_id_base64_url_encoded: product_id_base64_url_encoded), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
