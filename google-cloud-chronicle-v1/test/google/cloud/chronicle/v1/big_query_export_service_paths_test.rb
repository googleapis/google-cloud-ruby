...
class ::Google::Cloud::Chronicle::V1::BigQueryExportService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_big_query_export_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.big_query_export_path project: "value0", location: "value1", instance: "value2"
      assert_equal "projects/value0/locations/value1/instances/value2/bigQueryExport", path
    end
  end
