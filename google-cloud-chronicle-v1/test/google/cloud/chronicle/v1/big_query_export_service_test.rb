...
class ::Google::Cloud::Chronicle::V1::BigQueryExportService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_big_query_export
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Chronicle::V1::BigQueryExport.new
    ...
    get_big_query_export_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Chronicle::V1::GetBigQueryExportRequest, request
  ...
  def test_update_big_query_export
    ...
    update_big_query_export_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Chronicle::V1::UpdateBigQueryExportRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Chronicle::V1::BigQueryExport), request["big_query_export"]
  ...
  def test_provision_big_query_export
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Chronicle::V1::BigQueryExport.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    provision_big_query_export_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :provision_big_query_export, name
      assert_kind_of ::Google::Cloud::Chronicle::V1::ProvisionBigQueryExportRequest, request
    ...
    Gapic::ServiceStub.stub :new, provision_big_query_export_client_stub do
      ...
      # Verify method calls
      assert_equal 5, provision_big_query_export_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Chronicle::V1::BigQueryExportService::Client::Configuration, config
  end
