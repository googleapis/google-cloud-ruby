...
class ::Google::Cloud::Chronicle::V1::EntityService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_watchlist
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::Watchlist.new
    ...
    get_watchlist_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Chronicle::V1::EntityService::Rest::ServiceStub.stub :transcode_get_watchlist_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_watchlist_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_watchlist_client_stub.call_count
      end
    end
  end
  ...
  def test_list_watchlists
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::ListWatchlistsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_watchlists_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Chronicle::V1::EntityService::Rest::ServiceStub.stub :transcode_list_watchlists_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_watchlists_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_watchlists_client_stub.call_count
      end
    end
  end
  ...
  def test_create_watchlist
    ...
    ::Google::Cloud::Chronicle::V1::EntityService::Rest::ServiceStub.stub :transcode_create_watchlist_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_watchlist_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_watchlist_client_stub.call_count
      end
    end
  end
  ...
  def test_update_watchlist
    ...
    ::Google::Cloud::Chronicle::V1::EntityService::Rest::ServiceStub.stub :transcode_update_watchlist_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_watchlist_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_watchlist_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_watchlist
    ...
    delete_watchlist_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Chronicle::V1::EntityService::Rest::ServiceStub.stub :transcode_delete_watchlist_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_watchlist_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_watchlist_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Chronicle::V1::EntityService::Rest::Client::Configuration, config
  end
end
