...
class ::Google::Cloud::Chronicle::V1::FeaturedContentNativeDashboardService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_featured_content_native_dashboard
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::FeaturedContentNativeDashboard.new
    ...
    get_featured_content_native_dashboard_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Chronicle::V1::FeaturedContentNativeDashboardService::Rest::ServiceStub.stub :transcode_get_featured_content_native_dashboard_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_featured_content_native_dashboard_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_featured_content_native_dashboard_client_stub.call_count
      end
    end
  end
  ...
  def test_list_featured_content_native_dashboards
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::ListFeaturedContentNativeDashboardsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_featured_content_native_dashboards_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Chronicle::V1::FeaturedContentNativeDashboardService::Rest::ServiceStub.stub :transcode_list_featured_content_native_dashboards_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_featured_content_native_dashboards_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_featured_content_native_dashboards_client_stub.call_count
      end
    end
  end
  ...
  def test_install_featured_content_native_dashboard
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::InstallFeaturedContentNativeDashboardResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    install_featured_content_native_dashboard_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Chronicle::V1::FeaturedContentNativeDashboardService::Rest::ServiceStub.stub :transcode_install_featured_content_native_dashboard_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, install_featured_content_native_dashboard_client_stub do
        ...
        # Verify method calls
        assert_equal 5, install_featured_content_native_dashboard_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Chronicle::V1::FeaturedContentNativeDashboardService::Rest::Client::Configuration, config
  end
end
