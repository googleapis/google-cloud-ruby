...
class ::Google::Cloud::Chronicle::V1::DashboardQueryService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_dashboard_query
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::DashboardQuery.new
    ...
    get_dashboard_query_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Chronicle::V1::DashboardQueryService::Rest::ServiceStub.stub :transcode_get_dashboard_query_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_dashboard_query_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_dashboard_query_client_stub.call_count
      end
    end
  end
  ...
  def test_execute_dashboard_query
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::ExecuteDashboardQueryResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    execute_dashboard_query_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Chronicle::V1::DashboardQueryService::Rest::ServiceStub.stub :transcode_execute_dashboard_query_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, execute_dashboard_query_client_stub do
        ...
        # Verify method calls
        assert_equal 5, execute_dashboard_query_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Chronicle::V1::DashboardQueryService::Rest::Client::Configuration, config
  end
end
