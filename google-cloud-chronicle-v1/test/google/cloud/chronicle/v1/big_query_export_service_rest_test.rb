...
class ::Google::Cloud::Chronicle::V1::BigQueryExportService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_big_query_export
    # Create test objects.
    client_result = ::Google::Cloud::Chronicle::V1::BigQueryExport.new
  ...
  def test_provision_big_query_export
    ...
    provision_big_query_export_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Chronicle::V1::BigQueryExportService::Rest::ServiceStub.stub :transcode_provision_big_query_export_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, provision_big_query_export_client_stub do
        ...
        # Verify method calls
        assert_equal 5, provision_big_query_export_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Chronicle::V1::BigQueryExportService::Rest::Client::Configuration, config
  end
end
