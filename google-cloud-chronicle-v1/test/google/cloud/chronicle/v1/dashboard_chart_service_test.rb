...
class ::Google::Cloud::Chronicle::V1::DashboardChartService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_dashboard_chart
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Chronicle::V1::DashboardChart.new
    ...
    get_dashboard_chart_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_dashboard_chart, name
      assert_kind_of ::Google::Cloud::Chronicle::V1::GetDashboardChartRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_dashboard_chart_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_dashboard_chart_client_stub.call_rpc_count
    end
  end

  def test_batch_get_dashboard_charts
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Chronicle::V1::BatchGetDashboardChartsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    batch_get_dashboard_charts_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :batch_get_dashboard_charts, name
      assert_kind_of ::Google::Cloud::Chronicle::V1::BatchGetDashboardChartsRequest, request
    ...
    Gapic::ServiceStub.stub :new, batch_get_dashboard_charts_client_stub do
      ...
      # Verify method calls
      assert_equal 5, batch_get_dashboard_charts_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Chronicle::V1::DashboardChartService::Client::Configuration, config
  end
