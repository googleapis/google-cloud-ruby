...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-backupdr/latest)
for this library, google-cloud-backupdr, to see the convenience methods for
...
```
$ gem install google-cloud-backupdr
```
