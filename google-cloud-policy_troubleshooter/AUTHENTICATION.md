...
In general, the google-cloud-policy_troubleshooter library uses
...
The google-cloud-policy_troubleshooter library aims to make authentication
...
The environment variables that google-cloud-policy_troubleshooter
...
Google::Cloud::PolicyTroubleshooter.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-policy_troubleshooter.
