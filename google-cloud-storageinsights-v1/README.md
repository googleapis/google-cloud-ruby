...
the main client gem,
[google-cloud-storageinsights](https://rubygems.org/gems/google-cloud-storageinsights).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-storageinsights-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-storageinsights-v1/latest)
...
client library with a name such as `google-cloud-storageinsights`,
...
is part of the name, e.g. `google-cloud-storageinsights-v1`.
