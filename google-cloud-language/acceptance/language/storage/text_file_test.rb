...
describe "Language (TEXT/Storage File)", :language do
  ...
  describe "annotation" do
    it "works without creating a document" do
      annotation = language.annotate file, format: :text
    ...
    it "works with creating a document with format and language options" do
      doc = language.document file, format: :text, language: :en
      doc.must_be :text?
      doc.wont_be :html?
  ...
  describe "entities" do
    it "works without creating a document" do
      entities = language.entities file, format: :text
  ...
  describe "sentiment" do
    it "works without creating a document" do
      sentiment = language.sentiment file, format: :text
