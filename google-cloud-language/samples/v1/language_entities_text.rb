...
#   bundle exec ruby samples/v1/language_entities_text.rb [--text_content "California is a state."]
...
def sample_analyze_entities text_content
  ...
  response = language_client.analyze_entities(document, encoding_type: encoding_type)
