...
describe Google::Cloud::Language::Project, :syntax, :mock_language do
  ...
  it "runs syntax content and empty options" do
    ...
    syntax = language.syntax text_content
    mock.verify
  ...
  it "runs syntax with TEXT format options" do
    ...
    language.service.mocked_service = mock
    syntax = language.syntax text_content, format: :text
    mock.verify
  ...
  it "runs syntax with HTML format options" do
    ...
    language.service.mocked_service = mock
    syntax = language.syntax text_content, format: :html
    mock.verify
