...
class MockLanguageServiceCredentialsV1 < Google::Cloud::Language::V1::LanguageService::Credentials
...
describe Google::Cloud::Language::V1::LanguageService::Client do
  describe "analyze_sentiment" do
    let :custom_error do
      CustomTestErrorV1.new "Custom test error for Google::Cloud::Language::V1::LanguageService::Client#analyze_sentiment."
    end
    ...
    it "invokes analyze_sentiment without error" do
      ...
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Cloud::Language::V1::AnalyzeSentimentResponse

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of Google::Cloud::Language::V1::AnalyzeSentimentRequest, request
        assert_equal Gapic::Protobuf.coerce(document, to: Google::Cloud::Language::V1::Document), request.document
        assert_equal Gapic::Protobuf.coerce(encoding_type, to: Google::Cloud::Language::V1::EncodingType), request.encoding_type
        OpenStruct.new execute: expected_response
      end
      mock_stub = MockGrpcClientStubV1.new :analyze_sentiment, mock_method

      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1.new "analyze_sentiment"

      Google::Cloud::Language::V1::LanguageService::Stub.stub :new, mock_stub do
        Google::Cloud::Language::V1::LanguageService::Credentials.stub :default, mock_credentials do
  ...
  describe "analyze_entities" do
    let :custom_error do
      CustomTestErrorV1.new "Custom test error for Google::Cloud::Language::V1::LanguageService::Client#analyze_entities."
    end
    ...
    it "invokes analyze_entities without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Cloud::Language::V1::AnalyzeEntitiesResponse
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1.new "analyze_entities"
  ...
  describe "analyze_entity_sentiment" do
    let :custom_error do
      CustomTestErrorV1.new "Custom test error for Google::Cloud::Language::V1::LanguageService::Client#analyze_entity_sentiment."
    end
    ...
    it "invokes analyze_entity_sentiment without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Cloud::Language::V1::AnalyzeEntitySentimentResponse
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1.new "analyze_entity_sentiment"
  ...
  describe "analyze_syntax" do
    let :custom_error do
      CustomTestErrorV1.new "Custom test error for Google::Cloud::Language::V1::LanguageService::Client#analyze_syntax."
    end
    ...
    it "invokes analyze_syntax without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Cloud::Language::V1::AnalyzeSyntaxResponse
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1.new "analyze_syntax"
  ...
  describe "classify_text" do
    let :custom_error do
      CustomTestErrorV1.new "Custom test error for Google::Cloud::Language::V1::LanguageService::Client#classify_text."
    end
    ...
    it "invokes classify_text without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Cloud::Language::V1::ClassifyTextResponse
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1.new "classify_text"
  ...
  describe "annotate_text" do
    let :custom_error do
      CustomTestErrorV1.new "Custom test error for Google::Cloud::Language::V1::LanguageService::Client#annotate_text."
    end
    ...
    it "invokes annotate_text without error" do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Gapic::Protobuf.coerce expected_response, to: Google::Cloud::Language::V1::AnnotateTextResponse

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of Google::Cloud::Language::V1::AnnotateTextRequest, request
        assert_equal Gapic::Protobuf.coerce(document, to: Google::Cloud::Language::V1::Document), request.document
        assert_equal Gapic::Protobuf.coerce(features, to: Google::Cloud::Language::V1::AnnotateTextRequest::Features), request.features
        assert_equal Gapic::Protobuf.coerce(encoding_type, to: Google::Cloud::Language::V1::EncodingType), request.encoding_type
        OpenStruct.new execute: expected_response
      end
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1.new "annotate_text"
