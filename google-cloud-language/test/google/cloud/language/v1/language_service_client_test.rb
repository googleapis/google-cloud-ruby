...
class MockLanguageServiceCredentials_v1 < Google::Cloud::Language::V1::Credentials
...
describe Google::Cloud::Language::V1::LanguageServiceClient do
  ...
  describe 'analyze_sentiment' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Language::V1::LanguageServiceClient#analyze_sentiment."
    ...
    it 'invokes analyze_sentiment without error' do
      ...
      mock_stub = MockGrpcClientStub_v1.new(:analyze_sentiment, mock_method)

      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentials_v1.new("analyze_sentiment")

      Google::Cloud::Language::V1::LanguageService::Stub.stub(:new, mock_stub) do
        Google::Cloud::Language::V1::Credentials.stub(:default, mock_credentials) do
  ...
  describe 'analyze_entities' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Language::V1::LanguageServiceClient#analyze_entities."
    ...
    it 'invokes analyze_entities without error' do
      ...
      mock_stub = MockGrpcClientStub_v1.new(:analyze_entities, mock_method)

      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentials_v1.new("analyze_entities")
  ...
  describe 'analyze_entity_sentiment' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Language::V1::LanguageServiceClient#analyze_entity_sentiment."
    ...
    it 'invokes analyze_entity_sentiment without error' do
      ...
      mock_stub = MockGrpcClientStub_v1.new(:analyze_entity_sentiment, mock_method)

      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentials_v1.new("analyze_entity_sentiment")
  ...
  describe 'analyze_syntax' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Language::V1::LanguageServiceClient#analyze_syntax."
    ...
    it 'invokes analyze_syntax without error' do
      ...
      mock_stub = MockGrpcClientStub_v1.new(:analyze_syntax, mock_method)

      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentials_v1.new("analyze_syntax")
  ...
  describe 'classify_text' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Language::V1::LanguageServiceClient#classify_text."
    ...
    it 'invokes classify_text without error' do
      ...
      mock_stub = MockGrpcClientStub_v1.new(:classify_text, mock_method)

      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentials_v1.new("classify_text")
  ...
  describe 'annotate_text' do
    custom_error = CustomTestError_v1.new "Custom test error for Google::Cloud::Language::V1::LanguageServiceClient#annotate_text."
    ...
    it 'invokes annotate_text without error' do
      ...
      mock_stub = MockGrpcClientStub_v1.new(:annotate_text, mock_method)

      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentials_v1.new("annotate_text")
