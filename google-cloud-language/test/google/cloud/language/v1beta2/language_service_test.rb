...
describe Google::Cloud::Language::V1beta2::LanguageService::Client do
  describe "analyze_sentiment" do
    ...
    it "invokes analyze_sentiment without error" do
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1beta2.new "analyze_sentiment"
  ...
  describe "analyze_entities" do
    ...
    it "invokes analyze_entities without error" do
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1beta2.new "analyze_entities"
  ...
  describe "analyze_entity_sentiment" do
    ...
    it "invokes analyze_entity_sentiment without error" do
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1beta2.new "analyze_entity_sentiment"
  ...
  describe "analyze_syntax" do
    ...
    it "invokes analyze_syntax without error" do
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1beta2.new "analyze_syntax"
  ...
  describe "classify_text" do
    ...
    it "invokes classify_text without error" do
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1beta2.new "classify_text"
  ...
  describe "annotate_text" do
    ...
    it "invokes annotate_text without error" do
      ...
      # Mock auth layer
      mock_credentials = MockLanguageServiceCredentialsV1beta2.new "annotate_text"
