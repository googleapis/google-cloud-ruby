...
describe Google::Cloud::Language::V1beta2::LanguageServiceClient do
  ...
  describe 'analyze_sentiment' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Language::V1beta2::LanguageServiceClient#analyze_sentiment."
  ...
  describe 'analyze_entities' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Language::V1beta2::LanguageServiceClient#analyze_entities."
  ...
  describe 'analyze_entity_sentiment' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Language::V1beta2::LanguageServiceClient#analyze_entity_sentiment."
  ...
  describe 'analyze_syntax' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Language::V1beta2::LanguageServiceClient#analyze_syntax."
  ...
  describe 'classify_text' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Language::V1beta2::LanguageServiceClient#classify_text."
  ...
  describe 'annotate_text' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Language::V1beta2::LanguageServiceClient#annotate_text."
