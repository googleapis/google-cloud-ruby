# Ruby Client for the Security Command Center V1P1BETA1 API
...
specific version of the Security Command Center V1P1BETA1 API. Most users should consider using
the main client gem,
