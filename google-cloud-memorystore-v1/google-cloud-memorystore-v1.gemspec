...
require File.expand_path("lib/google/cloud/memorystore/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-memorystore-v1"
  gem.version       = Google::Cloud::Memorystore::V1::VERSION
  ...
  gem.summary       = "API Client library for the Memorystore V1 API"
