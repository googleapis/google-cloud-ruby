...
# Delete the Google::Cloud::Batch.iam_policy method and test
# until https://github.com/googleapis/gapic-generator-ruby/issues/775 is fixed
OwlBot.modifier path: "lib/google/cloud/batch.rb",
                name: "delete-iam-policy-factory" do |content|
  OwlBot::RubyContent
    .new(content)
    .select_block("module Google")
    .select_block("module Cloud")
    .select_block("module Batch")
    .select_block("def self.iam_policy")
    .delete
end
OwlBot.modifier path: "test/google/cloud/batch/client_test.rb",
                name: "delete-iam-policy-factory-test" do |content|
  OwlBot::RubyContent
    .new(content)
    .select_block("class Google::Cloud::Batch::ClientConstructionMinitest")
    .select_block("def test_iam_policy")
    .delete
end

# Delete the Google::Cloud::Batch.locations method and test
# until https://github.com/googleapis/gapic-generator-ruby/issues/775 is fixed
OwlBot.modifier path: "lib/google/cloud/batch.rb",
