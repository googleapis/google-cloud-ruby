...
The gem `google-cloud-batch` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-batch/latest)
for this library, google-cloud-batch, to see the convenience methods for
...
```
$ gem install google-cloud-batch
```
...
client library with a name such as `google-cloud-batch`,
...
is part of the name, e.g. `google-cloud-batch-v1`.
