...
module Google
  module Cloud
    module DiscoveryEngine
      ...
      # [Google::Cloud::DiscoveryEngine::V1beta::CompletionService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-discovery_engine-v1beta/latest/Google-Cloud-DiscoveryEngine-V1beta-CompletionService-Client)
      ...
      #
      def self.completion_service version: :v1beta, transport: :grpc, &block
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::DiscoveryEngine::V1beta::DocumentService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-discovery_engine-v1beta/latest/Google-Cloud-DiscoveryEngine-V1beta-DocumentService-Client)
      # for a gRPC client for version V1beta of the API.
      # However, you can specify a different API version by passing it in the
      ...
      # @return [::Object] A client object for the specified version.
      #
      def self.document_service version: :v1beta, transport: :grpc, &block
        require "google/cloud/discovery_engine/#{version.to_s.downcase}"
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::DiscoveryEngine::V1beta::RecommendationService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-discovery_engine-v1beta/latest/Google-Cloud-DiscoveryEngine-V1beta-RecommendationService-Client)
      # for a gRPC client for version V1beta of the API.
      # However, you can specify a different API version by passing it in the
      ...
      # @return [::Object] A client object for the specified version.
      #
      def self.recommendation_service version: :v1beta, transport: :grpc, &block
        require "google/cloud/discovery_engine/#{version.to_s.downcase}"
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::DiscoveryEngine::V1beta::SchemaService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-discovery_engine-v1beta/latest/Google-Cloud-DiscoveryEngine-V1beta-SchemaService-Client)
      # for a gRPC client for version V1beta of the API.
      # However, you can specify a different API version by passing it in the
      ...
      # @return [::Object] A client object for the specified version.
      #
      def self.schema_service version: :v1beta, transport: :grpc, &block
        require "google/cloud/discovery_engine/#{version.to_s.downcase}"
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::DiscoveryEngine::V1beta::SearchService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-discovery_engine-v1beta/latest/Google-Cloud-DiscoveryEngine-V1beta-SearchService-Client)
      # for a gRPC client for version V1beta of the API.
      # However, you can specify a different API version by passing it in the
      ...
      # @return [::Object] A client object for the specified version.
      #
      def self.search_service version: :v1beta, transport: :grpc, &block
        require "google/cloud/discovery_engine/#{version.to_s.downcase}"
      ...
      #
      # By default, this returns an instance of
      # [Google::Cloud::DiscoveryEngine::V1beta::UserEventService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-discovery_engine-v1beta/latest/Google-Cloud-DiscoveryEngine-V1beta-UserEventService-Client)
      # for a gRPC client for version V1beta of the API.
      # However, you can specify a different API version by passing it in the
      ...
      # @return [::Object] A client object for the specified version.
      #
      def self.user_event_service version: :v1beta, transport: :grpc, &block
        require "google/cloud/discovery_engine/#{version.to_s.downcase}"
