...
specific version of the Cloud Profiler V2 API. Most users should consider using
the main client gem,
[google-cloud-profiler](https://rubygems.org/gems/google-cloud-profiler).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-profiler-v2
```
