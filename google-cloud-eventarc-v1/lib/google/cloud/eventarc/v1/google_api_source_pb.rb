  ...
  module Cloud
    module Eventarc
      module V1
        ...
        GoogleApiSource::ProjectSubscriptions = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.eventarc.v1.GoogleApiSource.ProjectSubscriptions").msgclass
        GoogleApiSource::OrganizationSubscription = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.eventarc.v1.GoogleApiSource.OrganizationSubscription").msgclass
      end
    end
  end
end
