...
class ::Google::Cloud::Vision::V1p3beta1::ProductSearch::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_product_set
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Vision::V1p3beta1::ProductSet.new
  ...
  def test_list_product_sets
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Vision::V1p3beta1::ListProductSetsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
  ...
  def test_create_product
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Vision::V1p3beta1::Product.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
  ...
  def test_list_products
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Vision::V1p3beta1::ListProductsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
  ...
  def test_create_reference_image
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Vision::V1p3beta1::ReferenceImage.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
  ...
  def test_list_reference_images
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Vision::V1p3beta1::ListReferenceImagesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
  ...
  def test_list_products_in_product_set
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Vision::V1p3beta1::ListProductsInProductSetResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Vision::V1p3beta1::ProductSearch::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Vision::V1p3beta1::ProductSearch::Operations, client.operations_client
  end
end
