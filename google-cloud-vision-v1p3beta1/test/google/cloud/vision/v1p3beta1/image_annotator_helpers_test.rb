...
class HelperMockImageAnnotatorCredentials < Google::Cloud::Vision::V1p3beta1::ImageAnnotator::Credentials
...
class ImageAnnotatorClientHelpersTest < Minitest::Test
  ...
  def test_crop_hints_detection_list_of_gcs_image_uris
    Google::Cloud::Vision::V1p3beta1::ImageAnnotator::Credentials.stub :default, mock_credentials do
