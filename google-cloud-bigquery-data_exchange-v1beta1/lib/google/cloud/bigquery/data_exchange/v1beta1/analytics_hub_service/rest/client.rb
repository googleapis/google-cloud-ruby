...
require "google/cloud/bigquery/data_exchange/v1beta1/analytics_hub_service/rest/service_stub"
          ...
          module AnalyticsHubService
            module Rest
              ...
              class Client
                ...
                #
                # See {::Google::Cloud::Bigquery::DataExchange::V1beta1::AnalyticsHubService::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all AnalyticsHubService clients
                #   ::Google::Cloud::Bigquery::DataExchange::V1beta1::AnalyticsHubService::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                #   client = ::Google::Cloud::Bigquery::DataExchange::V1beta1::AnalyticsHubService::Rest::Client.new do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                def initialize
                  ...
                  @analytics_hub_service_stub = ::Google::Cloud::Bigquery::DataExchange::V1beta1::AnalyticsHubService::Rest::ServiceStub.new(
                ...
                # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Bigquery::DataExchange::V1beta1::DataExchange>]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Bigquery::DataExchange::V1beta1::DataExchange>]
                #
                ...
                #     results.
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Bigquery::DataExchange::V1beta1::Listing>]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Bigquery::DataExchange::V1beta1::Listing>]
                #
                # @raise [::Google::Cloud::Error] if the REST call is aborted.
                #
                # @example Basic example
                ...
                # {::Google::Cloud::Bigquery::DataExchange::V1beta1::AnalyticsHubService::Rest::Client::Configuration::Rpcs}
