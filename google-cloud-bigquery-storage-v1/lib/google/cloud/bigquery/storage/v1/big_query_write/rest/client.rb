...
require "google/cloud/bigquery/storage/v1/big_query_write/rest/service_stub"
      ...
      module Storage
        module V1
          module BigQueryWrite
            module Rest
              ##
              # REST client for the BigQueryWrite service.
              #
              # BigQuery Write API.
              #
              ...
              class Client
                ...
                #
                # See {::Google::Cloud::Bigquery::Storage::V1::BigQueryWrite::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all BigQueryWrite clients
                #   ::Google::Cloud::Bigquery::Storage::V1::BigQueryWrite::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                ##
                # Create a new BigQueryWrite REST client object.
                #
                # @example
                #
                ...
                def initialize
                  ...
                  @big_query_write_stub = ::Google::Cloud::Bigquery::Storage::V1::BigQueryWrite::Rest::ServiceStub.new(
                  ...
                  @big_query_write_stub.logger(stub: true)&.info do |entry|
                ...
                def create_write_stream request, options = nil
                  ...
                  call_metadata = @config.rpcs.create_write_stream.metadata.to_h
                  ...
                  @big_query_write_stub.create_write_stream request, options do |result, operation|
                ...
                def get_write_stream request, options = nil
                  ...
                  # Customize the options with defaults
                  call_metadata = @config.rpcs.get_write_stream.metadata.to_h
                  ...
                  @big_query_write_stub.get_write_stream request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                def finalize_write_stream request, options = nil
                  ...
                  # Customize the options with defaults
                  call_metadata = @config.rpcs.finalize_write_stream.metadata.to_h
                  ...
                  @big_query_write_stub.finalize_write_stream request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                def batch_commit_write_streams request, options = nil
                  ...
                  # Customize the options with defaults
                  call_metadata = @config.rpcs.batch_commit_write_streams.metadata.to_h
                  ...
                  @big_query_write_stub.batch_commit_write_streams request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                def flush_rows request, options = nil
                  ...
                  # Customize the options with defaults
                  call_metadata = @config.rpcs.flush_rows.metadata.to_h
                  ...
                  @big_query_write_stub.flush_rows request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                ##
                # Configuration class for the BigQueryWrite REST API.
                #
                # This class represents the configuration for BigQueryWrite REST,
                # providing control over timeouts, retry behavior, logging, transport
                # parameters, and other low-level controls. Certain parameters can also be
                # applied individually to specific RPCs. See
                # {::Google::Cloud::Bigquery::Storage::V1::BigQueryWrite::Rest::Client::Configuration::Rpcs}
