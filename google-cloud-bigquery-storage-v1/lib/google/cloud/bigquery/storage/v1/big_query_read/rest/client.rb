...
require "google/cloud/bigquery/storage/v1/big_query_read/rest/service_stub"
      ...
      module Storage
        module V1
          module BigQueryRead
            module Rest
              ##
              # REST client for the BigQueryRead service.
              #
              # BigQuery Read API.
              #
              ...
              class Client
                ...
                #
                # See {::Google::Cloud::Bigquery::Storage::V1::BigQueryRead::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all BigQueryRead clients
                #   ::Google::Cloud::Bigquery::Storage::V1::BigQueryRead::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                ##
                # Create a new BigQueryRead REST client object.
                #
                # @example
                #
                ...
                def initialize
                  ...
                  @big_query_read_stub = ::Google::Cloud::Bigquery::Storage::V1::BigQueryRead::Rest::ServiceStub.new(
                  ...
                  @big_query_read_stub.logger(stub: true)&.info do |entry|
                ...
                # @yieldparam result [::Google::Cloud::Bigquery::Storage::V1::ReadSession]
                ...
                def create_read_session request, options = nil
                  ...
                  call_metadata = @config.rpcs.create_read_session.metadata.to_h
                  ...
                  @big_query_read_stub.create_read_session request, options do |result, operation|
                ...
                def read_rows request, options = nil
                  ...
                  # Customize the options with defaults
                  call_metadata = @config.rpcs.read_rows.metadata.to_h
                  ...
                  ::Gapic::Rest::ServerStream.new(
                    ...
                    ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                      @big_query_read_stub.read_rows request, options do |chunk|
                        in_q.deq
                        out_q.enq chunk
                      end
                    end
                ...
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Cloud::Bigquery::Storage::V1::SplitReadStreamResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                ...
                def split_read_stream request, options = nil
                  ...
                  # Customize the options with defaults
                  call_metadata = @config.rpcs.split_read_stream.metadata.to_h
                  ...
                  @big_query_read_stub.split_read_stream request, options do |result, operation|
                    yield result, operation if block_given?
                  end
                rescue ::Gapic::Rest::Error => e
                  raise ::Google::Cloud::Error.from_error(e)
                ...
                ##
                # Configuration class for the BigQueryRead REST API.
                #
                # This class represents the configuration for BigQueryRead REST,
                # providing control over timeouts, retry behavior, logging, transport
                # parameters, and other low-level controls. Certain parameters can also be
                # applied individually to specific RPCs. See
                # {::Google::Cloud::Bigquery::Storage::V1::BigQueryRead::Rest::Client::Configuration::Rpcs}
