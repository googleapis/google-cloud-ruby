...
In general, the google-cloud-bigquery-storage-v1 library uses [Service
...
The environment variables that google-cloud-bigquery-storage-v1 checks for credentials are configured on the service Credentials class (such as {Google::Cloud::Bigquery::Storage::V1::BigQueryRead::Credentials}):
