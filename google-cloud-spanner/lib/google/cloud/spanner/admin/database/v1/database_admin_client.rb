        ...
        module Database
          module V1
            ...
            class DatabaseAdminClient
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   response = database_admin_client.create_backup
              ...
              def create_backup \
                ...
                @create_backup.call(req, options, &block)
              end
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   response = database_admin_client.get_backup
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   response = database_admin_client.update_backup
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   database_admin_client.delete_backup
              ...
              #   retries, etc.
              # @yield [result, operation] Access the result along with the RPC operation
              # @yieldparam result [Google::Spanner::Admin::Database::V1::ListBackupsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   response = database_admin_client.list_backups
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   response = database_admin_client.restore_database
              ...
              def restore_database \
                ...
                @restore_database.call(req, options, &block)
              end
              ...
              #   retries, etc.
              # @yield [result, operation] Access the result along with the RPC operation
              # @yieldparam result [Google::Spanner::Admin::Database::V1::ListDatabaseOperationsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   response = database_admin_client.list_database_operations
              ...
              #   retries, etc.
              # @yield [result, operation] Access the result along with the RPC operation
              # @yieldparam result [Google::Spanner::Admin::Database::V1::ListBackupOperationsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              ...
              #
              #   database_admin_client = Google::Cloud::Spanner::Admin::Database.new(version: :v1)
              #   response = database_admin_client.list_backup_operations
