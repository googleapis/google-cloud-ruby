    ...
    module Spanner
      class Database
        ...
        class List < DelegateClass(::Array)
          ...
          ##
          # Retrieves all databases by repeatedly loading {#next} until {#next?}
          # returns `false`. Calls the given block once for each database
          # database, which is passed as the parameter.
          #
          # An Enumerator is returned if no block is given.
          #
          # This method may make several API calls until all databases are
