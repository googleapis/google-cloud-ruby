...
export SPANNER_TEST_PROJECT=emulator-test-project
...
trap "kill -2 $EMULATOR_PID; unset SPANNER_EMULATOR_HOST; unset SPANNER_TEST_PROJECT; echo \"Cleanup the emulator\";" EXIT
