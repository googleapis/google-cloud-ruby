...
describe "Spanner Client", :non_streaming, :params, :spanner do
  ...
  it "queries and returns an integer parameter" do
    results = db.execute "SELECT @value AS value", params: { value: 999 }, streaming: false
  ...
  it "queries and returns a float parameter" do
    results = db.execute "SELECT @value AS value", params: { value: 12.0 }, streaming: false
  ...
  it "queries and returns a float parameter (Infinity)" do
    results = db.execute "SELECT @value AS value", params: { value: Float::INFINITY }, streaming: false
  ...
  it "queries and returns a float parameter (-NaN)" do
    results = db.execute "SELECT @value AS value", params: { value: Float::NAN }, streaming: false
  ...
  it "queries and returns a boolean parameter" do
    results = db.execute "SELECT @value AS value", params: { value: false }, streaming: false
  ...
  it "queries and returns a date parameter" do
    today = Date.today
    results = db.execute "SELECT @value AS value", params: { value: today }, streaming: false
  ...
  it "queries and returns a datetime parameter" do
    now = Time.now.utc
    results = db.execute "SELECT @value AS value", params: { value: now.to_datetime }, streaming: false

    results.must_be_kind_of Google::Cloud::Spanner::Results
    results.types[:value].must_equal :TIMESTAMP
    results.rows.first[:value].must_be_close_to now, 1
  end

  it "queries and returns a timestamp parameter" do
    now = Time.now
    results = db.execute "SELECT @value AS value", params: { value: now }, streaming: false
  ...
  it "queries and returns a bytes parameter" do
    results = db.execute "SELECT @value AS value", params: { value: StringIO.new("hello world!") }, streaming: false
  ...
  it "queries a string parameter and returns bytes" do
    results = db.execute "SELECT CAST(@value AS BYTES) AS value", params: { value: "hello world!" }, streaming: false
  ...
  it "queries a bytes parameter and returns string" do
    results = db.execute "SELECT CAST(@value AS STRING) AS value", params: { value: StringIO.new("hello world!") }, streaming: false, streaming: false
  ...
  it "queries and returns an array of integers parameter" do
    results = db.execute "SELECT @value AS value", params: { value: [1, 2, 3, 4] }, streaming: false
  ...
  it "queries and returns an array of strings parameter" do
    results = db.execute "SELECT @value AS value", params: { value: ["foo", "bar", "baz"] }, streaming: false
  ...
  it "queries and returns a struct parameter" do
    ...
    results = db.execute "SELECT @value AS value", params: { value: { message: "hello", repeat: 1 } }, streaming: false
  ...
  it "queries a struct parameter and returns string and integer" do
    ...
    results = db.execute "SELECT @value.message AS message, @value.repeat AS repeat", params: { value: { message: "hello", repeat: 1 } }, streaming: false
