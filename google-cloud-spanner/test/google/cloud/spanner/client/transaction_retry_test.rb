...
describe Google::Cloud::Spanner::Client, :transaction, :retry, :mock_spanner do
  ...
  it "retries aborted transactions without retry metadata" do
    ...
    mock.expect :execute_streaming_sql, results_enum, [session_grpc.name, "SELECT * FROM users", transaction: tx_selector, params: nil, param_types: nil, resume_token: nil, partition_token: nil, partition_token: nil, options: default_options]
