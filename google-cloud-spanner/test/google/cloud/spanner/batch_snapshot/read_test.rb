...
describe Google::Cloud::Spanner::BatchSnapshot, :read, :mock_spanner do
  ...
  it "can read all rows" do
    ...
    mock.expect :streaming_read, results_enum, [session_name, "my-table", ["id", "name", "active", "age", "score", "updated_at", "birthday", "avatar", "project_ids"], Google::Spanner::V1::KeySet.new(all: true), transaction: tx_selector, index: nil, limit: nil, resume_token: nil, partition_token: nil, options: default_options]
  ...
  it "can read rows by id" do
    ...
    mock = Minitest::Mock.new
    mock.expect :streaming_read, results_enum, [session_name, "my-table", ["id", "name", "active", "age", "score", "updated_at", "birthday", "avatar", "project_ids"], Google::Spanner::V1::KeySet.new(keys: [Google::Cloud::Spanner::Convert.raw_to_value([1]).list_value, Google::Cloud::Spanner::Convert.raw_to_value([2]).list_value, Google::Cloud::Spanner::Convert.raw_to_value([3]).list_value]), transaction: tx_selector, index: nil, limit: nil, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
  ...
  it "can read rows with index" do
    ...
    mock = Minitest::Mock.new
    mock.expect :streaming_read, results_enum, [session_name, "my-table", ["id", "name", "active", "age", "score", "updated_at", "birthday", "avatar", "project_ids"], Google::Spanner::V1::KeySet.new(keys: [Google::Cloud::Spanner::Convert.raw_to_value([1,1]).list_value, Google::Cloud::Spanner::Convert.raw_to_value([2,2]).list_value, Google::Cloud::Spanner::Convert.raw_to_value([3,3]).list_value]), transaction: tx_selector, index: "MyTableCompositeKey", limit: nil, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
  ...
  it "can read rows with index and range" do
    ...
    mock = Minitest::Mock.new
    mock.expect :streaming_read, results_enum, [session_name, "my-table", ["id", "name", "active", "age", "score", "updated_at", "birthday", "avatar", "project_ids"], Google::Spanner::V1::KeySet.new(ranges: [Google::Cloud::Spanner::Convert.to_key_range([1,1]..[3,3])]), transaction: tx_selector, index: "MyTableCompositeKey", limit: nil, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
  ...
  it "can read rows with limit" do
    ...
    mock = Minitest::Mock.new
    mock.expect :streaming_read, results_enum, [session_name, "my-table", ["id", "name", "active", "age", "score", "updated_at", "birthday", "avatar", "project_ids"], Google::Spanner::V1::KeySet.new(all: true), transaction: tx_selector, index: nil, limit: 5, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
  ...
  it "can read just one row with limit" do
    ...
    mock = Minitest::Mock.new
    mock.expect :streaming_read, results_enum, [session_name, "my-table", ["id", "name", "active", "age", "score", "updated_at", "birthday", "avatar", "project_ids"], Google::Spanner::V1::KeySet.new(keys: [Google::Cloud::Spanner::Convert.raw_to_value([1]).list_value]), transaction: tx_selector, index: nil, limit: 1, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
