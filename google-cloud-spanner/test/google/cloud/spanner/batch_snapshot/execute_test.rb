...
describe Google::Cloud::Spanner::BatchSnapshot, :execute, :mock_spanner do
  ...
  it "can execute a simple query" do
    ...
    mock.expect :execute_streaming_sql, results_enum, [session_name, "SELECT * FROM users", transaction: tx_selector, params: nil, param_types: nil, resume_token: nil, partition_token: nil, options: default_options]
  ...
  it "can execute a query with bool param" do
    mock = Minitest::Mock.new
    mock.expect :execute_streaming_sql, results_enum, [session_name, "SELECT * FROM users WHERE active = @active", transaction: tx_selector, params: Google::Protobuf::Struct.new(fields: { "active" => Google::Protobuf::Value.new(bool_value: true) }), param_types: { "active" => Google::Spanner::V1::Type.new(code: :BOOL) }, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
  ...
  it "can execute a query with int param" do
    mock = Minitest::Mock.new
    mock.expect :execute_streaming_sql, results_enum, [session_name, "SELECT * FROM users WHERE age = @age", transaction: tx_selector, params: Google::Protobuf::Struct.new(fields: { "age" => Google::Protobuf::Value.new(string_value: "29") }), param_types: { "age" => Google::Spanner::V1::Type.new(code: :INT64) }, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
  ...
  it "can execute a query with IO-ish param" do
    ...
    mock = Minitest::Mock.new
    mock.expect :execute_streaming_sql, results_enum, [session_name, "SELECT * FROM users WHERE avatar = @avatar", transaction: tx_selector, params: Google::Protobuf::Struct.new(fields: { "avatar" => Google::Protobuf::Value.new(string_value: Base64.strict_encode64("contents")) }), param_types: { "avatar" => Google::Spanner::V1::Type.new(code: :BYTES) }, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
  ...
  it "can execute a query with an empty Hash param" do
    ...
    mock = Minitest::Mock.new
    mock.expect :execute_streaming_sql, results_enum, [session_name, "SELECT * FROM users WHERE settings = @dict", transaction: tx_selector, params: Google::Protobuf::Struct.new(fields: { "dict" => Google::Protobuf::Value.new(struct_value: Google::Protobuf::Struct.new(fields: {})) }), param_types: { "dict" => Google::Spanner::V1::Type.new(code: :STRUCT, struct_type: Google::Spanner::V1::StructType.new(fields: [])) }, resume_token: nil, partition_token: nil, options: default_options]
    batch_snapshot.service.mocked_service = mock
