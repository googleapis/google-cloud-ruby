...
require File.expand_path("lib/google/shopping/merchant/order_tracking/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-order_tracking"
  gem.version       = Google::Shopping::Merchant::OrderTracking::VERSION
  ...
  gem.add_dependency "google-shopping-merchant-order_tracking-v1beta", ">= 0.0", "< 2.a"
end
