...
require "google/cloud/web_security_scanner/version"
...
::Google::Cloud.configure.add_config! :web_security_scanner do |config|
  config.add_field! :endpoint,      "websecurityscanner.googleapis.com", match: ::String
...
module Google
  module Cloud
    module WebSecurityScanner
      ...
      #   Defaults to `:v1`.
      # @return [WebSecurityScanner::Client] A client object for the specified version.
      #
      def self.web_security_scanner version: :v1, &block
        ...
        package_name = Google::Cloud::WebSecurityScanner
                       ...
                       .first
        package_module = Google::Cloud::WebSecurityScanner.const_get package_name
        package_module.const_get(:WebSecurityScanner).const_get(:Client).new(&block)
      end
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.web_security_scanner if block_given?

        ::Google::Cloud.configure.web_security_scanner
      end
    end
  end
end
