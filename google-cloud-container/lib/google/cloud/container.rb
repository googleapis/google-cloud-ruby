...
module Google
  module Cloud
    module Container
      ...
      # given API version does not support the given transport of the ClusterManager service.
      ...
      #
      def self.cluster_manager version: :v1, transport: :grpc, &block
        ...
        package_name = Google::Cloud::Container
                       ...
                       .first
        service_module = Google::Cloud::Container.const_get(package_name).const_get(:ClusterManager)
      ...
      #
      def self.cluster_manager_available? version: :v1, transport: :grpc
        require "google/cloud/container/#{version.to_s.downcase}"
        package_name = Google::Cloud::Container
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
