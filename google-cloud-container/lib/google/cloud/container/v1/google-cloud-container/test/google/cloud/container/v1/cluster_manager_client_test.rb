...
describe Google::Cloud::Container::V1::ClusterManagerClient do
  ...
  describe 'start_i_p_rotation' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Container::V1::ClusterManagerClient#start_i_p_rotation."

    it 'invokes start_i_p_rotation without error' do
      # Create request parameters
      project_id = ''
      zone = ''
      cluster_id = ''
      ...
      mock_stub = MockGrpcClientStub.new(:start_i_p_rotation, mock_method)

      # Mock auth layer
      mock_credentials = MockClusterManagerCredentials.new("start_i_p_rotation")
    ...
    it 'invokes start_i_p_rotation with error' do
      # Create request parameters
      project_id = ''
      zone = ''
      cluster_id = ''
  ...
  describe 'complete_i_p_rotation' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Container::V1::ClusterManagerClient#complete_i_p_rotation."

    it 'invokes complete_i_p_rotation without error' do
      # Create request parameters
      project_id = ''
      zone = ''
      cluster_id = ''
      ...
      mock_stub = MockGrpcClientStub.new(:complete_i_p_rotation, mock_method)

      # Mock auth layer
      mock_credentials = MockClusterManagerCredentials.new("complete_i_p_rotation")
    ...
    it 'invokes complete_i_p_rotation with error' do
      # Create request parameters
      project_id = ''
      zone = ''
      cluster_id = ''
