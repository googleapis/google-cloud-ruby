  ...
  def test_compute_threat_list_diff
    ...
    ::Google::Cloud::WebRisk::V1::WebRiskService::Rest::ServiceStub.stub :transcode_compute_threat_list_diff_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, compute_threat_list_diff_client_stub do
        # Create client
        c = ::Google::Cloud::WebRisk::V1::WebRiskService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.compute_threat_list_diff ::Google::Cloud::WebRisk::V1::ComputeThreatListDiffRequest.new(threat_type: threat_type, version_token: version_token, constraints: constraints) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.compute_threat_list_diff(::Google::Cloud::WebRisk::V1::ComputeThreatListDiffRequest.new(threat_type: threat_type, version_token: version_token, constraints: constraints), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_search_uris
    ...
    ::Google::Cloud::WebRisk::V1::WebRiskService::Rest::ServiceStub.stub :transcode_search_uris_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_uris_client_stub do
        ...
        # Use protobuf object
        c.search_uris ::Google::Cloud::WebRisk::V1::SearchUrisRequest.new(uri: uri, threat_types: threat_types) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.search_uris(::Google::Cloud::WebRisk::V1::SearchUrisRequest.new(uri: uri, threat_types: threat_types), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_search_hashes
    ...
    ::Google::Cloud::WebRisk::V1::WebRiskService::Rest::ServiceStub.stub :transcode_search_hashes_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_hashes_client_stub do
        ...
        # Use protobuf object
        c.search_hashes ::Google::Cloud::WebRisk::V1::SearchHashesRequest.new(hash_prefix: hash_prefix, threat_types: threat_types) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.search_hashes(::Google::Cloud::WebRisk::V1::SearchHashesRequest.new(hash_prefix: hash_prefix, threat_types: threat_types), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_submission
    ...
    ::Google::Cloud::WebRisk::V1::WebRiskService::Rest::ServiceStub.stub :transcode_create_submission_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_submission_client_stub do
        ...
        # Use hash object
        c.create_submission({ parent: parent, submission: submission }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.create_submission ::Google::Cloud::WebRisk::V1::CreateSubmissionRequest.new(parent: parent, submission: submission) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.create_submission({ parent: parent, submission: submission }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.create_submission(::Google::Cloud::WebRisk::V1::CreateSubmissionRequest.new(parent: parent, submission: submission), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_submit_uri
    ...
    ::Google::Cloud::WebRisk::V1::WebRiskService::Rest::ServiceStub.stub :transcode_submit_uri_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, submit_uri_client_stub do
        ...
        # Use hash object
        c.submit_uri({ parent: parent, submission: submission, threat_info: threat_info, threat_discovery: threat_discovery }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.submit_uri ::Google::Cloud::WebRisk::V1::SubmitUriRequest.new(parent: parent, submission: submission, threat_info: threat_info, threat_discovery: threat_discovery) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.submit_uri({ parent: parent, submission: submission, threat_info: threat_info, threat_discovery: threat_discovery }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.submit_uri(::Google::Cloud::WebRisk::V1::SubmitUriRequest.new(parent: parent, submission: submission, threat_info: threat_info, threat_discovery: threat_discovery), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
