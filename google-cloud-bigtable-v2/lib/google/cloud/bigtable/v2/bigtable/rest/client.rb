...
require "google/cloud/bigtable/v2/bigtable/rest/service_stub"
    ...
    module Bigtable
      module V2
        module Bigtable
          module Rest
            ##
            # REST client for the Bigtable service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Bigtable::V2::Bigtable::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all Bigtable clients
              #   ::Google::Cloud::Bigtable::V2::Bigtable::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new Bigtable REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @bigtable_stub = ::Google::Cloud::Bigtable::V2::Bigtable::Rest::ServiceStub.new(
                ...
                @bigtable_stub.logger(stub: true)&.info do |entry|
              ...
              def read_rows request, options = nil
                ...
                ::Gapic::Rest::ServerStream.new(
                  ...
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @bigtable_stub.read_rows request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              def sample_row_keys request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.sample_row_keys.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Bigtable::V2::SampleRowKeysResponse,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @bigtable_stub.sample_row_keys request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              def mutate_row request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.mutate_row.metadata.to_h
                ...
                @bigtable_stub.mutate_row request, options do |result, operation|
              ...
              def mutate_rows request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.mutate_rows.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Bigtable::V2::MutateRowsResponse,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @bigtable_stub.mutate_rows request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              def check_and_mutate_row request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.check_and_mutate_row.metadata.to_h
                ...
                @bigtable_stub.check_and_mutate_row request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def ping_and_warm request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.ping_and_warm.metadata.to_h
                ...
                @bigtable_stub.ping_and_warm request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def read_modify_write_row request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.read_modify_write_row.metadata.to_h
                ...
                @bigtable_stub.read_modify_write_row request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def generate_initial_change_stream_partitions request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.generate_initial_change_stream_partitions.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Bigtable::V2::GenerateInitialChangeStreamPartitionsResponse,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @bigtable_stub.generate_initial_change_stream_partitions request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              def read_change_stream request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.read_change_stream.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Bigtable::V2::ReadChangeStreamResponse,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @bigtable_stub.read_change_stream request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              def prepare_query request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.prepare_query.metadata.to_h
                ...
                @bigtable_stub.prepare_query request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def execute_query request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.execute_query.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Bigtable::V2::ExecuteQueryResponse,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @bigtable_stub.execute_query request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              ##
              # Configuration class for the Bigtable REST API.
              #
              # This class represents the configuration for Bigtable REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::Bigtable::V2::Bigtable::Rest::Client::Configuration::Rpcs}
