...
class ::Google::Cloud::Bigquery::DataPolicies::V1::DataPolicyService::ClientTest < Minitest::Test
  ...
  def test_create_data_policy
    ...
    Gapic::ServiceStub.stub :new, create_data_policy_client_stub do
      # Create client
      c = ::Google::Cloud::Bigquery::DataPolicies::V1::DataPolicyService::Client.new do |config|
      ...
      # Use protobuf object
      c.create_data_policy ::Google::Cloud::Bigquery::DataPolicies::V1::CreateDataPolicyRequest.new(parent: parent, data_policy: data_policy) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.create_data_policy(::Google::Cloud::Bigquery::DataPolicies::V1::CreateDataPolicyRequest.new(parent: parent, data_policy: data_policy), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_data_policy
    ...
    Gapic::ServiceStub.stub :new, update_data_policy_client_stub do
      ...
      # Use protobuf object
      c.update_data_policy ::Google::Cloud::Bigquery::DataPolicies::V1::UpdateDataPolicyRequest.new(data_policy: data_policy, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_data_policy(::Google::Cloud::Bigquery::DataPolicies::V1::UpdateDataPolicyRequest.new(data_policy: data_policy, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_rename_data_policy
    ...
    Gapic::ServiceStub.stub :new, rename_data_policy_client_stub do
      ...
      # Use hash object
      c.rename_data_policy({ name: name, new_data_policy_id: new_data_policy_id }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.rename_data_policy ::Google::Cloud::Bigquery::DataPolicies::V1::RenameDataPolicyRequest.new(name: name, new_data_policy_id: new_data_policy_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.rename_data_policy({ name: name, new_data_policy_id: new_data_policy_id }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.rename_data_policy(::Google::Cloud::Bigquery::DataPolicies::V1::RenameDataPolicyRequest.new(name: name, new_data_policy_id: new_data_policy_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_data_policy
    ...
    Gapic::ServiceStub.stub :new, delete_data_policy_client_stub do
      ...
      # Use protobuf object
      c.delete_data_policy ::Google::Cloud::Bigquery::DataPolicies::V1::DeleteDataPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_data_policy(::Google::Cloud::Bigquery::DataPolicies::V1::DeleteDataPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_data_policy
    ...
    Gapic::ServiceStub.stub :new, get_data_policy_client_stub do
      ...
      # Use protobuf object
      c.get_data_policy ::Google::Cloud::Bigquery::DataPolicies::V1::GetDataPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_data_policy(::Google::Cloud::Bigquery::DataPolicies::V1::GetDataPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_data_policies
    ...
    Gapic::ServiceStub.stub :new, list_data_policies_client_stub do
      ...
      # Use hash object
      c.list_data_policies({ parent: parent, page_size: page_size, page_token: page_token, filter: filter }) do |response, operation|
      ...
      # Use protobuf object
      c.list_data_policies ::Google::Cloud::Bigquery::DataPolicies::V1::ListDataPoliciesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      c.list_data_policies({ parent: parent, page_size: page_size, page_token: page_token, filter: filter }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_data_policies(::Google::Cloud::Bigquery::DataPolicies::V1::ListDataPoliciesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
