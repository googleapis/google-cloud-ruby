...
In general, the google-analytics-data-v1alpha library uses
...
The google-analytics-data-v1alpha library aims to make authentication
...
The environment variables that google-analytics-data-v1alpha
checks for credentials are configured on the service Credentials class (such as
{::Google::Analytics::Data::V1alpha::AnalyticsData::Credentials}):

1. `ANALYTICS_CREDENTIALS` - Path to JSON file, or JSON contents
2. `ANALYTICS_KEYFILE` - Path to JSON file, or JSON contents
...
connect to most services with google-analytics-data-v1alpha.
