# Ruby Client for the Google Analytics Data V1alpha API

API Client library for the Google Analytics Data V1alpha API
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-analytics-data-v1alpha/latest)
