    ...
    module Data
      module V1alpha
        ...
        class DimensionExpression
          ...
          class ConcatenateExpression; end
        end
        ...
        class CohortReportSettings; end
        ...
        class QuotaStatus; end

        # Explains a dimension.
        # @!attribute [rw] api_name
        #   @return [String]
        #     This dimension's name. Useable in [Dimension](https://cloud.google.com#Dimension)'s `name`. For
        #     example, `eventName`.
        ...
        class DimensionMetadata; end

        # Explains a metric.
        # @!attribute [rw] api_name
        #   @return [String]
        #     A metric name. Useable in [Metric](https://cloud.google.com#Metric)'s `name`. For example,
        #     `eventCount`.
        # @!attribute [rw] ui_name
        #   @return [String]
        ...
        #     [Metric](https://cloud.google.com#Metric)'s `expression` field for equivalent reports. Most metrics
        #     are not expressions, and for non-expressions, this field is empty.
        # @!attribute [rw] custom_definition
        #   @return [true, false]
        #     True if the metric is a custom metric for this property.
        class MetricMetadata; end
