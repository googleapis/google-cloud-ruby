  ...
  module Analytics
    module Data
      module V1alpha
        ...
        #     Toggles whether to return the current state of this Analytics Property's
        #     quota. Quota is returned in [PropertyQuota](https://cloud.google.com#PropertyQuota).
        class RunPivotReportRequest; end
        ...
        #   @return [Google::Analytics::Data::V1alpha::PropertyQuota]
        #     This Analytics Property's quota state including this request.
        class RunPivotReportResponse; end
        ...
        class RunRealtimeReportRequest; end
        ...
        class RunRealtimeReportResponse; end
      end
    end
  end
end