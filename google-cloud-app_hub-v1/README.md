...
specific version of the App Hub V1 API. Most users should consider using
the main client gem,
[google-cloud-app_hub](https://rubygems.org/gems/google-cloud-app_hub).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-app_hub-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-app_hub-v1/latest)
