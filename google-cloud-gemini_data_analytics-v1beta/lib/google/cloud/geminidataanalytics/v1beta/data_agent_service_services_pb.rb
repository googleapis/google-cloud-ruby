      ...
      module V1beta
        module DataAgentService
          ...
          class Service
            ...
            rpc :SetAgentOpsObservability, ::Google::Cloud::GeminiDataAnalytics::V1beta::SetAgentOpsObservabilityRequest, ::Google::Longrunning::Operation
            # Gets AgentOps observability settings and status of required services.
            rpc :RetrieveAgentOpsObservability, ::Google::Cloud::GeminiDataAnalytics::V1beta::RetrieveAgentOpsObservabilityRequest, ::Google::Cloud::GeminiDataAnalytics::V1beta::RetrieveAgentOpsObservabilityResponse
          end
