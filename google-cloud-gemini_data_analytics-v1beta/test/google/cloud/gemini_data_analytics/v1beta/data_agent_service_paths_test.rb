...
class ::Google::Cloud::GeminiDataAnalytics::V1beta::DataAgentService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_data_agent_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.data_agent_path project: "value0", location: "value1", data_agent: "value2"
      assert_equal "projects/value0/locations/value1/dataAgents/value2", path
    end
  end
