...
##
# Snippet for the update_workload_identity_pool_provider call in the WorkloadIdentityPools service
#
...
# Google::Iam::V1beta::WorkloadIdentityPools::Client#update_workload_identity_pool_provider.
#
