...
require "google/iam/v1beta/workload_identity_pools/rest/service_stub"
  ...
  module Iam
    module V1beta
      module WorkloadIdentityPools
        module Rest
          ##
          # REST client for the WorkloadIdentityPools service.
          #
          ...
          class Client
            ...
            #
            # See {::Google::Iam::V1beta::WorkloadIdentityPools::Rest::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all WorkloadIdentityPools clients
            #   ::Google::Iam::V1beta::WorkloadIdentityPools::Rest::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            ##
            # Create a new WorkloadIdentityPools REST client object.
            #
            # @example
            #
            ...
            def initialize
              ...
              @operations_client = ::Google::Iam::V1beta::WorkloadIdentityPools::Rest::Operations.new do |config|
              ...
              @workload_identity_pools_stub = ::Google::Iam::V1beta::WorkloadIdentityPools::Rest::ServiceStub.new(
              ...
              @workload_identity_pools_stub.logger(stub: true)&.info do |entry|
            ...
            #
            # @return [::Google::Iam::V1beta::WorkloadIdentityPools::Rest::Operations]
            #
            ...
            # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Iam::V1beta::WorkloadIdentityPool>]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Gapic::Rest::PagedEnumerable<::Google::Iam::V1beta::WorkloadIdentityPool>]
            #
            ...
            def list_workload_identity_pools request, options = nil
              ...
              call_metadata = @config.rpcs.list_workload_identity_pools.metadata.to_h
              ...
              @workload_identity_pools_stub.list_workload_identity_pools request, options do |result, operation|
                result = ::Gapic::Rest::PagedEnumerable.new @workload_identity_pools_stub, :list_workload_identity_pools, "workload_identity_pools", request, result, options
            ...
            def get_workload_identity_pool request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.get_workload_identity_pool.metadata.to_h
              ...
              @workload_identity_pools_stub.get_workload_identity_pool request, options do |result, operation|
                yield result, operation if block_given?
              end
            rescue ::Gapic::Rest::Error => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def create_workload_identity_pool request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.create_workload_identity_pool.metadata.to_h
              ...
              @workload_identity_pools_stub.create_workload_identity_pool request, options do |result, operation|
            ...
            def update_workload_identity_pool request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.update_workload_identity_pool.metadata.to_h
              ...
              @workload_identity_pools_stub.update_workload_identity_pool request, options do |result, operation|
                result = ::Gapic::Operation.new result, @operations_client, options: options
                yield result, operation if block_given?
                throw :response, result
              end
            ...
            def delete_workload_identity_pool request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.delete_workload_identity_pool.metadata.to_h
              ...
              @workload_identity_pools_stub.delete_workload_identity_pool request, options do |result, operation|
                result = ::Gapic::Operation.new result, @operations_client, options: options
                yield result, operation if block_given?
                throw :response, result
              end
            ...
            def undelete_workload_identity_pool request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.undelete_workload_identity_pool.metadata.to_h
              ...
              @workload_identity_pools_stub.undelete_workload_identity_pool request, options do |result, operation|
                result = ::Gapic::Operation.new result, @operations_client, options: options
                yield result, operation if block_given?
                throw :response, result
              end
            ...
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Iam::V1beta::WorkloadIdentityPoolProvider>]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Gapic::Rest::PagedEnumerable<::Google::Iam::V1beta::WorkloadIdentityPoolProvider>]
            #
            # @raise [::Google::Cloud::Error] if the REST call is aborted.
            #
            # @example Basic example
            ...
            def list_workload_identity_pool_providers request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.list_workload_identity_pool_providers.metadata.to_h
              ...
              @workload_identity_pools_stub.list_workload_identity_pool_providers request, options do |result, operation|
                result = ::Gapic::Rest::PagedEnumerable.new @workload_identity_pools_stub, :list_workload_identity_pool_providers, "workload_identity_pool_providers", request, result, options
                yield result, operation if block_given?
                throw :response, result
              end
            rescue ::Gapic::Rest::Error => e
            ...
            def get_workload_identity_pool_provider request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.get_workload_identity_pool_provider.metadata.to_h
              ...
              @workload_identity_pools_stub.get_workload_identity_pool_provider request, options do |result, operation|
                yield result, operation if block_given?
              end
            rescue ::Gapic::Rest::Error => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def create_workload_identity_pool_provider request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.create_workload_identity_pool_provider.metadata.to_h
              ...
              @workload_identity_pools_stub.create_workload_identity_pool_provider request, options do |result, operation|
                result = ::Gapic::Operation.new result, @operations_client, options: options
                yield result, operation if block_given?
                throw :response, result
              end
            ...
            def update_workload_identity_pool_provider request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.update_workload_identity_pool_provider.metadata.to_h
              ...
              @workload_identity_pools_stub.update_workload_identity_pool_provider request, options do |result, operation|
                result = ::Gapic::Operation.new result, @operations_client, options: options
                yield result, operation if block_given?
                throw :response, result
              end
            ...
            def delete_workload_identity_pool_provider request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.delete_workload_identity_pool_provider.metadata.to_h
              ...
              @workload_identity_pools_stub.delete_workload_identity_pool_provider request, options do |result, operation|
                result = ::Gapic::Operation.new result, @operations_client, options: options
                yield result, operation if block_given?
                throw :response, result
              end
            ...
            def undelete_workload_identity_pool_provider request, options = nil
              ...
              # Customize the options with defaults
              call_metadata = @config.rpcs.undelete_workload_identity_pool_provider.metadata.to_h
              ...
              @workload_identity_pools_stub.undelete_workload_identity_pool_provider request, options do |result, operation|
                result = ::Gapic::Operation.new result, @operations_client, options: options
                yield result, operation if block_given?
                throw :response, result
              end
            ...
            ##
            # Configuration class for the WorkloadIdentityPools REST API.
            #
            # This class represents the configuration for WorkloadIdentityPools REST,
            # providing control over timeouts, retry behavior, logging, transport
            # parameters, and other low-level controls. Certain parameters can also be
            # applied individually to specific RPCs. See
            # {::Google::Iam::V1beta::WorkloadIdentityPools::Rest::Client::Configuration::Rpcs}
