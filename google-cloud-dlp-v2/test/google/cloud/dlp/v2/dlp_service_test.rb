...
class ::Google::Cloud::Dlp::V2::DlpService::ClientTest < Minitest::Test
  ...
  def test_create_content_policy
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dlp::V2::ContentPolicy.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    create_content_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_content_policy, name
      assert_kind_of ::Google::Cloud::Dlp::V2::CreateContentPolicyRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dlp::V2::ContentPolicy), request["content_policy"]
      assert_equal "hello world", request["content_policy_id"]
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, create_content_policy_client_stub do
      # Create client
      c = ::Google::Cloud::Dlp::V2::DlpService::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      c.create_content_policy({ parent: parent, content_policy: content_policy, content_policy_id: content_policy_id }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.create_content_policy ::Google::Cloud::Dlp::V2::CreateContentPolicyRequest.new(parent: parent, content_policy: content_policy, content_policy_id: content_policy_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.create_content_policy({ parent: parent, content_policy: content_policy, content_policy_id: content_policy_id }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.create_content_policy(::Google::Cloud::Dlp::V2::CreateContentPolicyRequest.new(parent: parent, content_policy: content_policy, content_policy_id: content_policy_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Verify method calls
      assert_equal 5, create_content_policy_client_stub.call_rpc_count
    end
  end
  ...
  def test_update_content_policy
    ...
    update_content_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_content_policy, name
      assert_kind_of ::Google::Cloud::Dlp::V2::UpdateContentPolicyRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dlp::V2::ContentPolicy), request["content_policy"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, update_content_policy_client_stub do
      # Create client
      c = ::Google::Cloud::Dlp::V2::DlpService::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      c.update_content_policy({ name: name, content_policy: content_policy, update_mask: update_mask }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.update_content_policy ::Google::Cloud::Dlp::V2::UpdateContentPolicyRequest.new(name: name, content_policy: content_policy, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.update_content_policy({ name: name, content_policy: content_policy, update_mask: update_mask }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.update_content_policy(::Google::Cloud::Dlp::V2::UpdateContentPolicyRequest.new(name: name, content_policy: content_policy, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Verify method calls
      assert_equal 5, update_content_policy_client_stub.call_rpc_count
    end
  end
  ...
  def test_get_content_policy
    ...
    get_content_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_content_policy, name
      assert_kind_of ::Google::Cloud::Dlp::V2::GetContentPolicyRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, get_content_policy_client_stub do
      # Create client
      c = ::Google::Cloud::Dlp::V2::DlpService::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      c.get_content_policy({ name: name }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.get_content_policy ::Google::Cloud::Dlp::V2::GetContentPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.get_content_policy({ name: name }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.get_content_policy(::Google::Cloud::Dlp::V2::GetContentPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Verify method calls
      assert_equal 5, get_content_policy_client_stub.call_rpc_count
    end
  end

  def test_list_content_policies
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dlp::V2::ListContentPoliciesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_content_policies_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_content_policies, name
      assert_kind_of ::Google::Cloud::Dlp::V2::ListContentPoliciesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, list_content_policies_client_stub do
      # Create client
      c = ::Google::Cloud::Dlp::V2::DlpService::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      c.list_content_policies({ parent: parent, page_size: page_size, page_token: page_token }) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.list_content_policies ::Google::Cloud::Dlp::V2::ListContentPoliciesRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      c.list_content_policies({ parent: parent, page_size: page_size, page_token: page_token }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_content_policies(::Google::Cloud::Dlp::V2::ListContentPoliciesRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Verify method calls
      assert_equal 5, list_content_policies_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_content_policy
    ...
    delete_content_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_content_policy, name
      assert_kind_of ::Google::Cloud::Dlp::V2::DeleteContentPolicyRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, delete_content_policy_client_stub do
      # Create client
      c = ::Google::Cloud::Dlp::V2::DlpService::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      c.delete_content_policy({ name: name }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.delete_content_policy ::Google::Cloud::Dlp::V2::DeleteContentPolicyRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.delete_content_policy({ name: name }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.delete_content_policy(::Google::Cloud::Dlp::V2::DeleteContentPolicyRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Verify method calls
      assert_equal 5, delete_content_policy_client_stub.call_rpc_count
    end
  end
