      ...
      module V2
        module DlpService
          ...
          class Service
            ...
            rpc :CreateContentPolicy, ::Google::Cloud::Dlp::V2::CreateContentPolicyRequest, ::Google::Cloud::Dlp::V2::ContentPolicy
            # Update a ContentPolicy.
            rpc :UpdateContentPolicy, ::Google::Cloud::Dlp::V2::UpdateContentPolicyRequest, ::Google::Cloud::Dlp::V2::ContentPolicy
            # Get a ContentPolicy.
            rpc :GetContentPolicy, ::Google::Cloud::Dlp::V2::GetContentPolicyRequest, ::Google::Cloud::Dlp::V2::ContentPolicy
            # Lists ContentPolicies in a parent.
            rpc :ListContentPolicies, ::Google::Cloud::Dlp::V2::ListContentPoliciesRequest, ::Google::Cloud::Dlp::V2::ListContentPoliciesResponse
            # Delete a ContentPolicy.
            rpc :DeleteContentPolicy, ::Google::Cloud::Dlp::V2::DeleteContentPolicyRequest, ::Google::Protobuf::Empty
          end
