...
::Google::Cloud.configure.add_config! :oracle_database do |config|
...
module Google
  module Cloud
    module OracleDatabase
      ...
      # [Google::Cloud::OracleDatabase::V1::OracleDatabase::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-oracle_database-v1/latest/Google-Cloud-OracleDatabase-V1-OracleDatabase-Client)
      # for a gRPC client for version V1 of the API.
      # However, you can specify a different API version by passing it in the
      # `version` parameter. If the OracleDatabase service is
      ...
      # given API version does not support the given transport of the OracleDatabase service.
      ...
      #
      def self.oracle_database version: :v1, transport: :grpc, &block
        ...
        package_name = Google::Cloud::OracleDatabase
                       ...
                       .first
        service_module = Google::Cloud::OracleDatabase.const_get(package_name).const_get(:OracleDatabase)
      ...
      #
      def self.oracle_database_available? version: :v1, transport: :grpc
        require "google/cloud/oracle_database/#{version.to_s.downcase}"
        package_name = Google::Cloud::OracleDatabase
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
