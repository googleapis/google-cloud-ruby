...
class ::Google::Shopping::Merchant::Products::V1beta::ProductInputsService::Rest::ClientTest < Minitest::Test
  ...
  def test_insert_product_input
    ...
    insert_product_input_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_delete_product_input
    ...
    delete_product_input_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
