...
class Google::Cloud::Firestore::Admin::ClientConstructionMinitest < Minitest::Test
  ...
  def test_firestore_admin_grpc
    skip unless Google::Cloud::Firestore::Admin.firestore_admin_available? transport: :grpc
  ...
  def test_firestore_admin_rest
    skip unless Google::Cloud::Firestore::Admin.firestore_admin_available? transport: :rest
