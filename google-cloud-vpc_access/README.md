# Ruby Client for the Serverless VPC Access API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-vpc_access/latest)
for this library, google-cloud-vpc_access, to see the convenience methods for
...
```
$ gem install google-cloud-vpc_access
```
