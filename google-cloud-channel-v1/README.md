...
specific version of the Cloud Channel V1 API. Most users should consider using
the main client gem,
[google-cloud-channel](https://rubygems.org/gems/google-cloud-channel).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-channel-v1
```
