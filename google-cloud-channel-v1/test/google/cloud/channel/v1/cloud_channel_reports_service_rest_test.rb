...
class ::Google::Cloud::Channel::V1::CloudChannelReportsService::Rest::ClientTest < Minitest::Test
  ...
  def test_run_report_job
    ...
    run_report_job_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
  ...
  def test_fetch_report_results
    ...
    fetch_report_results_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
