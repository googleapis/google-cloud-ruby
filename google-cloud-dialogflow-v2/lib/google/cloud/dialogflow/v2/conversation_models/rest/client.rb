        ...
        module ConversationModels
          module Rest
            ...
            class Client
              ...
              #
              def universe_domain
                @conversation_models_stub.universe_domain
              end
              ...
              def initialize
                ...
                @conversation_models_stub.logger(stub: true)&.info do |entry|
                ...
                @location_client = Google::Cloud::Location::Locations::Rest::Client.new do |config|
                  ...
                  config.logger = @conversation_models_stub.logger if config.respond_to? :logger=
                end
              end
              ...
              #
              def logger
                @conversation_models_stub.logger
              end
