        ...
        module EncryptionSpecService
          ...
          class Client
            ...
            def initialize
              ...
              @encryption_spec_service_stub.stub_logger&.info do |entry|
              ...
              @location_client = Google::Cloud::Location::Locations::Client.new do |config|
                ...
                config.logger = @encryption_spec_service_stub.logger if config.respond_to? :logger=
              end
            end
            ...
            #
            def logger
              @encryption_spec_service_stub.logger
            end
