            ...
            class ServiceStub
              ...
              def create_conversation_dataset request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  method_name: "create_conversation_dataset",
                  options: options
                )
              ...
              def get_conversation_dataset request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "get_conversation_dataset",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def list_conversation_datasets request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "list_conversation_datasets",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def delete_conversation_dataset request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "delete_conversation_dataset",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def import_conversation_data request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "import_conversation_data",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
