...
class ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_conversation_model
    ...
    create_conversation_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_create_conversation_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_conversation_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_conversation_model_client_stub.call_count
      end
    end
  end
  ...
  def test_get_conversation_model
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ConversationModel.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_conversation_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_get_conversation_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_conversation_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_conversation_model_client_stub.call_count
      end
    end
  end
  ...
  def test_list_conversation_models
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ListConversationModelsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_conversation_models_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_list_conversation_models_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_conversation_models_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_conversation_models_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_conversation_model
    ...
    delete_conversation_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_delete_conversation_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_conversation_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_conversation_model_client_stub.call_count
      end
    end
  end
  ...
  def test_deploy_conversation_model
    ...
    deploy_conversation_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_deploy_conversation_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, deploy_conversation_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, deploy_conversation_model_client_stub.call_count
      end
    end
  end
  ...
  def test_undeploy_conversation_model
    ...
    undeploy_conversation_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_undeploy_conversation_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, undeploy_conversation_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, undeploy_conversation_model_client_stub.call_count
      end
    end
  end
  ...
  def test_get_conversation_model_evaluation
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ConversationModelEvaluation.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_conversation_model_evaluation_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_get_conversation_model_evaluation_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_conversation_model_evaluation_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_conversation_model_evaluation_client_stub.call_count
      end
    end
  end
  ...
  def test_list_conversation_model_evaluations
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ListConversationModelEvaluationsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_conversation_model_evaluations_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_list_conversation_model_evaluations_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_conversation_model_evaluations_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_conversation_model_evaluations_client_stub.call_count
      end
    end
  end
  ...
  def test_create_conversation_model_evaluation
    ...
    create_conversation_model_evaluation_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::ServiceStub.stub :transcode_create_conversation_model_evaluation_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_conversation_model_evaluation_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_conversation_model_evaluation_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::ConversationModels::Rest::Client::Configuration, config
  end
end
