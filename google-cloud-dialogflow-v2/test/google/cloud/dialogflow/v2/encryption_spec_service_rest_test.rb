  ...
  def test_get_encryption_spec
    ...
    ::Google::Cloud::Dialogflow::V2::EncryptionSpecService::Rest::ServiceStub.stub :transcode_get_encryption_spec_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_encryption_spec_client_stub do
        ...
        # Use protobuf object
        client.get_encryption_spec ::Google::Cloud::Dialogflow::V2::GetEncryptionSpecRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.get_encryption_spec(::Google::Cloud::Dialogflow::V2::GetEncryptionSpecRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_initialize_encryption_spec
    ...
    ::Google::Cloud::Dialogflow::V2::EncryptionSpecService::Rest::ServiceStub.stub :transcode_initialize_encryption_spec_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, initialize_encryption_spec_client_stub do
        ...
        # Use protobuf object
        client.initialize_encryption_spec ::Google::Cloud::Dialogflow::V2::InitializeEncryptionSpecRequest.new(encryption_spec: encryption_spec) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.initialize_encryption_spec(::Google::Cloud::Dialogflow::V2::InitializeEncryptionSpecRequest.new(encryption_spec: encryption_spec), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
