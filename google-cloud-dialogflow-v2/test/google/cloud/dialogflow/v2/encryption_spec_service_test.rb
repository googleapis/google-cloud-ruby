...
class ::Google::Cloud::Dialogflow::V2::EncryptionSpecService::ClientTest < Minitest::Test
  ...
  def test_get_encryption_spec
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2::EncryptionSpec.new
    ...
    get_encryption_spec_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2::GetEncryptionSpecRequest, request
  ...
  def test_initialize_encryption_spec
    ...
    initialize_encryption_spec_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2::InitializeEncryptionSpecRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2::EncryptionSpec), request["encryption_spec"]
      refute_nil options
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::EncryptionSpecService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::EncryptionSpecService::Operations, client.operations_client
  end
end
