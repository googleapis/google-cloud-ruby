...
class ::Google::Cloud::Dialogflow::V2::AnswerRecords::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_answer_records
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ListAnswerRecordsResponse.new
    ...
    list_answer_records_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
    ...
    ::Google::Cloud::Dialogflow::V2::AnswerRecords::Rest::ServiceStub.stub :transcode_list_answer_records_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_answer_records_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_answer_records_client_stub.call_count
      end
    end
  end
  ...
  def test_update_answer_record
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::AnswerRecord.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    update_answer_record_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::AnswerRecords::Rest::ServiceStub.stub :transcode_update_answer_record_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_answer_record_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_answer_record_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::AnswerRecords::Rest::Client::Configuration, config
  end
end
