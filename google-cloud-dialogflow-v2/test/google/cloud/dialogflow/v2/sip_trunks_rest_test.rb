...
class ::Google::Cloud::Dialogflow::V2::SipTrunks::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_sip_trunk
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::SipTrunk.new
    ...
    create_sip_trunk_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dialogflow::V2::SipTrunks::Rest::ServiceStub.stub :transcode_create_sip_trunk_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_sip_trunk_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_sip_trunk_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_sip_trunk
    ...
    delete_sip_trunk_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::SipTrunks::Rest::ServiceStub.stub :transcode_delete_sip_trunk_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_sip_trunk_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_sip_trunk_client_stub.call_count
      end
    end
  end
  ...
  def test_list_sip_trunks
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ListSipTrunksResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_sip_trunks_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::SipTrunks::Rest::ServiceStub.stub :transcode_list_sip_trunks_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_sip_trunks_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_sip_trunks_client_stub.call_count
      end
    end
  end
  ...
  def test_get_sip_trunk
    ...
    get_sip_trunk_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::SipTrunks::Rest::ServiceStub.stub :transcode_get_sip_trunk_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_sip_trunk_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_sip_trunk_client_stub.call_count
      end
    end
  end
  ...
  def test_update_sip_trunk
    ...
    update_sip_trunk_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::SipTrunks::Rest::ServiceStub.stub :transcode_update_sip_trunk_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_sip_trunk_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_sip_trunk_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::SipTrunks::Rest::Client::Configuration, config
  end
end
