...
class ::Google::Cloud::Dialogflow::V2::Generators::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_generator
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::Generator.new
    ...
    create_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dialogflow::V2::Generators::Rest::ServiceStub.stub :transcode_create_generator_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_generator_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_generator_client_stub.call_count
      end
    end
  end
  ...
  def test_get_generator
    ...
    get_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::Generators::Rest::ServiceStub.stub :transcode_get_generator_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_generator_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_generator_client_stub.call_count
      end
    end
  end
  ...
  def test_list_generators
    # Create test objects.
    client_result = ::Google::Cloud::Dialogflow::V2::ListGeneratorsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_generators_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::Generators::Rest::ServiceStub.stub :transcode_list_generators_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_generators_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_generators_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_generator
    ...
    delete_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::Generators::Rest::ServiceStub.stub :transcode_delete_generator_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_generator_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_generator_client_stub.call_count
      end
    end
  end
  ...
  def test_update_generator
    ...
    update_generator_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dialogflow::V2::Generators::Rest::ServiceStub.stub :transcode_update_generator_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_generator_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_generator_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::Generators::Rest::Client::Configuration, config
  end
end
