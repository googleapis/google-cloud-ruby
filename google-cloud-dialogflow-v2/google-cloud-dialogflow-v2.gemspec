...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Builds conversational interfaces (for example, chatbots, and voice-powered apps and devices). Note that google-cloud-dialogflow-v2 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-dialogflow instead. See the readme for more details."
