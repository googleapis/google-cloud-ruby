...
In general, the google-cloud-dialogflow-v2 library uses [Service
...
The environment variables that google-cloud-dialogflow-v2 checks for credentials are configured on the service Credentials class (such as {Google::Cloud::Dialogflow::V2::Agents::Credentials}):
