    ...
    module AdManager
      module V1
        module ProgrammaticBuyerService
          # Path helper methods for the ProgrammaticBuyerService API.
          module Paths
            ##
            ...
            ##
            # Create a fully-qualified ProgrammaticBuyer resource string.
            #
            # The resource will be in the following format:
            #
            ...
            #
            # @param network_code [String]
            # @param programmatic_buyer [String]
            #
            # @return [::String]
            def programmatic_buyer_path network_code:, programmatic_buyer:
