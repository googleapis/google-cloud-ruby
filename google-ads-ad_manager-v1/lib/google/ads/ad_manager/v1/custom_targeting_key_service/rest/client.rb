...
require "google/ads/ad_manager/v1/custom_targeting_key_service/rest/service_stub"
        ...
        module CustomTargetingKeyService
          module Rest
            ...
            class Client
              ...
              # @private
              attr_reader :custom_targeting_key_service_stub

              ##
              # Configure the CustomTargetingKeyService Client class.
              #
              # See {::Google::Ads::AdManager::V1::CustomTargetingKeyService::Rest::Client::Configuration}
              ...
              #   end
              #
              # @yield [config] Configure the CustomTargetingKeyService client.
              # @yieldparam config [Client::Configuration]
              #
              def initialize
              ...
              #   {::Google::Ads::AdManager::V1::GetCustomTargetingKeyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::GetCustomTargetingKeyRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload get_custom_targeting_key(name: nil)
              #   Pass arguments to `get_custom_targeting_key` via keyword arguments. Note that at
              ...
              def get_custom_targeting_key request, options = nil
                ...
                call_metadata = @config.rpcs.get_custom_targeting_key.metadata.to_h
              ...
              #   {::Google::Ads::AdManager::V1::ListCustomTargetingKeysRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::ListCustomTargetingKeysRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload list_custom_targeting_keys(parent: nil, page_size: nil, page_token: nil, filter: nil, order_by: nil, skip: nil)
              #   Pass arguments to `list_custom_targeting_keys` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param parent [::String]
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::CustomTargetingKey>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::CustomTargetingKey>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_custom_targeting_keys request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.list_custom_targeting_keys.metadata.to_h
              ...
              #
              # This class represents the configuration for CustomTargetingKeyService REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Ads::AdManager::V1::CustomTargetingKeyService::Rest::Client::Configuration::Rpcs}
              ...
              #   # get_custom_targeting_key to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::AdManager::V1::CustomTargetingKeyService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.get_custom_targeting_key.timeout = 20.0
              #   end
              #
              ...
              class Configuration
                ...
                ##
                # Configuration RPC class for the CustomTargetingKeyService API.
                #
                ...
                class Rpcs
                  ##
                  # RPC-specific configuration for `get_custom_targeting_key`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :get_custom_targeting_key
                  ##
                  # RPC-specific configuration for `list_custom_targeting_keys`
                  # @return [::Gapic::Config::Method]
                  #
                  ...
                  def initialize parent_rpcs = nil
                    get_custom_targeting_key_config = parent_rpcs.get_custom_targeting_key if parent_rpcs.respond_to? :get_custom_targeting_key
