...
require "google/ads/ad_manager/v1/network_service/rest/service_stub"
        ...
        module NetworkService
          module Rest
            ...
            class Client
              ...
              # @private
              attr_reader :network_service_stub

              ##
              # Configure the NetworkService Client class.
              #
              # See {::Google::Ads::AdManager::V1::NetworkService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all NetworkService clients
              #   ::Google::Ads::AdManager::V1::NetworkService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Configure the NetworkService Client instance.
              #
              ...
              #
              def universe_domain
                @network_service_stub.universe_domain
              end

              ##
              # Create a new NetworkService REST client object.
              #
              # @example
              #
              ...
              #   end
              #
              # @yield [config] Configure the NetworkService client.
              # @yieldparam config [Client::Configuration]
              #
              def initialize
                ...
                @network_service_stub = ::Google::Ads::AdManager::V1::NetworkService::Rest::ServiceStub.new(
              ...
              #   {::Google::Ads::AdManager::V1::GetNetworkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::GetNetworkRequest, ::Hash]
              ...
              #   request = Google::Ads::AdManager::V1::GetNetworkRequest.new
              #
              ...
              def get_network request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::GetNetworkRequest
              ...
              #   {::Google::Ads::AdManager::V1::ListNetworksRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::ListNetworksRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::AdManager::V1::ListNetworksRequest.new
              #
              ...
              def list_networks request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::ListNetworksRequest
              ...
              # {::Google::Ads::AdManager::V1::NetworkService::Rest::Client::Configuration::Rpcs}
              ...
              #   # get_network to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::AdManager::V1::NetworkService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.get_network.timeout = 20.0
              #   end
              #
              ...
              class Configuration
                ...
                ##
                # Configuration RPC class for the NetworkService API.
                #
