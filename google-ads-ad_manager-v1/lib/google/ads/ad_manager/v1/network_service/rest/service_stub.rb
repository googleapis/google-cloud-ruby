        ...
        module NetworkService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Ads::AdManager::V1::UpdateNetworkRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              ##
              # Baseline implementation for the provision_test_network REST call
              #
              # @param request_pb [::Google::Ads::AdManager::V1::ProvisionTestNetworkRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Ads::AdManager::V1::Network]
              #   A result object deserialized from the server's reply
              def provision_test_network request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_provision_test_network_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "provision_test_network",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Ads::AdManager::V1::Network.decode_json response.body, ignore_unknown_fields: true
              ...
              ##
              # Baseline implementation for the get_default_third_party_data_declaration REST call
              #
              # @param request_pb [::Google::Ads::AdManager::V1::GetDefaultThirdPartyDataDeclarationRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #   A result object deserialized from the server's reply
              def get_default_third_party_data_declaration request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_get_default_third_party_data_declaration_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "get_default_third_party_data_declaration",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Ads::AdManager::V1::DefaultThirdPartyDataDeclaration.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              def self.transcode_update_network_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :patch,
                                                          uri_template: "/v1/{network.name}",
                                                          body: "network",
                                                          matches: [
                                                            ["network.name", %r{^networks/[^/]+/?$}, false]
                                                          ]
                                                        )
                transcoder.transcode request_pb
              end
              ...
              # @private
              #
              # GRPC transcoding helper method for the provision_test_network REST call
              #
              # @param request_pb [::Google::Ads::AdManager::V1::ProvisionTestNetworkRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_provision_test_network_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/networks:provisionTestNetwork",
                                                          body: "*",
                                                          matches: []
                                                        )
                transcoder.transcode request_pb
              ...
              # @private
              #
              # GRPC transcoding helper method for the get_default_third_party_data_declaration REST call
              #
              # @param request_pb [::Google::Ads::AdManager::V1::GetDefaultThirdPartyDataDeclarationRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_get_default_third_party_data_declaration_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v1/{name}",
                                                          matches: [
                                                            ["name", %r{^networks/[^/]+/defaultThirdPartyDataDeclaration/?$}, false]
                                                          ]
                                                        )
                transcoder.transcode request_pb
              end
