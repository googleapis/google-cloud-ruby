    ...
    module AdManager
      module V1
        module NativeStyleService
          # Path helper methods for the NativeStyleService API.
          module Paths
            ##
            ...
            ##
            # Create a fully-qualified CreativeTemplate resource string.
            #
            # The resource will be in the following format:
            #
            ...
            #
            # @param network_code [String]
            # @param creative_template [String]
            #
            # @return [::String]
            def creative_template_path network_code:, creative_template:
              raise ::ArgumentError, "network_code cannot contain /" if network_code.to_s.include? "/"
            ...
            ##
            # Create a fully-qualified NativeStyle resource string.
            #
            # The resource will be in the following format:
            #
            ...
            #
            # @param network_code [String]
            # @param native_style [String]
            #
            # @return [::String]
            def native_style_path network_code:, native_style:
              raise ::ArgumentError, "network_code cannot contain /" if network_code.to_s.include? "/"
