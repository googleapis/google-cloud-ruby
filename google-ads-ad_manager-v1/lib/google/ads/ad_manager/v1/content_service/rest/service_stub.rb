        ...
        module ContentService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Ads::AdManager::V1::GetContentRequest]
              ...
              def get_content request_pb, options = nil
                ...
                result = ::Google::Ads::AdManager::V1::Content.decode_json response.body, ignore_unknown_fields: true
                catch :response do
              ...
              #
              # @param request_pb [::Google::Ads::AdManager::V1::ListContentRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Ads::AdManager::V1::ListContentResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Ads::AdManager::V1::ListContentResponse]
              #   A result object deserialized from the server's reply
              def list_content request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Ads::AdManager::V1::ListContentResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
