...
require "google/ads/ad_manager/v1/application_service/rest/service_stub"
    ...
    module AdManager
      module V1
        module ApplicationService
          module Rest
            ##
            # REST client for the ApplicationService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Ads::AdManager::V1::ApplicationService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all ApplicationService clients
              #   ::Google::Ads::AdManager::V1::ApplicationService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #
              def universe_domain
                @application_service_stub.universe_domain
              end

              ##
              # Create a new ApplicationService REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @application_service_stub = ::Google::Ads::AdManager::V1::ApplicationService::Rest::ServiceStub.new(
                ...
                @application_service_stub.logger(stub: true)&.info do |entry|
              ...
              #
              def logger
                @application_service_stub.logger
              end
              ...
              #   {::Google::Ads::AdManager::V1::GetApplicationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::GetApplicationRequest, ::Hash]
              ...
              #   request = Google::Ads::AdManager::V1::GetApplicationRequest.new
              #
              ...
              def get_application request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::GetApplicationRequest
                ...
                @application_service_stub.get_application request, options do |result, operation|
              ...
              #   {::Google::Ads::AdManager::V1::ListApplicationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::ListApplicationsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload list_applications(parent: nil, page_size: nil, page_token: nil, filter: nil, order_by: nil, skip: nil)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::Application>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::Application>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::AdManager::V1::ListApplicationsRequest.new
              #
              ...
              #   result.each do |item|
              #     # Each element is of type ::Google::Ads::AdManager::V1::Application.
              #     p item
              #   end
              #
              def list_applications request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::ListApplicationsRequest
                ...
                @application_service_stub.list_applications request, options do |result, operation|
              ...
              ##
              # Configuration class for the ApplicationService REST API.
              #
              # This class represents the configuration for ApplicationService REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Ads::AdManager::V1::ApplicationService::Rest::Client::Configuration::Rpcs}
