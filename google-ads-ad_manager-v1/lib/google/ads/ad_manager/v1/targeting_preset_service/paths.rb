    ...
    module AdManager
      module V1
        module TargetingPresetService
          # Path helper methods for the TargetingPresetService API.
          module Paths
            ##
            ...
            ##
            # Create a fully-qualified TargetingPreset resource string.
            #
            # The resource will be in the following format:
            #
            ...
            #
            # @param network_code [String]
            # @param targeting_preset [String]
            #
            # @return [::String]
            def targeting_preset_path network_code:, targeting_preset:
              raise ::ArgumentError, "network_code cannot contain /" if network_code.to_s.include? "/"
