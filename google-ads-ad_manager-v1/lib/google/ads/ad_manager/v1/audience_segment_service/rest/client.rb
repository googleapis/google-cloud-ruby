...
require "google/ads/ad_manager/v1/audience_segment_service/rest/service_stub"
    ...
    module AdManager
      module V1
        module AudienceSegmentService
          module Rest
            ##
            # REST client for the AudienceSegmentService service.
            #
            ...
            class Client
              ...
              # @private
              attr_reader :audience_segment_service_stub

              ##
              # Configure the AudienceSegmentService Client class.
              #
              # See {::Google::Ads::AdManager::V1::AudienceSegmentService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all AudienceSegmentService clients
              #   ::Google::Ads::AdManager::V1::AudienceSegmentService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Configure the AudienceSegmentService Client instance.
              #
              ...
              #
              def universe_domain
                @audience_segment_service_stub.universe_domain
              end

              ##
              # Create a new AudienceSegmentService REST client object.
              #
              # @example
              #
              ...
              #   end
              #
              # @yield [config] Configure the AudienceSegmentService client.
              # @yieldparam config [Client::Configuration]
              #
              def initialize
                ...
                @audience_segment_service_stub = ::Google::Ads::AdManager::V1::AudienceSegmentService::Rest::ServiceStub.new(
                ...
                @audience_segment_service_stub.logger(stub: true)&.info do |entry|
              ...
              #
              def logger
                @audience_segment_service_stub.logger
              end
              ...
              #   {::Google::Ads::AdManager::V1::GetAudienceSegmentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::GetAudienceSegmentRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload get_audience_segment(name: nil)
              #   Pass arguments to `get_audience_segment` via keyword arguments. Note that at
              ...
              #   request = Google::Ads::AdManager::V1::GetAudienceSegmentRequest.new
              #
              #   # Call the get_audience_segment method.
              #   result = client.get_audience_segment request
              #
              #   # The returned object is of type Google::Ads::AdManager::V1::AudienceSegment.
              #   p result
              #
              def get_audience_segment request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::GetAudienceSegmentRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                call_metadata = @config.rpcs.get_audience_segment.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.get_audience_segment.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.get_audience_segment.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @audience_segment_service_stub.get_audience_segment request, options do |result, operation|
              ...
              #   {::Google::Ads::AdManager::V1::ListAudienceSegmentsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::ListAudienceSegmentsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload list_audience_segments(parent: nil, page_size: nil, page_token: nil, filter: nil, order_by: nil, skip: nil)
              #   Pass arguments to `list_audience_segments` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param parent [::String]
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::AudienceSegment>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Ads::AdManager::V1::AudienceSegment>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::AdManager::V1::ListAudienceSegmentsRequest.new
              #
              #   # Call the list_audience_segments method.
              #   result = client.list_audience_segments request
              #
              #   # The returned object is of type Gapic::PagedEnumerable. You can iterate
              #   # over elements, and API calls will be issued to fetch pages as needed.
              #   result.each do |item|
              #     # Each element is of type ::Google::Ads::AdManager::V1::AudienceSegment.
              #     p item
              #   end
              #
              def list_audience_segments request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::ListAudienceSegmentsRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                call_metadata = @config.rpcs.list_audience_segments.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.list_audience_segments.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.list_audience_segments.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @audience_segment_service_stub.list_audience_segments request, options do |result, operation|
              ...
              #
              # @overload create_audience_segment(request, options = nil)
              #   Pass arguments to `create_audience_segment` via a request object, either of type
              #   {::Google::Ads::AdManager::V1::CreateAudienceSegmentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::CreateAudienceSegmentRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload create_audience_segment(parent: nil, audience_segment: nil)
              #   Pass arguments to `create_audience_segment` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param parent [::String]
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::AdManager::V1::CreateAudienceSegmentRequest.new
              #
              #   # Call the create_audience_segment method.
              #   result = client.create_audience_segment request
              #
              #   # The returned object is of type Google::Ads::AdManager::V1::AudienceSegment.
              #   p result
              #
              def create_audience_segment request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::CreateAudienceSegmentRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                call_metadata = @config.rpcs.create_audience_segment.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.create_audience_segment.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.create_audience_segment.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @audience_segment_service_stub.create_audience_segment request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #
              # @overload batch_create_audience_segments(request, options = nil)
              #   Pass arguments to `batch_create_audience_segments` via a request object, either of type
              #   {::Google::Ads::AdManager::V1::BatchCreateAudienceSegmentsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::AdManager::V1::BatchCreateAudienceSegmentsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload batch_create_audience_segments(parent: nil, requests: nil)
              #   Pass arguments to `batch_create_audience_segments` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param parent [::String]
              ...
              #     field.
              #   @param requests [::Array<::Google::Ads::AdManager::V1::CreateAudienceSegmentRequest, ::Hash>]
              #     Required. The `AudienceSegment` objects to create.
              #     A maximum of 100 objects can be created in a batch.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Ads::AdManager::V1::BatchCreateAudienceSegmentsResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Ads::AdManager::V1::BatchCreateAudienceSegmentsResponse]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::AdManager::V1::BatchCreateAudienceSegmentsRequest.new
              #
              #   # Call the batch_create_audience_segments method.
              #   result = client.batch_create_audience_segments request
              #
              #   # The returned object is of type Google::Ads::AdManager::V1::BatchCreateAudienceSegmentsResponse.
              #   p result
              #
              def batch_create_audience_segments request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::AdManager::V1::BatchCreateAudienceSegmentsRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                call_metadata = @config.rpcs.batch_create_audience_segments.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.batch_create_audience_segments.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.batch_create_audience_segments.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @audience_segment_service_stub.batch_create_audience_segments request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the AudienceSegmentService REST API.
              #
              # This class represents the configuration for AudienceSegmentService REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Ads::AdManager::V1::AudienceSegmentService::Rest::Client::Configuration::Rpcs}
              ...
              #   # get_audience_segment to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::AdManager::V1::AudienceSegmentService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.get_audience_segment.timeout = 20.0
              #   end
              #
              ...
              class Configuration
                ...
                ##
                # Configuration RPC class for the AudienceSegmentService API.
                #
                ...
                class Rpcs
                  ##
                  # RPC-specific configuration for `get_audience_segment`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :get_audience_segment
                  ##
                  # RPC-specific configuration for `list_audience_segments`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :list_audience_segments
                  ##
                  # RPC-specific configuration for `create_audience_segment`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :create_audience_segment
                  ##
                  # RPC-specific configuration for `batch_create_audience_segments`
                  # @return [::Gapic::Config::Method]
                  #
                  ...
                  def initialize parent_rpcs = nil
                    get_audience_segment_config = parent_rpcs.get_audience_segment if parent_rpcs.respond_to? :get_audience_segment
                    ...
                    create_audience_segment_config = parent_rpcs.create_audience_segment if parent_rpcs.respond_to? :create_audience_segment
