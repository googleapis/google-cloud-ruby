...
require "google/ads/admanager/v1/company_service/rest/service_stub"
        ...
        module CompanyService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Ads::Admanager::V1::CompanyService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CompanyService clients
              #   ::Google::Ads::Admanager::V1::CompanyService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @company_service_stub = ::Google::Ads::Admanager::V1::CompanyService::Rest::ServiceStub.new(
              ...
              #   {::Google::Ads::Admanager::V1::GetCompanyRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::Admanager::V1::GetCompanyRequest, ::Hash]
              ...
              #   request = Google::Ads::Admanager::V1::GetCompanyRequest.new
              #
              ...
              def get_company request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::Admanager::V1::GetCompanyRequest
              ...
              #   {::Google::Ads::Admanager::V1::ListCompaniesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::Admanager::V1::ListCompaniesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload list_companies(parent: nil, page_size: nil, page_token: nil, filter: nil, order_by: nil, skip: nil)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Ads::Admanager::V1::Company>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Ads::Admanager::V1::Company>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_companies request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::Admanager::V1::ListCompaniesRequest
              ...
              # {::Google::Ads::Admanager::V1::CompanyService::Rest::Client::Configuration::Rpcs}
              ...
              #   # get_company to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::Admanager::V1::CompanyService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.get_company.timeout = 20.0
              #   end
              #
