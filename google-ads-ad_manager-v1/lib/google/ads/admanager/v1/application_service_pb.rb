...
require 'google/ads/admanager/v1/application_messages_pb'
...
begin
  ...
  imports = [
    ["google.ads.admanager.v1.Application", "google/ads/admanager/v1/application_messages.proto"],
  ]
...
module Google
  module Ads
    module AdManager
      module V1
        GetApplicationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.GetApplicationRequest").msgclass
        ListApplicationsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListApplicationsRequest").msgclass
        ListApplicationsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListApplicationsResponse").msgclass
      end
    end
  end
end
