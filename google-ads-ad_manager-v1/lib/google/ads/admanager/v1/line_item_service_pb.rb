...
require 'google/ads/admanager/v1/line_item_messages_pb'
...
module Google
  module Ads
    module AdManager
      module V1
        GetLineItemRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.GetLineItemRequest").msgclass
        ListLineItemsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListLineItemsRequest").msgclass
        ListLineItemsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListLineItemsResponse").msgclass
      end
    end
  end
end
