...
require 'google/ads/admanager/v1/operating_system_version_messages_pb'
...
module Google
  module Ads
    module AdManager
      module V1
        GetOperatingSystemVersionRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.GetOperatingSystemVersionRequest").msgclass
        ListOperatingSystemVersionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListOperatingSystemVersionsRequest").msgclass
        ListOperatingSystemVersionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.admanager.v1.ListOperatingSystemVersionsResponse").msgclass
      end
    end
  end
end
