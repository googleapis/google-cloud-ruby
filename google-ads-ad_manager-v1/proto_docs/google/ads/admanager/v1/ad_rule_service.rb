  ...
  module Ads
    module AdManager
      module V1
        ...
        # objects.
        # @!attribute [rw] ad_rules
        #   @return [::Array<::Google::Ads::AdManager::V1::AdRule>]
        ...
        #   @return [::Array<::Google::Ads::AdManager::V1::CreateAdRuleRequest>]
        ...
        #     field.
        # @!attribute [rw] requests
        #   @return [::Array<::Google::Ads::AdManager::V1::UpdateAdRuleRequest>]
        #     Required. The `AdRule` objects to update.
        #     A maximum of 100 objects can be updated in a batch.
        class BatchUpdateAdRulesRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        class BatchActivateAdRulesRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end

        # Response object for `BatchActivateAdRules` method.
        class BatchActivateAdRulesResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        #     Format:
        #     `networks/{network_code}/adRules/{ad_rule}`
        class BatchDeactivateAdRulesRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end

        # Response object for `BatchDeactivateAdRules` method.
        class BatchDeactivateAdRulesResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
