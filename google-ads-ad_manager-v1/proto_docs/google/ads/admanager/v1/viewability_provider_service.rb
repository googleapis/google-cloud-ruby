  ...
  module Ads
    module AdManager
      module V1
        ...
        class GetViewabilityProviderRequest
        ...
        class ListViewabilityProvidersResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        #     create.
        class CreateViewabilityProviderRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        #   @return [::Array<::Google::Ads::AdManager::V1::CreateViewabilityProviderRequest>]
        #     Required. The
        #     {::Google::Ads::AdManager::V1::ViewabilityProvider ViewabilityProvider} objects
        ...
        # @!attribute [rw] requests
        #   @return [::Array<::Google::Ads::AdManager::V1::UpdateViewabilityProviderRequest>]
        #     Required. The
        #     {::Google::Ads::AdManager::V1::ViewabilityProvider ViewabilityProvider} objects
        #     to update. A maximum of 100 objects can be updated in a batch.
        class BatchUpdateViewabilityProvidersRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        #     The {::Google::Ads::AdManager::V1::ViewabilityProvider ViewabilityProvider}
        #     objects updated.
        class BatchUpdateViewabilityProvidersResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
      end
