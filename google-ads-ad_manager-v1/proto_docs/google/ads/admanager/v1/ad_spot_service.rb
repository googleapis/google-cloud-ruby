  ...
  module Ads
    module AdManager
      module V1
        ...
        # objects.
        # @!attribute [rw] ad_spots
        #   @return [::Array<::Google::Ads::AdManager::V1::AdSpot>]
        ...
        #   @return [::Array<::Google::Ads::AdManager::V1::CreateAdSpotRequest>]
        #     Required. The `AdSpot` objects to create.
        #     A maximum of 100 objects can be created in a batch.
        class BatchCreateAdSpotsRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        #     field.
        # @!attribute [rw] requests
        #   @return [::Array<::Google::Ads::AdManager::V1::UpdateAdSpotRequest>]
        #     Required. The `AdSpot` objects to update.
        #     A maximum of 100 objects can be updated in a batch.
        class BatchUpdateAdSpotsRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
