  ...
  module Ads
    module AdManager
      module V1
        ...
        class GetProgrammaticBuyerRequest
        ...
        class ListProgrammaticBuyersRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        # @!attribute [rw] programmatic_buyers
        #   @return [::Array<::Google::Ads::AdManager::V1::ProgrammaticBuyer>]
        ...
        class ListProgrammaticBuyersResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
      end
