  ...
  module Ads
    module AdManager
      module V1
        ...
        # `CreativeSet` objects.
        # @!attribute [rw] creative_sets
        #   @return [::Array<::Google::Ads::AdManager::V1::CreativeSet>]
        ...
        class ListCreativeSetsResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
