  ...
  module Ads
    module AdManager
      module V1
        ...
        class ListMobileDeviceSubmodelsRequest
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        # @!attribute [rw] mobile_device_submodels
        #   @return [::Array<::Google::Ads::AdManager::V1::MobileDeviceSubmodel>]
        ...
        class ListMobileDeviceSubmodelsResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
      end
