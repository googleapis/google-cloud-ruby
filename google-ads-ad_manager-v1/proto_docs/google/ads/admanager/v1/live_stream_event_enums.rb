  ...
  module Ads
    module AdManager
      module V1
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::AdBreakMarkupTypeEnum::AdBreakMarkupType AdBreakMarkupType}
        class AdBreakMarkupTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Describes the SCTE ad break markups for a LiveStreamEvent.
          module AdBreakMarkupType
            # Default value. This value is unused.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::LiveStreamEventStreamingFormatEnum::LiveStreamEventStreamingFormat LiveStreamEventStreamingFormat}
        class LiveStreamEventStreamingFormatEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # The LiveStreamEvent streaming format.
          module LiveStreamEventStreamingFormat
            # Default value. This value is unused.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::DynamicAdInsertionTypeEnum::DynamicAdInsertionType DynamicAdInsertionType}
        class DynamicAdInsertionTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Describes how the live stream will have ads dynamically inserted into
          # playlists.
          module DynamicAdInsertionType
            # Default value. This value is unused.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::HlsSettingsPlaylistTypeEnum::HlsSettingsPlaylistType HlsSettingsPlaylistType}
        class HlsSettingsPlaylistTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          module HlsSettingsPlaylistType
            # Default value. This value is unused.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::HlsMasterPlaylistRefreshTypeEnum::HlsMasterPlaylistRefreshType HlsMasterPlaylistRefreshType}
        class HlsMasterPlaylistRefreshTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Enumerates the different ways an HLS master playlist on a live stream will
          # can be refreshed.
          module HlsMasterPlaylistRefreshType
            # Default value. This value is unused.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::AdBreakFillTypeEnum::AdBreakFillType AdBreakFillType}
        class AdBreakFillTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Describes what should be used to fill an empty or underfilled ad break
          # during a live stream.
          module AdBreakFillType
            # Default value. This value is unused.
