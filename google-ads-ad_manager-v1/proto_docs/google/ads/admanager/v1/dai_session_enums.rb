...
module Google
  module Ads
    module AdManager
      module V1
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::StitchingTypeEnum::StitchingType StitchingType}
        class StitchingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Indicates how ads are stitched into the session.
          module StitchingType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::ReportingTypeEnum::ReportingType ReportingType}
        class ReportingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Indicates how ad tracking URLs are reported for the session.
          module ReportingType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::AdResponseTypeEnum::AdResponseType AdResponseType}
        class AdResponseTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # The type of the ad response.
          module AdResponseType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::BreakTypeEnum::BreakType BreakType}
        class BreakTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::PrefetchStageTypeEnum::PrefetchStageType PrefetchStageType}
        class PrefetchStageTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Indicates the prefetch stage for an ad pod.
          module PrefetchStageType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::CreativeIdTypeEnum::CreativeIdType CreativeIdType}
        class CreativeIdTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # The ID types in a VAST response to uniquely identify a creative.
          module CreativeIdType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::SessionFindingSeverityEnum::SessionFindingSeverity SessionFindingSeverity}
        class SessionFindingSeverityEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Severity levels for a finding.
          module SessionFindingSeverity
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::PodFindingTypeEnum::PodFindingType PodFindingType}
        class PodFindingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # Types of findings that can occur while decisioning an ad pod.
          module PodFindingType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::SlateFindingTypeEnum::SlateFindingType SlateFindingType}
        class SlateFindingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # A finding that occurred regarding the slate creative.
          module SlateFindingType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::AdBreakFindingTypeEnum::AdBreakFindingType AdBreakFindingType}
        class AdBreakFindingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # A finding that occurred while serving an ad break for a session.
          module AdBreakFindingType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::TrackingPingFindingTypeEnum::TrackingPingFindingType TrackingPingFindingType}
        class TrackingPingFindingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # A finding that occurred while pinging tracking URLs for a session.
          module TrackingPingFindingType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::CreativeFindingTypeEnum::CreativeFindingType CreativeFindingType}
        class CreativeFindingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # A finding that occurred while looking up creative information.
          module CreativeFindingType
            # Default value.
        ...
        # Wrapper message for
        # {::Google::Ads::AdManager::V1::AdRequestFindingTypeEnum::AdRequestFindingType AdRequestFindingType}
        class AdRequestFindingTypeEnum
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods

          # A finding that occurred while making an ad request.
          module AdRequestFindingType
            # Default value.
