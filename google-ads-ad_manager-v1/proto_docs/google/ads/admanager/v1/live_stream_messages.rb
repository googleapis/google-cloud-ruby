  ...
  module Ads
    module AdManager
      module V1
        ...
        #     255 characters.
        # @!attribute [r] status
        #   @return [::Google::Ads::AdManager::V1::LiveStreamEventStatusEnum::LiveStreamEventStatus]
        #     Output only. The status of this LiveStream. Live stream events are created
        #     in the
        #     {::Google::Ads::AdManager::V1::LiveStreamEventStatusEnum::LiveStreamEventStatus::PAUSED PAUSED}
        #     state.
        ...
        # @!attribute [rw] ad_break_fill_type
        #   @return [::Google::Ads::AdManager::V1::AdBreakFillTypeEnum::AdBreakFillType]
        #     Optional. The type of content that should be used to fill an empty ad
        #     break. Defaults to
        #     {::Google::Ads::AdManager::V1::AdBreakFillTypeEnum::AdBreakFillType::SLATE SLATE}.
        # @!attribute [rw] underfill_ad_break_fill_type
        #   @return [::Google::Ads::AdManager::V1::AdBreakFillTypeEnum::AdBreakFillType]
        ...
        # @!attribute [rw] ad_holiday_duration
        #   @return [::Google::Protobuf::Duration]
        ...
        #     Defaults to 0.
        # @!attribute [rw] enable_max_filler_duration
        #   @return [::Boolean]
        ...
        # @!attribute [rw] max_filler_duration
        #   @return [::Google::Protobuf::Duration]
        ...
        # @!attribute [rw] pod_serving_segment_duration
        #   @return [::Google::Protobuf::Duration]
        ...
        # @!attribute [rw] enable_durationless_ad_breaks
        #   @return [::Boolean]
        ...
        # @!attribute [rw] default_ad_break_duration
        #   @return [::Google::Protobuf::Duration]
        ...
        # @!attribute [rw] preroll_settings
        #   @return [::Google::Ads::AdManager::V1::PrerollSettings]
        ...
        #   @return [::Google::Ads::AdManager::V1::HlsSettings]
        ...
        # @!attribute [rw] allowlisted_ips_enabled
        #   @return [::Boolean]
        ...
        # @!attribute [rw] dynamic_ad_insertion_type
        #   @return [::Google::Ads::AdManager::V1::DynamicAdInsertionTypeEnum::DynamicAdInsertionType]
        ...
        # @!attribute [rw] relative_playlist_delivery_enabled
        #   @return [::Boolean]
        ...
        # @!attribute [rw] streaming_format
        #   @return [::Google::Ads::AdManager::V1::LiveStreamEventStreamingFormatEnum::LiveStreamEventStreamingFormat]
        #     Immutable. The streaming format of the LiveStream media.
        # @!attribute [rw] prefetch_enabled
        #   @return [::Boolean]
        #     Optional. Indicates whether the option to prefetch ad requests is enabled.
        # @!attribute [rw] prefetch_settings
        #   @return [::Google::Ads::AdManager::V1::PrefetchSettings]
        #     Optional. The information needed to prefetch ad requests for an ad break.
        # @!attribute [rw] forced_cue_in_enabled
        #   @return [::Boolean]
        ...
        #     enabled.
        # @!attribute [rw] short_segment_dropping_enabled
        #   @return [::Boolean]
        ...
        # @!attribute [rw] ad_break_markup_types_enabled
        #   @return [::Boolean]
        ...
        # @!attribute [rw] live_stream_conditioning
        #   @return [::Google::Ads::AdManager::V1::LiveStreamConditioning]
        #     Optional. The conditioning to apply to this LiveStream.
        # @!attribute [rw] early_break_notification_multi_break_scheduling_enabled
        #   @return [::Boolean]
        #     Optional. Indicates whether multi-break scheduling via Early Break
        #     Notification (EBN) is enabled for this LiveStream.
        # @!attribute [rw] ad_pod_trim_tolerance
        #   @return [::Google::Protobuf::Duration]
        ...
        # @!attribute [r] effective_asset_key
        #   @return [::String]
        ...
        # @!attribute [rw] auxiliary_ad_settings
        #   @return [::Google::Ads::AdManager::V1::AuxiliaryAdSettings]
        ...
        # @!attribute [rw] stage_one_ad_request_duration
        #   @return [::Google::Protobuf::Duration]
        ...
        # LiveStream.
        # @!attribute [rw] dash_bridge
        #   @return [::Google::Ads::AdManager::V1::DashBridge]
        ...
        #   @return [::Google::Ads::AdManager::V1::HlsSettingsPlaylistTypeEnum::HlsSettingsPlaylistType]
        ...
        #     tag. Will default to
        #     {::Google::Ads::AdManager::V1::HlsSettingsPlaylistTypeEnum::HlsSettingsPlaylistType::LIVE LIVE}.
        # @!attribute [rw] master_playlist_settings
        #   @return [::Google::Ads::AdManager::V1::MasterPlaylistSettings]
        ...
        #     {::Google::Ads::AdManager::V1::HlsMasterPlaylistRefreshTypeEnum::HlsMasterPlaylistRefreshType::AUTOMATIC AUTOMATIC}.
        class HlsSettings
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        # @!attribute [rw] max_ad_pod_duration
        #   @return [::Google::Protobuf::Duration]
        ...
        #   @return [::Google::Ads::AdManager::V1::HlsMasterPlaylistRefreshTypeEnum::HlsMasterPlaylistRefreshType]
