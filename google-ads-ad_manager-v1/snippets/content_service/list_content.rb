...
# Google::Ads::AdManager::V1::ContentService::Rest::Client#list_content.
#
def list_content
  ...
  request = Google::Ads::AdManager::V1::ListContentRequest.new
  ...
  result.each do |item|
    # Each element is of type ::Google::Ads::AdManager::V1::Content.
    p item
  end
end
