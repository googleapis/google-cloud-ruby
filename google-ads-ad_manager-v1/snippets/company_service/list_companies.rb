...
##
# Snippet for the list_companies call in the CompanyService service
#
...
# Google::Ads::AdManager::V1::CompanyService::Rest::Client#list_companies.
#
def list_companies
  ...
  request = Google::Ads::AdManager::V1::ListCompaniesRequest.new
  ...
  result.each do |item|
    # Each element is of type ::Google::Ads::AdManager::V1::Company.
    p item
  end
end
