...
##
# Snippet for the batch_reject_child_publishers call in the ChildPublisherService service
#
...
# Google::Ads::AdManager::V1::ChildPublisherService::Rest::Client#batch_reject_child_publishers.
#
