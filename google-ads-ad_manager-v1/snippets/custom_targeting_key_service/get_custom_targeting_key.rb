...
##
# Snippet for the get_custom_targeting_key call in the CustomTargetingKeyService service
#
...
# Google::Ads::Admanager::V1::CustomTargetingKeyService::Rest::Client#get_custom_targeting_key.
#
