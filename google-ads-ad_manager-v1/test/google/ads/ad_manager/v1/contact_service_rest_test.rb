...
require "google/ads/ad_manager/v1/contact_service/rest"


class ::Google::Ads::AdManager::V1::ContactService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_contact
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::Contact.new
  ...
  def test_list_contacts
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ListContactsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_batch_create_contacts
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::BatchCreateContactsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    batch_create_contacts_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::ContactService::Rest::ServiceStub.stub :transcode_batch_create_contacts_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_create_contacts_client_stub do
        ...
        # Verify method calls
        assert_equal 5, batch_create_contacts_client_stub.call_count
      end
    end
  end
  ...
  def test_batch_update_contacts
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::BatchUpdateContactsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    batch_update_contacts_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::ContactService::Rest::ServiceStub.stub :transcode_batch_update_contacts_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_update_contacts_client_stub do
        ...
        # Verify method calls
        assert_equal 5, batch_update_contacts_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::ContactService::Rest::Client::Configuration, config
  end
end
