...
require "google/ads/ad_manager/v1/mcm_earnings_service/rest"


class ::Google::Ads::AdManager::V1::McmEarningsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_fetch_mcm_earnings
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::FetchMcmEarningsResponse.new
    ...
    fetch_mcm_earnings_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::AdManager::V1::McmEarningsService::Rest::ServiceStub.stub :transcode_fetch_mcm_earnings_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, fetch_mcm_earnings_client_stub do
        ...
        # Verify method calls
        assert_equal 5, fetch_mcm_earnings_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::McmEarningsService::Rest::Client::Configuration, config
  end
end
