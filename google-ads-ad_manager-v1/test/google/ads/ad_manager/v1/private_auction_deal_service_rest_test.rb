...
class ::Google::Ads::AdManager::V1::PrivateAuctionDealService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_private_auction_deal
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::PrivateAuctionDeal.new
    ...
    get_private_auction_deal_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Ads::AdManager::V1::PrivateAuctionDealService::Rest::ServiceStub.stub :transcode_get_private_auction_deal_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_private_auction_deal_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_private_auction_deal_client_stub.call_count
      end
    end
  end

  def test_list_private_auction_deals
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::ListPrivateAuctionDealsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_private_auction_deals_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::PrivateAuctionDealService::Rest::ServiceStub.stub :transcode_list_private_auction_deals_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_private_auction_deals_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_private_auction_deals_client_stub.call_count
      end
    end
  end

  def test_create_private_auction_deal
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::PrivateAuctionDeal.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    create_private_auction_deal_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::PrivateAuctionDealService::Rest::ServiceStub.stub :transcode_create_private_auction_deal_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_private_auction_deal_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_private_auction_deal_client_stub.call_count
      end
    end
  end

  def test_update_private_auction_deal
    # Create test objects.
    client_result = ::Google::Ads::AdManager::V1::PrivateAuctionDeal.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    update_private_auction_deal_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Ads::AdManager::V1::PrivateAuctionDealService::Rest::ServiceStub.stub :transcode_update_private_auction_deal_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_private_auction_deal_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_private_auction_deal_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Ads::AdManager::V1::PrivateAuctionDealService::Rest::Client::Configuration, config
  end
end
