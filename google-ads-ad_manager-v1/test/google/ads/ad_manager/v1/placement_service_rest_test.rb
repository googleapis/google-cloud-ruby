...
class ::Google::Ads::AdManager::V1::PlacementService::Rest::ClientTest < Minitest::Test
  ...
  def test_get_placement
    ...
    get_placement_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_list_placements
    ...
    list_placements_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
