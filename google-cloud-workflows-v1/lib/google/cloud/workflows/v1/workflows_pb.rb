...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/workflows/v1/workflows.proto", :syntax => :proto3) do
    add_message "google.cloud.workflows.v1.Workflow" do
      ...
      optional :state, :enum, 3, "google.cloud.workflows.v1.Workflow.State"
    ...
    add_enum "google.cloud.workflows.v1.Workflow.State" do
      value :STATE_UNSPECIFIED, 0
      value :ACTIVE, 1
    end
    add_message "google.cloud.workflows.v1.ListWorkflowsRequest" do
    ...
    add_message "google.cloud.workflows.v1.ListWorkflowsResponse" do
      repeated :workflows, :message, 1, "google.cloud.workflows.v1.Workflow"
      optional :next_page_token, :string, 2
      repeated :unreachable, :string, 3
    end
    add_message "google.cloud.workflows.v1.GetWorkflowRequest" do
      optional :name, :string, 1
    end
    add_message "google.cloud.workflows.v1.CreateWorkflowRequest" do
      optional :parent, :string, 1
      optional :workflow, :message, 2, "google.cloud.workflows.v1.Workflow"
      optional :workflow_id, :string, 3
    end
    add_message "google.cloud.workflows.v1.DeleteWorkflowRequest" do
      optional :name, :string, 1
    end
    add_message "google.cloud.workflows.v1.UpdateWorkflowRequest" do
      optional :workflow, :message, 1, "google.cloud.workflows.v1.Workflow"
      optional :update_mask, :message, 2, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.workflows.v1.OperationMetadata" do
