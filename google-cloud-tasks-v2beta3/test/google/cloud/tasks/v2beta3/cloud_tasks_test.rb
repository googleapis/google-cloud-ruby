...
class ::Google::Cloud::Tasks::V2beta3::CloudTasks::ClientTest < Minitest::Test
  ...
  def test_buffer_task
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Tasks::V2beta3::BufferTaskResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    buffer_task_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Tasks::V2beta3::BufferTaskRequest, request
    ...
    Gapic::ServiceStub.stub :new, buffer_task_client_stub do
      ...
      # Use protobuf object
      client.buffer_task ::Google::Cloud::Tasks::V2beta3::BufferTaskRequest.new(queue: queue, task_id: task_id, body: body) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.buffer_task(::Google::Cloud::Tasks::V2beta3::BufferTaskRequest.new(queue: queue, task_id: task_id, body: body), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
