...
```
$ gem install google-cloud-tasks-v2beta3
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-tasks-v2beta3/latest)
