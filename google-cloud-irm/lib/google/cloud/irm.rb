...
module Google
  module Cloud
    ...
    module Irm
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("irm"))
      ...
      #   The major version of the service to be used. By default :v1alpha2
      #   is used.
      ...
      def self.new(*args, version: :v1alpha2, **kwargs)
        ...
        version_module = Google::Cloud::Irm
          .constants
          .select {|sym| sym.to_s.downcase == version.to_s.downcase}
          .first
        Google::Cloud::Irm.const_get(version_module).new(*args, **kwargs)
      end
    end
  end
end
