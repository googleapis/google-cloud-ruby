...
class ::Google::Analytics::Data::V1beta::AnalyticsData::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Analytics::Data::V1beta::AnalyticsData::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Analytics::Data::V1beta::AnalyticsData::Operations::Configuration, config
  end
end
