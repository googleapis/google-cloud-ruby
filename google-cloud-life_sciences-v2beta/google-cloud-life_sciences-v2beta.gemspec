...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Cloud Life Sciences is a suite of services and tools for managing, processing, and transforming life sciences data. Note that google-cloud-life_sciences-v2beta is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-life_sciences instead. See the readme for more details."
