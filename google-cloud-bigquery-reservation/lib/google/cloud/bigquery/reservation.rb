...
require "google/cloud/bigquery/reservation/version"
...
::Google::Cloud.configure.add_config! :bigquery_reservation do |config|
  ...
  module Cloud
    module Bigquery
      module Reservation
        ...
        # given API version does not support the given transport of the ReservationService service.
        # You can determine whether the method will succeed by calling
        # {Google::Cloud::Bigquery::Reservation.reservation_service_available?}.
        #
        ...
        ##
        # Determines whether the ReservationService service is supported by the current client.
        # If true, you can retrieve a client object by calling {Google::Cloud::Bigquery::Reservation.reservation_service}.
        # If false, that method will raise an exception. This could happen if the given
        # API version does not exist or does not support the ReservationService service,
        # or if the versioned client gem needs an update to support the ReservationService service.
        #
        # @param version [::String, ::Symbol] The API version to connect to. Optional.
        #   Defaults to `:v1`.
        # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
        ...
        #
        def self.reservation_service_available? version: :v1, transport: :grpc
          require "google/cloud/bigquery/reservation/#{version.to_s.downcase}"
          package_name = Google::Cloud::Bigquery::Reservation
                         .constants
                         .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
          ...
          service_module = Google::Cloud::Bigquery::Reservation.const_get package_name
          return false unless service_module.const_defined? :ReservationService
          service_module = service_module.const_get :ReservationService
          if transport == :rest
