...
In general, the google-cloud-bigquery-reservation library uses
...
The google-cloud-bigquery-reservation library aims to make authentication
...
The environment variables that google-cloud-bigquery-reservation
...
Google::Cloud::Bigquery::Reservation.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-bigquery-reservation.
