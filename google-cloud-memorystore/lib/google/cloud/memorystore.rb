...
require "google/cloud/memorystore/version"
...
::Google::Cloud.configure.add_config! :memorystore do |config|
...
module Google
  module Cloud
    module Memorystore
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.memorystore if block_given?

        ::Google::Cloud.configure.memorystore
      end
    end
  end
end
...
require "google/cloud/memorystore/helpers" if ::File.file? helper_path
