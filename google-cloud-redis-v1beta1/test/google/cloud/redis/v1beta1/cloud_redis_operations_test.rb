...
class ::Google::Cloud::Redis::V1beta1::CloudRedis::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Redis::V1beta1::CloudRedis::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Redis::V1beta1::CloudRedis::Operations::Configuration, config
  end
end
