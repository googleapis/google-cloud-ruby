...
```sh
export TEXT_TO_SPEECH_CREDENTIALS=/path/to/json`
```
...
1. `TEXT_TO_SPEECH_CREDENTIALS` - Path to JSON file, or JSON contents
2. `TEXT_TO_SPEECH_KEYFILE` - Path to JSON file, or JSON contents
...
ENV["TEXT_TO_SPEECH_PROJECT"]     = "my-project-id"
ENV["TEXT_TO_SPEECH_CREDENTIALS"] = "path/to/keyfile.json"
