    ...
    module Sql
      module V1
        module SqlSslCertsService
          module Rest
            ##
            # REST service stub for the SqlSslCertsService service.
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1::SqlSslCertsDeleteRequest]
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1::SqlSslCertsGetRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1::SqlSslCertsInsertRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def insert request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Sql::V1::SslCertsInsertResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1::SqlSslCertsListRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def list request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Sql::V1::SslCertsListResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              def self.transcode_delete_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :delete,
                                                          uri_template: "/v1/projects/{project}/instances/{instance}/sslCerts/{sha1_fingerprint}",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["instance", %r{^[^/]+/?$}, false],
                                                            ["sha1_fingerprint", %r{^[^/]+/?$}, false]
                                                          ]
                                                        )
              ...
              def self.transcode_insert_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/projects/{project}/instances/{instance}/sslCerts",
                                                          body: "body",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["instance", %r{^[^/]+/?$}, false]
