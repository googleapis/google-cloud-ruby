  ...
  module Cloud
    module Sql
      module V1
        ...
        ResolveConnectSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.sql.v1.ResolveConnectSettingsRequest").msgclass
