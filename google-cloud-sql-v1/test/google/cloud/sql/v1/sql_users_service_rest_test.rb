  ...
  def test_delete
    ...
    ::Google::Cloud::Sql::V1::SqlUsersService::Rest::ServiceStub.stub :transcode_delete_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_client_stub do
        ...
        # Use protobuf object
        c.delete ::Google::Cloud::Sql::V1::SqlUsersDeleteRequest.new(host: host, instance: instance, name: name, project: project, location: location) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.delete(::Google::Cloud::Sql::V1::SqlUsersDeleteRequest.new(host: host, instance: instance, name: name, project: project, location: location), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get
    ...
    ::Google::Cloud::Sql::V1::SqlUsersService::Rest::ServiceStub.stub :transcode_get_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_client_stub do
        ...
        # Use protobuf object
        c.get ::Google::Cloud::Sql::V1::SqlUsersGetRequest.new(instance: instance, name: name, project: project, host: host, location: location) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get(::Google::Cloud::Sql::V1::SqlUsersGetRequest.new(instance: instance, name: name, project: project, host: host, location: location), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_insert
    ...
    ::Google::Cloud::Sql::V1::SqlUsersService::Rest::ServiceStub.stub :transcode_insert_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, insert_client_stub do
        ...
        # Use protobuf object
        c.insert ::Google::Cloud::Sql::V1::SqlUsersInsertRequest.new(instance: instance, project: project, body: body, location: location) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.insert(::Google::Cloud::Sql::V1::SqlUsersInsertRequest.new(instance: instance, project: project, body: body, location: location), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list
    ...
    ::Google::Cloud::Sql::V1::SqlUsersService::Rest::ServiceStub.stub :transcode_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_client_stub do
        ...
        # Use protobuf object
        c.list ::Google::Cloud::Sql::V1::SqlUsersListRequest.new(instance: instance, project: project, location: location) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list(::Google::Cloud::Sql::V1::SqlUsersListRequest.new(instance: instance, project: project, location: location), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
