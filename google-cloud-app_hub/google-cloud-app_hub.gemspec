...
Gem::Specification.new do |gem|
  ...
  gem.description   = "App Hub acts as the foundational data model and central registry for your applications on Google Cloud."
  ...
  gem.add_dependency "google-cloud-app_hub-v1", "~> 1.0"
