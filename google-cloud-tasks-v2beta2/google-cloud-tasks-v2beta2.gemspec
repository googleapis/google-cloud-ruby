...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Manages the execution of large numbers of distributed requests. Note that google-cloud-tasks-v2beta2 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-tasks instead. See the readme for more details."
