# Ruby Client for the Identity and Access Management (IAM) V2 API
...
specific version of the Identity and Access Management (IAM) V2 API. Most users should consider using
the main client gem,
