# Ruby Client for the BeyondCorp V1 API
...
specific version of the BeyondCorp V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-beyond_corp-app_connections-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-beyond_corp-app_connections-v1/latest)
