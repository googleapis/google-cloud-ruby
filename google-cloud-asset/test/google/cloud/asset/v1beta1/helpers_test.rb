...
class HelperMockAssetCredentials_v1beta1 < Google::Cloud::Asset::V1beta1::Credentials
  def initialize
  end
...
describe Google::Cloud::Asset::V1beta1::AssetServiceClient do
  let(:mock_credentials) { HelperMockAssetCredentials_v1beta1.new }

  describe "the project_path instance method" do
    it "correctly calls Google::Cloud::Asset::V1beta1::AssetServiceClient.project_path" do
      Google::Cloud::Asset::V1beta1::Credentials.stub(:default, mock_credentials) do
        parameters = Google::Cloud::Asset::V1beta1::AssetServiceClient.method("project_path").parameters.map { |arg| arg.last.to_s }
        client = Google::Cloud::Asset.new version: :v1beta1
        assert_equal(
          client.project_path(*parameters),
          Google::Cloud::Asset::V1beta1::AssetServiceClient.project_path(*parameters)
        )
      end
    end
  end
