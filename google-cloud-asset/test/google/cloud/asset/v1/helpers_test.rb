...
describe Google::Cloud::Asset::V1::AssetServiceClient do
  ...
  describe "the feed_path instance method" do
    it "correctly calls Google::Cloud::Asset::V1::AssetServiceClient.feed_path" do
      Google::Cloud::Asset::V1::Credentials.stub(:default, mock_credentials) do
        client = Google::Cloud::Asset.new version: :v1
        parameters = client.method("feed_path").parameters.map { |arg| arg.last.to_s }
        assert_equal(
          client.feed_path(*parameters),
          Google::Cloud::Asset::V1::AssetServiceClient.feed_path(*parameters)
        )
      end
    end
  end
