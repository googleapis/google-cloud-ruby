...
class ::Google::Cloud::DiscoveryEngine::V1::RecommendationService::ClientTest < Minitest::Test
  ...
  def test_recommend
    ...
    Gapic::ServiceStub.stub :new, recommend_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1::RecommendationService::Client.new do |config|
      ...
      # Use protobuf object
      c.recommend ::Google::Cloud::DiscoveryEngine::V1::RecommendRequest.new(serving_config: serving_config, user_event: user_event, page_size: page_size, filter: filter, validate_only: validate_only, params: params, user_labels: user_labels) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.recommend(::Google::Cloud::DiscoveryEngine::V1::RecommendRequest.new(serving_config: serving_config, user_event: user_event, page_size: page_size, filter: filter, validate_only: validate_only, params: params, user_labels: user_labels), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
