...
class ::Google::Cloud::DiscoveryEngine::V1::SearchTuningService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_train_custom_model
    ...
    train_custom_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::DiscoveryEngine::V1::SearchTuningService::Rest::ServiceStub.stub :transcode_train_custom_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, train_custom_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, train_custom_model_client_stub.call_count
      end
    end
  end
  ...
  def test_list_custom_models
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::ListCustomModelsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_custom_models_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::DiscoveryEngine::V1::SearchTuningService::Rest::ServiceStub.stub :transcode_list_custom_models_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_custom_models_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_custom_models_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::SearchTuningService::Rest::Client::Configuration, config
  end
end
