...
class ::Google::Cloud::DiscoveryEngine::V1::ServingConfigService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_update_serving_config
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::ServingConfig.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ServingConfigService::Rest::Client::Configuration, config
  end
end
