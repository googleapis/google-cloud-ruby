...
class ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ClientTest < Minitest::Test
  ...
  def test_get_document
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_get_document_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_document_client_stub do
        # Create client
        c = ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.get_document ::Google::Cloud::DiscoveryEngine::V1::GetDocumentRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.get_document(::Google::Cloud::DiscoveryEngine::V1::GetDocumentRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_documents
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_list_documents_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_documents_client_stub do
        ...
        # Use protobuf object
        c.list_documents ::Google::Cloud::DiscoveryEngine::V1::ListDocumentsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_documents(::Google::Cloud::DiscoveryEngine::V1::ListDocumentsRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_document
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_create_document_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_document_client_stub do
        ...
        # Use protobuf object
        c.create_document ::Google::Cloud::DiscoveryEngine::V1::CreateDocumentRequest.new(parent: parent, document: document, document_id: document_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.create_document(::Google::Cloud::DiscoveryEngine::V1::CreateDocumentRequest.new(parent: parent, document: document, document_id: document_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_document
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_update_document_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_document_client_stub do
        ...
        # Use protobuf object
        c.update_document ::Google::Cloud::DiscoveryEngine::V1::UpdateDocumentRequest.new(document: document, allow_missing: allow_missing, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_document(::Google::Cloud::DiscoveryEngine::V1::UpdateDocumentRequest.new(document: document, allow_missing: allow_missing, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_document
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_delete_document_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_document_client_stub do
        ...
        # Use protobuf object
        c.delete_document ::Google::Cloud::DiscoveryEngine::V1::DeleteDocumentRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_document(::Google::Cloud::DiscoveryEngine::V1::DeleteDocumentRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_import_documents
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_import_documents_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, import_documents_client_stub do
        ...
        # Use hash object
        c.import_documents({ inline_source: inline_source, parent: parent, error_config: error_config, reconciliation_mode: reconciliation_mode, update_mask: update_mask, auto_generate_ids: auto_generate_ids, id_field: id_field, force_refresh_content: force_refresh_content }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.import_documents ::Google::Cloud::DiscoveryEngine::V1::ImportDocumentsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config, reconciliation_mode: reconciliation_mode, update_mask: update_mask, auto_generate_ids: auto_generate_ids, id_field: id_field, force_refresh_content: force_refresh_content) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.import_documents({ inline_source: inline_source, parent: parent, error_config: error_config, reconciliation_mode: reconciliation_mode, update_mask: update_mask, auto_generate_ids: auto_generate_ids, id_field: id_field, force_refresh_content: force_refresh_content }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.import_documents(::Google::Cloud::DiscoveryEngine::V1::ImportDocumentsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config, reconciliation_mode: reconciliation_mode, update_mask: update_mask, auto_generate_ids: auto_generate_ids, id_field: id_field, force_refresh_content: force_refresh_content), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_purge_documents
    ...
    purge_documents_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_purge_documents_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, purge_documents_client_stub do
        ...
        # Use protobuf object
        c.purge_documents ::Google::Cloud::DiscoveryEngine::V1::PurgeDocumentsRequest.new(gcs_source: gcs_source, parent: parent, filter: filter, error_config: error_config, force: force) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.purge_documents(::Google::Cloud::DiscoveryEngine::V1::PurgeDocumentsRequest.new(gcs_source: gcs_source, parent: parent, filter: filter, error_config: error_config, force: force), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_batch_get_documents_metadata
    ...
    batch_get_documents_metadata_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::DiscoveryEngine::V1::DocumentService::Rest::ServiceStub.stub :transcode_batch_get_documents_metadata_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_get_documents_metadata_client_stub do
        ...
        # Use protobuf object
        c.batch_get_documents_metadata ::Google::Cloud::DiscoveryEngine::V1::BatchGetDocumentsMetadataRequest.new(parent: parent, matcher: matcher) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.batch_get_documents_metadata(::Google::Cloud::DiscoveryEngine::V1::BatchGetDocumentsMetadataRequest.new(parent: parent, matcher: matcher), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
