  ...
  def test_search
    ...
    ::Google::Cloud::DiscoveryEngine::V1::SearchService::Rest::ServiceStub.stub :transcode_search_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_client_stub do
        ...
        # Use hash object
        client.search({ serving_config: serving_config, branch: branch, query: query, page_size: page_size, page_token: page_token, offset: offset, user_info: user_info, params: params, query_expansion_spec: query_expansion_spec, spell_correction_spec: spell_correction_spec, user_pseudo_id: user_pseudo_id, content_search_spec: content_search_spec, safe_search: safe_search, user_labels: user_labels }) do |_result, response|
        ...
        # Use protobuf object
        client.search ::Google::Cloud::DiscoveryEngine::V1::SearchRequest.new(serving_config: serving_config, branch: branch, query: query, page_size: page_size, page_token: page_token, offset: offset, user_info: user_info, params: params, query_expansion_spec: query_expansion_spec, spell_correction_spec: spell_correction_spec, user_pseudo_id: user_pseudo_id, content_search_spec: content_search_spec, safe_search: safe_search, user_labels: user_labels) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
