...
class ::Google::Cloud::DiscoveryEngine::V1::UserEventService::ClientTest < Minitest::Test
  ...
  def test_write_user_event
    ...
    Gapic::ServiceStub.stub :new, write_user_event_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1::UserEventService::Client.new do |config|
      ...
      # Use protobuf object
      c.write_user_event ::Google::Cloud::DiscoveryEngine::V1::WriteUserEventRequest.new(parent: parent, user_event: user_event, write_async: write_async) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.write_user_event(::Google::Cloud::DiscoveryEngine::V1::WriteUserEventRequest.new(parent: parent, user_event: user_event, write_async: write_async), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_collect_user_event
    ...
    Gapic::ServiceStub.stub :new, collect_user_event_client_stub do
      ...
      # Use protobuf object
      c.collect_user_event ::Google::Cloud::DiscoveryEngine::V1::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.collect_user_event(::Google::Cloud::DiscoveryEngine::V1::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_purge_user_events
    ...
    Gapic::ServiceStub.stub :new, purge_user_events_client_stub do
      ...
      # Use protobuf object
      c.purge_user_events ::Google::Cloud::DiscoveryEngine::V1::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.purge_user_events(::Google::Cloud::DiscoveryEngine::V1::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_user_events
    ...
    Gapic::ServiceStub.stub :new, import_user_events_client_stub do
      ...
      # Use protobuf object
      c.import_user_events ::Google::Cloud::DiscoveryEngine::V1::ImportUserEventsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.import_user_events(::Google::Cloud::DiscoveryEngine::V1::ImportUserEventsRequest.new(inline_source: inline_source, parent: parent, error_config: error_config), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
