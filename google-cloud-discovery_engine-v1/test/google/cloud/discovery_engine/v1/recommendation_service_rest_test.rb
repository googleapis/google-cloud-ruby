...
class ::Google::Cloud::DiscoveryEngine::V1::RecommendationService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_recommend
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::RecommendResponse.new
    ...
    recommend_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::DiscoveryEngine::V1::RecommendationService::Rest::ServiceStub.stub :transcode_recommend_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, recommend_client_stub do
        ...
        # Verify method calls
        assert_equal 5, recommend_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::RecommendationService::Rest::Client::Configuration, config
  end
end
