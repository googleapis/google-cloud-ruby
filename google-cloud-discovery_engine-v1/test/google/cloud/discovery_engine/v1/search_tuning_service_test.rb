...
class ::Google::Cloud::DiscoveryEngine::V1::SearchTuningService::ClientTest < Minitest::Test
  ...
  def test_train_custom_model
    ...
    Gapic::ServiceStub.stub :new, train_custom_model_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1::SearchTuningService::Client.new do |config|
      ...
      # Use protobuf object
      c.train_custom_model ::Google::Cloud::DiscoveryEngine::V1::TrainCustomModelRequest.new(gcs_training_input: gcs_training_input, data_store: data_store, model_type: model_type, error_config: error_config, model_id: model_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      c.train_custom_model(::Google::Cloud::DiscoveryEngine::V1::TrainCustomModelRequest.new(gcs_training_input: gcs_training_input, data_store: data_store, model_type: model_type, error_config: error_config, model_id: model_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_custom_models
    ...
    Gapic::ServiceStub.stub :new, list_custom_models_client_stub do
      ...
      # Use protobuf object
      c.list_custom_models ::Google::Cloud::DiscoveryEngine::V1::ListCustomModelsRequest.new(data_store: data_store) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_custom_models(::Google::Cloud::DiscoveryEngine::V1::ListCustomModelsRequest.new(data_store: data_store), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
