...
class ::Google::Cloud::DiscoveryEngine::V1::SchemaService::ClientTest < Minitest::Test
  ...
  def test_get_schema
    ...
    Gapic::ServiceStub.stub :new, get_schema_client_stub do
      ...
      # Use protobuf object
      client.get_schema ::Google::Cloud::DiscoveryEngine::V1::GetSchemaRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.get_schema(::Google::Cloud::DiscoveryEngine::V1::GetSchemaRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_schemas
    ...
    Gapic::ServiceStub.stub :new, list_schemas_client_stub do
      ...
      # Use protobuf object
      client.list_schemas ::Google::Cloud::DiscoveryEngine::V1::ListSchemasRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_schemas(::Google::Cloud::DiscoveryEngine::V1::ListSchemasRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_schema
    ...
    Gapic::ServiceStub.stub :new, create_schema_client_stub do
      ...
      # Use protobuf object
      client.create_schema ::Google::Cloud::DiscoveryEngine::V1::CreateSchemaRequest.new(parent: parent, schema: schema, schema_id: schema_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_schema(::Google::Cloud::DiscoveryEngine::V1::CreateSchemaRequest.new(parent: parent, schema: schema, schema_id: schema_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_schema
    ...
    Gapic::ServiceStub.stub :new, update_schema_client_stub do
      ...
      # Use protobuf object
      client.update_schema ::Google::Cloud::DiscoveryEngine::V1::UpdateSchemaRequest.new(schema: schema, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_schema(::Google::Cloud::DiscoveryEngine::V1::UpdateSchemaRequest.new(schema: schema, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_schema
    ...
    Gapic::ServiceStub.stub :new, delete_schema_client_stub do
      ...
      # Use protobuf object
      client.delete_schema ::Google::Cloud::DiscoveryEngine::V1::DeleteSchemaRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_schema(::Google::Cloud::DiscoveryEngine::V1::DeleteSchemaRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
