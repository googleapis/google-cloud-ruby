...
class ::Google::Cloud::DiscoveryEngine::V1::SchemaService::ClientTest < Minitest::Test
  ...
  def test_get_schema
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::Schema.new
    ...
    get_schema_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::GetSchemaRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_schema_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1::SchemaService::Client.new do |config|
      ...
      # Use protobuf object
      c.get_schema ::Google::Cloud::DiscoveryEngine::V1::GetSchemaRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.get_schema(::Google::Cloud::DiscoveryEngine::V1::GetSchemaRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_schemas
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::ListSchemasResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_schemas_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ListSchemasRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_schemas_client_stub do
      ...
      # Use protobuf object
      c.list_schemas ::Google::Cloud::DiscoveryEngine::V1::ListSchemasRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_schemas(::Google::Cloud::DiscoveryEngine::V1::ListSchemasRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_schema
    ...
    create_schema_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::CreateSchemaRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::Schema), request["schema"]
    ...
    Gapic::ServiceStub.stub :new, create_schema_client_stub do
      ...
      # Use protobuf object
      c.create_schema ::Google::Cloud::DiscoveryEngine::V1::CreateSchemaRequest.new(parent: parent, schema: schema, schema_id: schema_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_schema(::Google::Cloud::DiscoveryEngine::V1::CreateSchemaRequest.new(parent: parent, schema: schema, schema_id: schema_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_schema
    ...
    update_schema_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::UpdateSchemaRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::Schema), request["schema"]
    ...
    Gapic::ServiceStub.stub :new, update_schema_client_stub do
      ...
      # Use protobuf object
      c.update_schema ::Google::Cloud::DiscoveryEngine::V1::UpdateSchemaRequest.new(schema: schema, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_schema(::Google::Cloud::DiscoveryEngine::V1::UpdateSchemaRequest.new(schema: schema, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_schema
    ...
    delete_schema_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::DeleteSchemaRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_schema_client_stub do
      ...
      # Use protobuf object
      c.delete_schema ::Google::Cloud::DiscoveryEngine::V1::DeleteSchemaRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_schema(::Google::Cloud::DiscoveryEngine::V1::DeleteSchemaRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::SchemaService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::SchemaService::Operations, client.operations_client
  end
end
