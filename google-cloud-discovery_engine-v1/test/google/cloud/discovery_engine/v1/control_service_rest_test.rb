...
class ::Google::Cloud::DiscoveryEngine::V1::ControlService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_control
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::Control.new
  ...
  def test_list_controls
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::ListControlsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ControlService::Rest::Client::Configuration, config
  end
end
