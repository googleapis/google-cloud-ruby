...
class ::Google::Cloud::DiscoveryEngine::V1::SearchService::ClientTest < Minitest::Test
  ...
  def test_search
    ...
    search_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::SearchRequest::RelevanceFilterSpec), request["relevance_filter_spec"]
      ...
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::SearchRequest::SearchAddonSpec), request["search_addon_spec"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::SearchRequest::CustomRankingParams), request["custom_ranking_params"]
    ...
    Gapic::ServiceStub.stub :new, search_client_stub do
      ...
      # Use hash object
      c.search({ serving_config: serving_config, branch: branch, query: query, page_categories: page_categories, image_query: image_query, page_size: page_size, page_token: page_token, offset: offset, one_box_page_size: one_box_page_size, data_store_specs: data_store_specs, num_results_per_data_store: num_results_per_data_store, filter: filter, canonical_filter: canonical_filter, order_by: order_by, user_info: user_info, language_code: language_code, facet_specs: facet_specs, boost_spec: boost_spec, params: params, query_expansion_spec: query_expansion_spec, spell_correction_spec: spell_correction_spec, user_pseudo_id: user_pseudo_id, content_search_spec: content_search_spec, ranking_expression: ranking_expression, ranking_expression_backend: ranking_expression_backend, safe_search: safe_search, user_labels: user_labels, natural_language_query_understanding_spec: natural_language_query_understanding_spec, search_as_you_type_spec: search_as_you_type_spec, display_spec: display_spec, crowding_specs: crowding_specs, session: session, session_spec: session_spec, relevance_threshold: relevance_threshold, relevance_filter_spec: relevance_filter_spec, relevance_score_spec: relevance_score_spec, search_addon_spec: search_addon_spec, custom_ranking_params: custom_ranking_params, entity: entity }) do |response, operation|
      ...
      c.search({ serving_config: serving_config, branch: branch, query: query, page_categories: page_categories, image_query: image_query, page_size: page_size, page_token: page_token, offset: offset, one_box_page_size: one_box_page_size, data_store_specs: data_store_specs, num_results_per_data_store: num_results_per_data_store, filter: filter, canonical_filter: canonical_filter, order_by: order_by, user_info: user_info, language_code: language_code, facet_specs: facet_specs, boost_spec: boost_spec, params: params, query_expansion_spec: query_expansion_spec, spell_correction_spec: spell_correction_spec, user_pseudo_id: user_pseudo_id, content_search_spec: content_search_spec, ranking_expression: ranking_expression, ranking_expression_backend: ranking_expression_backend, safe_search: safe_search, user_labels: user_labels, natural_language_query_understanding_spec: natural_language_query_understanding_spec, search_as_you_type_spec: search_as_you_type_spec, display_spec: display_spec, crowding_specs: crowding_specs, session: session, session_spec: session_spec, relevance_threshold: relevance_threshold, relevance_filter_spec: relevance_filter_spec, relevance_score_spec: relevance_score_spec, search_addon_spec: search_addon_spec, custom_ranking_params: custom_ranking_params, entity: entity }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
