...
class ::Google::Cloud::DiscoveryEngine::V1::ControlService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_control
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::Control.new
    ...
    create_control_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::CreateControlRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::Control), request["control"]
    ...
    Gapic::ServiceStub.stub :new, create_control_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1::ControlService::Client.new do |config|
      ...
      # Use protobuf object
      c.create_control ::Google::Cloud::DiscoveryEngine::V1::CreateControlRequest.new(parent: parent, control: control, control_id: control_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.create_control(::Google::Cloud::DiscoveryEngine::V1::CreateControlRequest.new(parent: parent, control: control, control_id: control_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_control
    ...
    delete_control_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::DeleteControlRequest, request
    ...
    Gapic::ServiceStub.stub :new, delete_control_client_stub do
      ...
      # Use protobuf object
      c.delete_control ::Google::Cloud::DiscoveryEngine::V1::DeleteControlRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_control(::Google::Cloud::DiscoveryEngine::V1::DeleteControlRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_control
    ...
    update_control_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::UpdateControlRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DiscoveryEngine::V1::Control), request["control"]
    ...
    Gapic::ServiceStub.stub :new, update_control_client_stub do
      ...
      # Use protobuf object
      c.update_control ::Google::Cloud::DiscoveryEngine::V1::UpdateControlRequest.new(control: control, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_control(::Google::Cloud::DiscoveryEngine::V1::UpdateControlRequest.new(control: control, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_control
    ...
    get_control_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::GetControlRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_control_client_stub do
      ...
      # Use protobuf object
      c.get_control ::Google::Cloud::DiscoveryEngine::V1::GetControlRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_control(::Google::Cloud::DiscoveryEngine::V1::GetControlRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_controls
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DiscoveryEngine::V1::ListControlsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_controls_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ListControlsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_controls_client_stub do
      ...
      # Use protobuf object
      c.list_controls ::Google::Cloud::DiscoveryEngine::V1::ListControlsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_controls(::Google::Cloud::DiscoveryEngine::V1::ListControlsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::ControlService::Client::Configuration, config
  end
