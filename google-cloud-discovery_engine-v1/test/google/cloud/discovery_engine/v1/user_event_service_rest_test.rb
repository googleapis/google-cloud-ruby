...
class ::Google::Cloud::DiscoveryEngine::V1::UserEventService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_write_user_event
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1::UserEvent.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::UserEventService::Rest::Client::Configuration, config
  end
end
