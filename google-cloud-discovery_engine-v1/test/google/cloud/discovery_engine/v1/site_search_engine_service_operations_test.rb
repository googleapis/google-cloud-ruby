...
class ::Google::Cloud::DiscoveryEngine::V1::SiteSearchEngineService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1::SiteSearchEngineService::Operations.new do |config|
  ...
  def test_configure
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      client = ::Google::Cloud::DiscoveryEngine::V1::SiteSearchEngineService::Operations.new do |config|
        config.credentials = grpc_channel
      end
    end
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1::SiteSearchEngineService::Operations::Configuration, config
  end
end
