  ...
  module Cloud
    module DiscoveryEngine
      module V1
        ...
        StreamAssistRequest::AgentsSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1.StreamAssistRequest.AgentsSpec").msgclass
        StreamAssistRequest::AgentsSpec::AgentSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1.StreamAssistRequest.AgentsSpec.AgentSpec").msgclass
