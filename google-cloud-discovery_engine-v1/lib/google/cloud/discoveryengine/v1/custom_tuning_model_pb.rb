...
module Google
  module Cloud
    module DiscoveryEngine
      module V1
        CustomTuningModel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1.CustomTuningModel").msgclass
        CustomTuningModel::ModelState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1.CustomTuningModel.ModelState").enummodule
      end
    end
  end
end
