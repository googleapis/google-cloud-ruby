...
require "google/cloud/discovery_engine/v1/grounded_generation_service/client"
...
require "google/cloud/discovery_engine/v1/grounded_generation_service/helpers" if ::File.file? helper_path
