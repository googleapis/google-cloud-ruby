...
require "google/cloud/discovery_engine/v1/session_service/rest/service_stub"
        ...
        module SessionService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::DiscoveryEngine::V1::SessionService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all SessionService clients
              #   ::Google::Cloud::DiscoveryEngine::V1::SessionService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Cloud::DiscoveryEngine::V1::SessionService::Rest::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Cloud::DiscoveryEngine::V1::SessionService::Rest::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @session_service_stub = ::Google::Cloud::DiscoveryEngine::V1::SessionService::Rest::ServiceStub.new(
              ...
              # {::Google::Cloud::DiscoveryEngine::V1::SessionService::Rest::Client::Configuration::Rpcs}
