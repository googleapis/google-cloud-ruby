...
##
# Snippet for the create_sitemap call in the SiteSearchEngineService service
#
...
# Google::Cloud::DiscoveryEngine::V1::SiteSearchEngineService::Client#create_sitemap.
#
def create_sitemap
