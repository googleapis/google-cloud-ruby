...
##
# Snippet for the delete_session call in the ConversationalSearchService service
#
...
# Google::Cloud::DiscoveryEngine::V1::ConversationalSearchService::Client#delete_session.
#
def delete_session
