...
require "google/shopping/merchant/data_sources/v1/file_uploads_service/rest/service_stub"
          ...
          module FileUploadsService
            module Rest
              ...
              class Client
                ...
                #
                # See {::Google::Shopping::Merchant::DataSources::V1::FileUploadsService::Rest::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all FileUploadsService clients
                #   ::Google::Shopping::Merchant::DataSources::V1::FileUploadsService::Rest::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                #   client = ::Google::Shopping::Merchant::DataSources::V1::FileUploadsService::Rest::Client.new do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                def initialize
                  ...
                  @file_uploads_service_stub = ::Google::Shopping::Merchant::DataSources::V1::FileUploadsService::Rest::ServiceStub.new(
                ...
                #   {::Google::Shopping::Merchant::DataSources::V1::GetFileUploadRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Shopping::Merchant::DataSources::V1::GetFileUploadRequest, ::Hash]
                ...
                # @yieldparam result [::Google::Shopping::Merchant::DataSources::V1::FileUpload]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Shopping::Merchant::DataSources::V1::FileUpload]
                #
                ...
                #   request = Google::Shopping::Merchant::DataSources::V1::GetFileUploadRequest.new
                #
                #   # Call the get_file_upload method.
                #   result = client.get_file_upload request
                #
                #   # The returned object is of type Google::Shopping::Merchant::DataSources::V1::FileUpload.
                #   p result
                #
                def get_file_upload request, options = nil
                  raise ::ArgumentError, "request must be provided" if request.nil?

                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::DataSources::V1::GetFileUploadRequest
                ...
                # {::Google::Shopping::Merchant::DataSources::V1::FileUploadsService::Rest::Client::Configuration::Rpcs}
