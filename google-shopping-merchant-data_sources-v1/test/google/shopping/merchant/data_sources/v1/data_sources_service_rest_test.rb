...
class ::Google::Shopping::Merchant::DataSources::V1::DataSourcesService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_data_source
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::DataSources::V1::DataSource.new
  ...
  def test_list_data_sources
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::DataSources::V1::ListDataSourcesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_create_data_source
    ...
    create_data_source_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::DataSources::V1::DataSourcesService::Rest::ServiceStub.stub :transcode_create_data_source_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_data_source_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_data_source_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_data_source
    ...
    delete_data_source_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::DataSources::V1::DataSourcesService::Rest::ServiceStub.stub :transcode_delete_data_source_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_data_source_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_data_source_client_stub.call_count
      end
    end
  end
  ...
  def test_fetch_data_source
    ...
    fetch_data_source_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::DataSources::V1::DataSourcesService::Rest::ServiceStub.stub :transcode_fetch_data_source_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, fetch_data_source_client_stub do
        ...
        # Verify method calls
        assert_equal 5, fetch_data_source_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::DataSources::V1::DataSourcesService::Rest::Client::Configuration, config
  end
end
