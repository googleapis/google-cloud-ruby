...
class ::Google::Shopping::Merchant::DataSources::V1::DataSourcesService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_data_source_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.data_source_path account: "value0", datasource: "value1"
      assert_equal "accounts/value0/dataSources/value1", path
    end
  end
end
