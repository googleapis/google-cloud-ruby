...
specific version of the GDC Hardware Management V1ALPHA API. Most users should consider using
the main client gem,
[google-cloud-gdc_hardware_management](https://rubygems.org/gems/google-cloud-gdc_hardware_management).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-gdc_hardware_management-v1alpha
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-gdc_hardware_management-v1alpha/latest)
