...
##
# Snippet for the delete_hardware_group call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#delete_hardware_group.
#
