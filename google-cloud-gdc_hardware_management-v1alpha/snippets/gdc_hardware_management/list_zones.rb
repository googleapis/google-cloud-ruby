...
##
# Snippet for the list_zones call in the GDCHardwareManagement service
#
...
# Google::Cloud::GDCHardwareManagement::V1alpha::GDCHardwareManagement::Client#list_zones.
#
def list_zones
