...
class ::Google::Cloud::Bigquery::DataPolicies::V1beta1::DataPolicyService::ClientTest < Minitest::Test
  ...
  def test_create_data_policy
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Bigquery::DataPolicies::V1beta1::DataPolicy.new
    ...
    create_data_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::DataPolicies::V1beta1::CreateDataPolicyRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Bigquery::DataPolicies::V1beta1::DataPolicy), request["data_policy"]
      refute_nil options
    end
  ...
  def test_update_data_policy
    ...
    update_data_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::DataPolicies::V1beta1::UpdateDataPolicyRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Bigquery::DataPolicies::V1beta1::DataPolicy), request["data_policy"]
  ...
  def test_delete_data_policy
    ...
    delete_data_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::DataPolicies::V1beta1::DeleteDataPolicyRequest, request
  ...
  def test_get_data_policy
    ...
    get_data_policy_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::DataPolicies::V1beta1::GetDataPolicyRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_list_data_policies
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Bigquery::DataPolicies::V1beta1::ListDataPoliciesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_data_policies_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::DataPolicies::V1beta1::ListDataPoliciesRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Bigquery::DataPolicies::V1beta1::DataPolicyService::Client::Configuration, config
  end
end
