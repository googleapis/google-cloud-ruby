          ...
          module DataPolicyService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Cloud::Bigquery::DataPolicies::V1beta1::CreateDataPolicyRequest]
                ...
                def create_data_policy request_pb, options = nil
                  ...
                  result = ::Google::Cloud::Bigquery::DataPolicies::V1beta1::DataPolicy.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Cloud::Bigquery::DataPolicies::V1beta1::UpdateDataPolicyRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Cloud::Bigquery::DataPolicies::V1beta1::DeleteDataPolicyRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Cloud::Bigquery::DataPolicies::V1beta1::GetDataPolicyRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Cloud::Bigquery::DataPolicies::V1beta1::ListDataPoliciesRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Cloud::Bigquery::DataPolicies::V1beta1::ListDataPoliciesResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Cloud::Bigquery::DataPolicies::V1beta1::ListDataPoliciesResponse]
                #   A result object deserialized from the server's reply
                def list_data_policies request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Cloud::Bigquery::DataPolicies::V1beta1::ListDataPoliciesResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                def self.transcode_create_data_policy_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/v1beta1/{parent}/dataPolicies",
                                                            body: "data_policy",
                                                            matches: [
                ...
                def self.transcode_update_data_policy_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :patch,
                                                            uri_template: "/v1beta1/{data_policy.name}",
                                                            body: "data_policy",
                                                            matches: [
