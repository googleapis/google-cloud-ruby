...
require File.expand_path("lib/google/cloud/alloy_db/v1alpha/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-alloy_db-v1alpha"
  gem.version       = Google::Cloud::AlloyDB::V1alpha::VERSION
