...
class ::Google::Cloud::AlloyDB::V1alpha::AlloyDBCloudSQLAdmin::ClientTest < Minitest::Test
  ...
  def test_restore_from_cloud_sql
    ...
    Gapic::ServiceStub.stub :new, restore_from_cloud_sql_client_stub do
      # Create client
      c = ::Google::Cloud::AlloyDB::V1alpha::AlloyDBCloudSQLAdmin::Client.new do |config|
      ...
      # Use protobuf object
      c.restore_from_cloud_sql ::Google::Cloud::AlloyDB::V1alpha::RestoreFromCloudSQLRequest.new(cloudsql_backup_run_source: cloudsql_backup_run_source, parent: parent, cluster_id: cluster_id, cluster: cluster) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      c.restore_from_cloud_sql(::Google::Cloud::AlloyDB::V1alpha::RestoreFromCloudSQLRequest.new(cloudsql_backup_run_source: cloudsql_backup_run_source, parent: parent, cluster_id: cluster_id, cluster: cluster), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
