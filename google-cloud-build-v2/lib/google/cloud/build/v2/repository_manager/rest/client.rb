...
require "google/cloud/build/v2/repository_manager/rest/service_stub"
    ...
    module Build
      module V2
        module RepositoryManager
          module Rest
            ##
            # REST client for the RepositoryManager service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Build::V2::RepositoryManager::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all RepositoryManager clients
              #   ::Google::Cloud::Build::V2::RepositoryManager::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new RepositoryManager REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::Build::V2::RepositoryManager::Rest::Operations.new do |config|
                ...
                @repository_manager_stub = ::Google::Cloud::Build::V2::RepositoryManager::Rest::ServiceStub.new(
                ...
                @repository_manager_stub.logger(stub: true)&.info do |entry|
              ...
              #
              # @return [::Google::Cloud::Build::V2::RepositoryManager::Rest::Operations]
              #
              ...
              def create_connection request, options = nil
                ...
                @repository_manager_stub.create_connection request, options do |result, operation|
              ...
              def get_connection request, options = nil
                ...
                @repository_manager_stub.get_connection request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #     Page start.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Build::V2::Connection>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Build::V2::Connection>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_connections request, options = nil
                ...
                @repository_manager_stub.list_connections request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @repository_manager_stub, :list_connections, "connections", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def update_connection request, options = nil
                ...
                @repository_manager_stub.update_connection request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def delete_connection request, options = nil
                ...
                @repository_manager_stub.delete_connection request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def create_repository request, options = nil
                ...
                @repository_manager_stub.create_repository request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def batch_create_repositories request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.batch_create_repositories.metadata.to_h
                ...
                @repository_manager_stub.batch_create_repositories request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def get_repository request, options = nil
                ...
                @repository_manager_stub.get_repository request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Build::V2::Repository>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Build::V2::Repository>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_repositories request, options = nil
                ...
                @repository_manager_stub.list_repositories request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @repository_manager_stub, :list_repositories, "repositories", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def delete_repository request, options = nil
                ...
                @repository_manager_stub.delete_repository request, options do |result, operation|
                  result = ::Gapic::Operation.new result, @operations_client, options: options
                  yield result, operation if block_given?
                  throw :response, result
                end
              ...
              def fetch_read_write_token request, options = nil
                ...
                @repository_manager_stub.fetch_read_write_token request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def fetch_read_token request, options = nil
                ...
                @repository_manager_stub.fetch_read_token request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def fetch_linkable_repositories request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.fetch_linkable_repositories.metadata.to_h
                ...
                @repository_manager_stub.fetch_linkable_repositories request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @repository_manager_stub, :fetch_linkable_repositories, "repositories", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def fetch_git_refs request, options = nil
                ...
                @repository_manager_stub.fetch_git_refs request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the RepositoryManager REST API.
              #
              # This class represents the configuration for RepositoryManager REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::Build::V2::RepositoryManager::Rest::Client::Configuration::Rpcs}
