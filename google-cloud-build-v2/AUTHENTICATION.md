...
In general, the google-cloud-build-v2 library uses
...
The google-cloud-build-v2 library aims to make authentication
...
The environment variables that google-cloud-build-v2
checks for credentials are configured on the service Credentials class (such as
{::Google::Cloud::Build::V2::RepositoryManager::Credentials}):
...
connect to most services with google-cloud-build-v2.
