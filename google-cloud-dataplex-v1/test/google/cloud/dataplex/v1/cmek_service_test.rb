...
class ::Google::Cloud::Dataplex::V1::CmekService::ClientTest < Minitest::Test
  ...
  def test_create_encryption_config
    ...
    create_encryption_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_encryption_config, name
      assert_kind_of ::Google::Cloud::Dataplex::V1::CreateEncryptionConfigRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["encryption_config_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dataplex::V1::EncryptionConfig), request["encryption_config"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_encryption_config_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_encryption_config_client_stub.call_rpc_count
    end
  end
  ...
  def test_update_encryption_config
    ...
    update_encryption_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_encryption_config, name
      assert_kind_of ::Google::Cloud::Dataplex::V1::UpdateEncryptionConfigRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dataplex::V1::EncryptionConfig), request["encryption_config"]
    ...
    Gapic::ServiceStub.stub :new, update_encryption_config_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_encryption_config_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_encryption_config
    ...
    delete_encryption_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_encryption_config, name
      assert_kind_of ::Google::Cloud::Dataplex::V1::DeleteEncryptionConfigRequest, request
    ...
    Gapic::ServiceStub.stub :new, delete_encryption_config_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_encryption_config_client_stub.call_rpc_count
    end
  end

  def test_list_encryption_configs
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dataplex::V1::ListEncryptionConfigsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_encryption_configs_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_encryption_configs, name
      assert_kind_of ::Google::Cloud::Dataplex::V1::ListEncryptionConfigsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_encryption_configs_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_encryption_configs_client_stub.call_rpc_count
    end
  end

  def test_get_encryption_config
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dataplex::V1::EncryptionConfig.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_encryption_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_encryption_config, name
      assert_kind_of ::Google::Cloud::Dataplex::V1::GetEncryptionConfigRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_encryption_config_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_encryption_config_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dataplex::V1::CmekService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Dataplex::V1::CmekService::Operations, client.operations_client
  end
end
