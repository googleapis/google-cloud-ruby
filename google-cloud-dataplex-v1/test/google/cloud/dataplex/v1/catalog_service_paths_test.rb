...
class ::Google::Cloud::Dataplex::V1::CatalogService::ClientPathsTest < Minitest::Test
  ...
  def test_metadata_feed_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.metadata_feed_path project: "value0", location: "value1", metadata_feed: "value2"
      assert_equal "projects/value0/locations/value1/metadataFeeds/value2", path
    end
  end
