...
In general, the google-cloud-profiler library uses
...
The google-cloud-profiler library aims to make authentication
...
The environment variables that google-cloud-profiler
...
Google::Cloud::Profiler.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-profiler.
