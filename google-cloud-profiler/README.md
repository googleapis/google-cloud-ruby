# Ruby Client for the Cloud Profiler API

API Client library for the Cloud Profiler API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-profiler/latest)
for this library, google-cloud-profiler, to see the convenience methods for
...
client = Google::Cloud::Profiler.profiler_service
...
client library with a name such as `google-cloud-profiler`,
...
is part of the name, e.g. `google-cloud-profiler-v2`.
