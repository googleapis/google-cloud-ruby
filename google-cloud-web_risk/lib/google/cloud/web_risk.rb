...
module Google
  module Cloud
    module WebRisk
      ...
      # [Google::Cloud::WebRisk::V1::WebRiskService::Client](https://cloud.google.com/ruby/docs/reference/google-cloud-web_risk-v1/latest/Google-Cloud-WebRisk-V1-WebRiskService-Client)
      ...
      #
      def self.web_risk_service version: :v1, transport: :grpc, &block
        ...
        package_name = Google::Cloud::WebRisk
                       ...
                       .first
        service_module = Google::Cloud::WebRisk.const_get(package_name).const_get(:WebRiskService)
