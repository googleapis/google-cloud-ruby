...
module Google
  module Cloud
    module TelcoAutomation
      ...
      # {Google::Cloud::TelcoAutomation.telco_automation_available?}.
      #
      ...
      # If true, you can retrieve a client object by calling {Google::Cloud::TelcoAutomation.telco_automation}.
      ...
      #
      def self.telco_automation_available? version: :v1, transport: :grpc
        require "google/cloud/telco_automation/#{version.to_s.downcase}"
        package_name = Google::Cloud::TelcoAutomation
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::TelcoAutomation.const_get package_name
        return false unless service_module.const_defined? :TelcoAutomation
        service_module = service_module.const_get :TelcoAutomation
        if transport == :rest
