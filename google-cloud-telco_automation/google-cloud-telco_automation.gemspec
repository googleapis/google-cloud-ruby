...
Gem::Specification.new do |gem|
  ...
  gem.description   = "APIs to automate 5G deployment and management of cloud infrastructure and network functions."
  ...
  gem.add_dependency "google-cloud-telco_automation-v1", ">= 0.0", "< 2.a"
