...
specific version of the AlloyDB V1BETA API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-alloy_db-v1beta
```
...
request = ::Google::Cloud::AlloyDB::V1beta::ListClustersRequest.new # (request fields as keyword arguments...)
response = client.list_clusters request
```

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-alloy_db-v1beta/latest)
...
is part of the name, e.g. `google-cloud-alloy_db-v1beta`.
