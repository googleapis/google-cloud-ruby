      ...
      module V1beta
        module AlloyDBAdmin
          ...
          class Client
            ...
            #   {::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     Required. ID of the requesting object.
            #   @param database [::Google::Cloud::AlloyDB::V1beta::Database, ::Hash]
            #     Required. The resource being created.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::AlloyDB::V1beta::Database]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest.new
            #
            #   # Call the create_database method.
            #   result = client.create_database request
            #
            #   # The returned object is of type Google::Cloud::AlloyDB::V1beta::Database.
            #   p result
            #
            def create_database request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest
