...
require "google/cloud/alloy_db/v1beta/alloy_dbcsql_admin/rest/service_stub"
    ...
    module AlloyDB
      module V1beta
        module AlloyDBCSQLAdmin
          module Rest
            ##
            # REST client for the AlloyDBCSQLAdmin service.
            #
            ...
            class Client
              ...
              # @private
              attr_reader :alloy_dbcsql_admin_stub

              ##
              # Configure the AlloyDBCSQLAdmin Client class.
              #
              # See {::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all AlloyDBCSQLAdmin clients
              #   ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Configure the AlloyDBCSQLAdmin Client instance.
              #
              ...
              #
              def universe_domain
                @alloy_dbcsql_admin_stub.universe_domain
              end

              ##
              # Create a new AlloyDBCSQLAdmin REST client object.
              #
              # @example
              #
              #   # Create a client using the default configuration
              #   client = ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              # @yield [config] Configure the AlloyDBCSQLAdmin client.
              # @yieldparam config [Client::Configuration]
              #
              def initialize
                ...
                @operations_client = ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::Operations.new do |config|
                ...
                @alloy_dbcsql_admin_stub = ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::ServiceStub.new(
                ...
                @alloy_dbcsql_admin_stub.logger(stub: true)&.info do |entry|
                ...
                @location_client = Google::Cloud::Location::Locations::Rest::Client.new do |config|
                  config.credentials = credentials
                  config.quota_project = @quota_project_id
                  config.endpoint = @alloy_dbcsql_admin_stub.endpoint
                  config.universe_domain = @alloy_dbcsql_admin_stub.universe_domain
                  config.bindings_override = @config.bindings_override
                  config.logger = @alloy_dbcsql_admin_stub.logger if config.respond_to? :logger=
                end
              ...
              #
              # @return [::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::Operations]
              #
              ...
              #
              def logger
                @alloy_dbcsql_admin_stub.logger
              end
              ...
              def restore_from_cloud_sql request, options = nil
                ...
                @alloy_dbcsql_admin_stub.restore_from_cloud_sql request, options do |result, operation|
              ...
              ##
              # Configuration class for the AlloyDBCSQLAdmin REST API.
              #
              # This class represents the configuration for AlloyDBCSQLAdmin REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Rest::Client::Configuration::Rpcs}
              ...
              class Configuration
                ...
                ##
                # Configuration RPC class for the AlloyDBCSQLAdmin API.
                #
