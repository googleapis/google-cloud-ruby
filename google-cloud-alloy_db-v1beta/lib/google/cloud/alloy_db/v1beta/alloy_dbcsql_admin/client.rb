    ...
    module AlloyDB
      module V1beta
        module AlloyDBCSQLAdmin
          ##
          # Client for the AlloyDBCSQLAdmin service.
          #
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all AlloyDBCSQLAdmin clients
            #   ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            ##
            # Create a new AlloyDBCSQLAdmin client object.
            #
            # @example
            #
            #   # Create a client using the default configuration
            #   client = ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Client.new
            #
            #   # Create a client using a custom configuration
            #   client = ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @alloy_dbcsql_admin_stub = ::Gapic::ServiceStub.new(
              ...
              @alloy_dbcsql_admin_stub.stub_logger&.info do |entry|
            ...
            #
            # @return [::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Operations]
            #
            ...
            def restore_from_cloud_sql request, options = nil
              ...
              @alloy_dbcsql_admin_stub.call_rpc :restore_from_cloud_sql, request, options: options do |response, operation|
            ...
            ##
            # Configuration class for the AlloyDBCSQLAdmin API.
            #
            # This class represents the configuration for AlloyDBCSQLAdmin,
            # providing control over timeouts, retry behavior, logging, transport
            # parameters, and other low-level controls. Certain parameters can also be
            # applied individually to specific RPCs. See
            # {::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Client::Configuration::Rpcs}
