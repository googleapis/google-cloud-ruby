...
class ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AlloyDB::V1beta::AlloyDBCSQLAdmin::Operations::Configuration, config
  end
end
