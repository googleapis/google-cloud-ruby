...
class ::Google::Cloud::AlloyDB::V1beta::AlloyDBAdmin::ClientTest < Minitest::Test
  ...
  def test_list_clusters
    ...
    Gapic::ServiceStub.stub :new, list_clusters_client_stub do
      # Create client
      c = ::Google::Cloud::AlloyDB::V1beta::AlloyDBAdmin::Client.new do |config|
      ...
      # Use protobuf object
      c.list_clusters ::Google::Cloud::AlloyDB::V1beta::ListClustersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      c.list_clusters(::Google::Cloud::AlloyDB::V1beta::ListClustersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_cluster
    ...
    Gapic::ServiceStub.stub :new, get_cluster_client_stub do
      ...
      # Use protobuf object
      c.get_cluster ::Google::Cloud::AlloyDB::V1beta::GetClusterRequest.new(name: name, view: view) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_cluster(::Google::Cloud::AlloyDB::V1beta::GetClusterRequest.new(name: name, view: view), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_cluster
    ...
    Gapic::ServiceStub.stub :new, create_cluster_client_stub do
      ...
      # Use protobuf object
      c.create_cluster ::Google::Cloud::AlloyDB::V1beta::CreateClusterRequest.new(parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_cluster(::Google::Cloud::AlloyDB::V1beta::CreateClusterRequest.new(parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_cluster
    ...
    Gapic::ServiceStub.stub :new, update_cluster_client_stub do
      ...
      # Use protobuf object
      c.update_cluster ::Google::Cloud::AlloyDB::V1beta::UpdateClusterRequest.new(update_mask: update_mask, cluster: cluster, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_cluster(::Google::Cloud::AlloyDB::V1beta::UpdateClusterRequest.new(update_mask: update_mask, cluster: cluster, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_cluster
    ...
    Gapic::ServiceStub.stub :new, export_cluster_client_stub do
      ...
      # Use protobuf object
      c.export_cluster ::Google::Cloud::AlloyDB::V1beta::ExportClusterRequest.new(gcs_destination: gcs_destination, csv_export_options: csv_export_options, name: name, database: database) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.export_cluster(::Google::Cloud::AlloyDB::V1beta::ExportClusterRequest.new(gcs_destination: gcs_destination, csv_export_options: csv_export_options, name: name, database: database), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_cluster
    ...
    Gapic::ServiceStub.stub :new, import_cluster_client_stub do
      ...
      # Use protobuf object
      c.import_cluster ::Google::Cloud::AlloyDB::V1beta::ImportClusterRequest.new(sql_import_options: sql_import_options, name: name, gcs_uri: gcs_uri, database: database, user: user) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.import_cluster(::Google::Cloud::AlloyDB::V1beta::ImportClusterRequest.new(sql_import_options: sql_import_options, name: name, gcs_uri: gcs_uri, database: database, user: user), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_upgrade_cluster
    ...
    upgrade_cluster_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AlloyDB::V1beta::UpgradeClusterRequest, request
      assert_equal "hello world", request["name"]
    ...
    Gapic::ServiceStub.stub :new, upgrade_cluster_client_stub do
      ...
      # Use protobuf object
      c.upgrade_cluster ::Google::Cloud::AlloyDB::V1beta::UpgradeClusterRequest.new(name: name, version: version, request_id: request_id, validate_only: validate_only, etag: etag) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.upgrade_cluster(::Google::Cloud::AlloyDB::V1beta::UpgradeClusterRequest.new(name: name, version: version, request_id: request_id, validate_only: validate_only, etag: etag), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_cluster
    ...
    Gapic::ServiceStub.stub :new, delete_cluster_client_stub do
      ...
      # Use protobuf object
      c.delete_cluster ::Google::Cloud::AlloyDB::V1beta::DeleteClusterRequest.new(name: name, request_id: request_id, etag: etag, validate_only: validate_only, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_cluster(::Google::Cloud::AlloyDB::V1beta::DeleteClusterRequest.new(name: name, request_id: request_id, etag: etag, validate_only: validate_only, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_promote_cluster
    ...
    Gapic::ServiceStub.stub :new, promote_cluster_client_stub do
      ...
      # Use protobuf object
      c.promote_cluster ::Google::Cloud::AlloyDB::V1beta::PromoteClusterRequest.new(name: name, request_id: request_id, etag: etag, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.promote_cluster(::Google::Cloud::AlloyDB::V1beta::PromoteClusterRequest.new(name: name, request_id: request_id, etag: etag, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_switchover_cluster
    ...
    switchover_cluster_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AlloyDB::V1beta::SwitchoverClusterRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
      assert_equal true, request["validate_only"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, switchover_cluster_client_stub do
      ...
      # Use protobuf object
      c.switchover_cluster ::Google::Cloud::AlloyDB::V1beta::SwitchoverClusterRequest.new(name: name, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.switchover_cluster(::Google::Cloud::AlloyDB::V1beta::SwitchoverClusterRequest.new(name: name, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_restore_cluster
    ...
    Gapic::ServiceStub.stub :new, restore_cluster_client_stub do
      ...
      # Use protobuf object
      c.restore_cluster ::Google::Cloud::AlloyDB::V1beta::RestoreClusterRequest.new(backup_source: backup_source, parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.restore_cluster(::Google::Cloud::AlloyDB::V1beta::RestoreClusterRequest.new(backup_source: backup_source, parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_secondary_cluster
    ...
    Gapic::ServiceStub.stub :new, create_secondary_cluster_client_stub do
      ...
      # Use protobuf object
      c.create_secondary_cluster ::Google::Cloud::AlloyDB::V1beta::CreateSecondaryClusterRequest.new(parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_secondary_cluster(::Google::Cloud::AlloyDB::V1beta::CreateSecondaryClusterRequest.new(parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_instances
    ...
    Gapic::ServiceStub.stub :new, list_instances_client_stub do
      ...
      # Use protobuf object
      c.list_instances ::Google::Cloud::AlloyDB::V1beta::ListInstancesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_instances(::Google::Cloud::AlloyDB::V1beta::ListInstancesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_instance
    ...
    Gapic::ServiceStub.stub :new, get_instance_client_stub do
      ...
      # Use protobuf object
      c.get_instance ::Google::Cloud::AlloyDB::V1beta::GetInstanceRequest.new(name: name, view: view) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_instance(::Google::Cloud::AlloyDB::V1beta::GetInstanceRequest.new(name: name, view: view), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_instance
    ...
    Gapic::ServiceStub.stub :new, create_instance_client_stub do
      ...
      # Use protobuf object
      c.create_instance ::Google::Cloud::AlloyDB::V1beta::CreateInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_instance(::Google::Cloud::AlloyDB::V1beta::CreateInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_secondary_instance
    ...
    Gapic::ServiceStub.stub :new, create_secondary_instance_client_stub do
      ...
      # Use protobuf object
      c.create_secondary_instance ::Google::Cloud::AlloyDB::V1beta::CreateSecondaryInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_secondary_instance(::Google::Cloud::AlloyDB::V1beta::CreateSecondaryInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_create_instances
    ...
    Gapic::ServiceStub.stub :new, batch_create_instances_client_stub do
      ...
      # Use protobuf object
      c.batch_create_instances ::Google::Cloud::AlloyDB::V1beta::BatchCreateInstancesRequest.new(parent: parent, requests: requests, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.batch_create_instances(::Google::Cloud::AlloyDB::V1beta::BatchCreateInstancesRequest.new(parent: parent, requests: requests, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_instance
    ...
    Gapic::ServiceStub.stub :new, update_instance_client_stub do
      ...
      # Use protobuf object
      c.update_instance ::Google::Cloud::AlloyDB::V1beta::UpdateInstanceRequest.new(update_mask: update_mask, instance: instance, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_instance(::Google::Cloud::AlloyDB::V1beta::UpdateInstanceRequest.new(update_mask: update_mask, instance: instance, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_instance
    ...
    Gapic::ServiceStub.stub :new, delete_instance_client_stub do
      ...
      # Use protobuf object
      c.delete_instance ::Google::Cloud::AlloyDB::V1beta::DeleteInstanceRequest.new(name: name, request_id: request_id, etag: etag, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_instance(::Google::Cloud::AlloyDB::V1beta::DeleteInstanceRequest.new(name: name, request_id: request_id, etag: etag, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_failover_instance
    ...
    Gapic::ServiceStub.stub :new, failover_instance_client_stub do
      ...
      # Use protobuf object
      c.failover_instance ::Google::Cloud::AlloyDB::V1beta::FailoverInstanceRequest.new(name: name, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.failover_instance(::Google::Cloud::AlloyDB::V1beta::FailoverInstanceRequest.new(name: name, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_inject_fault
    ...
    Gapic::ServiceStub.stub :new, inject_fault_client_stub do
      ...
      # Use protobuf object
      c.inject_fault ::Google::Cloud::AlloyDB::V1beta::InjectFaultRequest.new(fault_type: fault_type, name: name, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.inject_fault(::Google::Cloud::AlloyDB::V1beta::InjectFaultRequest.new(fault_type: fault_type, name: name, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_restart_instance
    ...
    Gapic::ServiceStub.stub :new, restart_instance_client_stub do
      ...
      # Use protobuf object
      c.restart_instance ::Google::Cloud::AlloyDB::V1beta::RestartInstanceRequest.new(name: name, request_id: request_id, validate_only: validate_only, node_ids: node_ids) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.restart_instance(::Google::Cloud::AlloyDB::V1beta::RestartInstanceRequest.new(name: name, request_id: request_id, validate_only: validate_only, node_ids: node_ids), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_execute_sql
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AlloyDB::V1beta::ExecuteSqlResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    execute_sql_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AlloyDB::V1beta::ExecuteSqlRequest, request
    ...
    Gapic::ServiceStub.stub :new, execute_sql_client_stub do
      ...
      # Use protobuf object
      c.execute_sql ::Google::Cloud::AlloyDB::V1beta::ExecuteSqlRequest.new(password: password, instance: instance, database: database, user: user, sql_statement: sql_statement, validate_only: validate_only) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.execute_sql(::Google::Cloud::AlloyDB::V1beta::ExecuteSqlRequest.new(password: password, instance: instance, database: database, user: user, sql_statement: sql_statement, validate_only: validate_only), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_backups
    ...
    Gapic::ServiceStub.stub :new, list_backups_client_stub do
      ...
      # Use protobuf object
      c.list_backups ::Google::Cloud::AlloyDB::V1beta::ListBackupsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_backups(::Google::Cloud::AlloyDB::V1beta::ListBackupsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_backup
    ...
    Gapic::ServiceStub.stub :new, get_backup_client_stub do
      ...
      # Use protobuf object
      c.get_backup ::Google::Cloud::AlloyDB::V1beta::GetBackupRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_backup(::Google::Cloud::AlloyDB::V1beta::GetBackupRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_backup
    ...
    Gapic::ServiceStub.stub :new, create_backup_client_stub do
      ...
      # Use protobuf object
      c.create_backup ::Google::Cloud::AlloyDB::V1beta::CreateBackupRequest.new(parent: parent, backup_id: backup_id, backup: backup, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_backup(::Google::Cloud::AlloyDB::V1beta::CreateBackupRequest.new(parent: parent, backup_id: backup_id, backup: backup, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_backup
    ...
    Gapic::ServiceStub.stub :new, update_backup_client_stub do
      ...
      # Use protobuf object
      c.update_backup ::Google::Cloud::AlloyDB::V1beta::UpdateBackupRequest.new(update_mask: update_mask, backup: backup, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_backup(::Google::Cloud::AlloyDB::V1beta::UpdateBackupRequest.new(update_mask: update_mask, backup: backup, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_backup
    ...
    Gapic::ServiceStub.stub :new, delete_backup_client_stub do
      ...
      # Use protobuf object
      c.delete_backup ::Google::Cloud::AlloyDB::V1beta::DeleteBackupRequest.new(name: name, request_id: request_id, validate_only: validate_only, etag: etag) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_backup(::Google::Cloud::AlloyDB::V1beta::DeleteBackupRequest.new(name: name, request_id: request_id, validate_only: validate_only, etag: etag), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_supported_database_flags
    ...
    Gapic::ServiceStub.stub :new, list_supported_database_flags_client_stub do
      ...
      # Use protobuf object
      c.list_supported_database_flags ::Google::Cloud::AlloyDB::V1beta::ListSupportedDatabaseFlagsRequest.new(parent: parent, page_size: page_size, page_token: page_token, scope: scope) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_supported_database_flags(::Google::Cloud::AlloyDB::V1beta::ListSupportedDatabaseFlagsRequest.new(parent: parent, page_size: page_size, page_token: page_token, scope: scope), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_generate_client_certificate
    ...
    Gapic::ServiceStub.stub :new, generate_client_certificate_client_stub do
      ...
      # Use protobuf object
      c.generate_client_certificate ::Google::Cloud::AlloyDB::V1beta::GenerateClientCertificateRequest.new(parent: parent, request_id: request_id, pem_csr: pem_csr, cert_duration: cert_duration, public_key: public_key, use_metadata_exchange: use_metadata_exchange) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.generate_client_certificate(::Google::Cloud::AlloyDB::V1beta::GenerateClientCertificateRequest.new(parent: parent, request_id: request_id, pem_csr: pem_csr, cert_duration: cert_duration, public_key: public_key, use_metadata_exchange: use_metadata_exchange), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_connection_info
    ...
    Gapic::ServiceStub.stub :new, get_connection_info_client_stub do
      ...
      # Use protobuf object
      c.get_connection_info ::Google::Cloud::AlloyDB::V1beta::GetConnectionInfoRequest.new(parent: parent, request_id: request_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_connection_info(::Google::Cloud::AlloyDB::V1beta::GetConnectionInfoRequest.new(parent: parent, request_id: request_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_users
    ...
    Gapic::ServiceStub.stub :new, list_users_client_stub do
      ...
      # Use protobuf object
      c.list_users ::Google::Cloud::AlloyDB::V1beta::ListUsersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_users(::Google::Cloud::AlloyDB::V1beta::ListUsersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_user
    ...
    Gapic::ServiceStub.stub :new, get_user_client_stub do
      ...
      # Use protobuf object
      c.get_user ::Google::Cloud::AlloyDB::V1beta::GetUserRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_user(::Google::Cloud::AlloyDB::V1beta::GetUserRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_user
    ...
    Gapic::ServiceStub.stub :new, create_user_client_stub do
      ...
      # Use protobuf object
      c.create_user ::Google::Cloud::AlloyDB::V1beta::CreateUserRequest.new(parent: parent, user_id: user_id, user: user, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_user(::Google::Cloud::AlloyDB::V1beta::CreateUserRequest.new(parent: parent, user_id: user_id, user: user, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_user
    ...
    Gapic::ServiceStub.stub :new, update_user_client_stub do
      ...
      # Use protobuf object
      c.update_user ::Google::Cloud::AlloyDB::V1beta::UpdateUserRequest.new(update_mask: update_mask, user: user, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_user(::Google::Cloud::AlloyDB::V1beta::UpdateUserRequest.new(update_mask: update_mask, user: user, request_id: request_id, validate_only: validate_only, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_user
    ...
    Gapic::ServiceStub.stub :new, delete_user_client_stub do
      ...
      # Use protobuf object
      c.delete_user ::Google::Cloud::AlloyDB::V1beta::DeleteUserRequest.new(name: name, request_id: request_id, validate_only: validate_only) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_user(::Google::Cloud::AlloyDB::V1beta::DeleteUserRequest.new(name: name, request_id: request_id, validate_only: validate_only), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_databases
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AlloyDB::V1beta::ListDatabasesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_databases_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AlloyDB::V1beta::ListDatabasesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
    ...
    Gapic::ServiceStub.stub :new, list_databases_client_stub do
      ...
      # Use protobuf object
      c.list_databases ::Google::Cloud::AlloyDB::V1beta::ListDatabasesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_databases(::Google::Cloud::AlloyDB::V1beta::ListDatabasesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_database
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AlloyDB::V1beta::Database.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    create_database_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["database_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AlloyDB::V1beta::Database), request["database"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_database_client_stub do
      ...
      # Use protobuf object
      c.create_database ::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest.new(parent: parent, database_id: database_id, database: database) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_database(::Google::Cloud::AlloyDB::V1beta::CreateDatabaseRequest.new(parent: parent, database_id: database_id, database: database), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::AlloyDB::V1beta::AlloyDBAdmin::Client, client
