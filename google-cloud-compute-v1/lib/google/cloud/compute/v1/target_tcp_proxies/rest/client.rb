          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @target_tcp_proxies_stub.logger(stub: true)&.info do |entry|
              ...
              #
              def logger
                @target_tcp_proxies_stub.logger
              end
              ...
              #   {::Google::Cloud::Compute::V1::AggregatedListTargetTcpProxiesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::AggregatedListTargetTcpProxiesRequest, ::Hash]
              ...
              def aggregated_list request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Compute::V1::AggregatedListTargetTcpProxiesRequest
                ...
                @target_tcp_proxies_stub.aggregated_list request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @target_tcp_proxies_stub, :aggregated_list, "items", request, result, options
              ...
              def get request, options = nil
                ...
                @target_tcp_proxies_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @target_tcp_proxies_stub.list request, options do |result, operation|
              ...
              def set_backend_service request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.set_backend_service.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.set_backend_service.retry_policy
              ...
              def set_proxy_header request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.set_proxy_header.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.set_proxy_header.retry_policy
