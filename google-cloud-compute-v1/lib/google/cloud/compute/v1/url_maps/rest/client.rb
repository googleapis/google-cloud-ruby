          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @url_maps_stub.logger(stub: true)&.info do |entry|
              ...
              def aggregated_list request, options = nil
                ...
                @url_maps_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @url_maps_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def invalidate_cache request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.invalidate_cache.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.invalidate_cache.retry_policy
              ...
              def list request, options = nil
                ...
                @url_maps_stub.list request, options do |result, operation|
              ...
              def validate request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.validate.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.validate.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @url_maps_stub.validate request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Compute::V1::UrlMaps::Rest::Client::Configuration::Rpcs}
