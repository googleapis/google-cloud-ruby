    ...
    module Compute
      module V1
        module RegionSnapshotSettings
          module Rest
            ##
            # REST service stub for the RegionSnapshotSettings service.
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Compute::V1::GetRegionSnapshotSettingRequest]
              ...
              #
              # @param request_pb [::Google::Cloud::Compute::V1::PatchRegionSnapshotSettingRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def self.transcode_get_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/compute/v1/projects/{project}/regions/{region}/snapshotSettings",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["region", %r{^[^/]+/?$}, false]
                                                          ]
