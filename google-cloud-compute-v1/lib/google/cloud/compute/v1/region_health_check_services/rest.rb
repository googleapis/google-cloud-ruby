...
require "google/cloud/compute/v1/region_health_check_services/credentials"
...
require "google/cloud/compute/v1/region_health_check_services/rest/helpers" if ::File.file? helper_path
