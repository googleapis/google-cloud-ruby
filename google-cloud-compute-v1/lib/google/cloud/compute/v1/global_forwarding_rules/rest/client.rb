        ...
        module GlobalForwardingRules
          module Rest
            ...
            class Client
              ...
              #
              def universe_domain
                @global_forwarding_rules_stub.universe_domain
              end
              ...
              def initialize
                ...
                @global_forwarding_rules_stub.logger(stub: true)&.info do |entry|
              ...
              #
              def logger
                @global_forwarding_rules_stub.logger
              end
              ...
              def get request, options = nil
                ...
                @global_forwarding_rules_stub.get request, options do |result, operation|
              ...
              def list request, options = nil
                ...
                @global_forwarding_rules_stub.list request, options do |result, operation|
              ...
              def set_target request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.set_target.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.set_target.retry_policy
              ...
              # {::Google::Cloud::Compute::V1::GlobalForwardingRules::Rest::Client::Configuration::Rpcs}
