...
helper_path = ::File.join __dir__, "region_health_check_services", "helpers.rb"
require "google/cloud/compute/v1/region_health_check_services/helpers" if ::File.file? helper_path
