          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @instance_groups_stub.logger(stub: true)&.info do |entry|
              ...
              def add_instances request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.add_instances.timeout,
                                       ...
                                       retry_policy: @config.rpcs.add_instances.retry_policy
              ...
              def remove_instances request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.remove_instances.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.remove_instances.retry_policy
              ...
              # {::Google::Cloud::Compute::V1::InstanceGroups::Rest::Client::Configuration::Rpcs}
              ...
              #   # add_instances to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Cloud::Compute::V1::InstanceGroups::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.add_instances.timeout = 20.0
              #   end
              #
