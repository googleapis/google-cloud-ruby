        ...
        module Advice
          module Rest
            ...
            class Client
              ...
              # @private
              attr_reader :advice_stub

              ##
              # Configure the Advice Client class.
              #
              # See {::Google::Cloud::Compute::V1::Advice::Rest::Client::Configuration}
              ...
              #   end
              #
              # @yield [config] Configure the Advice client.
              # @yieldparam config [Client::Configuration]
              #
              def initialize
              ...
              # resources.
              #
              # @overload calendar_mode(request, options = nil)
              #   Pass arguments to `calendar_mode` via a request object, either of type
              #   {::Google::Cloud::Compute::V1::CalendarModeAdviceRpcRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Compute::V1::CalendarModeAdviceRpcRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload calendar_mode(calendar_mode_advice_request_resource: nil, project: nil, region: nil)
              #   Pass arguments to `calendar_mode` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param calendar_mode_advice_request_resource [::Google::Cloud::Compute::V1::CalendarModeAdviceRequest, ::Hash]
              ...
              def calendar_mode request, options = nil
                ...
                call_metadata = @config.rpcs.calendar_mode.metadata.to_h
              ...
              # {::Google::Cloud::Compute::V1::Advice::Rest::Client::Configuration::Rpcs}
              ...
              #   # calendar_mode to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Cloud::Compute::V1::Advice::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.calendar_mode.timeout = 20.0
              #   end
              #
              ...
              class Configuration
                ...
                ##
                # Configuration RPC class for the Advice API.
                #
                ...
                class Rpcs
                  ##
                  # RPC-specific configuration for `calendar_mode`
