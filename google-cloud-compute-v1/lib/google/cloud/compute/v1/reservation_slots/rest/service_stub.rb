    ...
    module Compute
      module V1
        module ReservationSlots
          module Rest
            ##
            # REST service stub for the ReservationSlots service.
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Compute::V1::GetReservationSlotRequest]
              ...
              def get request_pb, options = nil
                ...
                result = ::Google::Cloud::Compute::V1::ReservationSlotsGetResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
              ...
              #
              # @param request_pb [::Google::Cloud::Compute::V1::GetHealthReservationSlotRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Compute::V1::GetVersionReservationSlotRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Compute::V1::ListReservationSlotsRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::Compute::V1::ReservationSlotsListResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::Compute::V1::ReservationSlotsListResponse]
              #   A result object deserialized from the server's reply
              def list request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Compute::V1::ReservationSlotsListResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Cloud::Compute::V1::UpdateReservationSlotRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def self.transcode_get_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/compute/v1/projects/{project}/zones/{zone}/{parent_name}/reservationSlots/{reservation_slot}",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["zone", %r{^[^/]+/?$}, false],
                                                            ["parent_name", %r{^reservations/[^/]+/reservationBlocks/[^/]+/reservationSubBlocks/[^/]+/?$}, false],
                                                            ["reservation_slot", %r{^[^/]+/?$}, false]
                                                          ]
                                                        )
              ...
              def self.transcode_get_health_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/compute/v1/projects/{project}/zones/{zone}/{parent_name}/reservationSlots/{reservation_slot}/getHealth",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["zone", %r{^[^/]+/?$}, false],
                                                            ["parent_name", %r{^reservations/[^/]+/reservationBlocks/[^/]+/reservationSubBlocks/[^/]+/?$}, false],
              ...
              def self.transcode_get_version_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/compute/v1/projects/{project}/zones/{zone}/{parent_name}/reservationSlots/{reservation_slot}/getVersion",
              ...
              def self.transcode_list_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/compute/v1/projects/{project}/zones/{zone}/{parent_name}/reservationSlots",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["zone", %r{^[^/]+/?$}, false],
                                                            ["parent_name", %r{^reservations/[^/]+/reservationBlocks/[^/]+/reservationSubBlocks/[^/]+/?$}, false]
