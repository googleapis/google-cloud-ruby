...
require "google/cloud/compute/v1/external_vpn_gateways/credentials"
...
require "google/cloud/compute/v1/external_vpn_gateways/rest/helpers" if ::File.file? helper_path
