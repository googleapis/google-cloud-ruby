          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @target_pools_stub.logger(stub: true)&.info do |entry|
              ...
              def add_health_check request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.add_health_check.timeout,
                                       ...
                                       retry_policy: @config.rpcs.add_health_check.retry_policy
              ...
              def add_instance request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.add_instance.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.add_instance.retry_policy
              ...
              def aggregated_list request, options = nil
                ...
                @target_pools_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @target_pools_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_health request, options = nil
                ...
                @target_pools_stub.get_health request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @target_pools_stub.list request, options do |result, operation|
              ...
              def remove_health_check request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.remove_health_check.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.remove_health_check.retry_policy
              ...
              def remove_instance request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.remove_instance.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.remove_instance.retry_policy
              ...
              def set_backup request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.set_backup.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.set_backup.retry_policy
              ...
              # {::Google::Cloud::Compute::V1::TargetPools::Rest::Client::Configuration::Rpcs}
              ...
              #   # add_health_check to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Cloud::Compute::V1::TargetPools::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.add_health_check.timeout = 20.0
              #   end
              #
