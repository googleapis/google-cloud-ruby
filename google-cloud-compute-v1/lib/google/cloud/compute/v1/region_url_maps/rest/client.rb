        ...
        module RegionUrlMaps
          module Rest
            ...
            class Client
              ...
              #
              def universe_domain
                @region_url_maps_stub.universe_domain
              end
              ...
              def initialize
                ...
                @region_url_maps_stub.logger(stub: true)&.info do |entry|
              ...
              def get request, options = nil
                ...
                @region_url_maps_stub.get request, options do |result, operation|
              ...
              def list request, options = nil
                ...
                @region_url_maps_stub.list request, options do |result, operation|
              ...
              def validate request, options = nil
                ...
                @region_url_maps_stub.validate request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Compute::V1::RegionUrlMaps::Rest::Client::Configuration::Rpcs}
