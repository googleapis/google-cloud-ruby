            ...
            class Client
              ...
              def get_nat_mapping_info request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.get_nat_mapping_info.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.get_nat_mapping_info.retry_policy
              ...
              def get_router_status request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.get_router_status.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.get_router_status.retry_policy
              ...
              def preview request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.preview.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.preview.retry_policy
