        ...
        module NodeTemplates
          module Rest
            ...
            class Client
              ...
              #
              def universe_domain
                @node_templates_stub.universe_domain
              end
              ...
              def initialize
                ...
                @node_templates_stub.logger(stub: true)&.info do |entry|
              ...
              def aggregated_list request, options = nil
                ...
                @node_templates_stub.aggregated_list request, options do |result, operation|
              ...
              def get request, options = nil
                ...
                @node_templates_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_iam_policy request, options = nil
                ...
                @node_templates_stub.get_iam_policy request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @node_templates_stub.list request, options do |result, operation|
              ...
              def set_iam_policy request, options = nil
                ...
                @node_templates_stub.set_iam_policy request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def test_iam_permissions request, options = nil
                ...
                @node_templates_stub.test_iam_permissions request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Compute::V1::NodeTemplates::Rest::Client::Configuration::Rpcs}
