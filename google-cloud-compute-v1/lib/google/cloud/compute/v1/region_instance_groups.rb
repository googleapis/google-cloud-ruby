...
require "google/cloud/compute/v1/region_instance_groups/credentials"
...
helper_path = ::File.join __dir__, "region_instance_groups", "helpers.rb"
require "google/cloud/compute/v1/region_instance_groups/helpers" if ::File.file? helper_path
