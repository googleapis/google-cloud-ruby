        ...
        module TargetVpnGateways
          module Rest
            ...
            class Client
              ...
              # @example
              #
              #   # Modify the configuration for all TargetVpnGateways clients
              ...
              def initialize
                ...
                @target_vpn_gateways_stub.logger(stub: true)&.info do |entry|
              ...
              #
              def logger
                @target_vpn_gateways_stub.logger
              end
              ...
              def aggregated_list request, options = nil
                ...
                @target_vpn_gateways_stub.aggregated_list request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @target_vpn_gateways_stub, :aggregated_list, "items", request, result, options
              ...
              def get request, options = nil
                ...
                @target_vpn_gateways_stub.get request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def list request, options = nil
                ...
                @target_vpn_gateways_stub.list request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @target_vpn_gateways_stub, :list, "items", request, result, options
                  yield result, operation if block_given?
                  throw :response, result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              # {::Google::Cloud::Compute::V1::TargetVpnGateways::Rest::Client::Configuration::Rpcs}
