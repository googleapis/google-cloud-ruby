          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @interconnects_stub.logger(stub: true)&.info do |entry|
              ...
              def get_diagnostics request, options = nil
                ...
                options.apply_defaults timeout:      @config.rpcs.get_diagnostics.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.get_diagnostics.retry_policy
              ...
              # {::Google::Cloud::Compute::V1::Interconnects::Rest::Client::Configuration::Rpcs}
