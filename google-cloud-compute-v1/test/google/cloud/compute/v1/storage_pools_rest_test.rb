...
class ::Google::Cloud::Compute::V1::StoragePools::Rest::ClientTest < Minitest::Test
  ...
  def test_aggregated_list
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_aggregated_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, aggregated_list_client_stub do
        # Create client
        c = ::Google::Cloud::Compute::V1::StoragePools::Rest::Client.new do |config|
  ...
  def test_delete
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_delete_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_client_stub do
        ...
        # Use hash object
        c.delete({ project: project, request_id: request_id, storage_pool: storage_pool, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.delete ::Google::Cloud::Compute::V1::DeleteStoragePoolRequest.new(project: project, request_id: request_id, storage_pool: storage_pool, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.delete({ project: project, request_id: request_id, storage_pool: storage_pool, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.delete(::Google::Cloud::Compute::V1::DeleteStoragePoolRequest.new(project: project, request_id: request_id, storage_pool: storage_pool, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_get_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_client_stub do
        ...
        # Use hash object
        c.get({ project: project, storage_pool: storage_pool, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.get ::Google::Cloud::Compute::V1::GetStoragePoolRequest.new(project: project, storage_pool: storage_pool, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.get({ project: project, storage_pool: storage_pool, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.get(::Google::Cloud::Compute::V1::GetStoragePoolRequest.new(project: project, storage_pool: storage_pool, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_iam_policy
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_get_iam_policy_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_iam_policy_client_stub do
        ...
        # Use protobuf object
        c.get_iam_policy ::Google::Cloud::Compute::V1::GetIamPolicyStoragePoolRequest.new(options_requested_policy_version: options_requested_policy_version, project: project, resource: resource, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_iam_policy(::Google::Cloud::Compute::V1::GetIamPolicyStoragePoolRequest.new(options_requested_policy_version: options_requested_policy_version, project: project, resource: resource, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_insert
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_insert_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, insert_client_stub do
        ...
        # Use hash object
        c.insert({ project: project, request_id: request_id, storage_pool_resource: storage_pool_resource, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.insert ::Google::Cloud::Compute::V1::InsertStoragePoolRequest.new(project: project, request_id: request_id, storage_pool_resource: storage_pool_resource, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.insert({ project: project, request_id: request_id, storage_pool_resource: storage_pool_resource, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.insert(::Google::Cloud::Compute::V1::InsertStoragePoolRequest.new(project: project, request_id: request_id, storage_pool_resource: storage_pool_resource, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_disks
    ...
    list_disks_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_set_iam_policy
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_set_iam_policy_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, set_iam_policy_client_stub do
        ...
        # Use protobuf object
        c.set_iam_policy ::Google::Cloud::Compute::V1::SetIamPolicyStoragePoolRequest.new(project: project, resource: resource, zone: zone, zone_set_policy_request_resource: zone_set_policy_request_resource) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.set_iam_policy(::Google::Cloud::Compute::V1::SetIamPolicyStoragePoolRequest.new(project: project, resource: resource, zone: zone, zone_set_policy_request_resource: zone_set_policy_request_resource), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_test_iam_permissions
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_test_iam_permissions_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, test_iam_permissions_client_stub do
        ...
        # Use protobuf object
        c.test_iam_permissions ::Google::Cloud::Compute::V1::TestIamPermissionsStoragePoolRequest.new(project: project, resource: resource, test_permissions_request_resource: test_permissions_request_resource, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.test_iam_permissions(::Google::Cloud::Compute::V1::TestIamPermissionsStoragePoolRequest.new(project: project, resource: resource, test_permissions_request_resource: test_permissions_request_resource, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update
    ...
    ::Google::Cloud::Compute::V1::StoragePools::Rest::ServiceStub.stub :transcode_update_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_client_stub do
        ...
        # Use hash object
        c.update({ project: project, request_id: request_id, storage_pool: storage_pool, storage_pool_resource: storage_pool_resource, update_mask: update_mask, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.update ::Google::Cloud::Compute::V1::UpdateStoragePoolRequest.new(project: project, request_id: request_id, storage_pool: storage_pool, storage_pool_resource: storage_pool_resource, update_mask: update_mask, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.update({ project: project, request_id: request_id, storage_pool: storage_pool, storage_pool_resource: storage_pool_resource, update_mask: update_mask, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.update(::Google::Cloud::Compute::V1::UpdateStoragePoolRequest.new(project: project, request_id: request_id, storage_pool: storage_pool, storage_pool_resource: storage_pool_resource, update_mask: update_mask, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
