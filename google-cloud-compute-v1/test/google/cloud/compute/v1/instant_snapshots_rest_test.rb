...
class ::Google::Cloud::Compute::V1::InstantSnapshots::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_aggregated_list
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::InstantSnapshotAggregatedList.new
  ...
  def test_get
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::InstantSnapshot.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::InstantSnapshotList.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::InstantSnapshots::Rest::Client::Configuration, config
  end
end
