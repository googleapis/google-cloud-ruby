...
class ::Google::Cloud::Compute::V1::ZoneVmExtensionPolicies::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_delete
    ...
    vm_extension_policy = "hello world"
    zone = "hello world"
  ...
  def test_get
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::VmExtensionPolicy.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::VmExtensionPolicyList.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::ZoneVmExtensionPolicies::Rest::Client::Configuration, config
  end
end
