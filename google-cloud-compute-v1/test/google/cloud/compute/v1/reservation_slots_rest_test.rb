...
class ::Google::Cloud::Compute::V1::ReservationSlots::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::ReservationSlotsGetResponse.new
  ...
  def test_list
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::ReservationSlotsListResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::ReservationSlots::Rest::Client::Configuration, config
  end
end
