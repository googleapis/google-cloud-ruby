...
class ::Google::Cloud::Compute::V1::RegionTargetHttpsProxies::ClientTest < Minitest::Test
  ...
  def test_patch
    ...
    Gapic::Rest::ClientStub.stub :new, patch_client_stub do
      ...
      # Use hash object
      client.patch({ project: project, region: region, request_id: request_id, target_https_proxy: target_https_proxy, target_https_proxy_resource: target_https_proxy_resource }) do |result, response|
        assert_equal http_response, response
      end
      ...
      # Use protobuf object
      client.patch ::Google::Cloud::Compute::V1::PatchRegionTargetHttpsProxyRequest.new(project: project, region: region, request_id: request_id, target_https_proxy: target_https_proxy, target_https_proxy_resource: target_https_proxy_resource) do |result, response|
        assert_equal http_response, response
      end

      # Use hash object with options
      client.patch({ project: project, region: region, request_id: request_id, target_https_proxy: target_https_proxy, target_https_proxy_resource: target_https_proxy_resource }, call_options) do |result, response|
        assert_equal http_response, response
      end

      # Use protobuf object with options
      client.patch(::Google::Cloud::Compute::V1::PatchRegionTargetHttpsProxyRequest.new(project: project, region: region, request_id: request_id, target_https_proxy: target_https_proxy, target_https_proxy_resource: target_https_proxy_resource), call_options) do |result, response|
        assert_equal http_response, response
      end
