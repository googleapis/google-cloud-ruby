...
class ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_aggregated_list
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::StoragePoolTypeAggregatedList.new
    ...
    ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::ServiceStub.stub :transcode_aggregated_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, aggregated_list_client_stub do
        # Create client
        c = ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::Client.new do |config|
  ...
  def test_get
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::StoragePoolType.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::ServiceStub.stub :transcode_get_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_client_stub do
        ...
        # Use hash object
        c.get({ project: project, storage_pool_type: storage_pool_type, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.get ::Google::Cloud::Compute::V1::GetStoragePoolTypeRequest.new(project: project, storage_pool_type: storage_pool_type, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.get({ project: project, storage_pool_type: storage_pool_type, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.get(::Google::Cloud::Compute::V1::GetStoragePoolTypeRequest.new(project: project, storage_pool_type: storage_pool_type, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::StoragePoolTypeList.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::ServiceStub.stub :transcode_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_client_stub do
        ...
        # Use protobuf object
        c.list ::Google::Cloud::Compute::V1::ListStoragePoolTypesRequest.new(filter: filter, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list(::Google::Cloud::Compute::V1::ListStoragePoolTypesRequest.new(filter: filter, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::Client::Configuration, config
  end
end
