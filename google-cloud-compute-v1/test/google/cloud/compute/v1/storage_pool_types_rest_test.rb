  ...
  def test_get
    ...
    ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::ServiceStub.stub :transcode_get_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_client_stub do
        ...
        # Use hash object
        client.get({ project: project, storage_pool_type: storage_pool_type, zone: zone }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        client.get ::Google::Cloud::Compute::V1::GetStoragePoolTypeRequest.new(project: project, storage_pool_type: storage_pool_type, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        client.get({ project: project, storage_pool_type: storage_pool_type, zone: zone }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        client.get(::Google::Cloud::Compute::V1::GetStoragePoolTypeRequest.new(project: project, storage_pool_type: storage_pool_type, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list
    ...
    ::Google::Cloud::Compute::V1::StoragePoolTypes::Rest::ServiceStub.stub :transcode_list_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_client_stub do
        ...
        # Use protobuf object
        client.list ::Google::Cloud::Compute::V1::ListStoragePoolTypesRequest.new(filter: filter, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success, zone: zone) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.list(::Google::Cloud::Compute::V1::ListStoragePoolTypesRequest.new(filter: filter, max_results: max_results, order_by: order_by, page_token: page_token, project: project, return_partial_success: return_partial_success, zone: zone), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
