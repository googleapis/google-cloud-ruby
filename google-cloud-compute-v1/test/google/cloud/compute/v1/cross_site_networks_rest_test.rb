...
class ::Google::Cloud::Compute::V1::CrossSiteNetworks::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_delete
    ...
    cross_site_network = "hello world"
    project = "hello world"
  ...
  def test_get
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::CrossSiteNetwork.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list
    # Create test objects.
    client_result = ::Google::Cloud::Compute::V1::CrossSiteNetworkList.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::CrossSiteNetworks::Rest::Client::Configuration, config
  end
end
