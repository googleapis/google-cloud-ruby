  ...
  def test_cancel_request_remove_peering
    ...
    ::Google::Cloud::Compute::V1::Networks::Rest::ServiceStub.stub :transcode_cancel_request_remove_peering_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, cancel_request_remove_peering_client_stub do
        ...
        # Use hash object
        client.cancel_request_remove_peering({ network: network, networks_cancel_request_remove_peering_request_resource: networks_cancel_request_remove_peering_request_resource, project: project, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        client.cancel_request_remove_peering ::Google::Cloud::Compute::V1::CancelRequestRemovePeeringNetworkRequest.new(network: network, networks_cancel_request_remove_peering_request_resource: networks_cancel_request_remove_peering_request_resource, project: project, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        client.cancel_request_remove_peering({ network: network, networks_cancel_request_remove_peering_request_resource: networks_cancel_request_remove_peering_request_resource, project: project, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        client.cancel_request_remove_peering(::Google::Cloud::Compute::V1::CancelRequestRemovePeeringNetworkRequest.new(network: network, networks_cancel_request_remove_peering_request_resource: networks_cancel_request_remove_peering_request_resource, project: project, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_request_remove_peering
    ...
    ::Google::Cloud::Compute::V1::Networks::Rest::ServiceStub.stub :transcode_request_remove_peering_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, request_remove_peering_client_stub do
        ...
        # Use hash object
        client.request_remove_peering({ network: network, networks_request_remove_peering_request_resource: networks_request_remove_peering_request_resource, project: project, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        client.request_remove_peering ::Google::Cloud::Compute::V1::RequestRemovePeeringNetworkRequest.new(network: network, networks_request_remove_peering_request_resource: networks_request_remove_peering_request_resource, project: project, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        client.request_remove_peering({ network: network, networks_request_remove_peering_request_resource: networks_request_remove_peering_request_resource, project: project, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        client.request_remove_peering(::Google::Cloud::Compute::V1::RequestRemovePeeringNetworkRequest.new(network: network, networks_request_remove_peering_request_resource: networks_request_remove_peering_request_resource, project: project, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
