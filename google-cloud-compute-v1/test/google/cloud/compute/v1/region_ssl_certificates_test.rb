...
class ::Google::Cloud::Compute::V1::RegionSslCertificates::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Compute::V1::RegionSslCertificates::Rest::Client::Configuration, config
  end
end
