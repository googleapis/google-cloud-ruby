...
module Google
  module Cloud
    module SecureSourceManager
      ...
      # given API version does not support the given transport of the SecureSourceManager service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::SecureSourceManager.secure_source_manager_available?}.
      #
      ...
      ##
      # Determines whether the SecureSourceManager service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::SecureSourceManager.secure_source_manager}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the SecureSourceManager service,
      # or if the versioned client gem needs an update to support the SecureSourceManager service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
