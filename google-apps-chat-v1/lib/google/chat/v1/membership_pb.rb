  ...
  module Apps
    module Chat
      module V1
        ...
        Membership::Affiliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.chat.v1.Membership.Affiliation").enummodule
