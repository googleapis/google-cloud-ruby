...
class ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::ClientTest < Minitest::Test
  ...
  def test_synthesize_long_audio
    ...
    Gapic::ServiceStub.stub :new, synthesize_long_audio_client_stub do
      # Create client
      c = ::Google::Cloud::TextToSpeech::V1::TextToSpeechLongAudioSynthesize::Client.new do |config|
      ...
      # Use protobuf object
      c.synthesize_long_audio ::Google::Cloud::TextToSpeech::V1::SynthesizeLongAudioRequest.new(parent: parent, input: input, audio_config: audio_config, output_gcs_uri: output_gcs_uri, voice: voice) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      c.synthesize_long_audio(::Google::Cloud::TextToSpeech::V1::SynthesizeLongAudioRequest.new(parent: parent, input: input, audio_config: audio_config, output_gcs_uri: output_gcs_uri, voice: voice), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
