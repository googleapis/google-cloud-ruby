...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Synthesizes natural-sounding speech by applying powerful neural network models. Note that google-cloud-text_to_speech-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-text_to_speech instead. See the readme for more details."
