...
class ::Google::Cloud::AppEngine::V1::Services::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_services
    # Create test objects.
    client_result = ::Google::Cloud::AppEngine::V1::ListServicesResponse.new
  ...
  def test_get_service
    # Create test objects.
    client_result = ::Google::Cloud::AppEngine::V1::Service.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AppEngine::V1::Services::Rest::Client::Configuration, config
  end
end
