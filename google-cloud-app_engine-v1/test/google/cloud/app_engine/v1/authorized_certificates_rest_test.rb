...
class ::Google::Cloud::AppEngine::V1::AuthorizedCertificates::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_authorized_certificates
    # Create test objects.
    client_result = ::Google::Cloud::AppEngine::V1::ListAuthorizedCertificatesResponse.new
    ...
    list_authorized_certificates_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::AppEngine::V1::AuthorizedCertificates::Rest::ServiceStub.stub :transcode_list_authorized_certificates_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_authorized_certificates_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_authorized_certificates_client_stub.call_count
      end
    end
  end
  ...
  def test_get_authorized_certificate
    # Create test objects.
    client_result = ::Google::Cloud::AppEngine::V1::AuthorizedCertificate.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_authorized_certificate_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AppEngine::V1::AuthorizedCertificates::Rest::ServiceStub.stub :transcode_get_authorized_certificate_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_authorized_certificate_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_authorized_certificate_client_stub.call_count
      end
    end
  end
  ...
  def test_create_authorized_certificate
    ...
    create_authorized_certificate_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AppEngine::V1::AuthorizedCertificates::Rest::ServiceStub.stub :transcode_create_authorized_certificate_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_authorized_certificate_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_authorized_certificate_client_stub.call_count
      end
    end
  end
  ...
  def test_update_authorized_certificate
    ...
    update_authorized_certificate_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AppEngine::V1::AuthorizedCertificates::Rest::ServiceStub.stub :transcode_update_authorized_certificate_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_authorized_certificate_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_authorized_certificate_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_authorized_certificate
    ...
    delete_authorized_certificate_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AppEngine::V1::AuthorizedCertificates::Rest::ServiceStub.stub :transcode_delete_authorized_certificate_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_authorized_certificate_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_authorized_certificate_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AppEngine::V1::AuthorizedCertificates::Rest::Client::Configuration, config
  end
end
