...
class ::Google::Cloud::AppEngine::V1::AuthorizedDomains::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_authorized_domains
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AppEngine::V1::ListAuthorizedDomainsResponse.new
    ...
    list_authorized_domains_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_authorized_domains, name
      assert_kind_of ::Google::Cloud::AppEngine::V1::ListAuthorizedDomainsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_authorized_domains_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_authorized_domains_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AppEngine::V1::AuthorizedDomains::Client::Configuration, config
  end
end
