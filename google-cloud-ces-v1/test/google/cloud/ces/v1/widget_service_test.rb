...
class ::Google::Cloud::Ces::V1::WidgetService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_generate_chat_token
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Ces::V1::GenerateChatTokenResponse.new
    ...
    generate_chat_token_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Ces::V1::GenerateChatTokenRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Ces::V1::WidgetService::Client::Configuration, config
  end
