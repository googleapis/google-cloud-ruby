...
class ::Google::Cloud::Ces::V1::SessionService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_run_session
    # Create test objects.
    client_result = ::Google::Cloud::Ces::V1::RunSessionResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Ces::V1::SessionService::Rest::Client::Configuration, config
  end
end
