...
def create_context project_id:, session_id:, context_id:
  ...
  sessions_client = Google::Cloud::Dialogflow.sessions
  session_path = sessions_client.session_path project: project_id, session: session_id
  session_path = Google::Cloud::Dialogflow.sessions.session_path project: project_id, session: session_id

  context_client = Google::Cloud::Dialogflow.contexts
  context_path = context_client.context_path project: project_id, session: session_id, context: context_id
  context = { name: context_path, lifespan_count: 1 }
  response = context_client.create_context parent: session_path, context: context
