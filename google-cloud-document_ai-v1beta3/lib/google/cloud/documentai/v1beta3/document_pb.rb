...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/documentai/v1beta3/document.proto", :syntax => :proto3) do
    add_message "google.cloud.documentai.v1beta3.Document" do
      ...
      repeated :text_styles, :message, 5, "google.cloud.documentai.v1beta3.Document.Style"
      ...
      repeated :revisions, :message, 13, "google.cloud.documentai.v1beta3.Document.Revision"
      oneof :source do
        optional :uri, :string, 1
        optional :content, :bytes, 2
      end
    end
    add_message "google.cloud.documentai.v1beta3.Document.ShardInfo" do
      optional :shard_index, :int64, 1
      optional :shard_count, :int64, 2
      optional :text_offset, :int64, 3
    end
    add_message "google.cloud.documentai.v1beta3.Document.Style" do
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Page" do
      optional :page_number, :int32, 1
      optional :image, :message, 13, "google.cloud.documentai.v1beta3.Document.Page.Image"
      repeated :transforms, :message, 14, "google.cloud.documentai.v1beta3.Document.Page.Matrix"
      optional :dimension, :message, 2, "google.cloud.documentai.v1beta3.Document.Page.Dimension"
      optional :layout, :message, 3, "google.cloud.documentai.v1beta3.Document.Page.Layout"
      repeated :detected_languages, :message, 4, "google.cloud.documentai.v1beta3.Document.Page.DetectedLanguage"
      repeated :blocks, :message, 5, "google.cloud.documentai.v1beta3.Document.Page.Block"
      repeated :paragraphs, :message, 6, "google.cloud.documentai.v1beta3.Document.Page.Paragraph"
      repeated :lines, :message, 7, "google.cloud.documentai.v1beta3.Document.Page.Line"
      repeated :tokens, :message, 8, "google.cloud.documentai.v1beta3.Document.Page.Token"
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Page.Image" do
      optional :content, :bytes, 1
      optional :mime_type, :string, 2
      optional :width, :int32, 3
      optional :height, :int32, 4
    end
    add_message "google.cloud.documentai.v1beta3.Document.Page.Matrix" do
      optional :rows, :int32, 1
      optional :cols, :int32, 2
      optional :type, :int32, 3
      optional :data, :bytes, 4
    end
    add_message "google.cloud.documentai.v1beta3.Document.Page.Layout" do
      optional :text_anchor, :message, 1, "google.cloud.documentai.v1beta3.Document.TextAnchor"
      optional :confidence, :float, 2
      optional :bounding_poly, :message, 3, "google.cloud.documentai.v1beta3.BoundingPoly"
      optional :orientation, :enum, 4, "google.cloud.documentai.v1beta3.Document.Page.Layout.Orientation"
    end
    add_enum "google.cloud.documentai.v1beta3.Document.Page.Layout.Orientation" do
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Page.Block" do
      ...
      optional :provenance, :message, 3, "google.cloud.documentai.v1beta3.Document.Provenance"
    end
    add_message "google.cloud.documentai.v1beta3.Document.Page.Paragraph" do
      optional :layout, :message, 1, "google.cloud.documentai.v1beta3.Document.Page.Layout"
      repeated :detected_languages, :message, 2, "google.cloud.documentai.v1beta3.Document.Page.DetectedLanguage"
      optional :provenance, :message, 3, "google.cloud.documentai.v1beta3.Document.Provenance"
    end
    add_message "google.cloud.documentai.v1beta3.Document.Page.Line" do
      optional :layout, :message, 1, "google.cloud.documentai.v1beta3.Document.Page.Layout"
      repeated :detected_languages, :message, 2, "google.cloud.documentai.v1beta3.Document.Page.DetectedLanguage"
      optional :provenance, :message, 3, "google.cloud.documentai.v1beta3.Document.Provenance"
    end
    add_message "google.cloud.documentai.v1beta3.Document.Page.Token" do
      optional :layout, :message, 1, "google.cloud.documentai.v1beta3.Document.Page.Layout"
      optional :detected_break, :message, 2, "google.cloud.documentai.v1beta3.Document.Page.Token.DetectedBreak"
      repeated :detected_languages, :message, 3, "google.cloud.documentai.v1beta3.Document.Page.DetectedLanguage"
      optional :provenance, :message, 4, "google.cloud.documentai.v1beta3.Document.Provenance"
    end
    add_message "google.cloud.documentai.v1beta3.Document.Page.Token.DetectedBreak" do
      optional :type, :enum, 1, "google.cloud.documentai.v1beta3.Document.Page.Token.DetectedBreak.Type"
    end
    add_enum "google.cloud.documentai.v1beta3.Document.Page.Token.DetectedBreak.Type" do
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Page.Table" do
      optional :layout, :message, 1, "google.cloud.documentai.v1beta3.Document.Page.Layout"
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Page.Table.TableCell" do
      optional :layout, :message, 1, "google.cloud.documentai.v1beta3.Document.Page.Layout"
      optional :row_span, :int32, 2
      optional :col_span, :int32, 3
      repeated :detected_languages, :message, 4, "google.cloud.documentai.v1beta3.Document.Page.DetectedLanguage"
    end
    add_message "google.cloud.documentai.v1beta3.Document.Page.FormField" do
      optional :field_name, :message, 1, "google.cloud.documentai.v1beta3.Document.Page.Layout"
      optional :field_value, :message, 2, "google.cloud.documentai.v1beta3.Document.Page.Layout"
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Entity" do
      ...
      optional :page_anchor, :message, 6, "google.cloud.documentai.v1beta3.Document.PageAnchor"
      optional :id, :string, 7
      optional :normalized_value, :message, 9, "google.cloud.documentai.v1beta3.Document.Entity.NormalizedValue"
      repeated :properties, :message, 10, "google.cloud.documentai.v1beta3.Document.Entity"
      optional :provenance, :message, 11, "google.cloud.documentai.v1beta3.Document.Provenance"
      optional :redacted, :bool, 12
    end
    add_message "google.cloud.documentai.v1beta3.Document.Entity.NormalizedValue" do
    ...
    add_message "google.cloud.documentai.v1beta3.Document.TextAnchor.TextSegment" do
      optional :start_index, :int64, 1
      optional :end_index, :int64, 2
    end
    add_message "google.cloud.documentai.v1beta3.Document.PageAnchor" do
      repeated :page_refs, :message, 1, "google.cloud.documentai.v1beta3.Document.PageAnchor.PageRef"
    end
    add_message "google.cloud.documentai.v1beta3.Document.PageAnchor.PageRef" do
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Provenance" do
      optional :revision, :int32, 1
      optional :id, :int32, 2
      repeated :parents, :message, 3, "google.cloud.documentai.v1beta3.Document.Provenance.Parent"
      optional :type, :enum, 4, "google.cloud.documentai.v1beta3.Document.Provenance.OperationType"
    end
    ...
    add_message "google.cloud.documentai.v1beta3.Document.Revision.HumanReview" do
      optional :state, :string, 1
      optional :state_message, :string, 2
    end
    add_message "google.cloud.documentai.v1beta3.Document.TextChange" do
      optional :text_anchor, :message, 1, "google.cloud.documentai.v1beta3.Document.TextAnchor"
      optional :changed_text, :string, 2
      repeated :provenance, :message, 3, "google.cloud.documentai.v1beta3.Document.Provenance"
    end
  end
end
...
module Google
  module Cloud
    module DocumentAI
      module V1beta3
        Document = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document").msgclass
        Document::ShardInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.ShardInfo").msgclass
        Document::Style = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Style").msgclass
        Document::Style::FontSize = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Style.FontSize").msgclass
        Document::Page = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page").msgclass
        Document::Page::Dimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Dimension").msgclass
        Document::Page::Image = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Image").msgclass
        Document::Page::Matrix = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Matrix").msgclass
        Document::Page::Layout = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Layout").msgclass
        Document::Page::Layout::Orientation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Layout.Orientation").enummodule
        Document::Page::Block = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Block").msgclass
        Document::Page::Paragraph = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Paragraph").msgclass
        Document::Page::Line = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Page.Line").msgclass
        ...
        Document::PageAnchor::PageRef = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.PageAnchor.PageRef").msgclass
        Document::PageAnchor::PageRef::LayoutType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.PageAnchor.PageRef.LayoutType").enummodule
        Document::Provenance = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Provenance").msgclass
        Document::Provenance::Parent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Provenance.Parent").msgclass
        Document::Provenance::OperationType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Provenance.OperationType").enummodule
        Document::Revision = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Revision").msgclass
        Document::Revision::HumanReview = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.Revision.HumanReview").msgclass
        Document::TextChange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.documentai.v1beta3.Document.TextChange").msgclass
      end
    end
  end
end
