# Ruby Client for the Transcoder V1beta1 API

API Client library for the Transcoder V1beta1 API
...
specific version of the Transcoder V1beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-video-transcoder-v1beta1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-video-transcoder-v1beta1/latest)
