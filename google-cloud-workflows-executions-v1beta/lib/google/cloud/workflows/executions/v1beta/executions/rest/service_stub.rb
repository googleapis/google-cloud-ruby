          ...
          module Executions
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Cloud::Workflows::Executions::V1beta::ListExecutionsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Cloud::Workflows::Executions::V1beta::ListExecutionsResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Cloud::Workflows::Executions::V1beta::ListExecutionsResponse]
                ...
                def list_executions request_pb, options = nil
                  ...
                  result = ::Google::Cloud::Workflows::Executions::V1beta::ListExecutionsResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Cloud::Workflows::Executions::V1beta::CreateExecutionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Cloud::Workflows::Executions::V1beta::Execution]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                ...
                def create_execution request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Cloud::Workflows::Executions::V1beta::Execution.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                #
                # @param request_pb [::Google::Cloud::Workflows::Executions::V1beta::GetExecutionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Cloud::Workflows::Executions::V1beta::CancelExecutionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def self.transcode_list_executions_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/v1beta/{parent}/executions",
                                                            matches: [
