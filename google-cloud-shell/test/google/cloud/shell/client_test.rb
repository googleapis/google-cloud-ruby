...
class Google::Cloud::Shell::ClientConstructionMinitest < Minitest::Test
  ...
  def test_cloud_shell_service_grpc
    skip unless Google::Cloud::Shell.cloud_shell_service_available? transport: :grpc
  ...
  def test_cloud_shell_service_rest
    skip unless Google::Cloud::Shell.cloud_shell_service_available? transport: :rest
