...
require File.expand_path("lib/google/cloud/maintenance/api/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-maintenance-api-v1"
  gem.version       = Google::Cloud::Maintenance::Api::V1::VERSION
