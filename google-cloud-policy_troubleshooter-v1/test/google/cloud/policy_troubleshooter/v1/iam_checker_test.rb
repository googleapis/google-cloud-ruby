...
class ::Google::Cloud::PolicyTroubleshooter::V1::IamChecker::ClientTest < Minitest::Test
  ...
  def test_troubleshoot_iam_policy
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::PolicyTroubleshooter::V1::TroubleshootIamPolicyResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::PolicyTroubleshooter::V1::IamChecker::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::PolicyTroubleshooter::V1::IamChecker::Client, client
