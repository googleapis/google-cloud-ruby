# Ruby Client for the Data Labeling API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-data_labeling/latest)
for this library, google-cloud-data_labeling, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-data_labeling-v1beta1](https://cloud.google.com/ruby/docs/reference/google-cloud-data_labeling-v1beta1/latest).
...
client library with a name such as `google-cloud-data_labeling`,
...
is part of the name, e.g. `google-cloud-data_labeling-v1beta1`.
