...
Gem::Specification.new do |gem|
  ...
  gem.description   = "The Cloud Filestore API is used for creating and managing cloud file servers. Note that google-cloud-filestore-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-filestore instead. See the readme for more details."
