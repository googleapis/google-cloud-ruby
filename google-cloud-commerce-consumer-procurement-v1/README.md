...
specific version of the Cloud Commerce Consumer Procurement V1 API. Most users should consider using
the main client gem,
[google-cloud-commerce-consumer-procurement](https://rubygems.org/gems/google-cloud-commerce-consumer-procurement).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-commerce-consumer-procurement-v1
```
...
client library with a name such as `google-cloud-commerce-consumer-procurement`,
...
is part of the name, e.g. `google-cloud-commerce-consumer-procurement-v1`.
