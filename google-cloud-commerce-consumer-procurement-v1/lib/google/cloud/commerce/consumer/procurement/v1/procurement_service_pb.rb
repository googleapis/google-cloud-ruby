      ...
      module Consumer
        module Procurement
          module V1
            ...
            ModifyOrderRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.commerce.consumer.procurement.v1.ModifyOrderRequest").msgclass
            ModifyOrderRequest::Modification = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.commerce.consumer.procurement.v1.ModifyOrderRequest.Modification").msgclass
            ModifyOrderMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.commerce.consumer.procurement.v1.ModifyOrderMetadata").msgclass
            CancelOrderRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.commerce.consumer.procurement.v1.CancelOrderRequest").msgclass
            CancelOrderRequest::CancellationPolicy = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.commerce.consumer.procurement.v1.CancelOrderRequest.CancellationPolicy").enummodule
            CancelOrderMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.commerce.consumer.procurement.v1.CancelOrderMetadata").msgclass
            AutoRenewalBehavior = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.commerce.consumer.procurement.v1.AutoRenewalBehavior").enummodule
          end
        end
      end
    end
