...
_versioned_ client gems, with names of the form `google-shopping-merchant-reviews-v*`.
The gem `google-shopping-merchant-reviews` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-reviews)
for this library, google-shopping-merchant-reviews, to see the convenience methods for
...
```
$ gem install google-shopping-merchant-reviews
```
