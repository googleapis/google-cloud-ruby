    ...
    module NetworkManagement
      module V1
        module OrganizationVpcFlowLogsService
          module Rest
            ##
            # REST service stub for the OrganizationVpcFlowLogsService service.
              ...
              def self.transcode_get_vpc_flow_logs_config_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          ...
                                                          matches: [
                                                            ["name", %r{^organizations/[^/]+/locations/[^/]+/vpcFlowLogsConfigs/[^/]+/?$}, false]
                                                          ]
                                                        )
                transcoder.transcode request_pb
              end
              ...
              def self.transcode_update_vpc_flow_logs_config_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          ...
                                                          body: "vpc_flow_logs_config",
                                                          matches: [
                                                            ["vpc_flow_logs_config.name", %r{^organizations/[^/]+/locations/[^/]+/vpcFlowLogsConfigs/[^/]+/?$}, false]
                                                          ]
                                                        )
                transcoder.transcode request_pb
              end
