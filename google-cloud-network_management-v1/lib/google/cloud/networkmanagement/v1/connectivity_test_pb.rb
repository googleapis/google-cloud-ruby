  ...
  module Cloud
    module NetworkManagement
      module V1
        ...
        ProbingDetails::SingleEdgeResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.networkmanagement.v1.ProbingDetails.SingleEdgeResponse").msgclass
