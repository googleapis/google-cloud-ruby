...
##
# Snippet for the delete_vpc_flow_logs_config call in the OrganizationVpcFlowLogsService service
#
...
# Google::Cloud::NetworkManagement::V1::OrganizationVpcFlowLogsService::Client#delete_vpc_flow_logs_config.
#
