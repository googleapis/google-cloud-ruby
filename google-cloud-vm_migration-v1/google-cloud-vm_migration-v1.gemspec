...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Use the Migrate to Virtual Machines API to programmatically migrate workloads. Note that google-cloud-vm_migration-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-vm_migration instead. See the readme for more details."
