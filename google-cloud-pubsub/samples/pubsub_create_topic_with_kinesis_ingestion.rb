...
def create_topic_with_kinesis_ingestion topic_id:, stream_arn:, consumer_arn:, aws_role_arn:, gcp_service_account:
  ...
  kinesis =
    Google::Cloud::PubSub::V1::IngestionDataSourceSettings::AwsKinesis.new stream_arn: stream_arn,
                                                                           consumer_arn: consumer_arn,
                                                                           aws_role_arn: aws_role_arn,
                                                                           gcp_service_account: gcp_service_account

  ingestion_data_source_settings = Google::Cloud::PubSub::V1::IngestionDataSourceSettings.new aws_kinesis: kinesis
