...
def create_topic_with_azure_event_hubs_ingestion topic_id:, resource_group:, namespace:, event_hub:, client_id:,
  ...
  azure_event_hubs =
    Google::Cloud::PubSub::V1::IngestionDataSourceSettings::AzureEventHubs.new resource_group: resource_group,
                                                                               namespace: namespace,
                                                                               event_hub: event_hub,
                                                                               client_id: client_id,
                                                                               tenant_id: tenant_id,
  ...
  ingestion_data_source_settings =
    Google::Cloud::PubSub::V1::IngestionDataSourceSettings.new azure_event_hubs: azure_event_hubs
