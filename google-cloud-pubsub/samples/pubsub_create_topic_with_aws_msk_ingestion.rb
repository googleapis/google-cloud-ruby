...
def create_topic_with_aws_msk_ingestion topic_id:, cluster_arn:, msk_topic:, aws_role_arn:, gcp_service_account:
  ...
  aws_msk = Google::Cloud::PubSub::V1::IngestionDataSourceSettings::AwsMsk.new cluster_arn: cluster_arn,
                                                                               topic: msk_topic,
                                                                               aws_role_arn: aws_role_arn,
                                                                               gcp_service_account: gcp_service_account

  ingestion_data_source_settings = Google::Cloud::PubSub::V1::IngestionDataSourceSettings.new aws_msk: aws_msk
