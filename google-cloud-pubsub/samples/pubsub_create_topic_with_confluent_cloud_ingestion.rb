...
def create_topic_with_confluent_cloud_ingestion topic_id:, bootstrap_server:, cluster_id:, confluent_topic:,
  ...
  confluent_cloud =
    Google::Cloud::PubSub::V1::IngestionDataSourceSettings::ConfluentCloud.new bootstrap_server: bootstrap_server,
  ...
  ingestion_data_source_settings =
    Google::Cloud::PubSub::V1::IngestionDataSourceSettings.new confluent_cloud: confluent_cloud
