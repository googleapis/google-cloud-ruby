...
describe Google::Cloud::PubSub::MessageListener, :acknowledge, :mock_pubsub do
  ...
  it "does not send flow control settings to server when use_legacy_flow_control is true" do
    ...
    listener = subscriber.listen streams: 1, inventory: { max_outstanding_messages: 999, max_outstanding_bytes: 777, use_legacy_flow_control: true } do |result|
      # flush the initial buffer before any callbacks are processed
      listener.buffer.flush! unless called
