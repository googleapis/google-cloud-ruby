...
describe Google::Cloud::PubSub::MessageListener, :nack, :mock_pubsub do
  ...
  it "can nack a single message" do
    ...
    _(mod_ack_hash[0].sort).must_equal ["ack-id-123456789"]
  end
  ...
  it "can nack multiple messages" do
    ...
    _(mod_ack_hash[0].sort).must_equal ["ack-id-1111", "ack-id-1112", "ack-id-1113"]
  end
end
