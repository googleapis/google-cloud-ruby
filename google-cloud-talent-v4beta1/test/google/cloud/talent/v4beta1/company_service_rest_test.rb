...
class ::Google::Cloud::Talent::V4beta1::CompanyService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_company
    # Create test objects.
    client_result = ::Google::Cloud::Talent::V4beta1::Company.new
  ...
  def test_list_companies
    # Create test objects.
    client_result = ::Google::Cloud::Talent::V4beta1::ListCompaniesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Talent::V4beta1::CompanyService::Rest::Client::Configuration, config
  end
end
