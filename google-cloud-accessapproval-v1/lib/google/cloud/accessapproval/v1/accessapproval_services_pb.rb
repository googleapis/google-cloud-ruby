      ...
      module V1
        module AccessApproval
          ...
          class Service
            ...
            rpc :ListApprovalRequests, ListApprovalRequestsMessage, ListApprovalRequestsResponse
            # Gets an approval request. Returns NOT_FOUND if the request does not exist.
            rpc :GetApprovalRequest, GetApprovalRequestMessage, ApprovalRequest
            # Approves a request and returns the updated ApprovalRequest.
            #
            # Returns NOT_FOUND if the request does not exist. Returns
            # FAILED_PRECONDITION if the request exists but is not in a pending state.
            rpc :ApproveApprovalRequest, ApproveApprovalRequestMessage, ApprovalRequest
            ...
            # state.
            rpc :DismissApprovalRequest, DismissApprovalRequestMessage, ApprovalRequest
            # Gets the settings associated with a project, folder, or organization.
            rpc :GetAccessApprovalSettings, GetAccessApprovalSettingsMessage, AccessApprovalSettings
            # Updates the settings associated with a project, folder, or organization.
            # Settings to update are determined by the value of field_mask.
            rpc :UpdateAccessApprovalSettings, UpdateAccessApprovalSettingsMessage, AccessApprovalSettings
            ...
            rpc :DeleteAccessApprovalSettings, DeleteAccessApprovalSettingsMessage, Google::Protobuf::Empty
          end
