...
require "google/cloud/run/v2/services/rest/operations"
require "google/cloud/run/v2/services/rest/client"
...
require "google/cloud/run/v2/services/rest/helpers" if ::File.file? helper_path
