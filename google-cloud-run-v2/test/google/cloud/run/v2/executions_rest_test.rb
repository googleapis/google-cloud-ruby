...
class ::Google::Cloud::Run::V2::Executions::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_execution
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::Execution.new
  ...
  def test_list_executions
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::ListExecutionsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Run::V2::Executions::Rest::Client::Configuration, config
  end
end
