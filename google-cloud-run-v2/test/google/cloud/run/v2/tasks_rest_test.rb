...
class ::Google::Cloud::Run::V2::Tasks::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_task
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::Task.new
  ...
  def test_list_tasks
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::ListTasksResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Run::V2::Tasks::Rest::Client::Configuration, config
  end
end
