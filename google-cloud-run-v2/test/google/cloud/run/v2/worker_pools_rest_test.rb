...
class ::Google::Cloud::Run::V2::WorkerPools::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_worker_pool
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::WorkerPool.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_worker_pools
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::ListWorkerPoolsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Run::V2::WorkerPools::Rest::Client::Configuration, config
  end
end
