...
class ::Google::Cloud::Run::V2::Tasks::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_task
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Run::V2::Task.new
    ...
    get_task_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Run::V2::GetTaskRequest, request
  ...
  def test_list_tasks
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Run::V2::ListTasksResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_tasks_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Run::V2::ListTasksRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Run::V2::Tasks::Client::Configuration, config
  end
end
