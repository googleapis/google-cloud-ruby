...
class ::Google::Cloud::Run::V2::Instances::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_instance
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::Instance.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_instances
    # Create test objects.
    client_result = ::Google::Cloud::Run::V2::ListInstancesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Run::V2::Instances::Rest::Client::Configuration, config
  end
end
