      ...
      module V2beta
        module ConferenceRecordsService
          ...
          class Client
            ...
            #   {::Google::Apps::Meet::V2beta::GetSmartNoteRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Apps::Meet::V2beta::GetSmartNoteRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Apps::Meet::V2beta::SmartNote]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Google::Apps::Meet::V2beta::SmartNote]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Apps::Meet::V2beta::GetSmartNoteRequest.new
            #
            #   # Call the get_smart_note method.
            #   result = client.get_smart_note request
            #
            #   # The returned object is of type Google::Apps::Meet::V2beta::SmartNote.
            #   p result
            #
            def get_smart_note request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Apps::Meet::V2beta::GetSmartNoteRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.get_smart_note.metadata.to_h
              ...
              @conference_records_service_stub.call_rpc :get_smart_note, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            #   {::Google::Apps::Meet::V2beta::ListSmartNotesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Apps::Meet::V2beta::ListSmartNotesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Apps::Meet::V2beta::SmartNote>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Apps::Meet::V2beta::SmartNote>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Apps::Meet::V2beta::ListSmartNotesRequest.new
            #
            ...
            #   # over elements, and API calls will be issued to fetch pages as needed.
            #   result.each do |item|
            #     # Each element is of type ::Google::Apps::Meet::V2beta::SmartNote.
            #     p item
            #   end
            #
            def list_smart_notes request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Apps::Meet::V2beta::ListSmartNotesRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.list_smart_notes.metadata.to_h
              ...
              @conference_records_service_stub.call_rpc :list_smart_notes, request, options: options do |response, operation|
                response = ::Gapic::PagedEnumerable.new @conference_records_service_stub, :list_smart_notes, request, response, operation, options
                yield response, operation if block_given?
                throw :response, response
              end
            rescue ::GRPC::BadStatus => e
