      ...
      module V2beta
        module SpacesService
          ...
          class Client
            ...
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload connect_active_conference(name: nil, offer: nil, config: nil)
            ...
            #   @param config [::Google::Apps::Meet::V2beta::ConnectActiveConferenceRequest::ConnectionConfig, ::Hash]
            ...
            #   {::Google::Apps::Meet::V2beta::UpdateMemberRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Apps::Meet::V2beta::UpdateMemberRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Apps::Meet::V2beta::UpdateMemberRequest.new
            #
            ...
            def update_member request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Apps::Meet::V2beta::UpdateMemberRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.update_member.metadata.to_h
              ...
              if request.member&.name
                header_params["member.name"] = request.member.name
              end
              ...
              @spaces_service_stub.call_rpc :update_member, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            #   {::Google::Apps::Meet::V2beta::BatchUpdateMembersRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Apps::Meet::V2beta::BatchUpdateMembersRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     Format: spaces/\\{space}
            #   @param requests [::Array<::Google::Apps::Meet::V2beta::UpdateMemberRequest, ::Hash>]
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Apps::Meet::V2beta::BatchUpdateMembersResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Google::Apps::Meet::V2beta::BatchUpdateMembersResponse]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Apps::Meet::V2beta::BatchUpdateMembersRequest.new
            #
            #   # Call the batch_update_members method.
            #   result = client.batch_update_members request
            #
            #   # The returned object is of type Google::Apps::Meet::V2beta::BatchUpdateMembersResponse.
            #   p result
            #
            def batch_update_members request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Apps::Meet::V2beta::BatchUpdateMembersRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.batch_update_members.metadata.to_h
              ...
              @spaces_service_stub.call_rpc :batch_update_members, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
