      ...
      module V2beta
        module SpacesService
          ...
          class Service
            ...
            # Updates a member.
            rpc :UpdateMember, ::Google::Apps::Meet::V2beta::UpdateMemberRequest, ::Google::Apps::Meet::V2beta::Member
            # Updates members of one space within a batch.
            rpc :BatchUpdateMembers, ::Google::Apps::Meet::V2beta::BatchUpdateMembersRequest, ::Google::Apps::Meet::V2beta::BatchUpdateMembersResponse
          end
        ...
        module ConferenceRecordsService
          ...
          class Service
            ...
            rpc :GetSmartNote, ::Google::Apps::Meet::V2beta::GetSmartNoteRequest, ::Google::Apps::Meet::V2beta::SmartNote
            # Lists the set of smart notes from the conference record. By default,
            # ordered by start time and in ascending order.
            rpc :ListSmartNotes, ::Google::Apps::Meet::V2beta::ListSmartNotesRequest, ::Google::Apps::Meet::V2beta::ListSmartNotesResponse
          end
