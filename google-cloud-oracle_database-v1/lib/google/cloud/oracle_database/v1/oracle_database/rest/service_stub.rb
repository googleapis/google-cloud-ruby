        ...
        module OracleDatabase
          module Rest
            ...
            class ServiceStub
              ...
              ##
              # Baseline implementation for the refresh_autonomous_database REST call
              #
              # @param request_pb [::Google::Cloud::OracleDatabase::V1::RefreshAutonomousDatabaseRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Longrunning::Operation]
              #   A result object deserialized from the server's reply
              def refresh_autonomous_database request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_refresh_autonomous_database_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "refresh_autonomous_database",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              ##
              # Baseline implementation for the get_autonomous_database_refreshable_clones REST call
              #
              # @param request_pb [::Google::Cloud::OracleDatabase::V1::GetAutonomousDatabaseRefreshableClonesRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #   A result object deserialized from the server's reply
              def get_autonomous_database_refreshable_clones request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_get_autonomous_database_refreshable_clones_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "get_autonomous_database_refreshable_clones",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::OracleDatabase::V1::AutonomousDatabaseRefreshableClones.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              # @private
              #
              # GRPC transcoding helper method for the refresh_autonomous_database REST call
              #
              # @param request_pb [::Google::Cloud::OracleDatabase::V1::RefreshAutonomousDatabaseRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_refresh_autonomous_database_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
              ...
              # @private
              #
              # GRPC transcoding helper method for the get_autonomous_database_refreshable_clones REST call
              #
              # @param request_pb [::Google::Cloud::OracleDatabase::V1::GetAutonomousDatabaseRefreshableClonesRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_get_autonomous_database_refreshable_clones_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v1/{name}:getRefreshableClones",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/autonomousDatabases/[^/]+/?$}, false]
                                                          ]
                                                        )
