...
##
# Snippet for the list_cloud_exadata_infrastructures call in the OracleDatabase service
#
...
# Google::Cloud::OracleDatabase::V1::OracleDatabase::Rest::Client#list_cloud_exadata_infrastructures.
#
