...
##
# Snippet for the list_autonomous_db_versions call in the OracleDatabase service
#
...
# Google::Cloud::OracleDatabase::V1::OracleDatabase::Rest::Client#list_autonomous_db_versions.
#
