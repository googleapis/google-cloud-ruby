...
##
# Snippet for the test_goldengate_connection_assignment call in the OracleDatabase service
#
...
# Google::Cloud::OracleDatabase::V1::OracleDatabase::Client#test_goldengate_connection_assignment.
#
