...
require File.expand_path("lib/google/cloud/oracle_database/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-oracle_database-v1"
  gem.version       = Google::Cloud::OracleDatabase::V1::VERSION

  gem.authors       = ["Google LLC"]
  gem.email         = "googleapis-packages@google.com"
  gem.description   = "The Oracle Database@Google Cloud API provides a set of APIs to manage Oracle database services, such as Exadata and Autonomous Databases. Note that google-cloud-oracle_database-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-oracle_database instead. See the readme for more details."
