...
The recommended way to authenticate to the google-cloud-cloud_controls_partner-v1 library is to use
...
The google-cloud-cloud_controls_partner-v1 library provides several mechanisms to configure your system.
...
The environment variables that google-cloud-cloud_controls_partner-v1
