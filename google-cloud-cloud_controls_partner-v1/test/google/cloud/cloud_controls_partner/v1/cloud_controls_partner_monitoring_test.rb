...
class ::Google::Cloud::CloudControlsPartner::V1::CloudControlsPartnerMonitoring::ClientTest < Minitest::Test
  ...
  def test_list_violations
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::CloudControlsPartner::V1::ListViolationsResponse.new
    ...
    list_violations_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::CloudControlsPartner::V1::ListViolationsRequest, request
  ...
  def test_get_violation
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::CloudControlsPartner::V1::Violation.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_violation_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::CloudControlsPartner::V1::GetViolationRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::CloudControlsPartner::V1::CloudControlsPartnerMonitoring::Client::Configuration, config
  end
end
