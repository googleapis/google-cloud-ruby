      ...
      module V2
        module SpacesService
          ...
          class Service
            ...
            # "name,email,role".
            rpc :CreateMember, ::Google::Apps::Meet::V2::CreateMemberRequest, ::Google::Apps::Meet::V2::Member
            # Gets a member.
            #
            # This API supports the `fields` parameter in
            # [SystemParameterContext](https://cloud.google.com/apis/docs/system-parameters).
            # When the `fields` parameter is omitted, this API response will default to
            # "name,email,role".
            rpc :GetMember, ::Google::Apps::Meet::V2::GetMemberRequest, ::Google::Apps::Meet::V2::Member
            # Lists members.
            #
            # This API supports the `fields` parameter in
            # [SystemParameterContext](https://cloud.google.com/apis/docs/system-parameters).
            # When the `fields` parameter is omitted this API response will default to
            # "name,email,role".
            rpc :ListMembers, ::Google::Apps::Meet::V2::ListMembersRequest, ::Google::Apps::Meet::V2::ListMembersResponse
            # Deletes the member who was previously assigned roles in the space.
            rpc :DeleteMember, ::Google::Apps::Meet::V2::DeleteMemberRequest, ::Google::Protobuf::Empty
            # Updates a member.
            rpc :UpdateMember, ::Google::Apps::Meet::V2::UpdateMemberRequest, ::Google::Apps::Meet::V2::Member
            # Updates members of one space within a batch.
            rpc :BatchUpdateMembers, ::Google::Apps::Meet::V2::BatchUpdateMembersRequest, ::Google::Apps::Meet::V2::BatchUpdateMembersResponse
          end
        ...
        module ConferenceRecordsService
          ...
          class Service
            ...
            rpc :GetSmartNote, ::Google::Apps::Meet::V2::GetSmartNoteRequest, ::Google::Apps::Meet::V2::SmartNote
            # Lists the set of smart notes from the conference record. By default,
            # ordered by start time and in ascending order.
            rpc :ListSmartNotes, ::Google::Apps::Meet::V2::ListSmartNotesRequest, ::Google::Apps::Meet::V2::ListSmartNotesResponse
          end
