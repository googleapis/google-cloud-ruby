        ...
        module SpacesService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::CreateSpaceRequest]
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::GetSpaceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::UpdateSpaceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::EndActiveConferenceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::CreateMemberRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def create_member request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Apps::Meet::V2::Member.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::GetMemberRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::ListMembersRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Apps::Meet::V2::ListMembersResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Apps::Meet::V2::ListMembersResponse]
              #   A result object deserialized from the server's reply
              def list_members request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Apps::Meet::V2::ListMembersResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Apps::Meet::V2::DeleteMemberRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              ##
              # Baseline implementation for the update_member REST call
              #
              # @param request_pb [::Google::Apps::Meet::V2::UpdateMemberRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Apps::Meet::V2::Member]
              #   A result object deserialized from the server's reply
              def update_member request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_update_member_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
              ...
              ##
              # Baseline implementation for the batch_update_members REST call
              #
              # @param request_pb [::Google::Apps::Meet::V2::BatchUpdateMembersRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #   A result object deserialized from the server's reply
              def batch_update_members request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_batch_update_members_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "batch_update_members",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Apps::Meet::V2::BatchUpdateMembersResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              def self.transcode_end_active_conference_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v2/{name}:endActiveConference",
                                                          body: "*",
                                                          matches: [
                                                            ["name", %r{^spaces/[^/]+/?$}, false]
                                                          ]
              ...
              def self.transcode_create_member_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v2/{parent}/members",
                                                          body: "member",
                                                          matches: [
              ...
              # @private
              #
              # GRPC transcoding helper method for the update_member REST call
              #
              # @param request_pb [::Google::Apps::Meet::V2::UpdateMemberRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_update_member_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :patch,
                                                          uri_template: "/v2/{member.name}",
                                                          body: "member",
                                                          matches: [
                                                            ["member.name", %r{^spaces/[^/]+/members/[^/]+/?$}, false]
                                                          ]
                                                        )
                transcoder.transcode request_pb
              end
              ...
              # @private
              #
              # GRPC transcoding helper method for the batch_update_members REST call
              #
              # @param request_pb [::Google::Apps::Meet::V2::BatchUpdateMembersRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_batch_update_members_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v2/{parent}/members:batchUpdate",
                                                          body: "*",
                                                          matches: [
                                                            ["parent", %r{^spaces/[^/]+/?$}, false]
                                                          ]
