      ...
      module V2
        module SpacesService
          ...
          class Client
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Apps::Meet::V2::Member]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Apps::Meet::V2::Member>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Apps::Meet::V2::Member>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Apps::Meet::V2::BatchUpdateMembersResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
