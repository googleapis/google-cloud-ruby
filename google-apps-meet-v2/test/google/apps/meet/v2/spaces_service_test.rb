...
require "google/apps/meet/v2/spaces_service"

class ::Google::Apps::Meet::V2::SpacesService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_space
    # Create GRPC objects.
    grpc_response = ::Google::Apps::Meet::V2::Space.new
    ...
    create_space_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::CreateSpaceRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Apps::Meet::V2::Space), request["space"]
      refute_nil options
    end
  ...
  def test_get_space
    ...
    get_space_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::GetSpaceRequest, request
  ...
  def test_update_space
    ...
    update_space_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::UpdateSpaceRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Apps::Meet::V2::Space), request["space"]
  ...
  def test_end_active_conference
    ...
    end_active_conference_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::EndActiveConferenceRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_create_member
    # Create GRPC objects.
    grpc_response = ::Google::Apps::Meet::V2::Member.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    create_member_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::CreateMemberRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Apps::Meet::V2::Member), request["member"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_member_client_stub do
      ...
      # Use hash object
      c.create_member({ parent: parent, member: member }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.create_member ::Google::Apps::Meet::V2::CreateMemberRequest.new(parent: parent, member: member) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.create_member({ parent: parent, member: member }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.create_member(::Google::Apps::Meet::V2::CreateMemberRequest.new(parent: parent, member: member), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_member
    ...
    get_member_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::GetMemberRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_member_client_stub do
      ...
      # Use hash object
      c.get_member({ name: name }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.get_member ::Google::Apps::Meet::V2::GetMemberRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.get_member({ name: name }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.get_member(::Google::Apps::Meet::V2::GetMemberRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_members
    # Create GRPC objects.
    grpc_response = ::Google::Apps::Meet::V2::ListMembersResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_members_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::ListMembersRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_members_client_stub do
      ...
      # Use hash object
      c.list_members({ parent: parent, page_size: page_size, page_token: page_token }) do |response, operation|
      ...
      # Use protobuf object
      c.list_members ::Google::Apps::Meet::V2::ListMembersRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      c.list_members({ parent: parent, page_size: page_size, page_token: page_token }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list_members(::Google::Apps::Meet::V2::ListMembersRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_member
    ...
    delete_member_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::DeleteMemberRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_member_client_stub do
      ...
      # Use hash object
      c.delete_member({ name: name }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.delete_member ::Google::Apps::Meet::V2::DeleteMemberRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      c.delete_member({ name: name }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      c.delete_member(::Google::Apps::Meet::V2::DeleteMemberRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_member
    ...
    update_member_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::UpdateMemberRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Apps::Meet::V2::Member), request["member"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, update_member_client_stub do
      ...
      # Use protobuf object
      c.update_member ::Google::Apps::Meet::V2::UpdateMemberRequest.new(member: member, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.update_member(::Google::Apps::Meet::V2::UpdateMemberRequest.new(member: member, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_update_members
    # Create GRPC objects.
    grpc_response = ::Google::Apps::Meet::V2::BatchUpdateMembersResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    batch_update_members_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Apps::Meet::V2::BatchUpdateMembersRequest, request
      assert_equal "hello world", request["parent"]
      assert_kind_of ::Google::Apps::Meet::V2::UpdateMemberRequest, request["requests"].first
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, batch_update_members_client_stub do
      ...
      # Use protobuf object
      c.batch_update_members ::Google::Apps::Meet::V2::BatchUpdateMembersRequest.new(parent: parent, requests: requests, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.batch_update_members(::Google::Apps::Meet::V2::BatchUpdateMembersRequest.new(parent: parent, requests: requests, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Apps::Meet::V2::SpacesService::Client::Configuration, config
  end
