...
class ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ClientTest < Minitest::Test
  ...
  def test_get_smart_note
    # Create test objects.
    client_result = ::Google::Apps::Meet::V2::SmartNote.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_get_smart_note_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_smart_note_client_stub do
        ...
        # Use protobuf object
        c.get_smart_note ::Google::Apps::Meet::V2::GetSmartNoteRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_smart_note(::Google::Apps::Meet::V2::GetSmartNoteRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_smart_notes
    # Create test objects.
    client_result = ::Google::Apps::Meet::V2::ListSmartNotesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Apps::Meet::V2::ConferenceRecordsService::Rest::ServiceStub.stub :transcode_list_smart_notes_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_smart_notes_client_stub do
        ...
        # Use protobuf object
        c.list_smart_notes ::Google::Apps::Meet::V2::ListSmartNotesRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_smart_notes(::Google::Apps::Meet::V2::ListSmartNotesRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
