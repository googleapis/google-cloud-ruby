...
require "google/cloud/support/v2/case_service/rest/service_stub"
        ...
        module CaseService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Support::V2::CaseService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CaseService clients
              #   ::Google::Cloud::Support::V2::CaseService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Cloud::Support::V2::CaseService::Rest::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @case_service_stub = ::Google::Cloud::Support::V2::CaseService::Rest::ServiceStub.new(
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Support::V2::Case>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Support::V2::Case>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              #     first page is retrieved.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Support::V2::CaseClassification>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Support::V2::CaseClassification>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              # {::Google::Cloud::Support::V2::CaseService::Rest::Client::Configuration::Rpcs}
