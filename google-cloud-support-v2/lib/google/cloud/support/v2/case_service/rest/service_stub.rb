        ...
        module CaseService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::GetCaseRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::Support::V2::Case]
              ...
              def get_case request_pb, options = nil
                ...
                result = ::Google::Cloud::Support::V2::Case.decode_json response.body, ignore_unknown_fields: true
                catch :response do
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::ListCasesRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::Support::V2::ListCasesResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::Support::V2::ListCasesResponse]
              #   A result object deserialized from the server's reply
              def list_cases request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Support::V2::ListCasesResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::SearchCasesRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::Support::V2::SearchCasesResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::Support::V2::SearchCasesResponse]
              #   A result object deserialized from the server's reply
              def search_cases request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Support::V2::SearchCasesResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::CreateCaseRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::UpdateCaseRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::EscalateCaseRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::CloseCaseRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Support::V2::SearchCaseClassificationsRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::Support::V2::SearchCaseClassificationsResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::Support::V2::SearchCaseClassificationsResponse]
              #   A result object deserialized from the server's reply
              def search_case_classifications request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Support::V2::SearchCaseClassificationsResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              def self.transcode_search_cases_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v2/{parent}/cases:search",
                                                          matches: [
                                                            ["parent", %r{^projects/[^/]+/?$}, false]
                                                          ]
                                                        )
              ...
              def self.transcode_search_case_classifications_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v2/caseClassifications:search",
                                                          matches: []
                                                        )
                transcoder.transcode request_pb
              end
