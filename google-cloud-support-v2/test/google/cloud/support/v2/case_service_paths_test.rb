...
class ::Google::Cloud::Support::V2::CaseService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_case_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.case_path organization: "value0", case_param: "value1"
      assert_equal "organizations/value0/cases/value1", path

      path = client.case_path project: "value0", case_param: "value1"
