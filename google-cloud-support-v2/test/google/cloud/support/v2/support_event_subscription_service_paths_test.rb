...
class ::Google::Cloud::Support::V2::SupportEventSubscriptionService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_support_event_subscription_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.support_event_subscription_path organization: "value0", support_event_subscription: "value1"
      assert_equal "organizations/value0/supportEventSubscriptions/value1", path
    end
  end
end
