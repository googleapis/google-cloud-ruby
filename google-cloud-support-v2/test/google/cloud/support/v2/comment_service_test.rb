...
class ::Google::Cloud::Support::V2::CommentService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_comments
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Support::V2::ListCommentsResponse.new
    ...
    list_comments_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Support::V2::ListCommentsRequest, request
  ...
  def test_create_comment
    ...
    create_comment_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Support::V2::CreateCommentRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Support::V2::Comment), request["comment"]
      refute_nil options
    end
  ...
  def test_get_comment
    ...
    Gapic::ServiceStub.stub :new, get_comment_client_stub do
      ...
      # Use protobuf object
      client.get_comment ::Google::Cloud::Support::V2::GetCommentRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_comment(::Google::Cloud::Support::V2::GetCommentRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Support::V2::CommentService::Client::Configuration, config
  end
