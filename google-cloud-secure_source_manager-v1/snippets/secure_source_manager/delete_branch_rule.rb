...
##
# Snippet for the delete_branch_rule call in the SecureSourceManager service
#
...
# Google::Cloud::SecureSourceManager::V1::SecureSourceManager::Client#delete_branch_rule.
#
