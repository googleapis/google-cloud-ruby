...
module Google
  module Cloud
    module DatabaseCenter
      module V1beta
        QueryProductsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.databasecenter.v1beta.QueryProductsRequest").msgclass
        QueryProductsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.databasecenter.v1beta.QueryProductsResponse").msgclass
        QueryDatabaseResourceGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.databasecenter.v1beta.QueryDatabaseResourceGroupsRequest").msgclass
