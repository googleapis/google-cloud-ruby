...
class ::Google::Cloud::ApiRegistry::V1beta::CloudApiRegistry::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_mcp_server
    # Create test objects.
    client_result = ::Google::Cloud::ApiRegistry::V1beta::McpServer.new
  ...
  def test_list_mcp_servers
    # Create test objects.
    client_result = ::Google::Cloud::ApiRegistry::V1beta::ListMcpServersResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_get_mcp_tool
    # Create test objects.
    client_result = ::Google::Cloud::ApiRegistry::V1beta::McpTool.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_mcp_tool_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiRegistry::V1beta::CloudApiRegistry::Rest::ServiceStub.stub :transcode_get_mcp_tool_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_mcp_tool_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_mcp_tool_client_stub.call_count
      end
    end
  end
  ...
  def test_list_mcp_tools
    # Create test objects.
    client_result = ::Google::Cloud::ApiRegistry::V1beta::ListMcpToolsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_mcp_tools_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ApiRegistry::V1beta::CloudApiRegistry::Rest::ServiceStub.stub :transcode_list_mcp_tools_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_mcp_tools_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_mcp_tools_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ApiRegistry::V1beta::CloudApiRegistry::Rest::Client::Configuration, config
  end
end
