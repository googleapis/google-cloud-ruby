...
##
# Snippet for the get_certificate_authority call in the Memorystore service
#
...
# Google::Cloud::Memorystore::V1beta::Memorystore::Rest::Client#get_certificate_authority.
#
