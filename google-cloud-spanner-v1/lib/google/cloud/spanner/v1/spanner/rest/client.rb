...
require "google/cloud/spanner/v1/spanner/rest/service_stub"
    ...
    module Spanner
      module V1
        module Spanner
          module Rest
            ##
            # REST client for the Spanner service.
            #
            # Cloud Spanner API
            #
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Spanner::V1::Spanner::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all Spanner clients
              #   ::Google::Cloud::Spanner::V1::Spanner::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new Spanner REST client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                @spanner_stub = ::Google::Cloud::Spanner::V1::Spanner::Rest::ServiceStub.new(
                ...
                @spanner_stub.logger(stub: true)&.info do |entry|
              ...
              def create_session request, options = nil
                ...
                @spanner_stub.create_session request, options do |result, operation|
              ...
              def batch_create_sessions request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.batch_create_sessions.metadata.to_h
                ...
                @spanner_stub.batch_create_sessions request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def get_session request, options = nil
                ...
                @spanner_stub.get_session request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Spanner::V1::Session>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::Spanner::V1::Session>]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              def list_sessions request, options = nil
                ...
                @spanner_stub.list_sessions request, options do |result, operation|
                  result = ::Gapic::Rest::PagedEnumerable.new @spanner_stub, :list_sessions, "sessions", request, result, options
                  yield result, operation if block_given?
              ...
              def delete_session request, options = nil
                ...
                @spanner_stub.delete_session request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_streaming_sql ExecuteStreamingSql}
              # instead.
              #
              ...
              def execute_sql request, options = nil
                ...
                @spanner_stub.execute_sql request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Like {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_sql ExecuteSql}, except returns the
              # result set as a stream. Unlike
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_sql ExecuteSql}, there is no limit on
              ...
              def execute_streaming_sql request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.execute_streaming_sql.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ...
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @spanner_stub.execute_streaming_sql request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_sql ExecuteSql}.
              #
              ...
              def execute_batch_dml request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.execute_batch_dml.metadata.to_h
                ...
                @spanner_stub.execute_batch_dml request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_sql ExecuteSql}. This method can't be
              ...
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#streaming_read StreamingRead} instead.
              #
              ...
              def read request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.read.metadata.to_h
                ...
                @spanner_stub.read request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Like {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#read Read}, except returns the result set
              # as a stream. Unlike {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#read Read}, there is no
              ...
              def streaming_read request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.streaming_read.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Spanner::V1::PartialResultSet,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @spanner_stub.streaming_read request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#read Read},
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_sql ExecuteSql} and
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#commit Commit} can begin a new transaction as a
              # side-effect.
              #
              ...
              def begin_transaction request, options = nil
                ...
                @spanner_stub.begin_transaction request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #     {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#begin_transaction BeginTransaction} and
              #     {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#commit Commit} instead.
              #
              ...
              def commit request, options = nil
                ...
                @spanner_stub.commit request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#read Read} or
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_sql ExecuteSql} requests and ultimately
              ...
              def rollback request, options = nil
                ...
                @spanner_stub.rollback request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # by {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_streaming_sql ExecuteStreamingSql} to
              ...
              #     {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#execute_streaming_sql `ExecuteStreamingSql`} with
              ...
              def partition_query request, options = nil
                ...
                @spanner_stub.partition_query request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              # operation in parallel. Each of the returned partition tokens can be used
              # by {::Google::Cloud::Spanner::V1::Spanner::Rest::Client#streaming_read StreamingRead} to specify a
              ...
              def partition_read request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.partition_read.metadata.to_h
                ...
                @spanner_stub.partition_read request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              def batch_write request, options = nil
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Spanner::V1::BatchWriteResponse,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @spanner_stub.batch_write request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              def fetch_cache_update request, options = nil
                ...
                # Customize the options with defaults
                call_metadata = @config.rpcs.fetch_cache_update.metadata.to_h
                ...
                ::Gapic::Rest::ServerStream.new(
                  ::Google::Cloud::Spanner::V1::CacheUpdate,
                  ::Gapic::Rest::ThreadedEnumerator.new do |in_q, out_q|
                    @spanner_stub.fetch_cache_update request, options do |chunk|
                      in_q.deq
                      out_q.enq chunk
                    end
                  end
              ...
              ##
              # Configuration class for the Spanner REST API.
              #
              # This class represents the configuration for Spanner REST,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Cloud::Spanner::V1::Spanner::Rest::Client::Configuration::Rpcs}
