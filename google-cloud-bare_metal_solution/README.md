...
The gem `google-cloud-bare_metal_solution` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-bare_metal_solution/latest)
for this library, google-cloud-bare_metal_solution, to see the convenience methods for
...
```
$ gem install google-cloud-bare_metal_solution
```
...
client library with a name such as `google-cloud-bare_metal_solution`,
...
is part of the name, e.g. `google-cloud-bare_metal_solution-v2`.
