...
class ::Google::Shopping::Merchant::Reports::V1::ReportService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_search
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Reports::V1::SearchResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Reports::V1::ReportService::Rest::Client::Configuration, config
  end
end
