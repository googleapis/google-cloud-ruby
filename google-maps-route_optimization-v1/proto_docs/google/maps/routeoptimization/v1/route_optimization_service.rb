  ...
  module Maps
    module RouteOptimization
      module V1
        ...
        # @!attribute [rw] input
        #   @return [::Google::Maps::RouteOptimization::V1::Uri]
        ...
        class OptimizeToursUriMetadata
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::BatchOptimizeToursRequest::AsyncModelConfig>]
        ...
        class BatchOptimizeToursRequest
          ...
          #   @return [::Google::Maps::RouteOptimization::V1::InputConfig]
          #     Required. Information about the input model.
          # @!attribute [rw] output_config
          #   @return [::Google::Maps::RouteOptimization::V1::OutputConfig]
        ...
        class OptimizeToursLongRunningMetadata
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end
        ...
        # @!attribute [rw] model
        #   @return [::Google::Maps::RouteOptimization::V1::ShipmentModel]
        #     Shipment model to solve.
        # @!attribute [rw] solving_mode
        #   @return [::Google::Maps::RouteOptimization::V1::OptimizeToursRequest::SolvingMode]
        #     By default, the solving mode is `DEFAULT_SOLVE` (0).
        # @!attribute [rw] search_mode
        #   @return [::Google::Maps::RouteOptimization::V1::OptimizeToursRequest::SearchMode]
        #     Search mode used to solve the request.
        # @!attribute [rw] injected_first_solution_routes
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentRoute>]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::InjectedSolutionConstraint]
        ...
        class OptimizeToursRequest
          ...
          # {::Google::Maps::RouteOptimization::V1::OptimizeToursRequest#max_validation_errors max_validation_errors}
          ...
          module SolvingMode
            ...
            # {::Google::Maps::RouteOptimization::V1::OptimizeToursResponse#validation_errors OptimizeToursResponse.validation_errors}
            # or
            # {::Google::Maps::RouteOptimization::V1::OptimizeToursResponse#skipped_shipments OptimizeToursResponse.skipped_shipments},
        ...
        #   @return [::String]
        #     Copy of the
        #     {::Google::Maps::RouteOptimization::V1::OptimizeToursRequest#label OptimizeToursRequest.label},
        #     if a label was specified in the request.
        # @!attribute [rw] skipped_shipments
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::SkippedShipment>]
        #     The list of all shipments skipped.
        # @!attribute [rw] validation_errors
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::OptimizeToursValidationError>]
        #     List of all the validation errors that we were able to detect
        #     independently. See the "MULTIPLE ERRORS" explanation for the
        #     {::Google::Maps::RouteOptimization::V1::OptimizeToursValidationError OptimizeToursValidationError}
        #     message. Instead of errors, this will include warnings in the case
        #     `solving_mode` is `DEFAULT_SOLVE`.
        # @!attribute [rw] processed_request
        #   @return [::Google::Maps::RouteOptimization::V1::OptimizeToursRequest]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::OptimizeToursResponse::Metrics]
        ...
        class OptimizeToursResponse
          ...
          #   @return [::Google::Maps::RouteOptimization::V1::AggregatedMetrics]
          #     Aggregated over the routes. Each metric is the sum (or max, for loads)
          #     over all
          #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute#metrics ShipmentRoute.metrics}
          ...
          #     {::Google::Maps::RouteOptimization::V1::Vehicle#used_if_route_is_empty Vehicle.used_if_route_is_empty}
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::Shipment>]
        #     Set of shipments which must be performed in the model.
        # @!attribute [rw] vehicles
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::Vehicle>]
        #     Set of vehicles which can be used to perform visits.
        # @!attribute [rw] objectives
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentModel::Objective>]
        ...
        #     the same unit as
        #     {::Google::Maps::RouteOptimization::V1::Shipment#penalty_cost Shipment.penalty_cost}.
        # @!attribute [rw] duration_distance_matrices
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentModel::DurationDistanceMatrix>]
        ...
        #
        #     Tags correspond to
        #     {::Google::Maps::RouteOptimization::V1::Shipment::VisitRequest#tags VisitRequest.tags}
        #     or
        #     {::Google::Maps::RouteOptimization::V1::Vehicle#start_tags Vehicle.start_tags}.
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::TransitionAttributes>]
        #     Transition attributes added to the model.
        # @!attribute [rw] shipment_type_incompatibilities
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentTypeIncompatibility>]
        #     Sets of incompatible shipment_types (see `ShipmentTypeIncompatibility`).
        # @!attribute [rw] shipment_type_requirements
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentTypeRequirement>]
        #     Sets of `shipment_type` requirements (see `ShipmentTypeRequirement`).
        # @!attribute [rw] precedence_rules
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentModel::PrecedenceRule>]
        ...
        class ShipmentModel
          ...
          # for more details.
          # @!attribute [rw] type
          #   @return [::Google::Maps::RouteOptimization::V1::ShipmentModel::Objective::Type]
          ...
          # @!attribute [rw] rows
          #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentModel::DurationDistanceMatrix::Row>]
          #     Specifies the rows of the duration and distance matrix. It must have as
          #     many elements as
          #     {::Google::Maps::RouteOptimization::V1::ShipmentModel#duration_distance_matrix_src_tags ShipmentModel.duration_distance_matrix_src_tags}.
          ...
          class DurationDistanceMatrix
            ...
            #     {::Google::Maps::RouteOptimization::V1::ShipmentModel#duration_distance_matrix_dst_tags ShipmentModel.duration_distance_matrix_dst_tags}.
            # @!attribute [rw] meters
            #   @return [::Array<::Float>]
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::Shipment::VisitRequest>]
        ...
        #   @return [::Google::Protobuf::Map{::String => ::Google::Maps::RouteOptimization::V1::Shipment::Load}]
        ...
        #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Visit ShipmentRoute.Visit}.
        # @!attribute [rw] ignore
        #   @return [::Boolean]
        ...
        class Shipment
          ...
          #   @return [::Google::Maps::RouteOptimization::V1::Waypoint]
          ...
          #   @return [::Array<::Google::Maps::RouteOptimization::V1::TimeWindow>]
          ...
          #     {::Google::Maps::RouteOptimization::V1::TimeWindow#start_time TimeWindow.start_time}.
          #
          ...
          #     {::Google::Maps::RouteOptimization::V1::Shipment#load_demands Shipment.load_demands}
          #     field, except that it only applies to this
          #     {::Google::Maps::RouteOptimization::V1::Shipment::VisitRequest VisitRequest}
          #     instead of the whole
          #     {::Google::Maps::RouteOptimization::V1::Shipment Shipment}. The demands listed
          ...
          #     {::Google::Maps::RouteOptimization::V1::Vehicle#extra_visit_duration_for_visit_type Vehicle.extra_visit_duration_for_visit_type}).
          #
          ...
          class VisitRequest
            ...
            #   @return [::String]
            # @!attribute [rw] value
            #   @return [::Google::Maps::RouteOptimization::V1::Shipment::Load]
          ...
          # {::Google::Maps::RouteOptimization::V1::Shipment#load_demands load_demands}.
          # @!attribute [rw] amount
          #   @return [::Integer]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::ShipmentTypeIncompatibility::IncompatibilityMode]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::ShipmentTypeRequirement::RequirementMode]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::Vehicle::TravelMode]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::RouteModifiers]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::Vehicle::UnloadingPolicy]
        #     Unloading policy enforced on the vehicle.
        # @!attribute [rw] load_limits
        #   @return [::Google::Protobuf::Map{::String => ::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit}]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::Vehicle::DurationLimit]
        ...
        #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Transition#travel_duration transitions.travel_duration}.
        # @!attribute [rw] route_distance_limit
        #   @return [::Google::Maps::RouteOptimization::V1::DistanceLimit]
        ...
        #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Transition#travel_distance_meters transitions.travel_distance_meters}.
        ...
        #     in addition to
        #     {::Google::Maps::RouteOptimization::V1::Shipment::VisitRequest#duration VisitRequest.duration}
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::BreakRule]
        ...
        #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute ShipmentRoute}.
        # @!attribute [rw] ignore
        #   @return [::Boolean]
        ...
        class Vehicle
          ...
          # {::Google::Maps::RouteOptimization::V1::Vehicle#load_limits load_limits}.
          ...
          #     {::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit#cost_per_unit_above_soft_max cost_per_unit_above_soft_max}.
          # @!attribute [rw] cost_per_unit_above_soft_max
          #   @return [::Float]
          #     If the load ever exceeds
          #     {::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit#soft_max_load soft_max_load}
          #     along this vehicle's route, the following cost penalty applies (only once
          #     per vehicle): (load -
          #     {::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit#soft_max_load soft_max_load})
          #     * {::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit#cost_per_unit_above_soft_max cost_per_unit_above_soft_max}. All costs
          ...
          #   @return [::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit::Interval]
          #     The acceptable load interval of the vehicle at the start of the route.
          # @!attribute [rw] end_load_interval
          #   @return [::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit::Interval]
          #     The acceptable load interval of the vehicle at the end of the route.
          # @!attribute [rw] cost_per_kilometer
          #   @return [::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit::LoadCost]
          ...
          class LoadLimit
            ...
            #     {::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit::Interval#min min}
            #     must be ≤
            #     {::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit::Interval#max max}.
            # @!attribute [rw] max
            #   @return [::Integer]
          ...
          #   @return [::String]
          # @!attribute [rw] value
          #   @return [::Google::Maps::RouteOptimization::V1::Vehicle::LoadLimit]
        ...
        # (see
        # {::Google::Maps::RouteOptimization::V1::ShipmentModel#global_start_time ShipmentModel.global_start_time}
        # and
        # {::Google::Maps::RouteOptimization::V1::ShipmentModel#global_end_time ShipmentModel.global_end_time})
        # and should respect:
        # ```
        ...
        #     {::Google::Maps::RouteOptimization::V1::Shipment::VisitRequest#tags VisitRequest.tags}
        #     or {::Google::Maps::RouteOptimization::V1::Vehicle#end_tags Vehicle.end_tags}
        ...
        #     {::Google::Maps::RouteOptimization::V1::Vehicle#cost_per_kilometer Vehicle.cost_per_kilometer}
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::Location]
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::BreakRule::BreakRequest>]
        #     Sequence of breaks. See the `BreakRequest` message.
        # @!attribute [rw] frequency_constraints
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::BreakRule::FrequencyConstraint>]
        ...
        # @!attribute [rw] visits
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentRoute::Visit>]
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentRoute::Transition>]
        #     Ordered list of transitions for the route.
        # @!attribute [rw] has_traffic_infeasibilities
        #   @return [::Boolean]
        #     When
        #     {::Google::Maps::RouteOptimization::V1::OptimizeToursRequest#consider_road_traffic OptimizeToursRequest.consider_road_traffic},
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::ShipmentRoute::EncodedPolyline]
        #     The encoded polyline representation of the route.
        #     This field is only populated if
        #     {::Google::Maps::RouteOptimization::V1::OptimizeToursRequest#populate_polylines OptimizeToursRequest.populate_polylines}
        #     is set to true.
        # @!attribute [rw] breaks
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::ShipmentRoute::Break>]
        ...
        #     {::Google::Maps::RouteOptimization::V1::AggregatedMetrics AggregatedMetrics} are
        #     summed over all
        #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute#transitions ShipmentRoute.transitions}
        #     or
        #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute#visits ShipmentRoute.visits},
        #     depending on the context.
        # @!attribute [rw] vehicle_fullness
        #   @return [::Google::Maps::RouteOptimization::V1::VehicleFullness]
        #     {::Google::Maps::RouteOptimization::V1::VehicleFullness VehicleFullness} field
        ...
        #     {::Google::Maps::RouteOptimization::V1::AggregatedMetrics#travel_distance_meters AggregatedMetrics.travel_distance_meters})
        #     and the related vehicle limit (e.g.
        #     {::Google::Maps::RouteOptimization::V1::Vehicle#route_distance_limit Vehicle.route_distance_limit}).
        #
        #     Experimental: This field's behavior or existence may change in future.
        ...
        class ShipmentRoute
          ...
          #     {::Google::Maps::RouteOptimization::V1::ShipmentModel ShipmentModel}.
          ...
          #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Transition Transition.loads}
          #     (see this field).
          # @!attribute [rw] detour
          #   @return [::Google::Protobuf::Duration]
          ...
          #     {::Google::Maps::RouteOptimization::V1::Shipment::VisitRequest#label VisitRequest.label},
          #     if specified in the `VisitRequest`.
          # @!attribute [rw] injected_solution_location_token
          #   @return [::Integer]
          ...
          #     {::Google::Maps::RouteOptimization::V1::Shipment::VisitRequest#avoid_u_turns VisitRequest.avoid_u_turns}
          ...
          #     {::Google::Maps::RouteOptimization::V1::OptimizeToursRequest OptimizeToursRequest}.
          #
          #     Experimental: See
          #     https://developers.google.com/maps/tt/route-optimization/experimental/u-turn-avoidance/make-request
          #     for more details.
          ...
          #     vehicle end). See
          #     {::Google::Maps::RouteOptimization::V1::TransitionAttributes#delay TransitionAttributes.delay}.
          ...
          #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute#breaks ShipmentRoute.breaks}.
          ...
          #   @return [::Google::Protobuf::Map{::String => ::Google::Maps::RouteOptimization::V1::ShipmentRoute::VehicleLoad}]
          #     Vehicle loads during this transition, for each type that either appears
          #     in this vehicle's
          #     {::Google::Maps::RouteOptimization::V1::Vehicle#load_limits Vehicle.load_limits},
          ...
          class Transition
            ...
            #   @return [::String]
            # @!attribute [rw] value
            #   @return [::Google::Maps::RouteOptimization::V1::ShipmentRoute::VehicleLoad]
          ...
          # {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Transition#vehicle_loads Transition.vehicle_loads}).
          # @!attribute [rw] amount
          #   @return [::Integer]
        ...
        #   @return [::String]
        #     Copy of the corresponding
        #     {::Google::Maps::RouteOptimization::V1::Shipment#label Shipment.label}, if
        ...
        #
        #     Experimental: This field's behavior or existence may change in future.
        # @!attribute [rw] estimated_incompatible_vehicle_ratio
        #   @return [::Float]
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::SkippedShipment::Reason>]
        ...
        class SkippedShipment
          ...
          # @!attribute [rw] code
          #   @return [::Google::Maps::RouteOptimization::V1::SkippedShipment::Reason::Code]
          ...
          # @!attribute [rw] example_vehicle_indices
          #   @return [::Array<::Integer>]
          #     Same as
          #     {::Google::Maps::RouteOptimization::V1::SkippedShipment::Reason#example_vehicle_index example_vehicle_index}
        ...
        # {::Google::Maps::RouteOptimization::V1::ShipmentRoute ShipmentRoute} (resp. for
        # {::Google::Maps::RouteOptimization::V1::OptimizeToursResponse OptimizeToursResponse}
        # over all
        # {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Transition Transition}
        # and/or {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Visit Visit} (resp.
        # over all {::Google::Maps::RouteOptimization::V1::ShipmentRoute ShipmentRoute})
        # elements.
        # @!attribute [rw] performed_shipment_count
        #   @return [::Integer]
        #     Number of shipments performed. Note that a pickup and delivery pair only
        #     counts once.
        # @!attribute [rw] performed_mandatory_shipment_count
        #   @return [::Integer]
        #     Number of mandatory shipments performed.
        #
        #     Experimental: This field's behavior or existence may change in future.
        # @!attribute [rw] performed_shipment_penalty_cost_sum
        #   @return [::Float]
        #     The sum of the
        #     {::Google::Maps::RouteOptimization::V1::Shipment#penalty_cost Shipment.penalty_cost}
        ...
        #     {::Google::Maps::RouteOptimization::V1::ShipmentRoute::Transition#vehicle_loads Transition.vehicle_loads}
        #     (resp.
        #     {::Google::Maps::RouteOptimization::V1::AggregatedMetrics#max_loads ShipmentRoute.metrics.max_loads}.
        ...
        # {::Google::Maps::RouteOptimization::V1::VehicleFullness VehicleFullness} is a
        # metric which computes how full a vehicle is. Each
        # {::Google::Maps::RouteOptimization::V1::VehicleFullness VehicleFullness} field is
        ...
        #     {::Google::Maps::RouteOptimization::V1::Vehicle#travel_duration_limit Vehicle.travel_duration_limit}.
        #     If
        #     {::Google::Maps::RouteOptimization::V1::Vehicle#travel_duration_limit Vehicle.travel_duration_limit}
        #     is unset, this field will be unset.
        # @!attribute [rw] active_duration
        #   @return [::Float]
        #     The ratio between [AggregatedMetrics.total_duration_seconds][] and
        #     {::Google::Maps::RouteOptimization::V1::Vehicle#route_duration_limit Vehicle.route_duration_limit}.
        #     If
        #     {::Google::Maps::RouteOptimization::V1::Vehicle#route_duration_limit Vehicle.route_duration_limit}
        #     is unset, this field will be unset.
        # @!attribute [rw] max_load
        ...
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::InjectedSolutionConstraint::ConstraintRelaxation>]
        ...
        class InjectedSolutionConstraint
          ...
          #   @return [::Array<::Google::Maps::RouteOptimization::V1::InjectedSolutionConstraint::ConstraintRelaxation::Relaxation>]
          ...
          class ConstraintRelaxation
            ...
            # @!attribute [rw] level
            #   @return [::Google::Maps::RouteOptimization::V1::InjectedSolutionConstraint::ConstraintRelaxation::Relaxation::Level]
        ...
        # @!attribute [rw] fields
        #   @return [::Array<::Google::Maps::RouteOptimization::V1::OptimizeToursValidationError::FieldReference>]
        ...
        class OptimizeToursValidationError
          ...
          #   @return [::Google::Maps::RouteOptimization::V1::OptimizeToursValidationError::FieldReference]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::GcsSource]
        #     A Google Cloud Storage location. This must be a single object (file).
        # @!attribute [rw] data_format
        #   @return [::Google::Maps::RouteOptimization::V1::DataFormat]
        ...
        #   @return [::Google::Maps::RouteOptimization::V1::GcsDestination]
