...
class ::Google::Cloud::Redis::Cluster::V1::CloudRedisCluster::ClientTest < Minitest::Test
  ...
  def test_get_shared_regional_certificate_authority
    ...
    Gapic::ServiceStub.stub :new, get_shared_regional_certificate_authority_client_stub do
      ...
      # Use protobuf object
      client.get_shared_regional_certificate_authority ::Google::Cloud::Redis::Cluster::V1::GetSharedRegionalCertificateAuthorityRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_shared_regional_certificate_authority(::Google::Cloud::Redis::Cluster::V1::GetSharedRegionalCertificateAuthorityRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
