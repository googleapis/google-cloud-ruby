          ...
          module CloudRedisCluster
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Cloud::Redis::Cluster::V1::GetSharedRegionalCertificateAuthorityRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                def get_shared_regional_certificate_authority request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Cloud::Redis::Cluster::V1::SharedRegionalCertificateAuthority.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
