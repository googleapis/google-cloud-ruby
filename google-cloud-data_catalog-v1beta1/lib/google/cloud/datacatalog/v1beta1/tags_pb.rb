  ...
  module Cloud
    module DataCatalog
      module V1beta1
        ...
        TagTemplate::DataplexTransferStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.datacatalog.v1beta1.TagTemplate.DataplexTransferStatus").enummodule
