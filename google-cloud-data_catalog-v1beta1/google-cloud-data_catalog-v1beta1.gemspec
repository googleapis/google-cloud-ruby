...
Gem::Specification.new do |gem|
  ...
  gem.description   = "A fully managed and highly scalable data discovery and metadata management service. Note that google-cloud-data_catalog-v1beta1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-data_catalog instead. See the readme for more details."
