...
class ::Google::Shopping::Merchant::Conversions::V1::ConversionSourcesService::ClientTest < Minitest::Test
  ...
  def test_create_conversion_source
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Conversions::V1::ConversionSource.new
    ...
    create_conversion_source_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::CreateConversionSourceRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Conversions::V1::ConversionSource), request["conversion_source"]
      refute_nil options
    end
  ...
  def test_update_conversion_source
    ...
    update_conversion_source_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::UpdateConversionSourceRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Shopping::Merchant::Conversions::V1::ConversionSource), request["conversion_source"]
  ...
  def test_delete_conversion_source
    ...
    delete_conversion_source_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::DeleteConversionSourceRequest, request
  ...
  def test_undelete_conversion_source
    ...
    undelete_conversion_source_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::UndeleteConversionSourceRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_get_conversion_source
    ...
    get_conversion_source_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::GetConversionSourceRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
  ...
  def test_list_conversion_sources
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Conversions::V1::ListConversionSourcesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_conversion_sources_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::ListConversionSourcesRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::ConversionSourcesService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Shopping::Merchant::Conversions::V1::ConversionSourcesService::Client, client
