...
require File.expand_path("lib/google/cloud/network_security/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-network_security-v1"
  gem.version       = Google::Cloud::NetworkSecurity::V1::VERSION
  ...
  gem.summary       = "API Client library for the Network Security V1 API"
