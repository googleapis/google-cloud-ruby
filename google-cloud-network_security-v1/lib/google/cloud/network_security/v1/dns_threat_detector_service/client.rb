      ...
      module V1
        module DnsThreatDetectorService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::NetworkSecurity::V1::DnsThreatDetectorService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all DnsThreatDetectorService clients
            #   ::Google::Cloud::NetworkSecurity::V1::DnsThreatDetectorService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/networksecurity/v1/dns_threat_detector_services_pb"
              ...
              @dns_threat_detector_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::NetworkSecurity::V1::DnsThreatDetectorService::Stub,
            ...
            #   {::Google::Cloud::NetworkSecurity::V1::ListDnsThreatDetectorsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::NetworkSecurity::V1::ListDnsThreatDetectorsRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::NetworkSecurity::V1::DnsThreatDetector>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::NetworkSecurity::V1::DnsThreatDetector>]
            #
            ...
            #   request = Google::Cloud::NetworkSecurity::V1::ListDnsThreatDetectorsRequest.new
            #
            ...
            #   result.each do |item|
            #     # Each element is of type ::Google::Cloud::NetworkSecurity::V1::DnsThreatDetector.
            #     p item
            #   end
            #
            def list_dns_threat_detectors request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::NetworkSecurity::V1::ListDnsThreatDetectorsRequest
            ...
            #   {::Google::Cloud::NetworkSecurity::V1::GetDnsThreatDetectorRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::NetworkSecurity::V1::GetDnsThreatDetectorRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::NetworkSecurity::V1::DnsThreatDetector]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_dns_threat_detector request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::NetworkSecurity::V1::GetDnsThreatDetectorRequest
            ...
            #   {::Google::Cloud::NetworkSecurity::V1::CreateDnsThreatDetectorRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::NetworkSecurity::V1::CreateDnsThreatDetectorRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   @param dns_threat_detector [::Google::Cloud::NetworkSecurity::V1::DnsThreatDetector, ::Hash]
            ...
            def create_dns_threat_detector request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::NetworkSecurity::V1::CreateDnsThreatDetectorRequest
            ...
            #   {::Google::Cloud::NetworkSecurity::V1::UpdateDnsThreatDetectorRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::NetworkSecurity::V1::UpdateDnsThreatDetectorRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def update_dns_threat_detector request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::NetworkSecurity::V1::UpdateDnsThreatDetectorRequest
            ...
            #   {::Google::Cloud::NetworkSecurity::V1::DeleteDnsThreatDetectorRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::NetworkSecurity::V1::DeleteDnsThreatDetectorRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::NetworkSecurity::V1::DeleteDnsThreatDetectorRequest.new
            #
            ...
            def delete_dns_threat_detector request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::NetworkSecurity::V1::DeleteDnsThreatDetectorRequest
            ...
            # {::Google::Cloud::NetworkSecurity::V1::DnsThreatDetectorService::Client::Configuration::Rpcs}
