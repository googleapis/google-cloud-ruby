...
# [START privateca_v1beta1_generated_CertificateAuthorityService_DisableCertificateAuthority_sync]
require "google/cloud/security/private_ca/v1beta1"

##
# Snippet for the disable_certificate_authority call in the CertificateAuthorityService service
#
...
# Google::Cloud::Security::PrivateCA::V1beta1::CertificateAuthorityService::Client#disable_certificate_authority.
#
