  ...
  module Cloud
    module NetApp
      module V1
        ...
        StoragePoolType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.StoragePoolType").enummodule
        ScaleType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.ScaleType").enummodule
        ...
        OsType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.netapp.v1.OsType").enummodule
      end
    end
  end
end
