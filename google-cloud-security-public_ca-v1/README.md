# Ruby Client for the Public Certificate Authority V1 API
...
specific version of the Public Certificate Authority V1 API. Most users should consider using
the main client gem,
[google-cloud-security-public_ca](https://rubygems.org/gems/google-cloud-security-public_ca).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-security-public_ca-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-security-public_ca-v1/latest)
