...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Add-ons are customized applications that extend Google Workspace applications. Note that google-cloud-gsuite_add_ons-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-gsuite_add_ons instead. See the readme for more details."
