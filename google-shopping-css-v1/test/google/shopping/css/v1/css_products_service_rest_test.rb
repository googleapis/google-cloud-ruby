...
class ::Google::Shopping::Css::V1::CssProductsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_css_product
    # Create test objects.
    client_result = ::Google::Shopping::Css::V1::CssProduct.new
    ...
    get_css_product_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Css::V1::CssProductsService::Rest::ServiceStub.stub :transcode_get_css_product_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_css_product_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_css_product_client_stub.call_count
      end
    end
  end
  ...
  def test_list_css_products
    # Create test objects.
    client_result = ::Google::Shopping::Css::V1::ListCssProductsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_css_products_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Css::V1::CssProductsService::Rest::ServiceStub.stub :transcode_list_css_products_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_css_products_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_css_products_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Css::V1::CssProductsService::Rest::Client::Configuration, config
  end
end
