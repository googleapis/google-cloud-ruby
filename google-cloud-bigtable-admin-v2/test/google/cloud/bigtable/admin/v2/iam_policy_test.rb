...
class ::Google::Cloud::Bigtable::Admin::V2::IAMPolicy::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Bigtable::Admin::V2::IAMPolicy::Client::Configuration, config
  end
end
