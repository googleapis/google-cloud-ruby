        ...
        module V2
          module IAMPolicy
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Bigtable::Admin::V2::IAMPolicy::Client::Configuration}
              ...
              #
              #     ::Google::Cloud::Bigtable::Admin::V2::IAMPolicy::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Cloud::Bigtable::Admin::V2::IAMPolicy::Client.new
              #
              # To create a new IAMPolicy client with a custom
              # configuration:
              #
              #     client = ::Google::Cloud::Bigtable::Admin::V2::IAMPolicy::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # {::Google::Cloud::Bigtable::Admin::V2::IAMPolicy::Client::Configuration::Rpcs}
