    ...
    module Bigtable
      module Admin
        module V2
          ...
          LogicalView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.LogicalView").msgclass
          MaterializedView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.bigtable.admin.v2.MaterializedView").msgclass
        end
      end
    end
  end
