...
class ::Google::Cloud::Speech::V1::Speech::ClientTest < Minitest::Test
  ...
  def test_recognize
    ...
    Gapic::ServiceStub.stub :new, recognize_client_stub do
      # Create client
      c = ::Google::Cloud::Speech::V1::Speech::Client.new do |config|
      ...
      # Use protobuf object
      c.recognize ::Google::Cloud::Speech::V1::RecognizeRequest.new(config: config, audio: audio) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.recognize(::Google::Cloud::Speech::V1::RecognizeRequest.new(config: config, audio: audio), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_long_running_recognize
    ...
    Gapic::ServiceStub.stub :new, long_running_recognize_client_stub do
      ...
      # Use protobuf object
      c.long_running_recognize ::Google::Cloud::Speech::V1::LongRunningRecognizeRequest.new(config: config, audio: audio, output_config: output_config) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.long_running_recognize(::Google::Cloud::Speech::V1::LongRunningRecognizeRequest.new(config: config, audio: audio, output_config: output_config), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
