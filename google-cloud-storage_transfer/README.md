# Ruby Client for the Storage Transfer Service API

API Client library for the Storage Transfer Service API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-storage_transfer/latest)
for this library, google-cloud-storage_transfer, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-storage_transfer-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-storage_transfer-v1/latest).
...
client library with a name such as `google-cloud-storage_transfer`,
...
is part of the name, e.g. `google-cloud-storage_transfer-v1`.
