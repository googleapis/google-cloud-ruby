...
describe "Storage Transfer Service Event Driven Gcs Transfer" do
  ...
  # end
  # let :topic do
  #   topic = pubsub.create_topic "ruby_storage_transfer_samples_#{SecureRandom.hex}"
  #   topic
  # end
  after do
  ...
  it "creates a transfer job" do
    ...
    out, _err = capture_io do
      retry_resource_exhaustion do
        create_event_driven_gcs_transfer project_id: project.project_id, gcs_source_bucket: source_bucket.name, gcs_sink_bucket: sink_bucket.name, pubsub_id: "projects/storage-sdk-vendor/subscriptions/shubhangi-test"
      end
    end
