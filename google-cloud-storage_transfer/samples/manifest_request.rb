...
def manifest_request project_id: , gcs_source_bucket:, gcs_sink_bucket: , manifest_location:
    ...
    # manifest_location = 'gs://manifestsource/manifest.csv'
    ...
    transfer_job = {
      ...
      transfer_spec: {
        #{}source_agent_pool_name: "projects/storage-sdk-vendor/agentPools/shubhangi-test-pool1",
        gcs_data_source: {
  ...
  if $PROGRAM_NAME == __FILE__
    quickstart project_id: ARGV.shift, gcs_source_bucket: ARGV.shift, gcs_sink_bucket: ARGV.shift, manifest_request: ARGV.shift
  end
