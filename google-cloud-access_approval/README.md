...
The gem `google-cloud-access_approval` is a convenience wrapper library that brings the
...
client gems:
[google-cloud-access_approval-v1](https://googleapis.dev/ruby/google-cloud-access_approval-v1/latest).
...
```
$ gem install google-cloud-access_approval
```
