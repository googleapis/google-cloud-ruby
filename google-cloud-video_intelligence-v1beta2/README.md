# Ruby Client for the Google Cloud Video Intelligence V1BETA2 API
...
specific version of the Google Cloud Video Intelligence V1BETA2 API. Most users should consider using
the main client gem,
