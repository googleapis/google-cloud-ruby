# Ruby Client for the Cloud Video Intelligence V1beta2 API

API Client library for the Cloud Video Intelligence V1beta2 API
...
specific version of the Cloud Video Intelligence V1beta2 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-video_intelligence-v1beta2
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-video_intelligence-v1beta2/latest)
...
is part of the name, e.g. `google-cloud-video_intelligence-v1beta2`.
