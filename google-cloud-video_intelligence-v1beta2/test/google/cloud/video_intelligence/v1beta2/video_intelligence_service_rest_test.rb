  ...
  def test_annotate_video
    ...
    ::Google::Cloud::VideoIntelligence::V1beta2::VideoIntelligenceService::Rest::ServiceStub.stub :transcode_annotate_video_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, annotate_video_client_stub do
        # Create client
        c = ::Google::Cloud::VideoIntelligence::V1beta2::VideoIntelligenceService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.annotate_video ::Google::Cloud::VideoIntelligence::V1beta2::AnnotateVideoRequest.new(input_uri: input_uri, input_content: input_content, features: features, video_context: video_context, output_uri: output_uri, location_id: location_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.annotate_video(::Google::Cloud::VideoIntelligence::V1beta2::AnnotateVideoRequest.new(input_uri: input_uri, input_content: input_content, features: features, video_context: video_context, output_uri: output_uri, location_id: location_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
