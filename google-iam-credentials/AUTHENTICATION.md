...
In general, the google-iam-credentials library uses
...
```sh
export IAM_CREDENTIALS_CREDENTIALS=path/to/keyfile.json
```
...
The google-iam-credentials library aims to make authentication
...
The environment variables that google-iam-credentials
...
Google::Iam::Credentials.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-iam-credentials.
