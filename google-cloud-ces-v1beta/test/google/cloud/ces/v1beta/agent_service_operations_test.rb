...
class ::Google::Cloud::Ces::V1beta::AgentService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Ces::V1beta::AgentService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Ces::V1beta::AgentService::Operations::Configuration, config
  end
end
