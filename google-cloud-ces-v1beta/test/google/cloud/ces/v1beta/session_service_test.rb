...
class ::Google::Cloud::Ces::V1beta::SessionService::ClientTest < Minitest::Test
  ...
  def test_stream_run_session
    ...
    Gapic::ServiceStub.stub :new, stream_run_session_client_stub do
      ...
      # Use protobuf object
      client.stream_run_session ::Google::Cloud::Ces::V1beta::RunSessionRequest.new(config: config, inputs: inputs) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Ces::V1beta::RunSessionResponse, r
        end
      ...
      # Use protobuf object with options
      client.stream_run_session(::Google::Cloud::Ces::V1beta::RunSessionRequest.new(config: config, inputs: inputs), grpc_options) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Ces::V1beta::RunSessionResponse, r
        end
