...
class ::Google::Cloud::Ces::V1beta::SessionService::ClientTest < Minitest::Test
  ...
  def test_run_session
    ...
    Gapic::ServiceStub.stub :new, run_session_client_stub do
      # Create client
      c = ::Google::Cloud::Ces::V1beta::SessionService::Client.new do |config|
      ...
      # Use protobuf object
      c.run_session ::Google::Cloud::Ces::V1beta::RunSessionRequest.new(config: config, inputs: inputs) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.run_session(::Google::Cloud::Ces::V1beta::RunSessionRequest.new(config: config, inputs: inputs), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
    ...
    Gapic::ServiceStub.stub :new, stream_run_session_client_stub do
      ...
      c.stream_run_session({ config: config, inputs: inputs }) do |response, operation|
        ...
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Ces::V1beta::RunSessionResponse, r
        end
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      c.stream_run_session ::Google::Cloud::Ces::V1beta::RunSessionRequest.new(config: config, inputs: inputs) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Ces::V1beta::RunSessionResponse, r
        end
      ...
      # Use protobuf object with options
      c.stream_run_session(::Google::Cloud::Ces::V1beta::RunSessionRequest.new(config: config, inputs: inputs), grpc_options) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Ces::V1beta::RunSessionResponse, r
        end
