...
class ::Google::Cloud::Ces::V1beta::WidgetService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_generate_chat_token
    # Create test objects.
    client_result = ::Google::Cloud::Ces::V1beta::GenerateChatTokenResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Ces::V1beta::WidgetService::Rest::Client::Configuration, config
  end
end
