        ...
        module WidgetService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Ces::V1beta::GenerateChatTokenRequest]
              ...
              def generate_chat_token request_pb, options = nil
                ...
                result = ::Google::Cloud::Ces::V1beta::GenerateChatTokenResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
              ...
              def self.transcode_generate_chat_token_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1beta/{name}:generateChatToken",
                                                          body: "*",
                                                          matches: [
