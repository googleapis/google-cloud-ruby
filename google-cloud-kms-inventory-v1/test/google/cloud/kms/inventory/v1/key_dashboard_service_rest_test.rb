...
class ::Google::Cloud::Kms::Inventory::V1::KeyDashboardService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_crypto_keys
    # Create test objects.
    client_result = ::Google::Cloud::Kms::Inventory::V1::ListCryptoKeysResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Kms::Inventory::V1::KeyDashboardService::Rest::Client::Configuration, config
  end
end
