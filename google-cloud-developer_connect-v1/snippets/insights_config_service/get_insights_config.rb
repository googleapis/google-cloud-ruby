...
##
# Snippet for the get_insights_config call in the InsightsConfigService service
#
...
# Google::Cloud::Developerconnect::V1::InsightsConfigService::Client#get_insights_config.
#
