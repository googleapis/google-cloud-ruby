...
##
# Snippet for the update_insights_config call in the InsightsConfigService service
#
...
# Google::Cloud::Developerconnect::V1::InsightsConfigService::Client#update_insights_config.
#
