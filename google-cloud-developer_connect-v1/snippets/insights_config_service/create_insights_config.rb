...
##
# Snippet for the create_insights_config call in the InsightsConfigService service
#
...
# Google::Cloud::Developerconnect::V1::InsightsConfigService::Client#create_insights_config.
#
