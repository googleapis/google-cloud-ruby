...
class ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_insights_configs
    # Create test objects.
    client_result = ::Google::Cloud::Developerconnect::V1::ListInsightsConfigsResponse.new
    ...
    list_insights_configs_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ServiceStub.stub :transcode_list_insights_configs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_insights_configs_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_insights_configs_client_stub.call_count
      end
    end
  end
  ...
  def test_create_insights_config
    ...
    create_insights_config_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ServiceStub.stub :transcode_create_insights_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_insights_config_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_insights_config_client_stub.call_count
      end
    end
  end
  ...
  def test_get_insights_config
    # Create test objects.
    client_result = ::Google::Cloud::Developerconnect::V1::InsightsConfig.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_insights_config_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ServiceStub.stub :transcode_get_insights_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_insights_config_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_insights_config_client_stub.call_count
      end
    end
  end
  ...
  def test_update_insights_config
    ...
    update_insights_config_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ServiceStub.stub :transcode_update_insights_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_insights_config_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_insights_config_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_insights_config
    ...
    delete_insights_config_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ServiceStub.stub :transcode_delete_insights_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_insights_config_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_insights_config_client_stub.call_count
      end
    end
  end

  def test_get_deployment_event
    # Create test objects.
    client_result = ::Google::Cloud::Developerconnect::V1::DeploymentEvent.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_deployment_event_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ServiceStub.stub :transcode_get_deployment_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_deployment_event_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_deployment_event_client_stub.call_count
      end
    end
  end

  def test_list_deployment_events
    # Create test objects.
    client_result = ::Google::Cloud::Developerconnect::V1::ListDeploymentEventsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_deployment_events_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::ServiceStub.stub :transcode_list_deployment_events_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_deployment_events_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_deployment_events_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Developerconnect::V1::InsightsConfigService::Rest::Client::Configuration, config
  end
end
