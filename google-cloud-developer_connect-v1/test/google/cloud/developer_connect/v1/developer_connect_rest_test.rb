...
class ::Google::Cloud::DeveloperConnect::V1::DeveloperConnect::Rest::ClientTest < Minitest::Test
  ...
  def test_start_o_auth
    # Create test objects.
    client_result = ::Google::Cloud::DeveloperConnect::V1::StartOAuthResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    start_o_auth_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::DeveloperConnect::V1::DeveloperConnect::Rest::ServiceStub.stub :transcode_start_o_auth_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, start_o_auth_client_stub do
        ...
        # Verify method calls
        assert_equal 5, start_o_auth_client_stub.call_count
      end
    end
  end
  ...
  def test_finish_o_auth
    # Create test objects.
    client_result = ::Google::Cloud::DeveloperConnect::V1::FinishOAuthResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    finish_o_auth_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::DeveloperConnect::V1::DeveloperConnect::Rest::ServiceStub.stub :transcode_finish_o_auth_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, finish_o_auth_client_stub do
        ...
        # Verify method calls
        assert_equal 5, finish_o_auth_client_stub.call_count
      end
    end
  end
