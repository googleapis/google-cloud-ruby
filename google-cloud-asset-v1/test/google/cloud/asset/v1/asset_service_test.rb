...
class ::Google::Cloud::Asset::V1::AssetService::ClientTest < Minitest::Test
  ...
  def test_export_iam_policy_analysis
    ...
    export_iam_policy_analysis_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Asset::V1::ExportIamPolicyAnalysisRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Asset::V1::IamPolicyAnalysisQuery), request.analysis_query
    ...
    Gapic::ServiceStub.stub :new, export_iam_policy_analysis_client_stub do
      ...
      # Use hash object
      client.export_iam_policy_analysis({ analysis_query: analysis_query, output_config: output_config }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.export_iam_policy_analysis ::Google::Cloud::Asset::V1::ExportIamPolicyAnalysisRequest.new(analysis_query: analysis_query, output_config: output_config) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.export_iam_policy_analysis({ analysis_query: analysis_query, output_config: output_config }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.export_iam_policy_analysis ::Google::Cloud::Asset::V1::ExportIamPolicyAnalysisRequest.new(analysis_query: analysis_query, output_config: output_config), grpc_options do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
