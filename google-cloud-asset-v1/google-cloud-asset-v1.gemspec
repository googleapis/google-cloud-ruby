...
Gem::Specification.new do |gem|
  ...
  gem.description   = "The Cloud Asset API manages the history and inventory of Google Cloud resources. Note that google-cloud-asset-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-asset instead. See the readme for more details."
