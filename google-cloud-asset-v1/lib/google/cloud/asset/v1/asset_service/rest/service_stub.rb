            ...
            class ServiceStub
              ...
              def batch_get_assets_history request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "batch_get_assets_history",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def search_all_resources request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "search_all_resources",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def search_all_iam_policies request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "search_all_iam_policies",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def analyze_iam_policy request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "analyze_iam_policy",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def analyze_iam_policy_longrunning request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "analyze_iam_policy_longrunning",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Longrunning::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def create_saved_query request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "create_saved_query",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def update_saved_query request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "update_saved_query",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Asset::V1::SavedQuery.decode_json response.body, ignore_unknown_fields: true
              ...
              def batch_get_effective_iam_policies request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "batch_get_effective_iam_policies",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def analyze_org_policies request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "analyze_org_policies",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def analyze_org_policy_governed_containers request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "analyze_org_policy_governed_containers",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def analyze_org_policy_governed_assets request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "analyze_org_policy_governed_assets",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
