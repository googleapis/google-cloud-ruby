...
##
# Snippet for the get_schema call in the ManagedSchemaRegistry service
#
...
# Google::Cloud::ManagedKafka::SchemaRegistry::V1::ManagedSchemaRegistry::Client#get_schema.
#
def get_schema
