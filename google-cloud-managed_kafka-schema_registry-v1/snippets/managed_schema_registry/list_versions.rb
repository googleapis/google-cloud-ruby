...
##
# Snippet for the list_versions call in the ManagedSchemaRegistry service
#
...
# Google::Cloud::ManagedKafka::SchemaRegistry::V1::ManagedSchemaRegistry::Client#list_versions.
#
def list_versions
