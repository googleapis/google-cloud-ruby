...
##
# Snippet for the delete_schema_config call in the ManagedSchemaRegistry service
#
...
# Google::Cloud::ManagedKafka::SchemaRegistry::V1::ManagedSchemaRegistry::Client#delete_schema_config.
#
