...
class ::Google::Cloud::AssuredWorkloads::V1::AssuredWorkloadsService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Cloud::AssuredWorkloads::V1::AssuredWorkloadsService::Operations.new do |config|
  ...
  def test_configure
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      client = ::Google::Cloud::AssuredWorkloads::V1::AssuredWorkloadsService::Operations.new do |config|
        config.credentials = grpc_channel
      end
    end
    ...
    assert_kind_of ::Google::Cloud::AssuredWorkloads::V1::AssuredWorkloadsService::Operations::Configuration, config
  end
end
