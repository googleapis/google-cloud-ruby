...
```
$ gem install google-cloud-assured_workloads-v1
```
...
client library with a name such as `google-cloud-assured_workloads`,
...
is part of the name, e.g. `google-cloud-assured_workloads-v1`.
