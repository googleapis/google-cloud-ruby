...
class ::Google::Shopping::Merchant::Accounts::V1beta::GbpAccountsService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_gbp_accounts
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1beta::ListGbpAccountsResponse.new
    ...
    list_gbp_accounts_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::GbpAccountsService::Rest::ServiceStub.stub :transcode_list_gbp_accounts_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_gbp_accounts_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_gbp_accounts_client_stub.call_count
      end
    end
  end
  ...
  def test_link_gbp_account
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Accounts::V1beta::LinkGbpAccountResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    link_gbp_account_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::GbpAccountsService::Rest::ServiceStub.stub :transcode_link_gbp_account_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, link_gbp_account_client_stub do
        ...
        # Verify method calls
        assert_equal 5, link_gbp_account_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1beta::GbpAccountsService::Rest::Client::Configuration, config
  end
end
