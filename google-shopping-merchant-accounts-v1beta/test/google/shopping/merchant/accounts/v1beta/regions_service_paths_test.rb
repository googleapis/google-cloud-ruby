...
class ::Google::Shopping::Merchant::Accounts::V1beta::RegionsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_region_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.region_path account: "value0", region: "value1"
      assert_equal "accounts/value0/regions/value1", path
    end
  end
end
