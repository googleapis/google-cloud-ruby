...
class ::Google::Shopping::Merchant::Accounts::V1beta::ProgramsService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_program_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.program_path account: "value0", program: "value1"
      assert_equal "accounts/value0/programs/value1", path
    end
  end
end
