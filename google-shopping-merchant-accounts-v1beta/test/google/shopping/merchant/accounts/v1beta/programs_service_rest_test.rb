  ...
  def test_get_program
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::ProgramsService::Rest::ServiceStub.stub :transcode_get_program_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_program_client_stub do
        # Create client
        c = ::Google::Shopping::Merchant::Accounts::V1beta::ProgramsService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.get_program ::Google::Shopping::Merchant::Accounts::V1beta::GetProgramRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.get_program(::Google::Shopping::Merchant::Accounts::V1beta::GetProgramRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_programs
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::ProgramsService::Rest::ServiceStub.stub :transcode_list_programs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_programs_client_stub do
        ...
        # Use protobuf object
        c.list_programs ::Google::Shopping::Merchant::Accounts::V1beta::ListProgramsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_programs(::Google::Shopping::Merchant::Accounts::V1beta::ListProgramsRequest.new(parent: parent, page_size: page_size, page_token: page_token), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_enable_program
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::ProgramsService::Rest::ServiceStub.stub :transcode_enable_program_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, enable_program_client_stub do
        ...
        # Use protobuf object
        c.enable_program ::Google::Shopping::Merchant::Accounts::V1beta::EnableProgramRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.enable_program(::Google::Shopping::Merchant::Accounts::V1beta::EnableProgramRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_disable_program
    ...
    ::Google::Shopping::Merchant::Accounts::V1beta::ProgramsService::Rest::ServiceStub.stub :transcode_disable_program_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, disable_program_client_stub do
        ...
        # Use protobuf object
        c.disable_program ::Google::Shopping::Merchant::Accounts::V1beta::DisableProgramRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.disable_program(::Google::Shopping::Merchant::Accounts::V1beta::DisableProgramRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
