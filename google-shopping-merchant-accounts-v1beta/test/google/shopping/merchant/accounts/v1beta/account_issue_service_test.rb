...
class ::Google::Shopping::Merchant::Accounts::V1beta::AccountIssueService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_account_issues
    # Create GRPC objects.
    grpc_response = ::Google::Shopping::Merchant::Accounts::V1beta::ListAccountIssuesResponse.new
    ...
    list_account_issues_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Shopping::Merchant::Accounts::V1beta::ListAccountIssuesRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Accounts::V1beta::AccountIssueService::Client::Configuration, config
  end
end
