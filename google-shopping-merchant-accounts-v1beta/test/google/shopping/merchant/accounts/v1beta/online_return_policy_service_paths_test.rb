...
class ::Google::Shopping::Merchant::Accounts::V1beta::OnlineReturnPolicyService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_online_return_policy_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.online_return_policy_path account: "value0", return_policy: "value1"
      assert_equal "accounts/value0/onlineReturnPolicies/value1", path
    end
  end
end
