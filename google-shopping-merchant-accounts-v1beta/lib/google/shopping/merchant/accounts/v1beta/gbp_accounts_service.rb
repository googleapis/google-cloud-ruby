...
require "google/shopping/merchant/accounts/v1beta/gbp_accounts_service/client"
...
helper_path = ::File.join __dir__, "gbp_accounts_service", "helpers.rb"
require "google/shopping/merchant/accounts/v1beta/gbp_accounts_service/helpers" if ::File.file? helper_path
