      ...
      module Accounts
        module V1beta
          module CheckoutSettingsService
            ##
            # Client for the CheckoutSettingsService service.
            #
            ...
            class Client
              ...
              #
              # See {::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CheckoutSettingsService clients
              #   ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              ##
              # Create a new CheckoutSettingsService client object.
              #
              # @example
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/shopping/merchant/accounts/v1beta/checkoutsettings_services_pb"
                ...
                @checkout_settings_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Stub,
                ...
                @checkout_settings_service_stub.stub_logger&.info do |entry|
              ...
              #   {::Google::Shopping::Merchant::Accounts::V1beta::GetCheckoutSettingsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Shopping::Merchant::Accounts::V1beta::GetCheckoutSettingsRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettings]
              ...
              #   request = Google::Shopping::Merchant::Accounts::V1beta::GetCheckoutSettingsRequest.new
              #
              #   # Call the get_checkout_settings method.
              #   result = client.get_checkout_settings request
              #
              #   # The returned object is of type Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettings.
              #   p result
              #
              def get_checkout_settings request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1beta::GetCheckoutSettingsRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                metadata = @config.rpcs.get_checkout_settings.metadata.to_h
                ...
                @checkout_settings_service_stub.call_rpc :get_checkout_settings, request, options: options do |response, operation|
              ...
              #   {::Google::Shopping::Merchant::Accounts::V1beta::CreateCheckoutSettingsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Shopping::Merchant::Accounts::V1beta::CreateCheckoutSettingsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #     created.
              #   @param checkout_settings [::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettings, ::Hash]
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Shopping::Merchant::Accounts::V1beta::CreateCheckoutSettingsRequest.new
              #
              ...
              def create_checkout_settings request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1beta::CreateCheckoutSettingsRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                metadata = @config.rpcs.create_checkout_settings.metadata.to_h
                ...
                @checkout_settings_service_stub.call_rpc :create_checkout_settings, request, options: options do |response, operation|
                  yield response, operation if block_given?
                end
              rescue ::GRPC::BadStatus => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #   {::Google::Shopping::Merchant::Accounts::V1beta::UpdateCheckoutSettingsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Shopping::Merchant::Accounts::V1beta::UpdateCheckoutSettingsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Shopping::Merchant::Accounts::V1beta::UpdateCheckoutSettingsRequest.new
              #
              ...
              def update_checkout_settings request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1beta::UpdateCheckoutSettingsRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                metadata = @config.rpcs.update_checkout_settings.metadata.to_h
                ...
                header_params = {}
                if request.checkout_settings&.name
                  header_params["checkout_settings.name"] = request.checkout_settings.name
                end
                ...
                @checkout_settings_service_stub.call_rpc :update_checkout_settings, request, options: options do |response, operation|
                  yield response, operation if block_given?
                end
              rescue ::GRPC::BadStatus => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #   {::Google::Shopping::Merchant::Accounts::V1beta::DeleteCheckoutSettingsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Shopping::Merchant::Accounts::V1beta::DeleteCheckoutSettingsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def delete_checkout_settings request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Shopping::Merchant::Accounts::V1beta::DeleteCheckoutSettingsRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                metadata = @config.rpcs.delete_checkout_settings.metadata.to_h
                ...
                @checkout_settings_service_stub.call_rpc :delete_checkout_settings, request, options: options do |response, operation|
                  yield response, operation if block_given?
                end
              rescue ::GRPC::BadStatus => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              ##
              # Configuration class for the CheckoutSettingsService API.
              #
              # This class represents the configuration for CheckoutSettingsService,
              # providing control over timeouts, retry behavior, logging, transport
              # parameters, and other low-level controls. Certain parameters can also be
              # applied individually to specific RPCs. See
              # {::Google::Shopping::Merchant::Accounts::V1beta::CheckoutSettingsService::Client::Configuration::Rpcs}
