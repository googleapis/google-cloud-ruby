    ...
    module Merchant
      module Accounts
        module V1beta
          ...
          CreateOnlineReturnPolicyRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1beta.CreateOnlineReturnPolicyRequest").msgclass
          UpdateOnlineReturnPolicyRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1beta.UpdateOnlineReturnPolicyRequest").msgclass
          DeleteOnlineReturnPolicyRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1beta.DeleteOnlineReturnPolicyRequest").msgclass
          ...
          OnlineReturnPolicy::ReturnLabelSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy.ReturnLabelSource").enummodule
        end
      end
    end
  end
