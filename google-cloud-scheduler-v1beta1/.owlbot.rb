...
OwlBot.modifier path: "proto_docs/google/cloud/scheduler/v1beta1/job.rb" do |content|
  content.gsub "{::Google::Cloud::Location::Locations::Client#list_locations ListLocations}",
