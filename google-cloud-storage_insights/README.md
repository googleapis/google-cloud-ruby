...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-storage_insights/latest)
for this library, google-cloud-storage_insights, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-storage_insights-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-storage_insights-v1/latest).
...
```
$ gem install google-cloud-storage_insights
```
