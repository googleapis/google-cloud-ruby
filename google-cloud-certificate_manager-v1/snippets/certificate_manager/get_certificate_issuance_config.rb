...
##
# Snippet for the get_certificate_issuance_config call in the CertificateManager service
#
...
# Google::Cloud::CertificateManager::V1::CertificateManager::Client#get_certificate_issuance_config.
#
