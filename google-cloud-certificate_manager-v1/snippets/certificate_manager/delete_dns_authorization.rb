...
##
# Snippet for the delete_dns_authorization call in the CertificateManager service
#
...
# Google::Cloud::CertificateManager::V1::CertificateManager::Client#delete_dns_authorization.
#
