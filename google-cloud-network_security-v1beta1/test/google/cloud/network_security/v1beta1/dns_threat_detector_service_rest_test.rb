...
class ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetectorService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_dns_threat_detectors
    # Create test objects.
    client_result = ::Google::Cloud::NetworkSecurity::V1beta1::ListDnsThreatDetectorsResponse.new
    ...
    list_dns_threat_detectors_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetectorService::Rest::ServiceStub.stub :transcode_list_dns_threat_detectors_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_dns_threat_detectors_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_dns_threat_detectors_client_stub.call_count
      end
    end
  end
  ...
  def test_get_dns_threat_detector
    # Create test objects.
    client_result = ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetector.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_dns_threat_detector_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetectorService::Rest::ServiceStub.stub :transcode_get_dns_threat_detector_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_dns_threat_detector_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_dns_threat_detector_client_stub.call_count
      end
    end
  end
  ...
  def test_create_dns_threat_detector
    ...
    create_dns_threat_detector_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetectorService::Rest::ServiceStub.stub :transcode_create_dns_threat_detector_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_dns_threat_detector_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_dns_threat_detector_client_stub.call_count
      end
    end
  end
  ...
  def test_update_dns_threat_detector
    ...
    update_dns_threat_detector_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetectorService::Rest::ServiceStub.stub :transcode_update_dns_threat_detector_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_dns_threat_detector_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_dns_threat_detector_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_dns_threat_detector
    ...
    delete_dns_threat_detector_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetectorService::Rest::ServiceStub.stub :transcode_delete_dns_threat_detector_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_dns_threat_detector_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_dns_threat_detector_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::NetworkSecurity::V1beta1::DnsThreatDetectorService::Rest::Client::Configuration, config
  end
end
