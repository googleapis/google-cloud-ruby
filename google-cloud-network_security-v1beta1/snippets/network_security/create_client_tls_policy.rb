...
##
# Snippet for the create_client_tls_policy call in the NetworkSecurity service
#
...
# Google::Cloud::NetworkSecurity::V1beta1::NetworkSecurity::Client#create_client_tls_policy.
#
