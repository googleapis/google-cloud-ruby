...
##
# Snippet for the get_server_tls_policy call in the NetworkSecurity service
#
...
# Google::Cloud::NetworkSecurity::V1beta1::NetworkSecurity::Client#get_server_tls_policy.
#
