...
##
# Snippet for the update_server_tls_policy call in the NetworkSecurity service
#
...
# Google::Cloud::NetworkSecurity::V1beta1::NetworkSecurity::Client#update_server_tls_policy.
#
