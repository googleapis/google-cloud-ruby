...
class ::Google::Cloud::ResourceManager::V3::TagBindings::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_tag_bindings
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::ResourceManager::V3::ListTagBindingsResponse.new
    ...
    list_tag_bindings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_tag_bindings, name
      assert_kind_of ::Google::Cloud::ResourceManager::V3::ListTagBindingsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_tag_bindings_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_tag_bindings_client_stub.call_rpc_count
    end
  end

  def test_create_tag_binding
    # Create GRPC objects.
    ...
    create_tag_binding_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_tag_binding, name
      assert_kind_of ::Google::Cloud::ResourceManager::V3::CreateTagBindingRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::ResourceManager::V3::TagBinding), request["tag_binding"]
    ...
    Gapic::ServiceStub.stub :new, create_tag_binding_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_tag_binding_client_stub.call_rpc_count
    end
  end

  def test_delete_tag_binding
    # Create GRPC objects.
    grpc_response = ::Google::Longrunning::Operation.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    delete_tag_binding_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_tag_binding, name
      assert_kind_of ::Google::Cloud::ResourceManager::V3::DeleteTagBindingRequest, request
    ...
    Gapic::ServiceStub.stub :new, delete_tag_binding_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_tag_binding_client_stub.call_rpc_count
    end
  end

  def test_list_effective_tags
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::ResourceManager::V3::ListEffectiveTagsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_effective_tags_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_effective_tags, name
      assert_kind_of ::Google::Cloud::ResourceManager::V3::ListEffectiveTagsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, list_effective_tags_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_effective_tags_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ResourceManager::V3::TagBindings::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::ResourceManager::V3::TagBindings::Operations, client.operations_client
  end
end
