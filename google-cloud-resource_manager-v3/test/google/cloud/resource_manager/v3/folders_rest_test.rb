...
class ::Google::Cloud::ResourceManager::V3::Folders::Rest::ClientTest < Minitest::Test
  ...
  def test_get_folder
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_get_folder_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_folder_client_stub do
        # Create client
        c = ::Google::Cloud::ResourceManager::V3::Folders::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.get_folder ::Google::Cloud::ResourceManager::V3::GetFolderRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.get_folder(::Google::Cloud::ResourceManager::V3::GetFolderRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_folders
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_list_folders_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_folders_client_stub do
        ...
        # Use hash object
        c.list_folders({ parent: parent, page_size: page_size, page_token: page_token, show_deleted: show_deleted }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.list_folders ::Google::Cloud::ResourceManager::V3::ListFoldersRequest.new(parent: parent, page_size: page_size, page_token: page_token, show_deleted: show_deleted) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.list_folders({ parent: parent, page_size: page_size, page_token: page_token, show_deleted: show_deleted }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.list_folders(::Google::Cloud::ResourceManager::V3::ListFoldersRequest.new(parent: parent, page_size: page_size, page_token: page_token, show_deleted: show_deleted), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_search_folders
    ...
    search_folders_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_search_folders_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_folders_client_stub do
        ...
        # Use hash object
        c.search_folders({ page_size: page_size, page_token: page_token, query: query }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.search_folders ::Google::Cloud::ResourceManager::V3::SearchFoldersRequest.new(page_size: page_size, page_token: page_token, query: query) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.search_folders({ page_size: page_size, page_token: page_token, query: query }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.search_folders(::Google::Cloud::ResourceManager::V3::SearchFoldersRequest.new(page_size: page_size, page_token: page_token, query: query), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_folder
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_create_folder_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_folder_client_stub do
        ...
        # Use hash object
        c.create_folder({ folder: folder }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.create_folder ::Google::Cloud::ResourceManager::V3::CreateFolderRequest.new(folder: folder) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.create_folder({ folder: folder }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.create_folder(::Google::Cloud::ResourceManager::V3::CreateFolderRequest.new(folder: folder), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_folder
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_update_folder_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_folder_client_stub do
        ...
        # Use hash object
        c.update_folder({ folder: folder, update_mask: update_mask }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.update_folder ::Google::Cloud::ResourceManager::V3::UpdateFolderRequest.new(folder: folder, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.update_folder({ folder: folder, update_mask: update_mask }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.update_folder(::Google::Cloud::ResourceManager::V3::UpdateFolderRequest.new(folder: folder, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_move_folder
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_move_folder_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, move_folder_client_stub do
        ...
        # Use hash object
        c.move_folder({ name: name, destination_parent: destination_parent }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.move_folder ::Google::Cloud::ResourceManager::V3::MoveFolderRequest.new(name: name, destination_parent: destination_parent) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.move_folder({ name: name, destination_parent: destination_parent }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.move_folder(::Google::Cloud::ResourceManager::V3::MoveFolderRequest.new(name: name, destination_parent: destination_parent), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_folder
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_delete_folder_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_folder_client_stub do
        ...
        # Use protobuf object
        c.delete_folder ::Google::Cloud::ResourceManager::V3::DeleteFolderRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_folder(::Google::Cloud::ResourceManager::V3::DeleteFolderRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_undelete_folder
    ...
    undelete_folder_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Folders::Rest::ServiceStub.stub :transcode_undelete_folder_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, undelete_folder_client_stub do
        ...
        # Use hash object
        c.undelete_folder({ name: name }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.undelete_folder ::Google::Cloud::ResourceManager::V3::UndeleteFolderRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.undelete_folder({ name: name }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.undelete_folder(::Google::Cloud::ResourceManager::V3::UndeleteFolderRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
