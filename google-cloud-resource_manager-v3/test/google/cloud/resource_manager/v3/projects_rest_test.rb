...
class ::Google::Cloud::ResourceManager::V3::Projects::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_project
    # Create test objects.
    client_result = ::Google::Cloud::ResourceManager::V3::Project.new
    ...
    get_project_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_get_project_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_project_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_project_client_stub.call_count
      end
    end
  end
  ...
  def test_list_projects
    # Create test objects.
    client_result = ::Google::Cloud::ResourceManager::V3::ListProjectsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_projects_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_list_projects_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_projects_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_projects_client_stub.call_count
      end
    end
  end
  ...
  def test_search_projects
    # Create test objects.
    client_result = ::Google::Cloud::ResourceManager::V3::SearchProjectsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    search_projects_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_search_projects_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_projects_client_stub do
        ...
        # Verify method calls
        assert_equal 5, search_projects_client_stub.call_count
      end
    end
  end
  ...
  def test_create_project
    ...
    create_project_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_create_project_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_project_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_project_client_stub.call_count
      end
    end
  end
  ...
  def test_update_project
    ...
    update_project_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_update_project_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_project_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_project_client_stub.call_count
      end
    end
  end
  ...
  def test_move_project
    ...
    move_project_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_move_project_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, move_project_client_stub do
        ...
        # Verify method calls
        assert_equal 5, move_project_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_project
    ...
    delete_project_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_delete_project_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_project_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_project_client_stub.call_count
      end
    end
  end
  ...
  def test_undelete_project
    ...
    undelete_project_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::ResourceManager::V3::Projects::Rest::ServiceStub.stub :transcode_undelete_project_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, undelete_project_client_stub do
        ...
        # Verify method calls
        assert_equal 5, undelete_project_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ResourceManager::V3::Projects::Rest::Client::Configuration, config
  end
end
