...
class ::Google::Cloud::ResourceManager::V3::Organizations::ClientTest < Minitest::Test
  ...
  def test_get_organization
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::ResourceManager::V3::Organization.new
    ...
    get_organization_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::ResourceManager::V3::GetOrganizationRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_organization_client_stub do
      # Create client
      c = ::Google::Cloud::ResourceManager::V3::Organizations::Client.new do |config|
      ...
      # Use protobuf object
      c.get_organization ::Google::Cloud::ResourceManager::V3::GetOrganizationRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.get_organization(::Google::Cloud::ResourceManager::V3::GetOrganizationRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_search_organizations
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::ResourceManager::V3::SearchOrganizationsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    search_organizations_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :search_organizations, name
      assert_kind_of ::Google::Cloud::ResourceManager::V3::SearchOrganizationsRequest, request
    ...
    Gapic::ServiceStub.stub :new, search_organizations_client_stub do
      # Create client
      c = ::Google::Cloud::ResourceManager::V3::Organizations::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      c.search_organizations({ page_size: page_size, page_token: page_token, query: query }) do |response, operation|
      ...
      # Use protobuf object
      c.search_organizations ::Google::Cloud::ResourceManager::V3::SearchOrganizationsRequest.new(page_size: page_size, page_token: page_token, query: query) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      c.search_organizations({ page_size: page_size, page_token: page_token, query: query }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.search_organizations(::Google::Cloud::ResourceManager::V3::SearchOrganizationsRequest.new(page_size: page_size, page_token: page_token, query: query), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Verify method calls
      assert_equal 5, search_organizations_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ResourceManager::V3::Organizations::Client::Configuration, config
  end
