...
class ::Google::Cloud::Maintenance::Api::V1beta::Maintenance::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_summarize_maintenances
    # Create test objects.
    client_result = ::Google::Cloud::Maintenance::Api::V1beta::SummarizeMaintenancesResponse.new
    ...
    summarize_maintenances_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Maintenance::Api::V1beta::Maintenance::Rest::ServiceStub.stub :transcode_summarize_maintenances_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, summarize_maintenances_client_stub do
        ...
        # Verify method calls
        assert_equal 5, summarize_maintenances_client_stub.call_count
      end
    end
  end
  ...
  def test_list_resource_maintenances
    # Create test objects.
    client_result = ::Google::Cloud::Maintenance::Api::V1beta::ListResourceMaintenancesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_resource_maintenances_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Maintenance::Api::V1beta::Maintenance::Rest::ServiceStub.stub :transcode_list_resource_maintenances_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_resource_maintenances_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_resource_maintenances_client_stub.call_count
      end
    end
  end
  ...
  def test_get_resource_maintenance
    # Create test objects.
    client_result = ::Google::Cloud::Maintenance::Api::V1beta::ResourceMaintenance.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_resource_maintenance_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Maintenance::Api::V1beta::Maintenance::Rest::ServiceStub.stub :transcode_get_resource_maintenance_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_resource_maintenance_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_resource_maintenance_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Maintenance::Api::V1beta::Maintenance::Rest::Client::Configuration, config
  end
end
