...
describe Google::Cloud::Firestore::Collection, :query, :using_transaction, :mock_firestore do
  ...
  def assert_results_enum enum
    ...
    results.each do |result|
      ...
      result.ref.context.must_equal transaction
      result.parent.context.must_equal transaction
    end
