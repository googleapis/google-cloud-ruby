...
describe Google::Cloud::Firestore::Collection, :docs, :using_transaction, :mock_firestore do
  ...
  it "gets docs" do
    ...
    firestore_mock.expect :run_query, query_docs_enum, ["projects/#{project}/databases/(default)/documents/users/mike", structured_query: expected_query, transaction: transaction_id, options: default_options]
