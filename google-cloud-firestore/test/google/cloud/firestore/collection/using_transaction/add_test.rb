...
describe Google::Cloud::Firestore::Collection, :add, :using_transaction, :mock_firestore do
  ...
  it "creates a Document reference with a random id" do
    ...
    firestore_mock.expect :commit, commit_resp, [database_path, commit_writes, transaction: transaction_id, options: default_options]

    Google::Cloud::Firestore::Generate.stub :unique_id, random_document_id do
      collection.context.must_equal transaction
