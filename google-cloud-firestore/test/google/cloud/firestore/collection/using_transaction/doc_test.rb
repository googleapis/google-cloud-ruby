...
describe Google::Cloud::Firestore::Collection, :doc, :using_transaction, :mock_firestore do
  ...
  it "produces a Document reference for a document_id" do
    ...
    document.context.must_equal transaction
    document.parent.context.must_equal transaction
  end
