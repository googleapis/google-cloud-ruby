...
describe Google::Cloud::Firestore::Collection, :add, :closed_transaction, :mock_firestore do
  let(:transaction) do
  ...
  let(:collection) { Google::Cloud::Firestore::Collection.from_path "#{documents_path}/#{collection_path}", transaction }
