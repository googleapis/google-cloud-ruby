...
describe Google::Cloud::Firestore::Collection, :add, :closed_read_transaction, :mock_firestore do
  ...
  let(:collection) { Google::Cloud::Firestore::Collection.from_path "#{documents_path}/#{collection_path}", read_transaction }
