...
describe Google::Cloud::Firestore::Collection, :docs, :empty_read_transaction, :without_read_time, :mock_firestore do
  ...
  it "gets docs" do
    ...
    firestore_mock.expect :run_query, query_docs_enum, ["projects/#{project}/databases/(default)/documents/users/mike", structured_query: expected_query, new_transaction: transaction_opt, options: default_options]
