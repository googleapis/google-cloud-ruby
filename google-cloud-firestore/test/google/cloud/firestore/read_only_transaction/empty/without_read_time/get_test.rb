...
describe Google::Cloud::Firestore::ReadOnlyTransaction, :get, :empty, :without_read_time, :mock_firestore do
  ...
  it "gets a collection (ref)" do
    ...
    col = firestore.col :users
    results_enum = read_transaction.get col
  ...
  it "gets a collection (string)" do
    ...
    results_enum = read_transaction.get "users"
  ...
  it "gets a simple query" do
    ...
    results_enum = read_transaction.get query
