...
describe Google::Cloud::Firestore::ReadOnlyTransaction, :docs, :closed, :mock_firestore do
  ...
  it "raises when calling docs directly" do
    error = expect do
      read_transaction.docs :users
    end.must_raise RuntimeError
    error.message.must_equal "transaction is closed"
  end

  it "gets docs using a chained collection object" do
    ...
    docs_enum = read_transaction.col(:users).docs
