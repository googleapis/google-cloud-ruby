...
describe Google::Cloud::Firestore::Query, :mock_firestore do
  let(:query) { Google::Cloud::Firestore::Query.start "#{firestore.path}/documents", firestore }
  ...
  it "runs a query with a single select" do
    ...
    results_enum = query.select(:name).run
  ...
  it "runs a query with multiple select values" do
    ...
    results_enum = query.select(:name, "status", :activity).run
  ...
  it "runs a query with multiple select calls" do
    ...
    results_enum = query.select(:name).select("status").select(:activity).run
  ...
  it "runs a query with from" do
    ...
    results_enum = query.from(:users).run
  ...
  it "runs a query with from with all_descendants" do
    ...
    results_enum = query.from(:users).all_descendants.run
  ...
  it "runs a query with from with direct_descendants" do
    ...
    results_enum = query.from(:users).direct_descendants.run
  ...
  it "runs a query with offset and limit" do
    ...
    results_enum = query.offset(3).limit(42).run
  ...
  it "runs a query with a single order" do
    ...
    results_enum = query.order(:name).run
  ...
  it "runs a query with a multiple order calls" do
    ...
    results_enum = query.order(:name).order(:__name__, :desc).run
  ...
  it "runs a query with start_after and end_before" do
    ...
    results_enum = query.start_after(:foo).end_before(:bar).run
  ...
  it "runs a query with multiple start_after and end_before" do
    ...
    results_enum = query.start_after(:foo, :bar).end_before(:baz, :bif).run
  ...
  it "runs a query with start_at and end_at" do
    ...
    results_enum = query.start_at(:foo).end_at(:bar).run
  ...
  it "runs a query with multiple start_at and end_at" do
    ...
    results_enum = query.start_at(:foo, :bar).end_at(:baz, :bif).run
  ...
  it "runs a simple query" do
    ...
    results_enum = query.select(:name).from(:users).run
  ...
  it "runs a complex query" do
    ...
    results_enum = query.select(:name).from(:users).offset(3).limit(42).order(:name).order(:__name__, :desc).start_after(:foo).end_before(:bar).run
