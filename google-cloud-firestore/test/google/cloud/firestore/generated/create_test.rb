...
describe "Cross-Language Create Tests", :mock_firestore do
  ...
  it "basic" do
    ...
    firestore.create document_path, create_data
  end
  ...
  describe :SERVER_TIME do
    ...
    it "multiple SERVER_TIME fields" do
      create_data = { a: 1, b: :SERVER_TIME, c: { d: :SERVER_TIME } }
    ...
    it "nested SERVER_TIME field" do
      create_data = { a: 1, b: { c: :SERVER_TIME } }
