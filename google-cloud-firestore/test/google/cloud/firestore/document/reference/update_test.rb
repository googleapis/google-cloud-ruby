...
describe Google::Cloud::Firestore::Document::Reference, :update, :mock_firestore do
  let(:document_path) { "users/mike" }
  let(:document) { Google::Cloud::Firestore::Document.from_path "#{documents_path}/#{document_path}", firestore }
