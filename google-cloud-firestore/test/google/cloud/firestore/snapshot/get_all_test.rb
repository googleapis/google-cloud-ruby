...
describe Google::Cloud::Firestore::Snapshot, :get_all, :mock_firestore do
  ...
  it "gets multiple docs using splat (string)" do
    firestore_mock.expect :batch_get_documents, batch_docs_enum, [database_path, full_doc_paths, mask: name_mask, transaction: transaction_id, options: default_options]
