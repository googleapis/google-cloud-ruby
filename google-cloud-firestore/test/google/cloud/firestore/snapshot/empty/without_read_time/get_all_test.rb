...
describe Google::Cloud::Firestore::Snapshot, :get_all, :empty, :without_read_time, :mock_firestore do
  ...
  it "gets multiple docs using splat (string)" do
    ...
    docs_enum = snapshot.get_all "users/mike", "users/tad", "users/chris"
  ...
  it "gets multiple docs using splat (doc ref)" do
    ...
    docs_enum = snapshot.get_all snapshot.doc("users/mike"), snapshot.doc("users/tad"), snapshot.doc("users/chris")
  ...
  it "gets a single doc (string)" do
    ...
    docs_enum = snapshot.get_all "users/mike"
  ...
  it "gets a single doc (doc ref)" do
    ...
    docs_enum = snapshot.get_all snapshot.doc("users/mike")
  ...
  it "gets multiple docs using splat (string)" do
    ...
    docs_enum = snapshot.get_all "users/mike", "users/tad", "users/chris", mask: :name
  ...
  it "gets multiple docs using splat (doc ref)" do
    ...
    docs_enum = snapshot.get_all snapshot.doc("users/mike"), snapshot.doc("users/tad"), snapshot.doc("users/chris"), mask: :name
