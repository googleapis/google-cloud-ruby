...
describe Google::Cloud::Firestore::Snapshot, :docs, :empty, :without_read_time, :mock_firestore do
  ...
  it "gets docs with string using documents alias" do
    ...
    docs_enum = snapshot.documents "users"
