...
describe Google::Cloud::Firestore::Database, :read_only_transaction, :mock_firestore do
  ...
  it "runs a simple query" do
    ...
    firestore.read_only_transaction do |s|
  ...
  describe "with read_time" do
    it "runs a simple query" do
      ...
      firestore.read_only_transaction read_time: read_time do |s|
        results_enum = s.select(:name).from(:users).run
        assert_results_enum results_enum
      end
    end
  ...
  describe "read_transaction alias" do
    it "runs a simple query" do
      expected_query = Google::Firestore::V1beta1::StructuredQuery.new(
        select: Google::Firestore::V1beta1::StructuredQuery::Projection.new(
          fields: [Google::Firestore::V1beta1::StructuredQuery::FieldReference.new(field_path: "name")]),
      ...
      firestore.read_transaction do |s|
        results_enum = s.select(:name).from(:users).run
        assert_results_enum results_enum
      end
    end
    ...
    describe "with read_time" do
      it "runs a simple query" do
        ...
        firestore.read_transaction read_time: read_time do |s|
          results_enum = s.select(:name).from(:users).run
          assert_results_enum results_enum
        end
      end
  ...
  def assert_results_enum enum
    ...
    results.each do |result|
      ...
      result.ref.context.must_be_kind_of Google::Cloud::Firestore::ReadOnlyTransaction
      result.parent.context.must_be_kind_of Google::Cloud::Firestore::ReadOnlyTransaction
    end
