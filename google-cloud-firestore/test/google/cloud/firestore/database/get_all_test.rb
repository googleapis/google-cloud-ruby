...
describe Google::Cloud::Firestore::Database, :get_all, :mock_firestore do
  ...
  it "gets multiple docs using splat (string)" do
    ...
    docs_enum = firestore.get_all "users/mike", "users/tad", "users/chris", mask: :name
  ...
  it "gets multiple docs using splat (doc ref)" do
    ...
    docs_enum = firestore.get_all firestore.doc("users/mike"), firestore.doc("users/tad"), firestore.doc("users/chris"), mask: :name
