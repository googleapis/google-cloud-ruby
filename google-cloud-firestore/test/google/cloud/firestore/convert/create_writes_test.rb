...
describe Google::Cloud::Firestore::Convert, :create_writes do
  ...
  it "basic create" do
    ...
    actual_writes = Google::Cloud::Firestore::Convert.create_writes document_path, data
  ...
  describe :DELETE do
    it "DELETE cannot appear in data" do
      ...
      error = expect do
        Google::Cloud::Firestore::Convert.create_writes document_path, data
  ...
  describe :SERVER_TIME do
    ...
    it "multiple SERVER_TIME fields" do
      data = { a: 1, b: :SERVER_TIME, c: { d: :SERVER_TIME } }
