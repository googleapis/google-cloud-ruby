...
describe Google::Cloud::Firestore::Convert, :delete_write do
  ...
  it "delete with exists precondition" do
    ...
    actual_write = Google::Cloud::Firestore::Convert.delete_write document_path, exists: true
  ...
  it "delete without precondition" do
    ...
    actual_write = Google::Cloud::Firestore::Convert.delete_write document_path
  ...
  it "delete with last-update-time precondition" do
    ...
    actual_write = Google::Cloud::Firestore::Convert.delete_write document_path, update_time: delete_time
  end
end
