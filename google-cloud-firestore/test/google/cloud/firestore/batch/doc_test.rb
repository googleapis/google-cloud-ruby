...
describe Google::Cloud::Firestore::Batch, :doc, :mock_firestore do
  ...
  it "produces a Document reference for a document_path" do
    ...
    document = batch.doc document_path
    ...
    document.parent.context.must_equal batch
  end
