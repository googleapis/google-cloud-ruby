...
describe Google::Cloud::Firestore::Batch, :merge, :mock_firestore do
  ...
  it "merges a new document given a string path" do
  ...
  it "raises if not given a Hash" do
    error = expect do
      batch.merge document_path, "not a hash"
