...
describe Google::Cloud::Firestore::Client, :get_all, :mock_firestore do
  ...
  it "gets multiple docs using splat (doc ref)" do
    ...
    docs_enum = firestore.get_all firestore.doc("users/alice"), firestore.doc("users/bob"), firestore.doc("users/carol")
  ...
  it "gets a single doc (string)" do
    firestore_mock.expect :batch_get_documents, [batch_docs_enum.to_a.first].to_enum, batch_get_documents_args(documents: [full_doc_paths.first])

    docs_enum = firestore.get_all "users/alice"
  ...
  it "gets a single doc (doc ref)" do
    ...
    docs_enum = firestore.get_all firestore.doc("users/alice")
  ...
  describe :field_mask do
    ...
    it "gets multiple docs using splat (string)" do
      firestore_mock.expect :batch_get_documents, batch_docs_enum, batch_get_documents_args(mask: field_mask)

      docs_enum = firestore.get_all "users/alice", "users/bob", "users/carol", field_mask: [:name]
    ...
    it "gets multiple docs using splat (doc ref)" do
      ...
      docs_enum = firestore.get_all firestore.doc("users/alice"), firestore.doc("users/bob"), firestore.doc("users/carol"), field_mask: ["name"]
    ...
    it "gets a single doc (string)" do
      firestore_mock.expect :batch_get_documents, [batch_docs_enum.to_a.first].to_enum, batch_get_documents_args(documents: [full_doc_paths.first], mask: field_mask)

      docs_enum = firestore.get_all "users/alice", field_mask: firestore.field_path(:name)
    ...
    it "gets a single doc (doc ref)" do
      ...
      docs_enum = firestore.get_all firestore.doc("users/alice"), field_mask: [firestore.field_path(:name)]
