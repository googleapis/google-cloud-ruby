...
describe Google::Cloud::Firestore::Transaction, :get_all, :empty, :mock_firestore do
  ...
  it "gets multiple docs using splat (string)" do
    firestore_mock.expect :batch_get_documents, transaction_docs_enum, [database_path, full_doc_paths, mask: name_mask, new_transaction: transaction_opt, options: default_options]
