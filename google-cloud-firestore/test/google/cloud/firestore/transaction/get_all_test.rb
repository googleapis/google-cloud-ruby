...
describe Google::Cloud::Firestore::Transaction, :get_all, :mock_firestore do
  ...
  it "gets multiple docs using splat (string)" do
    firestore_mock.expect :batch_get_documents, transaction_docs_enum, [database_path, full_doc_paths, mask: nil, transaction: transaction_id, options: default_options]
  ...
  it "gets multiple docs using splat (doc ref)" do
    ...
    docs_enum = transaction.get_all transaction.doc("users/mike"), transaction.doc("users/tad"), transaction.doc("users/chris")
  ...
  it "gets a single doc (string)" do
    firestore_mock.expect :batch_get_documents, [transaction_docs_enum.to_a.first].to_enum, [database_path, [full_doc_paths.first], mask: nil, transaction: transaction_id, options: default_options]
  ...
  it "gets a single doc (doc ref)" do
    ...
    docs_enum = transaction.get_all transaction.doc("users/mike")
  ...
  it "gets multiple docs using splat (string)" do
    firestore_mock.expect :batch_get_documents, transaction_docs_enum, [database_path, full_doc_paths, mask: name_mask, transaction: transaction_id, options: default_options]

    docs_enum = transaction.get_all "users/mike", "users/tad", "users/chris", mask: :name
  ...
  it "gets multiple docs using splat (doc ref)" do
    ...
    docs_enum = transaction.get_all transaction.doc("users/mike"), transaction.doc("users/tad"), transaction.doc("users/chris"), mask: :name
