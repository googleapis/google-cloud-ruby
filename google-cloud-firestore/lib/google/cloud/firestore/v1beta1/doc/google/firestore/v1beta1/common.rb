...
module Google
  module Firestore
    module V1beta1
      ...
      # {Google::Firestore::V1beta1::Document Document}, and takes in account the
      # dynamic nature of {Google::Firestore::V1beta1::Value Value}.
      # @!attribute [rw] field_paths
      #   @return [Array<String>]
      #     The list of field paths in the mask. See
      #     {Google::Firestore::V1beta1::Document#fields Document#fields} for a field
