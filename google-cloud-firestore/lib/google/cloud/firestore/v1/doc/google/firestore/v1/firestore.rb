...
module Google
  module Firestore
    module V1
      # The request for
      # {Google::Firestore::V1::Firestore::GetDocument Firestore::GetDocument}.
      # @!attribute [rw] name
      #   @return [String]
      ...
      # The request for
      # {Google::Firestore::V1::Firestore::ListDocuments Firestore::ListDocuments}.
      # @!attribute [rw] parent
      #   @return [String]
      ...
      #     {Google::Firestore::V1::Document#create_time Document#create_time}, or
      #     {Google::Firestore::V1::Document#update_time Document#update_time} set.
      #
      ...
      # The request for
      # {Google::Firestore::V1::Firestore::CreateDocument Firestore::CreateDocument}.
      # @!attribute [rw] parent
      #   @return [String]
      ...
      # The request for
      # {Google::Firestore::V1::Firestore::UpdateDocument Firestore::UpdateDocument}.
      # @!attribute [rw] document
      #   @return [Google::Firestore::V1::Document]
      ...
      # The request for
      # {Google::Firestore::V1::Firestore::DeleteDocument Firestore::DeleteDocument}.
      # @!attribute [rw] name
      #   @return [String]
      ...
      # The request for
      # {Google::Firestore::V1::Firestore::BatchGetDocuments Firestore::BatchGetDocuments}.
      ...
      #     {Google::Firestore::V1::BatchGetDocumentsRequest#new_transaction BatchGetDocumentsRequest#new_transaction}
      ...
      # The request for
      # {Google::Firestore::V1::Firestore::BeginTransaction Firestore::BeginTransaction}.
      # @!attribute [rw] database
      #   @return [String]
      #     The database name. In the format:
      #     `projects/{project_id}/databases/{database_id}`.
      ...
      # The response for
      # {Google::Firestore::V1::Firestore::RunQuery Firestore::RunQuery}.
      # @!attribute [rw] transaction
      #   @return [String]
      #     The transaction that was started as part of this request.
      #     Can only be set in the first response, and only if
      #     {Google::Firestore::V1::RunQueryRequest#new_transaction RunQueryRequest#new_transaction}
      ...
      #     {Google::Firestore::V1::WriteResponse WriteResponse} it has received. This
      ...
      #     A {Google::Firestore::V1::Document Document} has been removed from a target
      ...
      #     {Google::Firestore::V1::TargetChange TargetChange} for an identical target.
      #
      ...
      # The request for
      # {Google::Firestore::V1::Firestore::ListCollectionIds Firestore::ListCollectionIds}.
      # @!attribute [rw] parent
      #   @return [String]
