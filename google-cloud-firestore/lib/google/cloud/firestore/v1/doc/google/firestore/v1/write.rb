  ...
  module Firestore
    module V1
      ...
      class DocumentTransform
        ...
        #     {Google::Firestore::V1::Document#fields Document#fields} for the field path
        #     syntax reference.
      ...
      #     {Google::Firestore::V1::DocumentTransform::FieldTransform DocumentTransform::FieldTransform},
      #     in the same order.
      class WriteResult; end

      # A {Google::Firestore::V1::Document Document} has changed.
      #
      # May be the result of multiple {Google::Firestore::V1::Write writes}, including
      # deletes, that ultimately resulted in a new value for the
      # {Google::Firestore::V1::Document Document}.
      #
      # Multiple {Google::Firestore::V1::DocumentChange DocumentChange} messages may be
      ...
      # {Google::Firestore::V1::Document Document}.
      #
      # Multiple {Google::Firestore::V1::DocumentDelete DocumentDelete} messages may be
      # returned for the same logical delete, if multiple targets are affected.
      # @!attribute [rw] document
      #   @return [String]
      #     The resource name of the {Google::Firestore::V1::Document Document} that was
      #     deleted.
      # @!attribute [rw] removed_target_ids
      #   @return [Array<Integer>]
      ...
      # A {Google::Firestore::V1::Document Document} has been removed from the view of
      # the targets.
      #
      ...
      #
      # Multiple {Google::Firestore::V1::DocumentRemove DocumentRemove} messages may be
      # returned for the same logical write or delete, if multiple targets are
      # affected.
      # @!attribute [rw] document
      #   @return [String]
      #     The resource name of the {Google::Firestore::V1::Document Document} that has
      #     gone out of view.
      # @!attribute [rw] removed_target_ids
      #   @return [Array<Integer>]
      ...
      #     {Google::Firestore::V1::ExistenceFilter#target_id target_id}.
      #
