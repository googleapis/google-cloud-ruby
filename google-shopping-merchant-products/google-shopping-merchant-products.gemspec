...
require File.expand_path("lib/google/shopping/merchant/products/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-shopping-merchant-products"
  gem.version       = Google::Shopping::Merchant::Products::VERSION
  ...
  gem.add_dependency "google-shopping-merchant-products-v1beta", ">= 0.0", "< 2.a"
end
