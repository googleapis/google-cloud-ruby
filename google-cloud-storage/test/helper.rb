...
class MockStorage < Minitest::Spec
  ...
  def compose_object_args bucket_name,
                          ...
                          user_project: nil,
                          options: {}
    req = compose_request source_files, destination_gapi, sources_if_generation_match
    opts = {
      destination_predefined_acl: destination_predefined_acl,
      if_generation_match: if_generation_match,
      if_metageneration_match: if_metageneration_match,
  ...
  def compose_request source_files, destination_gapi, sources_if_generation_match
    ...
    if sources_if_generation_match
