...
describe Google::Cloud::Storage::File, :update, :lazy, :mock_storage do
  ...
  it "updates its cache control" do
    ...
    mock.expect :patch_object, Google::Apis::StorageV1::Object.from_json(random_file_hash(bucket_name, file_name).to_json),
      [bucket_name, file_name, patch_file_gapi], **patch_object_args
  ...
  it "updates its storage_class" do
    ...
    mock.expect :rewrite_object, done_rewrite(patched_file_gapi),
      [bucket_name, file_name, bucket_name, file_name, patch_file_gapi], **rewrite_object_args
  ...
  it "updates its storage_class with user_project set to true" do
    ...
    patched_file_gapi.storage_class = "DURABLE_REDUCED_AVAILABILITY"
    mock.expect :rewrite_object, done_rewrite(patched_file_gapi),
      [bucket_name, file_name, bucket_name, file_user_project.name, patch_file_gapi], **rewrite_object_args(user_project: "test")
  ...
  it "updates its storage_class, calling rewrite_object as many times as is needed" do
    ...
    mock.expect :rewrite_object, undone_rewrite("keeptrying"),
      [bucket_name, file_name, bucket_name, file_name, patch_file_gapi], **rewrite_object_args(rewrite_token: "notyetcomplete")
    mock.expect :rewrite_object, undone_rewrite("almostthere"),
      [bucket_name, file_name, bucket_name, file_name, patch_file_gapi], **rewrite_object_args(rewrite_token: "keeptrying")
    mock.expect :rewrite_object, done_rewrite(patched_file_gapi),
      [bucket_name, file_name, bucket_name, file_name, patch_file_gapi], **rewrite_object_args(rewrite_token: "almostthere")
  ...
  it "updates its storage_class, calling rewrite_object as many times as is needed with user_project set to true" do
    ...
    patched_file_gapi.storage_class = "DURABLE_REDUCED_AVAILABILITY"
    mock.expect :rewrite_object, undone_rewrite("notyetcomplete"),
      [bucket_name, file_user_project.name, bucket_name, file_user_project.name, patch_file_gapi], **rewrite_object_args(user_project: "test")
    mock.expect :rewrite_object, undone_rewrite("keeptrying"),
      [bucket_name, file_user_project.name, bucket_name, file_user_project.name, patch_file_gapi], **rewrite_object_args(rewrite_token: "notyetcomplete", user_project: "test")
    mock.expect :rewrite_object, undone_rewrite("almostthere"),
      [bucket_name, file_user_project.name, bucket_name, file_user_project.name, patch_file_gapi], **rewrite_object_args(rewrite_token: "keeptrying", user_project: "test")
    mock.expect :rewrite_object, done_rewrite(patched_file_gapi),
      [bucket_name, file_user_project.name, bucket_name, file_user_project.name, patch_file_gapi], **rewrite_object_args(rewrite_token: "almostthere", user_project: "test")
  ...
  it "updates multiple attributes in a block with user_project set to true" do
    ...
    mock.expect :patch_object, Google::Apis::StorageV1::Object.from_json(random_file_hash(bucket_name, file_name).to_json),
      [bucket_name, file_user_project.name, patch_file_gapi], **patch_object_args(user_project: "test")
