...
# Sample for storage_print_bucket_acl_for_user
class StoragePrintBucketACLForUser
...
if $PROGRAM_NAME == __FILE__
  StoragePrintBucketACLForUser.new.print_bucket_acl_for_user bucket_name: arguments.shift,
