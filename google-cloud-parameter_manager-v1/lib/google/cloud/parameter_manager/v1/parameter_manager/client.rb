      ...
      module V1
        module ParameterManager
          ...
          class Client
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::ParameterManager::V1::Template>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::ParameterManager::V1::Template>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def list_templates request, options = nil
              ...
              @parameter_manager_stub.call_rpc :list_templates, request, options: options do |response, operation|
                response = ::Gapic::PagedEnumerable.new @parameter_manager_stub, :list_templates, request, response, operation, options
                yield response, operation if block_given?
                throw :response, response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::ParameterManager::V1::Template]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_template request, options = nil
              ...
              @parameter_manager_stub.call_rpc :get_template, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def create_template request, options = nil
              ...
              @parameter_manager_stub.call_rpc :create_template, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def update_template request, options = nil
              ...
              @parameter_manager_stub.call_rpc :update_template, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def delete_template request, options = nil
              ...
              @parameter_manager_stub.call_rpc :delete_template, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::ParameterManager::V1::TemplateVersion>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::ParameterManager::V1::TemplateVersion>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def list_template_versions request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.list_template_versions.metadata.to_h
              ...
              @parameter_manager_stub.call_rpc :list_template_versions, request, options: options do |response, operation|
                response = ::Gapic::PagedEnumerable.new @parameter_manager_stub, :list_template_versions, request, response, operation, options
                yield response, operation if block_given?
                throw :response, response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::ParameterManager::V1::TemplateVersion]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_template_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.get_template_version.metadata.to_h
              ...
              @parameter_manager_stub.call_rpc :get_template_version, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def create_template_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.create_template_version.metadata.to_h
              ...
              @parameter_manager_stub.call_rpc :create_template_version, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def update_template_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.update_template_version.metadata.to_h
              ...
              header_params = {}
              if request.template_version&.name
                header_params["template_version.name"] = request.template_version.name
              end
              ...
              @parameter_manager_stub.call_rpc :update_template_version, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def delete_template_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.delete_template_version.metadata.to_h
              ...
              @parameter_manager_stub.call_rpc :delete_template_version, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::ParameterManager::V1::RenderTemplateVersionResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def render_template_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.render_template_version.metadata.to_h
              ...
              @parameter_manager_stub.call_rpc :render_template_version, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
