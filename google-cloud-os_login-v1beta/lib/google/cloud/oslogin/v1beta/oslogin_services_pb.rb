      ...
      module V1beta
        module OsLoginService
          ...
          class Service
            ...
            rpc :GetSshPublicKey, Google::Cloud::OsLogin::V1beta::GetSshPublicKeyRequest, Google::Cloud::OsLogin::Common::Google::Cloud::Oslogin::Common::SshPublicKey
            ...
            rpc :UpdateSshPublicKey, Google::Cloud::OsLogin::V1beta::UpdateSshPublicKeyRequest, Google::Cloud::OsLogin::Common::Google::Cloud::Oslogin::Common::SshPublicKey
          end
