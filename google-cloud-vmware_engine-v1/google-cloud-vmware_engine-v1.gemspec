...
Gem::Specification.new do |gem|
  ...
  gem.description   = "The Google VMware Engine API lets you programmatically manage VMware environments. Note that google-cloud-vmware_engine-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-vmware_engine instead. See the readme for more details."
