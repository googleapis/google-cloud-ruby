...
##
# Snippet for the update_vmware_engine_network call in the VmwareEngine service
#
...
# Google::Cloud::VmwareEngine::V1::VmwareEngine::Client#update_vmware_engine_network.
#
