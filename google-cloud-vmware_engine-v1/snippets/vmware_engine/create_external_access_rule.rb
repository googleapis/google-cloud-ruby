...
##
# Snippet for the create_external_access_rule call in the VmwareEngine service
#
...
# Google::Cloud::VmwareEngine::V1::VmwareEngine::Client#create_external_access_rule.
#
