...
##
# Snippet for the fetch_network_policy_external_addresses call in the VmwareEngine service
#
...
# Google::Cloud::VmwareEngine::V1::VmwareEngine::Client#fetch_network_policy_external_addresses.
#
