...
4. [Setup Authentication.](https://googleapis.dev/ruby/google-cloud-secretmanager/latest/file.AUTHENTICATION.html)

### Installation
```
$ gem install google-cloud-secretmanager
```
...
[Client Library Documentation]: https://googleapis.dev/ruby/google-cloud-secretmanager/latest
