  ...
  def test_list_instances
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_list_instances_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_instances_client_stub do
        # Create client
        c = ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.list_instances ::Google::Cloud::Memcache::V1::ListInstancesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.list_instances(::Google::Cloud::Memcache::V1::ListInstancesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_instance
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_get_instance_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_instance_client_stub do
        ...
        # Use protobuf object
        c.get_instance ::Google::Cloud::Memcache::V1::GetInstanceRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_instance(::Google::Cloud::Memcache::V1::GetInstanceRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_instance
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_create_instance_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_instance_client_stub do
        ...
        # Use protobuf object
        c.create_instance ::Google::Cloud::Memcache::V1::CreateInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.create_instance(::Google::Cloud::Memcache::V1::CreateInstanceRequest.new(parent: parent, instance_id: instance_id, instance: instance), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_instance
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_update_instance_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_instance_client_stub do
        ...
        # Use protobuf object
        c.update_instance ::Google::Cloud::Memcache::V1::UpdateInstanceRequest.new(update_mask: update_mask, instance: instance) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_instance(::Google::Cloud::Memcache::V1::UpdateInstanceRequest.new(update_mask: update_mask, instance: instance), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_parameters
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_update_parameters_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_parameters_client_stub do
        ...
        # Use protobuf object
        c.update_parameters ::Google::Cloud::Memcache::V1::UpdateParametersRequest.new(name: name, update_mask: update_mask, parameters: parameters) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_parameters(::Google::Cloud::Memcache::V1::UpdateParametersRequest.new(name: name, update_mask: update_mask, parameters: parameters), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_instance
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_delete_instance_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_instance_client_stub do
        ...
        # Use protobuf object
        c.delete_instance ::Google::Cloud::Memcache::V1::DeleteInstanceRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_instance(::Google::Cloud::Memcache::V1::DeleteInstanceRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_apply_parameters
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_apply_parameters_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, apply_parameters_client_stub do
        ...
        # Use protobuf object
        c.apply_parameters ::Google::Cloud::Memcache::V1::ApplyParametersRequest.new(name: name, node_ids: node_ids, apply_all: apply_all) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.apply_parameters(::Google::Cloud::Memcache::V1::ApplyParametersRequest.new(name: name, node_ids: node_ids, apply_all: apply_all), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_reschedule_maintenance
    ...
    ::Google::Cloud::Memcache::V1::CloudMemcache::Rest::ServiceStub.stub :transcode_reschedule_maintenance_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, reschedule_maintenance_client_stub do
        ...
        # Use protobuf object
        c.reschedule_maintenance ::Google::Cloud::Memcache::V1::RescheduleMaintenanceRequest.new(instance: instance, reschedule_type: reschedule_type, schedule_time: schedule_time) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.reschedule_maintenance(::Google::Cloud::Memcache::V1::RescheduleMaintenanceRequest.new(instance: instance, reschedule_type: reschedule_type, schedule_time: schedule_time), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
