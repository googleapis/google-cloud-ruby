...
class Google::Apps::Meet::ClientConstructionMinitest < Minitest::Test
  ...
  def test_spaces_service_grpc
    skip unless Google::Apps::Meet.spaces_service_available? transport: :grpc
  ...
  def test_spaces_service_rest
    skip unless Google::Apps::Meet.spaces_service_available? transport: :rest
  ...
  def test_conference_records_service_grpc
    skip unless Google::Apps::Meet.conference_records_service_available? transport: :grpc
    Gapic::ServiceStub.stub :new, DummyStub.new do
      grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
  ...
  def test_conference_records_service_rest
    skip unless Google::Apps::Meet.conference_records_service_available? transport: :rest
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
