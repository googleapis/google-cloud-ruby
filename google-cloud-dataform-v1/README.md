# Ruby Client for the Dataform V1 API
...
specific version of the Dataform V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-dataform-v1
```
...
client library with a name such as `google-cloud-dataform`,
...
is part of the name, e.g. `google-cloud-dataform-v1`.
