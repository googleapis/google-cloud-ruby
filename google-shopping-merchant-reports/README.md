...
The gem `google-shopping-merchant-reports` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-reports)
for this library, google-shopping-merchant-reports, to see the convenience methods for
...
```
$ gem install google-shopping-merchant-reports
```
...
is part of the name, e.g. `google-shopping-merchant-reports-v1beta`.
