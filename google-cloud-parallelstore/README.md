...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-parallelstore/latest)
for this library, google-cloud-parallelstore, to see the convenience methods for
...
```
$ gem install google-cloud-parallelstore
```
...
is part of the name, e.g. `google-cloud-parallelstore-v1beta`.
