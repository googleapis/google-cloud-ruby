    ...
    module MediaTranslation
      module V1beta1
        module SpeechTranslationService
          ...
          class Client
            # @private
            DEFAULT_ENDPOINT_TEMPLATE = "mediatranslation.$UNIVERSE_DOMAIN$"

            # @private
            attr_reader :speech_translation_service_stub
            ...
            #
            def universe_domain
              @speech_translation_service_stub.universe_domain
            end
            ...
            def initialize
              ...
              @speech_translation_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::MediaTranslation::V1beta1::SpeechTranslationService::Stub,
            ...
            #
            # @param request [::Gapic::StreamInput, ::Enumerable<::Google::Cloud::MediaTranslation::V1beta1::StreamingTranslateSpeechRequest, ::Hash>]
            #   An enumerable of {::Google::Cloud::MediaTranslation::V1beta1::StreamingTranslateSpeechRequest} instances.
            # @param options [::Gapic::CallOptions, ::Hash]
            #   Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Enumerable<::Google::Cloud::MediaTranslation::V1beta1::StreamingTranslateSpeechResponse>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Enumerable<::Google::Cloud::MediaTranslation::V1beta1::StreamingTranslateSpeechResponse>]
            #
            ...
            def streaming_translate_speech request, options = nil
              ...
              request = request.lazy.map do |req|
                ::Gapic::Protobuf.coerce req, to: ::Google::Cloud::MediaTranslation::V1beta1::StreamingTranslateSpeechRequest
              end
              ...
              metadata = @config.rpcs.streaming_translate_speech.metadata.to_h

              # Set x-goog-api-client and x-goog-user-project headers
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                lib_name: @config.lib_name, lib_version: @config.lib_version,
                gapic_version: ::Google::Cloud::MediaTranslation::V1beta1::VERSION
            ...
            ##
            # Configuration class for the SpeechTranslationService API.
            #
            # This class represents the configuration for SpeechTranslationService,
            # providing control over timeouts, retry behavior, logging, transport
            # parameters, and other low-level controls. Certain parameters can also be
            # applied individually to specific RPCs. See
            # {::Google::Cloud::MediaTranslation::V1beta1::SpeechTranslationService::Client::Configuration::Rpcs}
            ...
            class Configuration
              ...
              ##
              # Configuration RPC class for the SpeechTranslationService API.
              #
              ...
              class Rpcs
                ##
                # RPC-specific configuration for `streaming_translate_speech`
                # @return [::Gapic::Config::Method]
                #
                attr_reader :streaming_translate_speech

                # @private
                def initialize parent_rpcs = nil
                  streaming_translate_speech_config = parent_rpcs.streaming_translate_speech if parent_rpcs.respond_to? :streaming_translate_speech
                  @streaming_translate_speech = ::Gapic::Config::Method.new streaming_translate_speech_config
