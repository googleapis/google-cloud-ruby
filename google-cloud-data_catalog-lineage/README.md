# Ruby Client for the Data Lineage API

API Client library for the Data Lineage API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-data_catalog-lineage/latest)
for this library, google-cloud-data_catalog-lineage, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-data_catalog-lineage-v1](https://googleapis.dev/ruby/google-cloud-data_catalog-lineage-v1/latest).
...
client library with a name such as `google-cloud-data_catalog-lineage`,
...
is part of the name, e.g. `google-cloud-data_catalog-lineage-v1`.
