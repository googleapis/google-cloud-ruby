...
require File.expand_path("lib/google/cloud/api_keys/v2/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-api_keys-v2"
  gem.version       = Google::Cloud::ApiKeys::V2::VERSION
  ...
  gem.summary       = "API Client library for the API Keys V2 API"
