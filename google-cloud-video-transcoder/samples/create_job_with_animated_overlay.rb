...
def create_job_with_animated_overlay project_id:, location:, input_uri:, overlay_image_uri:, output_uri:
...
if $PROGRAM_NAME == __FILE__
  ...
  case command
  when "create_job_with_animated_overlay"
    ...
    puts <<~USAGE
      ...
      Commands:
        create_job_with_animated_overlay <location> <input_uri> <overlay_image_uri> <output_uri> Create a job with an animated overlay
