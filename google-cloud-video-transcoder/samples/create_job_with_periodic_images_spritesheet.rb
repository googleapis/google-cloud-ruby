...
def create_job_with_periodic_images_spritesheet project_id:, location:, input_uri:, output_uri:
...
if $PROGRAM_NAME == __FILE__
  ...
  case command
  when "create_job_with_periodic_images_spritesheet"
    ...
    puts <<~USAGE
      ...
      Commands:
        create_job_with_periodic_images_spritesheet <location> <input_uri> <output_uri> Create a job that generates a periodic images spritesheet
