...
::Google::Cloud.configure.add_config! :video_transcoder do |config|
  ...
  module Cloud
    module Video
      module Transcoder
        ...
        # given API version does not support the given transport of the TranscoderService service.
        # You can determine whether the method will succeed by calling
        # {Google::Cloud::Video::Transcoder.transcoder_service_available?}.
        #
        ...
        # If true, you can retrieve a client object by calling {Google::Cloud::Video::Transcoder.transcoder_service}.
        # If false, that method will raise an exception. This could happen if the given
        # API version does not exist or does not support the TranscoderService service,
        # or if the versioned client gem needs an update to support the TranscoderService service.
        #
        # @param version [::String, ::Symbol] The API version to connect to. Optional.
        #   Defaults to `:v1`.
        # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
        ...
        #
        def self.transcoder_service_available? version: :v1, transport: :grpc
          require "google/cloud/video/transcoder/#{version.to_s.downcase}"
          package_name = Google::Cloud::Video::Transcoder
                         .constants
                         .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
          ...
          service_module = Google::Cloud::Video::Transcoder.const_get package_name
          return false unless service_module.const_defined? :TranscoderService
          service_module = service_module.const_get :TranscoderService
          if transport == :rest
        ...
        #
        def self.configure
          yield ::Google::Cloud.configure.video_transcoder if block_given?
...
helper_path = ::File.join __dir__, "transcoder", "helpers.rb"
require "google/cloud/video/transcoder/helpers" if ::File.file? helper_path
