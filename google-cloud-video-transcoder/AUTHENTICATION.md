...
In general, the google-cloud-video-transcoder library uses
...
The google-cloud-video-transcoder library aims to make authentication
...
Google::Cloud::Video::Transcoder.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-video-transcoder.
