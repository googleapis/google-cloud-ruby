...
class ::Google::Cloud::Retail::V2::PredictionService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_predict
    # Create test objects.
    client_result = ::Google::Cloud::Retail::V2::PredictResponse.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2::PredictionService::Rest::Client::Configuration, config
  end
end
