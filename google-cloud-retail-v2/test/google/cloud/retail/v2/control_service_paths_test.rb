...
class ::Google::Cloud::Retail::V2::ControlService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_control_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.control_path project: "value0", location: "value1", catalog: "value2", control: "value3"
      assert_equal "projects/value0/locations/value1/catalogs/value2/controls/value3", path
    end
  end
end
