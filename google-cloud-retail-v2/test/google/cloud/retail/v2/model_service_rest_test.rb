...
class ::Google::Cloud::Retail::V2::ModelService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_model
    # Create test objects.
    client_result = ::Google::Cloud::Retail::V2::Model.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_pause_model
    ...
    pause_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Retail::V2::ModelService::Rest::ServiceStub.stub :transcode_pause_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, pause_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, pause_model_client_stub.call_count
      end
    end
  end
  ...
  def test_resume_model
    ...
    resume_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Retail::V2::ModelService::Rest::ServiceStub.stub :transcode_resume_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, resume_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, resume_model_client_stub.call_count
      end
    end
  end
  ...
  def test_list_models
    # Create test objects.
    client_result = ::Google::Cloud::Retail::V2::ListModelsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_tune_model
    ...
    tune_model_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Retail::V2::ModelService::Rest::ServiceStub.stub :transcode_tune_model_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, tune_model_client_stub do
        ...
        # Verify method calls
        assert_equal 5, tune_model_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2::ModelService::Rest::Client::Configuration, config
  end
end
