...
require File.expand_path("lib/google/cloud/gke_recommender/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-gke_recommender-v1"
  gem.version       = Google::Cloud::GkeRecommender::V1::VERSION
