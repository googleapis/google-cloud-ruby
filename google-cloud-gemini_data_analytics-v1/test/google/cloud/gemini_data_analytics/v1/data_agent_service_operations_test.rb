...
class ::Google::Cloud::GeminiDataAnalytics::V1::DataAgentService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::GeminiDataAnalytics::V1::DataAgentService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::GeminiDataAnalytics::V1::DataAgentService::Operations::Configuration, config
  end
end
