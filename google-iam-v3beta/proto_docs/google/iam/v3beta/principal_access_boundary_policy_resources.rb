...
module Google
  module Iam
    module V3beta
      ...
      #   @return [::Google::Iam::V3beta::PrincipalAccessBoundaryPolicyDetails]
      ...
      # @!attribute [rw] rules
      #   @return [::Array<::Google::Iam::V3beta::PrincipalAccessBoundaryPolicyRule>]
      ...
      # @!attribute [rw] effect
      #   @return [::Google::Iam::V3beta::PrincipalAccessBoundaryPolicyRule::Effect]
