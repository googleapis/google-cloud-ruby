    ...
    module V3beta
      module PrincipalAccessBoundaryPolicies
        ...
        class Client
          ...
          #
          # See {::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::Client::Configuration}
          ...
          def initialize
            ...
            @principal_access_boundary_policies_stub = ::Gapic::ServiceStub.new(
              ::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::Stub,
          ...
          #
          # @return [::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::Operations]
          #
          ...
          #
          # @yield [response, operation] Access the result along with the RPC operation
          # @yieldparam response [::Google::Iam::V3beta::PrincipalAccessBoundaryPolicy]
          # @yieldparam operation [::GRPC::ActiveCall::Operation]
          #
          ...
          #
          # @yield [response, operation] Access the result along with the RPC operation
          # @yieldparam response [::Gapic::PagedEnumerable<::Google::Iam::V3beta::PrincipalAccessBoundaryPolicy>]
          # @yieldparam operation [::GRPC::ActiveCall::Operation]
          #
          # @return [::Gapic::PagedEnumerable<::Google::Iam::V3beta::PrincipalAccessBoundaryPolicy>]
          #
          # @raise [::Google::Cloud::Error] if the RPC is aborted.
          #
          # @example Basic example
          ...
          # {::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::Client::Configuration::Rpcs}
