...
require "google/iam/v3beta/principal_access_boundary_policies_service_services_pb"
require "google/iam/v3beta/principal_access_boundary_policies"

class ::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      c = ::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::Operations.new do |config|
  ...
  def test_configure
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      client = ::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::Operations.new do |config|
        config.credentials = grpc_channel
      end
    end
    ...
    assert_kind_of ::Google::Iam::V3beta::PrincipalAccessBoundaryPolicies::Operations::Configuration, config
  end
end
