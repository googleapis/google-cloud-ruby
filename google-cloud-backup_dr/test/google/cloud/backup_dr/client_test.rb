...
class Google::Cloud::BackupDr::ClientConstructionMinitest < Minitest::Test
  ...
  def test_backup_dr_grpc
    skip unless Google::Cloud::BackupDr.backup_dr_available? transport: :grpc
  ...
  def test_backup_dr_rest
    skip unless Google::Cloud::BackupDr.backup_dr_available? transport: :rest
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
      client = Google::Cloud::BackupDr.backup_dr transport: :rest do |config|
        config.credentials = :dummy_credentials
      end
      assert_kind_of Google::Cloud::BackupDr::V1beta::BackupDR::Rest::Client, client
    end
  end
  ...
  def test_backup_dr_protection_summary_rest
    ...
    Gapic::Rest::ClientStub.stub :new, DummyStub.new do
      ...
      assert_kind_of Google::Cloud::BackupDr::V1beta::BackupDrProtectionSummary::Rest::Client, client
    end
  end
end
