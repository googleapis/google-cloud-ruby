...
module Google
  module Cloud
    module OrgPolicy
      ...
      # given API version does not support the given transport of the OrgPolicy service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::OrgPolicy.org_policy_available?}.
      #
      # ## About OrgPolicy
      #
      ...
      ##
      # Determines whether the OrgPolicy service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::OrgPolicy.org_policy}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the OrgPolicy service,
      # or if the versioned client gem needs an update to support the OrgPolicy service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v2`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
      ...
      #
      def self.org_policy_available? version: :v2, transport: :grpc
        require "google/cloud/org_policy/#{version.to_s.downcase}"
        package_name = Google::Cloud::OrgPolicy
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::OrgPolicy.const_get package_name
        return false unless service_module.const_defined? :OrgPolicy
        service_module = service_module.const_get :OrgPolicy
        if transport == :rest
