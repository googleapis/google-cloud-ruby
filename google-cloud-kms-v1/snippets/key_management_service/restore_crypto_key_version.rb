...
##
# Snippet for the restore_crypto_key_version call in the KeyManagementService service
#
...
# Google::Cloud::Kms::V1::KeyManagementService::Client#restore_crypto_key_version.
#
