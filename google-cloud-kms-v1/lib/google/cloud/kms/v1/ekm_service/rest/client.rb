          ...
          module Rest
            ...
            class Client
              ...
              def list_ekm_connections request, options = nil
                ...
                @ekm_service_stub.list_ekm_connections request, options do |result, response|
              ...
              def get_ekm_connection request, options = nil
                ...
                @ekm_service_stub.get_ekm_connection request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def create_ekm_connection request, options = nil
                ...
                @ekm_service_stub.create_ekm_connection request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Gapic::Rest::Error => e
              ...
              def update_ekm_connection request, options = nil
                ...
                @ekm_service_stub.update_ekm_connection request, options do |result, response|
                  yield result, response if block_given?
                  return result
                end
              rescue ::Gapic::Rest::Error => e
