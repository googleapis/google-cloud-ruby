      ...
      module V1
        module KeyManagementService
          ...
          class Client
            ...
            #
            # @return [::Google::Cloud::Kms::V1::KeyManagementService::Operations]
            #
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Kms::V1::RetiredResource>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Kms::V1::RetiredResource>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def list_retired_resources request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.list_retired_resources.metadata.to_h
              ...
              @key_management_service_stub.call_rpc :list_retired_resources, request, options: options do |response, operation|
                response = ::Gapic::PagedEnumerable.new @key_management_service_stub, :list_retired_resources, request, response, operation, options
                yield response, operation if block_given?
                throw :response, response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Kms::V1::RetiredResource]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_retired_resource request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.get_retired_resource.metadata.to_h
              ...
              @key_management_service_stub.call_rpc :get_retired_resource, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            def delete_crypto_key request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.delete_crypto_key.metadata.to_h
              ...
              @key_management_service_stub.call_rpc :delete_crypto_key, request, options: options do |response, operation|
            ...
            def delete_crypto_key_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.delete_crypto_key_version.metadata.to_h
              ...
              @key_management_service_stub.call_rpc :delete_crypto_key_version, request, options: options do |response, operation|
                response = ::Gapic::Operation.new response, @operations_client, options: options
                yield response, operation if block_given?
                throw :response, response
              end
            ...
            def import_trusted_key_wrapped_crypto_key_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.import_trusted_key_wrapped_crypto_key_version.metadata.to_h
              ...
              @key_management_service_stub.call_rpc :import_trusted_key_wrapped_crypto_key_version, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Kms::V1::ExportTrustedKeyWrappedCryptoKeyVersionResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def export_trusted_key_wrapped_crypto_key_version request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.export_trusted_key_wrapped_crypto_key_version.metadata.to_h
              ...
              @key_management_service_stub.call_rpc :export_trusted_key_wrapped_crypto_key_version, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
