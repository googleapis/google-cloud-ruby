...
class ::Google::Cloud::Kms::V1::AutokeyAdmin::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_update_autokey_config
    # Create test objects.
    client_result = ::Google::Cloud::Kms::V1::AutokeyConfig.new
    ...
    update_autokey_config_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Kms::V1::AutokeyAdmin::Rest::ServiceStub.stub :transcode_update_autokey_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_autokey_config_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_autokey_config_client_stub.call_count
      end
    end
  end
  ...
  def test_get_autokey_config
    ...
    get_autokey_config_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Kms::V1::AutokeyAdmin::Rest::ServiceStub.stub :transcode_get_autokey_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_autokey_config_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_autokey_config_client_stub.call_count
      end
    end
  end
  ...
  def test_show_effective_autokey_config
    # Create test objects.
    client_result = ::Google::Cloud::Kms::V1::ShowEffectiveAutokeyConfigResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    show_effective_autokey_config_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Kms::V1::AutokeyAdmin::Rest::ServiceStub.stub :transcode_show_effective_autokey_config_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, show_effective_autokey_config_client_stub do
        ...
        # Verify method calls
        assert_equal 5, show_effective_autokey_config_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Kms::V1::AutokeyAdmin::Rest::Client::Configuration, config
  end
end
