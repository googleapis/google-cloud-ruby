...
class ::Google::Cloud::Parallelstore::V1beta::Parallelstore::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_instances
    # Create test objects.
    client_result = ::Google::Cloud::Parallelstore::V1beta::ListInstancesResponse.new
  ...
  def test_get_instance
    # Create test objects.
    client_result = ::Google::Cloud::Parallelstore::V1beta::Instance.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Parallelstore::V1beta::Parallelstore::Rest::Client::Configuration, config
  end
end
