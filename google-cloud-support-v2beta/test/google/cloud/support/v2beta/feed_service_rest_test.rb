...
class ::Google::Cloud::Support::V2beta::FeedService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_show_feed
    # Create test objects.
    client_result = ::Google::Cloud::Support::V2beta::ShowFeedResponse.new
    ...
    show_feed_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Support::V2beta::FeedService::Rest::ServiceStub.stub :transcode_show_feed_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, show_feed_client_stub do
        ...
        # Verify method calls
        assert_equal 5, show_feed_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Support::V2beta::FeedService::Rest::Client::Configuration, config
  end
end
