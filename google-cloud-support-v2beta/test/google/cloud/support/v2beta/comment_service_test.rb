...
class ::Google::Cloud::Support::V2beta::CommentService::ClientTest < Minitest::Test
  ...
  def test_list_comments
    ...
    Gapic::ServiceStub.stub :new, list_comments_client_stub do
      ...
      # Use protobuf object
      client.list_comments ::Google::Cloud::Support::V2beta::ListCommentsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_comments(::Google::Cloud::Support::V2beta::ListCommentsRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_comment
    ...
    Gapic::ServiceStub.stub :new, create_comment_client_stub do
      ...
      # Use protobuf object
      client.create_comment ::Google::Cloud::Support::V2beta::CreateCommentRequest.new(parent: parent, comment: comment) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_comment(::Google::Cloud::Support::V2beta::CreateCommentRequest.new(parent: parent, comment: comment), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_comment
    ...
    Gapic::ServiceStub.stub :new, get_comment_client_stub do
      ...
      # Use protobuf object
      client.get_comment ::Google::Cloud::Support::V2beta::GetCommentRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_comment(::Google::Cloud::Support::V2beta::GetCommentRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
