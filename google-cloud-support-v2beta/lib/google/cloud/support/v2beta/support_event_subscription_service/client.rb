      ...
      module V2beta
        module SupportEventSubscriptionService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Support::V2beta::SupportEventSubscriptionService::Client::Configuration}
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/support/v2beta/support_event_subscription_service_services_pb"
              ...
              @support_event_subscription_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Support::V2beta::SupportEventSubscriptionService::Stub,
            ...
            # @yieldparam response [::Google::Cloud::Support::V2beta::SupportEventSubscription]
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Support::V2beta::SupportEventSubscription>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Support::V2beta::SupportEventSubscription>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            # {::Google::Cloud::Support::V2beta::SupportEventSubscriptionService::Client::Configuration::Rpcs}
