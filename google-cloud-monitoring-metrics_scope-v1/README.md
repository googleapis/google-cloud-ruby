...
the main client gem,
[google-cloud-monitoring-metrics_scope](https://rubygems.org/gems/google-cloud-monitoring-metrics_scope).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-monitoring-metrics_scope-v1
```
