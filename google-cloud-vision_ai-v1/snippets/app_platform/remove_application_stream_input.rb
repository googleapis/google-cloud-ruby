...
##
# Snippet for the remove_application_stream_input call in the AppPlatform service
#
...
# Google::Cloud::VisionAI::V1::AppPlatform::Client#remove_application_stream_input.
#
