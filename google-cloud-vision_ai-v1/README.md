...
specific version of the Vision AI V1 API. Most users should consider using
the main client gem,
[google-cloud-vision_ai](https://rubygems.org/gems/google-cloud-vision_ai).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-vision_ai-v1
```
