...
class ::Google::Cloud::VisionAI::V1::StreamingService::Rest::ClientTest < Minitest::Test
  ...
  def test_acquire_lease
    ...
    acquire_lease_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_release_lease
    ...
    release_lease_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
