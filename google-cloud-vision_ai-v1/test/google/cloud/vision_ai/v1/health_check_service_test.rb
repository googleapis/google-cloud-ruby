...
class ::Google::Cloud::VisionAI::V1::HealthCheckService::ClientTest < Minitest::Test
  ...
  def test_health_check
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::VisionAI::V1::HealthCheckResponse.new
    ...
    health_check_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :health_check, name
      assert_kind_of ::Google::Cloud::VisionAI::V1::HealthCheckRequest, request
    ...
    Gapic::ServiceStub.stub :new, health_check_client_stub do
      ...
      # Verify method calls
      assert_equal 5, health_check_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VisionAI::V1::HealthCheckService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::VisionAI::V1::HealthCheckService::Client, client
