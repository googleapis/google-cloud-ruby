...
class ::Google::Cloud::VisionAI::V1::HealthCheckService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_health_check
    # Create test objects.
    client_result = ::Google::Cloud::VisionAI::V1::HealthCheckResponse.new
    ...
    health_check_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::VisionAI::V1::HealthCheckService::Rest::ServiceStub.stub :transcode_health_check_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, health_check_client_stub do
        ...
        # Verify method calls
        assert_equal 5, health_check_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VisionAI::V1::HealthCheckService::Rest::Client::Configuration, config
  end
end
