  ...
  def test_list_clusters
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_list_clusters_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_clusters_client_stub do
        # Create client
        c = ::Google::Cloud::VisionAI::V1::StreamsService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        c.list_clusters ::Google::Cloud::VisionAI::V1::ListClustersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        c.list_clusters(::Google::Cloud::VisionAI::V1::ListClustersRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_cluster
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_get_cluster_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_cluster_client_stub do
        ...
        # Use protobuf object
        c.get_cluster ::Google::Cloud::VisionAI::V1::GetClusterRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_cluster(::Google::Cloud::VisionAI::V1::GetClusterRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_cluster
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_create_cluster_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_cluster_client_stub do
        ...
        # Use protobuf object
        c.create_cluster ::Google::Cloud::VisionAI::V1::CreateClusterRequest.new(parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.create_cluster(::Google::Cloud::VisionAI::V1::CreateClusterRequest.new(parent: parent, cluster_id: cluster_id, cluster: cluster, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_cluster
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_update_cluster_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_cluster_client_stub do
        ...
        # Use protobuf object
        c.update_cluster ::Google::Cloud::VisionAI::V1::UpdateClusterRequest.new(update_mask: update_mask, cluster: cluster, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.update_cluster(::Google::Cloud::VisionAI::V1::UpdateClusterRequest.new(update_mask: update_mask, cluster: cluster, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_cluster
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_delete_cluster_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_cluster_client_stub do
        ...
        # Use protobuf object
        c.delete_cluster ::Google::Cloud::VisionAI::V1::DeleteClusterRequest.new(name: name, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_cluster(::Google::Cloud::VisionAI::V1::DeleteClusterRequest.new(name: name, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_streams
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_list_streams_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_streams_client_stub do
        ...
        # Use protobuf object
        c.list_streams ::Google::Cloud::VisionAI::V1::ListStreamsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_streams(::Google::Cloud::VisionAI::V1::ListStreamsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_stream
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_get_stream_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_stream_client_stub do
        ...
        # Use protobuf object
        c.get_stream ::Google::Cloud::VisionAI::V1::GetStreamRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_stream(::Google::Cloud::VisionAI::V1::GetStreamRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_stream
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_create_stream_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_stream_client_stub do
        ...
        # Use hash object
        c.create_stream({ parent: parent, stream_id: stream_id, stream: stream, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.create_stream ::Google::Cloud::VisionAI::V1::CreateStreamRequest.new(parent: parent, stream_id: stream_id, stream: stream, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.create_stream({ parent: parent, stream_id: stream_id, stream: stream, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.create_stream(::Google::Cloud::VisionAI::V1::CreateStreamRequest.new(parent: parent, stream_id: stream_id, stream: stream, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_stream
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_update_stream_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_stream_client_stub do
        ...
        # Use hash object
        c.update_stream({ update_mask: update_mask, stream: stream, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.update_stream ::Google::Cloud::VisionAI::V1::UpdateStreamRequest.new(update_mask: update_mask, stream: stream, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.update_stream({ update_mask: update_mask, stream: stream, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.update_stream(::Google::Cloud::VisionAI::V1::UpdateStreamRequest.new(update_mask: update_mask, stream: stream, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_stream
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_delete_stream_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_stream_client_stub do
        ...
        # Use protobuf object
        c.delete_stream ::Google::Cloud::VisionAI::V1::DeleteStreamRequest.new(name: name, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_stream(::Google::Cloud::VisionAI::V1::DeleteStreamRequest.new(name: name, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_stream_thumbnail
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_get_stream_thumbnail_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_stream_thumbnail_client_stub do
        ...
        # Use hash object
        c.get_stream_thumbnail({ stream: stream, gcs_object_name: gcs_object_name, event: event, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.get_stream_thumbnail ::Google::Cloud::VisionAI::V1::GetStreamThumbnailRequest.new(stream: stream, gcs_object_name: gcs_object_name, event: event, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.get_stream_thumbnail({ stream: stream, gcs_object_name: gcs_object_name, event: event, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.get_stream_thumbnail(::Google::Cloud::VisionAI::V1::GetStreamThumbnailRequest.new(stream: stream, gcs_object_name: gcs_object_name, event: event, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_generate_stream_hls_token
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_generate_stream_hls_token_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, generate_stream_hls_token_client_stub do
        ...
        # Use hash object
        c.generate_stream_hls_token({ stream: stream }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.generate_stream_hls_token ::Google::Cloud::VisionAI::V1::GenerateStreamHlsTokenRequest.new(stream: stream) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.generate_stream_hls_token({ stream: stream }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.generate_stream_hls_token(::Google::Cloud::VisionAI::V1::GenerateStreamHlsTokenRequest.new(stream: stream), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_events
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_list_events_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_events_client_stub do
        ...
        # Use protobuf object
        c.list_events ::Google::Cloud::VisionAI::V1::ListEventsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.list_events(::Google::Cloud::VisionAI::V1::ListEventsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_event
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_get_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_event_client_stub do
        ...
        # Use protobuf object
        c.get_event ::Google::Cloud::VisionAI::V1::GetEventRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.get_event(::Google::Cloud::VisionAI::V1::GetEventRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_event
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_create_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_event_client_stub do
        ...
        # Use hash object
        c.create_event({ parent: parent, event_id: event_id, event: event, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.create_event ::Google::Cloud::VisionAI::V1::CreateEventRequest.new(parent: parent, event_id: event_id, event: event, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.create_event({ parent: parent, event_id: event_id, event: event, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.create_event(::Google::Cloud::VisionAI::V1::CreateEventRequest.new(parent: parent, event_id: event_id, event: event, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_event
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_update_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_event_client_stub do
        ...
        # Use hash object
        c.update_event({ update_mask: update_mask, event: event, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.update_event ::Google::Cloud::VisionAI::V1::UpdateEventRequest.new(update_mask: update_mask, event: event, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.update_event({ update_mask: update_mask, event: event, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.update_event(::Google::Cloud::VisionAI::V1::UpdateEventRequest.new(update_mask: update_mask, event: event, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_event
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_delete_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_event_client_stub do
        ...
        # Use protobuf object
        c.delete_event ::Google::Cloud::VisionAI::V1::DeleteEventRequest.new(name: name, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        c.delete_event(::Google::Cloud::VisionAI::V1::DeleteEventRequest.new(name: name, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_series
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_list_series_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_series_client_stub do
        ...
        # Use hash object
        c.list_series({ parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.list_series ::Google::Cloud::VisionAI::V1::ListSeriesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.list_series({ parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.list_series(::Google::Cloud::VisionAI::V1::ListSeriesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_series
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_get_series_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_series_client_stub do
        ...
        # Use hash object
        c.get_series({ name: name }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.get_series ::Google::Cloud::VisionAI::V1::GetSeriesRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.get_series({ name: name }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.get_series(::Google::Cloud::VisionAI::V1::GetSeriesRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_create_series
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_create_series_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_series_client_stub do
        ...
        # Use hash object
        c.create_series({ parent: parent, series_id: series_id, series: series, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.create_series ::Google::Cloud::VisionAI::V1::CreateSeriesRequest.new(parent: parent, series_id: series_id, series: series, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.create_series({ parent: parent, series_id: series_id, series: series, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.create_series(::Google::Cloud::VisionAI::V1::CreateSeriesRequest.new(parent: parent, series_id: series_id, series: series, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_series
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_update_series_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_series_client_stub do
        ...
        # Use hash object
        c.update_series({ update_mask: update_mask, series: series, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.update_series ::Google::Cloud::VisionAI::V1::UpdateSeriesRequest.new(update_mask: update_mask, series: series, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.update_series({ update_mask: update_mask, series: series, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.update_series(::Google::Cloud::VisionAI::V1::UpdateSeriesRequest.new(update_mask: update_mask, series: series, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_series
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_delete_series_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_series_client_stub do
        ...
        # Use hash object
        c.delete_series({ name: name, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.delete_series ::Google::Cloud::VisionAI::V1::DeleteSeriesRequest.new(name: name, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.delete_series({ name: name, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.delete_series(::Google::Cloud::VisionAI::V1::DeleteSeriesRequest.new(name: name, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_materialize_channel
    ...
    ::Google::Cloud::VisionAI::V1::StreamsService::Rest::ServiceStub.stub :transcode_materialize_channel_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, materialize_channel_client_stub do
        ...
        # Use hash object
        c.materialize_channel({ parent: parent, channel_id: channel_id, channel: channel, request_id: request_id }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        c.materialize_channel ::Google::Cloud::VisionAI::V1::MaterializeChannelRequest.new(parent: parent, channel_id: channel_id, channel: channel, request_id: request_id) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        c.materialize_channel({ parent: parent, channel_id: channel_id, channel: channel, request_id: request_id }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        c.materialize_channel(::Google::Cloud::VisionAI::V1::MaterializeChannelRequest.new(parent: parent, channel_id: channel_id, channel: channel, request_id: request_id), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
