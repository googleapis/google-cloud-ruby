...
module Google
  module Cloud
    ...
    ##
    # # Ruby Client for Secret Manager API ([Beta](https://github.com/googleapis/google-cloud-ruby#versioning))
    #
    ...
    module SecretManager
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("secret_manager"))
      ...
      def self.new(*args, version: :v1beta1, **kwargs)
        ...
        version_module = Google::Cloud::SecretManager
          .constants
          .select {|sym| sym.to_s.downcase == version.to_s.downcase}
          .first
        Google::Cloud::SecretManager.const_get(version_module).new(*args, **kwargs)
      end
    end
  end
end
