...
module Google
  module Cloud
    module SecretManager
      ...
      # given API version does not support the given transport of the SecretManagerService service.
      ...
      #
      def self.secret_manager_service version: :v1, transport: :grpc, &block
      ...
      #
      def self.secret_manager_service_available? version: :v1, transport: :grpc
        require "google/cloud/secret_manager/#{version.to_s.downcase}"
        package_name = Google::Cloud::SecretManager
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
