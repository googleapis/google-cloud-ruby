...
describe Gcloud::Datastore::Property do
  ...
  it "encodes a string" do
    ...
    value = Gcloud::Datastore::Property.encode raw
  ...
  it "decodes a string" do
    ...
    raw = Gcloud::Datastore::Property.decode value
    raw.must_equal str
  end

  it "encodes true" do
    value = Gcloud::Datastore::Property.encode true
  ...
  it "encodes false" do
    value = Gcloud::Datastore::Property.encode false
  ...
  it "encodes Time" do
    value = Gcloud::Datastore::Property.encode time_obj
  ...
  it "encodes Key" do
    ...
    value = Gcloud::Datastore::Property.encode key
