...
describe Google::Cloud::Datastore::Properties do
  ...
  it "decodes empty value" do
    ...
    raw = Google::Cloud::GRPCUtils.from_value value
    raw.must_equal nil
  end

  it "encodes a string" do
    raw = "hello, i am a string"
    value = Google::Cloud::GRPCUtils.to_value raw
  ...
  it "encodes nil" do
    value = Google::Cloud::GRPCUtils.to_value nil
  ...
  it "encodes true" do
    value = Google::Cloud::GRPCUtils.to_value true
  ...
  it "encodes false" do
    value = Google::Cloud::GRPCUtils.to_value false
    value.value_type.must_equal :boolean_value
  ...
  it "encodes Key" do
    ...
    value = Google::Cloud::GRPCUtils.to_value key
  ...
  it "encodes Entity" do
    ...
    entity["name"] = "Thing 1"
    value = Google::Cloud::GRPCUtils.to_value entity
  ...
  it "encodes Array" do
    ...
    value = Google::Cloud::GRPCUtils.to_value array
  ...
  it "encodes Time" do
    value = Google::Cloud::GRPCUtils.to_value time_obj
  ...
  it "encodes Date" do
    ...
    value = Google::Cloud::GRPCUtils.to_value date_obj
  ...
  it "encodes DateTime" do
    ...
    value = Google::Cloud::GRPCUtils.to_value datetime_obj
    value.value_type.must_equal :timestamp_value
    value.timestamp_value.must_equal time_grpc
    value.key_value.must_be :nil?
    value.entity_value.must_be :nil?
  ...
  it "encodes location hash" do
    ...
    value = Google::Cloud::GRPCUtils.to_value latlng_obj
