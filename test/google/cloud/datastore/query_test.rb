...
describe Google::Cloud::Datastore::Query do
  ...
  it "can filter properties" do
    ...
    assert_equal true, Google::Cloud::GRPCUtils.from_value(new_filter.property_filter.value)
    ...
    assert_equal true, Google::Cloud::GRPCUtils.from_value(first_filter.property_filter.value)
    ...
    assert_equal Time.new(2014, 1, 1, 0, 0, 0, 0),
                 Google::Cloud::GRPCUtils.from_value(second_filter.property_filter.value)
  end
  ...
  it "can query ancestor" do
    ...
    key = Google::Cloud::GRPCUtils.from_value(ancestor_filter.property_filter.value)
  ...
  it "can chain query methods" do
    ...
    Google::Cloud::GRPCUtils.from_value(filter.property_filter.value).must_equal true
