...
In general, the google-cloud-functions-v2 library uses
...
The google-cloud-functions-v2 library aims to make authentication
...
The environment variables that google-cloud-functions-v2
checks for credentials are configured on the service Credentials class (such as
{::Google::Cloud::Functions::V2::FunctionService::Credentials}):
...
connect to most services with google-cloud-functions-v2.
