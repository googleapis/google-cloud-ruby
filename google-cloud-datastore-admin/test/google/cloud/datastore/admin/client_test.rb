...
class Google::Cloud::Datastore::Admin::ClientConstructionMinitest < Minitest::Test
  ...
  def test_datastore_admin_grpc
    skip unless Google::Cloud::Datastore::Admin.datastore_admin_available? transport: :grpc
  ...
  def test_datastore_admin_rest
    skip unless Google::Cloud::Datastore::Admin.datastore_admin_available? transport: :rest
