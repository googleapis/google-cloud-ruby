  ...
  def test_get_shared_regional_certificate_authority
    ...
    ::Google::Cloud::Redis::Cluster::V1beta1::CloudRedisCluster::Rest::ServiceStub.stub :transcode_get_shared_regional_certificate_authority_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_shared_regional_certificate_authority_client_stub do
        ...
        # Use protobuf object
        client.get_shared_regional_certificate_authority ::Google::Cloud::Redis::Cluster::V1beta1::GetSharedRegionalCertificateAuthorityRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.get_shared_regional_certificate_authority(::Google::Cloud::Redis::Cluster::V1beta1::GetSharedRegionalCertificateAuthorityRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
