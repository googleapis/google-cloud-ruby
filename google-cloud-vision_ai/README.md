...
The gem `google-cloud-vision_ai` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-vision_ai/latest)
for this library, google-cloud-vision_ai, to see the convenience methods for
...
```
$ gem install google-cloud-vision_ai
```
...
client library with a name such as `google-cloud-vision_ai`,
...
is part of the name, e.g. `google-cloud-vision_ai-v1`.
