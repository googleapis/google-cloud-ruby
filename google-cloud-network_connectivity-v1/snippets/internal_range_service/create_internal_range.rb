...
##
# Snippet for the create_internal_range call in the InternalRangeService service
#
...
# Google::Cloud::NetworkConnectivity::V1::InternalRangeService::Client#create_internal_range.
#
def create_internal_range
