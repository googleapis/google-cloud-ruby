...
class ::Google::Cloud::NetworkConnectivity::V1::PolicyBasedRoutingService::ClientTest < Minitest::Test
  ...
  def test_list_policy_based_routes
    ...
    Gapic::ServiceStub.stub :new, list_policy_based_routes_client_stub do
      # Create client
      c = ::Google::Cloud::NetworkConnectivity::V1::PolicyBasedRoutingService::Client.new do |config|
      ...
      # Use protobuf object
      c.list_policy_based_routes ::Google::Cloud::NetworkConnectivity::V1::ListPolicyBasedRoutesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      c.list_policy_based_routes(::Google::Cloud::NetworkConnectivity::V1::ListPolicyBasedRoutesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_policy_based_route
    ...
    Gapic::ServiceStub.stub :new, get_policy_based_route_client_stub do
      ...
      # Use protobuf object
      c.get_policy_based_route ::Google::Cloud::NetworkConnectivity::V1::GetPolicyBasedRouteRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get_policy_based_route(::Google::Cloud::NetworkConnectivity::V1::GetPolicyBasedRouteRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_policy_based_route
    ...
    Gapic::ServiceStub.stub :new, create_policy_based_route_client_stub do
      ...
      # Use protobuf object
      c.create_policy_based_route ::Google::Cloud::NetworkConnectivity::V1::CreatePolicyBasedRouteRequest.new(parent: parent, policy_based_route_id: policy_based_route_id, policy_based_route: policy_based_route, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.create_policy_based_route(::Google::Cloud::NetworkConnectivity::V1::CreatePolicyBasedRouteRequest.new(parent: parent, policy_based_route_id: policy_based_route_id, policy_based_route: policy_based_route, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_policy_based_route
    ...
    Gapic::ServiceStub.stub :new, delete_policy_based_route_client_stub do
      ...
      # Use protobuf object
      c.delete_policy_based_route ::Google::Cloud::NetworkConnectivity::V1::DeletePolicyBasedRouteRequest.new(name: name, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.delete_policy_based_route(::Google::Cloud::NetworkConnectivity::V1::DeletePolicyBasedRouteRequest.new(name: name, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
