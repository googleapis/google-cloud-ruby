...
class ::Google::Cloud::NetworkConnectivity::V1::PolicyBasedRoutingService::ClientPathsTest < Minitest::Test
  ...
  def test_policy_based_route_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.policy_based_route_path project: "value0", location: "value1", policy_based_route: "value2"
      assert_equal "projects/value0/value1/global/PolicyBasedRoutes/value2", path
    end
  end
end
