          ...
          module NotificationsApiService
            module Rest
              ...
              class ServiceStub
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Notifications::V1::GetNotificationSubscriptionRequest]
                ...
                def get_notification_subscription request_pb, options = nil
                  ...
                  result = ::Google::Shopping::Merchant::Notifications::V1::NotificationSubscription.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Notifications::V1::CreateNotificationSubscriptionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Notifications::V1::UpdateNotificationSubscriptionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Notifications::V1::DeleteNotificationSubscriptionRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #
                # @param request_pb [::Google::Shopping::Merchant::Notifications::V1::ListNotificationSubscriptionsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                # @yield [result, operation] Access the result along with the TransportOperation object
                # @yieldparam result [::Google::Shopping::Merchant::Notifications::V1::ListNotificationSubscriptionsResponse]
                # @yieldparam operation [::Gapic::Rest::TransportOperation]
                #
                # @return [::Google::Shopping::Merchant::Notifications::V1::ListNotificationSubscriptionsResponse]
                #   A result object deserialized from the server's reply
                def list_notification_subscriptions request_pb, options = nil
                  ...
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Shopping::Merchant::Notifications::V1::ListNotificationSubscriptionsResponse.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                ##
                # Baseline implementation for the get_notification_subscription_health_metrics REST call
                #
                # @param request_pb [::Google::Shopping::Merchant::Notifications::V1::GetNotificationSubscriptionHealthMetricsRequest]
                #   A request object representing the call parameters. Required.
                # @param options [::Gapic::CallOptions]
                #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
                #
                ...
                #   A result object deserialized from the server's reply
                def get_notification_subscription_health_metrics request_pb, options = nil
                  raise ::ArgumentError, "request must be provided" if request_pb.nil?

                  verb, uri, query_string_params, body = ServiceStub.transcode_get_notification_subscription_health_metrics_request request_pb
                  query_string_params = if query_string_params.any?
                                          query_string_params.to_h { |p| p.split "=", 2 }
                                        else
                                          {}
                  ...
                  response = @client_stub.make_http_request(
                    ...
                    body: body || "",
                    params: query_string_params,
                    method_name: "get_notification_subscription_health_metrics",
                    options: options
                  )
                  operation = ::Gapic::Rest::TransportOperation.new response
                  result = ::Google::Shopping::Merchant::Notifications::V1::NotificationSubscriptionHealthMetrics.decode_json response.body, ignore_unknown_fields: true
                  catch :response do
                    yield result, operation if block_given?
                    result
                  end
                ...
                def self.transcode_get_notification_subscription_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/notifications/v1/{name}",
                                                            matches: [
                ...
                def self.transcode_create_notification_subscription_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :post,
                                                            uri_template: "/notifications/v1/{parent}/notificationsubscriptions",
                ...
                def self.transcode_update_notification_subscription_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :patch,
                                                            uri_template: "/notifications/v1/{notification_subscription.name}",
                                                            body: "notification_subscription",
                                                            matches: [
                ...
                # @private
                #
                # GRPC transcoding helper method for the get_notification_subscription_health_metrics REST call
                #
                # @param request_pb [::Google::Shopping::Merchant::Notifications::V1::GetNotificationSubscriptionHealthMetricsRequest]
                #   A request object representing the call parameters. Required.
                # @return [Array(String, [String, nil], Hash{String => String})]
                #   Uri, Body, Query string parameters
                def self.transcode_get_notification_subscription_health_metrics_request request_pb
                  transcoder = Gapic::Rest::GrpcTranscoder.new
                                                          .with_bindings(
                                                            uri_method: :get,
                                                            uri_template: "/notifications/v1/{name}:getHealth",
                                                            matches: [
                                                              ["name", %r{^accounts/[^/]+/notificationsubscriptions/[^/]+/?$}, false]
                                                            ]
                                                          )
