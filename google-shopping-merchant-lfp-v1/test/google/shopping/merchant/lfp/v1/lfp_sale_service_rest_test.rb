...
class ::Google::Shopping::Merchant::Lfp::V1::LfpSaleService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_insert_lfp_sale
    # Create test objects.
    client_result = ::Google::Shopping::Merchant::Lfp::V1::LfpSale.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Shopping::Merchant::Lfp::V1::LfpSaleService::Rest::Client::Configuration, config
  end
end
