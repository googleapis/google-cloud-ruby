...
module Google
  module Shopping
    module Merchant
      module Lfp
        module V1
          LfpInventory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.lfp.v1.LfpInventory").msgclass
          InsertLfpInventoryRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.shopping.merchant.lfp.v1.InsertLfpInventoryRequest").msgclass
        end
      end
    end
  end
