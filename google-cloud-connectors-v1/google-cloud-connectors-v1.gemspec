...
require File.expand_path("lib/google/cloud/connectors/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-connectors-v1"
  gem.version       = Google::Cloud::Connectors::V1::VERSION
