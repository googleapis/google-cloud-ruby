...
module Google
  module Cloud
    module Recommender
      ...
      # given API version does not support the given transport of the Recommender service.
      # You can determine whether the method will succeed by calling
      # {Google::Cloud::Recommender.recommender_service_available?}.
      #
      # ## About Recommender
      #
      ...
      ##
      # Determines whether the Recommender service is supported by the current client.
      # If true, you can retrieve a client object by calling {Google::Cloud::Recommender.recommender_service}.
      # If false, that method will raise an exception. This could happen if the given
      # API version does not exist or does not support the Recommender service,
      # or if the versioned client gem needs an update to support the Recommender service.
      #
      # @param version [::String, ::Symbol] The API version to connect to. Optional.
      #   Defaults to `:v1`.
      # @param transport [:grpc, :rest] The transport to use. Defaults to `:grpc`.
      ...
      #
      def self.recommender_service_available? version: :v1, transport: :grpc
        require "google/cloud/recommender/#{version.to_s.downcase}"
        package_name = Google::Cloud::Recommender
                       .constants
                       .select { |sym| sym.to_s.downcase == version.to_s.downcase.tr("_", "") }
        ...
        service_module = Google::Cloud::Recommender.const_get package_name
        return false unless service_module.const_defined? :Recommender
        service_module = service_module.const_get :Recommender
        if transport == :rest
