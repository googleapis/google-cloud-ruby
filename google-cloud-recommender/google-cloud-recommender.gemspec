...
Gem::Specification.new do |gem|
  ...
  gem.description   = "google-cloud-recommender is the official library for the Recommender API."
  gem.summary       = "API Client library for the Recommender API"
  gem.homepage      = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-recommender"
  ...
  gem.add_dependency "google-cloud-recommender-v1", "~> 0.0"
