# Ruby Client for the Security Command Center V2 API
...
specific version of the Security Command Center V2 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-security_center-v2
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-security_center-v2/latest)
...
is part of the name, e.g. `google-cloud-security_center-v2`.
