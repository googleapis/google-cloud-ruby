...
::Google::Cloud.configure.add_config! :api_gateway do |config|
  config.add_field! :endpoint,      "apigateway.googleapis.com", match: ::String
...
module Google
  module Cloud
    module ApiGateway
      ...
      #   Defaults to `:v1`.
      # @return [ApiGatewayService::Client] A client object for the specified version.
      #
      def self.api_gateway_service version: :v1, &block
        ...
        package_name = Google::Cloud::ApiGateway
                       ...
                       .first
        package_module = Google::Cloud::ApiGateway.const_get package_name
        package_module.const_get(:ApiGatewayService).const_get(:Client).new(&block)
      end
