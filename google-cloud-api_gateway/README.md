...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-api_gateway/latest)
for this library, google-cloud-api_gateway, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-api_gateway-v1](https://googleapis.dev/ruby/google-cloud-api_gateway-v1/latest).
