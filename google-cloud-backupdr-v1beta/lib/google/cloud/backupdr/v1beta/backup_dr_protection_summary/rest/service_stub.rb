        ...
        module BackupDrProtectionSummary
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsResponse]
              ...
              def list_resource_backup_configs request_pb, options = nil
                ...
                result = ::Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
              ...
              def self.transcode_list_resource_backup_configs_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/v1beta/{parent}/resourceBackupConfigs",
                                                          matches: [
