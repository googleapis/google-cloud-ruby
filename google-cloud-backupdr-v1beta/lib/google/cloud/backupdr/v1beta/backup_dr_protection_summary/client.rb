      ...
      module V1beta
        module BackupDrProtectionSummary
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::BackupDR::V1beta::BackupDrProtectionSummary::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all BackupDrProtectionSummary clients
            #   ::Google::Cloud::BackupDR::V1beta::BackupDrProtectionSummary::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::BackupDR::V1beta::BackupDrProtectionSummary::Client.new
            #
            #   # Create a client using a custom configuration
            #   client = ::Google::Cloud::BackupDR::V1beta::BackupDrProtectionSummary::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/backupdr/v1beta/protection_summary_services_pb"
              ...
              @backup_dr_protection_summary_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::BackupDR::V1beta::BackupDrProtectionSummary::Stub,
            ...
            #   {::Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::BackupDR::V1beta::ResourceBackupConfig>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::BackupDR::V1beta::ResourceBackupConfig>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            #   require "google/cloud/backupdr/v1beta"
            #
            #   # Create a client object. The client can be reused for multiple calls.
            #   client = Google::Cloud::BackupDR::V1beta::BackupDrProtectionSummary::Client.new
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsRequest.new
            #
            ...
            #   result.each do |item|
            #     # Each element is of type ::Google::Cloud::BackupDR::V1beta::ResourceBackupConfig.
            #     p item
            #   end
            #
            def list_resource_backup_configs request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::BackupDR::V1beta::ListResourceBackupConfigsRequest
              ...
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                ...
                gapic_version: ::Google::Cloud::BackupDR::V1beta::VERSION
            ...
            # {::Google::Cloud::BackupDR::V1beta::BackupDrProtectionSummary::Client::Configuration::Rpcs}
