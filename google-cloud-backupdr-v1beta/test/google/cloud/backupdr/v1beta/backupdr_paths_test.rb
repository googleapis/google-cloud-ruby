...
class ::Google::Cloud::BackupDR::V1beta::BackupDR::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_auto_protection_policy_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.auto_protection_policy_path project: "value0", location: "value1", auto_protection_policy: "value2"
      assert_equal "projects/value0/locations/value1/autoProtectionPolicies/value2", path
    end
  end

  def test_auto_protection_policy_binding_path
    grpc_channel = ::GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      client = ::Google::Cloud::BackupDR::V1beta::BackupDR::Client.new do |config|
        config.credentials = grpc_channel
      ...
      path = client.auto_protection_policy_binding_path project: "value0", location: "value1", auto_protection_policy: "value2", binding: "value3"
      assert_equal "projects/value0/locations/value1/autoProtectionPolicies/value2/bindings/value3", path
    end
  end
  ...
  def test_binding_matching_resource_path
    grpc_channel = ::GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      client = ::Google::Cloud::BackupDR::V1beta::BackupDR::Client.new do |config|
        config.credentials = grpc_channel
      ...
      path = client.binding_matching_resource_path project: "value0", location: "value1", auto_protection_policy: "value2", binding: "value3", matching_resource: "value4"
      assert_equal "projects/value0/locations/value1/autoProtectionPolicies/value2/bindings/value3/matchingResources/value4", path
    end
  end
