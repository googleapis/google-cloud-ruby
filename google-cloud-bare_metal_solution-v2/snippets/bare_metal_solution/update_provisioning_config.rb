...
##
# Snippet for the update_provisioning_config call in the BareMetalSolution service
#
...
# Google::Cloud::BareMetalSolution::V2::BareMetalSolution::Client#update_provisioning_config.
#
