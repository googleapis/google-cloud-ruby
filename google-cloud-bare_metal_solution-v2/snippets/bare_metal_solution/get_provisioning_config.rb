...
##
# Snippet for the get_provisioning_config call in the BareMetalSolution service
#
...
# Google::Cloud::BareMetalSolution::V2::BareMetalSolution::Client#get_provisioning_config.
#
