...
##
# Snippet for the get_volume_snapshot call in the BareMetalSolution service
#
...
# Google::Cloud::BareMetalSolution::V2::BareMetalSolution::Client#get_volume_snapshot.
#
