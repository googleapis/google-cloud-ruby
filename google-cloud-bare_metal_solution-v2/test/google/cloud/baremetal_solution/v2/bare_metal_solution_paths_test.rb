...
class ::Google::Cloud::BaremetalSolution::V2::BareMetalSolution::ClientPathsTest < Minitest::Test
  ...
  def test_snapshot_schedule_policy_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.snapshot_schedule_policy_path project: "value0", location: "value1", snapshot_schedule_policy: "value2"
      assert_equal "projects/value0/locations/value1/snapshotSchedulePolicies/value2", path
    end
  end
