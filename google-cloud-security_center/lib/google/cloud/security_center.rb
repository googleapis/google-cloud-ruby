...
module Google
  module Cloud
    ...
    module SecurityCenter
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("security_center"))
      ...
      def self.new(*args, version: :v1, **kwargs)
        ...
        version_module = Google::Cloud::SecurityCenter
          .constants
          .select {|sym| sym.to_s.downcase == version.to_s.downcase}
          .first
        Google::Cloud::SecurityCenter.const_get(version_module).new(*args, **kwargs)
      end
    end
  end
end
