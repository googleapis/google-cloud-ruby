...
module Google
  module Cloud
    module SecurityCenter
      ...
      #   Defaults to `:v1`.
      # @return [SecurityCenter::Client] A client object for the specified version.
      #
      def self.security_center version: :v1, &block
        ...
        package_name = Google::Cloud::SecurityCenter
                       ...
                       .first
        package_module = Google::Cloud::SecurityCenter.const_get package_name
        package_module.const_get(:SecurityCenter).const_get(:Client).new(&block)
      end
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.security_center if block_given?

        ::Google::Cloud.configure.security_center
      end
    end
  end
end
