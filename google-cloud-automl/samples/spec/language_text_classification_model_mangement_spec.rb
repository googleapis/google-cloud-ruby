...
describe "Language Text Classification Model Management" do
  let(:project_id) { ENV["AUTOML_PROJECT_ID"] }
  let(:dataset_id) { ENV["AUTOML_CLASSIFICATION_DATASET_ID"] }
  ...
  example "Create a model", :slow do
    ...
    capture do
      text_classification_create_model actual_project_id: project_id, actual_dataset_id: dataset_id,
