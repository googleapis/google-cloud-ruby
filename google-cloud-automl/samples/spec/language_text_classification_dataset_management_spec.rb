...
describe "Language Text Classification Dataset Management" do
  ...
  let(:import_file_path) { "classification-import.csv" }
  ...
  example "Create, import, delete a dataset", :slow do
    ...
    dataset_id = nil
    capture do
      dataset_id = text_classification_create_dataset actual_project_id: project_id, actual_display_name: dataset_name
    end
