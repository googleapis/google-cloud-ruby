...
xdescribe "Vision Classification Dataset Management" do
  ...
  example "Create, import, delete a dataset", :slow do
    ...
    import_file = ensure_import_file! bucket, "vision-class-import.csv"

    dataset_id = nil
    capture do
      dataset_id = classification_create_dataset actual_project_id: project_id, actual_display_name: dataset_name
    end
