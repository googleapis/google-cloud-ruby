...
describe "Language Entity Extraction Dataset Management" do
  ...
  example "Create, import, delete a dataset", :slow do
    ...
    import_file = "gs://cloud-samples-data/automl/language_entity_extraction/dataset.csv"

    dataset_id = nil
    capture do
      dataset_id = entity_extraction_create_dataset actual_project_id: project_id, actual_display_name: dataset_name
    end
