...
describe "Vision Object Detection Dataset Management" do
  ...
  example "Create, import, delete a dataset", :slow do
    ...
    dataset_id = nil
    capture do
      dataset_id = object_detection_create_dataset actual_project_id: project_id, actual_display_name: dataset_name
    end
