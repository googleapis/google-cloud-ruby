  ...
  module Cloud
    module AutoML
      module V1beta1
        ...
        class VideoClassificationDatasetMetadata; end

        # Dataset metadata specific to video object tracking.
        class VideoObjectTrackingDatasetMetadata; end

        # Model metadata specific to video classification.
        class VideoClassificationModelMetadata; end

        # Model metadata specific to video object tracking.
        class VideoObjectTrackingModelMetadata; end
      end
    end
  end
end