  ...
  def test_create_job
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_create_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_job_client_stub do
        ...
        # Use protobuf object
        client.create_job ::Google::Cloud::Talent::V4::CreateJobRequest.new(parent: parent, job: job) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.create_job(::Google::Cloud::Talent::V4::CreateJobRequest.new(parent: parent, job: job), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_batch_create_jobs
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_batch_create_jobs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_create_jobs_client_stub do
        ...
        # Use protobuf object
        client.batch_create_jobs ::Google::Cloud::Talent::V4::BatchCreateJobsRequest.new(parent: parent, jobs: jobs) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.batch_create_jobs(::Google::Cloud::Talent::V4::BatchCreateJobsRequest.new(parent: parent, jobs: jobs), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_job
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_get_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_job_client_stub do
        ...
        # Use protobuf object
        client.get_job ::Google::Cloud::Talent::V4::GetJobRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.get_job(::Google::Cloud::Talent::V4::GetJobRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_job
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_update_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_job_client_stub do
        ...
        # Use protobuf object
        client.update_job ::Google::Cloud::Talent::V4::UpdateJobRequest.new(job: job, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.update_job(::Google::Cloud::Talent::V4::UpdateJobRequest.new(job: job, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_batch_update_jobs
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_batch_update_jobs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_update_jobs_client_stub do
        ...
        # Use protobuf object
        client.batch_update_jobs ::Google::Cloud::Talent::V4::BatchUpdateJobsRequest.new(parent: parent, jobs: jobs, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.batch_update_jobs(::Google::Cloud::Talent::V4::BatchUpdateJobsRequest.new(parent: parent, jobs: jobs, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_delete_job
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_delete_job_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_job_client_stub do
        ...
        # Use protobuf object
        client.delete_job ::Google::Cloud::Talent::V4::DeleteJobRequest.new(name: name) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.delete_job(::Google::Cloud::Talent::V4::DeleteJobRequest.new(name: name), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_batch_delete_jobs
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_batch_delete_jobs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, batch_delete_jobs_client_stub do
        ...
        # Use hash object
        client.batch_delete_jobs({ parent: parent, names: names }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object
        client.batch_delete_jobs ::Google::Cloud::Talent::V4::BatchDeleteJobsRequest.new(parent: parent, names: names) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use hash object with options
        client.batch_delete_jobs({ parent: parent, names: names }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end

        # Use protobuf object with options
        client.batch_delete_jobs(::Google::Cloud::Talent::V4::BatchDeleteJobsRequest.new(parent: parent, names: names), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_list_jobs
    ...
    ::Google::Cloud::Talent::V4::JobService::Rest::ServiceStub.stub :transcode_list_jobs_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_jobs_client_stub do
        ...
        # Use protobuf object
        client.list_jobs ::Google::Cloud::Talent::V4::ListJobsRequest.new(parent: parent, filter: filter, page_token: page_token, page_size: page_size, job_view: job_view) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.list_jobs(::Google::Cloud::Talent::V4::ListJobsRequest.new(parent: parent, filter: filter, page_token: page_token, page_size: page_size, job_view: job_view), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
