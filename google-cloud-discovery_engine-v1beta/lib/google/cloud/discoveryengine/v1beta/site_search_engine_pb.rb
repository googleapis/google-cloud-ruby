  ...
  module Cloud
    module DiscoveryEngine
      module V1beta
        ...
        Sitemap = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.discoveryengine.v1beta.Sitemap").msgclass
      end
    end
  end
end
