      ...
      module V1beta
        module SiteSearchEngineService
          ...
          module Paths
            ...
            #
            # @overload site_search_engine_path(project:, location:, data_store:)
            ...
            #
            # @overload site_search_engine_path(project:, location:, collection:, data_store:)
            #   The resource will be in the following format:
            #
            ...
            #
            # @return [::String]
            def site_search_engine_path **args
              resources = {
            ...
            #
            # @overload target_site_path(project:, location:, collection:, data_store:, target_site:)
            #   The resource will be in the following format:
            #
            ...
            #
            # @return [::String]
            def target_site_path **args
              resources = {
                "data_store:location:project:target_site" => (proc do |project:, location:, data_store:, target_site:|
                  raise ::ArgumentError, "project cannot contain /" if project.to_s.include? "/"
                  raise ::ArgumentError, "location cannot contain /" if location.to_s.include? "/"
                ...
                "collection:data_store:location:project:target_site" => (proc do |project:, location:, collection:, data_store:, target_site:|
                  raise ::ArgumentError, "project cannot contain /" if project.to_s.include? "/"
                  raise ::ArgumentError, "location cannot contain /" if location.to_s.include? "/"
                  raise ::ArgumentError, "collection cannot contain /" if collection.to_s.include? "/"
                  raise ::ArgumentError, "data_store cannot contain /" if data_store.to_s.include? "/"
