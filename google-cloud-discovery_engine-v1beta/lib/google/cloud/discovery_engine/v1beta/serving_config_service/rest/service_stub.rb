        ...
        module ServingConfigService
          module Rest
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::DiscoveryEngine::V1beta::CreateServingConfigRequest]
              ...
              def create_serving_config request_pb, options = nil
                ...
                result = ::Google::Cloud::DiscoveryEngine::V1beta::ServingConfig.decode_json response.body, ignore_unknown_fields: true
                catch :response do
              ...
              #
              # @param request_pb [::Google::Cloud::DiscoveryEngine::V1beta::DeleteServingConfigRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::DiscoveryEngine::V1beta::UpdateServingConfigRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::DiscoveryEngine::V1beta::GetServingConfigRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::DiscoveryEngine::V1beta::ListServingConfigsRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::DiscoveryEngine::V1beta::ListServingConfigsResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::DiscoveryEngine::V1beta::ListServingConfigsResponse]
              #   A result object deserialized from the server's reply
              def list_serving_configs request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::DiscoveryEngine::V1beta::ListServingConfigsResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              def self.transcode_create_serving_config_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1beta/{parent}/servingConfigs",
                                                          body: "serving_config",
                                                          matches: [
              ...
              def self.transcode_delete_serving_config_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          ...
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/dataStores/[^/]+/servingConfigs/[^/]+/?$}, false]
                                                          ]
                                                        )
                                                        .with_bindings(
                                                          uri_method: :delete,
                                                          uri_template: "/v1beta/{name}",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/collections/[^/]+/dataStores/[^/]+/servingConfigs/[^/]+/?$}, false]
                                                          ]
                                                        )
                                                        .with_bindings(
                                                          uri_method: :delete,
                                                          uri_template: "/v1beta/{name}",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/collections/[^/]+/engines/[^/]+/servingConfigs/[^/]+/?$}, false]
                                                          ]
                                                        )
                transcoder.transcode request_pb
              end
              ...
              def self.transcode_update_serving_config_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :patch,
                                                          uri_template: "/v1beta/{serving_config.name}",
                                                          body: "serving_config",
                                                          matches: [
