...
require "google/cloud/discovery_engine/v1beta/user_license_service/rest/service_stub"
        ...
        module UserLicenseService
          module Rest
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Rest::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all UserLicenseService clients
              #   ::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Rest::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @operations_client = ::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Rest::Operations.new do |config|
                ...
                @user_license_service_stub = ::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Rest::ServiceStub.new(
              ...
              #
              # @return [::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Rest::Operations]
              #
              ...
              #   {::Google::Cloud::DiscoveryEngine::V1beta::ListUserLicensesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::DiscoveryEngine::V1beta::ListUserLicensesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload list_user_licenses(parent: nil, page_size: nil, page_token: nil, filter: nil, order_by: nil)
              ...
              # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Google::Cloud::DiscoveryEngine::V1beta::UserLicense>]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Gapic::Rest::PagedEnumerable<::Google::Cloud::DiscoveryEngine::V1beta::UserLicense>]
              #
              ...
              def list_user_licenses request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DiscoveryEngine::V1beta::ListUserLicensesRequest
              ...
              ##
              # Lists all the
              # {::Google::Cloud::DiscoveryEngine::V1beta::LicenseConfigUsageStats LicenseConfigUsageStats}s
              # associated with the project.
              #
              # @overload list_license_configs_usage_stats(request, options = nil)
              #   Pass arguments to `list_license_configs_usage_stats` via a request object, either of type
              #   {::Google::Cloud::DiscoveryEngine::V1beta::ListLicenseConfigsUsageStatsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::DiscoveryEngine::V1beta::ListLicenseConfigsUsageStatsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @overload list_license_configs_usage_stats(parent: nil)
              #   Pass arguments to `list_license_configs_usage_stats` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param parent [::String]
              ...
              #     `projects/{project}/locations/{location}/userStores/{user_store_id}`.
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::DiscoveryEngine::V1beta::ListLicenseConfigsUsageStatsResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              # @return [::Google::Cloud::DiscoveryEngine::V1beta::ListLicenseConfigsUsageStatsResponse]
              #
              # @raise [::Google::Cloud::Error] if the REST call is aborted.
              #
              # @example Basic example
              ...
              #   p result
              #
              def list_license_configs_usage_stats request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DiscoveryEngine::V1beta::ListLicenseConfigsUsageStatsRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                call_metadata = @config.rpcs.list_license_configs_usage_stats.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.list_license_configs_usage_stats.timeout,
                                       metadata:     call_metadata,
                                       retry_policy: @config.rpcs.list_license_configs_usage_stats.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @user_license_service_stub.list_license_configs_usage_stats request, options do |result, operation|
                  yield result, operation if block_given?
                end
              rescue ::Gapic::Rest::Error => e
                raise ::Google::Cloud::Error.from_error(e)
              ...
              #   {::Google::Cloud::DiscoveryEngine::V1beta::BatchUpdateUserLicensesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::DiscoveryEngine::V1beta::BatchUpdateUserLicensesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              ...
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param inline_source [::Google::Cloud::DiscoveryEngine::V1beta::BatchUpdateUserLicensesRequest::InlineSource, ::Hash]
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::DiscoveryEngine::V1beta::BatchUpdateUserLicensesRequest.new
              #
              ...
              def batch_update_user_licenses request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DiscoveryEngine::V1beta::BatchUpdateUserLicensesRequest
              ...
              # {::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Rest::Client::Configuration::Rpcs}
              ...
              class Configuration
                ...
                class Rpcs
                  ...
                  ##
                  # RPC-specific configuration for `list_license_configs_usage_stats`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :list_license_configs_usage_stats
                  ##
                  ...
                  def initialize parent_rpcs = nil
                    ...
                    list_license_configs_usage_stats_config = parent_rpcs.list_license_configs_usage_stats if parent_rpcs.respond_to? :list_license_configs_usage_stats
                    @list_license_configs_usage_stats = ::Gapic::Config::Method.new list_license_configs_usage_stats_config
