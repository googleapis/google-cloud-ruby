      ...
      module V1beta
        module UserLicenseService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all UserLicenseService clients
            #   ::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @user_license_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Stub,
            ...
            #
            # @return [::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Operations]
            #
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::DiscoveryEngine::V1beta::UserLicense>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::DiscoveryEngine::V1beta::UserLicense>]
            #
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::DiscoveryEngine::V1beta::ListLicenseConfigsUsageStatsResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def list_license_configs_usage_stats request, options = nil
              ...
              # Customize the options with defaults
              metadata = @config.rpcs.list_license_configs_usage_stats.metadata.to_h
              ...
              @user_license_service_stub.call_rpc :list_license_configs_usage_stats, request, options: options do |response, operation|
                yield response, operation if block_given?
              end
            rescue ::GRPC::BadStatus => e
              raise ::Google::Cloud::Error.from_error(e)
            ...
            # {::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Client::Configuration::Rpcs}
