# Ruby Client for the Discovery Engine V1BETA API
...
specific version of the Discovery Engine V1BETA API. Most users should consider using
the main client gem,
...
is part of the name, e.g. `google-cloud-discovery_engine-v1beta`.
