...
##
# Snippet for the advanced_complete_query call in the CompletionService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::CompletionService::Client#advanced_complete_query.
#
