...
##
# Snippet for the enable_advanced_site_search call in the SiteSearchEngineService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::SiteSearchEngineService::Client#enable_advanced_site_search.
#
