...
##
# Snippet for the get_target_site call in the SiteSearchEngineService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::SiteSearchEngineService::Client#get_target_site.
#
def get_target_site
