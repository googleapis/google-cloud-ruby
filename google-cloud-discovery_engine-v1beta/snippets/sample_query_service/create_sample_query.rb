...
##
# Snippet for the create_sample_query call in the SampleQueryService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::SampleQueryService::Client#create_sample_query.
#
