...
##
# Snippet for the get_license_config call in the LicenseConfigService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::LicenseConfigService::Client#get_license_config.
#
