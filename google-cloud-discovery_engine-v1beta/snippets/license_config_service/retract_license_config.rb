...
##
# Snippet for the retract_license_config call in the LicenseConfigService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::LicenseConfigService::Client#retract_license_config.
#
