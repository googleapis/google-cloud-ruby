...
##
# Snippet for the distribute_license_config call in the LicenseConfigService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::LicenseConfigService::Client#distribute_license_config.
#
