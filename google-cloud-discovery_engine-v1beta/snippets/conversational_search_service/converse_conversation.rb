...
##
# Snippet for the converse_conversation call in the ConversationalSearchService service
#
...
# Google::Cloud::DiscoveryEngine::V1beta::ConversationalSearchService::Client#converse_conversation.
#
