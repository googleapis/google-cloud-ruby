...
class ::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_license_config_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      client = ::Google::Cloud::DiscoveryEngine::V1beta::UserLicenseService::Client.new do |config|
