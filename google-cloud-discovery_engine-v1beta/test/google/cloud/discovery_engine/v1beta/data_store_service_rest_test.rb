...
class ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_data_store
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Rest::ServiceStub.stub :transcode_create_data_store_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_data_store_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_data_store_client_stub.call_count
      end
    end
  end
  ...
  def test_get_data_store
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::DataStore.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Rest::ServiceStub.stub :transcode_get_data_store_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_data_store_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_data_store_client_stub.call_count
      end
    end
  end
  ...
  def test_list_data_stores
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::ListDataStoresResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Rest::ServiceStub.stub :transcode_list_data_stores_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_data_stores_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_data_stores_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_data_store
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Rest::ServiceStub.stub :transcode_delete_data_store_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_data_store_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_data_store_client_stub.call_count
      end
    end
  end
  ...
  def test_update_data_store
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Rest::ServiceStub.stub :transcode_update_data_store_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_data_store_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_data_store_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::DataStoreService::Rest::Client::Configuration, config
  end
end
