...
require "google/cloud/discovery_engine/v1beta/identity_mapping_store_service"

class ::Google::Cloud::DiscoveryEngine::V1beta::IdentityMappingStoreService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
