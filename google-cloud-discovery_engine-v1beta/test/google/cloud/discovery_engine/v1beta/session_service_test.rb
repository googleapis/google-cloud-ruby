...
class ::Google::Cloud::DiscoveryEngine::V1beta::SessionService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_session
    ...
    Gapic::ServiceStub.stub :new, create_session_client_stub do
      # Create client
      c = ::Google::Cloud::DiscoveryEngine::V1beta::SessionService::Client.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::SessionService::Client::Configuration, config
  end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::SessionService::Client, client
