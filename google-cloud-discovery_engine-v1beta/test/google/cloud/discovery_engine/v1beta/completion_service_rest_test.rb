  ...
  def test_complete_query
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::CompletionService::Rest::ServiceStub.stub :transcode_complete_query_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, complete_query_client_stub do
        ...
        # Use protobuf object
        client.complete_query ::Google::Cloud::DiscoveryEngine::V1beta::CompleteQueryRequest.new(data_store: data_store, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id, include_tail_suggestions: include_tail_suggestions) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.complete_query(::Google::Cloud::DiscoveryEngine::V1beta::CompleteQueryRequest.new(data_store: data_store, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id, include_tail_suggestions: include_tail_suggestions), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_advanced_complete_query
    ...
    ::Google::Cloud::DiscoveryEngine::V1beta::CompletionService::Rest::ServiceStub.stub :transcode_advanced_complete_query_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, advanced_complete_query_client_stub do
        ...
        # Use hash object
        client.advanced_complete_query({ completion_config: completion_config, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id, user_info: user_info, include_tail_suggestions: include_tail_suggestions, boost_spec: boost_spec, suggestion_types: suggestion_types }) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use hash object with options
        client.advanced_complete_query({ completion_config: completion_config, query: query, query_model: query_model, user_pseudo_id: user_pseudo_id, user_info: user_info, include_tail_suggestions: include_tail_suggestions, boost_spec: boost_spec, suggestion_types: suggestion_types }, call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
