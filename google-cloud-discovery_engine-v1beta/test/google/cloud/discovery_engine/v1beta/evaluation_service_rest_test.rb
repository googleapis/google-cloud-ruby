...
require "google/cloud/discovery_engine/v1beta/evaluation_service/rest"


class ::Google::Cloud::DiscoveryEngine::V1beta::EvaluationService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_evaluation
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::Evaluation.new
  ...
  def test_list_evaluations
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::ListEvaluationsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_create_evaluation
    ...
    create_evaluation_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_list_evaluation_results
    # Create test objects.
    client_result = ::Google::Cloud::DiscoveryEngine::V1beta::ListEvaluationResultsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_evaluation_results_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DiscoveryEngine::V1beta::EvaluationService::Rest::Client::Configuration, config
  end
end
