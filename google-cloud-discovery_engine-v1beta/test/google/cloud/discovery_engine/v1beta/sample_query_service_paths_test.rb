...
class ::Google::Cloud::DiscoveryEngine::V1beta::SampleQueryService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_sample_query_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.sample_query_path project: "value0", location: "value1", sample_query_set: "value2", sample_query: "value3"
      assert_equal "projects/value0/locations/value1/sampleQuerySets/value2/sampleQueries/value3", path
    end
  end
