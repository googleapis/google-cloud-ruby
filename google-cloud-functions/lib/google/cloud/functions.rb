...
::Google::Cloud.configure.add_config! :functions do |config|
  config.add_field! :endpoint,      "cloudfunctions.googleapis.com", match: ::String
...
module Google
  module Cloud
    module Functions
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.functions if block_given?

        ::Google::Cloud.configure.functions
      end
    end
  end
end

helper_path = ::File.join __dir__, "functions", "helpers.rb"
require "google/cloud/functions/helpers" if ::File.file? helper_path
