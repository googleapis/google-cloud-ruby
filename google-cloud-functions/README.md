...
The gem `google-cloud-functions` is the main client library that brings the
versioned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-functions/latest)
for this library, google-cloud-functions, to see the convenience methods for
...
request = ::Google::Cloud::Functions::V2::GetFunctionRequest.new # (request fields as keyword arguments...)
