...
In general, the google-cloud-functions library uses
...
```sh
export FUNCTIONS_CREDENTIALS=path/to/keyfile.json
```
...
The google-cloud-functions library aims to make authentication
...
The environment variables that google-cloud-functions
...
Google::Cloud::Functions.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-functions.
