...
the main client gem,
[google-shopping-merchant-reviews](https://rubygems.org/gems/google-shopping-merchant-reviews).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-shopping-merchant-reviews-v1beta
```
...
View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-reviews-v1beta)
...
client library with a name such as `google-shopping-merchant-reviews`,
...
is part of the name, e.g. `google-shopping-merchant-reviews-v1beta`.
