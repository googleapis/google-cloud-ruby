...
##
# Snippet for the list_product_reviews call in the ProductReviewsService service
#
...
# Google::Shopping::Merchant::Reviews::V1beta::ProductReviewsService::Client#list_product_reviews.
#
