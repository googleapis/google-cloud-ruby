...
##
# Snippet for the query_capacity_plans call in the CapacityPlanningService service
#
...
# Google::Cloud::CapacityPlanner::V1beta::CapacityPlanningService::Client#query_capacity_plans.
#
def query_capacity_plans
