...
class ::Google::Cloud::BinaryAuthorization::V1::BinauthzManagementService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_attestor_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.attestor_path project: "value0", attestor: "value1"
      assert_equal "projects/value0/attestors/value1", path
    end
  end
