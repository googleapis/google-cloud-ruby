    ...
    it 'invokes import_ssh_public_key without error' do
      ...
      Google::Cloud::Oslogin::V1::OsLoginService::Stub.stub(:new, mock_stub) do
        Google::Cloud::OsLogin::V1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          response = client.import_ssh_public_key(formatted_parent)

          # Verify the response
          assert_equal(expected_response, response)

          # Call method with block
          client.import_ssh_public_key(formatted_parent) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
            refute_nil(operation)
          end
    ...
    it 'invokes import_ssh_public_key with error' do
      ...
      Google::Cloud::Oslogin::V1::OsLoginService::Stub.stub(:new, mock_stub) do
        Google::Cloud::OsLogin::V1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          err = assert_raises Google::Gax::GaxError, CustomTestError_v1 do
            client.import_ssh_public_key(formatted_parent)
          end
