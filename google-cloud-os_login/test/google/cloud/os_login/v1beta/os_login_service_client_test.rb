...
class MockOsLoginServiceCredentials_v1beta < Google::Cloud::OsLogin::V1beta::Credentials
...
describe Google::Cloud::OsLogin::V1beta::OsLoginServiceClient do

  describe 'delete_posix_account' do
    custom_error = CustomTestError_v1beta.new "Custom test error for Google::Cloud::OsLogin::V1beta::OsLoginServiceClient#delete_posix_account."
    ...
    it 'invokes delete_posix_account without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta.new(:delete_posix_account, mock_method)

      # Mock auth layer
      mock_credentials = MockOsLoginServiceCredentials_v1beta.new("delete_posix_account")

      Google::Cloud::Oslogin::V1beta::OsLoginService::Stub.stub(:new, mock_stub) do
        Google::Cloud::OsLogin::V1beta::Credentials.stub(:default, mock_credentials) do
          client = Google::Cloud::OsLogin::V1beta.new
  ...
  describe 'delete_ssh_public_key' do
    custom_error = CustomTestError_v1beta.new "Custom test error for Google::Cloud::OsLogin::V1beta::OsLoginServiceClient#delete_ssh_public_key."
    ...
    it 'invokes delete_ssh_public_key without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta.new(:delete_ssh_public_key, mock_method)

      # Mock auth layer
      mock_credentials = MockOsLoginServiceCredentials_v1beta.new("delete_ssh_public_key")
  ...
  describe 'get_login_profile' do
    custom_error = CustomTestError_v1beta.new "Custom test error for Google::Cloud::OsLogin::V1beta::OsLoginServiceClient#get_login_profile."
    ...
    it 'invokes get_login_profile without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta.new(:get_login_profile, mock_method)

      # Mock auth layer
      mock_credentials = MockOsLoginServiceCredentials_v1beta.new("get_login_profile")
  ...
  describe 'get_ssh_public_key' do
    custom_error = CustomTestError_v1beta.new "Custom test error for Google::Cloud::OsLogin::V1beta::OsLoginServiceClient#get_ssh_public_key."
    ...
    it 'invokes get_ssh_public_key without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta.new(:get_ssh_public_key, mock_method)

      # Mock auth layer
      mock_credentials = MockOsLoginServiceCredentials_v1beta.new("get_ssh_public_key")
  ...
  describe 'import_ssh_public_key' do
    custom_error = CustomTestError_v1beta.new "Custom test error for Google::Cloud::OsLogin::V1beta::OsLoginServiceClient#import_ssh_public_key."
    ...
    it 'invokes import_ssh_public_key without error' do
      ...
      # Create expected grpc response
      expected_response = {}
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Oslogin::V1beta::ImportSshPublicKeyResponse)
      ...
      mock_stub = MockGrpcClientStub_v1beta.new(:import_ssh_public_key, mock_method)

      # Mock auth layer
      mock_credentials = MockOsLoginServiceCredentials_v1beta.new("import_ssh_public_key")
  ...
  describe 'update_ssh_public_key' do
    custom_error = CustomTestError_v1beta.new "Custom test error for Google::Cloud::OsLogin::V1beta::OsLoginServiceClient#update_ssh_public_key."
    ...
    it 'invokes update_ssh_public_key without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta.new(:update_ssh_public_key, mock_method)

      # Mock auth layer
      mock_credentials = MockOsLoginServiceCredentials_v1beta.new("update_ssh_public_key")
