...
module Google
  module Cloud
    ...
    module OsLogin
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("os_login"))
      ...
      def self.new(*args, version: :v1, **kwargs)
        ...
        version_module = Google::Cloud::OsLogin
          .constants
          .select {|sym| sym.to_s.downcase == version.to_s.downcase}
          .first
        Google::Cloud::OsLogin.const_get(version_module).new(*args, **kwargs)
      end
    end
  end
end
