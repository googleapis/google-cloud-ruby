# Ruby Client for the Network Management API

API Client library for the Network Management API

The Network Management API provides a collection of network performance monitoring and diagnostic capabilities.

Actual client classes for the various versions of this API are defined in
_versioned_ client gems, with names of the form `google-cloud-network_management-v*`.
The gem `google-cloud-network_management` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-network_management/latest)
for this library, google-cloud-network_management, to see the convenience methods for
...
```
$ gem install google-cloud-network_management
```
