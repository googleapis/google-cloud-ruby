...
class ::Google::Cloud::Build::V1::CloudBuild::ClientTest < Minitest::Test
  ...
  def test_create_build
    ...
    Gapic::ServiceStub.stub :new, create_build_client_stub do
      ...
      # Use hash object
      client.create_build({ project_id: project_id, build: build }) do |response, operation|
      ...
      # Use protobuf object
      client.create_build ::Google::Cloud::Build::V1::CreateBuildRequest.new(project_id: project_id, build: build) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      client.create_build({ project_id: project_id, build: build }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      client.create_build ::Google::Cloud::Build::V1::CreateBuildRequest.new(project_id: project_id, build: build), grpc_options do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_build
    ...
    Gapic::ServiceStub.stub :new, get_build_client_stub do
      ...
      # Use hash object
      client.get_build({ project_id: project_id, id: id }) do |response, operation|
      ...
      # Use protobuf object
      client.get_build ::Google::Cloud::Build::V1::GetBuildRequest.new(project_id: project_id, id: id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.get_build({ project_id: project_id, id: id }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.get_build ::Google::Cloud::Build::V1::GetBuildRequest.new(project_id: project_id, id: id), grpc_options do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_builds
    ...
    Gapic::ServiceStub.stub :new, list_builds_client_stub do
      ...
      # Use hash object
      client.list_builds({ project_id: project_id, page_size: page_size, page_token: page_token, filter: filter }) do |response, operation|
      ...
      # Use protobuf object
      client.list_builds ::Google::Cloud::Build::V1::ListBuildsRequest.new(project_id: project_id, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.list_builds({ project_id: project_id, page_size: page_size, page_token: page_token, filter: filter }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_builds ::Google::Cloud::Build::V1::ListBuildsRequest.new(project_id: project_id, page_size: page_size, page_token: page_token, filter: filter), grpc_options do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_cancel_build
    ...
    Gapic::ServiceStub.stub :new, cancel_build_client_stub do
      ...
      # Use hash object
      client.cancel_build({ project_id: project_id, id: id }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.cancel_build ::Google::Cloud::Build::V1::CancelBuildRequest.new(project_id: project_id, id: id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.cancel_build({ project_id: project_id, id: id }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.cancel_build ::Google::Cloud::Build::V1::CancelBuildRequest.new(project_id: project_id, id: id), grpc_options do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_retry_build
    ...
    Gapic::ServiceStub.stub :new, retry_build_client_stub do
      ...
      # Use hash object
      client.retry_build({ project_id: project_id, id: id }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.retry_build ::Google::Cloud::Build::V1::RetryBuildRequest.new(project_id: project_id, id: id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.retry_build({ project_id: project_id, id: id }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.retry_build ::Google::Cloud::Build::V1::RetryBuildRequest.new(project_id: project_id, id: id), grpc_options do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_worker_pool
    ...
    Gapic::ServiceStub.stub :new, create_worker_pool_client_stub do
      ...
      # Use hash object
      client.create_worker_pool({ parent: parent, worker_pool: worker_pool }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.create_worker_pool ::Google::Cloud::Build::V1::CreateWorkerPoolRequest.new(parent: parent, worker_pool: worker_pool) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.create_worker_pool({ parent: parent, worker_pool: worker_pool }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_worker_pool
    ...
    Gapic::ServiceStub.stub :new, delete_worker_pool_client_stub do
      ...
      # Use hash object
      client.delete_worker_pool({ name: name }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.delete_worker_pool ::Google::Cloud::Build::V1::DeleteWorkerPoolRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.delete_worker_pool({ name: name }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_worker_pool
    ...
    Gapic::ServiceStub.stub :new, update_worker_pool_client_stub do
      ...
      # Use hash object
      client.update_worker_pool({ name: name, worker_pool: worker_pool }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.update_worker_pool ::Google::Cloud::Build::V1::UpdateWorkerPoolRequest.new(name: name, worker_pool: worker_pool) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.update_worker_pool({ name: name, worker_pool: worker_pool }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_worker_pools
    ...
    Gapic::ServiceStub.stub :new, list_worker_pools_client_stub do
      ...
      # Use hash object
      client.list_worker_pools({ parent: parent }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.list_worker_pools ::Google::Cloud::Build::V1::ListWorkerPoolsRequest.new(parent: parent) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.list_worker_pools({ parent: parent }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
