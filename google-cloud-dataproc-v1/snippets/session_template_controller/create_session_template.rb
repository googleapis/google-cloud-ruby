...
##
# Snippet for the create_session_template call in the SessionTemplateController service
#
...
# Google::Cloud::Dataproc::V1::SessionTemplateController::Client#create_session_template.
#
