...
class ::Google::Cloud::Dataproc::V1::SessionController::ClientTest < Minitest::Test
  ...
  def test_create_session
    ...
    create_session_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dataproc::V1::CreateSessionRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dataproc::V1::Session), request["session"]
  ...
  def test_get_session
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dataproc::V1::Session.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_session_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dataproc::V1::GetSessionRequest, request
  ...
  def test_list_sessions
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dataproc::V1::ListSessionsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_sessions_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dataproc::V1::ListSessionsRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_terminate_session
    ...
    terminate_session_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :terminate_session, name
      assert_kind_of ::Google::Cloud::Dataproc::V1::TerminateSessionRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, terminate_session_client_stub do
      ...
      # Verify method calls
      assert_equal 5, terminate_session_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_session
    ...
    delete_session_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dataproc::V1::DeleteSessionRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dataproc::V1::SessionController::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Dataproc::V1::SessionController::Operations, client.operations_client
  end
end
