...
class ::Google::Cloud::Dataproc::V1::SessionTemplateController::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_session_template_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.session_template_path project: "value0", location: "value1", template: "value2"
      assert_equal "projects/value0/locations/value1/sessionTemplates/value2", path
    end
  end
end
