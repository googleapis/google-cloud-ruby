...
require "google/cloud/dataproc/v1/session_template_controller/rest"


class ::Google::Cloud::Dataproc::V1::SessionTemplateController::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_session_template
    # Create test objects.
    client_result = ::Google::Cloud::Dataproc::V1::SessionTemplate.new
    ...
    create_session_template_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::Dataproc::V1::SessionTemplateController::Rest::ServiceStub.stub :transcode_create_session_template_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_session_template_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_session_template_client_stub.call_count
      end
    end
  end

  def test_update_session_template
    # Create test objects.
    client_result = ::Google::Cloud::Dataproc::V1::SessionTemplate.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    update_session_template_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dataproc::V1::SessionTemplateController::Rest::ServiceStub.stub :transcode_update_session_template_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_session_template_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_session_template_client_stub.call_count
      end
    end
  end

  def test_get_session_template
    # Create test objects.
    client_result = ::Google::Cloud::Dataproc::V1::SessionTemplate.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_session_template_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dataproc::V1::SessionTemplateController::Rest::ServiceStub.stub :transcode_get_session_template_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_session_template_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_session_template_client_stub.call_count
      end
    end
  end
  ...
  def test_list_session_templates
    # Create test objects.
    client_result = ::Google::Cloud::Dataproc::V1::ListSessionTemplatesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_session_templates_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dataproc::V1::SessionTemplateController::Rest::ServiceStub.stub :transcode_list_session_templates_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_session_templates_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_session_templates_client_stub.call_count
      end
    end
  end

  def test_delete_session_template
    # Create test objects.
    ...
    delete_session_template_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::Dataproc::V1::SessionTemplateController::Rest::ServiceStub.stub :transcode_delete_session_template_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_session_template_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_session_template_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dataproc::V1::SessionTemplateController::Rest::Client::Configuration, config
  end
end
