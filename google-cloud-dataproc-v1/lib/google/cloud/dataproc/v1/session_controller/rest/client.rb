          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @session_controller_stub.logger(stub: true)&.info do |entry|
                ...
                @iam_policy_client = Google::Iam::V1::IAMPolicy::Rest::Client.new do |config|
                  ...
                  config.logger = @session_controller_stub.logger if config.respond_to? :logger=
                end
              end
              ...
              #
              def logger
                @session_controller_stub.logger
              end
