...
##
# Snippet for the create_ca_pool call in the CertificateAuthorityService service
#
...
# Google::Cloud::Security::PrivateCA::V1::CertificateAuthorityService::Client#create_ca_pool.
#
def create_ca_pool
