...
##
# Snippet for the update_ca_pool call in the CertificateAuthorityService service
#
...
# Google::Cloud::Security::PrivateCA::V1::CertificateAuthorityService::Client#update_ca_pool.
#
def update_ca_pool
