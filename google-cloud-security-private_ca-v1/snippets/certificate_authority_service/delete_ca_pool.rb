...
##
# Snippet for the delete_ca_pool call in the CertificateAuthorityService service
#
...
# Google::Cloud::Security::PrivateCA::V1::CertificateAuthorityService::Client#delete_ca_pool.
#
def delete_ca_pool
