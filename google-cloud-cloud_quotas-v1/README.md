# Ruby Client for the Cloud Quotas V1 API
...
specific version of the Cloud Quotas V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-cloud_quotas-v1
```
...
is part of the name, e.g. `google-cloud-cloud_quotas-v1`.
