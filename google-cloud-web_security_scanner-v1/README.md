...
specific version of the Web Security Scanner V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-web_security_scanner-v1
```
...
client library with a name such as `google-cloud-web_security_scanner`,
...
is part of the name, e.g. `google-cloud-web_security_scanner-v1`.
