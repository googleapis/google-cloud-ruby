...
class ::Google::Cloud::Sql::V1beta4::SqlUsersService::ClientTest < Minitest::Test
  ...
  def test_delete
    ...
    Gapic::ServiceStub.stub :new, delete_client_stub do
      # Create client
      c = ::Google::Cloud::Sql::V1beta4::SqlUsersService::Client.new do |config|
      ...
      # Use protobuf object
      c.delete ::Google::Cloud::Sql::V1beta4::SqlUsersDeleteRequest.new(host: host, instance: instance, name: name, project: project) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      c.delete(::Google::Cloud::Sql::V1beta4::SqlUsersDeleteRequest.new(host: host, instance: instance, name: name, project: project), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Sql::V1beta4::User.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Sql::V1beta4::SqlUsersGetRequest, request
      assert_equal "hello world", request["instance"]
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["project"]
      assert_equal "hello world", request["host"]
    ...
    Gapic::ServiceStub.stub :new, get_client_stub do
      ...
      # Use protobuf object
      c.get ::Google::Cloud::Sql::V1beta4::SqlUsersGetRequest.new(instance: instance, name: name, project: project, host: host) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.get(::Google::Cloud::Sql::V1beta4::SqlUsersGetRequest.new(instance: instance, name: name, project: project, host: host), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_insert
    ...
    Gapic::ServiceStub.stub :new, insert_client_stub do
      ...
      # Use protobuf object
      c.insert ::Google::Cloud::Sql::V1beta4::SqlUsersInsertRequest.new(instance: instance, project: project, body: body) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.insert(::Google::Cloud::Sql::V1beta4::SqlUsersInsertRequest.new(instance: instance, project: project, body: body), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list
    ...
    Gapic::ServiceStub.stub :new, list_client_stub do
      ...
      # Use protobuf object
      c.list ::Google::Cloud::Sql::V1beta4::SqlUsersListRequest.new(instance: instance, project: project) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      c.list(::Google::Cloud::Sql::V1beta4::SqlUsersListRequest.new(instance: instance, project: project), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update
    ...
    Gapic::ServiceStub.stub :new, update_client_stub do
      ...
      # Use protobuf object
      c.update ::Google::Cloud::Sql::V1beta4::SqlUsersUpdateRequest.new(host: host, instance: instance, name: name, project: project, database_roles: database_roles, revoke_existing_roles: revoke_existing_roles, server_roles: server_roles, revoke_existing_server_roles: revoke_existing_server_roles, body: body) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_credentials
    ...
    Gapic::ServiceStub.stub :new, dummy_stub do
      ...
      assert_kind_of ::Google::Cloud::Sql::V1beta4::SqlUsersService::Client, client
