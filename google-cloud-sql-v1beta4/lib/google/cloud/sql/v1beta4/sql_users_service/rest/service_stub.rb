    ...
    module Sql
      module V1beta4
        module SqlUsersService
          module Rest
            ##
            # REST service stub for the SqlUsersService service.
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlUsersDeleteRequest]
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlUsersGetRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def get request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Sql::V1beta4::User.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlUsersInsertRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlUsersListRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def list request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Sql::V1beta4::UsersListResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlUsersUpdateRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def self.transcode_delete_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :delete,
                                                          uri_template: "/sql/v1beta4/projects/{project}/instances/{instance}/users",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["instance", %r{^[^/]+/?$}, false]
                                                          ]
              ...
              def self.transcode_get_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/sql/v1beta4/projects/{project}/instances/{instance}/users/{name}",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["instance", %r{^[^/]+/?$}, false],
                                                            ["name", %r{^[^/]+/?$}, false]
