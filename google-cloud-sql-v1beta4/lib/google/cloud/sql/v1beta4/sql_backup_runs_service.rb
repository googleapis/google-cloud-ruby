...
require "google/cloud/sql/v1beta4/sql_backup_runs_service/client"
...
require "google/cloud/sql/v1beta4/sql_backup_runs_service/helpers" if ::File.file? helper_path
