    ...
    module Sql
      module V1beta4
        module SqlOperationsService
          module Rest
            ##
            # REST service stub for the SqlOperationsService service.
            ...
            class ServiceStub
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlOperationsGetRequest]
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlOperationsListRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              # @yield [result, operation] Access the result along with the TransportOperation object
              # @yieldparam result [::Google::Cloud::Sql::V1beta4::OperationsListResponse]
              # @yieldparam operation [::Gapic::Rest::TransportOperation]
              #
              ...
              def list request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Sql::V1beta4::OperationsListResponse.decode_json response.body, ignore_unknown_fields: true
                catch :response do
                  yield result, operation if block_given?
                  result
                end
              ...
              #
              # @param request_pb [::Google::Cloud::Sql::V1beta4::SqlOperationsCancelRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def self.transcode_get_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/sql/v1beta4/projects/{project}/operations/{operation}",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["operation", %r{^[^/]+/?$}, false]
                                                          ]
              ...
              def self.transcode_list_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :get,
                                                          uri_template: "/sql/v1beta4/projects/{project}/operations",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false]
                                                          ]
                                                        )
              ...
              def self.transcode_cancel_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/sql/v1beta4/projects/{project}/operations/{operation}/cancel",
                                                          matches: [
                                                            ["project", %r{^[^/]+/?$}, false],
                                                            ["operation", %r{^[^/]+/?$}, false]
                                                          ]
