...
class ::Google::Longrunning::Operations::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    # Create test objects.
    client_result = ::Google::Longrunning::ListOperationsResponse.new
  ...
  def test_delete_operation
    ...
    delete_operation_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Longrunning::Operations::Rest::ServiceStub.stub :transcode_delete_operation_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_operation_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_operation_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Longrunning::Operations::Rest::Client::Configuration, config
  end
end
