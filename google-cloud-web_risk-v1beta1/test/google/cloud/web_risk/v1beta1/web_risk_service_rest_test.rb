...
class ::Google::Cloud::WebRisk::V1beta1::WebRiskService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_compute_threat_list_diff
    # Create test objects.
    client_result = ::Google::Cloud::WebRisk::V1beta1::ComputeThreatListDiffResponse.new
  ...
  def test_search_uris
    # Create test objects.
    client_result = ::Google::Cloud::WebRisk::V1beta1::SearchUrisResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_search_hashes
    # Create test objects.
    client_result = ::Google::Cloud::WebRisk::V1beta1::SearchHashesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::WebRisk::V1beta1::WebRiskService::Rest::Client::Configuration, config
  end
end
