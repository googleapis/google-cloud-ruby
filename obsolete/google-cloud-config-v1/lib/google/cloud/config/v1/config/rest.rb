...
require "google/cloud/config/v1/bindings_override"

require "google/cloud/config/v1/config/credentials"
require "google/cloud/config/v1/config/paths"
require "google/cloud/config/v1/config/rest/operations"
require "google/cloud/config/v1/config/rest/client"
...
require "google/cloud/config/v1/config/rest/helpers" if ::File.file? helper_path
