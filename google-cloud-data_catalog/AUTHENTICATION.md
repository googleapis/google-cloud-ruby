...
In general, the google-cloud-data_catalog library uses
...
```sh
export DATA_CATALOG_CREDENTIALS=path/to/keyfile.json
```
...
The google-cloud-data_catalog library aims to make authentication
...
Google::Cloud::DataCatalog.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-data_catalog.
