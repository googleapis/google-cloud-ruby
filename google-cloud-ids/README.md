# Ruby Client for the Cloud IDS API

API Client library for the Cloud IDS API
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-ids/latest)
for this library, google-cloud-ids, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-ids-v1](https://cloud.google.com/ruby/docs/reference/google-cloud-ids-v1/latest).
