...
class ::Google::Cloud::Datastream::V1::Datastream::ClientTest < Minitest::Test
  ...
  def test_run_stream
    ...
    run_stream_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :run_stream, name
      assert_kind_of ::Google::Cloud::Datastream::V1::RunStreamRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Datastream::V1::CdcStrategy), request["cdc_strategy"]
      assert_equal true, request["force"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, run_stream_client_stub do
      ...
      # Verify method calls
      assert_equal 5, run_stream_client_stub.call_rpc_count
    end
  end
