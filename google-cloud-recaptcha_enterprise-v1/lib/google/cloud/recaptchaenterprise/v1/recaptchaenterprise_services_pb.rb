      ...
      module V1
        module RecaptchaEnterpriseService
          ...
          class Service
            ...
            rpc :GetPolicy, ::Google::Cloud::RecaptchaEnterprise::V1::GetPolicyRequest, ::Google::Cloud::RecaptchaEnterprise::V1::Policy
            # Updates the policy for a key.
            rpc :UpdatePolicy, ::Google::Cloud::RecaptchaEnterprise::V1::UpdatePolicyRequest, ::Google::Cloud::RecaptchaEnterprise::V1::Policy
