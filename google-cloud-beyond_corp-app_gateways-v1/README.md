# Ruby Client for the BeyondCorp AppGateways V1 API

API Client library for the BeyondCorp AppGateways V1 API
...
the main client gem,
[google-cloud-beyond_corp-app_gateways](https://rubygems.org/gems/google-cloud-beyond_corp-app_gateways).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-beyond_corp-app_gateways-v1
```
...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-beyond_corp-app_gateways-v1/latest)
