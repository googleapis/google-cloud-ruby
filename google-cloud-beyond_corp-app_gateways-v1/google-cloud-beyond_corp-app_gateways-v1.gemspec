...
require File.expand_path("lib/google/cloud/beyond_corp/app_gateways/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-beyond_corp-app_gateways-v1"
  gem.version       = Google::Cloud::BeyondCorp::AppGateways::V1::VERSION
