...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Controls access to cloud applications running on Google Cloud Platform. Note that google-cloud-iap-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-iap instead. See the readme for more details."
