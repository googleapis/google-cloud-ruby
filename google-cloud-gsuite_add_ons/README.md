...
View the [Client Library Documentation](https://cloud.google.com/ruby/docs/reference/google-cloud-gsuite_add_ons/latest)
for this library, google-cloud-gsuite_add_ons, to see the convenience methods for
constructing client objects. Reference documentation for the client objects
themselves can be found in the client library documentation for the versioned
client gems:
[google-cloud-gsuite_add_ons-v1](https://googleapis.dev/ruby/google-cloud-gsuite_add_ons-v1/latest).
...
```
$ gem install google-cloud-gsuite_add_ons
```
