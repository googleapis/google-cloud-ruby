...
class ::Google::Cloud::AIPlatform::V1::DataFoundryService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_generate_synthetic_data
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1::GenerateSyntheticDataResponse.new
    ...
    generate_synthetic_data_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :generate_synthetic_data, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::GenerateSyntheticDataRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1::TaskDescriptionStrategy), request["task_description"]
      assert_equal :task_description, request.strategy
      assert_equal "hello world", request["location"]
      assert_equal 42, request["count"]
      assert_kind_of ::Google::Cloud::AIPlatform::V1::OutputFieldSpec, request["output_field_specs"].first
      assert_kind_of ::Google::Cloud::AIPlatform::V1::SyntheticExample, request["examples"].first
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, generate_synthetic_data_client_stub do
      ...
      # Verify method calls
      assert_equal 5, generate_synthetic_data_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::DataFoundryService::Client::Configuration, config
  end
end
