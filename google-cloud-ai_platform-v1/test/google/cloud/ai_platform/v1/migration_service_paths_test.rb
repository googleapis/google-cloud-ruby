...
class ::Google::Cloud::AIPlatform::V1::MigrationService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_version_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.version_path project: "value0", model: "value1", version: "value2"
      assert_equal "projects/value0/models/value1/versions/value2", path
    end
  end
end
