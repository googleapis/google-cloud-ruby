...
class ::Google::Cloud::AIPlatform::V1::ReasoningEngineService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_reasoning_engine
    ...
    create_reasoning_engine_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_reasoning_engine, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::CreateReasoningEngineRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1::ReasoningEngine), request["reasoning_engine"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_reasoning_engine_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_reasoning_engine_client_stub.call_rpc_count
    end
  end

  def test_get_reasoning_engine
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1::ReasoningEngine.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_reasoning_engine_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_reasoning_engine, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::GetReasoningEngineRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_reasoning_engine_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_reasoning_engine_client_stub.call_rpc_count
    end
  end

  def test_list_reasoning_engines
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1::ListReasoningEnginesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_reasoning_engines_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_reasoning_engines, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::ListReasoningEnginesRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_reasoning_engines_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_reasoning_engines_client_stub.call_rpc_count
    end
  end
  ...
  def test_update_reasoning_engine
    ...
    update_reasoning_engine_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_reasoning_engine, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::UpdateReasoningEngineRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1::ReasoningEngine), request["reasoning_engine"]
    ...
    Gapic::ServiceStub.stub :new, update_reasoning_engine_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_reasoning_engine_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_reasoning_engine
    ...
    Gapic::ServiceStub.stub :new, delete_reasoning_engine_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_reasoning_engine_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::ReasoningEngineService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::ReasoningEngineService::Operations, client.operations_client
  end
end
