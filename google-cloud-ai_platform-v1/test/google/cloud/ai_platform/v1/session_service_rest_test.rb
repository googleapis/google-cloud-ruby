...
require "google/cloud/ai_platform/v1/session_service/rest"


class ::Google::Cloud::AIPlatform::V1::SessionService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_session
    ...
    ::Google::Cloud::AIPlatform::V1::SessionService::Rest::ServiceStub.stub :transcode_create_session_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_session_client_stub do
        ...
        # Use protobuf object
        client.create_session ::Google::Cloud::AIPlatform::V1::CreateSessionRequest.new(parent: parent, session: session) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.create_session(::Google::Cloud::AIPlatform::V1::CreateSessionRequest.new(parent: parent, session: session), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_session
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::Session.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_sessions
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::ListSessionsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_list_events
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::ListEventsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
  ...
  def test_append_event
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::AppendEventResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    append_event_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::SessionService::Rest::ServiceStub.stub :transcode_append_event_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, append_event_client_stub do
        ...
        # Verify method calls
        assert_equal 5, append_event_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::SessionService::Rest::Client::Configuration, config
  end
end
