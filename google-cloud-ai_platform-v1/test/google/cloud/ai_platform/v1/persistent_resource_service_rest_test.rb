...
class ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_persistent_resource
    ...
    create_persistent_resource_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
    ...
    ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::ServiceStub.stub :transcode_create_persistent_resource_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_persistent_resource_client_stub do
        ...
        # Verify method calls
        assert_equal 5, create_persistent_resource_client_stub.call_count
      end
    end
  end
  ...
  def test_get_persistent_resource
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::PersistentResource.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    get_persistent_resource_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::ServiceStub.stub :transcode_get_persistent_resource_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, get_persistent_resource_client_stub do
        ...
        # Verify method calls
        assert_equal 5, get_persistent_resource_client_stub.call_count
      end
    end
  end
  ...
  def test_list_persistent_resources
    # Create test objects.
    client_result = ::Google::Cloud::AIPlatform::V1::ListPersistentResourcesResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    list_persistent_resources_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::ServiceStub.stub :transcode_list_persistent_resources_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, list_persistent_resources_client_stub do
        ...
        # Verify method calls
        assert_equal 5, list_persistent_resources_client_stub.call_count
      end
    end
  end
  ...
  def test_delete_persistent_resource
    ...
    delete_persistent_resource_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::ServiceStub.stub :transcode_delete_persistent_resource_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, delete_persistent_resource_client_stub do
        ...
        # Verify method calls
        assert_equal 5, delete_persistent_resource_client_stub.call_count
      end
    end
  end
  ...
  def test_update_persistent_resource
    ...
    update_persistent_resource_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::ServiceStub.stub :transcode_update_persistent_resource_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_persistent_resource_client_stub do
        ...
        # Verify method calls
        assert_equal 5, update_persistent_resource_client_stub.call_count
      end
    end
  end
  ...
  def test_reboot_persistent_resource
    ...
    reboot_persistent_resource_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:, method_name:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
    ...
    ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::ServiceStub.stub :transcode_reboot_persistent_resource_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, reboot_persistent_resource_client_stub do
        ...
        # Verify method calls
        assert_equal 5, reboot_persistent_resource_client_stub.call_count
      end
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::PersistentResourceService::Rest::Client::Configuration, config
  end
end
