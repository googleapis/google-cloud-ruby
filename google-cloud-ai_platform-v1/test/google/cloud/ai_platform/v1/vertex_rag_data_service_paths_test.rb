...
class ::Google::Cloud::AIPlatform::V1::VertexRagDataService::ClientPathsTest < Minitest::Test
  class DummyStub
    def endpoint
  ...
  def test_rag_file_path
    ...
    ::Gapic::ServiceStub.stub :new, DummyStub.new do
      ...
      path = client.rag_file_path project: "value0", location: "value1", rag_corpus: "value2", rag_file: "value3"
      assert_equal "projects/value0/locations/value1/ragCorpora/value2/ragFiles/value3", path
    end
  end
