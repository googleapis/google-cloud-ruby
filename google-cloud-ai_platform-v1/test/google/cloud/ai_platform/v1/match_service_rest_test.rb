...
class ::Google::Cloud::AIPlatform::V1::MatchService::Rest::ClientTest < Minitest::Test
  ...
  def test_find_neighbors
    ...
    find_neighbors_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
  ...
  def test_read_index_datapoints
    ...
    read_index_datapoints_client_stub = ClientStub.new http_response do |_verb, uri:, body:, params:, options:|
      assert options.metadata.key? :"x-goog-api-client"
      assert options.metadata[:"x-goog-api-client"].include? "rest"
      refute options.metadata[:"x-goog-api-client"].include? "grpc"
    end
