...
class ::Google::Cloud::AIPlatform::V1::GenAiCacheService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_cached_content
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1::CachedContent.new
    ...
    create_cached_content_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :create_cached_content, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::CreateCachedContentRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1::CachedContent), request["cached_content"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_cached_content_client_stub do
      ...
      # Verify method calls
      assert_equal 5, create_cached_content_client_stub.call_rpc_count
    end
  end
  ...
  def test_get_cached_content
    ...
    get_cached_content_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :get_cached_content, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::GetCachedContentRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_cached_content_client_stub do
      ...
      # Verify method calls
      assert_equal 5, get_cached_content_client_stub.call_rpc_count
    end
  end

  def test_update_cached_content
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1::CachedContent.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    update_cached_content_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_cached_content, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::UpdateCachedContentRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1::CachedContent), request["cached_content"]
    ...
    Gapic::ServiceStub.stub :new, update_cached_content_client_stub do
      ...
      # Verify method calls
      assert_equal 5, update_cached_content_client_stub.call_rpc_count
    end
  end

  def test_delete_cached_content
    # Create GRPC objects.
    ...
    delete_cached_content_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :delete_cached_content, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::DeleteCachedContentRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_cached_content_client_stub do
      ...
      # Verify method calls
      assert_equal 5, delete_cached_content_client_stub.call_rpc_count
    end
  end

  def test_list_cached_contents
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1::ListCachedContentsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_cached_contents_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :list_cached_contents, name
      assert_kind_of ::Google::Cloud::AIPlatform::V1::ListCachedContentsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_cached_contents_client_stub do
      ...
      # Verify method calls
      assert_equal 5, list_cached_contents_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1::GenAiCacheService::Client::Configuration, config
  end
