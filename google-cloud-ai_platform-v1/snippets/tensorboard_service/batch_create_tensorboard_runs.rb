...
##
# Snippet for the batch_create_tensorboard_runs call in the TensorboardService service
#
...
# Google::Cloud::AIPlatform::V1::TensorboardService::Client#batch_create_tensorboard_runs.
#
