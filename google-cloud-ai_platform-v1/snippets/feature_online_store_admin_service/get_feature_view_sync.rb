...
##
# Snippet for the get_feature_view_sync call in the FeatureOnlineStoreAdminService service
#
...
# Google::Cloud::AIPlatform::V1::FeatureOnlineStoreAdminService::Client#get_feature_view_sync.
#
