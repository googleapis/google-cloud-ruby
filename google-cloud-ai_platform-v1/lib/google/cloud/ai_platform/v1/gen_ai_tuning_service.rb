...
helper_path = ::File.join __dir__, "gen_ai_tuning_service", "helpers.rb"
require "google/cloud/ai_platform/v1/gen_ai_tuning_service/helpers" if ::File.file? helper_path
