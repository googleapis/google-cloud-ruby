          ...
          module Rest
            ...
            class Client
              ...
              def initialize
                ...
                @featurestore_online_serving_service_stub.logger(stub: true)&.info do |entry|
                ...
                @location_client = Google::Cloud::Location::Locations::Rest::Client.new do |config|
                  ...
                  config.logger = @featurestore_online_serving_service_stub.logger if config.respond_to? :logger=
                end
              ...
              #
              def logger
                @featurestore_online_serving_service_stub.logger
              end
