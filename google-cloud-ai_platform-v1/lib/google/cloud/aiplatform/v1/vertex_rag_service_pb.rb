  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        AskContextsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.AskContextsRequest").msgclass
        AskContextsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.AskContextsResponse").msgclass
        AsyncRetrieveContextsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.AsyncRetrieveContextsRequest").msgclass
        AsyncRetrieveContextsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.AsyncRetrieveContextsResponse").msgclass
        AsyncRetrieveContextsOperationMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.AsyncRetrieveContextsOperationMetadata").msgclass
      end
    end
  end
end
