  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        ReasoningEngineSpec::SourceCodeSpec::ImageSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.ReasoningEngineSpec.SourceCodeSpec.ImageSpec").msgclass
