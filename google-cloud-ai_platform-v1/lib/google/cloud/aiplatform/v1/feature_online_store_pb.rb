  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        FeatureOnlineStore::Bigtable::BigtableMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.FeatureOnlineStore.Bigtable.BigtableMetadata").msgclass
