  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        VertexMultimodalDatasetSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.VertexMultimodalDatasetSource").msgclass
        VertexMultimodalDatasetDestination = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.VertexMultimodalDatasetDestination").msgclass
