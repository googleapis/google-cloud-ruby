  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        VertexAiSearchConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.VertexAiSearchConfig").msgclass
        ...
        RagChunk = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.RagChunk").msgclass
        RagChunk::PageSpan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.RagChunk.PageSpan").msgclass
