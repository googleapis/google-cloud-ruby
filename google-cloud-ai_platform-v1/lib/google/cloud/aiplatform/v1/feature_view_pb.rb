  ...
  module Cloud
    module AIPlatform
      module V1
        ...
        FeatureView::BigtableMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1.FeatureView.BigtableMetadata").msgclass
