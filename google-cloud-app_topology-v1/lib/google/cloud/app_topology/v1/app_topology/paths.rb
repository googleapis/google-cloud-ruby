...
module Google
  module Cloud
    module AppTopology
      module V1
        module AppTopology
          # Path helper methods for the AppTopology API.
          module Paths
            ##
            # Create a fully-qualified DiscoveredResourcesTopology resource string.
            #
            ...
            #
            # @return [::String]
            def discovered_resources_topology_path project:, location:
            ...
            #
            # @return [::String]
            def schema_path project:, location:, domain:
              raise ::ArgumentError, "project cannot contain /" if project.to_s.include? "/"
              raise ::ArgumentError, "location cannot contain /" if location.to_s.include? "/"
