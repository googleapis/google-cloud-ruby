  ...
  module Cloud
    module AppTopology
      module V1
        ...
        # @!attribute [rw] nodes
        #   @return [::Array<::Google::Cloud::AppTopology::V1::Node>]
        #     A collection of unique nodes that make up the graph.
        # @!attribute [rw] edges
        #   @return [::Array<::Google::Cloud::AppTopology::V1::Edge>]
        ...
        #   @return [::Google::Cloud::AppTopology::V1::EntityContext]
