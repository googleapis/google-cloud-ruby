            ...
            class ServiceStub
              ...
              def set_node_pool_autoscaling request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "set_node_pool_autoscaling",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def set_logging_service request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "set_logging_service",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def set_monitoring_service request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "set_monitoring_service",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def complete_node_pool_upgrade request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "complete_node_pool_upgrade",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Protobuf::Empty.decode_json response.body, ignore_unknown_fields: true
              ...
              def rollback_node_pool_upgrade request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "rollback_node_pool_upgrade",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def set_node_pool_management request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "set_node_pool_management",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def complete_ip_rotation request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "complete_ip_rotation",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def set_node_pool_size request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "set_node_pool_size",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def set_network_policy request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "set_network_policy",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def set_maintenance_policy request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "set_maintenance_policy",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              def list_usable_subnetworks request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "list_usable_subnetworks",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              def check_autopilot_compatibility request_pb, options = nil
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "check_autopilot_compatibility",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
              ...
              ##
              # Baseline implementation for the complete_control_plane_upgrade REST call
              #
              # @param request_pb [::Google::Cloud::Container::V1::CompleteControlPlaneUpgradeRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Cloud::Container::V1::Operation]
              #   A result object deserialized from the server's reply
              def complete_control_plane_upgrade request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_complete_control_plane_upgrade_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                response = @client_stub.make_http_request(
                  ...
                  body: body || "",
                  params: query_string_params,
                  method_name: "complete_control_plane_upgrade",
                  options: options
                )
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::Container::V1::Operation.decode_json response.body, ignore_unknown_fields: true
              ...
              # @private
              #
              # GRPC transcoding helper method for the complete_control_plane_upgrade REST call
              #
              # @param request_pb [::Google::Cloud::Container::V1::CompleteControlPlaneUpgradeRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_complete_control_plane_upgrade_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/{name}:completeControlPlaneUpgrade",
                                                          body: "*",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/clusters/[^/]+/?$}, false]
                                                          ]
