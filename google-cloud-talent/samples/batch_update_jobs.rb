...
def sample_batch_update_jobs project_id, tenant_id, job_name_one,
                             ...
                             language_code_one, job_name_two,
                             company_name_two, requisition_id_two,
                             title_two, description_two,
  ...
  operation = job_service.batch_update_jobs parent: formatted_parent, jobs: jobs
...
if $PROGRAM_NAME == __FILE__
  ...
  sample_batch_update_jobs project_id, tenant_id, job_name_one,
                           company_name_one, requisition_id_one,
                           title_one, description_one,
                           job_application_url_one, address_one,
                           language_code_one, job_name_two, company_name_two,
                           requisition_id_two, title_two, description_two,
                           job_application_url_two, address_two, language_code_two
end
