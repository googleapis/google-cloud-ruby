...
In general, the google-cloud-service_directory-v1beta1 library uses [Service
...
The environment variables that google-cloud-service_directory-v1beta1 checks for credentials are configured on the service Credentials class (such as {Google::Cloud::ServiceDirectory::V1beta1::LookupService::Credentials}):
