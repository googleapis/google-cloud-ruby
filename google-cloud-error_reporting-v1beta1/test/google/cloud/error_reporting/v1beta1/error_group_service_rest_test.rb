...
class ::Google::Cloud::ErrorReporting::V1beta1::ErrorGroupService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_group
    # Create test objects.
    client_result = ::Google::Cloud::ErrorReporting::V1beta1::ErrorGroup.new
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ErrorReporting::V1beta1::ErrorGroupService::Rest::Client::Configuration, config
  end
end
