...
```
$ gem install google-shopping-merchant-order_tracking-v1
```
...
request = ::Google::Shopping::Merchant::OrderTracking::V1::CreateOrderTrackingSignalRequest.new # (request fields as keyword arguments...)
response = client.create_order_tracking_signal request
```

View the [Client Library Documentation](https://rubydoc.info/gems/google-shopping-merchant-order_tracking-v1)
...
is part of the name, e.g. `google-shopping-merchant-order_tracking-v1`.
