...
The gem `google-cloud-notebooks` is the main client library that brings the
...
[google-cloud-notebooks-v1beta1](https://cloud.google.com/ruby/docs/reference/google-cloud-notebooks-v1beta1/latest).
