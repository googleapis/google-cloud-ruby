...
require "google/cloud/notebooks/version"
...
module Google
  module Cloud
    module Notebooks
      ...
      #
      def self.configure
        yield ::Google::Cloud.configure.notebooks if block_given?

        ::Google::Cloud.configure.notebooks
      end
    end
  end
end

helper_path = ::File.join __dir__, "notebooks", "helpers.rb"
require "google/cloud/notebooks/helpers" if ::File.file? helper_path
